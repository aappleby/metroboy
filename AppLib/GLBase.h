...
int   create_vbo(int size_bytes, const void* data = nullptr);
void  update_vbo(int vbo, int size_bytes, const void* data);

int   create_ibo(int size_bytes, const void* data = nullptr);
...
int   create_table_u8(int width, int height, const void* data = nullptr);
void  update_table_u8(int tex, int width, int height, const void* pix);

// basically an unsigned 32-bit integer texture
int   create_table_u32(int width, int height, const void* data = nullptr);
