...
void P09_ApuControl_tick(const ChipIn& chip_in, const CpuIn& cpu_in, const Gameboy& a, const Gameboy& b, Gameboy& c) {
  ...
  /*p16.ANUJ*/ c.apu.CPU_WR_WEIRD = and(cpu_in.FROM_CPU5, b.apu.APU_WR);
  ...
  {
    /*p01.ATAL*/ wire CLK_AxCxExGx3  = not(b.sys.CLK_xBxDxFxH3);
...

  {
    ...
    /*p10.ATUP*/ c.apu.ADDR_xxx0xxxx = not(b.A04);
    /*p10.BOXY*/ c.apu.ADDR_xx0xxxxx = not(b.A05);
    /*p10.ASAD*/ c.apu.ADDR_x0xxxxxx = not(b.A06);
    /*p10.AVUN*/ c.apu.ADDR_0xxxxxxx = not(b.A07);

    /*p10.ATEG*/ c.apu.ADDR_XX1Xn = or(b.apu.ADDR_xxx0xxxx, b.A05, b.A06, b.A07);
    /*p10.AWET*/ c.apu.ADDR_XX2Xn = or(b.A04, b.apu.ADDR_xx0xxxxx, b.A06, b.A07);
    /*p10.ACOM*/ c.apu.ADDR_XX3Xn = nand(b.apu.ADDR_0xxxxxxx, b.apu.ADDR_x0xxxxxx, b.A05, b.A04);

    /*p10.BUNO*/ c.apu.ADDR_FF1X  = nor(b.apu.ADDR_FFXXn1, b.apu.ADDR_XX1Xn);
    /*p10.CONA*/ c.apu.ADDR_FF2X  = not(b.apu.ADDR_FF2Xn);
    /*p10.BARO*/ c.apu.ADDR_FF3X  = nor(b.apu.ADDR_XX3Xn, b.apu.ADDR_FFXXn1);

    /*p10.BANU*/ c.apu.ADDR_FF1Xn = not(b.apu.ADDR_FF1X);
    /*p10.BEZY*/ c.apu.ADDR_FF2Xn = or(b.apu.ADDR_XX2Xn, b.apu.ADDR_FFXXn1);
...

  {
    ...
    /*p09.BAXY*/ c.apu.NR50_WR1  = not(NR50_WRn1);
    /*p09.BOWE*/ c.apu.NR50_WR2  = not(NR50_WRn1);

    /*p09.BUBU*/ c.apu.NR50_WRn2 = not(b.apu.NR50_WR1);
    /*p09.ATAF*/ c.apu.NR50_WRn3 = not(b.apu.NR50_WR2);
    ...
    /*p09.BEFU*/ c.apu.NR50_RDn1 = nor(CPU_RDn, ADDR_FF24n);
    /*p09.ADAK*/ c.apu.NR50_RD1  = not(b.apu.NR50_RDn1);

    /*p09.AKOD*/ if (b.apu.NR50_RD1) c.D0 = b.apu.NR50_VOL_L0;
    /*p09.AWED*/ if (b.apu.NR50_RD1) c.D1 = b.apu.NR50_VOL_L1;
    /*p09.AVUD*/ if (b.apu.NR50_RD1) c.D2 = b.apu.NR50_VOL_L2;
    /*p09.AXEM*/ if (b.apu.NR50_RD1) c.D3 = b.apu.NR50_VIN_TO_L;
    /*p09.AMAD*/ if (b.apu.NR50_RD1) c.D4 = b.apu.NR50_VOL_R0;
    /*p09.ARUX*/ if (b.apu.NR50_RD1) c.D5 = b.apu.NR50_VOL_R1;
    /*p09.BOCY*/ if (b.apu.NR50_RD1) c.D6 = b.apu.NR50_VOL_R2;
    /*p09.ATUM*/ if (b.apu.NR50_RD1) c.D7 = b.apu.NR50_VIN_TO_R;
  }
...

  {
    ...
    /*p10.CORA*/ c.apu.ADDR_FF25  = nor(b.apu.ADDR_FF2Xn, ADDR_0101bn);
    /*p09.GEPA*/ c.apu.ADDR_FF25n = not(b.apu.ADDR_FF25);
    /*p09.BUPO*/ c.apu.NR51_WRn = nand(b.apu.ADDR_FF25, b.apu.APU_WR);
    ...
    /*p09.AGUZ*/ wire CPU_RDn = not(b.sys.CPU_RD);
    /*p09.HEFA*/ c.apu.NR51_RDn = nor(b.apu.ADDR_FF25n, CPU_RDn);
    /*p09.GUMU*/ c.apu.NR51_RD = not(b.apu.NR51_RDn);

    /*p09.CAPU*/ if (b.apu.NR51_RD) c.D1 = b.apu.NR51_0;
    /*p09.CAGA*/ if (b.apu.NR51_RD) c.D2 = b.apu.NR51_1;
    /*p09.BOCA*/ if (b.apu.NR51_RD) c.D3 = b.apu.NR51_2;
    /*p09.BUZU*/ if (b.apu.NR51_RD) c.D0 = b.apu.NR51_3;
    /*p09.CERE*/ if (b.apu.NR51_RD) c.D7 = b.apu.NR51_4;
    /*p09.CADA*/ if (b.apu.NR51_RD) c.D6 = b.apu.NR51_5;
    /*p09.CAVU*/ if (b.apu.NR51_RD) c.D4 = b.apu.NR51_6;
    /*p09.CUDU*/ if (b.apu.NR51_RD) c.D5 = b.apu.NR51_7;
  }
...

  {
    ...
    /*p10.DOXY*/ c.apu.ADDR_FF26  = and(b.apu.ADDR_FF2X,  ADDR_0110bn); // something not right here

    /*p09.ETUC*/ c.apu.NR52_WR1  = and(b.apu.ADDR_FF26, b.apu.APU_WR);
    /*p09.HAWU*/ c.apu.NR52_WRn1 = nand(b.apu.ADDR_FF26, b.apu.APU_WR);
    /*p09.BOPY*/ c.apu.NR52_WRn2 = nand(b.apu.ADDR_FF26, b.apu.APU_WR);
    /*p09.FOKU*/ c.apu.NR52_WRn3 = not(b.apu.NR52_WR1);
    ...
    /*p09.DOLE*/ wire NR52_RDna = nand(b.apu.ADDR_FF26, CPU_RDa);
    /*p09.KAMU*/ wire NR52_RDnb = nand(b.apu.ADDR_FF26, CPU_RDb);
    /*p09.DURU*/ wire NR52_RDnd = nand(b.apu.ADDR_FF26, CPU_RDc);
    /*p09.FEWA*/ wire NR52_RDnc = nand(b.apu.ADDR_FF26, CPU_RDd);
    /*p09.JURE*/ wire NR52_RDne = nand(b.apu.ADDR_FF26, CPU_RDe);
