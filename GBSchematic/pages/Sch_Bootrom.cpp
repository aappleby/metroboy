...
void Bootrom_tick(const BusTristates& bus,
...

  {
    ...
    /*p07.YULA*/ wire BOOT_RD    = and(ctl.TEDO_CPURD, MODE_DBG1n, dec.ADDR_BOOT);
...

  {
    ...
    /*p07.TEXE*/ wire FF50_RD = and(ctl.TEDO_CPURD, dec.ADDR_FFXX, ADDR_x1x1xxxx, ADDR_0x0x0000);

    if (FF50_RD) bus_out.set_data(
      /*p07.SYPU*/ prev.BOOT_BIT
    );
  }
}
...
void Bootrom_tock(const BusTristates& bus,
  ...
  /*p07.TYRO*/ wire ADDR_0x0x0000 = nor(bus.A07(), bus.A05(), bus.A03(), bus.A02(), bus.A01(), bus.A00());
  /*p07.TUFA*/ wire ADDR_x1x1xxxx = and(bus.A04(), bus.A06());
  /*p07.TUGE*/ wire FF50_WRn = nand(ctl.TAPU_CPUWR, dec.ADDR_FFXX, ADDR_0x0x0000, ADDR_x1x1xxxx);
  /*p07.SATO*/ wire BOOT_BIT_IN  = or(bus.D0(), prev.BOOT_BIT);
  /*p07.TEPU*/ next.BOOT_BIT.tock(FF50_WRn, rst_sig1.SYS_RESETn, BOOT_BIT_IN);
}
