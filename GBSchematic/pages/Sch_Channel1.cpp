...
void Channel1_tick(const Pins& pins,
...

  {
    ...
    /*p11.AMYD*/ if (NR10_RD) next.bus.D0 = b.ch1.NR10_SHIFT0;
    /*p11.ATAX*/ if (NR10_RD) next.bus.D1 = b.ch1.NR10_SHIFT1;
    /*p11.AZYP*/ if (NR10_RD) next.bus.D2 = b.ch1.NR10_SHIFT2;
    /*p11.AFOX*/ if (NR10_RD) next.bus.D3 = b.ch1.NR10_SWEEP_DIR;
    /*p11.AVEK*/ if (NR10_RD) next.bus.D4 = b.ch1.NR10_DELAY0;
    /*p11.AKUX*/ if (NR10_RD) next.bus.D5 = b.ch1.NR10_DELAY1;
    /*p11.AWOS*/ if (NR10_RD) next.bus.D6 = b.ch1.NR10_DELAY2;
  }
  ...
  // FF11 NR11
  {
    ...
    /*p11.CENA*/ next.ch1.NR11_DUTY_0 = tock_pos(a.ch1.NR11_CLK, b.ch1.NR11_CLK, RESET1n, b.ch1.NR11_DUTY_0, b.bus.D6);
    /*p11.DYCA*/ next.ch1.NR11_DUTY_1 = tock_pos(a.ch1.NR11_CLK, b.ch1.NR11_CLK, RESET1n, b.ch1.NR11_DUTY_1, b.bus.D7);

    /*p11.BOWO*/ if (NR11_RD) next.bus.D6 = b.ch1.NR11_DUTY_0;
    /*p11.CUDA*/ if (NR11_RD) next.bus.D7 = b.ch1.NR11_DUTY_1;
  }
...

  {
    ...
    /*p11.JYNE*/ if (!NR12_RDn) next.bus.D0 = b.ch1.NR12_DELAY0;
    /*p11.JACA*/ if (!NR12_RDn) next.bus.D1 = b.ch1.NR12_DELAY1;
    /*p11.JOKU*/ if (!NR12_RDn) next.bus.D2 = b.ch1.NR12_DELAY2;
    /*p11.HONO*/ if (!NR12_RDo) next.bus.D3 = b.ch1.NR12_ENV_DIR;
    /*p11.HOWU*/ if (!NR12_RDo) next.bus.D4 = b.ch1.NR12_VOL0;
    /*p11.HEWA*/ if (!NR12_RDo) next.bus.D5 = b.ch1.NR12_VOL1;
    /*p11.HEVE*/ if (!NR12_RDo) next.bus.D6 = b.ch1.NR12_VOL2;
    /*p11.JYSE*/ if (!NR12_RDo) next.bus.D7 = b.ch1.NR12_VOL3;
...

  {
    ...
    /*p11.FORU*/ if (FF13_RDa) next.bus.D0 = b.ch1.FREQ_CNT_00;
    /*p11.GEFU*/ if (FF13_RDa) next.bus.D1 = b.ch1.FREQ_CNT_01;
    /*p11.KYVU*/ if (FF13_RDa) next.bus.D2 = b.ch1.FREQ_CNT_02;
    /*p11.KUMO*/ if (FF13_RDa) next.bus.D3 = b.ch1.FREQ_CNT_03;
    /*p11.KARY*/ if (FF13_RDa) next.bus.D4 = b.ch1.FREQ_CNT_04;
    /*p11.GODE*/ if (FF13_RDa) next.bus.D5 = b.ch1.FREQ_CNT_05;
    /*p11.GOJE*/ if (FF13_RDa) next.bus.D6 = b.ch1.FREQ_CNT_06;
    /*p11.FOZE*/ if (FF13_RDa) next.bus.D7 = b.ch1.FREQ_CNT_07;
    /*p11.DOPA*/ if (FF14_RDa) next.bus.D0 = b.ch1.FREQ_CNT_08;
    /*p11.DEMU*/ if (FF14_RDa) next.bus.D1 = b.ch1.FREQ_CNT_09;
    /*p11.DEXO*/ if (FF14_RDa) next.bus.D2 = b.ch1.FREQ_CNT_10;
  }
  ...
  {
    // FIXME
    //wire aCLK_1M  = a.clk.DOVA_xxxDEFGx;
    //wire bCLK_1M  = b.clk.DOVA_xxxDEFGx;
    wire aCLK_1M  = clk.DOVA_xxxDEFGx;
    wire bCLK_1M  = clk.DOVA_xxxDEFGx;
