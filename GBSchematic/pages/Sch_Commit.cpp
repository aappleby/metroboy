...
bool TestGB::commit_everything() {
  ...
  /*p27.PYNU*/ changed |= vid_reg.WIN_MODE_LATCH1.commit();
  ...
  /* PIN_01 */ changed |= cart_pins.A00_A.commit();   // <- P08.KUPO
  /* PIN_01 */ changed |= cart_pins.A00_C.commit();   // -> P08.KOVA
  /* PIN_01 */ changed |= cart_pins.A00_D.commit();   // <- P08.KOTY
  /* PIN_02 */ changed |= cart_pins.A01_A.commit();   // <- P08.CABA
  /* PIN_02 */ changed |= cart_pins.A01_C.commit();   // -> P08.CAMU
  /* PIN_02 */ changed |= cart_pins.A01_D.commit();   // <- P08.COTU
  /* PIN_03 */ changed |= cart_pins.A02_A.commit();   // <- P08.BOKU
  /* PIN_03 */ changed |= cart_pins.A02_C.commit();   // -> P08.BUXU
  /* PIN_03 */ changed |= cart_pins.A02_D.commit();   // <- P08.BAJO
  /* PIN_04 */ changed |= cart_pins.A03_A.commit();   // <- P08.BOTY
  /* PIN_04 */ changed |= cart_pins.A03_C.commit();   // -> P08.BASE
  /* PIN_04 */ changed |= cart_pins.A03_D.commit();   // <- P08.BOLA
  /* PIN_05 */ changed |= cart_pins.A04_A.commit();   // <- P08.BYLA
  /* PIN_05 */ changed |= cart_pins.A04_C.commit();   // -> P08.AFEC
  /* PIN_05 */ changed |= cart_pins.A04_D.commit();   // <- P08.BEVO
  /* PIN_06 */ changed |= cart_pins.A05_A.commit();   // <- P08.BADU
  /* PIN_06 */ changed |= cart_pins.A05_C.commit();   // -> P08.ABUP
  /* PIN_06 */ changed |= cart_pins.A05_D.commit();   // <- P08.AJAV
  /* PIN_07 */ changed |= cart_pins.A06_A.commit();   // <- P08.CEPU
  /* PIN_07 */ changed |= cart_pins.A06_C.commit();   // -> P08.CYGU
  /* PIN_07 */ changed |= cart_pins.A06_D.commit();   // <- P08.CYKA
  /* PIN_08 */ changed |= cart_pins.A07_A.commit();   // <- P08.DEFY
  /* PIN_08 */ changed |= cart_pins.A07_C.commit();   // -> P08.COGO
  /* PIN_08 */ changed |= cart_pins.A07_D.commit();   // <- P08.COLO
  /* PIN_09 */ changed |= cart_pins.A08_A.commit();   // <- P08.MYNY
  /* PIN_09 */ changed |= cart_pins.A08_C.commit();   // -> P08.MUJY
  /* PIN_09 */ changed |= cart_pins.A08_D.commit();   // <- P08.MEGO
  /* PIN_10 */ changed |= cart_pins.A09_A.commit();   // <- P08.MUNE
  /* PIN_10 */ changed |= cart_pins.A09_C.commit();   // -> P08.NENA
  /* PIN_10 */ changed |= cart_pins.A09_D.commit();   // <- P08.MENY
  /* PIN_11 */ changed |= cart_pins.A10_A.commit();   // <- P08.ROXU
  /* PIN_11 */ changed |= cart_pins.A10_C.commit();   // -> P08.SURA
  /* PIN_11 */ changed |= cart_pins.A10_D.commit();   // <- P08.RORE
  /* PIN_12 */ changed |= cart_pins.A11_A.commit();   // <- P08.LEPY
  /* PIN_12 */ changed |= cart_pins.A11_C.commit();   // -> P08.MADY
  /* PIN_12 */ changed |= cart_pins.A11_D.commit();   // <- P08.LYNY
  /* PIN_13 */ changed |= cart_pins.A12_A.commit();   // <- P08.LUCE
  /* PIN_13 */ changed |= cart_pins.A12_C.commit();   // -> P08.LAHE
  /* PIN_13 */ changed |= cart_pins.A12_D.commit();   // <- P08.LOSO
  /* PIN_14 */ changed |= cart_pins.A13_A.commit();   // <- P08.LABE
  /* PIN_14 */ changed |= cart_pins.A13_C.commit();   // -> P08.LURA
  /* PIN_14 */ changed |= cart_pins.A13_D.commit();   // <- P08.LEVA
  /* PIN_15 */ changed |= cart_pins.A14_A.commit();   // <- P08.PUHE
  /* PIN_15 */ changed |= cart_pins.A14_C.commit();   // -> P08.PEVO
  /* PIN_15 */ changed |= cart_pins.A14_D.commit();   // <- P08.PAHY
  /* PIN_16 */ changed |= cart_pins.A15_A.commit();   // <- P08.SUZE
  /* PIN_16 */ changed |= cart_pins.A15_C.commit();   // -> P08.RAZA
  /* PIN_16 */ changed |= cart_pins.A15_D.commit();   // <- P08.RULO
  /* PIN_17 */ changed |= cart_pins.D0_A.commit();    // <- P08.RUXA
  /* PIN_17 */ changed |= cart_pins.D0_B.commit();    // <- P08.LULA
  /* PIN_17 */ changed |= cart_pins.D0_C.commit();    // -> P08.TOVO,SOMA
  /* PIN_17 */ changed |= cart_pins.D0_D.commit();    // <- P08.RUNE
  /* PIN_18 */ changed |= cart_pins.D1_A.commit();    // <- P08.RUJA
  /* PIN_18 */ changed |= cart_pins.D1_B.commit();    // <- P08.LULA
  /* PIN_18 */ changed |= cart_pins.D1_C.commit();    // -> P08.RUZY,RONY
  /* PIN_18 */ changed |= cart_pins.D1_D.commit();    // <- P08.RYPU
  /* PIN_19 */ changed |= cart_pins.D2_A.commit();    // <- P08.RABY
  /* PIN_19 */ changed |= cart_pins.D2_B.commit();    // <- P08.LULA
  /* PIN_19 */ changed |= cart_pins.D2_C.commit();    // -> P08.ROME,RAXY
  /* PIN_19 */ changed |= cart_pins.D2_D.commit();    // <- P08.SULY
  /* PIN_20 */ changed |= cart_pins.D3_A.commit();    // <- P08.RERA
  /* PIN_20 */ changed |= cart_pins.D3_B.commit();    // <- P08.LULA
  /* PIN_20 */ changed |= cart_pins.D3_C.commit();    // -> P08.SAZA,SELO
  /* PIN_20 */ changed |= cart_pins.D3_D.commit();    // <- P08.SEZE
  /* PIN_21 */ changed |= cart_pins.D4_A.commit();    // <- P08.RORY
  /* PIN_21 */ changed |= cart_pins.D4_B.commit();    // <- P08.LULA
  /* PIN_21 */ changed |= cart_pins.D4_C.commit();    // -> P08.TEHE,SODY
  /* PIN_21 */ changed |= cart_pins.D4_D.commit();    // <- P08.RESY
  /* PIN_22 */ changed |= cart_pins.D5_A.commit();    // <- P08.RYVO
  /* PIN_22 */ changed |= cart_pins.D5_B.commit();    // <- P08.LULA
  /* PIN_22 */ changed |= cart_pins.D5_C.commit();    // -> P08.RATU,SAGO
  /* PIN_22 */ changed |= cart_pins.D5_D.commit();    // <- P08.TAMU
  /* PIN_23 */ changed |= cart_pins.D6_A.commit();    // <- P08.RAFY
  /* PIN_23 */ changed |= cart_pins.D6_B.commit();    // <- P08.LULA
  /* PIN_23 */ changed |= cart_pins.D6_C.commit();    // -> P08.SOCA,RUPA
  /* PIN_23 */ changed |= cart_pins.D6_D.commit();    // <- P08.ROGY
  /* PIN_24 */ changed |= cart_pins.D7_A.commit();    // <- P08.RAVU
  /* PIN_24 */ changed |= cart_pins.D7_B.commit();    // <- P08.LULA
  /* PIN_24 */ changed |= cart_pins.D7_C.commit();    // -> P08.RYBA,SAZY
  /* PIN_24 */ changed |= cart_pins.D7_D.commit();    // <- P08.RYDA
  ...
  /* PIN_78 */ changed |= cart_pins.WRn_A.commit();   // <- P08.UVER
  /* PIN_78 */ changed |= cart_pins.WRn_C.commit();   // -> P07.UBAL
  /* PIN_78 */ changed |= cart_pins.WRn_D.commit();   // <- P08.USUF
  /* PIN_79 */ changed |= cart_pins.RDn_A.commit();   // <- P08.UGAC
  /* PIN_79 */ changed |= cart_pins.RDn_C.commit();   // -> P07.UJYV
  /* PIN_79 */ changed |= cart_pins.RDn_D.commit();   // <- P08.URUN
  /* PIN_80 */ changed |= cart_pins.CSn_A.commit();   // <- P08.TYHO

  changed |= vrm_tri.MA00.commit();
  changed |= vrm_tri.MA01.commit();
  changed |= vrm_tri.MA02.commit();
  changed |= vrm_tri.MA03.commit();
  changed |= vrm_tri.MA04.commit();
  changed |= vrm_tri.MA05.commit();
  changed |= vrm_tri.MA06.commit();
  changed |= vrm_tri.MA07.commit();
  changed |= vrm_tri.MA08.commit();
  changed |= vrm_tri.MA09.commit();
  changed |= vrm_tri.MA10.commit();
  changed |= vrm_tri.MA11.commit();
  changed |= vrm_tri.MA12.commit();
  changed |= vrm_tri.MD0.commit();
  changed |= vrm_tri.MD1.commit();
  changed |= vrm_tri.MD2.commit();
  changed |= vrm_tri.MD3.commit();
  changed |= vrm_tri.MD4.commit();
  changed |= vrm_tri.MD5.commit();
  changed |= vrm_tri.MD6.commit();
  changed |= vrm_tri.MD7.commit();

  changed |= bus_tri.A00.commit();
  changed |= bus_tri.A01.commit();
  changed |= bus_tri.A02.commit();
  changed |= bus_tri.A03.commit();
  changed |= bus_tri.A04.commit();
  changed |= bus_tri.A05.commit();
  changed |= bus_tri.A06.commit();
  changed |= bus_tri.A07.commit();
  changed |= bus_tri.A08.commit();
  changed |= bus_tri.A09.commit();
  changed |= bus_tri.A10.commit();
  changed |= bus_tri.A11.commit();
  changed |= bus_tri.A12.commit();
  changed |= bus_tri.A13.commit();
  changed |= bus_tri.A14.commit();
  changed |= bus_tri.A15.commit();
  changed |= bus_tri.D0.commit();
  changed |= bus_tri.D1.commit();
  changed |= bus_tri.D2.commit();
  changed |= bus_tri.D3.commit();
  changed |= bus_tri.D4.commit();
  changed |= bus_tri.D5.commit();
  changed |= bus_tri.D6.commit();
  changed |= bus_tri.D7.commit();

  changed |= sil_tri.TS_IDX_0.commit();
  changed |= sil_tri.TS_IDX_1.commit();
  changed |= sil_tri.TS_IDX_2.commit();
  changed |= sil_tri.TS_IDX_3.commit();
  changed |= sil_tri.TS_IDX_4.commit();
  changed |= sil_tri.TS_IDX_5.commit();
  changed |= sil_tri.TS_LINE_0.commit();
  changed |= sil_tri.TS_LINE_1.commit();
  changed |= sil_tri.TS_LINE_2.commit();
  changed |= sil_tri.TS_LINE_3.commit();
