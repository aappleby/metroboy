...
void Debug::tick(const Bus& bus,
  ...
  /*p25.SOTO*/ next.DBG_SOTO.tock(CLK_SOTO, rst.sig.SOTO_RESET, !prev.DBG_SOTO);
  ...
  /*p07.BURO*/ next.FF60_0.tock(FF60_WRn, rst.sig.SYS_RESETn, bus.D0);
  /*p07.AMUT*/ next.FF60_1.tock(FF60_WRn, rst.sig.SYS_RESETn, bus.D1);
