...
void Debug::tick(const Bus& bus,
  ...
  /*p05.AXYN*/ wire AXYN_xBCDEFGH = not(clk.BEDO_xxxDxxxx);
  ...
  /*p07.LECO*/ wire LECO_xBCDEFGH = nor(clk.BEDO_xxxDxxxx, prev.MODE_DBG2);
  ...
  /*p25.TUSO*/ wire TUSO = nor(prev.MODE_DBG2, clk.BOGA_ABCxEFGH);
