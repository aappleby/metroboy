...
void Joypad_tock(const Bus& bus,
  ...
  /*p02.KERY*/ wire ANY_BUTTON = or(prev.PIN_P13_C, prev.PIN_P12_C, prev.PIN_P11_C, prev.PIN_P10_C);
  /*p02.BATU*/ next.JP_GLITCH0.tock(clk.BOGA_AxCDEFGH, rst_reg.sig.SYS_RESETn, ANY_BUTTON);
  /*p02.ACEF*/ next.JP_GLITCH1.tock(clk.BOGA_AxCDEFGH, rst_reg.sig.SYS_RESETn, prev.JP_GLITCH0);
  /*p02.AGEM*/ next.JP_GLITCH2.tock(clk.BOGA_AxCDEFGH, rst_reg.sig.SYS_RESETn, prev.JP_GLITCH1);
  /*p02.APUG*/ next.JP_GLITCH3.tock(clk.BOGA_AxCDEFGH, rst_reg.sig.SYS_RESETn, prev.JP_GLITCH2);

  /*p10.ATOZ*/ wire FF00_WRn   = nand(ctl.CPU_WR, ADDR_111111110xx00000, A06n, A05n);
  /*p05.JUTE*/ next.JOYP_RA    .tock(FF00_WRn, rst_reg.sig.SYS_RESETn, bus.D0);
  /*p05.KECY*/ next.JOYP_LB    .tock(FF00_WRn, rst_reg.sig.SYS_RESETn, bus.D1);
  /*p05.JALE*/ next.JOYP_UC    .tock(FF00_WRn, rst_reg.sig.SYS_RESETn, bus.D2);
  /*p05.KYME*/ next.JOYP_DS    .tock(FF00_WRn, rst_reg.sig.SYS_RESETn, bus.D3);
  /*p05.KELY*/ next.JOYP_UDLR  .tock(FF00_WRn, rst_reg.sig.SYS_RESETn, bus.D4);
  /*p05.COFY*/ next.JOYP_ABCS  .tock(FF00_WRn, rst_reg.sig.SYS_RESETn, bus.D5);
  /*p05.KUKO*/ next.DBG_FF00_D6.tock(FF00_WRn, rst_reg.sig.SYS_RESETn, bus.D6);
  /*p05.KERU*/ next.DBG_FF00_D7.tock(FF00_WRn, rst_reg.sig.SYS_RESETn, bus.D7);
}
