...
void LCD::tick(const Clocks& clk,
               const Resets& rst,
               const LCD& lcd,
               const Video& vid,
               ...
               LCD& next)
{
  ...
  /*p21.XYVO*/ next.LINE_144_d0  = and(lcd.Y4, lcd.Y7); // 128 + 16 = 144
  /*p29.ALES*/ next.LINE_144_d0n = not(lcd.LINE_144_d0);
  /*p21.POPU*/ next.VBLANK_d4.tock(lcd.NEW_LINE_d4a, VID_RESETn2, lcd.LINE_144_d0);
...
void LCD::tick2(const Clocks& clk,
                const Resets& rst,
                const LCD& lcd,
                const Video& vid,
                ...
                LCD& next)
{
  ...
  /*p21.MUDE*/ wire X_RSTn = nor(next.NEW_LINE_d0a, VID_RESET2);
  /*p21.SAXO*/ next.X0.tock( clk.TALU_xxxxEFGH, X_RSTn, !next.X0);
  /*p21.TYPO*/ next.X1.tock(!next.X0,           X_RSTn, !next.X1);
  /*p21.VYZO*/ next.X2.tock(!next.X1,           X_RSTn, !next.X2);
  /*p21.TELU*/ next.X3.tock(!next.X2,           X_RSTn, !next.X3);
  /*p21.SUDE*/ next.X4.tock(!next.X3,           X_RSTn, !next.X4);
  /*p21.TAHA*/ next.X5.tock(!next.X4,           X_RSTn, !next.X5);
  /*p21.TYRY*/ next.X6.tock(!next.X5,           X_RSTn, !next.X6);

  // 113 = 64 + 32 + 16 + 1, schematic is wrong
  /*p21.SANU*/ wire LINE_END = and(next.X6, next.X5, next.X4, next.X0);
  /*p21.RUTU*/ next.NEW_LINE_d0a.tock(clk.SONO_ABCDxxxx, VID_RESETn2, LINE_END);
  /*p21.NYPE*/ next.NEW_LINE_d4a.tock(clk.TALU_xxxxEFGH, VID_RESETn2, next.NEW_LINE_d0a);
  /*p21.PURE*/ next.NEW_LINE_d0n = not(next.NEW_LINE_d0a);
  ...
  /*p21.MUWY*/ next.Y0.tock( next.NEW_LINE_d0a, FRAME_RSTn, !next.Y0);
  /*p21.MYRO*/ next.Y1.tock(!next.Y0,           FRAME_RSTn, !next.Y1);
  /*p21.LEXA*/ next.Y2.tock(!next.Y1,           FRAME_RSTn, !next.Y2);
  /*p21.LYDO*/ next.Y3.tock(!next.Y2,           FRAME_RSTn, !next.Y3);
  /*p21.LOVU*/ next.Y4.tock(!next.Y3,           FRAME_RSTn, !next.Y4);
  /*p21.LEMA*/ next.Y5.tock(!next.Y4,           FRAME_RSTn, !next.Y5);
  /*p21.MATO*/ next.Y6.tock(!next.Y5,           FRAME_RSTn, !next.Y6);
  /*p21.LAFO*/ next.Y7.tock(!next.Y6,           FRAME_RSTn, !next.Y7);

  /*p21.XYVO*/ next.LINE_144_d0   = and(next.Y4, next.Y7);
  /*p21.NOKO*/ next.LINE_153_d0 = and(next.Y7, next.Y4, next.Y3, next.Y0);

  /*p21.MYTA*/ next.LINE_153_d4.tock(lcd.NEW_LINE_d4a, VID_RESETn2, lcd.LINE_153_d0);

  /*p21.POPU*/ next.VBLANK_d4.tock(next.NEW_LINE_d4a, VID_RESETn2, next.LINE_144_d0);
  /*p21.PARU*/ next.VBLANK_d4n = not(!next.VBLANK_d4);

  /*p01.ATAR*/ wire VID_RESET6  = not(rst.VID_RESETn);
  /*p01.AMYG*/ wire VID_RESET7  = not(rst.VID_RESETn);
  /*p01.ABEZ*/ wire VID_RESETn3 = not(VID_RESET6);
  /*p28.ABAF*/ wire VID_LINE_d4n  = not(next.VID_LINE_d4);

  /*p21.SELA*/ next.NEW_LINE_d0b = not(lcd.NEW_LINE_d0n);
  /*p29.ALES*/ next.LINE_144_d0n   = not(next.LINE_144_d0);
  /*p29.ABOV*/ next.VID_LINE_d0  = and(lcd.NEW_LINE_d0b, lcd.LINE_144_d0n);
  /*p29.CATU*/ next.VID_LINE_d4.tock(clk.XUPY_ABxxEFxx, VID_RESETn3, lcd.VID_LINE_d0);
  /*p28.ANEL*/ next.VID_LINE_d6.tock(clk.AWOH_xxCDxxGH, VID_RESETn3, lcd.VID_LINE_d4);
...
#if 0
  /*p28.BYHA*/ next.VID_LINE_TRIG_d4n = and(or(next.VID_LINE_d6, VID_LINE_d4n), VID_RESETn3);
  /*p28.ATEJ*/ next.VID_LINE_TRIG_d4a = not(next.VID_LINE_TRIG_d4n);
  /*p27.XAHY*/ next.VID_LINE_TRIG_d4o = not(next.VID_LINE_TRIG_d4a);

  /*p28.ABAK*/ next.VID_LINE_TRIG_d4b = or (next.VID_LINE_TRIG_d4a, VID_RESET7);
  /*p28.BYVA*/ next.VID_LINE_TRIG_d4p = not(next.VID_LINE_TRIG_d4b);
...
#if 0
  {
    ...
    /*p21.RYNO*/ wire CPGn = or(next.LINE_STROBE, next.NEW_LINE_d0a);
    /*p21.POGU*/ wire POGU = not(CPGn);
    next.PIN_CPG = POGU;
  }
...

  {
    ...
    /*p21.TOBA*/ wire TOBA = and(vid.CLKPIPE, next.CPEN_LATCH);
    /*p21.SEMU*/ wire CPn  = or(TOBA, vid.FINE_MATCH_TRIG);
    /*p21.RYPO*/ wire RYPO = not(CPn);
    next.PIN_CP = RYPO;
  }

  {
    ...
    /*p24.POFY*/ wire POFY = not(next.RUJU);
    /*p24.RUZE*/ wire RUZE = not(POFY);
    next.PIN_ST = RUZE;
  }
  ...
  {
    /*p24.KEDY*/ wire LCDC_ENn = not(LCDC_EN);
    /*p21.PURE*/ wire LINE_DONEn = not(next.NEW_LINE_d0a);
    /*p24.KASA*/ wire LINE_DONEb = not(LINE_DONEn);
    /*p24.UMOB*/ wire DIV_06 = not(DIV_06n);
    /*p24.KAHE*/ wire CPLn = amux2(LCDC_EN, LINE_DONEb, LCDC_ENn, DIV_06);
    /*p24.KYMO*/ wire KYMO = not(CPLn);
...

  {
    ...
    /*p01.LYHA*/ wire VID_RESET2  = not(rst.VID_RESETn);
    /*p01.LYFE*/ wire VID_RESETn2 = not(VID_RESET2);
    /*p24.LOFU*/ wire CLK_LINE_EVEN = not(next.NEW_LINE_d0a);
    /*p24.LUCA*/ next.LINE_EVEN.tock(CLK_LINE_EVEN, VID_RESETn2, !next.LINE_EVEN);
    /*p21.NAPO*/ next.FRAME_EVEN.tock(next.VBLANK_d4, VID_RESETn2, !next.FRAME_EVEN);

    /*p24.MAGU*/ wire MAGU = xor(next.FRAME_EVEN, next.LINE_EVEN);
    /*p24.MECO*/ wire MECO = not(MAGU);
    /*p24.KEBO*/ wire KEBO = not(MECO);
    /*p24.USEC*/ wire USEC = not(DIV_07n);
    /*p24.KUPA*/ wire FRn  = amux2(LCDC_EN, KEBO, LCDC_ENn, USEC);
...

  {
    ...
    /*p01.LYHA*/ wire VID_RESET2  = not(rst.VID_RESETn);
    /*p01.LYFE*/ wire VID_RESETn2 = not(VID_RESET2);
    /*p24.NERU*/ wire LINE_000n = nor(next.Y0, next.Y1, next.Y2, next.Y3, next.Y4, next.Y5, next.Y6, next.Y7);
    /*p24.MEDA*/ next.VSYNC_OUTn.tock(next.NEW_LINE_d4a, VID_RESETn2, LINE_000n);
    /*p24.MURE*/ wire MURE = not(next.VSYNC_OUTn);
    next.PIN_S = MURE;
  }
#endif
}
