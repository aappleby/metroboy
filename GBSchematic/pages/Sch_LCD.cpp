...
void LCD::tick_slow(const ClockSignals& clk,
                    ...
                    LCD& next)
{
  /*p01.LYHA*/ wire VID_RESET2  = not(rst.sig.VID_RESETn);
  /*p01.LYFE*/ wire VID_RESETn2 = not(VID_RESET2);
  /*p01.ATAR*/ wire VID_RESET6  = not(rst.sig.VID_RESETn);
  /*p01.AMYG*/ wire VID_RESET7  = not(rst.sig.VID_RESETn);
  ...
  {
    /*p01.TOFU*/ wire VID_RESET3  = not(rst.sig.VID_RESETn);
