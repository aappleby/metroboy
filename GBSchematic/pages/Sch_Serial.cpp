...
void Serial_tick(const Bus& bus,
  ...
  /*p06.CABY*/ wire XFER_RESET = and(prev.SER_CNT3n, rst.sig.SYS_RESETn);
  /*p06.ETAF*/ next.XFER_START.tock(FF02_WRn, XFER_RESET,    bus.D7);
  /*p06.CULY*/ next.XFER_DIR  .tock(FF02_WRn, rst.sig.SYS_RESETn, bus.D0);
  ...
  /*p06.CARO*/ wire SER_RST  = and(FF02_WRn, rst.sig.SYS_RESETn);
  ...
  /*p06.COHY*/ wire SER_DATA0_RSTn = or(and(FF01_WRn, bus.D0), rst.sig.SYS_RESETn);
  /*p06.DUMO*/ wire SER_DATA1_RSTn = or(and(FF01_WRn, bus.D1), rst.sig.SYS_RESETn);
  /*p06.DYBO*/ wire SER_DATA2_RSTn = or(and(FF01_WRn, bus.D2), rst.sig.SYS_RESETn);
  /*p06.DAJU*/ wire SER_DATA3_RSTn = or(and(FF01_WRn, bus.D3), rst.sig.SYS_RESETn);
  /*p06.DYLY*/ wire SER_DATA4_RSTn = or(and(FF01_WRn, bus.D4), rst.sig.SYS_RESETn);
  /*p06.EHUJ*/ wire SER_DATA5_RSTn = or(and(FF01_WRn, bus.D5), rst.sig.SYS_RESETn);
  /*p06.EFAK*/ wire SER_DATA6_RSTn = or(and(FF01_WRn, bus.D6), rst.sig.SYS_RESETn);
  /*p06.EGUV*/ wire SER_DATA7_RSTn = or(and(FF01_WRn, bus.D7), rst.sig.SYS_RESETn);
  ...
  /*p06.ELYS*/ next.SER_OUT   = tock_pos(SER_CLKn, SER_CLKn, rst.sig.SYS_RESETn, prev.SER_OUT, prev.SER_DATA7);
