...
void Serial_tick(const BusControl& bus,
  ...
  /*p06.UWAM*/ wire FF02_WRn = nand(bus.CPU_WR, dec.ADDR_FF00_FF03, bus.A01, dec.TOVY_A00n);
  /*p06.CABY*/ wire XFER_RESET = and(prev.SER_CNT3n, rst.SYS_RESETn);
  /*p06.ETAF*/ next.XFER_START.tock(FF02_WRn, XFER_RESET,    bus.D7);
  /*p06.CULY*/ next.XFER_DIR  .tock(FF02_WRn, rst.SYS_RESETn, bus.D0);
  ...
  /*p06.CARO*/ wire SER_RST  = and(FF02_WRn, rst.SYS_RESETn);
  ...
  /*p06.URYS*/ wire FF01_WRn = nand(bus.CPU_WR, dec.ADDR_FF00_FF03, bus.A00, dec.TOLA_A01n);
  ...
  /*p06.COHY*/ wire SER_DATA0_RSTn = or(and(FF01_WRn, bus.D0), rst.SYS_RESETn);
  /*p06.DUMO*/ wire SER_DATA1_RSTn = or(and(FF01_WRn, bus.D1), rst.SYS_RESETn);
  /*p06.DYBO*/ wire SER_DATA2_RSTn = or(and(FF01_WRn, bus.D2), rst.SYS_RESETn);
  /*p06.DAJU*/ wire SER_DATA3_RSTn = or(and(FF01_WRn, bus.D3), rst.SYS_RESETn);
  /*p06.DYLY*/ wire SER_DATA4_RSTn = or(and(FF01_WRn, bus.D4), rst.SYS_RESETn);
  /*p06.EHUJ*/ wire SER_DATA5_RSTn = or(and(FF01_WRn, bus.D5), rst.SYS_RESETn);
  /*p06.EFAK*/ wire SER_DATA6_RSTn = or(and(FF01_WRn, bus.D6), rst.SYS_RESETn);
  /*p06.EGUV*/ wire SER_DATA7_RSTn = or(and(FF01_WRn, bus.D7), rst.SYS_RESETn);
  ...
  /*p06.CUBA*/ next.SER_DATA0.tock(SER_CLK3, SER_DATA0_SETn, SER_DATA0_RSTn, SIN_Cn);
  /*p06.DEGU*/ next.SER_DATA1.tock(SER_CLK3, SER_DATA1_SETn, SER_DATA1_RSTn, prev.SER_DATA0);
  /*p06.DYRA*/ next.SER_DATA2.tock(SER_CLK3, SER_DATA2_SETn, SER_DATA2_RSTn, prev.SER_DATA1);
  /*p06.DOJO*/ next.SER_DATA3.tock(SER_CLK3, SER_DATA3_SETn, SER_DATA3_RSTn, prev.SER_DATA2);
  /*p06.DOVU*/ next.SER_DATA4.tock(SER_CLK2, SER_DATA4_SETn, SER_DATA4_RSTn, prev.SER_DATA3);
  /*p06.EJAB*/ next.SER_DATA5.tock(SER_CLK2, SER_DATA5_SETn, SER_DATA5_RSTn, prev.SER_DATA4);
  /*p06.EROD*/ next.SER_DATA6.tock(SER_CLK2, SER_DATA6_SETn, SER_DATA6_RSTn, prev.SER_DATA5);
  /*p06.EDER*/ next.SER_DATA7.tock(SER_CLK2, SER_DATA7_SETn, SER_DATA7_RSTn, prev.SER_DATA6);
  /*p06.ELYS*/ next.SER_OUT   = tock_pos(SER_CLKn, SER_CLKn, rst.SYS_RESETn, prev.SER_OUT, prev.SER_DATA7);
  ...
  /*p06.UFEG*/ wire FF01_RD = and(bus.CPU_RD, dec.ADDR_FF00_FF03, bus.A00, dec.TOLA_A01n);
  ...
  /*p06.UCOM*/ wire FF02_RD = and (bus.CPU_RD, dec.ADDR_FF00_FF03, bus.A01, dec.TOVY_A00n);
