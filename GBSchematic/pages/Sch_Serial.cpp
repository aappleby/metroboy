...
void Serial_tick(const BusSignals& ctl,
  ...
  /*p06.ETAF*/ next.XFER_START.tock(FF02_WRn, XFER_RESET,         bus.D0());
  /*p06.CULY*/ next.XFER_DIR  .tock(FF02_WRn, rst_sig.SYS_RESETn, bus.D1());
  ...
  /*p06.COHY*/ wire SER_DATA0_RSTn = or(and(FF01_WRn, bus.D0()), rst_sig.SYS_RESETn);
  /*p06.DUMO*/ wire SER_DATA1_RSTn = or(and(FF01_WRn, bus.D1()), rst_sig.SYS_RESETn);
  /*p06.DYBO*/ wire SER_DATA2_RSTn = or(and(FF01_WRn, bus.D2()), rst_sig.SYS_RESETn);
  /*p06.DAJU*/ wire SER_DATA3_RSTn = or(and(FF01_WRn, bus.D3()), rst_sig.SYS_RESETn);
  /*p06.DYLY*/ wire SER_DATA4_RSTn = or(and(FF01_WRn, bus.D4()), rst_sig.SYS_RESETn);
  /*p06.EHUJ*/ wire SER_DATA5_RSTn = or(and(FF01_WRn, bus.D5()), rst_sig.SYS_RESETn);
  /*p06.EFAK*/ wire SER_DATA6_RSTn = or(and(FF01_WRn, bus.D6()), rst_sig.SYS_RESETn);
  /*p06.EGUV*/ wire SER_DATA7_RSTn = or(and(FF01_WRn, bus.D7()), rst_sig.SYS_RESETn);
  ...
  /*p06.ELYS*/ next.SER_OUT   = tock_pos(SER_CLKn, SER_CLKn, rst_sig.SYS_RESETn, prev.SER_OUT, prev.SER_DATA7);
  ...
  if (FF01_RD) bus.set_data(
    /*p06.CUGY*/ prev.SER_DATA0,
    /*p06.DUDE*/ prev.SER_DATA1,
    /*p06.DETU*/ prev.SER_DATA2,
    /*p06.DASO*/ prev.SER_DATA3,
    /*p06.DAME*/ prev.SER_DATA4,
    /*p06.EVOK*/ prev.SER_DATA5,
    /*p06.EFAB*/ prev.SER_DATA6,
    /*p06.ETAK*/ prev.SER_DATA7
  );

  /*p06.UCOM*/ wire FF02_RD = and (ctl.TEDO_CPURD, dec.ADDR_FF00_FF03, bus.A01(), dec.TOVY_A00n);

  if (FF02_RD) bus.set_data(
    /*p06.CORE*/ prev.XFER_DIR,
    /*p06.ELUV*/ prev.XFER_START
  );
}
