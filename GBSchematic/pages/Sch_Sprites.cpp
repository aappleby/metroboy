...
void Sprites_tick(const Pins& pins,
...

  {
    ...
    {
      /*p29.TOMA*/ wire SEQ_CLK = nand(clocks.sig.LAPE_AxCxExGx, SEQ_5n);
      /*p27.SECA*/ wire SPR_SEQ_RST = nor(vid.SPRITE_FETCH_TRIG, rst.VID_RESET5, lcd.VID_LINE_TRIG_d4n);
...

    {
      ...
      /*p29.TYFO*/ next.SEQ_B0d.tock    (clocks.sig.LAPE_AxCxExGx, VYPO, next.SPR_SEQ0);
      /*p29.TOBU*/ next.SEQ_xx23xx .tock(clocks.sig.TAVA_xBxDxFxH, vid.RENDERING_LATCH, spr.SPR_SEQ1);    // note input is seq 1 not 2
      /*p29.VONU*/ next.SEQ_xxx34xn.tock(clocks.sig.TAVA_xBxDxFxH, vid.RENDERING_LATCH, spr.SEQ_xx23xx);
      /*p29.SEBA*/ next.SEQ_xxxx45n.tock(clocks.sig.LAPE_AxCxExGx, vid.RENDERING_LATCH, spr.SEQ_xxx34xn); // is this clock wrong?
    }
...

  {
    ...
    /*p29.CARE*/ wire STORE_ENn = or(clocks.sig.XOCE_AxxDExxH, CEHA, SPR_MATCH_Y);
    /*p29.DYTY*/ next.STORE_EN = not(STORE_ENn);


    /*p28.WEFE*/ wire WEFE = not(pins.P10_B);
    /*p30.CYKE*/ wire CYKE = not(clocks.sig.XUPY_ABxxEFxx);
    ...
    /*p28.ASEN*/ wire ASEN = or(rst.VID_RESET6, spr.SCAN_DONE_d0_TRIG);
    /*p28.BESU*/ wire BESU = or(lcd.VID_LINE_d4, ASEN);
    /*p29.CENO*/ next.STORE_SPRITE_IDXn.tock(clocks.sig.XUPY_ABxxEFxx, rst.VID_RESETn3, BESU);
...
void Sprites_tickScanner(const Clocks& clocks,
...

  {
    ...
    /*p28.GAVA*/ wire SCAN_CLK = or(spr.SCAN_DONE_d0, clocks.sig.XUPY_ABxxEFxx);
    ...
    /*p29.BYBA*/ next.SCAN_DONE_d4.tock(clocks.sig.XUPY_ABxxEFxx, SCAN_RSTo, spr.SCAN_DONE_d0);
    /*p29.DOBA*/ next.SCAN_DONE_d5.tock(clocks.sig.ALET_xBxDxFxH, SCAN_RSTo, spr.SCAN_DONE_d4);
