...
void P21_VideoControl_tick(const Bus& bus,
...

  {
    ...
    /*p27.NUNU*/ next.WIN_MATCH_SYNC2.tock(clk.MEHE_AxCxExGx, rst_sig.VID_RESETn, vid.WIN_MATCH_SYNC1);
    ...
    /*p27.NOPA*/ next.WIN_MODE_SYNC.tock(clk.ALET_xBxDxFxH, rst_sig.VID_RESETn, vid.WIN_MODE_LATCH);
    ...
    /*p27.SOVY*/ next.WIN_MODE_SYNC2.tock(clk.ALET_xBxDxFxH, rst_sig.VID_RESETn, vid.WIN_MODE_LATCH2);
  }
...

  {
    ...
    /*p21.ROPO*/ next.LYC_MATCH.tock(clk.TALU_xxxxEFGH, rst_sig.WESY_RESET, LY_MATCHa);
  }
...

  {
    ...
    /*p27.SARY*/ next.WY_MATCH_SYNC.tock(clk.TALU_xxxxEFGH, rst_sig.VID_RESETn, WY_MATCH);
  }
