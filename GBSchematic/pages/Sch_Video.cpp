...
void P21_VideoControl_tick(const Bus& bus,
...

  {
    // We stop the pipe as soon as there's a store match or we switch to window mode
    {
      ...
      /*p24.VYBO*/ wire VYBO = nor(sst.STORE_MATCH, vid.RENDER_DONE, clk.MYVO_AxCxExGx);
    ...
    // But we don't enter sprite mode until background sequencer hits BG_SEQ5
    {
      ...
      /*p27.SOBU*/ next.SPRITE_FETCH_SYNC1.tock(clk.TAVA_xBxDxFxH, VYPO, SPRITE_FETCH);
      /*p27.SUDA*/ next.SPRITE_FETCH_SYNC2.tock(clk.LAPE_AxCxExGx, VYPO,  vid.SPRITE_FETCH_SYNC1);
      /*p27.RYCE*/ next.SPRITE_FETCH_TRIG = and(vid.SPRITE_FETCH_SYNC1, !vid.SPRITE_FETCH_SYNC2);

      /*p27.SECA*/ wire SPRITE_FETCH_BEGINn = nor(vid.SPRITE_FETCH_TRIG, rst_reg.sig.VID_RESET5, lcd.VID_LINE_TRIG_d4n);
  ...
  {
    /*p21.WEGO*/ wire WEGO = or(rst_reg.sig.VID_RESET3, vid.RENDER_DONE_SYNC);
    ...
    /*p21.VOGA*/ next.RENDER_DONE_SYNC.tock(clk.ALET_xBxDxFxH, vid.X_RST, vid.RENDER_DONE);
  }
...

  {
    ...
    /*p27.NYZE*/ next.FINE_MATCH_SYNC2.tock(clk.MOXE_AxCxExGx, vid.RENDERING_LATCH, vid.FINE_MATCH_SYNC1);
...

  {
    ...
    /*p27.RENE*/ next.WIN_MATCH_ONSCREEN_SYNC2.tock(clk.ALET_xBxDxFxH, vid.RENDERING_LATCH, vid.WIN_MATCH_ONSCREEN_SYNC1);
    /*p27.SEKO*/ next.WIN_TRIGGER = nor(vid.WIN_MATCH_ONSCREEN_SYNC2, !vid.WIN_MATCH_ONSCREEN_SYNC1);

    /*p27.PYCO*/ next.WIN_MATCH_SYNC1.tock(vid.ROCO_4M,          rst_reg.sig.VID_RESETn, vid.WIN_MATCH);
    /*p27.NUNU*/ next.WIN_MATCH_SYNC2.tock(clk.MEHE_AxCxExGx, rst_reg.sig.VID_RESETn, vid.WIN_MATCH_SYNC1);

    /*p27.XOFO*/ wire LINE_RST = nand(regs.LCDC_WINEN, lcd.VID_LINE_TRIG_d4o, rst_reg.sig.VID_RESETn);
    ...
    /*p27.NOPA*/ next.WIN_MODE_SYNC.tock(clk.ALET_xBxDxFxH, rst_reg.sig.VID_RESETn, vid.WIN_MODE_LATCH);
    ...
    if (rst_reg.sig.VID_RESET4 || vid.BG_SEQ_7) {
      next.PUKU = 1;
    ...
    /*p27.SOVY*/ next.WIN_MODE_SYNC2.tock(clk.ALET_xBxDxFxH, rst_reg.sig.VID_RESETn, vid.WIN_MODE_LATCH2);
  }
...

  {
    ...
    /*p27.LEBO*/ wire BG_SEQ_CLK = nand(clk.ALET_xBxDxFxH, BG_SEQ_5n);
    ...
    /*p24.NYKA*/ next.BG_SEQ_6.tock(clk.ALET_xBxDxFxH, RENDERING_AND_NOT_WIN_TRIG, vid.BG_SEQ_5);
    /*p24.PORY*/ next.BG_SEQ_7.tock(clk.MYVO_AxCxExGx, RENDERING_AND_NOT_WIN_TRIG, vid.BG_SEQ_6);

    /*p27.LYZU*/ next.BG_SEQ_x1x3x5x7_DELAY.tock(clk.ALET_xBxDxFxH, vid.RENDERING_LATCH, vid.BG_SEQ_x1x3x5x7);

    /*p27.LOVY*/ next.BG_SEQ5_SYNC.tock(clk.MYVO_AxCxExGx, BG_SEQ_RSTn, vid.BG_SEQ_5);
  ...
  {
    /*p24.PYGO*/ next.TILE_DONE.tock(clk.ALET_xBxDxFxH, vid.RENDERING_LATCH, vid.BG_SEQ_7);
...

  {
    ...
    /*p21.ROPO*/ next.LYC_MATCH.tock(clk.TALU_xxxxEFGH, rst_reg.sig.WESY_RESET, LY_MATCHa);
  }
...

  {
    ...
    /*p21.ROXE*/ next.INT_HBL_EN.tock(CLK_STAT, rst_reg.sig.WESY_RESET, bus.D3);
    /*p21.RUFO*/ next.INT_VBL_EN.tock(CLK_STAT, rst_reg.sig.WESY_RESET, bus.D4);
    /*p21.REFE*/ next.INT_OAM_EN.tock(CLK_STAT, rst_reg.sig.WESY_RESET, bus.D5);
    /*p21.RUGU*/ next.INT_LYC_EN.tock(CLK_STAT, rst_reg.sig.WESY_RESET, bus.D6);
    ...
    /*p21.PAGO*/ wire STAT_LYC_MATCH1 = nor(rst_reg.sig.WESY_RESET, FF41_WRn);  // schematic wrong, this is NOR
...

  {
    ...
    /*p27.SARY*/ next.WY_MATCH_SYNC.tock(clk.TALU_xxxxEFGH, rst_reg.sig.VID_RESETn, WY_MATCH);
  }
...

  {
    ...
    /*p27.REPU*/ wire IN_FRAME_Y  = nor(lcd.VBLANK_d4b, rst_reg.sig.VID_RESET4);   // schematic wrong, this is NOR
...

  {
    ...
    /*p27.XOFO*/ wire X_RST = nand(regs.LCDC_WINEN, lcd.VID_LINE_TRIG_d4o, rst_reg.sig.VID_RESETn);
    /*p27.REPU*/ wire Y_RST  = nor(lcd.VBLANK_d4b, rst_reg.sig.VID_RESET4);   // schematic wrong, this is NOR
  ...
  {
    /*p21.TADY*/ next.X_RST = nor(lcd.VID_LINE_TRIG_d4n, rst_reg.sig.VID_RESET3);
