...
void P01_ClocksReset_tick(const Gameboy& a, const Gameboy& b, Gameboy& c) {
  ...
  /*p01.UPYF*/ c.p01.UPYF        = or(b.chip.RST, b.p01.CLK_BAD1);
  /*p01.TUBO*/ c.p01.TUBO        = or(b.p01.CPUCLK_REQn, b.p01.UPYF);
  /*p01.UNUT*/ c.p01.UNUT        = and(b.p01.TUBO, b.p01.DIV_15);
  /*p01.TABA*/ c.p01.CPU_RESET   = or(b.p07.MODE_DBG2, b.p07.MODE_DBG1, b.p01.UNUT);
  /*p01.ALYP*/ c.p01.CPU_RESETn  = not(b.p01.CPU_RESET);
  ...
  /*p01.AFAR*/ c.p01.AFAR        = nor(b.p01.CPU_RESETn, b.chip.RST);
  /*p01.ASOL*/ c.p01.ASOL        = or (b.p01.AFAR, b.chip.RST);
  /*p01.AFER*/ c.p01.RESET_REG   = tock_pos(a.p01.RESET_CLK, b.p01.RESET_CLK, b.p07.MODE_PROD, b.p01.RESET_REG, b.p01.ASOL);
  /*p01.AVOR*/ c.p01.AVOR        = or(b.p01.RESET_REG, b.p01.ASOL);

  /*p01.ALUR*/ c.p01.SYS_RESETn1 = not(b.p01.AVOR);

  /*p01.DULA*/ c.p01.SYS_RESET1  = not(b.p01.SYS_RESETn1);
  /*P09.HAPO*/ c.p01.SYS_RESET2  = not(b.p01.SYS_RESETn1);

  /*p01.CUNU*/ c.p01.SYS_RESETn2 = not(b.p01.SYS_RESET1);
  /*P09.GUFO*/ c.p01.SYS_RESETn3 = not(b.p01.SYS_RESET2);

  /*p01.XORE*/ c.p01.SYS_RESET3  = not(b.p01.SYS_RESETn2);
  /*p01.XEBE*/ c.p01.SYS_RESETn4 = not(b.p01.SYS_RESET3);
  /*p01.WALU*/ c.p01.SYS_RESETn5 = not(b.p01.SYS_RESET3);
  /*p01.WESY*/ c.p01.SYS_RESETn6 = not(b.p01.SYS_RESET3);
  /*p01.XARE*/ c.p01.SYS_RESETn7 = not(b.p01.SYS_RESET3);

  //----------
  // VID reset tree

  /*p01.XODO*/ c.p01.VID_RESET1  = and(b.p01.SYS_RESETn4, b.p23.LCD_ON); // polarity?
  /*p01.XAPO*/ c.p01.VID_RESETn1 = not(b.p01.VID_RESET1);

  /*p01.LYHA*/ c.p01.VID_RESET2  = not(b.p01.VID_RESETn1);
  /*p01.TOFU*/ c.p01.VID_RESET3  = not(b.p01.VID_RESETn1);
  /*p01.PYRY*/ c.p01.VID_RESET4  = not(b.p01.VID_RESETn1);
  /*p01.ROSY*/ c.p01.VID_RESET5  = not(b.p01.VID_RESETn1);
  /*p01.ATAR*/ c.p01.VID_RESET6  = not(b.p01.VID_RESETn1);
  /*p01.AMYG*/ c.p01.VID_RESET7  = not(b.p01.VID_RESETn1);

  /*p01.LYFE*/ c.p01.VID_RESETn2 = not(b.p01.VID_RESET2);
  /*p01.ABEZ*/ c.p01.VID_RESETn3 = not(b.p01.VID_RESET6);
  ...
  /*p07.UBAL*/ c.p07.CPU_WR_MUX = mux2(b.chip.WR_C, b.p01.CPU_WR_SYNC, b.p07.MODE_DBG2);
  /*p07.UJYV*/ c.p07.CPU_RD_MUX = mux2(b.chip.RD_C, b.cpu.CPU_RAW_RD,  b.p07.MODE_DBG2);
  ...
  /*p01.BUVU*/ c.p01.BUVU = and(b.p01.CPUCLK_REQ, b.p01.BALY);
  /*p01.BYXO*/ c.p01.BYXO = not(b.p01.BUVU);
  /*p01.BEDO*/ c.p01.CPUCLK_xxxxxFGH2 = not(b.p01.BYXO);
  /*p01.BOWA*/ c.p01.CPUCLK_ABCDExxx2 = not(b.p01.CPUCLK_xxxxxFGH2);

  //----------
  // Cartridge clock

  /*p01.UVYT*/ c.p01.CPUCLK_xxxxEFGH8 = not(b.p01.CPUCLK_ABCDxxxx3);
  /*p01.DOVA*/ c.p01.CPUCLK_xxxxEFGH9 = not(b.p01.CPUCLK_ABCDxxxx3);
  /*p04.MOPA*/ c.p04.CPUCLK_ABCDxxxx9 = not(b.p01.CPUCLK_xxxxEFGH8);
  ...
  /*p01.UKUP*/ c.p01.DIV_00 = tock_pos(a.p01.DIV_CLK,  b.p01.DIV_CLK,  b.p01.DIV_RSTn, b.p01.DIV_00, !b.p01.DIV_00);
  /*p01.UFOR*/ c.p01.DIV_01 = tock_pos(!a.p01.DIV_00, !b.p01.DIV_00, b.p01.DIV_RSTn, b.p01.DIV_01, !b.p01.DIV_01);
  /*p01.UNER*/ c.p01.DIV_02 = tock_pos(!a.p01.DIV_01, !b.p01.DIV_01, b.p01.DIV_RSTn, b.p01.DIV_02, !b.p01.DIV_02);
  /*p01.TERO*/ c.p01.DIV_03 = tock_pos(!a.p01.DIV_02, !b.p01.DIV_02, b.p01.DIV_RSTn, b.p01.DIV_03, !b.p01.DIV_03);
  /*p01.UNYK*/ c.p01.DIV_04 = tock_pos(!a.p01.DIV_03, !b.p01.DIV_03, b.p01.DIV_RSTn, b.p01.DIV_04, !b.p01.DIV_04);
  /*p01.TAMA*/ c.p01.DIV_05 = tock_pos(!a.p01.DIV_04, !b.p01.DIV_04, b.p01.DIV_RSTn, b.p01.DIV_05, !b.p01.DIV_05);
  /*p01.UGOT*/ c.p01.DIV_06 = tock_pos( a.p01.ULUR,     b.p01.ULUR,  b.p01.DIV_RSTn, b.p01.DIV_06, !b.p01.DIV_06);
  /*p01.TULU*/ c.p01.DIV_07 = tock_pos(!a.p01.DIV_06, !b.p01.DIV_06, b.p01.DIV_RSTn, b.p01.DIV_07, !b.p01.DIV_07);
  /*p01.TUGO*/ c.p01.DIV_08 = tock_pos(!a.p01.DIV_07, !b.p01.DIV_07, b.p01.DIV_RSTn, b.p01.DIV_08, !b.p01.DIV_08);
  /*p01.TOFE*/ c.p01.DIV_09 = tock_pos(!a.p01.DIV_08, !b.p01.DIV_08, b.p01.DIV_RSTn, b.p01.DIV_09, !b.p01.DIV_09);
  /*p01.TERU*/ c.p01.DIV_10 = tock_pos(!a.p01.DIV_09, !b.p01.DIV_09, b.p01.DIV_RSTn, b.p01.DIV_10, !b.p01.DIV_10);
  /*p01.SOLA*/ c.p01.DIV_11 = tock_pos(!a.p01.DIV_10, !b.p01.DIV_10, b.p01.DIV_RSTn, b.p01.DIV_11, !b.p01.DIV_11);
  /*p01.SUBU*/ c.p01.DIV_12 = tock_pos(!a.p01.DIV_11, !b.p01.DIV_11, b.p01.DIV_RSTn, b.p01.DIV_12, !b.p01.DIV_12);
  /*p01.TEKA*/ c.p01.DIV_13 = tock_pos(!a.p01.DIV_12, !b.p01.DIV_12, b.p01.DIV_RSTn, b.p01.DIV_13, !b.p01.DIV_13);
  /*p01.UKET*/ c.p01.DIV_14 = tock_pos(!a.p01.DIV_13, !b.p01.DIV_13, b.p01.DIV_RSTn, b.p01.DIV_14, !b.p01.DIV_14);
  /*p01.UPOF*/ c.p01.DIV_15 = tock_pos(!a.p01.DIV_14, !b.p01.DIV_14, b.p01.DIV_RSTn, b.p01.DIV_15, !b.p01.DIV_15);

  /*p01.UMEK*/ c.p01.DIV_06n = not(b.p01.DIV_06);
  /*p01.UREK*/ c.p01.DIV_07n = not(b.p01.DIV_07);
  /*p01.UTOK*/ c.p01.DIV_08n = not(b.p01.DIV_08);
  /*p01.SAPY*/ c.p01.DIV_09n = not(b.p01.DIV_09);
  /*p01.UMER*/ c.p01.DIV_10n = not(b.p01.DIV_10);
  /*p01.RAVE*/ c.p01.DIV_11n = not(b.p01.DIV_11);
  /*p01.RYSO*/ c.p01.DIV_12n = not(b.p01.DIV_12);
  /*p01.UDOR*/ c.p01.DIV_13n = not(b.p01.DIV_13);

  /*p01.TAWU*/ if (b.p01.DIV_RD) c.D0 = not(b.p01.DIV_06n);
  /*p01.TAKU*/ if (b.p01.DIV_RD) c.D1 = not(b.p01.DIV_07n);
  /*p01.TEMU*/ if (b.p01.DIV_RD) c.D2 = not(b.p01.DIV_08n);
  /*p01.TUSE*/ if (b.p01.DIV_RD) c.D3 = not(b.p01.DIV_09n);
  /*p01.UPUG*/ if (b.p01.DIV_RD) c.D4 = not(b.p01.DIV_10n);
  /*p01.SEPU*/ if (b.p01.DIV_RD) c.D5 = not(b.p01.DIV_11n);
  /*p01.SAWA*/ if (b.p01.DIV_RD) c.D6 = not(b.p01.DIV_12n);
  /*p01.TATU*/ if (b.p01.DIV_RD) c.D7 = not(b.p01.DIV_13n);
