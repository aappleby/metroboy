...
void System_tick(const Gameboy& a, const Gameboy& b, Gameboy& c) {
  ...
  /*p01.AVOR*/ pc.SYS_RESET4  = or(pb.RESET_REG, pb.RESET_IN);
  /*p01.ALUR*/ pc.SYS_RESETn1 = not(pb.SYS_RESET4);
  ...
  /*p01.BALY*/ pc.DIV_CLKn  = not(pb.BYJU);
  /*p01.BYJU*/   pc.BYJU      = nor(pb.CLK_xxxxxFGH1, pb.CLK_BAD2);
  /*p01.BELE*/     pc.CLK_xxxxxFGH1 = not(pb.CLK_ABCDExxx3);
  /*p01.BUTO*/       pc.CLK_ABCDExxx3 = nand(pb.CLK_AxxxxFGH1, pb.CLK_xxxxEFGH1, pb.CPUCLK_xxxxEFGH5);   // The CPUCLK_REQ cancels out here, CLK_ABCDExxx3 is not affected by it.
  ...
  /*p10.ATOZ*/ pc.FF00_WRn = nand(pb.CPU_WR, pb.ADDR_111111110xx00000, pb.ADDR_xxxxxxxxx0xxxxxx, pb.ADDR_xxxxxxxxxx0xxxxx);
  /*p10.ACAT*/ pc.FF00_RD  =  and(pb.CPU_RD, pb.ADDR_111111110xx00000, pb.ADDR_xxxxxxxxx0xxxxxx, pb.ADDR_xxxxxxxxxx0xxxxx);
  ...
  {
    /*p05.AXYN*/ wire AXYN = not(pb.CPU_CLK1n);
    /*p05.ADYR*/ wire ADYR = not(AXYN);
    /*p05.APYS*/ wire APYS = nor(pb.MODE_DBG2, ADYR);
    /*p05.AFOP*/ wire AFOP = not(APYS);
...

  {
    ...
    /*p07.ZERY*/ c.BOOT_CS = not(/*p07.ZADO*/ nand(BOOT_RD, pb.ADDR_00XX2));
  ...
  /*p07.LECO*/ pc.LECO = nor(pb.CPU_CLK1n, pb.MODE_DBG2);
  ...
  */
  ...
  /*p25.RUXA*/ pc.D0_A = nand(b.D0, pb.DBUS_OUT);
  /*p25.RUJA*/ pc.D1_A = nand(b.D1, pb.DBUS_OUT);
  /*p25.RABY*/ pc.D2_A = nand(b.D2, pb.DBUS_OUT);
  /*p25.RERA*/ pc.D3_A = nand(b.D3, pb.DBUS_OUT);
  /*p25.RORY*/ pc.D4_A = nand(b.D4, pb.DBUS_OUT);
  /*p25.RYVO*/ pc.D5_A = nand(b.D5, pb.DBUS_OUT);
  /*p25.RAFY*/ pc.D6_A = nand(b.D6, pb.DBUS_OUT);
  /*p25.RAVU*/ pc.D7_A = nand(b.D7, pb.DBUS_OUT);
  ...
  /*p08.RUNE*/ pc.D0_D = nor (b.D0, pb.DBUS_OUTn);
  /*p08.RYPU*/ pc.D1_D = nor (b.D1, pb.DBUS_OUTn);
  /*p08.SULY*/ pc.D2_D = nor (b.D2, pb.DBUS_OUTn);
  /*p08.SEZE*/ pc.D3_D = nor (b.D3, pb.DBUS_OUTn);
  /*p08.RESY*/ pc.D4_D = nor (b.D4, pb.DBUS_OUTn);
  /*p08.TAMU*/ pc.D5_D = nor (b.D5, pb.DBUS_OUTn);
  /*p08.ROGY*/ pc.D6_D = nor (b.D6, pb.DBUS_OUTn);
  /*p08.RYDA*/ pc.D7_D = nor (b.D7, pb.DBUS_OUTn);
