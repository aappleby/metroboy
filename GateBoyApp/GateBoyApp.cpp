...
void GateBoyApp::app_render_frame(Viewport view) {
  ...
  */
  ...
  d.dump_bitp("TOXE_SFETCH_S0      ", gb->sprite_fetcher.TOXE_SFETCH_S0p_xxx     .state);
  d.dump_bitp("TULY_SFETCH_S1      ", gb->sprite_fetcher.TULY_SFETCH_S1p_odd     .state);
  d.dump_bitp("TESE_SFETCH_S2      ", gb->sprite_fetcher.TESE_SFETCH_S2p_xxx     .state);
  ...
  d("SCAN INDEX        : %02d\n", pack_u8p(6, &gb->sprite_scanner.YFEL_SCAN0_evn));
  d("\n");
  ...
  d("\n");
  d.dump_bitp("YFEL_SCAN0       ", gb->sprite_scanner.YFEL_SCAN0_evn.state);
  d.dump_bitp("WEWY_SCAN1       ", gb->sprite_scanner.WEWY_SCAN1_evn.state);
  d.dump_bitp("GOSO_SCAN2       ", gb->sprite_scanner.GOSO_SCAN2_evn.state);
  d.dump_bitp("ELYN_SCAN3       ", gb->sprite_scanner.ELYN_SCAN3_evn.state);
  d.dump_bitp("FAHA_SCAN4       ", gb->sprite_scanner.FAHA_SCAN4_evn.state);
  d.dump_bitp("FONY_SCAN5       ", gb->sprite_scanner.FONY_SCAN5_evn.state);
  d("\n");
