...
void GateBoy::run_reset_sequence(bool fastboot) {
  ...
  CHECK_N(clk_reg.AFUR_xxxxEFGHp.qp_chain());
  CHECK_P(clk_reg.ALEF_AxxxxFGHp.qp_chain());
  CHECK_P(clk_reg.APUK_ABxxxxGHp.qp_chain());
  CHECK_P(clk_reg.ADYK_ABCxxxxHp.qp_chain());
...
struct GateBoyOffsets {
  const int o_cpu_bus        = offsetof(GateBoy, BUS_CPU_A);
...
void GateBoy::next_phase() {
  ...
  if (DELTA_GH) {
    cpu_data_latch = pack_u8p(8, &BUS_CPU_D[0]);
  }
...
void GateBoy::tock_slow(int pass_index) {
  ...
  BUS_CPU_A[ 0].set((cpu_addr >>  0) & 1);
  BUS_CPU_A[ 1].set((cpu_addr >>  1) & 1);
  BUS_CPU_A[ 2].set((cpu_addr >>  2) & 1);
  BUS_CPU_A[ 3].set((cpu_addr >>  3) & 1);
  BUS_CPU_A[ 4].set((cpu_addr >>  4) & 1);
  BUS_CPU_A[ 5].set((cpu_addr >>  5) & 1);
  BUS_CPU_A[ 6].set((cpu_addr >>  6) & 1);
  BUS_CPU_A[ 7].set((cpu_addr >>  7) & 1);
  BUS_CPU_A[ 8].set((cpu_addr >>  8) & 1);
  BUS_CPU_A[ 9].set((cpu_addr >>  9) & 1);
  BUS_CPU_A[10].set((cpu_addr >> 10) & 1);
  BUS_CPU_A[11].set((cpu_addr >> 11) & 1);
  BUS_CPU_A[12].set((cpu_addr >> 12) & 1);
  BUS_CPU_A[13].set((cpu_addr >> 13) & 1);
  BUS_CPU_A[14].set((cpu_addr >> 14) & 1);
  BUS_CPU_A[15].set((cpu_addr >> 15) & 1);

  BUS_CPU_D[0].tri(BUS_CPU_OEp, bus_req.data_lo & 0x01);
  BUS_CPU_D[1].tri(BUS_CPU_OEp, bus_req.data_lo & 0x02);
  BUS_CPU_D[2].tri(BUS_CPU_OEp, bus_req.data_lo & 0x04);
  BUS_CPU_D[3].tri(BUS_CPU_OEp, bus_req.data_lo & 0x08);
  BUS_CPU_D[4].tri(BUS_CPU_OEp, bus_req.data_lo & 0x10);
  BUS_CPU_D[5].tri(BUS_CPU_OEp, bus_req.data_lo & 0x20);
  BUS_CPU_D[6].tri(BUS_CPU_OEp, bus_req.data_lo & 0x40);
  BUS_CPU_D[7].tri(BUS_CPU_OEp, bus_req.data_lo & 0x80);

  //----------------------------------------------------------------------------------------------------------------------------------------------------------------
  // Address decoders

  /* p06.SARE*/ wire _SARE_XX00_XX07p_ext = nor5 (BUS_CPU_A[ 7].qp_ext(), BUS_CPU_A[ 6].qp_ext(), BUS_CPU_A[ 5].qp_ext(),
                                                  BUS_CPU_A[ 4].qp_ext(), BUS_CPU_A[ 3].qp_ext());
  /* p07.TUNA*/ wire _TUNA_0000_FDFFp_ext = nand7(BUS_CPU_A[15].qp_ext(), BUS_CPU_A[14].qp_ext(), BUS_CPU_A[13].qp_ext(),
                                                  BUS_CPU_A[12].qp_ext(), BUS_CPU_A[11].qp_ext(), BUS_CPU_A[10].qp_ext(),
                                                  BUS_CPU_A[ 9].qp_ext());

  /* p07.TULO*/ wire _TULO_00000000_XXp_ext = nor8(BUS_CPU_A[15].qp_ext(), BUS_CPU_A[14].qp_ext(), BUS_CPU_A[13].qp_ext(), BUS_CPU_A[12].qp_ext(),
                                                   BUS_CPU_A[11].qp_ext(), BUS_CPU_A[10].qp_ext(), BUS_CPU_A[ 9].qp_ext(), BUS_CPU_A[ 8].qp_ext());
  /* p07.ZORO*/ wire _ZORO_0000xxxx_XXp_ext = nor4(BUS_CPU_A[15].qp_ext(), BUS_CPU_A[14].qp_ext(), BUS_CPU_A[13].qp_ext(), BUS_CPU_A[12].qp_ext());
  /* p07.ZADU*/ wire _ZADU_xxxx0000_XXp_ext = nor4(BUS_CPU_A[11].qp_ext(), BUS_CPU_A[10].qp_ext(), BUS_CPU_A[ 9].qp_ext(), BUS_CPU_A[ 8].qp_ext());

  /* p07.SEMY*/ wire _SEMY_XX_0000xxxxp_ext = nor4(BUS_CPU_A[ 7].qp_ext(), BUS_CPU_A[ 6].qp_ext(), BUS_CPU_A[ 5].qp_ext(), BUS_CPU_A[ 4].qp_ext());
  /* p07.SAPA*/ wire _SAPA_XX_xxxx1111p_ext = and4(BUS_CPU_A[ 0].qp_ext(), BUS_CPU_A[ 1].qp_ext(), BUS_CPU_A[ 2].qp_ext(), BUS_CPU_A[ 3].qp_ext());
  /* p22.XALY*/ wire _XALY_XX_0x00xxxxp_ext = nor3(BUS_CPU_A[ 7].qp_ext(), BUS_CPU_A[ 5].qp_ext(), BUS_CPU_A[ 4].qp_ext());
  /* p10.AMUS*/ wire _AMUS_XX_0xx00000p_ext = nor6(BUS_CPU_A[ 0].qp_ext(), BUS_CPU_A[ 1].qp_ext(), BUS_CPU_A[ 2].qp_ext(), BUS_CPU_A[ 3].qp_ext(), BUS_CPU_A[ 4].qp_ext(), BUS_CPU_A[ 7].qp_ext());
  /* p07.TYRO*/ wire _TYFO_XX_0x0x0000p_ext = nor6(BUS_CPU_A[ 7].qp_ext(), BUS_CPU_A[ 5].qp_ext(), BUS_CPU_A[ 3].qp_ext(), BUS_CPU_A[ 2].qp_ext(), BUS_CPU_A[ 1].qp_ext(), BUS_CPU_A[ 0].qp_ext());
  /* p07.TUFA*/ wire _TUFA_XX_x1x1xxxxp_ext = and2(BUS_CPU_A[ 4].qp_ext(), BUS_CPU_A[ 6].qp_ext());

  /* p03.TOVY*/ wire _TOVY_A00n_ext = not1(BUS_CPU_A[ 0].qp_ext());
  /* p22.XOLA*/ wire _XOLA_A00n_ext = not1(BUS_CPU_A[ 0].qp_ext());
  /* p08.TOLA*/ wire _TOLA_A01n_ext = not1(BUS_CPU_A[ 1].qp_ext());
  /* p22.XENO*/ wire _XENO_A01n_ext = not1(BUS_CPU_A[ 1].qp_ext());
  /* p06.SEFY*/ wire _SEFY_A02n_ext = not1(BUS_CPU_A[ 2].qp_ext());
  /* p22.XUSY*/ wire _XUSY_A02n_ext = not1(BUS_CPU_A[ 2].qp_ext());
  /* p22.XERA*/ wire _XERA_A03n_ext = not1(BUS_CPU_A[ 3].qp_ext());
  /* p10.BYKO*/ wire _BYKO_A05n_ext = not1(BUS_CPU_A[ 5].qp_ext());
  /* p10.AKUG*/ wire _AKUG_A06n_ext = not1(BUS_CPU_A[ 6].qp_ext());
  /* p07.TONA*/ wire _TONA_A08n_ext = not1(BUS_CPU_A[ 8].qp_ext());
  /* p08.SOGY*/ wire _SOGY_A14n_ext = not1(BUS_CPU_A[14].qp_ext());
  /*#p08.SORE*/ wire _SORE_A15n_ext = not1(BUS_CPU_A[15].qp_ext());
  ...
  /* p03.RYFO*/ wire _RYFO_FF04_FF07p_ext  = and3(_SYKE_FF00_FFFFp_ext, BUS_CPU_A[ 2].qp_ext(), _SARE_XX00_XX07p_ext);
  ...
  /*#p08.TEVY*/ wire _TEVY_8000_9FFFn_ext  = or3(BUS_CPU_A[13].qp_ext(), BUS_CPU_A[14].qp_ext(), _SORE_A15n_ext);
  /* p06.SANO*/ wire _SANO_FF00_FF03p_ext  = and3(_SARE_XX00_XX07p_ext, _SEFY_A02n_ext, _SYKE_FF00_FFFFp_ext);
  /* p22.WUTU*/ wire _WUTU_FF40_FF4Fn_ext  = nand3(_SYKE_FF00_FFFFp_ext, BUS_CPU_A[ 6].qp_ext(), _XALY_XX_0x00xxxxp_ext);
  /* p22.WERO*/ wire _WERO_FF40_FF4Fp_ext  = not1(_WUTU_FF40_FF4Fn_ext);
  /* p08.TUMA*/ wire _TUMA_A000_BFFFp_ext  = and3(BUS_CPU_A[13].qp_ext(), _SOGY_A14n_ext, BUS_CPU_A[15].qp_ext());
  /* p08.TYNU*/ wire _TYNU_A000_FFFFp_ext  = and_or3(BUS_CPU_A[15].qp_ext(), BUS_CPU_A[14].qp_ext(), _TUMA_A000_BFFFp_ext);
  ...
  {
    PIN_CPU_ADDR_HIp.setp(_SYRO_FE00_FFFFp_ext);
  }
  ...
  {
    wire ADYK_ABCxxxxHp_chain = clk_reg.ADYK_ABCxxxxHp.qp_chain();
    wire AFUR_xxxxEFGHn_chain = clk_reg.AFUR_xxxxEFGHp.qn_chain();
    wire ALEF_AxxxxFGHn_chain = clk_reg.ALEF_AxxxxFGHp.qn_chain();
    wire APUK_ABxxxxGHn_chain = clk_reg.APUK_ABxxxxGHp.qn_chain();

    /* p01.AFUR*/ clk_reg.AFUR_xxxxEFGHp.dff9(!_ATAL_xBxDxFxH_clk, UPOJ_MODE_PRODn_ext(), ADYK_ABCxxxxHp_chain);
    /* p01.ALEF*/ clk_reg.ALEF_AxxxxFGHp.dff9( _ATAL_xBxDxFxH_clk, UPOJ_MODE_PRODn_ext(), AFUR_xxxxEFGHn_chain);
    /* p01.APUK*/ clk_reg.APUK_ABxxxxGHp.dff9(!_ATAL_xBxDxFxH_clk, UPOJ_MODE_PRODn_ext(), ALEF_AxxxxFGHn_chain);
    /* p01.ADYK*/ clk_reg.ADYK_ABCxxxxHp.dff9( _ATAL_xBxDxFxH_clk, UPOJ_MODE_PRODn_ext(), APUK_ABxxxxGHn_chain);
  }
  ...
  /* p07.UJYV*/ wire _UJYV_CPU_RDn_ext = mux2n(UNOR_MODE_DBG2p_ext(), /*PIN_EXT_RDn.qn_new()*/ 0, PIN_CPU_RDp.qp_old());
  /* p07.TEDO*/ wire TEDO_CPU_RDp_ext = not1(_UJYV_CPU_RDn_ext);

  /* p07.AJAS*/ wire _AJAS_CPU_RDn_ext = not1(TEDO_CPU_RDp_ext);
  /* p07.ASOT*/ wire ASOT_CPU_RDp_ext = not1(_AJAS_CPU_RDn_ext);

  /* p04.DECY*/ wire _DECY_LATCH_EXTn_ext = not1(PIN_CPU_LATCH_EXT.qp_old());
  /* p04.CATY*/ wire CATY_LATCH_EXTp_ext = not1(_DECY_LATCH_EXTn_ext);

  /* p28.MYNU*/ wire _MYNU_CPU_RDn_ext = nand2(ASOT_CPU_RDp_ext, CATY_LATCH_EXTp_ext);
  /* p28.LEKO*/ wire LEKO_CPU_RDp_ext = not1(_MYNU_CPU_RDn_ext);

  /* p10.ACAT*/ wire _ACAT_FF00_RDp_ext =  and4(TEDO_CPU_RDp_ext, _ANAP_FF_0xx00000_ext,  _AKUG_A06n_ext,         _BYKO_A05n_ext);
  /* p06.UFEG*/ wire _UFEG_FF01_RDp_ext =  and4(TEDO_CPU_RDp_ext, _SANO_FF00_FF03p_ext,   BUS_CPU_A[ 0].qp_ext(), _TOLA_A01n_ext);
  /* p06.UCOM*/ wire _UCOM_FF02_RDp_ext =  and4(TEDO_CPU_RDp_ext, _SANO_FF00_FF03p_ext,   _TOVY_A00n_ext,         BUS_CPU_A[ 1].qp_ext());
  /* p01.TAGY*/ wire _TAGY_FF04_RDp_ext =  and4(TEDO_CPU_RDp_ext, _RYFO_FF04_FF07p_ext,   _TOLA_A01n_ext,         _TOVY_A00n_ext);
  /*#p03.TEDA*/ wire _TEDA_FF05_RDp_ext =  and4(TEDO_CPU_RDp_ext, _RYFO_FF04_FF07p_ext,   _TOLA_A01n_ext,         BUS_CPU_A[ 0].qp_ext());
  /* p03.TUBY*/ wire _TUBY_FF06_RDp_ext =  and4(TEDO_CPU_RDp_ext, _RYFO_FF04_FF07p_ext,   BUS_CPU_A[ 1].qp_ext(), _TOVY_A00n_ext);
  /* p03.SORA*/ wire _SORA_FF07_RDp_ext =  and4(TEDO_CPU_RDp_ext, _RYFO_FF04_FF07p_ext,   BUS_CPU_A[ 1].qp_ext(), BUS_CPU_A[ 0].qp_ext());
  /* p07.ROLO*/ wire _ROLO_FF0F_RDn_ext = nand4(TEDO_CPU_RDp_ext, _SYKE_FF00_FFFFp_ext,   _SEMY_XX_0000xxxxp_ext, _SAPA_XX_xxxx1111p_ext); // schematic wrong, is NAND
  /* p07.TEXE*/ wire _TEXE_FF50_RDp_ext =  and4(TEDO_CPU_RDp_ext, _SYKE_FF00_FFFFp_ext,   _TYFO_XX_0x0x0000p_ext, _TUFA_XX_x1x1xxxxp_ext);
  /* p23.VYRE*/ wire _VYRE_FF40_RDp_ext =  and2(ASOT_CPU_RDp_ext, _VOCA_FF40p_ext);
  /* p21.TOBE*/ wire _TOBE_FF41_RDp_ext =  and2(ASOT_CPU_RDp_ext, _VARY_FF41p_ext);
  /* p23.ANYP*/ wire _ANYP_FF42_RDp_ext =  and2(ASOT_CPU_RDp_ext, _XARO_FF42p_ext);
  /* p23.AVOG*/ wire _AVOG_FF43_RDp_ext =  and2(ASOT_CPU_RDp_ext, _XAVY_FF43p_ext);
  /* p23.WAFU*/ wire _WAFU_FF44_RDp_ext =  and2(ASOT_CPU_RDp_ext, _XOGY_FF44p_ext);
  /* p23.XYLY*/ wire _XYLY_FF45_RDp_ext =  and2(ASOT_CPU_RDp_ext, _XAYU_FF45p_ext);
  /*#p04.MOLU*/ wire _MOLU_FF46_RDp_ext =  and2(ASOT_CPU_RDp_ext, _XEDA_FF46p_ext);
  ...
  /* p36.MUMY*/ wire _MUMY_FF49_RDp_ext =  and2(ASOT_CPU_RDp_ext, _TEGO_FF49p_ext);
  /* p23.WAXU*/ wire _WAXU_FF4A_RDp_ext =  and2(ASOT_CPU_RDp_ext, _VYGA_FF4Ap_ext);
  /* p23.WYZE*/ wire _WYZE_FF4B_RDp_ext =  and2(ASOT_CPU_RDp_ext, _VUMY_FF4Bp_ext);
  ...
  /* p01.AREV*/ wire _AREV_CPU_WRn_ABCDxxxH_clk = nand2(PIN_CPU_WRp.qp_old(), _AFAS_xxxxEFGx_clk);
  /* p01.APOV*/ wire _APOV_CPU_WRp_xxxxEFGx_clk = not1(_AREV_CPU_WRn_ABCDxxxH_clk);
  /* p07.UBAL*/ wire _UBAL_CPU_WRn_ABCDxxxH_clk = mux2n(UNOR_MODE_DBG2p_ext(), /*PIN_EXT_WRn.qn_new()*/ 0, _APOV_CPU_WRp_xxxxEFGx_clk); // Ignoring debug stuff for now
  ...
  /* p06.URYS*/ wire _URYS_FF01_WRn_clk = nand4(_TAPU_CPU_WRp_xxxxEFGx_clk, _SANO_FF00_FF03p_ext,  BUS_CPU_A[ 0].qp_ext(), _TOLA_A01n_ext);
  /* p06.UWAM*/ wire _UWAM_FF02_WRn_clk = nand4(_TAPU_CPU_WRp_xxxxEFGx_clk, _SANO_FF00_FF03p_ext,  _TOVY_A00n_ext,         BUS_CPU_A[ 1].qp_ext());
  /* p01.TAPE*/ wire _TAPE_FF04_WRp_clk =  and4(_TAPU_CPU_WRp_xxxxEFGx_clk, _RYFO_FF04_FF07p_ext,  _TOLA_A01n_ext,         _TOVY_A00n_ext);
  /*#p03.TOPE*/ wire _TOPE_FF05_WRn_clk = nand4(_TAPU_CPU_WRp_xxxxEFGx_clk, _RYFO_FF04_FF07p_ext,  BUS_CPU_A[ 0].qp_ext(), _TOLA_A01n_ext);
  /* p03.TYJU*/ wire _TYJU_FF06_WRn_clk = nand4(_TAPU_CPU_WRp_xxxxEFGx_clk, _RYFO_FF04_FF07p_ext,  BUS_CPU_A[ 1].qp_ext(), _TOVY_A00n_ext);
  /* p03.SARA*/ wire _SARA_FF07_WRn_clk = nand4(_TAPU_CPU_WRp_xxxxEFGx_clk, _RYFO_FF04_FF07p_ext,  BUS_CPU_A[ 1].qp_ext(), BUS_CPU_A[ 0].qp_ext());
  ...
  [this,
    _ABOL_CLKREQn_ext,
    _AFEP_AxxxxFGH_clk, _AROV_xxCDEFxx_clk,
    _BALY_xBCDEFGH_clk, _BOGA_Axxxxxxx_clk,
    _BEKO_ABCDxxxx_clk, _BUDE_xxxxEFGH_clk,
    _BOLO_ABCDEFxx_clk](){
    ...
    PIN_CPU_BOWA_Axxxxxxx.setp(_BOWA_xBCDEFGH_clk);
    PIN_CPU_BEDO_xBCDEFGH.setp(_BEDO_Axxxxxxx_clk);
    PIN_CPU_BEKO_ABCDxxxx.setp(_BEKO_ABCDxxxx_clk);
    PIN_CPU_BUDE_xxxxEFGH.setp(_BUDE_xxxxEFGH_clk);
    PIN_CPU_BOLO_ABCDEFxx.setp(_BOLO_ABCDEFxx_clk);
    PIN_CPU_BUKE_AxxxxxGH.setp(_BUKE_AxxxxxGH_clk);
    PIN_CPU_BOMA_xBCDEFGH.setp(_BOMA_xBCDEFGH_clk);
    PIN_CPU_BOGA_Axxxxxxx.setp(_BOGA_Axxxxxxx_clk);
  }();
  ...
  [this, _UCOB_CLKBADp_ext, _BOGA_Axxxxxxx_clk, _TAGY_FF04_RDp_ext, _TAPE_FF04_WRp_clk]() {
    ...
    /* p01.UKUP*/ tim_reg.UKUP_DIV00p.dff17(_BOGA_Axxxxxxx_clk,           _UFOL_DIV_RSTn_ext, tim_reg.UKUP_DIV00p.qn_chain());
    /* p01.UFOR*/ tim_reg.UFOR_DIV01p.dff17(tim_reg.UKUP_DIV00p.qn_new(), _UFOL_DIV_RSTn_ext, tim_reg.UFOR_DIV01p.qn_chain());
    /* p01.UNER*/ tim_reg.UNER_DIV02p.dff17(tim_reg.UFOR_DIV01p.qn_new(), _UFOL_DIV_RSTn_ext, tim_reg.UNER_DIV02p.qn_chain());
    /*#p01.TERO*/ tim_reg.TERO_DIV03p.dff17(tim_reg.UNER_DIV02p.qn_new(), _UFOL_DIV_RSTn_ext, tim_reg.TERO_DIV03p.qn_chain());
    /* p01.UNYK*/ tim_reg.UNYK_DIV04p.dff17(tim_reg.TERO_DIV03p.qn_new(), _UFOL_DIV_RSTn_ext, tim_reg.UNYK_DIV04p.qn_chain());
    /* p01.TAMA*/ tim_reg.TAMA_DIV05p.dff17(tim_reg.UNYK_DIV04p.qn_new(), _UFOL_DIV_RSTn_ext, tim_reg.TAMA_DIV05p.qn_chain());
    ...
    /* p01.UGOT*/ tim_reg.UGOT_DIV06p.dff17(_ULUR_DIV_06_clknew,          _UFOL_DIV_RSTn_ext, tim_reg.UGOT_DIV06p.qn_chain());
    /* p01.TULU*/ tim_reg.TULU_DIV07p.dff17(tim_reg.UGOT_DIV06p.qn_new(), _UFOL_DIV_RSTn_ext, tim_reg.TULU_DIV07p.qn_chain());
    /* p01.TUGO*/ tim_reg.TUGO_DIV08p.dff17(tim_reg.TULU_DIV07p.qn_new(), _UFOL_DIV_RSTn_ext, tim_reg.TUGO_DIV08p.qn_chain());
    /* p01.TOFE*/ tim_reg.TOFE_DIV09p.dff17(tim_reg.TUGO_DIV08p.qn_new(), _UFOL_DIV_RSTn_ext, tim_reg.TOFE_DIV09p.qn_chain());
    /* p01.TERU*/ tim_reg.TERU_DIV10p.dff17(tim_reg.TOFE_DIV09p.qn_new(), _UFOL_DIV_RSTn_ext, tim_reg.TERU_DIV10p.qn_chain());
    /* p01.SOLA*/ tim_reg.SOLA_DIV11p.dff17(tim_reg.TERU_DIV10p.qn_new(), _UFOL_DIV_RSTn_ext, tim_reg.SOLA_DIV11p.qn_chain());
    /* p01.SUBU*/ tim_reg.SUBU_DIV12p.dff17(tim_reg.SOLA_DIV11p.qn_new(), _UFOL_DIV_RSTn_ext, tim_reg.SUBU_DIV12p.qn_chain());
    /* p01.TEKA*/ tim_reg.TEKA_DIV13p.dff17(tim_reg.SUBU_DIV12p.qn_new(), _UFOL_DIV_RSTn_ext, tim_reg.TEKA_DIV13p.qn_chain());
    /* p01.UKET*/ tim_reg.UKET_DIV14p.dff17(tim_reg.TEKA_DIV13p.qn_new(), _UFOL_DIV_RSTn_ext, tim_reg.UKET_DIV14p.qn_chain());
    /* p01.UPOF*/ tim_reg.UPOF_DIV15p.dff17(tim_reg.UKET_DIV14p.qn_new(), _UFOL_DIV_RSTn_ext, tim_reg.UPOF_DIV15p.qn_chain());
    ...
    /* p01.TAWU*/ BUS_CPU_D[0].tri6_pn(_TAGY_FF04_RDp_ext, _UMEK_DIV06n);
    /* p01.TAKU*/ BUS_CPU_D[1].tri6_pn(_TAGY_FF04_RDp_ext, _UREK_DIV07n);
    /* p01.TEMU*/ BUS_CPU_D[2].tri6_pn(_TAGY_FF04_RDp_ext, _UTOK_DIV08n);
    /* p01.TUSE*/ BUS_CPU_D[3].tri6_pn(_TAGY_FF04_RDp_ext, _SAPY_DIV09n);
    /* p01.UPUG*/ BUS_CPU_D[4].tri6_pn(_TAGY_FF04_RDp_ext, _UMER_DIV10n); // Schematic wrong, UPUG/SEPU driving D5/D4
    /* p01.SEPU*/ BUS_CPU_D[5].tri6_pn(_TAGY_FF04_RDp_ext, _RAVE_DIV11n);
    /* p01.SAWA*/ BUS_CPU_D[6].tri6_pn(_TAGY_FF04_RDp_ext, _RYSO_DIV12n);
    /* p01.TATU*/ BUS_CPU_D[7].tri6_pn(_TAGY_FF04_RDp_ext, _UDOR_DIV13n);
  }();

  //----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
  // Power-on reset handler

  [this, _UCOB_CLKBADp_ext, _BOGA_Axxxxxxx_clk]() {
    /* p01.AFER*/ clk_reg.AFER_SYS_RSTp_s.dff13(_BOGA_Axxxxxxx_clk, UPOJ_MODE_PRODn_ext(), clk_reg.ASOL_POR_DONEn_s.qp_old());
    ...
    PIN_CPU_SYS_RSTp.setp(clk_reg.AFER_SYS_RSTp_s.qp_new());
  }();

  /*#p01.AVOR*/ wire _AVOR_SYS_RSTp_new = or2(clk_reg.AFER_SYS_RSTp_s.qp_new(), clk_reg.ASOL_POR_DONEn_s.qp_new());
  /*#p01.ALUR*/ wire ALUR_SYS_RSTn_new = not1(_AVOR_SYS_RSTp_new);
  /*#p01.DULA*/ wire _DULA_SYS_RSTp_new = not1(ALUR_SYS_RSTn_new);
  /*#p01.CUNU*/ wire CUNU_SYS_RSTn_new = not1(_DULA_SYS_RSTp_new);
  /*#p01.XORE*/ wire XORE_SYS_RSTp_new = not1(CUNU_SYS_RSTn_new);

  //----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
  // Boot bit

  [this, ALUR_SYS_RSTn_new, _TEXE_FF50_RDp_ext, _TUGE_FF50_WRn_clk]() {
    // FF50 - disable bootrom bit
    /* p07.SATO*/ wire _SATO_BOOT_BITn_old = or2(BUS_CPU_D[0].qp_ext(), BOOT_BITn.qp_chain());
    /* p07.TEPU*/ BOOT_BITn.dff17(_TUGE_FF50_WRn_clk, ALUR_SYS_RSTn_new, _SATO_BOOT_BITn_old);
    /* p07.SYPU*/ BUS_CPU_D[0].tri6_pn(_TEXE_FF50_RDp_ext, BOOT_BITn.qp_new());
  }();
  /* p07.TERA*/ wire _TERA_BOOT_BITp_new  = not1(BOOT_BITn.qp_new());
  /* p07.TUTU*/ wire TUTU_READ_BOOTROMp_new = and2(_TERA_BOOT_BITp_new, _TULO_00000000_XXp_ext);
  ...
  /*#p08.TEXO*/ wire _TEXO_8000_9FFFn_ext  = and2(PIN_CPU_EXT_BUSp.qp_old(), _TEVY_8000_9FFFn_ext);
  /*#p25.TEFA*/ wire _TEFA_8000_9FFFp_ext  = nor2(_SYRO_FE00_FFFFp_ext, _TEXO_8000_9FFFn_ext);
  /*#p25.SOSE*/ wire _SOSE_8000_9FFFp_ext  = and2(_TEFA_8000_9FFFp_ext, BUS_CPU_A[15].qp_ext());

  /*#p01.AGUT*/ wire _AGUT_xxCDEFGH_clk = or_and3(_AROV_xxCDEFxx_clk, _AJAX_xxxxEFGH_clk, PIN_CPU_EXT_BUSp.qp_old());
  /*#p01.AWOD*/ wire _AWOD_ABxxxxxx_clk = nor2(UNOR_MODE_DBG2p_ext(), _AGUT_xxCDEFGH_clk);
  /*#p01.ABUZ*/ wire ABUZ_xxCDEFGH_clk = not1(_AWOD_ABxxxxxx_clk);

  //----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
  // Timer

  [this, ALUR_SYS_RSTn_new, _BOGA_Axxxxxxx_clk, _TEDA_FF05_RDp_ext, _TUBY_FF06_RDp_ext, _SORA_FF07_RDp_ext, _TOPE_FF05_WRn_clk, _TYJU_FF06_WRn_clk, _SARA_FF07_WRn_clk]() {
    /*#p03.MERY*/ wire _MERY_TIMER_OVERFLOWp_old = nor2(tim_reg.NUGA_TIMA7p.qp_old(), tim_reg.NYDU_TIMA7p_DELAY.qn_old());
    /*#p03.MOBA*/ tim_reg.MOBA_TIMER_OVERFLOWp.dff17(_BOGA_Axxxxxxx_clk, ALUR_SYS_RSTn_new, _MERY_TIMER_OVERFLOWp_old);

    /*#p03.MEKE*/ wire _MEKE_TIMER_OVERFLOWn_new = not1(tim_reg.MOBA_TIMER_OVERFLOWp.qp_new());
    /*#p03.MUZU*/ wire _MUZU_CPU_LOAD_TIMAn_ext  = or2(PIN_CPU_LATCH_EXT.qp_old(), _TOPE_FF05_WRn_clk);
    ...
    // FF06 TMA
    /* p03.SABU*/ tim_reg.SABU_TMA0p.dff17(_TYJU_FF06_WRn_clk, ALUR_SYS_RSTn_new, BUS_CPU_D[0].qp_ext());
    /* p03.NYKE*/ tim_reg.NYKE_TMA1p.dff17(_TYJU_FF06_WRn_clk, ALUR_SYS_RSTn_new, BUS_CPU_D[1].qp_ext());
    /* p03.MURU*/ tim_reg.MURU_TMA2p.dff17(_TYJU_FF06_WRn_clk, ALUR_SYS_RSTn_new, BUS_CPU_D[2].qp_ext());
    /* p03.TYVA*/ tim_reg.TYVA_TMA3p.dff17(_TYJU_FF06_WRn_clk, ALUR_SYS_RSTn_new, BUS_CPU_D[3].qp_ext());
    /* p03.TYRU*/ tim_reg.TYRU_TMA4p.dff17(_TYJU_FF06_WRn_clk, ALUR_SYS_RSTn_new, BUS_CPU_D[4].qp_ext());
    /* p03.SUFY*/ tim_reg.SUFY_TMA5p.dff17(_TYJU_FF06_WRn_clk, ALUR_SYS_RSTn_new, BUS_CPU_D[5].qp_ext());
    /* p03.PETO*/ tim_reg.PETO_TMA6p.dff17(_TYJU_FF06_WRn_clk, ALUR_SYS_RSTn_new, BUS_CPU_D[6].qp_ext());
    /* p03.SETA*/ tim_reg.SETA_TMA7p.dff17(_TYJU_FF06_WRn_clk, ALUR_SYS_RSTn_new, BUS_CPU_D[7].qp_ext());

    // FF07 TAC
    /* p03.SOPU*/ tim_reg.SOPU_TAC0p.dff17(_SARA_FF07_WRn_clk, ALUR_SYS_RSTn_new, BUS_CPU_D[0].qp_ext());
    /* p03.SAMY*/ tim_reg.SAMY_TAC1p.dff17(_SARA_FF07_WRn_clk, ALUR_SYS_RSTn_new, BUS_CPU_D[1].qp_ext());
    /* p03.SABO*/ tim_reg.SABO_TAC2p.dff17(_SARA_FF07_WRn_clk, ALUR_SYS_RSTn_new, BUS_CPU_D[2].qp_ext());

    /*#p03.ROKE*/ wire _ROKE_TIMA_D0_new = mux2n(_TOPE_FF05_WRn_clk, tim_reg.SABU_TMA0p.qp_new(), BUS_CPU_D[0].qp_ext());
    /*#p03.PETU*/ wire _PETU_TIMA_D1_new = mux2n(_TOPE_FF05_WRn_clk, tim_reg.NYKE_TMA1p.qp_new(), BUS_CPU_D[1].qp_ext());
    /*#p03.NYKU*/ wire _NYKU_TIMA_D2_new = mux2n(_TOPE_FF05_WRn_clk, tim_reg.MURU_TMA2p.qp_new(), BUS_CPU_D[2].qp_ext());
    /*#p03.SOCE*/ wire _SOCE_TIMA_D3_new = mux2n(_TOPE_FF05_WRn_clk, tim_reg.TYVA_TMA3p.qp_new(), BUS_CPU_D[3].qp_ext());
    /*#p03.SALA*/ wire _SALA_TIMA_D4_new = mux2n(_TOPE_FF05_WRn_clk, tim_reg.TYRU_TMA4p.qp_new(), BUS_CPU_D[4].qp_ext());
    /*#p03.SYRU*/ wire _SYRU_TIMA_D5_new = mux2n(_TOPE_FF05_WRn_clk, tim_reg.SUFY_TMA5p.qp_new(), BUS_CPU_D[5].qp_ext());
    /*#p03.REFU*/ wire _REFU_TIMA_D6_new = mux2n(_TOPE_FF05_WRn_clk, tim_reg.PETO_TMA6p.qp_new(), BUS_CPU_D[6].qp_ext());
    /*#p03.RATO*/ wire _RATO_TIMA_D7_new = mux2n(_TOPE_FF05_WRn_clk, tim_reg.SETA_TMA7p.qp_new(), BUS_CPU_D[7].qp_ext());
  ...
  //----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
  // LCDC. Has to be near the top as it controls the video reset signals

  /* p23.WYMO*/ wire _WYMO_LCDC_WINENp_old = pix_pipe.WYMO_LCDC_WINENn.qn_old();

  [this, XORE_SYS_RSTp_new, _VYRE_FF40_RDp_ext, _WARU_FF40_WRp_clk]() {
    // FF40 LCDC
    /* p23.XUBO*/ wire _XUBO_FF40_WRn_clk = not1(_WARU_FF40_WRp_clk);
    /* p01.XARE*/ wire _XARE_SYS_RSTn_new = not1(XORE_SYS_RSTp_new);
    /*#p23.VYXE*/ pix_pipe.VYXE_LCDC_BGENn  .dff9(_XUBO_FF40_WRn_clk, _XARE_SYS_RSTn_new, BUS_CPU_D[0].qp_ext());
    /* p23.XYLO*/ pix_pipe.XYLO_LCDC_SPENn  .dff9(_XUBO_FF40_WRn_clk, _XARE_SYS_RSTn_new, BUS_CPU_D[1].qp_ext());
    /* p23.XYMO*/ pix_pipe.XYMO_LCDC_SPSIZEn.dff9(_XUBO_FF40_WRn_clk, _XARE_SYS_RSTn_new, BUS_CPU_D[2].qp_ext());
    /* p23.XAFO*/ pix_pipe.XAFO_LCDC_BGMAPn .dff9(_XUBO_FF40_WRn_clk, _XARE_SYS_RSTn_new, BUS_CPU_D[3].qp_ext());
    /* p23.WEXU*/ pix_pipe.WEXU_LCDC_BGTILEn.dff9(_XUBO_FF40_WRn_clk, _XARE_SYS_RSTn_new, BUS_CPU_D[4].qp_ext());
    /* p23.WYMO*/ pix_pipe.WYMO_LCDC_WINENn .dff9(_XUBO_FF40_WRn_clk, _XARE_SYS_RSTn_new, BUS_CPU_D[5].qp_ext());
    /* p23.WOKY*/ pix_pipe.WOKY_LCDC_WINMAPn.dff9(_XUBO_FF40_WRn_clk, _XARE_SYS_RSTn_new, BUS_CPU_D[6].qp_ext());
    /* p23.XONA*/ pix_pipe.XONA_LCDC_LCDENn .dff9(_XUBO_FF40_WRn_clk, _XARE_SYS_RSTn_new, BUS_CPU_D[7].qp_ext());
    ...
    /* p23.WUKA*/ BUS_CPU_D[3].tri6_nn(_WYCE_FF40_RDn_ext, pix_pipe.XAFO_LCDC_BGMAPn .qp_new());
    /* p23.VOKE*/ BUS_CPU_D[4].tri6_nn(_WYCE_FF40_RDn_ext, pix_pipe.WEXU_LCDC_BGTILEn.qp_new());
    /* p23.VATO*/ BUS_CPU_D[5].tri6_nn(_WYCE_FF40_RDn_ext, pix_pipe.WYMO_LCDC_WINENn .qp_new());
    /*#p23.VAHA*/ BUS_CPU_D[6].tri6_nn(_WYCE_FF40_RDn_ext, pix_pipe.WOKY_LCDC_WINMAPn.qp_new());
    /*#p23.XEBU*/ BUS_CPU_D[7].tri6_nn(_WYCE_FF40_RDn_ext, pix_pipe.XONA_LCDC_LCDENn .qp_new());
  }();

  //----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
  // Video clock & reset signals

  /* p01.XEBE*/ wire _XEBE_SYS_RSTn_new = not1(XORE_SYS_RSTp_new);
...

  {
    ...
    /* p29.WOSU*/ clk_reg.WOSU_AxxDExxHp.dff17(_XYFY_xBxDxFxH_new,              _XAPO_VID_RSTn_new, clk_reg.WUVU_ABxxEFxxp.qn_chain());
    /* p29.WUVU*/ clk_reg.WUVU_ABxxEFxxp.dff17(_XOTA_AxCxExGx_new,              _XAPO_VID_RSTn_new, clk_reg.WUVU_ABxxEFxxp.qn_chain());
    /* p21.VENA*/ clk_reg.VENA_xxCDEFxxp.dff17(clk_reg.WUVU_ABxxEFxxp.qn_new(), _XAPO_VID_RSTn_new, clk_reg.VENA_xxCDEFxxp.qn_chain()); // inverting the clock to VENA doesn't seem to break anything, which is really weird
  }
  ...
  [this,XORE_SYS_RSTp_new, _SEPA_FF41_WRp_clk, _TALU_xxCDEFxx_clknew, _XYLY_FF45_RDp_ext, _XUFA_FF45_WRn_clk]() {
    /* p01.WESY*/ wire _WESY_SYS_RSTn_new = not1(XORE_SYS_RSTp_new);
    ...
    /* p23.SYRY*/ lcd_reg.SYRY_LYC0n.dff9(_WANE_FF45_WRp_clk, _WESY_SYS_RSTn_new, BUS_CPU_D[0].qp_ext());
    /* p23.VUCE*/ lcd_reg.VUCE_LYC1n.dff9(_WANE_FF45_WRp_clk, _WESY_SYS_RSTn_new, BUS_CPU_D[1].qp_ext());
    /* p23.SEDY*/ lcd_reg.SEDY_LYC2n.dff9(_WANE_FF45_WRp_clk, _WESY_SYS_RSTn_new, BUS_CPU_D[2].qp_ext());
    /* p23.SALO*/ lcd_reg.SALO_LYC3n.dff9(_WANE_FF45_WRp_clk, _WESY_SYS_RSTn_new, BUS_CPU_D[3].qp_ext());
    /* p23.SOTA*/ lcd_reg.SOTA_LYC4n.dff9(_WANE_FF45_WRp_clk, _WESY_SYS_RSTn_new, BUS_CPU_D[4].qp_ext());
    /* p23.VAFA*/ lcd_reg.VAFA_LYC5n.dff9(_WANE_FF45_WRp_clk, _WESY_SYS_RSTn_new, BUS_CPU_D[5].qp_ext());
    /* p23.VEVO*/ lcd_reg.VEVO_LYC6n.dff9(_WANE_FF45_WRp_clk, _WESY_SYS_RSTn_new, BUS_CPU_D[6].qp_ext());
    /* p23.RAHA*/ lcd_reg.RAHA_LYC7n.dff9(_WANE_FF45_WRp_clk, _WESY_SYS_RSTn_new, BUS_CPU_D[7].qp_ext());
  ...
  [this, CUNU_SYS_RSTn_new, _UVYT_ABCDxxxx_clk, _MOLU_FF46_RDp_ext, _LAVY_FF46_WRp_clk]() {
    ...
    /*#p04.LENE*/ dma_reg.LENE_DMA_TRIG_d4.dff17(_MOPA_xxxxEFGH_new, CUNU_SYS_RSTn_new, dma_reg.LUVY_DMA_TRIG_d0.qp_old());
    /*#p04.LUVY*/ dma_reg.LUVY_DMA_TRIG_d0.dff17(_UVYT_ABCDxxxx_clk, CUNU_SYS_RSTn_new, _LUPA_DMA_TRIG_old);

    /*#p04.LOKO*/ wire _LOKO_DMA_RSTp_new = nand2(dma_reg.LENE_DMA_TRIG_d4.qn_new(), CUNU_SYS_RSTn_new);
    ...
    /*#p04.MATU*/ dma_reg.MATU_DMA_RUNNINGp.dff17(_UVYT_ABCDxxxx_clk, CUNU_SYS_RSTn_new, dma_reg.LOKY_DMA_LATCHp.qp_old());
    /* p04.LARA*/ dma_reg.LARA_DMA_LATCHn = nand3(dma_reg.LOKY_DMA_LATCHp.qp_chain(), dma_reg.MYTE_DMA_DONE.qn_new(), CUNU_SYS_RSTn_new);
    /*#p04.LOKY*/ dma_reg.LOKY_DMA_LATCHp = nand2(dma_reg.LARA_DMA_LATCHn.qp_new(),   dma_reg.LENE_DMA_TRIG_d4.qn_new());
    /* p04.LARA*/ dma_reg.LARA_DMA_LATCHn = nand3(dma_reg.LOKY_DMA_LATCHp.qp_new(),   dma_reg.MYTE_DMA_DONE.qn_new(), CUNU_SYS_RSTn_new);

    /*#p04.META*/ wire _META_DMA_CLKp_new = and2(_UVYT_ABCDxxxx_clk, dma_reg.LOKY_DMA_LATCHp.qp_new());
    /*#p04.NAKY*/ dma_reg.NAKY_DMA_A00p.dff17(_META_DMA_CLKp_new,             _LAPA_DMA_RSTn_new, dma_reg.NAKY_DMA_A00p.qn_chain());
    /*#p04.PYRO*/ dma_reg.PYRO_DMA_A01p.dff17(dma_reg.NAKY_DMA_A00p.qn_new(), _LAPA_DMA_RSTn_new, dma_reg.PYRO_DMA_A01p.qn_chain());
    /* p04.NEFY*/ dma_reg.NEFY_DMA_A02p.dff17(dma_reg.PYRO_DMA_A01p.qn_new(), _LAPA_DMA_RSTn_new, dma_reg.NEFY_DMA_A02p.qn_chain());
    /* p04.MUTY*/ dma_reg.MUTY_DMA_A03p.dff17(dma_reg.NEFY_DMA_A02p.qn_new(), _LAPA_DMA_RSTn_new, dma_reg.MUTY_DMA_A03p.qn_chain());
    /* p04.NYKO*/ dma_reg.NYKO_DMA_A04p.dff17(dma_reg.MUTY_DMA_A03p.qn_new(), _LAPA_DMA_RSTn_new, dma_reg.NYKO_DMA_A04p.qn_chain());
    /* p04.PYLO*/ dma_reg.PYLO_DMA_A05p.dff17(dma_reg.NYKO_DMA_A04p.qn_new(), _LAPA_DMA_RSTn_new, dma_reg.PYLO_DMA_A05p.qn_chain());
    /* p04.NUTO*/ dma_reg.NUTO_DMA_A06p.dff17(dma_reg.PYLO_DMA_A05p.qn_new(), _LAPA_DMA_RSTn_new, dma_reg.NUTO_DMA_A06p.qn_chain());
    /* p04.MUGU*/ dma_reg.MUGU_DMA_A07p.dff17(dma_reg.NUTO_DMA_A06p.qn_new(), _LAPA_DMA_RSTn_new, dma_reg.MUGU_DMA_A07p.qn_chain());

    /*#p04.LORU*/ wire _LORU_FF46_WRn_new = not1(_LAVY_FF46_WRp_clk);
    /*#p04.NAFA*/ dma_reg.NAFA_DMA_A08n.dff8p(_LORU_FF46_WRn_new, BUS_CPU_D[0].qp_ext());
    /* p04.PYNE*/ dma_reg.PYNE_DMA_A09n.dff8p(_LORU_FF46_WRn_new, BUS_CPU_D[1].qp_ext());
    /* p04.PARA*/ dma_reg.PARA_DMA_A10n.dff8p(_LORU_FF46_WRn_new, BUS_CPU_D[2].qp_ext());
    /* p04.NYDO*/ dma_reg.NYDO_DMA_A11n.dff8p(_LORU_FF46_WRn_new, BUS_CPU_D[3].qp_ext());
    /* p04.NYGY*/ dma_reg.NYGY_DMA_A12n.dff8p(_LORU_FF46_WRn_new, BUS_CPU_D[4].qp_ext());
    /* p04.PULA*/ dma_reg.PULA_DMA_A13n.dff8p(_LORU_FF46_WRn_new, BUS_CPU_D[5].qp_ext());
    /* p04.POKU*/ dma_reg.POKU_DMA_A14n.dff8p(_LORU_FF46_WRn_new, BUS_CPU_D[6].qp_ext());
    /* p04.MARU*/ dma_reg.MARU_DMA_A15n.dff8p(_LORU_FF46_WRn_new, BUS_CPU_D[7].qp_ext());
  ...
  /* p04.LUMA*/ wire LUMA_DMA_CARTp_new = not1(_MORY_DMA_CARTn_new);
  /* p04.MUHO*/ wire _MUHO_DMA_VRAMp_new = nand2(dma_reg.MATU_DMA_RUNNINGp.qp_new(), _MUDA_DMA_VRAMp_new);
  /* p04.LUFA*/ wire LUFA_DMA_VRAMp_new = not1(_MUHO_DMA_VRAMp_new);
  ...
  [this, _LYFE_VID_RSTn_new, _ATAR_VID_RSTp_new, _ABEZ_VID_RSTn_new, _TALU_xxCDEFxx_clknew, _SONO_ABxxxxGH_clknew, _AWOH_xxCDxxGH_clknew, _XUPY_ABxxEFxx_clknew]() {
...

    {
      ...
      /*#p28.ANEL*/ lcd_reg.ANEL_LINE_P002p .dff17(_AWOH_xxCDxxGH_clknew, _ABEZ_VID_RSTn_new, lcd_reg.CATU_LINE_P000p.qp_chain());
      ...
      /* p28.ATEJ*/ ATEJ_LINE_TRIGp.set(not1(_BYHA_LINE_TRIGn_new));
    }

    {
      ...
      /*#p21.NYPE*/ lcd_reg.NYPE_x113p.dff17(_TALU_xxCDEFxx_clknew,         _LYFE_VID_RSTn_new, lcd_reg.RUTU_x113p.qp_chain());
      /*#p21.RUTU*/ lcd_reg.RUTU_x113p.dff17(_SONO_ABxxxxGH_clknew,         _LYFE_VID_RSTn_new, _SANU_x113p_old);
      /*#p21.POPU*/ lcd_reg.POPU_VBLANKp.dff17(lcd_reg.NYPE_x113p.qp_new(), _LYFE_VID_RSTn_new, _XYVO_y144p_old);
    }
  }();
  ...
  /*#p21.XENA*/ wire _XENA_STORE_MATCHn_old = not1(FEPO_STORE_MATCHp.qp_old());
  /*#p21.WODU*/ wire _WODU_HBLANKp_old = and2(_XENA_STORE_MATCHn_old, _XANO_PX167p_old);


  /* p21.TADY*/ wire _TADY_LINE_RSTn_new  = nor2(ATEJ_LINE_TRIGp.qp_new(), _TOFU_VID_RSTp_new);
  ...
  /*#p21.PARU*/ wire _PARU_VBLANKp_new = not1(lcd_reg.POPU_VBLANKp.qn_new());

  //--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
  // Sprite scanner

  [this, _ATAR_VID_RSTp_new, _TOFU_VID_RSTp_new, _ALET_xBxDxFxH_clk]() {
    /*#p01.ABEZ*/ wire _ABEZ_VID_RSTn_new = not1(_ATAR_VID_RSTp_new);
    /*#p29.XUPY*/ wire _XUPY_ABxxEFxx_clknew = not1(clk_reg.WUVU_ABxxEFxxp.qn_new());

    /*#p28.ANOM*/ wire _ANOM_SCAN_RSTn_new  = nor2(ATEJ_LINE_TRIGp.qp_new(), _ATAR_VID_RSTp_new);
...

    {
      ...
      /*#p29.DOBA*/ sprite_scanner.DOBA_SCAN_DONE_Bp.dff17(_ALET_xBxDxFxH_clk,    _BAGY_SCAN_RSTn_new, sprite_scanner.BYBA_SCAN_DONE_Ap.qp_old());
      /*#p29.BYBA*/ sprite_scanner.BYBA_SCAN_DONE_Ap.dff17(_XUPY_ABxxEFxx_clknew, _BAGY_SCAN_RSTn_new, _FETO_SCAN_DONEp_old);
    }

    {
      /* p28.YFEL*/ sprite_scanner.YFEL_SCAN0.RSTn(_ANOM_SCAN_RSTn_new);
      /* p28.WEWY*/ sprite_scanner.WEWY_SCAN1.RSTn(_ANOM_SCAN_RSTn_new);
      /* p28.GOSO*/ sprite_scanner.GOSO_SCAN2.RSTn(_ANOM_SCAN_RSTn_new);
      /* p28.ELYN*/ sprite_scanner.ELYN_SCAN3.RSTn(_ANOM_SCAN_RSTn_new);
      /* p28.FAHA*/ sprite_scanner.FAHA_SCAN4.RSTn(_ANOM_SCAN_RSTn_new);
      /* p28.FONY*/ sprite_scanner.FONY_SCAN5.RSTn(_ANOM_SCAN_RSTn_new);
      ...
      /* p28.YFEL*/ sprite_scanner.YFEL_SCAN0.dff17(_GAVA_ABxxEFxx_new,                 _ANOM_SCAN_RSTn_new, sprite_scanner.YFEL_SCAN0.qn_new());
      /* p28.WEWY*/ sprite_scanner.WEWY_SCAN1.dff17(sprite_scanner.YFEL_SCAN0.qn_new(), _ANOM_SCAN_RSTn_new, sprite_scanner.WEWY_SCAN1.qn_new());
      /* p28.GOSO*/ sprite_scanner.GOSO_SCAN2.dff17(sprite_scanner.WEWY_SCAN1.qn_new(), _ANOM_SCAN_RSTn_new, sprite_scanner.GOSO_SCAN2.qn_new());
      /* p28.ELYN*/ sprite_scanner.ELYN_SCAN3.dff17(sprite_scanner.GOSO_SCAN2.qn_new(), _ANOM_SCAN_RSTn_new, sprite_scanner.ELYN_SCAN3.qn_new());
      /* p28.FAHA*/ sprite_scanner.FAHA_SCAN4.dff17(sprite_scanner.ELYN_SCAN3.qn_new(), _ANOM_SCAN_RSTn_new, sprite_scanner.FAHA_SCAN4.qn_new());
      /* p28.FONY*/ sprite_scanner.FONY_SCAN5.dff17(sprite_scanner.FAHA_SCAN4.qn_new(), _ANOM_SCAN_RSTn_new, sprite_scanner.FONY_SCAN5.qn_new());
    }

    {
      /*#p29.BEBU*/ wire _BEBU_SCAN_DONE_TRIGn_new = or3(sprite_scanner.DOBA_SCAN_DONE_Bp.qp_new(), _BALU_SCAN_RSTp_new, sprite_scanner.BYBA_SCAN_DONE_Ap.qn_new());
      /*#p29.AVAP*/ AVAP_SCAN_DONE_TRIGp.set(not1(_BEBU_SCAN_DONE_TRIGn_new));
      /*#p28.ASEN*/ wire _ASEN_SCAN_DONE_TRIGp_new = or2(_ATAR_VID_RSTp_new, AVAP_SCAN_DONE_TRIGp.qp_new());
      /*#p29.CENO*/ sprite_scanner.CENO_SCANNINGp.dff17(_XUPY_ABxxEFxx_clknew, _ABEZ_VID_RSTn_new,  sprite_scanner.BESU_SCANNINGp.qp_chain());
  ...
  //--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
  // Messy disorganized window sequencer stuffs

  /* p29.TEPA*/ wire TEPA_RENDERINGp_old = not1(pix_pipe.XYMU_RENDERINGn.qn_old());
  {
    /*#p21.XYMU*/ pix_pipe.XYMU_RENDERINGn.nor_latch(_WEGO_HBLANKp_new, AVAP_SCAN_DONE_TRIGp.qp_new());
  }
  /* p29.TEPA*/ wire TEPA_RENDERINGp_new = not1(pix_pipe.XYMU_RENDERINGn.qn_new());
  /* p24.LOBY*/ wire LOBY_RENDERINGn_new = not1(pix_pipe.XYMU_RENDERINGn.qn_new());
  /*#p25.XANE*/ wire XANE_VRAM_LOCKn_new = nor2(LUFA_DMA_VRAMp_new, pix_pipe.XYMU_RENDERINGn.qn_new());


  {
    /* p27.XAHY*/ wire _XAHY_LINE_TRIGn_new = not1(ATEJ_LINE_TRIGp.qp_new());
    /*#p27.XOFO*/ wire _XOFO_WIN_RSTp_new   = nand3(pix_pipe.WYMO_LCDC_WINENn.qn_new(), _XAHY_LINE_TRIGn_new, _XAPO_VID_RSTn_new);
    /* p27.NUNU*/ pix_pipe.NUNU_WIN_MATCHp .dff17(_MEHE_AxCxExGx_clk, _XAPO_VID_RSTn_new, pix_pipe.PYCO_WIN_MATCHp.qp_old());
    /* p27.NOPA*/ pix_pipe.NOPA_WIN_MODE_Bp.dff17(_ALET_xBxDxFxH_clk, _XAPO_VID_RSTn_new, pix_pipe.PYNU_WIN_MODE_Ap.qp_chain());
    /* p27.PYNU*/ pix_pipe.PYNU_WIN_MODE_Ap.nor_latch(pix_pipe.NUNU_WIN_MATCHp.qp_new(), _XOFO_WIN_RSTp_new);
    /*#p27.NUNY*/ NUNY_WIN_MODE_TRIGp.set(and2(pix_pipe.PYNU_WIN_MODE_Ap.qp_new(), pix_pipe.NOPA_WIN_MODE_Bp.qn_new()));
  }
  /*#p27.NOCU*/ wire _NOCU_WIN_MODEn_new = not1(pix_pipe.PYNU_WIN_MODE_Ap.qp_new());
  /* p27.PORE*/ wire PORE_WIN_MODEp_new = not1(_NOCU_WIN_MODEn_new);

  /* p27.MOCE*/ wire _MOCE_BFETCH_DONEn_old = nand3(tile_fetcher.LAXU_BFETCH_S0p.qp_old(), tile_fetcher.NYVA_BFETCH_S2p.qp_old(), NYXU_BFETCH_RSTn.qp_old());
  /* p27.LYRY*/ wire _LYRY_BFETCH_DONEp_old = not1(_MOCE_BFETCH_DONEn_old);

  {
    {
      /* p27.NYFO*/ wire _NYFO_WX_MATCH_TRIGn_new = not1(NUNY_WIN_MODE_TRIGp.qp_new());
      /* p27.MOSU*/ wire _MOSU_WX_MATCH_TRIGp_new = not1(_NYFO_WX_MATCH_TRIGn_new);
      /* p24.NAFY*/ wire _NAFY_RENDERING_AND_NOT_WIN_TRIG_new = nor2(_MOSU_WX_MATCH_TRIGp_new, LOBY_RENDERINGn_new);
      /* p24.PYGO*/ tile_fetcher.PYGO_FETCH_DONEp.dff17(_ALET_xBxDxFxH_clk, pix_pipe.XYMU_RENDERINGn.qn_new(),    tile_fetcher.PORY_FETCH_DONEp.qp_chain());
      /* p24.PORY*/ tile_fetcher.PORY_FETCH_DONEp.dff17(_MYVO_AxCxExGx_clk, _NAFY_RENDERING_AND_NOT_WIN_TRIG_new, tile_fetcher.NYKA_FETCH_DONEp.qp_chain());
      ...
      /* p24.POKY*/ tile_fetcher.POKY_PRELOAD_LATCHp.nor_latch(tile_fetcher.PYGO_FETCH_DONEp.qp_new(), LOBY_RENDERINGn_new);
      ...
      /* p27.TAVE*/ TAVE_PRELOAD_DONE_TRIGp.set(not1(_SUVU_PRELOAD_DONE_TRIGn_new));
    }
  }
  ...
  {
    /* p27.SOVY*/ pix_pipe.SOVY_WIN_HITp.dff17(_ALET_xBxDxFxH_clk, _XAPO_VID_RSTn_new, pix_pipe.RYDY_WIN_HITp.qp_chain());
    ...
    /* p27.PUKU*/ pix_pipe.PUKU_WIN_HITn = nor2(pix_pipe.RYDY_WIN_HITp.qp_new(), NUNY_WIN_MODE_TRIGp.qp_new());
  ...
  /*#p24.TOMU*/ wire TOMU_WIN_HITp_new = not1(_SYLO_WIN_HITn_new);
  /* p27.TUXY*/ wire _TUXY_WIN_FIRST_TILEne_new = nand2(_SYLO_WIN_HITn_new, pix_pipe.SOVY_WIN_HITp.qp_new());
  ...
  /*#p24.VYBO*/ wire _VYBO_CLKPIPE_xBxDxFxH_clknew = nor3(FEPO_STORE_MATCHp.qp_old(), _WODU_HBLANKp_old, _MYVO_AxCxExGx_clk); // FIXME old/new - but does it really matter here?

  /*#p24.SOCY*/ wire _SOCY_WIN_HITn_new = not1(TOMU_WIN_HITp_new);
  ...
  /*#p24.SEGU*/ wire SEGU_CLKPIPE_AxCxExGx_clknew = not1(_TYFA_CLKPIPE_xBxDxFxH_clknew);

  /*#p24.ROXO*/ wire _ROXO_CLKPIPE_xBxDxFxH_clknew = not1(SEGU_CLKPIPE_AxCxExGx_clknew);

  {
    /* p27.ROCO*/ wire _ROCO_CLKPIPE_xBxDxFxH_clknew = not1(SEGU_CLKPIPE_AxCxExGx_clknew);
    /* p27.PYCO*/ pix_pipe.PYCO_WIN_MATCHp.dff17(_ROCO_CLKPIPE_xBxDxFxH_clknew, _XAPO_VID_RSTn_new, _NUKO_WX_MATCHp_old);
  }

  {
    ...
    /* p27.RENE*/ pix_pipe.RENE_WIN_FETCHn_B.dff17(_ALET_xBxDxFxH_clk,            pix_pipe.XYMU_RENDERINGn.qn_new(), pix_pipe.RYFA_WIN_FETCHn_A.qp_chain());
    /* p27.RYFA*/ pix_pipe.RYFA_WIN_FETCHn_A.dff17(SEGU_CLKPIPE_AxCxExGx_clknew, pix_pipe.XYMU_RENDERINGn.qn_new(), _PANY_WIN_FETCHn_old);
    /* p27.SEKO*/ wire _SEKO_WIN_FETCH_TRIGp_new = nor2(pix_pipe.RYFA_WIN_FETCHn_A.qn_new(), pix_pipe.RENE_WIN_FETCHn_B.qp_new());
    /* p27.TEVO*/ TEVO_FETCH_TRIGp.set(or3(_SEKO_WIN_FETCH_TRIGp_new, _SUZU_WIN_FIRST_TILEne_new, TAVE_PRELOAD_DONE_TRIGp.qp_new())); // Schematic wrong, this is OR
  }
  {
    /* p27.NYFO*/ wire _NYFO_WIN_MODE_TRIGn_new = not1(NUNY_WIN_MODE_TRIGp.qp_new());
    /* p27.MOSU*/ wire _MOSU_WIN_MODE_TRIGp_new = not1(_NYFO_WIN_MODE_TRIGn_new);
    /* p27.NYXU*/ NYXU_BFETCH_RSTn.set(nor3(AVAP_SCAN_DONE_TRIGp.qp_new(), _MOSU_WIN_MODE_TRIGp_new, TEVO_FETCH_TRIGp.qp_new()));
  }
  ...
  {
    {
      /* p27.VETU*/ wire _VETU_WIN_MAP_clknew = and2(TEVO_FETCH_TRIGp.qp_new(), PORE_WIN_MODEp_new);
      /* p27.XAHY*/ wire _XAHY_LINE_TRIGn_new = not1(ATEJ_LINE_TRIGp.qp_new());
      /*#p27.XOFO*/ wire _XOFO_WIN_RSTp_new   = nand3(pix_pipe.WYMO_LCDC_WINENn.qn_new(), _XAHY_LINE_TRIGn_new, _XAPO_VID_RSTn_new);
      /* p27.XACO*/ wire _XACO_WIN_RSTn_new = not1(_XOFO_WIN_RSTp_new);
      /* p27.WYKA*/ pix_pipe.WYKA_WIN_X3.dff17(_VETU_WIN_MAP_clknew,          _XACO_WIN_RSTn_new, pix_pipe.WYKA_WIN_X3.qn_chain());
      /* p27.WODY*/ pix_pipe.WODY_WIN_X4.dff17(pix_pipe.WYKA_WIN_X3.qn_new(), _XACO_WIN_RSTn_new, pix_pipe.WODY_WIN_X4.qn_chain());
      /* p27.WOBO*/ pix_pipe.WOBO_WIN_X5.dff17(pix_pipe.WODY_WIN_X4.qn_new(), _XACO_WIN_RSTn_new, pix_pipe.WOBO_WIN_X5.qn_chain());
      /* p27.WYKO*/ pix_pipe.WYKO_WIN_X6.dff17(pix_pipe.WOBO_WIN_X5.qn_new(), _XACO_WIN_RSTn_new, pix_pipe.WYKO_WIN_X6.qn_chain());
      /* p27.XOLO*/ pix_pipe.XOLO_WIN_X7.dff17(pix_pipe.WYKO_WIN_X6.qn_new(), _XACO_WIN_RSTn_new, pix_pipe.XOLO_WIN_X7.qn_chain());
    }

    {
      ...
      /* p27.VYNO*/ pix_pipe.VYNO_WIN_Y0.dff17(_WAZY_WIN_Y_CLKp,              _SYNY_VBLANKn_new, pix_pipe.VYNO_WIN_Y0.qn_chain());
      /* p27.VUJO*/ pix_pipe.VUJO_WIN_Y1.dff17(pix_pipe.VYNO_WIN_Y0.qn_new(), _SYNY_VBLANKn_new, pix_pipe.VUJO_WIN_Y1.qn_chain());
      /* p27.VYMU*/ pix_pipe.VYMU_WIN_Y2.dff17(pix_pipe.VUJO_WIN_Y1.qn_new(), _SYNY_VBLANKn_new, pix_pipe.VYMU_WIN_Y2.qn_chain());
      /* p27.TUFU*/ pix_pipe.TUFU_WIN_Y3.dff17(pix_pipe.VYMU_WIN_Y2.qn_new(), _SYNY_VBLANKn_new, pix_pipe.TUFU_WIN_Y3.qn_chain());
      /* p27.TAXA*/ pix_pipe.TAXA_WIN_Y4.dff17(pix_pipe.TUFU_WIN_Y3.qn_new(), _SYNY_VBLANKn_new, pix_pipe.TAXA_WIN_Y4.qn_chain());
      /* p27.TOZO*/ pix_pipe.TOZO_WIN_Y5.dff17(pix_pipe.TAXA_WIN_Y4.qn_new(), _SYNY_VBLANKn_new, pix_pipe.TOZO_WIN_Y5.qn_chain());
      /* p27.TATE*/ pix_pipe.TATE_WIN_Y6.dff17(pix_pipe.TOZO_WIN_Y5.qn_new(), _SYNY_VBLANKn_new, pix_pipe.TATE_WIN_Y6.qn_chain());
      /* p27.TEKE*/ pix_pipe.TEKE_WIN_Y7.dff17(pix_pipe.TATE_WIN_Y6.qn_new(), _SYNY_VBLANKn_new, pix_pipe.TEKE_WIN_Y7.qn_chain());
    }
  }
  ...
  [this, _LYFE_VID_RSTn_new, _LYHA_VID_RSTp_new]() {
    /*#p21.TALU*/ wire _TALU_xxCDEFxx_clknew = not1(clk_reg.VENA_xxCDEFxxp.qn_new());
    ...
    /*#p21.SAXO*/ lcd_reg.SAXO_LX0p.dff17(_TALU_xxCDEFxx_clknew,        _MUDE_X_RSTn_new, lcd_reg.SAXO_LX0p.qn_chain());
    /*#p21.TYPO*/ lcd_reg.TYPO_LX1p.dff17(lcd_reg.SAXO_LX0p.qn_new(),   _MUDE_X_RSTn_new, lcd_reg.TYPO_LX1p.qn_chain());
    /*#p21.VYZO*/ lcd_reg.VYZO_LX2p.dff17(lcd_reg.TYPO_LX1p.qn_new(),   _MUDE_X_RSTn_new, lcd_reg.VYZO_LX2p.qn_chain());
    /*#p21.TELU*/ lcd_reg.TELU_LX3p.dff17(lcd_reg.VYZO_LX2p.qn_new(),   _MUDE_X_RSTn_new, lcd_reg.TELU_LX3p.qn_chain());
    /*#p21.SUDE*/ lcd_reg.SUDE_LX4p.dff17(lcd_reg.TELU_LX3p.qn_new(),   _MUDE_X_RSTn_new, lcd_reg.SUDE_LX4p.qn_chain());
    /*#p21.TAHA*/ lcd_reg.TAHA_LX5p.dff17(lcd_reg.SUDE_LX4p.qn_new(),   _MUDE_X_RSTn_new, lcd_reg.TAHA_LX5p.qn_chain());
    /*#p21.TYRY*/ lcd_reg.TYRY_LX6p.dff17(lcd_reg.TAHA_LX5p.qn_new(),   _MUDE_X_RSTn_new, lcd_reg.TYRY_LX6p.qn_chain());

    /*#p21.LAMA*/ wire _LAMA_Y_RSTn_new = nor2(lcd_reg.MYTA_y153p.qp_new(), _LYHA_VID_RSTp_new);
    /*#p21.MUWY*/ lcd_reg.MUWY_LY0p.dff17(lcd_reg.RUTU_x113p.qp_new(),  _LAMA_Y_RSTn_new, lcd_reg.MUWY_LY0p.qn_chain());
    /*#p21.MYRO*/ lcd_reg.MYRO_LY1p.dff17(lcd_reg.MUWY_LY0p.qn_new(),   _LAMA_Y_RSTn_new, lcd_reg.MYRO_LY1p.qn_chain());
    /*#p21.LEXA*/ lcd_reg.LEXA_LY2p.dff17(lcd_reg.MYRO_LY1p.qn_new(),   _LAMA_Y_RSTn_new, lcd_reg.LEXA_LY2p.qn_chain());
    /*#p21.LYDO*/ lcd_reg.LYDO_LY3p.dff17(lcd_reg.LEXA_LY2p.qn_new(),   _LAMA_Y_RSTn_new, lcd_reg.LYDO_LY3p.qn_chain());
    /*#p21.LOVU*/ lcd_reg.LOVU_LY4p.dff17(lcd_reg.LYDO_LY3p.qn_new(),   _LAMA_Y_RSTn_new, lcd_reg.LOVU_LY4p.qn_chain());
    /*#p21.LEMA*/ lcd_reg.LEMA_LY5p.dff17(lcd_reg.LOVU_LY4p.qn_new(),   _LAMA_Y_RSTn_new, lcd_reg.LEMA_LY5p.qn_chain());
    /*#p21.MATO*/ lcd_reg.MATO_LY6p.dff17(lcd_reg.LEMA_LY5p.qn_new(),   _LAMA_Y_RSTn_new, lcd_reg.MATO_LY6p.qn_chain());
    /*#p21.LAFO*/ lcd_reg.LAFO_LY7p.dff17(lcd_reg.MATO_LY6p.qn_new(),   _LAMA_Y_RSTn_new, lcd_reg.LAFO_LY7p.qn_chain());
  }();
  ...
  //----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
  // Background/window tile fetch sequencer & tile temp storage

  /* p27.SOWO*/ wire _SOWO_SFETCH_RUNNINGn_old = not1(sprite_fetcher.TAKA_SFETCH_RUNNINGp.qp_old());
  /* p27.TEKY*/ wire _TEKY_SFETCH_REQp_old = and4(FEPO_STORE_MATCHp.qp_old(), _TUKU_WIN_HITn_old, _LYRY_BFETCH_DONEp_old, _SOWO_SFETCH_RUNNINGn_old);

  //[this, _MYVO_AxCxExGx_clk, _ALET_xBxDxFxH_clk]()
  {
    ...
    /* p27.LAXU*/ tile_fetcher.LAXU_BFETCH_S0p.RSTn(NYXU_BFETCH_RSTn.qp_new());
    /* p27.MESU*/ tile_fetcher.MESU_BFETCH_S1p.RSTn(NYXU_BFETCH_RSTn.qp_new());
    /* p27.NYVA*/ tile_fetcher.NYVA_BFETCH_S2p.RSTn(NYXU_BFETCH_RSTn.qp_new());

    /* p27.MOCE*/ wire _MOCE_BFETCH_DONEn_mid = nand3(tile_fetcher.LAXU_BFETCH_S0p.qp_new(), tile_fetcher.NYVA_BFETCH_S2p.qp_new(), NYXU_BFETCH_RSTn.qp_new());
    /* p27.LEBO*/ wire _LEBO_AxCxExGx_clkmid = nand2(_ALET_xBxDxFxH_clk, _MOCE_BFETCH_DONEn_mid);

    /* p27.LAXU*/ tile_fetcher.LAXU_BFETCH_S0p.dff17(_LEBO_AxCxExGx_clkmid,                 NYXU_BFETCH_RSTn.qp_new(), tile_fetcher.LAXU_BFETCH_S0p.qn_new());
    /* p27.MESU*/ tile_fetcher.MESU_BFETCH_S1p.dff17(tile_fetcher.LAXU_BFETCH_S0p.qn_new(), NYXU_BFETCH_RSTn.qp_new(), tile_fetcher.MESU_BFETCH_S1p.qn_new());
    /* p27.NYVA*/ tile_fetcher.NYVA_BFETCH_S2p.dff17(tile_fetcher.MESU_BFETCH_S1p.qn_new(), NYXU_BFETCH_RSTn.qp_new(), tile_fetcher.NYVA_BFETCH_S2p.qn_new());

    /* p27.LOVY*/ tile_fetcher.LOVY_FETCH_DONEp.dff17(_MYVO_AxCxExGx_clk, NYXU_BFETCH_RSTn.qp_new(), _LYRY_BFETCH_DONEp_old);
    /* p27.LURY*/ wire _LURY_BG_FETCH_DONEn_new = and2(tile_fetcher.LOVY_FETCH_DONEp.qn_new(), pix_pipe.XYMU_RENDERINGn.qn_new());
    /* p27.LONY*/ tile_fetcher.LONY_FETCHINGp.nand_latch(NYXU_BFETCH_RSTn.qp_new(), _LURY_BG_FETCH_DONEn_new);
  }
  //();
...

  {
    ...
    /*#p27.MYSO*/ wire _MYSO_BG_TRIGp_new = nor3(LOBY_RENDERINGn_new, _LAXE_BFETCH_S0n_new, tile_fetcher.LYZU_BFETCH_S0p_D1.qp_new()); // MYSO fires on fetch phase 2, 6, 10
    {
      ...
      /* p32.LEGU*/ vram_bus.LEGU_TILE_DA0n.dff8p(_LOMA_LATCH_TILE_DAn_new, BUS_VRAM_Dp[0].qp_old());
      /* p32.NUDU*/ vram_bus.NUDU_TILE_DA1n.dff8p(_LOMA_LATCH_TILE_DAn_new, BUS_VRAM_Dp[1].qp_old());
      /* p32.MUKU*/ vram_bus.MUKU_TILE_DA2n.dff8p(_LOMA_LATCH_TILE_DAn_new, BUS_VRAM_Dp[2].qp_old());
      /* p32.LUZO*/ vram_bus.LUZO_TILE_DA3n.dff8p(_LOMA_LATCH_TILE_DAn_new, BUS_VRAM_Dp[3].qp_old());
      /* p32.MEGU*/ vram_bus.MEGU_TILE_DA4n.dff8p(_LOMA_LATCH_TILE_DAn_new, BUS_VRAM_Dp[4].qp_old());
      /* p32.MYJY*/ vram_bus.MYJY_TILE_DA5n.dff8p(_LOMA_LATCH_TILE_DAn_new, BUS_VRAM_Dp[5].qp_old());
      /* p32.NASA*/ vram_bus.NASA_TILE_DA6n.dff8p(_LOMA_LATCH_TILE_DAn_new, BUS_VRAM_Dp[6].qp_old());
      /* p32.NEFO*/ vram_bus.NEFO_TILE_DA7n.dff8p(_LOMA_LATCH_TILE_DAn_new, BUS_VRAM_Dp[7].qp_old());
    }

    {
      ...
      /* p32.RAWU*/ vram_bus.RAWU_TILE_DB0p.dff11(_LABU_LATCH_TILE_DBn_new, _VYPO_VCC, BUS_VRAM_Dp[0].qp_old());
      /* p32.POZO*/ vram_bus.POZO_TILE_DB1p.dff11(_LABU_LATCH_TILE_DBn_new, _VYPO_VCC, BUS_VRAM_Dp[1].qp_old());
      /* p32.PYZO*/ vram_bus.PYZO_TILE_DB2p.dff11(_LABU_LATCH_TILE_DBn_new, _VYPO_VCC, BUS_VRAM_Dp[2].qp_old());
      /* p32.POXA*/ vram_bus.POXA_TILE_DB3p.dff11(_LABU_LATCH_TILE_DBn_new, _VYPO_VCC, BUS_VRAM_Dp[3].qp_old());
      /* p32.PULO*/ vram_bus.PULO_TILE_DB4p.dff11(_LABU_LATCH_TILE_DBn_new, _VYPO_VCC, BUS_VRAM_Dp[4].qp_old());
      /* p32.POJU*/ vram_bus.POJU_TILE_DB5p.dff11(_LABU_LATCH_TILE_DBn_new, _VYPO_VCC, BUS_VRAM_Dp[5].qp_old());
      /* p32.POWY*/ vram_bus.POWY_TILE_DB6p.dff11(_LABU_LATCH_TILE_DBn_new, _VYPO_VCC, BUS_VRAM_Dp[6].qp_old());
      /* p32.PYJU*/ vram_bus.PYJU_TILE_DB7p.dff11(_LABU_LATCH_TILE_DBn_new, _VYPO_VCC, BUS_VRAM_Dp[7].qp_old());
    }
  }
  ...
  /*#p29.TULY*/ wire _TULY_SFETCH_S1p_old = sprite_fetcher.TULY_SFETCH_S1p.qp_old();
  /*#p29.VONU*/ wire _VONU_SFETCH_S1p_D4_old = sprite_fetcher.VONU_SFETCH_S1p_D4.qp_old();

  [this, _ALET_xBxDxFxH_clk, _XAPO_VID_RSTn_new, _TEKY_SFETCH_REQp_old]() {
    wire _VYPO_VCC = 1;
    ...
    /* p27.SUDA*/ sprite_fetcher.SUDA_SFETCH_REQp.dff17(_LAPE_AxCxExGx_clk, _VYPO_VCC, sprite_fetcher.SOBU_SFETCH_REQp.qp_chain());
    ...
    /*#p27.SECA*/ wire _SECA_SFETCH_RSTn_new = nor3(_RYCE_SFETCH_TRIGp_new, _ROSY_VID_RSTp_new, ATEJ_LINE_TRIGp.qp_new());

    /*#p29.TYFO*/ sprite_fetcher.TYFO_SFETCH_S0p_D1.dff17(_LAPE_AxCxExGx_clk, _VYPO_VCC,                         sprite_fetcher.TOXE_SFETCH_S0p.qp_chain());
    /*#p29.SEBA*/ sprite_fetcher.SEBA_SFETCH_S1p_D5.dff17(_LAPE_AxCxExGx_clk, pix_pipe.XYMU_RENDERINGn.qn_new(), sprite_fetcher.VONU_SFETCH_S1p_D4.qp_chain());
    /*#p29.VONU*/ sprite_fetcher.VONU_SFETCH_S1p_D4.dff17(_TAVA_xBxDxFxH_clk, pix_pipe.XYMU_RENDERINGn.qn_new(), sprite_fetcher.TOBU_SFETCH_S1p_D2.qp_chain());
    /*#p29.TOBU*/ sprite_fetcher.TOBU_SFETCH_S1p_D2.dff17(_TAVA_xBxDxFxH_clk, pix_pipe.XYMU_RENDERINGn.qn_new(), sprite_fetcher.TULY_SFETCH_S1p.qp_chain());
    ...
    /*#p29.TESE*/ sprite_fetcher.TESE_SFETCH_S2p.RSTn(_SECA_SFETCH_RSTn_new);
    ...
    /*#p29.TOXE*/ sprite_fetcher.TOXE_SFETCH_S0p.dff17(_TOMA_SFETCH_xBxDxFxH_clknew,            _SECA_SFETCH_RSTn_new, sprite_fetcher.TOXE_SFETCH_S0p.qn_new());
    /*#p29.TULY*/ sprite_fetcher.TULY_SFETCH_S1p.dff17(sprite_fetcher.TOXE_SFETCH_S0p.qn_new(), _SECA_SFETCH_RSTn_new, sprite_fetcher.TULY_SFETCH_S1p.qn_new());
    /*#p29.TESE*/ sprite_fetcher.TESE_SFETCH_S2p.dff17(sprite_fetcher.TULY_SFETCH_S1p.qn_new(), _SECA_SFETCH_RSTn_new, sprite_fetcher.TESE_SFETCH_S2p.qn_new());
    ...
    /* p29.WUTY*/ WUTY_SFETCH_DONEp.set(not1(_VUSA_SPRITE_DONEn_new));
    /* p27.VEKU*/ wire _VEKU_SFETCH_RUNNING_RSTn_new = nor2(WUTY_SFETCH_DONEp.qp_new(), TAVE_PRELOAD_DONE_TRIGp.qp_new()); // def nor
    /* p27.TAKA*/ sprite_fetcher.TAKA_SFETCH_RUNNINGp.nand_latch(_SECA_SFETCH_RSTn_new, _VEKU_SFETCH_RUNNING_RSTn_new);
  }();

  /* p29.SAKY*/ wire _SAKY_SFETCH_new = nor2(sprite_fetcher.TULY_SFETCH_S1p.qp_new(), sprite_fetcher.VONU_SFETCH_S1p_D4.qp_new());
  /* p29.TYSO*/ wire _TYSO_SFETCHINGn_new = or2(_SAKY_SFETCH_new, TEPA_RENDERINGp_new); // def or
  /* p29.TEXY*/ wire TEXY_SFETCHINGp_new = not1(_TYSO_SFETCHINGn_new);

  //----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
  // Fine scroll matcher

  [this, _MOXE_AxCxExGx_clk, _ROXO_CLKPIPE_xBxDxFxH_clknew]() {
    ...
    /*#p27.PASO*/ wire _PASO_FINE_RST_new = nor2(_PAHA_RENDERINGn_new, TEVO_FETCH_TRIGp.qp_new());
  ...
  /*#p24.SACU*/ wire _SACU_CLKPIPE_AxCxExGx_clknew = or2(SEGU_CLKPIPE_AxCxExGx_clknew, pix_pipe.ROXY_SCX_FINE_MATCH_LATCHn.qp_new());

  //----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
  // Pixel counter

  [this, _TOFU_VID_RSTp_new, _SACU_CLKPIPE_AxCxExGx_clknew]() {

    // Pixel counter, has carry lookahead because this can increment every tcycle
    /* p21.RYBO*/ wire _RYBO_old = xor2(pix_pipe.XEHO_PX0p.qp_chain(), pix_pipe.SAVY_PX1p.qp_chain()); // XOR layout 1, feet facing gnd, this should def be regular xor
    /* p21.XUKE*/ wire _XUKE_old = and2(pix_pipe.XEHO_PX0p.qp_chain(), pix_pipe.SAVY_PX1p.qp_chain());
    /* p21.XYLE*/ wire _XYLE_old = and2(pix_pipe.XODU_PX2p.qp_chain(), _XUKE_old);
    /* p21.XEGY*/ wire _XEGY_old = xor2(pix_pipe.XODU_PX2p.qp_chain(), _XUKE_old); // feet facing gnd
    /* p21.XORA*/ wire _XORA_old = xor2(pix_pipe.XYDO_PX3p.qp_chain(), _XYLE_old); // feet facing gnd

    /* p21.TADY*/ wire _TADY_LINE_RSTn_new  = nor2(ATEJ_LINE_TRIGp.qp_new(), _TOFU_VID_RSTp_new);
    /* p21.XEHO*/ pix_pipe.XEHO_PX0p.dff17(_SACU_CLKPIPE_AxCxExGx_clknew, _TADY_LINE_RSTn_new, pix_pipe.XEHO_PX0p.qn_chain());
    ...
    /* p21.SAKE*/ wire _SAKE_old = xor2(pix_pipe.TUHU_PX4p.qp_chain(), pix_pipe.TUKY_PX5p.qp_chain());
    /* p21.TYBA*/ wire _TYBA_old = and2(pix_pipe.TUHU_PX4p.qp_chain(), pix_pipe.TUKY_PX5p.qp_chain());
    /* p21.SURY*/ wire _SURY_old = and2(pix_pipe.TAKO_PX6p.qp_chain(), _TYBA_old);
    /* p21.TYGE*/ wire _TYGE_old = xor2(pix_pipe.TAKO_PX6p.qp_chain(), _TYBA_old);
    /* p21.ROKU*/ wire _ROKU_old = xor2(pix_pipe.SYBE_PX7p.qp_chain(), _SURY_old);

    /* p21.TUHU*/ pix_pipe.TUHU_PX4p.dff17(_TOCA_new, _TADY_LINE_RSTn_new, pix_pipe.TUHU_PX4p.qn_chain());
  ...
  //--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
  // OAM latch to temp storage. Has to be up here because it reads the _old_ oam latch and the temp stores are immediately used by the sprite matcher.

  wire _BAXO_OAM_DB5p_old = oam_bus.BAXO_OAM_DB5p.qp_old();
  ...
  /* p29.TUVO*/ wire _TUVO_PPU_OAM_RDp_new = nor3(TEPA_RENDERINGp_new, sprite_fetcher.TULY_SFETCH_S1p.qp_new(), sprite_fetcher.TESE_SFETCH_S2p.qp_new());

  {
    ...
    /*#p29.XUSO*/ oam_bus.XUSO_OAM_DA0p.dff8n(_YWOK_OAM_CLKp_new, oam_bus.YDYV_OAM_LATCH_DA0n.qp_old());
    /* p29.XEGU*/ oam_bus.XEGU_OAM_DA1p.dff8n(_YWOK_OAM_CLKp_new, oam_bus.YCEB_OAM_LATCH_DA1n.qp_old());
    /* p29.YJEX*/ oam_bus.YJEX_OAM_DA2p.dff8n(_YWOK_OAM_CLKp_new, oam_bus.ZUCA_OAM_LATCH_DA2n.qp_old());
    /* p29.XYJU*/ oam_bus.XYJU_OAM_DA3p.dff8n(_YWOK_OAM_CLKp_new, oam_bus.WONE_OAM_LATCH_DA3n.qp_old());
    /* p29.YBOG*/ oam_bus.YBOG_OAM_DA4p.dff8n(_YWOK_OAM_CLKp_new, oam_bus.ZAXE_OAM_LATCH_DA4n.qp_old());
    /* p29.WYSO*/ oam_bus.WYSO_OAM_DA5p.dff8n(_YWOK_OAM_CLKp_new, oam_bus.XAFU_OAM_LATCH_DA5n.qp_old());
    /* p29.XOTE*/ oam_bus.XOTE_OAM_DA6p.dff8n(_YWOK_OAM_CLKp_new, oam_bus.YSES_OAM_LATCH_DA6n.qp_old());
    /* p29.YZAB*/ oam_bus.YZAB_OAM_DA7p.dff8n(_YWOK_OAM_CLKp_new, oam_bus.ZECA_OAM_LATCH_DA7n.qp_old());

    /* p31.XEGA*/ wire _XEGA_OAM_CLKp_new = not1(_COTA_OAM_CLKn_new);
    /* p31.YLOR*/ oam_bus.YLOR_OAM_DB0p.dff8n(_XEGA_OAM_CLKp_new, oam_bus.XYKY_OAM_LATCH_DB0n.qp_old());
    /* p31.ZYTY*/ oam_bus.ZYTY_OAM_DB1p.dff8n(_XEGA_OAM_CLKp_new, oam_bus.YRUM_OAM_LATCH_DB1n.qp_old());
    /* p31.ZYVE*/ oam_bus.ZYVE_OAM_DB2p.dff8n(_XEGA_OAM_CLKp_new, oam_bus.YSEX_OAM_LATCH_DB2n.qp_old());
    /* p31.ZEZY*/ oam_bus.ZEZY_OAM_DB3p.dff8n(_XEGA_OAM_CLKp_new, oam_bus.YVEL_OAM_LATCH_DB3n.qp_old());
    /* p31.GOMO*/ oam_bus.GOMO_OAM_DB4p.dff8n(_XEGA_OAM_CLKp_new, oam_bus.WYNO_OAM_LATCH_DB4n.qp_old());
    /* p31.BAXO*/ oam_bus.BAXO_OAM_DB5p.dff8n(_XEGA_OAM_CLKp_new, oam_bus.CYRA_OAM_LATCH_DB5n.qp_old());
    /* p31.YZOS*/ oam_bus.YZOS_OAM_DB6p.dff8n(_XEGA_OAM_CLKp_new, oam_bus.ZUVE_OAM_LATCH_DB6n.qp_old());
    /* p31.DEPO*/ oam_bus.DEPO_OAM_DB7p.dff8n(_XEGA_OAM_CLKp_new, oam_bus.ECED_OAM_LATCH_DB7n.qp_old());
  }

  //--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
  // Sprite Y matcher. This is using an adder as a subtracter by inverting the first input.

  [this, _ZEME_AxCxExGx_clk, _XOCE_xBCxxFGx_clknew, _XAPO_VID_RSTn_new]() {
    wire GND = 0;
...
#pragma warning(pop)
  ...
  [this, _AMYG_VID_RSTp_new, _ZAGO_SPX0n_old, _ZOCY_SPX1n_old, _YPUR_SPX2n_old, _YVOK_SPX3n_old, _COSE_SPX4n_old, _AROP_SPX5n_old, _XATU_SPX6n_old, _BADY_SPX7n_old]() {
    /* p28.ABAK*/ wire _ABAK_LINE_RSTp_new =  or2(ATEJ_LINE_TRIGp.qp_new(), _AMYG_VID_RSTp_new);
    ...
    /*#p28.AZYB*/ wire _AZYB_LINE_TRIGn = not1(ATEJ_LINE_TRIGp.qp_new());
    ...
    {
      /* p29.EBOJ*/ sprite_store.EBOJ_STORE0_RSTp.dff17(WUTY_SFETCH_DONEp.qp_new(), _BYVA_LINE_RSTn_new, GUVA_SPRITE0_GETp.qp_old());
      /* p29.CEDY*/ sprite_store.CEDY_STORE1_RSTp.dff17(WUTY_SFETCH_DONEp.qp_new(), _BYVA_LINE_RSTn_new, ENUT_SPRITE1_GETp.qp_old());
      /* p29.EGAV*/ sprite_store.EGAV_STORE2_RSTp.dff17(WUTY_SFETCH_DONEp.qp_new(), _BYVA_LINE_RSTn_new, EMOL_SPRITE2_GETp.qp_old());
      /* p29.GOTA*/ sprite_store.GOTA_STORE3_RSTp.dff17(WUTY_SFETCH_DONEp.qp_new(), _BYVA_LINE_RSTn_new, GYFY_SPRITE3_GETp.qp_old());
      /* p29.XUDY*/ sprite_store.XUDY_STORE4_RSTp.dff17(WUTY_SFETCH_DONEp.qp_new(), _BYVA_LINE_RSTn_new, GONO_SPRITE4_GETp.qp_old());
      /* p29.WAFY*/ sprite_store.WAFY_STORE5_RSTp.dff17(WUTY_SFETCH_DONEp.qp_new(), _BYVA_LINE_RSTn_new, GEGA_SPRITE5_GETp.qp_old());
      /* p29.WOMY*/ sprite_store.WOMY_STORE6_RSTp.dff17(WUTY_SFETCH_DONEp.qp_new(), _BYVA_LINE_RSTn_new, XOJA_SPRITE6_GETp.qp_old());
      /* p29.WAPO*/ sprite_store.WAPO_STORE7_RSTp.dff17(WUTY_SFETCH_DONEp.qp_new(), _BYVA_LINE_RSTn_new, GUTU_SPRITE7_GETp.qp_old());
      /* p29.EXUQ*/ sprite_store.EXUQ_STORE8_RSTp.dff17(WUTY_SFETCH_DONEp.qp_new(), _BYVA_LINE_RSTn_new, FOXA_SPRITE8_GETp.qp_old());
      /* p29.FONO*/ sprite_store.FONO_STORE9_RSTp.dff17(WUTY_SFETCH_DONEp.qp_new(), _BYVA_LINE_RSTn_new, GUZE_SPRITE9_GETp.qp_old());
    }

    {
      ...
      /* p30.YGUS*/ sprite_store.YGUS_STORE0_I0n.dff8n(_GENY_STORE0_CLKp_new, SPR_TRI_I[0].qp_old());
      /* p30.YSOK*/ sprite_store.YSOK_STORE0_I1n.dff8n(_GENY_STORE0_CLKp_new, SPR_TRI_I[1].qp_old());
      /* p30.YZEP*/ sprite_store.YZEP_STORE0_I2n.dff8n(_GENY_STORE0_CLKp_new, SPR_TRI_I[2].qp_old());
      /* p30.WYTE*/ sprite_store.WYTE_STORE0_I3n.dff8n(_GENY_STORE0_CLKp_new, SPR_TRI_I[3].qp_old());
      /* p30.ZONY*/ sprite_store.ZONY_STORE0_I4n.dff8n(_GENY_STORE0_CLKp_new, SPR_TRI_I[4].qp_old());
      /* p30.YWAK*/ sprite_store.YWAK_STORE0_I5n.dff8n(_GENY_STORE0_CLKp_new, SPR_TRI_I[5].qp_old());

      /* p30.CADU*/ sprite_store.CADU_STORE1_I0n.dff8n(_BYVY_STORE1_CLKp_new, SPR_TRI_I[0].qp_old());
      /* p30.CEBO*/ sprite_store.CEBO_STORE1_I1n.dff8n(_BYVY_STORE1_CLKp_new, SPR_TRI_I[1].qp_old());
      /* p30.CUFA*/ sprite_store.CUFA_STORE1_I2n.dff8n(_BYVY_STORE1_CLKp_new, SPR_TRI_I[2].qp_old());
      /* p30.COMA*/ sprite_store.COMA_STORE1_I3n.dff8n(_BYVY_STORE1_CLKp_new, SPR_TRI_I[3].qp_old());
      /* p30.CUZA*/ sprite_store.CUZA_STORE1_I4n.dff8n(_BYVY_STORE1_CLKp_new, SPR_TRI_I[4].qp_old());
      /* p30.CAJY*/ sprite_store.CAJY_STORE1_I5n.dff8n(_BYVY_STORE1_CLKp_new, SPR_TRI_I[5].qp_old());

      /* p30.BUHE*/ sprite_store.BUHE_STORE2_I0n.dff8n(_BUZY_STORE2_CLKp_new, SPR_TRI_I[0].qp_old());
      /* p30.BYHU*/ sprite_store.BYHU_STORE2_I1n.dff8n(_BUZY_STORE2_CLKp_new, SPR_TRI_I[1].qp_old());
      /* p30.BECA*/ sprite_store.BECA_STORE2_I2n.dff8n(_BUZY_STORE2_CLKp_new, SPR_TRI_I[2].qp_old());
      /* p30.BULU*/ sprite_store.BULU_STORE2_I3n.dff8n(_BUZY_STORE2_CLKp_new, SPR_TRI_I[3].qp_old());
      /* p30.BUNA*/ sprite_store.BUNA_STORE2_I4n.dff8n(_BUZY_STORE2_CLKp_new, SPR_TRI_I[4].qp_old());
      /* p30.BOXA*/ sprite_store.BOXA_STORE2_I5n.dff8n(_BUZY_STORE2_CLKp_new, SPR_TRI_I[5].qp_old());

      /* p30.DEVY*/ sprite_store.DEVY_STORE3_I0n.dff8n(_FEKA_STORE3_CLKp_new, SPR_TRI_I[0].qp_old());
      /* p30.DESE*/ sprite_store.DESE_STORE3_I1n.dff8n(_FEKA_STORE3_CLKp_new, SPR_TRI_I[1].qp_old());
      /* p30.DUNY*/ sprite_store.DUNY_STORE3_I2n.dff8n(_FEKA_STORE3_CLKp_new, SPR_TRI_I[2].qp_old());
      /* p30.DUHA*/ sprite_store.DUHA_STORE3_I3n.dff8n(_FEKA_STORE3_CLKp_new, SPR_TRI_I[3].qp_old());
      /* p30.DEBA*/ sprite_store.DEBA_STORE3_I4n.dff8n(_FEKA_STORE3_CLKp_new, SPR_TRI_I[4].qp_old());
      /* p30.DAFU*/ sprite_store.DAFU_STORE3_I5n.dff8n(_FEKA_STORE3_CLKp_new, SPR_TRI_I[5].qp_old());

      /* p30.XAVE*/ sprite_store.XAVE_STORE4_I0n.dff8n(_WYLU_STORE4_CLKp_new, SPR_TRI_I[0].qp_old());
      /* p30.XEFE*/ sprite_store.XEFE_STORE4_I1n.dff8n(_WYLU_STORE4_CLKp_new, SPR_TRI_I[1].qp_old());
      /* p30.WANU*/ sprite_store.WANU_STORE4_I2n.dff8n(_WYLU_STORE4_CLKp_new, SPR_TRI_I[2].qp_old());
      /* p30.XABO*/ sprite_store.XABO_STORE4_I3n.dff8n(_WYLU_STORE4_CLKp_new, SPR_TRI_I[3].qp_old());
      /* p30.XEGE*/ sprite_store.XEGE_STORE4_I4n.dff8n(_WYLU_STORE4_CLKp_new, SPR_TRI_I[4].qp_old());
      /* p30.XYNU*/ sprite_store.XYNU_STORE4_I5n.dff8n(_WYLU_STORE4_CLKp_new, SPR_TRI_I[5].qp_old());

      /* p30.EKOP*/ sprite_store.EKOP_STORE5_I0n.dff8n(_DYMO_STORE5_CLKp_new, SPR_TRI_I[0].qp_old());
      /* p30.ETYM*/ sprite_store.ETYM_STORE5_I1n.dff8n(_DYMO_STORE5_CLKp_new, SPR_TRI_I[1].qp_old());
      /* p30.GORU*/ sprite_store.GORU_STORE5_I2n.dff8n(_DYMO_STORE5_CLKp_new, SPR_TRI_I[2].qp_old());
      /* p30.EBEX*/ sprite_store.EBEX_STORE5_I3n.dff8n(_DYMO_STORE5_CLKp_new, SPR_TRI_I[3].qp_old());
      /* p30.ETAV*/ sprite_store.ETAV_STORE5_I4n.dff8n(_DYMO_STORE5_CLKp_new, SPR_TRI_I[4].qp_old());
      /* p30.EKAP*/ sprite_store.EKAP_STORE5_I5n.dff8n(_DYMO_STORE5_CLKp_new, SPR_TRI_I[5].qp_old());

      /* p30.GABO*/ sprite_store.GABO_STORE6_I0n.dff8n(_WUSE_STORE6_CLKp_new, SPR_TRI_I[0].qp_old());
      /* p30.GACY*/ sprite_store.GACY_STORE6_I1n.dff8n(_WUSE_STORE6_CLKp_new, SPR_TRI_I[1].qp_old());
      /* p30.FOGO*/ sprite_store.FOGO_STORE6_I2n.dff8n(_WUSE_STORE6_CLKp_new, SPR_TRI_I[2].qp_old());
      /* p30.GOHU*/ sprite_store.GOHU_STORE6_I3n.dff8n(_WUSE_STORE6_CLKp_new, SPR_TRI_I[3].qp_old());
      /* p30.FOXY*/ sprite_store.FOXY_STORE6_I4n.dff8n(_WUSE_STORE6_CLKp_new, SPR_TRI_I[4].qp_old());
      /* p30.GECU*/ sprite_store.GECU_STORE6_I5n.dff8n(_WUSE_STORE6_CLKp_new, SPR_TRI_I[5].qp_old());

      /* p30.GULE*/ sprite_store.GULE_STORE7_I0n.dff8n(_FEFO_STORE7_CLKp_new, SPR_TRI_I[0].qp_old());
      /* p30.GYNO*/ sprite_store.GYNO_STORE7_I1n.dff8n(_FEFO_STORE7_CLKp_new, SPR_TRI_I[1].qp_old());
      /* p30.FEFA*/ sprite_store.FEFA_STORE7_I2n.dff8n(_FEFO_STORE7_CLKp_new, SPR_TRI_I[2].qp_old());
      /* p30.FYSU*/ sprite_store.FYSU_STORE7_I3n.dff8n(_FEFO_STORE7_CLKp_new, SPR_TRI_I[3].qp_old());
      /* p30.GESY*/ sprite_store.GESY_STORE7_I4n.dff8n(_FEFO_STORE7_CLKp_new, SPR_TRI_I[4].qp_old());
      /* p30.FUZO*/ sprite_store.FUZO_STORE7_I5n.dff8n(_FEFO_STORE7_CLKp_new, SPR_TRI_I[5].qp_old());

      /* p30.AXUV*/ sprite_store.AXUV_STORE8_I0n.dff8n(_AKOL_STORE8_CLKp_new, SPR_TRI_I[0].qp_old());
      /* p30.BADA*/ sprite_store.BADA_STORE8_I1n.dff8n(_AKOL_STORE8_CLKp_new, SPR_TRI_I[1].qp_old());
      /* p30.APEV*/ sprite_store.APEV_STORE8_I2n.dff8n(_AKOL_STORE8_CLKp_new, SPR_TRI_I[2].qp_old());
      /* p30.BADO*/ sprite_store.BADO_STORE8_I3n.dff8n(_AKOL_STORE8_CLKp_new, SPR_TRI_I[3].qp_old());
      /* p30.BEXY*/ sprite_store.BEXY_STORE8_I4n.dff8n(_AKOL_STORE8_CLKp_new, SPR_TRI_I[4].qp_old());
      /* p30.BYHE*/ sprite_store.BYHE_STORE8_I5n.dff8n(_AKOL_STORE8_CLKp_new, SPR_TRI_I[5].qp_old());

      /* p30.YBER*/ sprite_store.YBER_STORE9_I0n.dff8n(_WUFA_STORE9_CLKp_new, SPR_TRI_I[0].qp_old());
      /* p30.YZOR*/ sprite_store.YZOR_STORE9_I1n.dff8n(_WUFA_STORE9_CLKp_new, SPR_TRI_I[1].qp_old());
      /* p30.XYFE*/ sprite_store.XYFE_STORE9_I2n.dff8n(_WUFA_STORE9_CLKp_new, SPR_TRI_I[2].qp_old());
      /* p30.XOTU*/ sprite_store.XOTU_STORE9_I3n.dff8n(_WUFA_STORE9_CLKp_new, SPR_TRI_I[3].qp_old());
      /* p30.XUTE*/ sprite_store.XUTE_STORE9_I4n.dff8n(_WUFA_STORE9_CLKp_new, SPR_TRI_I[4].qp_old());
      /* p30.XUFO*/ sprite_store.XUFO_STORE9_I5n.dff8n(_WUFA_STORE9_CLKp_new, SPR_TRI_I[5].qp_old());
    }

    {
      ...
      /* p30.GYHO*/ sprite_store.GYHO_STORE0_L0n.dff8n(_ENOB_STORE0_CLKp_new, SPR_TRI_L[0].qp_old());
      /* p30.CUFO*/ sprite_store.CUFO_STORE0_L1n.dff8n(_ENOB_STORE0_CLKp_new, SPR_TRI_L[1].qp_old());
      /* p30.BOZU*/ sprite_store.BOZU_STORE0_L2n.dff8n(_ENOB_STORE0_CLKp_new, SPR_TRI_L[2].qp_old());
      /* p30.FYHY*/ sprite_store.FYHY_STORE0_L3n.dff8n(_ENOB_STORE0_CLKp_new, SPR_TRI_L[3].qp_old());

      /* p30.AMES*/ sprite_store.AMES_STORE1_L0n.dff8n(_AHOF_STORE1_CLKp_new, SPR_TRI_L[0].qp_old());
      /* p30.AROF*/ sprite_store.AROF_STORE1_L1n.dff8n(_AHOF_STORE1_CLKp_new, SPR_TRI_L[1].qp_old());
      /* p30.ABOP*/ sprite_store.ABOP_STORE1_L2n.dff8n(_AHOF_STORE1_CLKp_new, SPR_TRI_L[2].qp_old());
      /* p30.ABUG*/ sprite_store.ABUG_STORE1_L3n.dff8n(_AHOF_STORE1_CLKp_new, SPR_TRI_L[3].qp_old());

      /* p30.YLOV*/ sprite_store.YLOV_STORE2_L0n.dff8n(_FUKE_STORE2_CLKp_new, SPR_TRI_L[0].qp_old());
      /* p30.XOSY*/ sprite_store.XOSY_STORE2_L1n.dff8n(_FUKE_STORE2_CLKp_new, SPR_TRI_L[1].qp_old());
      /* p30.XAZY*/ sprite_store.XAZY_STORE2_L2n.dff8n(_FUKE_STORE2_CLKp_new, SPR_TRI_L[2].qp_old());
      /* p30.YKUK*/ sprite_store.YKUK_STORE2_L3n.dff8n(_FUKE_STORE2_CLKp_new, SPR_TRI_L[3].qp_old());

      /* p30.ZURO*/ sprite_store.ZURO_STORE3_L0n.dff8n(_XYHA_STORE3_CLKp_new, SPR_TRI_L[0].qp_old());
      /* p30.ZYLU*/ sprite_store.ZYLU_STORE3_L1n.dff8n(_XYHA_STORE3_CLKp_new, SPR_TRI_L[1].qp_old());
      /* p30.ZENE*/ sprite_store.ZENE_STORE3_L2n.dff8n(_XYHA_STORE3_CLKp_new, SPR_TRI_L[2].qp_old());
      /* p30.ZURY*/ sprite_store.ZURY_STORE3_L3n.dff8n(_XYHA_STORE3_CLKp_new, SPR_TRI_L[3].qp_old());

      /* p30.CAPO*/ sprite_store.CAPO_STORE4_L0n.dff8n(_EWOT_STORE4_CLKp_new, SPR_TRI_L[0].qp_old());
      /* p30.CAJU*/ sprite_store.CAJU_STORE4_L1n.dff8n(_EWOT_STORE4_CLKp_new, SPR_TRI_L[1].qp_old());
      /* p30.CONO*/ sprite_store.CONO_STORE4_L2n.dff8n(_EWOT_STORE4_CLKp_new, SPR_TRI_L[2].qp_old());
      /* p30.CUMU*/ sprite_store.CUMU_STORE4_L3n.dff8n(_EWOT_STORE4_CLKp_new, SPR_TRI_L[3].qp_old());

      /* p30.ACEP*/ sprite_store.ACEP_STORE5_L0n.dff8n(_BUCY_STORE5_CLKp_new, SPR_TRI_L[0].qp_old());
      /* p30.ABEG*/ sprite_store.ABEG_STORE5_L1n.dff8n(_BUCY_STORE5_CLKp_new, SPR_TRI_L[1].qp_old());
      /* p30.ABUX*/ sprite_store.ABUX_STORE5_L2n.dff8n(_BUCY_STORE5_CLKp_new, SPR_TRI_L[2].qp_old());
      /* p30.ANED*/ sprite_store.ANED_STORE5_L3n.dff8n(_BUCY_STORE5_CLKp_new, SPR_TRI_L[3].qp_old());

      /* p30.ZUMY*/ sprite_store.ZUMY_STORE6_L0n.dff8n(_ZURU_STORE6_CLKp_new, SPR_TRI_L[0].qp_old());
      /* p30.ZAFU*/ sprite_store.ZAFU_STORE6_L1n.dff8n(_ZURU_STORE6_CLKp_new, SPR_TRI_L[1].qp_old());
      /* p30.ZEXO*/ sprite_store.ZEXO_STORE6_L2n.dff8n(_ZURU_STORE6_CLKp_new, SPR_TRI_L[2].qp_old());
      /* p30.ZUBE*/ sprite_store.ZUBE_STORE6_L3n.dff8n(_ZURU_STORE6_CLKp_new, SPR_TRI_L[3].qp_old());

      /* p30.XYNA*/ sprite_store.XYNA_STORE7_L0n.dff8n(_WABE_STORE7_CLKp_new, SPR_TRI_L[0].qp_old());
      /* p30.YGUM*/ sprite_store.YGUM_STORE7_L1n.dff8n(_WABE_STORE7_CLKp_new, SPR_TRI_L[1].qp_old());
      /* p30.XAKU*/ sprite_store.XAKU_STORE7_L2n.dff8n(_WABE_STORE7_CLKp_new, SPR_TRI_L[2].qp_old());
      /* p30.XYGO*/ sprite_store.XYGO_STORE7_L3n.dff8n(_WABE_STORE7_CLKp_new, SPR_TRI_L[3].qp_old());

      /* p30.AZAP*/ sprite_store.AZAP_STORE8_L0n.dff8n(_BYMY_STORE8_CLKp_new, SPR_TRI_L[0].qp_old());
      /* p30.AFYX*/ sprite_store.AFYX_STORE8_L1n.dff8n(_BYMY_STORE8_CLKp_new, SPR_TRI_L[1].qp_old());
      /* p30.AFUT*/ sprite_store.AFUT_STORE8_L2n.dff8n(_BYMY_STORE8_CLKp_new, SPR_TRI_L[2].qp_old());
      /* p30.AFYM*/ sprite_store.AFYM_STORE8_L3n.dff8n(_BYMY_STORE8_CLKp_new, SPR_TRI_L[3].qp_old());

      /* p30.CANA*/ sprite_store.CANA_STORE9_L0n.dff8n(_FAKA_STORE9_CLKp_new, SPR_TRI_L[0].qp_old());
      /* p30.FOFO*/ sprite_store.FOFO_STORE9_L1n.dff8n(_FAKA_STORE9_CLKp_new, SPR_TRI_L[1].qp_old());
      /* p30.DYSY*/ sprite_store.DYSY_STORE9_L2n.dff8n(_FAKA_STORE9_CLKp_new, SPR_TRI_L[2].qp_old());
      /* p30.DEWU*/ sprite_store.DEWU_STORE9_L3n.dff8n(_FAKA_STORE9_CLKp_new, SPR_TRI_L[3].qp_old());
    }
  ...
  //--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
  // Sprite store tribuf driver. The value written to the tribuf is read on the _next_ cycle.
  ...
  [this](){
    ...
    /* p29.FURO*/ wire _FURO_SPRITE0_GETn_new = not1(GUVA_SPRITE0_GETp.qp_new());
    /* p29.DYDO*/ wire _DYDO_SPRITE1_GETn_new = not1(ENUT_SPRITE1_GETp.qp_new());
    /* p29.FAME*/ wire _FAME_SPRITE2_GETn_new = not1(EMOL_SPRITE2_GETp.qp_new());
    /* p29.GYMA*/ wire _GYMA_SPRITE3_GETn_new = not1(GYFY_SPRITE3_GETp.qp_new());
    /* p29.GOWO*/ wire _GOWO_SPRITE4_GETn_new = not1(GONO_SPRITE4_GETp.qp_new());
    /* p29.GYGY*/ wire _GYGY_SPRITE5_GETn_new = not1(GEGA_SPRITE5_GETp.qp_new());
    /* p29.XYME*/ wire _XYME_SPRITE6_GETn_new = not1(XOJA_SPRITE6_GETp.qp_new());
    /* p29.GUGY*/ wire _GUGY_SPRITE7_GETn_new = not1(GUTU_SPRITE7_GETp.qp_new());
    /* p29.DENY*/ wire _DENY_SPRITE8_GETn_new = not1(FOXA_SPRITE8_GETp.qp_new());
    /* p29.FADO*/ wire _FADO_SPRITE9_GETn_new = not1(GUZE_SPRITE9_GETp.qp_new());

    /* p30.ZETU*/ SPR_TRI_I[0].tri6_nn(_FURO_SPRITE0_GETn_new, sprite_store.YGUS_STORE0_I0n.qp_new());
    /* p30.ZECE*/ SPR_TRI_I[1].tri6_nn(_FURO_SPRITE0_GETn_new, sprite_store.YSOK_STORE0_I1n.qp_new());
    /* p30.ZAVE*/ SPR_TRI_I[2].tri6_nn(_FURO_SPRITE0_GETn_new, sprite_store.YZEP_STORE0_I2n.qp_new());
    /* p30.WOKO*/ SPR_TRI_I[3].tri6_nn(_FURO_SPRITE0_GETn_new, sprite_store.WYTE_STORE0_I3n.qp_new());
    /* p30.ZUMU*/ SPR_TRI_I[4].tri6_nn(_FURO_SPRITE0_GETn_new, sprite_store.ZONY_STORE0_I4n.qp_new());
    /*#p30.ZEDY*/ SPR_TRI_I[5].tri6_nn(_FURO_SPRITE0_GETn_new, sprite_store.YWAK_STORE0_I5n.qp_new());
    /* p30.WEHE*/ SPR_TRI_L[0].tri6_nn(_FURO_SPRITE0_GETn_new, sprite_store.GYHO_STORE0_L0n.qp_new());
    /* p30.BUKY*/ SPR_TRI_L[1].tri6_nn(_FURO_SPRITE0_GETn_new, sprite_store.CUFO_STORE0_L1n.qp_new());
    /* p30.AJAL*/ SPR_TRI_L[2].tri6_nn(_FURO_SPRITE0_GETn_new, sprite_store.BOZU_STORE0_L2n.qp_new());
    /* p30.GOFO*/ SPR_TRI_L[3].tri6_nn(_FURO_SPRITE0_GETn_new, sprite_store.FYHY_STORE0_L3n.qp_new());

    /*#p30.CUBO*/ SPR_TRI_I[0].tri6_nn(_DYDO_SPRITE1_GETn_new, sprite_store.CADU_STORE1_I0n.qp_new());
    /* p30.CELU*/ SPR_TRI_I[1].tri6_nn(_DYDO_SPRITE1_GETn_new, sprite_store.CEBO_STORE1_I1n.qp_new());
    /* p30.CEGY*/ SPR_TRI_I[2].tri6_nn(_DYDO_SPRITE1_GETn_new, sprite_store.CUFA_STORE1_I2n.qp_new());
    /* p30.BETY*/ SPR_TRI_I[3].tri6_nn(_DYDO_SPRITE1_GETn_new, sprite_store.COMA_STORE1_I3n.qp_new());
    /* p30.CYBY*/ SPR_TRI_I[4].tri6_nn(_DYDO_SPRITE1_GETn_new, sprite_store.CUZA_STORE1_I4n.qp_new());
    /* p30.BEMO*/ SPR_TRI_I[5].tri6_nn(_DYDO_SPRITE1_GETn_new, sprite_store.CAJY_STORE1_I5n.qp_new());
    /* p30.BYRO*/ SPR_TRI_L[0].tri6_nn(_DYDO_SPRITE1_GETn_new, sprite_store.AMES_STORE1_L0n.qp_new());
    /* p30.AHUM*/ SPR_TRI_L[1].tri6_nn(_DYDO_SPRITE1_GETn_new, sprite_store.AROF_STORE1_L1n.qp_new());
    /* p30.BACO*/ SPR_TRI_L[2].tri6_nn(_DYDO_SPRITE1_GETn_new, sprite_store.ABOP_STORE1_L2n.qp_new());
    /* p30.BEFE*/ SPR_TRI_L[3].tri6_nn(_DYDO_SPRITE1_GETn_new, sprite_store.ABUG_STORE1_L3n.qp_new());

    /* p30.CUBE*/ SPR_TRI_I[0].tri6_nn(_FAME_SPRITE2_GETn_new, sprite_store.BUHE_STORE2_I0n.qp_new());
    /* p30.AFOZ*/ SPR_TRI_I[1].tri6_nn(_FAME_SPRITE2_GETn_new, sprite_store.BYHU_STORE2_I1n.qp_new());
    /* p30.APON*/ SPR_TRI_I[2].tri6_nn(_FAME_SPRITE2_GETn_new, sprite_store.BECA_STORE2_I2n.qp_new());
    /* p30.CUVU*/ SPR_TRI_I[3].tri6_nn(_FAME_SPRITE2_GETn_new, sprite_store.BULU_STORE2_I3n.qp_new());
    /* p30.CYRO*/ SPR_TRI_I[4].tri6_nn(_FAME_SPRITE2_GETn_new, sprite_store.BUNA_STORE2_I4n.qp_new());
    /* p30.AXEC*/ SPR_TRI_I[5].tri6_nn(_FAME_SPRITE2_GETn_new, sprite_store.BOXA_STORE2_I5n.qp_new());
    /* p30.ZUKE*/ SPR_TRI_L[0].tri6_nn(_FAME_SPRITE2_GETn_new, sprite_store.YLOV_STORE2_L0n.qp_new());
    /* p30.WERE*/ SPR_TRI_L[1].tri6_nn(_FAME_SPRITE2_GETn_new, sprite_store.XOSY_STORE2_L1n.qp_new());
    /* p30.WUXE*/ SPR_TRI_L[2].tri6_nn(_FAME_SPRITE2_GETn_new, sprite_store.XAZY_STORE2_L2n.qp_new());
    /* p30.ZABY*/ SPR_TRI_L[3].tri6_nn(_FAME_SPRITE2_GETn_new, sprite_store.YKUK_STORE2_L3n.qp_new());

    /* p30.ENAP*/ SPR_TRI_I[0].tri6_nn(_GYMA_SPRITE3_GETn_new, sprite_store.DEVY_STORE3_I0n.qp_new());
    /* p30.DYGO*/ SPR_TRI_I[1].tri6_nn(_GYMA_SPRITE3_GETn_new, sprite_store.DESE_STORE3_I1n.qp_new());
    /* p30.DOWA*/ SPR_TRI_I[2].tri6_nn(_GYMA_SPRITE3_GETn_new, sprite_store.DUNY_STORE3_I2n.qp_new());
    /* p30.DONY*/ SPR_TRI_I[3].tri6_nn(_GYMA_SPRITE3_GETn_new, sprite_store.DUHA_STORE3_I3n.qp_new());
    /* p30.EFUD*/ SPR_TRI_I[4].tri6_nn(_GYMA_SPRITE3_GETn_new, sprite_store.DEBA_STORE3_I4n.qp_new());
    /* p30.DEZU*/ SPR_TRI_I[5].tri6_nn(_GYMA_SPRITE3_GETn_new, sprite_store.DAFU_STORE3_I5n.qp_new());
    /* p30.ZEXE*/ SPR_TRI_L[0].tri6_nn(_GYMA_SPRITE3_GETn_new, sprite_store.ZURO_STORE3_L0n.qp_new());
    /* p30.YWAV*/ SPR_TRI_L[1].tri6_nn(_GYMA_SPRITE3_GETn_new, sprite_store.ZYLU_STORE3_L1n.qp_new());
    /* p30.YJEM*/ SPR_TRI_L[2].tri6_nn(_GYMA_SPRITE3_GETn_new, sprite_store.ZENE_STORE3_L2n.qp_new());
    /* p30.ZYPO*/ SPR_TRI_L[3].tri6_nn(_GYMA_SPRITE3_GETn_new, sprite_store.ZURY_STORE3_L3n.qp_new());

    /* p30.WUXU*/ SPR_TRI_I[0].tri6_nn(_GOWO_SPRITE4_GETn_new, sprite_store.XAVE_STORE4_I0n.qp_new());
    /* p30.WEPY*/ SPR_TRI_I[1].tri6_nn(_GOWO_SPRITE4_GETn_new, sprite_store.XEFE_STORE4_I1n.qp_new());
    /* p30.WERU*/ SPR_TRI_I[2].tri6_nn(_GOWO_SPRITE4_GETn_new, sprite_store.WANU_STORE4_I2n.qp_new());
    /* p30.XYRE*/ SPR_TRI_I[3].tri6_nn(_GOWO_SPRITE4_GETn_new, sprite_store.XABO_STORE4_I3n.qp_new());
    /* p30.WOXY*/ SPR_TRI_I[4].tri6_nn(_GOWO_SPRITE4_GETn_new, sprite_store.XEGE_STORE4_I4n.qp_new());
    /* p30.WAJA*/ SPR_TRI_I[5].tri6_nn(_GOWO_SPRITE4_GETn_new, sprite_store.XYNU_STORE4_I5n.qp_new());
    /* p30.BUCE*/ SPR_TRI_L[0].tri6_nn(_GOWO_SPRITE4_GETn_new, sprite_store.CAPO_STORE4_L0n.qp_new());
    /* p30.BEVY*/ SPR_TRI_L[1].tri6_nn(_GOWO_SPRITE4_GETn_new, sprite_store.CAJU_STORE4_L1n.qp_new());
    /* p30.BOVE*/ SPR_TRI_L[2].tri6_nn(_GOWO_SPRITE4_GETn_new, sprite_store.CONO_STORE4_L2n.qp_new());
    /* p30.BYDO*/ SPR_TRI_L[3].tri6_nn(_GOWO_SPRITE4_GETn_new, sprite_store.CUMU_STORE4_L3n.qp_new());

    /* p30.DOBO*/ SPR_TRI_I[0].tri6_nn(_GYGY_SPRITE5_GETn_new, sprite_store.EKOP_STORE5_I0n.qp_new());
    /* p30.DYNY*/ SPR_TRI_I[1].tri6_nn(_GYGY_SPRITE5_GETn_new, sprite_store.ETYM_STORE5_I1n.qp_new());
    /* p30.WAGA*/ SPR_TRI_I[2].tri6_nn(_GYGY_SPRITE5_GETn_new, sprite_store.GORU_STORE5_I2n.qp_new());
    /* p30.DUZA*/ SPR_TRI_I[3].tri6_nn(_GYGY_SPRITE5_GETn_new, sprite_store.EBEX_STORE5_I3n.qp_new());
    /* p30.DALY*/ SPR_TRI_I[4].tri6_nn(_GYGY_SPRITE5_GETn_new, sprite_store.ETAV_STORE5_I4n.qp_new());
    /* p30.DALO*/ SPR_TRI_I[5].tri6_nn(_GYGY_SPRITE5_GETn_new, sprite_store.EKAP_STORE5_I5n.qp_new());
    /* p30.BACE*/ SPR_TRI_L[0].tri6_nn(_GYGY_SPRITE5_GETn_new, sprite_store.ACEP_STORE5_L0n.qp_new());
    /* p30.BUJA*/ SPR_TRI_L[1].tri6_nn(_GYGY_SPRITE5_GETn_new, sprite_store.ABEG_STORE5_L1n.qp_new());
    /* p30.BODU*/ SPR_TRI_L[2].tri6_nn(_GYGY_SPRITE5_GETn_new, sprite_store.ABUX_STORE5_L2n.qp_new());
    /* p30.AWAT*/ SPR_TRI_L[3].tri6_nn(_GYGY_SPRITE5_GETn_new, sprite_store.ANED_STORE5_L3n.qp_new());

    /* p30.WATO*/ SPR_TRI_I[0].tri6_nn(_XYME_SPRITE6_GETn_new, sprite_store.GABO_STORE6_I0n.qp_new());
    /* p30.WYWY*/ SPR_TRI_I[1].tri6_nn(_XYME_SPRITE6_GETn_new, sprite_store.GACY_STORE6_I1n.qp_new());
    /* p30.EZOC*/ SPR_TRI_I[2].tri6_nn(_XYME_SPRITE6_GETn_new, sprite_store.FOGO_STORE6_I2n.qp_new());
    /* p30.WABO*/ SPR_TRI_I[3].tri6_nn(_XYME_SPRITE6_GETn_new, sprite_store.GOHU_STORE6_I3n.qp_new());
    /* p30.ELYC*/ SPR_TRI_I[4].tri6_nn(_XYME_SPRITE6_GETn_new, sprite_store.FOXY_STORE6_I4n.qp_new());
    /* p30.WOCY*/ SPR_TRI_I[5].tri6_nn(_XYME_SPRITE6_GETn_new, sprite_store.GECU_STORE6_I5n.qp_new());
    /* p30.YBUK*/ SPR_TRI_L[0].tri6_nn(_XYME_SPRITE6_GETn_new, sprite_store.ZUMY_STORE6_L0n.qp_new());
    /* p30.YKOZ*/ SPR_TRI_L[1].tri6_nn(_XYME_SPRITE6_GETn_new, sprite_store.ZAFU_STORE6_L1n.qp_new());
    /* p30.ZYTO*/ SPR_TRI_L[2].tri6_nn(_XYME_SPRITE6_GETn_new, sprite_store.ZEXO_STORE6_L2n.qp_new());
    /* p30.ZUDO*/ SPR_TRI_L[3].tri6_nn(_XYME_SPRITE6_GETn_new, sprite_store.ZUBE_STORE6_L3n.qp_new());

    /* p30.WAKO*/ SPR_TRI_I[0].tri6_nn(_GUGY_SPRITE7_GETn_new, sprite_store.GULE_STORE7_I0n.qp_new());
    /* p30.WYGO*/ SPR_TRI_I[1].tri6_nn(_GUGY_SPRITE7_GETn_new, sprite_store.GYNO_STORE7_I1n.qp_new());
    /* p30.ELEP*/ SPR_TRI_I[2].tri6_nn(_GUGY_SPRITE7_GETn_new, sprite_store.FEFA_STORE7_I2n.qp_new());
    /* p30.ETAD*/ SPR_TRI_I[3].tri6_nn(_GUGY_SPRITE7_GETn_new, sprite_store.FYSU_STORE7_I3n.qp_new());
    /* p30.WABA*/ SPR_TRI_I[4].tri6_nn(_GUGY_SPRITE7_GETn_new, sprite_store.GESY_STORE7_I4n.qp_new());
    /* p30.EVYT*/ SPR_TRI_I[5].tri6_nn(_GUGY_SPRITE7_GETn_new, sprite_store.FUZO_STORE7_I5n.qp_new());
    /* p30.WAXE*/ SPR_TRI_L[0].tri6_nn(_GUGY_SPRITE7_GETn_new, sprite_store.XYNA_STORE7_L0n.qp_new());
    /* p30.YPOZ*/ SPR_TRI_L[1].tri6_nn(_GUGY_SPRITE7_GETn_new, sprite_store.YGUM_STORE7_L1n.qp_new());
    /* p30.WABU*/ SPR_TRI_L[2].tri6_nn(_GUGY_SPRITE7_GETn_new, sprite_store.XAKU_STORE7_L2n.qp_new());
    /* p30.WANA*/ SPR_TRI_L[3].tri6_nn(_GUGY_SPRITE7_GETn_new, sprite_store.XYGO_STORE7_L3n.qp_new());

    /* p30.APOC*/ SPR_TRI_I[0].tri6_nn(_DENY_SPRITE8_GETn_new, sprite_store.AXUV_STORE8_I0n.qp_new());
    /* p30.AKYH*/ SPR_TRI_I[1].tri6_nn(_DENY_SPRITE8_GETn_new, sprite_store.BADA_STORE8_I1n.qp_new());
    /* p30.AFEN*/ SPR_TRI_I[2].tri6_nn(_DENY_SPRITE8_GETn_new, sprite_store.APEV_STORE8_I2n.qp_new());
    /* p30.APYV*/ SPR_TRI_I[3].tri6_nn(_DENY_SPRITE8_GETn_new, sprite_store.BADO_STORE8_I3n.qp_new());
    /* p30.APOB*/ SPR_TRI_I[4].tri6_nn(_DENY_SPRITE8_GETn_new, sprite_store.BEXY_STORE8_I4n.qp_new());
    /* p30.ADYB*/ SPR_TRI_I[5].tri6_nn(_DENY_SPRITE8_GETn_new, sprite_store.BYHE_STORE8_I5n.qp_new());
    /* p30.BOSO*/ SPR_TRI_L[0].tri6_nn(_DENY_SPRITE8_GETn_new, sprite_store.AZAP_STORE8_L0n.qp_new());
    /* p30.BAZU*/ SPR_TRI_L[1].tri6_nn(_DENY_SPRITE8_GETn_new, sprite_store.AFYX_STORE8_L1n.qp_new());
    /* p30.AHAC*/ SPR_TRI_L[2].tri6_nn(_DENY_SPRITE8_GETn_new, sprite_store.AFUT_STORE8_L2n.qp_new());
    /* p30.BUJY*/ SPR_TRI_L[3].tri6_nn(_DENY_SPRITE8_GETn_new, sprite_store.AFYM_STORE8_L3n.qp_new());

    /* p30.ZARO*/ SPR_TRI_I[0].tri6_nn(_FADO_SPRITE9_GETn_new, sprite_store.YBER_STORE9_I0n.qp_new());
    /* p30.ZOJY*/ SPR_TRI_I[1].tri6_nn(_FADO_SPRITE9_GETn_new, sprite_store.YZOR_STORE9_I1n.qp_new());
    /* p30.YNEV*/ SPR_TRI_I[2].tri6_nn(_FADO_SPRITE9_GETn_new, sprite_store.XYFE_STORE9_I2n.qp_new());
    /* p30.XYRA*/ SPR_TRI_I[3].tri6_nn(_FADO_SPRITE9_GETn_new, sprite_store.XOTU_STORE9_I3n.qp_new());
    /* p30.YRAD*/ SPR_TRI_I[4].tri6_nn(_FADO_SPRITE9_GETn_new, sprite_store.XUTE_STORE9_I4n.qp_new());
    /* p30.YHAL*/ SPR_TRI_I[5].tri6_nn(_FADO_SPRITE9_GETn_new, sprite_store.XUFO_STORE9_I5n.qp_new());
    /* p30.BYME*/ SPR_TRI_L[0].tri6_nn(_FADO_SPRITE9_GETn_new, sprite_store.CANA_STORE9_L0n.qp_new());
    /* p30.GATE*/ SPR_TRI_L[1].tri6_nn(_FADO_SPRITE9_GETn_new, sprite_store.FOFO_STORE9_L1n.qp_new());
    /* p30.COHO*/ SPR_TRI_L[2].tri6_nn(_FADO_SPRITE9_GETn_new, sprite_store.DYSY_STORE9_L2n.qp_new());
    /* p30.CAWO*/ SPR_TRI_L[3].tri6_nn(_FADO_SPRITE9_GETn_new, sprite_store.DEWU_STORE9_L3n.qp_new());
    ...
    /*#p30.WUZY*/ SPR_TRI_I[0].tri6_nn(_BUZA_STORE_SPRITE_INDXn_new, sprite_scanner.XADU_SPRITE_IDX0p.qn_new());
    /* p30.WYSE*/ SPR_TRI_I[1].tri6_nn(_BUZA_STORE_SPRITE_INDXn_new, sprite_scanner.XEDY_SPRITE_IDX1p.qn_new());
    /* p30.ZYSU*/ SPR_TRI_I[2].tri6_nn(_BUZA_STORE_SPRITE_INDXn_new, sprite_scanner.ZUZE_SPRITE_IDX2p.qn_new());
    /* p30.WYDA*/ SPR_TRI_I[3].tri6_nn(_BUZA_STORE_SPRITE_INDXn_new, sprite_scanner.XOBE_SPRITE_IDX3p.qn_new());
    /* p30.WUCO*/ SPR_TRI_I[4].tri6_nn(_BUZA_STORE_SPRITE_INDXn_new, sprite_scanner.YDUF_SPRITE_IDX4p.qn_new());
    /* p30.WEZA*/ SPR_TRI_I[5].tri6_nn(_BUZA_STORE_SPRITE_INDXn_new, sprite_scanner.XECU_SPRITE_IDX5p.qn_new());
    ...
    /*#p30.CUCU*/ SPR_TRI_L[0].tri6_nn(FEPO_STORE_MATCHp.qp_new(), _DEGE_SPRITE_DELTA0_new);
    /*#p30.CUCA*/ SPR_TRI_L[1].tri6_nn(FEPO_STORE_MATCHp.qp_new(), _DABY_SPRITE_DELTA1_new);
    /*#p30.CEGA*/ SPR_TRI_L[2].tri6_nn(FEPO_STORE_MATCHp.qp_new(), _DABU_SPRITE_DELTA2_new);
    /*#p30.WENU*/ SPR_TRI_L[3].tri6_nn(FEPO_STORE_MATCHp.qp_new(), _GYSA_SPRITE_DELTA3_new);
  }();

  //--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
  // Sprite flipper + sprite temp storage

  [this, LOBY_RENDERINGn_new, TEPA_RENDERINGp_old, _TYTU_SFETCH_S0n_new, _TULY_SFETCH_S1p_old, _VONU_SFETCH_S1p_D4_old, _BAXO_OAM_DB5p_old]() {
    /* p29.SAKY*/ wire _SAKY_SFETCH_old = nor2(_TULY_SFETCH_S1p_old, _VONU_SFETCH_S1p_D4_old);
    /* p29.TYSO*/ wire _TYSO_SPRITE_READn_old = or2(_SAKY_SFETCH_old, TEPA_RENDERINGp_old); // def or
    ...
    /* p29.SYCU*/ wire _SYCU_SFETCH_S0pe_new = nor3(_TYTU_SFETCH_S0n_new, LOBY_RENDERINGn_new, sprite_fetcher.TYFO_SFETCH_S0p_D1.qp_new());
  ...
  [this, ALUR_SYS_RSTn_new, _BOGA_Axxxxxxx_clk, _ACAT_FF00_RDp_ext, _ATOZ_FF00_WRn_clk]() {
    ...
    /* p05.JUTE*/ joypad.JUTE_JOYP_RA     .dff17(_ATOZ_FF00_WRn_clk, ALUR_SYS_RSTn_new, BUS_CPU_D[0].qp_ext());
    /* p05.KECY*/ joypad.KECY_JOYP_LB     .dff17(_ATOZ_FF00_WRn_clk, ALUR_SYS_RSTn_new, BUS_CPU_D[1].qp_ext());
    /* p05.JALE*/ joypad.JALE_JOYP_UC     .dff17(_ATOZ_FF00_WRn_clk, ALUR_SYS_RSTn_new, BUS_CPU_D[2].qp_ext());
    /* p05.KYME*/ joypad.KYME_JOYP_DS     .dff17(_ATOZ_FF00_WRn_clk, ALUR_SYS_RSTn_new, BUS_CPU_D[3].qp_ext());
    /* p05.KELY*/ joypad.KELY_JOYP_UDLRp  .dff17(_ATOZ_FF00_WRn_clk, ALUR_SYS_RSTn_new, BUS_CPU_D[4].qp_ext());
    /* p05.COFY*/ joypad.COFY_JOYP_ABCSp  .dff17(_ATOZ_FF00_WRn_clk, ALUR_SYS_RSTn_new, BUS_CPU_D[5].qp_ext());
    /* p05.KUKO*/ joypad.KUKO_DBG_FF00_D6n.dff17(_ATOZ_FF00_WRn_clk, ALUR_SYS_RSTn_new, BUS_CPU_D[6].qp_ext());
    /* p05.KERU*/ joypad.KERU_DBG_FF00_D7n.dff17(_ATOZ_FF00_WRn_clk, ALUR_SYS_RSTn_new, BUS_CPU_D[7].qp_ext());
    ...
    */
    ...
    /* p02.KERY*/ wire _KERY_ANY_BUTTONp_ext = or4(PIN_JOY_P13.qp_old(), PIN_JOY_P12.qp_old(), PIN_JOY_P11.qp_old(), PIN_JOY_P10.qp_old());
    ...
    /* p02.APUG*/ joypad.APUG_JP_GLITCH3.dff17(_BOGA_Axxxxxxx_clk, ALUR_SYS_RSTn_new, joypad.AGEM_JP_GLITCH2.qp_chain());
    /* p02.AGEM*/ joypad.AGEM_JP_GLITCH2.dff17(_BOGA_Axxxxxxx_clk, ALUR_SYS_RSTn_new, joypad.ACEF_JP_GLITCH1.qp_chain());
    /* p02.ACEF*/ joypad.ACEF_JP_GLITCH1.dff17(_BOGA_Axxxxxxx_clk, ALUR_SYS_RSTn_new, joypad.BATU_JP_GLITCH0.qp_chain());
    /* p02.BATU*/ joypad.BATU_JP_GLITCH0.dff17(_BOGA_Axxxxxxx_clk, ALUR_SYS_RSTn_new, _KERY_ANY_BUTTONp_ext);

    /* p05.BYZO*/ wire _BYZO_FF00_RDn_ext = not1(_ACAT_FF00_RDp_ext);

    //if (!_BYZO_FF00_RDn_ext) __debugbreak();

    /* p05.KEVU*/ joypad.KEVU_JOYP_L0n.tp_latch(_BYZO_FF00_RDn_ext, PIN_JOY_P10.qp_old());
    /* p05.KAPA*/ joypad.KAPA_JOYP_L1n.tp_latch(_BYZO_FF00_RDn_ext, PIN_JOY_P11.qp_old());
    /* p05.KEJA*/ joypad.KEJA_JOYP_L2n.tp_latch(_BYZO_FF00_RDn_ext, PIN_JOY_P12.qp_old());
    /* p05.KOLO*/ joypad.KOLO_JOYP_L3n.tp_latch(_BYZO_FF00_RDn_ext, PIN_JOY_P13.qp_old());

    /* p05.KEMA*/ BUS_CPU_D[0].tri6_nn(_BYZO_FF00_RDn_ext, joypad.KEVU_JOYP_L0n.qp_new());
    /* p05.KURO*/ BUS_CPU_D[1].tri6_nn(_BYZO_FF00_RDn_ext, joypad.KAPA_JOYP_L1n.qp_new());
    /* p05.KUVE*/ BUS_CPU_D[2].tri6_nn(_BYZO_FF00_RDn_ext, joypad.KEJA_JOYP_L2n.qp_new());
    /* p05.JEKU*/ BUS_CPU_D[3].tri6_nn(_BYZO_FF00_RDn_ext, joypad.KOLO_JOYP_L3n.qp_new());
    /* p05.KOCE*/ BUS_CPU_D[4].tri6_nn(_BYZO_FF00_RDn_ext, joypad.KELY_JOYP_UDLRp.qn_new());
    /* p05.CUDY*/ BUS_CPU_D[5].tri6_nn(_BYZO_FF00_RDn_ext, joypad.COFY_JOYP_ABCSp.qn_new());
    /* p??.????*/ BUS_CPU_D[6].tri6_nn(_BYZO_FF00_RDn_ext, joypad.KUKO_DBG_FF00_D6n.qp_new());
    /* p??.????*/ BUS_CPU_D[7].tri6_nn(_BYZO_FF00_RDn_ext, joypad.KERU_DBG_FF00_D7n.qp_new());
  }();

  //----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
  // Serial

  [this, ALUR_SYS_RSTn_new, _UFEG_FF01_RDp_ext, _URYS_FF01_WRn_clk, _UCOM_FF02_RDp_ext, _UWAM_FF02_WRn_clk]() {
    /* hack */
    PIN_SIN.pin_in(1, 1);

    /* p06.CARO*/ wire _CARO_SER_RST_new = and2(_UWAM_FF02_WRn_clk, ALUR_SYS_RSTn_new);
    ...
    /* p06.CABY*/ wire _CABY_XFER_RESET_new = and2(_COBA_SER_CNT3n_new, ALUR_SYS_RSTn_new);
    /* p06.ETAF*/ ser_reg.ETAF_SER_RUNNING.dff17(_UWAM_FF02_WRn_clk, _CABY_XFER_RESET_new, BUS_CPU_D[7].qp_ext());
    ...
    /* p06.CULY*/ ser_reg.CULY_XFER_DIR.dff17(_UWAM_FF02_WRn_clk, ALUR_SYS_RSTn_new, BUS_CPU_D[0].qp_ext());
    ...
    /* p06.CAGE*/ wire _CAGE_SER_IN_new  = not1(PIN_SIN.qp_old());
    /* p06.EDYL*/ wire _EDYL_SER_CLK_new = not1(_DAWA_SER_clknew);
    /* p06.ELYS*/ ser_reg.ELYS_SER_OUT  .dff17(_EDYL_SER_CLK_new, ALUR_SYS_RSTn_new, ser_reg.EDER_SER_DATA7.qp_chain());
    ...
    /* p06.COHY*/ wire _COHY_SER_DATA0_RSTn_new = or_and3(_URYS_FF01_WRn_clk, BUS_CPU_D[0].qp_ext(), ALUR_SYS_RSTn_new);
    /* p06.DUMO*/ wire _DUMO_SER_DATA1_RSTn_new = or_and3(_URYS_FF01_WRn_clk, BUS_CPU_D[1].qp_ext(), ALUR_SYS_RSTn_new);
    /* p06.DYBO*/ wire _DYBO_SER_DATA2_RSTn_new = or_and3(_URYS_FF01_WRn_clk, BUS_CPU_D[2].qp_ext(), ALUR_SYS_RSTn_new);
    /* p06.DAJU*/ wire _DAJU_SER_DATA3_RSTn_new = or_and3(_URYS_FF01_WRn_clk, BUS_CPU_D[3].qp_ext(), ALUR_SYS_RSTn_new);
    /* p06.DYLY*/ wire _DYLY_SER_DATA4_RSTn_new = or_and3(_URYS_FF01_WRn_clk, BUS_CPU_D[4].qp_ext(), ALUR_SYS_RSTn_new);
    /* p06.EHUJ*/ wire _EHUJ_SER_DATA5_RSTn_new = or_and3(_URYS_FF01_WRn_clk, BUS_CPU_D[5].qp_ext(), ALUR_SYS_RSTn_new);
    /* p06.EFAK*/ wire _EFAK_SER_DATA6_RSTn_new = or_and3(_URYS_FF01_WRn_clk, BUS_CPU_D[6].qp_ext(), ALUR_SYS_RSTn_new);
    /* p06.EGUV*/ wire _EGUV_SER_DATA7_RSTn_new = or_and3(_URYS_FF01_WRn_clk, BUS_CPU_D[7].qp_ext(), ALUR_SYS_RSTn_new);

    /* p06.DAKU*/ wire _DAKU_FF01_WRp_clk = not1(_URYS_FF01_WRn_clk);
    /* p06.CUFU*/ wire _CUFU_SER_DATA0_SETn_new = nand2(BUS_CPU_D[0].qp_ext(), _DAKU_FF01_WRp_clk);
    /* p06.DOCU*/ wire _DOCU_SER_DATA1_SETn_new = nand2(BUS_CPU_D[1].qp_ext(), _DAKU_FF01_WRp_clk);
    /* p06.DELA*/ wire _DELA_SER_DATA2_SETn_new = nand2(BUS_CPU_D[2].qp_ext(), _DAKU_FF01_WRp_clk);
    /* p06.DYGE*/ wire _DYGE_SER_DATA3_SETn_new = nand2(BUS_CPU_D[3].qp_ext(), _DAKU_FF01_WRp_clk);
    /* p06.DOLA*/ wire _DOLA_SER_DATA4_SETn_new = nand2(BUS_CPU_D[4].qp_ext(), _DAKU_FF01_WRp_clk);
    /* p06.ELOK*/ wire _ELOK_SER_DATA5_SETn_new = nand2(BUS_CPU_D[5].qp_ext(), _DAKU_FF01_WRp_clk);
    /* p06.EDEL*/ wire _EDEL_SER_DATA6_SETn_new = nand2(BUS_CPU_D[6].qp_ext(), _DAKU_FF01_WRp_clk);
    /* p06.EFEF*/ wire _EFEL_SER_DATA7_SETn_new = nand2(BUS_CPU_D[7].qp_ext(), _DAKU_FF01_WRp_clk);
    ...
    /* p06.EDER*/ ser_reg.EDER_SER_DATA7.dff22(_EPYT_SER_CLK_new, _EFEL_SER_DATA7_SETn_new, _EGUV_SER_DATA7_RSTn_new, ser_reg.EROD_SER_DATA6.qp_chain());
    /* p06.EROD*/ ser_reg.EROD_SER_DATA6.dff22(_EPYT_SER_CLK_new, _EDEL_SER_DATA6_SETn_new, _EFAK_SER_DATA6_RSTn_new, ser_reg.EJAB_SER_DATA5.qp_chain());
    /* p06.EJAB*/ ser_reg.EJAB_SER_DATA5.dff22(_EPYT_SER_CLK_new, _ELOK_SER_DATA5_SETn_new, _EHUJ_SER_DATA5_RSTn_new, ser_reg.DOVU_SER_DATA4.qp_chain());
    /* p06.DOVU*/ ser_reg.DOVU_SER_DATA4.dff22(_EPYT_SER_CLK_new, _DOLA_SER_DATA4_SETn_new, _DYLY_SER_DATA4_RSTn_new, ser_reg.DOJO_SER_DATA3.qp_chain());
    /* p06.DOJO*/ ser_reg.DOJO_SER_DATA3.dff22(_DAWE_SER_CLK_new, _DYGE_SER_DATA3_SETn_new, _DAJU_SER_DATA3_RSTn_new, ser_reg.DYRA_SER_DATA2.qp_chain());
    /* p06.DYRA*/ ser_reg.DYRA_SER_DATA2.dff22(_DAWE_SER_CLK_new, _DELA_SER_DATA2_SETn_new, _DYBO_SER_DATA2_RSTn_new, ser_reg.DEGU_SER_DATA1.qp_chain());
    /* p06.DEGU*/ ser_reg.DEGU_SER_DATA1.dff22(_DAWE_SER_CLK_new, _DOCU_SER_DATA1_SETn_new, _DUMO_SER_DATA1_RSTn_new, ser_reg.CUBA_SER_DATA0.qp_chain());
    ...
    /* FF01 SER */
    /*#p06.CUGY*/ BUS_CPU_D[0].tri6_pn(_UFEG_FF01_RDp_ext, ser_reg.CUBA_SER_DATA0.qn_new());
    /* p06.DUDE*/ BUS_CPU_D[1].tri6_pn(_UFEG_FF01_RDp_ext, ser_reg.DEGU_SER_DATA1.qn_new());
    /* p06.DETU*/ BUS_CPU_D[2].tri6_pn(_UFEG_FF01_RDp_ext, ser_reg.DYRA_SER_DATA2.qn_new());
    /* p06.DASO*/ BUS_CPU_D[3].tri6_pn(_UFEG_FF01_RDp_ext, ser_reg.DOJO_SER_DATA3.qn_new());
    /* p06.DAME*/ BUS_CPU_D[4].tri6_pn(_UFEG_FF01_RDp_ext, ser_reg.DOVU_SER_DATA4.qn_new());
    /* p06.EVOK*/ BUS_CPU_D[5].tri6_pn(_UFEG_FF01_RDp_ext, ser_reg.EJAB_SER_DATA5.qn_new());
    /* p06.EFAB*/ BUS_CPU_D[6].tri6_pn(_UFEG_FF01_RDp_ext, ser_reg.EROD_SER_DATA6.qn_new());
    /*#p06.ETAK*/ BUS_CPU_D[7].tri6_pn(_UFEG_FF01_RDp_ext, ser_reg.EDER_SER_DATA7.qn_new());

    /* FF02 SER */
    /* p06.CORE*/ BUS_CPU_D[0].tri6_pn(_UCOM_FF02_RDp_ext, ser_reg.CULY_XFER_DIR.qn_new());
    /* p06.ELUV*/ BUS_CPU_D[7].tri6_pn(_UCOM_FF02_RDp_ext, ser_reg.ETAF_SER_RUNNING.qn_new());
  }();

  //--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
  // Bootrom read

  [this, cpu_addr, TEDO_CPU_RDp_ext, TUTU_READ_BOOTROMp_new, _TULO_00000000_XXp_ext, _ZUFA_0000_00FFp_ext]() {
    /* BOOT -> CBD */
#if 0
  ...
  /* p07.ZYRA*/ wire BOOTROM_A7n    = not1(BUS_CPU_A[ 7]);
    ...
    BUS_CPU_D[0].tri6_pn(_ZERY_BOOT_CSp_new, !bool(bootrom_data & 0x01));
    BUS_CPU_D[1].tri6_pn(_ZERY_BOOT_CSp_new, !bool(bootrom_data & 0x02));
    BUS_CPU_D[2].tri6_pn(_ZERY_BOOT_CSp_new, !bool(bootrom_data & 0x04));
    BUS_CPU_D[3].tri6_pn(_ZERY_BOOT_CSp_new, !bool(bootrom_data & 0x08));
    BUS_CPU_D[4].tri6_pn(_ZERY_BOOT_CSp_new, !bool(bootrom_data & 0x10));
    BUS_CPU_D[5].tri6_pn(_ZERY_BOOT_CSp_new, !bool(bootrom_data & 0x20));
    BUS_CPU_D[6].tri6_pn(_ZERY_BOOT_CSp_new, !bool(bootrom_data & 0x40));
    BUS_CPU_D[7].tri6_pn(_ZERY_BOOT_CSp_new, !bool(bootrom_data & 0x80));
  }();

  //--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
  // Various ppu registers

  [
    this,
    _BOGE_DMA_RUNNINGn_new, _PARU_VBLANKp_new, _ACYL_SCANNINGp_new,
    CUNU_SYS_RSTn_new, XORE_SYS_RSTp_new,
    _TOBE_FF41_RDp_ext, _SEPA_FF41_WRp_clk,
    _ANYP_FF42_RDp_ext, _BEDY_FF42_WRp_clk,
    _AVOG_FF43_RDp_ext, _ARUR_FF43_WRp_clk,
    _WAFU_FF44_RDp_ext,
    _VUSO_FF47_RDp_ext, _VELY_FF47_WRp_clk,
    _XUFY_FF48_RDp_ext, _XOMA_FF48_WRp_clk,
    _MUMY_FF49_RDp_ext, _MYXE_FF49_WRp_clk,
    _WAXU_FF4A_RDp_ext, _WEKO_FF4A_WRp_clk,
    _WYZE_FF4B_RDp_ext, _WUZA_FF4B_WRp_clk
  ]() {
    /*#p01.WALU*/ wire _WALU_SYS_RSTn_new = not1(XORE_SYS_RSTp_new);
    /* p01.WESY*/ wire _WESY_SYS_RSTn_new = not1(XORE_SYS_RSTp_new);

    // FF41 STAT
    /* p21.RYVE*/ wire _RYVE_FF41_WRn_clk = not1(_SEPA_FF41_WRp_clk);
    /* p21.ROXE*/ pix_pipe.ROXE_STAT_HBI_ENn.dff9(_RYVE_FF41_WRn_clk, _WESY_SYS_RSTn_new, BUS_CPU_D[3].qp_ext());
    /* p21.RUFO*/ pix_pipe.RUFO_STAT_VBI_ENn.dff9(_RYVE_FF41_WRn_clk, _WESY_SYS_RSTn_new, BUS_CPU_D[4].qp_ext());
    /* p21.REFE*/ pix_pipe.REFE_STAT_OAI_ENn.dff9(_RYVE_FF41_WRn_clk, _WESY_SYS_RSTn_new, BUS_CPU_D[5].qp_ext());
    /* p21.RUGU*/ pix_pipe.RUGU_STAT_LYI_ENn.dff9(_RYVE_FF41_WRn_clk, _WESY_SYS_RSTn_new, BUS_CPU_D[6].qp_ext());
    ...
    /* p21.POTE*/ BUS_CPU_D[6].tri6_nn(_VAVE_FF41_RDn_ext, pix_pipe.RUGU_STAT_LYI_ENn.qp_new());

    /* FF42 SCY */
    /* p23.CAVO*/ wire _CAVO_FF42_WRn_clk = not1(_BEDY_FF42_WRp_clk);
    /* p23.GAVE*/ pix_pipe.GAVE_SCY0n.dff9(_CAVO_FF42_WRn_clk, CUNU_SYS_RSTn_new, BUS_CPU_D[0].qp_ext());
    /* p23.FYMO*/ pix_pipe.FYMO_SCY1n.dff9(_CAVO_FF42_WRn_clk, CUNU_SYS_RSTn_new, BUS_CPU_D[1].qp_ext());
    /* p23.FEZU*/ pix_pipe.FEZU_SCY2n.dff9(_CAVO_FF42_WRn_clk, CUNU_SYS_RSTn_new, BUS_CPU_D[2].qp_ext());
    /* p23.FUJO*/ pix_pipe.FUJO_SCY3n.dff9(_CAVO_FF42_WRn_clk, CUNU_SYS_RSTn_new, BUS_CPU_D[3].qp_ext());
    /* p23.DEDE*/ pix_pipe.DEDE_SCY4n.dff9(_CAVO_FF42_WRn_clk, CUNU_SYS_RSTn_new, BUS_CPU_D[4].qp_ext());
    /* p23.FOTY*/ pix_pipe.FOTY_SCY5n.dff9(_CAVO_FF42_WRn_clk, CUNU_SYS_RSTn_new, BUS_CPU_D[5].qp_ext());
    /* p23.FOHA*/ pix_pipe.FOHA_SCY6n.dff9(_CAVO_FF42_WRn_clk, CUNU_SYS_RSTn_new, BUS_CPU_D[6].qp_ext());
    /* p23.FUNY*/ pix_pipe.FUNY_SCY7n.dff9(_CAVO_FF42_WRn_clk, CUNU_SYS_RSTn_new, BUS_CPU_D[7].qp_ext());

    /* p23.BUWY*/ wire _BUWY_FF42_RDn_ext = not1(_ANYP_FF42_RDp_ext);
    /*#p23.WARE*/ BUS_CPU_D[0].tri6_nn(_BUWY_FF42_RDn_ext, pix_pipe.GAVE_SCY0n.qp_new());
    /* p23.GOBA*/ BUS_CPU_D[1].tri6_nn(_BUWY_FF42_RDn_ext, pix_pipe.FYMO_SCY1n.qp_new());
    /* p23.GONU*/ BUS_CPU_D[2].tri6_nn(_BUWY_FF42_RDn_ext, pix_pipe.FEZU_SCY2n.qp_new());
    /* p23.GODO*/ BUS_CPU_D[3].tri6_nn(_BUWY_FF42_RDn_ext, pix_pipe.FUJO_SCY3n.qp_new());
    /* p23.CUSA*/ BUS_CPU_D[4].tri6_nn(_BUWY_FF42_RDn_ext, pix_pipe.DEDE_SCY4n.qp_new());
    /* p23.GYZO*/ BUS_CPU_D[5].tri6_nn(_BUWY_FF42_RDn_ext, pix_pipe.FOTY_SCY5n.qp_new());
    /* p23.GUNE*/ BUS_CPU_D[6].tri6_nn(_BUWY_FF42_RDn_ext, pix_pipe.FOHA_SCY6n.qp_new());
    /* p23.GYZA*/ BUS_CPU_D[7].tri6_nn(_BUWY_FF42_RDn_ext, pix_pipe.FUNY_SCY7n.qp_new());

    // FF43 SCX
    /* p23.AMUN*/ wire _AMUN_FF43_WRn_clk = not1(_ARUR_FF43_WRp_clk);
    /* p23.DATY*/ pix_pipe.DATY_SCX0n.dff9(_AMUN_FF43_WRn_clk, CUNU_SYS_RSTn_new, BUS_CPU_D[0].qp_ext());
    /* p23.DUZU*/ pix_pipe.DUZU_SCX1n.dff9(_AMUN_FF43_WRn_clk, CUNU_SYS_RSTn_new, BUS_CPU_D[1].qp_ext());
    /* p23.CYXU*/ pix_pipe.CYXU_SCX2n.dff9(_AMUN_FF43_WRn_clk, CUNU_SYS_RSTn_new, BUS_CPU_D[2].qp_ext());
    /* p23.GUBO*/ pix_pipe.GUBO_SCX3n.dff9(_AMUN_FF43_WRn_clk, CUNU_SYS_RSTn_new, BUS_CPU_D[3].qp_ext());
    /* p23.BEMY*/ pix_pipe.BEMY_SCX4n.dff9(_AMUN_FF43_WRn_clk, CUNU_SYS_RSTn_new, BUS_CPU_D[4].qp_ext());
    /* p23.CUZY*/ pix_pipe.CUZY_SCX5n.dff9(_AMUN_FF43_WRn_clk, CUNU_SYS_RSTn_new, BUS_CPU_D[5].qp_ext());
    /* p23.CABU*/ pix_pipe.CABU_SCX6n.dff9(_AMUN_FF43_WRn_clk, CUNU_SYS_RSTn_new, BUS_CPU_D[6].qp_ext());
    /* p23.BAKE*/ pix_pipe.BAKE_SCX7n.dff9(_AMUN_FF43_WRn_clk, CUNU_SYS_RSTn_new, BUS_CPU_D[7].qp_ext());

    /* p23.BEBA*/ wire _BEBA_FF43_RDn_ext = not1(_AVOG_FF43_RDp_ext);
    /*#p23.EDOS*/ BUS_CPU_D[0].tri6_nn(_BEBA_FF43_RDn_ext, pix_pipe.DATY_SCX0n.qp_new());
    /* p23.EKOB*/ BUS_CPU_D[1].tri6_nn(_BEBA_FF43_RDn_ext, pix_pipe.DUZU_SCX1n.qp_new());
    /* p23.CUGA*/ BUS_CPU_D[2].tri6_nn(_BEBA_FF43_RDn_ext, pix_pipe.CYXU_SCX2n.qp_new());
    /* p23.WONY*/ BUS_CPU_D[3].tri6_nn(_BEBA_FF43_RDn_ext, pix_pipe.GUBO_SCX3n.qp_new());
    /* p23.CEDU*/ BUS_CPU_D[4].tri6_nn(_BEBA_FF43_RDn_ext, pix_pipe.BEMY_SCX4n.qp_new());
    /* p23.CATA*/ BUS_CPU_D[5].tri6_nn(_BEBA_FF43_RDn_ext, pix_pipe.CUZY_SCX5n.qp_new());
    /* p23.DOXE*/ BUS_CPU_D[6].tri6_nn(_BEBA_FF43_RDn_ext, pix_pipe.CABU_SCX6n.qp_new());
    /* p23.CASY*/ BUS_CPU_D[7].tri6_nn(_BEBA_FF43_RDn_ext, pix_pipe.BAKE_SCX7n.qp_new());
    ...
    /* p23.LYCO*/ BUS_CPU_D[2].tri6_nn(_VARO_FF44_RDn_ext, _MYFA_LY2n_new);
    /* p23.WOJY*/ BUS_CPU_D[3].tri6_nn(_VARO_FF44_RDn_ext, _XUHY_LY3n_new);
    /* p23.VYNE*/ BUS_CPU_D[4].tri6_nn(_VARO_FF44_RDn_ext, _WATA_LY4n_new);
    /* p23.WAMA*/ BUS_CPU_D[5].tri6_nn(_VARO_FF44_RDn_ext, _XAGA_LY5n_new);
    /* p23.WAVO*/ BUS_CPU_D[6].tri6_nn(_VARO_FF44_RDn_ext, _XUCE_LY6n_new);
    /* p23.WEZE*/ BUS_CPU_D[7].tri6_nn(_VARO_FF44_RDn_ext, _XOWO_LY7n_new);

    // FF47 BGP
    /* p36.TEPO*/ wire _TEPO_FF47_WRp_clk = not1(_VELY_FF47_WRp_clk);
    /*#p36.PAVO*/ pix_pipe.PAVO_BGP_D0n.dff8p(_TEPO_FF47_WRp_clk, BUS_CPU_D[0].qp_ext());
    /* p36.NUSY*/ pix_pipe.NUSY_BGP_D1n.dff8p(_TEPO_FF47_WRp_clk, BUS_CPU_D[1].qp_ext());
    /* p36.PYLU*/ pix_pipe.PYLU_BGP_D2n.dff8p(_TEPO_FF47_WRp_clk, BUS_CPU_D[2].qp_ext());
    /* p36.MAXY*/ pix_pipe.MAXY_BGP_D3n.dff8p(_TEPO_FF47_WRp_clk, BUS_CPU_D[3].qp_ext());
    /* p36.MUKE*/ pix_pipe.MUKE_BGP_D4n.dff8p(_TEPO_FF47_WRp_clk, BUS_CPU_D[4].qp_ext());
    /* p36.MORU*/ pix_pipe.MORU_BGP_D5n.dff8p(_TEPO_FF47_WRp_clk, BUS_CPU_D[5].qp_ext());
    /* p36.MOGY*/ pix_pipe.MOGY_BGP_D6n.dff8p(_TEPO_FF47_WRp_clk, BUS_CPU_D[6].qp_ext());
    /* p36.MENA*/ pix_pipe.MENA_BGP_D7n.dff8p(_TEPO_FF47_WRp_clk, BUS_CPU_D[7].qp_ext());

    /* p36.TEPY*/ wire _TEPY_FF47_RDn_ext = not1(_VUSO_FF47_RDp_ext);
    /*#p36.RARO*/ BUS_CPU_D[0].tri6_nn(_TEPY_FF47_RDn_ext, pix_pipe.PAVO_BGP_D0n.qp_new());
    /* p36.PABA*/ BUS_CPU_D[1].tri6_nn(_TEPY_FF47_RDn_ext, pix_pipe.NUSY_BGP_D1n.qp_new());
    /* p36.REDO*/ BUS_CPU_D[2].tri6_nn(_TEPY_FF47_RDn_ext, pix_pipe.PYLU_BGP_D2n.qp_new());
    /* p36.LOBE*/ BUS_CPU_D[3].tri6_nn(_TEPY_FF47_RDn_ext, pix_pipe.MAXY_BGP_D3n.qp_new());
    /* p36.LACE*/ BUS_CPU_D[4].tri6_nn(_TEPY_FF47_RDn_ext, pix_pipe.MUKE_BGP_D4n.qp_new());
    /* p36.LYKA*/ BUS_CPU_D[5].tri6_nn(_TEPY_FF47_RDn_ext, pix_pipe.MORU_BGP_D5n.qp_new());
    /* p36.LODY*/ BUS_CPU_D[6].tri6_nn(_TEPY_FF47_RDn_ext, pix_pipe.MOGY_BGP_D6n.qp_new());
    /* p36.LARY*/ BUS_CPU_D[7].tri6_nn(_TEPY_FF47_RDn_ext, pix_pipe.MENA_BGP_D7n.qp_new());

    // FF48 OBP0
    /* p36.XELO*/ wire _XELO_FF48_WRn_clk = not1(_XOMA_FF48_WRp_clk);
    /* p36.XUFU*/ pix_pipe.XUFU_OBP0_D0n.dff8p(_XELO_FF48_WRn_clk, BUS_CPU_D[0].qp_ext());
    /* p36.XUKY*/ pix_pipe.XUKY_OBP0_D1n.dff8p(_XELO_FF48_WRn_clk, BUS_CPU_D[1].qp_ext());
    /* p36.XOVA*/ pix_pipe.XOVA_OBP0_D2n.dff8p(_XELO_FF48_WRn_clk, BUS_CPU_D[2].qp_ext());
    /* p36.XALO*/ pix_pipe.XALO_OBP0_D3n.dff8p(_XELO_FF48_WRn_clk, BUS_CPU_D[3].qp_ext());
    /* p36.XERU*/ pix_pipe.XERU_OBP0_D4n.dff8p(_XELO_FF48_WRn_clk, BUS_CPU_D[4].qp_ext());
    /* p36.XYZE*/ pix_pipe.XYZE_OBP0_D5n.dff8p(_XELO_FF48_WRn_clk, BUS_CPU_D[5].qp_ext());
    /* p36.XUPO*/ pix_pipe.XUPO_OBP0_D6n.dff8p(_XELO_FF48_WRn_clk, BUS_CPU_D[6].qp_ext());
    /* p36.XANA*/ pix_pipe.XANA_OBP0_D7n.dff8p(_XELO_FF48_WRn_clk, BUS_CPU_D[7].qp_ext());

    /* p36.XOZY*/ wire _XOZY_FF48_RDn_ext = not1(_XUFY_FF48_RDp_ext);
    /*#p36.XARY*/ BUS_CPU_D[0].tri6_nn(_XOZY_FF48_RDn_ext, pix_pipe.XUFU_OBP0_D0n.qp_new());
    /* p36.XOKE*/ BUS_CPU_D[1].tri6_nn(_XOZY_FF48_RDn_ext, pix_pipe.XUKY_OBP0_D1n.qp_new());
    /* p36.XUNO*/ BUS_CPU_D[2].tri6_nn(_XOZY_FF48_RDn_ext, pix_pipe.XOVA_OBP0_D2n.qp_new());
    /* p36.XUBY*/ BUS_CPU_D[3].tri6_nn(_XOZY_FF48_RDn_ext, pix_pipe.XALO_OBP0_D3n.qp_new());
    /* p36.XAJU*/ BUS_CPU_D[4].tri6_nn(_XOZY_FF48_RDn_ext, pix_pipe.XERU_OBP0_D4n.qp_new());
    /* p36.XOBO*/ BUS_CPU_D[5].tri6_nn(_XOZY_FF48_RDn_ext, pix_pipe.XYZE_OBP0_D5n.qp_new());
    /* p36.XAXA*/ BUS_CPU_D[6].tri6_nn(_XOZY_FF48_RDn_ext, pix_pipe.XUPO_OBP0_D6n.qp_new());
    /* p36.XAWO*/ BUS_CPU_D[7].tri6_nn(_XOZY_FF48_RDn_ext, pix_pipe.XANA_OBP0_D7n.qp_new());

    // FF49 OBP1
    /* p36.LEHO*/ wire _LEHO_FF49_WRn_clk = not1(_MYXE_FF49_WRp_clk);
    /* p36.MOXY*/ pix_pipe.MOXY_OBP1_D0n.dff8p(_LEHO_FF49_WRn_clk, BUS_CPU_D[0].qp_ext());
    /* p36.LAWO*/ pix_pipe.LAWO_OBP1_D1n.dff8p(_LEHO_FF49_WRn_clk, BUS_CPU_D[1].qp_ext());
    /* p36.MOSA*/ pix_pipe.MOSA_OBP1_D2n.dff8p(_LEHO_FF49_WRn_clk, BUS_CPU_D[2].qp_ext());
    /* p36.LOSE*/ pix_pipe.LOSE_OBP1_D3n.dff8p(_LEHO_FF49_WRn_clk, BUS_CPU_D[3].qp_ext());
    /* p36.LUNE*/ pix_pipe.LUNE_OBP1_D4n.dff8p(_LEHO_FF49_WRn_clk, BUS_CPU_D[4].qp_ext());
    /* p36.LUGU*/ pix_pipe.LUGU_OBP1_D5n.dff8p(_LEHO_FF49_WRn_clk, BUS_CPU_D[5].qp_ext());
    /* p36.LEPU*/ pix_pipe.LEPU_OBP1_D6n.dff8p(_LEHO_FF49_WRn_clk, BUS_CPU_D[6].qp_ext());
    /* p36.LUXO*/ pix_pipe.LUXO_OBP1_D7n.dff8p(_LEHO_FF49_WRn_clk, BUS_CPU_D[7].qp_ext());

    /* p36.LOTE*/ wire _LOTE_FF49_RDn_ext = not1(_MUMY_FF49_RDp_ext);
    /*#p36.LAJU*/ BUS_CPU_D[0].tri6_nn(_LOTE_FF49_RDn_ext, pix_pipe.MOXY_OBP1_D0n.qp_new());
    /* p36.LEPA*/ BUS_CPU_D[1].tri6_nn(_LOTE_FF49_RDn_ext, pix_pipe.LAWO_OBP1_D1n.qp_new());
    /* p36.LODE*/ BUS_CPU_D[2].tri6_nn(_LOTE_FF49_RDn_ext, pix_pipe.MOSA_OBP1_D2n.qp_new());
    /* p36.LYZA*/ BUS_CPU_D[3].tri6_nn(_LOTE_FF49_RDn_ext, pix_pipe.LOSE_OBP1_D3n.qp_new());
    /* p36.LUKY*/ BUS_CPU_D[4].tri6_nn(_LOTE_FF49_RDn_ext, pix_pipe.LUNE_OBP1_D4n.qp_new());
    /* p36.LUGA*/ BUS_CPU_D[5].tri6_nn(_LOTE_FF49_RDn_ext, pix_pipe.LUGU_OBP1_D5n.qp_new());
    /* p36.LEBA*/ BUS_CPU_D[6].tri6_nn(_LOTE_FF49_RDn_ext, pix_pipe.LEPU_OBP1_D6n.qp_new());
    /* p36.LELU*/ BUS_CPU_D[7].tri6_nn(_LOTE_FF49_RDn_ext, pix_pipe.LUXO_OBP1_D7n.qp_new());

    // FF4A WY
    /* p23.VEFU*/ wire _VEFU_FF4A_WRn_clk = not1(_WEKO_FF4A_WRp_clk);
    /* p23.NESO*/ pix_pipe.NESO_WY0n.dff9(_VEFU_FF4A_WRn_clk, _WALU_SYS_RSTn_new, BUS_CPU_D[0].qp_ext());
    /* p23.NYRO*/ pix_pipe.NYRO_WY1n.dff9(_VEFU_FF4A_WRn_clk, _WALU_SYS_RSTn_new, BUS_CPU_D[1].qp_ext());
    /* p23.NAGA*/ pix_pipe.NAGA_WY2n.dff9(_VEFU_FF4A_WRn_clk, _WALU_SYS_RSTn_new, BUS_CPU_D[2].qp_ext());
    /* p23.MELA*/ pix_pipe.MELA_WY3n.dff9(_VEFU_FF4A_WRn_clk, _WALU_SYS_RSTn_new, BUS_CPU_D[3].qp_ext());
    /* p23.NULO*/ pix_pipe.NULO_WY4n.dff9(_VEFU_FF4A_WRn_clk, _WALU_SYS_RSTn_new, BUS_CPU_D[4].qp_ext());
    /* p23.NENE*/ pix_pipe.NENE_WY5n.dff9(_VEFU_FF4A_WRn_clk, _WALU_SYS_RSTn_new, BUS_CPU_D[5].qp_ext());
    /* p23.NUKA*/ pix_pipe.NUKA_WY6n.dff9(_VEFU_FF4A_WRn_clk, _WALU_SYS_RSTn_new, BUS_CPU_D[6].qp_ext());
    /* p23.NAFU*/ pix_pipe.NAFU_WY7n.dff9(_VEFU_FF4A_WRn_clk, _WALU_SYS_RSTn_new, BUS_CPU_D[7].qp_ext());
    ...
    /* p23.MYPA*/ pix_pipe.MYPA_WX0n.dff9(_VOXU_FF4B_WRn_clk, _WALU_SYS_RSTn_new, BUS_CPU_D[0].qp_ext());
    /* p23.NOFE*/ pix_pipe.NOFE_WX1n.dff9(_VOXU_FF4B_WRn_clk, _WALU_SYS_RSTn_new, BUS_CPU_D[1].qp_ext());
    /* p23.NOKE*/ pix_pipe.NOKE_WX2n.dff9(_VOXU_FF4B_WRn_clk, _WALU_SYS_RSTn_new, BUS_CPU_D[2].qp_ext());
    /* p23.MEBY*/ pix_pipe.MEBY_WX3n.dff9(_VOXU_FF4B_WRn_clk, _WALU_SYS_RSTn_new, BUS_CPU_D[3].qp_ext());
    /* p23.MYPU*/ pix_pipe.MYPU_WX4n.dff9(_VOXU_FF4B_WRn_clk, _WALU_SYS_RSTn_new, BUS_CPU_D[4].qp_ext());
    /* p23.MYCE*/ pix_pipe.MYCE_WX5n.dff9(_VOXU_FF4B_WRn_clk, _WALU_SYS_RSTn_new, BUS_CPU_D[5].qp_ext());
    /* p23.MUVO*/ pix_pipe.MUVO_WX6n.dff9(_VOXU_FF4B_WRn_clk, _WALU_SYS_RSTn_new, BUS_CPU_D[6].qp_ext());
    /* p23.NUKU*/ pix_pipe.NUKU_WX7n.dff9(_VOXU_FF4B_WRn_clk, _WALU_SYS_RSTn_new, BUS_CPU_D[7].qp_ext());
  ...
  [this, ALUR_SYS_RSTn_new, _ROLO_FF0F_RDn_ext, _REFA_FF0F_WRn_clk, FFFF_RDn_ext, FFFF_WRn_ext, _PARU_VBLANKp_new]() {
    ...
    /* p02.LETY*/ wire _LETY_INT_VBL_ACKn_ext  = not1(PIN_CPU_ACK_VBLANK.qp_old());
    /* p02.LEJA*/ wire _LEJA_INT_STAT_ACKn_ext = not1(PIN_CPU_ACK_STAT.qp_old());
    /* p02.LESA*/ wire _LESA_INT_TIM_ACKn_ext  = not1(PIN_CPU_ACK_TIMER.qp_old());
    /* p02.LUFE*/ wire _LUFE_INT_SER_ACKn_ext  = not1(PIN_CPU_ACK_SERIAL.qp_old());
    /* p02.LAMO*/ wire _LAMO_INT_JOY_ACKn_ext  = not1(PIN_CPU_ACK_JOYPAD.qp_old());

    /* p02.ROTU*/ wire _ROTU_FF0F_WRp_clk = not1(_REFA_FF0F_WRn_clk);
    /* p02.MYZU*/ wire _MYZU_FF0F_SET0n_new = nand3(_ROTU_FF0F_WRp_clk, _LETY_INT_VBL_ACKn_ext,  BUS_CPU_D[0].qp_ext());
    /* p02.MODY*/ wire _MODY_FF0F_SET1n_new = nand3(_ROTU_FF0F_WRp_clk, _LEJA_INT_STAT_ACKn_ext, BUS_CPU_D[1].qp_ext());
    /* p02.PYHU*/ wire _PYHU_FF0F_SET2n_new = nand3(_ROTU_FF0F_WRp_clk, _LESA_INT_TIM_ACKn_ext,  BUS_CPU_D[2].qp_ext());
    /* p02.TOME*/ wire _TOME_FF0F_SET3n_new = nand3(_ROTU_FF0F_WRp_clk, _LUFE_INT_SER_ACKn_ext,  BUS_CPU_D[3].qp_ext());
    /* p02.TOGA*/ wire _TOGA_FF0F_SET4n_new = nand3(_ROTU_FF0F_WRp_clk, _LAMO_INT_JOY_ACKn_ext,  BUS_CPU_D[4].qp_ext());

    /*#p02.MUXE*/ wire _MUXE_INT0_WRn_new = or2(BUS_CPU_D[0].qp_ext(), _REFA_FF0F_WRn_clk);
    /* p02.NABE*/ wire _NABE_INT1_WRn_new = or2(BUS_CPU_D[1].qp_ext(), _REFA_FF0F_WRn_clk);
    /* p02.RAKE*/ wire _RAKE_INT2_WRn_new = or2(BUS_CPU_D[2].qp_ext(), _REFA_FF0F_WRn_clk);
    /* p02.SULO*/ wire _SULO_INT3_WRn_new = or2(BUS_CPU_D[3].qp_ext(), _REFA_FF0F_WRn_clk);
    /* p02.SEME*/ wire _SEME_INT4_WRn_new = or2(BUS_CPU_D[4].qp_ext(), _REFA_FF0F_WRn_clk);

    /*#p02.LYTA*/ wire _LYTA_FF0F_RST0n_new = and3(_MUXE_INT0_WRn_new, _LETY_INT_VBL_ACKn_ext,  ALUR_SYS_RSTn_new);
    /* p02.MOVU*/ wire _MOVU_FF0F_RST1n_new = and3(_NABE_INT1_WRn_new, _LEJA_INT_STAT_ACKn_ext, ALUR_SYS_RSTn_new);
    /* p02.PYGA*/ wire _PYGA_FF0F_RST2n_new = and3(_RAKE_INT2_WRn_new, _LESA_INT_TIM_ACKn_ext,  ALUR_SYS_RSTn_new);
    /* p02.TUNY*/ wire _TUNY_FF0F_RST3n_new = and3(_SULO_INT3_WRn_new, _LUFE_INT_SER_ACKn_ext,  ALUR_SYS_RSTn_new);
    /* p02.TYME*/ wire _TYME_FF0F_RST4n_new = and3(_SEME_INT4_WRn_new, _LAMO_INT_JOY_ACKn_ext,  ALUR_SYS_RSTn_new);
    ...
    /*#p21.XENA*/ wire _XENA_STORE_MATCHn_new = not1(FEPO_STORE_MATCHp.qp_new());
    ...
    /*#p21.TARU*/ wire _TARU_INT_HBL_t3_new   = and2(_WODU_HBLANKp_new, _TOLU_VBLANKn_new);
    ...
    /*#p02.NELA*/ BUS_CPU_D[0].tri6_pn(_POLA_FF0F_RDp_ext, int_reg.MATY_FF0F_L0p.qn_new());
    /*#p02.NABO*/ BUS_CPU_D[1].tri6_pn(_POLA_FF0F_RDp_ext, int_reg.MOPO_FF0F_L1p.qn_new());
    /*#p02.ROVA*/ BUS_CPU_D[2].tri6_pn(_POLA_FF0F_RDp_ext, int_reg.PAVY_FF0F_L2p.qn_new());
    /*#p02.PADO*/ BUS_CPU_D[3].tri6_pn(_POLA_FF0F_RDp_ext, int_reg.NEJY_FF0F_L3p.qn_new());
    /*#p02.PEGY*/ BUS_CPU_D[4].tri6_pn(_POLA_FF0F_RDp_ext, int_reg.NUTY_FF0F_L4p.qn_new());
...

    {
      ...
      IE_D0.dff(FFFF_WRn_ext, 1, !sys_rst, BUS_CPU_D[0].qp_ext());
      IE_D1.dff(FFFF_WRn_ext, 1, !sys_rst, BUS_CPU_D[1].qp_ext());
      IE_D2.dff(FFFF_WRn_ext, 1, !sys_rst, BUS_CPU_D[2].qp_ext());
      IE_D3.dff(FFFF_WRn_ext, 1, !sys_rst, BUS_CPU_D[3].qp_ext());
      IE_D4.dff(FFFF_WRn_ext, 1, !sys_rst, BUS_CPU_D[4].qp_ext());

      BUS_CPU_D[0].tri6_nn(FFFF_RDn_ext, IE_D0.qn_new());
      BUS_CPU_D[1].tri6_nn(FFFF_RDn_ext, IE_D1.qn_new());
      BUS_CPU_D[2].tri6_nn(FFFF_RDn_ext, IE_D2.qn_new());
      BUS_CPU_D[3].tri6_nn(FFFF_RDn_ext, IE_D3.qn_new());
      BUS_CPU_D[4].tri6_nn(FFFF_RDn_ext, IE_D4.qn_new());
  ...
  /*#p25.SYCY*/ wire _SYCY_DBG_CLOCKn_ext = not1(UNOR_MODE_DBG2p_ext());
  /*#p25.SOTO*/ SOTO_DBG_VRAMp.dff17(_SYCY_DBG_CLOCKn_ext, CUNU_SYS_RSTn_new, SOTO_DBG_VRAMp.qn_chain());
  /* p04.MAKA*/ oam_bus.MAKA_HOLD_MEMp.dff17(_ZEME_AxCxExGx_clk, CUNU_SYS_RSTn_new, CATY_LATCH_EXTp_ext);
  ...
  //--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
  //--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
  // OUTPUT LOGIC ONLY PAST THIS LINE
  //--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
  //--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
  //--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
  //--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...

  {
    ...
    /*#p24.POME*/ pix_pipe.POME.set(nor2(AVAP_SCAN_DONE_TRIGp.qp_new(), pix_pipe.POFY.qp_chain()));
    ...
    /*#p24.POME*/ pix_pipe.POME.set(nor2(AVAP_SCAN_DONE_TRIGp.qp_new(), pix_pipe.POFY.qp_new()));
    /*#p24.RUJU*/ pix_pipe.RUJU.set(or3(pix_pipe.PAHO_X_8_SYNC.qp_new(), _TOFU_VID_RSTp_new, pix_pipe.POME.qp_new()));
    /*#p24.POFY*/ pix_pipe.POFY.set(not1(pix_pipe.RUJU.qp_new()));

    /*#p24.RUZE*/ wire _RUZE_HSYNCn_new = not1(pix_pipe.POFY.qp_new());
    PIN_LCD_HSYNC.pin_out(_RUZE_HSYNCn_new, _RUZE_HSYNCn_new);
  }

  {
    ...
    /*#p24.LUCA*/ lcd_reg.LUCA_LINE_EVENp .dff17(_LOFU_LINE_ENDn_new,               _LYFE_VID_RSTn_new, lcd_reg.LUCA_LINE_EVENp.qn_chain());
    /*#p21.NAPO*/ lcd_reg.NAPO_FRAME_EVENp.dff17(lcd_reg.POPU_VBLANKp.qp_new(), _LYFE_VID_RSTn_new, lcd_reg.NAPO_FRAME_EVENp.qn_chain());
    ...
    /*#p24.KUPA*/ wire _KUPA_new = amux2(pix_pipe.XONA_LCDC_LCDENn.qn_new(), _KEBO_new, _KEDY_LCDC_ENn_new, _USEC_DIV07p_new);
  ...
  [this, _SACU_CLKPIPE_AxCxExGx_clknew]() {
    wire _VYPO_VCC = 1;
    wire GND = 0;

    /* p32.PYBO*/ pix_pipe.PYBO_BGW_PIPE_A7.dff22(_SACU_CLKPIPE_AxCxExGx_clknew, pix_pipe.NEDA_BGW_PIPE_A6.qp_chain());
    /* p32.NEDA*/ pix_pipe.NEDA_BGW_PIPE_A6.dff22(_SACU_CLKPIPE_AxCxExGx_clknew, pix_pipe.MODU_BGW_PIPE_A5.qp_chain());
    /* p32.MODU*/ pix_pipe.MODU_BGW_PIPE_A5.dff22(_SACU_CLKPIPE_AxCxExGx_clknew, pix_pipe.NEPO_BGW_PIPE_A4.qp_chain());
    /* p32.NEPO*/ pix_pipe.NEPO_BGW_PIPE_A4.dff22(_SACU_CLKPIPE_AxCxExGx_clknew, pix_pipe.MACU_BGW_PIPE_A3.qp_chain());
    /* p32.MACU*/ pix_pipe.MACU_BGW_PIPE_A3.dff22(_SACU_CLKPIPE_AxCxExGx_clknew, pix_pipe.MOJU_BGW_PIPE_A2.qp_chain());
    /* p32.MOJU*/ pix_pipe.MOJU_BGW_PIPE_A2.dff22(_SACU_CLKPIPE_AxCxExGx_clknew, pix_pipe.NOZO_BGW_PIPE_A1.qp_chain());
    /* p32.NOZO*/ pix_pipe.NOZO_BGW_PIPE_A1.dff22(_SACU_CLKPIPE_AxCxExGx_clknew, pix_pipe.MYDE_BGW_PIPE_A0.qp_chain());
    /* p32.MYDE*/ pix_pipe.MYDE_BGW_PIPE_A0.dff22(_SACU_CLKPIPE_AxCxExGx_clknew, GND);

    /* p32.SOHU*/ pix_pipe.SOHU_BGW_PIPE_B7.dff22(_SACU_CLKPIPE_AxCxExGx_clknew, pix_pipe.RALU_BGW_PIPE_B6.qp_chain());
    /* p32.RALU*/ pix_pipe.RALU_BGW_PIPE_B6.dff22(_SACU_CLKPIPE_AxCxExGx_clknew, pix_pipe.SETU_BGW_PIPE_B5.qp_chain());
    /* p32.SETU*/ pix_pipe.SETU_BGW_PIPE_B5.dff22(_SACU_CLKPIPE_AxCxExGx_clknew, pix_pipe.SOBO_BGW_PIPE_B4.qp_chain());
    /* p32.SOBO*/ pix_pipe.SOBO_BGW_PIPE_B4.dff22(_SACU_CLKPIPE_AxCxExGx_clknew, pix_pipe.RYSA_BGW_PIPE_B3.qp_chain());
    /* p32.RYSA*/ pix_pipe.RYSA_BGW_PIPE_B3.dff22(_SACU_CLKPIPE_AxCxExGx_clknew, pix_pipe.SADY_BGW_PIPE_B2.qp_chain());
    /* p32.SADY*/ pix_pipe.SADY_BGW_PIPE_B2.dff22(_SACU_CLKPIPE_AxCxExGx_clknew, pix_pipe.TACA_BGW_PIPE_B1.qp_chain());
    /* p32.TACA*/ pix_pipe.TACA_BGW_PIPE_B1.dff22(_SACU_CLKPIPE_AxCxExGx_clknew, pix_pipe.TOMY_BGW_PIPE_B0.qp_chain());
    /* p32.TOMY*/ pix_pipe.TOMY_BGW_PIPE_B0.dff22(_SACU_CLKPIPE_AxCxExGx_clknew, GND);

    /* p33.WUFY*/ pix_pipe.WUFY_SPR_PIPE_A7.dff22(_SACU_CLKPIPE_AxCxExGx_clknew, pix_pipe.VAFO_SPR_PIPE_A6.qp_chain());
    /* p33.VAFO*/ pix_pipe.VAFO_SPR_PIPE_A6.dff22(_SACU_CLKPIPE_AxCxExGx_clknew, pix_pipe.WORA_SPR_PIPE_A5.qp_chain());
    /* p33.WORA*/ pix_pipe.WORA_SPR_PIPE_A5.dff22(_SACU_CLKPIPE_AxCxExGx_clknew, pix_pipe.WYHO_SPR_PIPE_A4.qp_chain());
    /* p33.WYHO*/ pix_pipe.WYHO_SPR_PIPE_A4.dff22(_SACU_CLKPIPE_AxCxExGx_clknew, pix_pipe.LESU_SPR_PIPE_A3.qp_chain());
    /* p33.LESU*/ pix_pipe.LESU_SPR_PIPE_A3.dff22(_SACU_CLKPIPE_AxCxExGx_clknew, pix_pipe.LEFE_SPR_PIPE_A2.qp_chain());
    /* p33.LEFE*/ pix_pipe.LEFE_SPR_PIPE_A2.dff22(_SACU_CLKPIPE_AxCxExGx_clknew, pix_pipe.MASO_SPR_PIPE_A1.qp_chain());
    /* p33.MASO*/ pix_pipe.MASO_SPR_PIPE_A1.dff22(_SACU_CLKPIPE_AxCxExGx_clknew, pix_pipe.NURO_SPR_PIPE_A0.qp_chain());
    /* p33.NURO*/ pix_pipe.NURO_SPR_PIPE_A0.dff22(_SACU_CLKPIPE_AxCxExGx_clknew, GND);

    /* p33.VUPY*/ pix_pipe.VUPY_SPR_PIPE_B7.dff22(_SACU_CLKPIPE_AxCxExGx_clknew, pix_pipe.VANU_SPR_PIPE_B6.qp_chain());
    /* p33.VANU*/ pix_pipe.VANU_SPR_PIPE_B6.dff22(_SACU_CLKPIPE_AxCxExGx_clknew, pix_pipe.WEBA_SPR_PIPE_B5.qp_chain());
    /* p33.WEBA*/ pix_pipe.WEBA_SPR_PIPE_B5.dff22(_SACU_CLKPIPE_AxCxExGx_clknew, pix_pipe.VARE_SPR_PIPE_B4.qp_chain());
    /* p33.VARE*/ pix_pipe.VARE_SPR_PIPE_B4.dff22(_SACU_CLKPIPE_AxCxExGx_clknew, pix_pipe.PYJO_SPR_PIPE_B3.qp_chain());
    /* p33.PYJO*/ pix_pipe.PYJO_SPR_PIPE_B3.dff22(_SACU_CLKPIPE_AxCxExGx_clknew, pix_pipe.NATY_SPR_PIPE_B2.qp_chain());
    /* p33.NATY*/ pix_pipe.NATY_SPR_PIPE_B2.dff22(_SACU_CLKPIPE_AxCxExGx_clknew, pix_pipe.PEFU_SPR_PIPE_B1.qp_chain());
    /* p33.PEFU*/ pix_pipe.PEFU_SPR_PIPE_B1.dff22(_SACU_CLKPIPE_AxCxExGx_clknew, pix_pipe.NYLU_SPR_PIPE_B0.qp_chain());
    /* p33.NYLU*/ pix_pipe.NYLU_SPR_PIPE_B0.dff22(_SACU_CLKPIPE_AxCxExGx_clknew, GND);

    /* p34.LYME*/ pix_pipe.LYME_PAL_PIPE_D7.dff22(_SACU_CLKPIPE_AxCxExGx_clknew, pix_pipe.MODA_PAL_PIPE_D6.qp_chain());
    /* p34.MODA*/ pix_pipe.MODA_PAL_PIPE_D6.dff22(_SACU_CLKPIPE_AxCxExGx_clknew, pix_pipe.NUKE_PAL_PIPE_D5.qp_chain());
    /* p34.NUKE*/ pix_pipe.NUKE_PAL_PIPE_D5.dff22(_SACU_CLKPIPE_AxCxExGx_clknew, pix_pipe.PALU_PAL_PIPE_D4.qp_chain());
    /* p34.PALU*/ pix_pipe.PALU_PAL_PIPE_D4.dff22(_SACU_CLKPIPE_AxCxExGx_clknew, pix_pipe.SOMY_PAL_PIPE_D3.qp_chain());
    /* p34.SOMY*/ pix_pipe.SOMY_PAL_PIPE_D3.dff22(_SACU_CLKPIPE_AxCxExGx_clknew, pix_pipe.ROSA_PAL_PIPE_D2.qp_chain());
    /* p34.ROSA*/ pix_pipe.ROSA_PAL_PIPE_D2.dff22(_SACU_CLKPIPE_AxCxExGx_clknew, pix_pipe.SATA_PAL_PIPE_D1.qp_chain());
    /* p34.SATA*/ pix_pipe.SATA_PAL_PIPE_D1.dff22(_SACU_CLKPIPE_AxCxExGx_clknew, pix_pipe.RUGO_PAL_PIPE_D0.qp_chain());
    /* p34.RUGO*/ pix_pipe.RUGO_PAL_PIPE_D0.dff22(_SACU_CLKPIPE_AxCxExGx_clknew, GND);

    /* p26.VAVA*/ pix_pipe.VAVA_MASK_PIPE_7.dff22(_SACU_CLKPIPE_AxCxExGx_clknew, pix_pipe.VUMO_MASK_PIPE_6.qp_chain());
    /* p26.VUMO*/ pix_pipe.VUMO_MASK_PIPE_6.dff22(_SACU_CLKPIPE_AxCxExGx_clknew, pix_pipe.WODA_MASK_PIPE_5.qp_chain());
    /* p26.WODA*/ pix_pipe.WODA_MASK_PIPE_5.dff22(_SACU_CLKPIPE_AxCxExGx_clknew, pix_pipe.XETE_MASK_PIPE_4.qp_chain());
    /* p26.XETE*/ pix_pipe.XETE_MASK_PIPE_4.dff22(_SACU_CLKPIPE_AxCxExGx_clknew, pix_pipe.WYFU_MASK_PIPE_3.qp_chain());
    /* p26.WYFU*/ pix_pipe.WYFU_MASK_PIPE_3.dff22(_SACU_CLKPIPE_AxCxExGx_clknew, pix_pipe.VOSA_MASK_PIPE_2.qp_chain());
    /* p26.VOSA*/ pix_pipe.VOSA_MASK_PIPE_2.dff22(_SACU_CLKPIPE_AxCxExGx_clknew, pix_pipe.WURU_MASK_PIPE_1.qp_chain());
    /* p26.WURU*/ pix_pipe.WURU_MASK_PIPE_1.dff22(_SACU_CLKPIPE_AxCxExGx_clknew, pix_pipe.VEZO_MASK_PIPE_0.qp_chain());
    /* p26.VEZO*/ pix_pipe.VEZO_MASK_PIPE_0.dff22(_SACU_CLKPIPE_AxCxExGx_clknew, _VYPO_VCC);

    /* p29.XEFY*/ wire _XEPY_SPRITE_DONEn_new  = not1(WUTY_SFETCH_DONEp.qp_new());
    ...
    {
      /* p32.LOZE*/ wire _LOZE_PIPE_A_LOADp_new = not1(NYXU_BFETCH_RSTn.qp_new());
    ...
    {
      /* p32.LUXA*/ wire _LUXA_PIPE_B_LOADp_new = not1(NYXU_BFETCH_RSTn.qp_new());
  ...
  [this, _TOFU_VID_RSTp_new, _LYFE_VID_RSTn_new]() {
    // Pixel merge + emit
    ...
    PIN_LCD_DATA0.pin_out(/*lcd_data0_delay.q1_new()*/ _REMY_LD0n_new, /*lcd_data0_delay.q1_new()*/ _REMY_LD0n_new);
  ...
  //[this, _BUDE_xxxxEFGH_clk, _ABUZ_xxCDEFGH_clk, _TEXO_8000_9FFFn_ext, _TYNU_A000_FFFFp_ext, _TUNA_0000_FDFFp_ext, _TULO_00000000_XXp_ext, _TEDO_CPU_RDp_ext, _APOV_CPU_WRp_xxxxEFGx_clk]()
  {
    ...
    /* p08.MOCA*/ wire MOCA_DBG_EXT_RD_ext = nor2(_TEXO_8000_9FFFn_ext, UMUT_MODE_DBG1p_ext());

    /* p08.LEVO*/ wire _LEVO_ADDR_INT_OR_ADDR_VRAM_ext = not1(_TEXO_8000_9FFFn_ext);
    /* p08.LAGU*/ wire _LAGU_ext = and_or3(PIN_CPU_RDp.qp_old(), _LEVO_ADDR_INT_OR_ADDR_VRAM_ext, PIN_CPU_WRp.qp_old());
    /* p08.LYWE*/ wire _LYWE_ext = not1(_LAGU_ext);
    /* p08.MOTY*/ wire MOTY_CPU_EXT_RD_ext = or2(MOCA_DBG_EXT_RD_ext, _LYWE_ext);

    {
      PIN_EXT_CLK.pin_out(_BUDE_xxxxEFGH_clk, _BUDE_xxxxEFGH_clk);
    }

    {
      /* p08.TYMU*/ wire _TYMU_EXT_RDn_new = nor2(LUMA_DMA_CARTp_new, MOTY_CPU_EXT_RD_ext);
...

    {
      ...
      /* p08.NEVY*/ wire _NEVY_new = or2(_MEXO_CPU_WRn_ABCDxxxH_new, MOCA_DBG_EXT_RD_ext);
    ...
    {
      /* p08.TOZA*/ wire _TOZA_PIN_EXT_CS_A_xxCDEFGH_clk = and3(ABUZ_xxCDEFGH_clk, _TYNU_A000_FFFFp_ext, _TUNA_0000_FDFFp_ext);
      /* p08.TYHO*/ wire _TYHO_PIN_EXT_CS_A_xxCDEFGH_clknew = mux2p(LUMA_DMA_CARTp_new, dma_reg.MARU_DMA_A15n.qn_new(), _TOZA_PIN_EXT_CS_A_xxCDEFGH_clk);
      PIN_EXT_CSn.pin_out(_TYHO_PIN_EXT_CS_A_xxCDEFGH_clknew, _TYHO_PIN_EXT_CS_A_xxCDEFGH_clknew);
    }

    {
      /* p08.LOXO*/ wire _LOXO_HOLDn_new = and_or3(MULE_MODE_DBG1n_ext(), _TEXO_8000_9FFFn_ext, UMUT_MODE_DBG1p_ext());
      /* p08.LASY*/ wire _LASY_HOLDp_new = not1(_LOXO_HOLDn_new);
      /* p08.MATE*/ wire _MATE_HOLDn_new = not1(_LASY_HOLDp_new);
      /* p08.ALOR*/ ext_bus.ALOR_EXT_ADDR_LATCH_00p.tp_latch(_MATE_HOLDn_new, BUS_CPU_A[ 0].qp_ext());
      /* p08.APUR*/ ext_bus.APUR_EXT_ADDR_LATCH_01p.tp_latch(_MATE_HOLDn_new, BUS_CPU_A[ 1].qp_ext());
      /* p08.ALYR*/ ext_bus.ALYR_EXT_ADDR_LATCH_02p.tp_latch(_MATE_HOLDn_new, BUS_CPU_A[ 2].qp_ext());
      /* p08.ARET*/ ext_bus.ARET_EXT_ADDR_LATCH_03p.tp_latch(_MATE_HOLDn_new, BUS_CPU_A[ 3].qp_ext());
      /* p08.AVYS*/ ext_bus.AVYS_EXT_ADDR_LATCH_04p.tp_latch(_MATE_HOLDn_new, BUS_CPU_A[ 4].qp_ext());
      /* p08.ATEV*/ ext_bus.ATEV_EXT_ADDR_LATCH_05p.tp_latch(_MATE_HOLDn_new, BUS_CPU_A[ 5].qp_ext());
      /* p08.AROS*/ ext_bus.AROS_EXT_ADDR_LATCH_06p.tp_latch(_MATE_HOLDn_new, BUS_CPU_A[ 6].qp_ext());
      /* p08.ARYM*/ ext_bus.ARYM_EXT_ADDR_LATCH_07p.tp_latch(_MATE_HOLDn_new, BUS_CPU_A[ 7].qp_ext());
      /* p08.LUNO*/ ext_bus.LUNO_EXT_ADDR_LATCH_08p.tp_latch(_MATE_HOLDn_new, BUS_CPU_A[ 8].qp_ext());
      /* p08.LYSA*/ ext_bus.LYSA_EXT_ADDR_LATCH_09p.tp_latch(_MATE_HOLDn_new, BUS_CPU_A[ 9].qp_ext());
      /* p08.PATE*/ ext_bus.PATE_EXT_ADDR_LATCH_10p.tp_latch(_MATE_HOLDn_new, BUS_CPU_A[10].qp_ext());
      /* p08.LUMY*/ ext_bus.LUMY_EXT_ADDR_LATCH_11p.tp_latch(_MATE_HOLDn_new, BUS_CPU_A[11].qp_ext());
      /* p08.LOBU*/ ext_bus.LOBU_EXT_ADDR_LATCH_12p.tp_latch(_MATE_HOLDn_new, BUS_CPU_A[12].qp_ext());
      /* p08.LONU*/ ext_bus.LONU_EXT_ADDR_LATCH_13p.tp_latch(_MATE_HOLDn_new, BUS_CPU_A[13].qp_ext());
      /* p08.NYRE*/ ext_bus.NYRE_EXT_ADDR_LATCH_14p.tp_latch(_MATE_HOLDn_new, BUS_CPU_A[14].qp_ext());
    }
    ...
    // A15 is "special"
    {
      /* p08.SOBY*/ wire _SOBY_A15n_new = nor2(BUS_CPU_A[15].qp_ext(), TUTU_READ_BOOTROMp_new);
      /* p08.SEPY*/ wire _SEPY_A15p_ABxxxxxx_clknew = nand2(ABUZ_xxCDEFGH_clk, _SOBY_A15n_new);
      /* p08.TAZY*/ wire _TAZY_A15p_new = mux2p(LUMA_DMA_CARTp_new, dma_reg.MARU_DMA_A15n.qn_new(), _SEPY_A15p_ABxxxxxx_clknew);
...

    {
      ...
      /* p08.RORU*/ wire _RORU_CBD_TO_EPDn_new = mux2p(UNOR_MODE_DBG2p_ext(), _REDU_CPU_RDn_ext, MOTY_CPU_EXT_RD_ext);
      /* p08.LULA*/ wire _LULA_CBD_TO_EPDp_new = not1(_RORU_CBD_TO_EPDn_new);

      /* p25.RUXA*/ wire _RUXA_new = nand2(BUS_CPU_D[0].qp_ext(), _LULA_CBD_TO_EPDp_new);
      /* p25.RUJA*/ wire _RUJA_new = nand2(BUS_CPU_D[1].qp_ext(), _LULA_CBD_TO_EPDp_new);
      /* p25.RABY*/ wire _RABY_new = nand2(BUS_CPU_D[2].qp_ext(), _LULA_CBD_TO_EPDp_new);
      /* p25.RERA*/ wire _RERA_new = nand2(BUS_CPU_D[3].qp_ext(), _LULA_CBD_TO_EPDp_new);
      /* p25.RORY*/ wire _RORY_new = nand2(BUS_CPU_D[4].qp_ext(), _LULA_CBD_TO_EPDp_new);
      /* p25.RYVO*/ wire _RYVO_new = nand2(BUS_CPU_D[5].qp_ext(), _LULA_CBD_TO_EPDp_new);
      /* p25.RAFY*/ wire _RAFY_new = nand2(BUS_CPU_D[6].qp_ext(), _LULA_CBD_TO_EPDp_new);
      /* p25.RAVU*/ wire _RAVU_new = nand2(BUS_CPU_D[7].qp_ext(), _LULA_CBD_TO_EPDp_new);

      /* p08.RUNE*/ wire _RUNE_new = nor2 (BUS_CPU_D[0].qp_ext(), _RORU_CBD_TO_EPDn_new);
      /* p08.RYPU*/ wire _RYPU_new = nor2 (BUS_CPU_D[1].qp_ext(), _RORU_CBD_TO_EPDn_new);
      /* p08.SULY*/ wire _SULY_new = nor2 (BUS_CPU_D[2].qp_ext(), _RORU_CBD_TO_EPDn_new);
      /* p08.SEZE*/ wire _SEZE_new = nor2 (BUS_CPU_D[3].qp_ext(), _RORU_CBD_TO_EPDn_new);
      /* p08.RESY*/ wire _RESY_new = nor2 (BUS_CPU_D[4].qp_ext(), _RORU_CBD_TO_EPDn_new);
      /* p08.TAMU*/ wire _TAMU_new = nor2 (BUS_CPU_D[5].qp_ext(), _RORU_CBD_TO_EPDn_new);
      /* p08.ROGY*/ wire _ROGY_new = nor2 (BUS_CPU_D[6].qp_ext(), _RORU_CBD_TO_EPDn_new);
      /* p08.RYDA*/ wire _RYDA_new = nor2 (BUS_CPU_D[7].qp_ext(), _RORU_CBD_TO_EPDn_new);
...

    {
      ...
      // Ext RAM write
      if (eram_WRp_new) ext_ram[eram_addr]  = pack_u8p(8, &PIN_EXT_D[0]);

      // Cart RAM write
      if (cram_WRp_new) cart_ram[cram_addr] = pack_u8p(8, &PIN_EXT_D[0]);
    }

    {
      // External data bus -> latch -> CPU data bus
      /* p08.LAVO*/ wire _LAVO_HOLDn_new = nand3(PIN_CPU_RDp.qp_old(), _TEXO_8000_9FFFn_ext, PIN_CPU_LATCH_EXT.qp_old());
      /*#p08.SOMA*/ ext_bus.SOMA_EXT_DATA_LATCH_D0n.tp_latch(_LAVO_HOLDn_new, PIN_EXT_D[0].qn_new()); // FIXME waaaaait why is this qn_new? because of the pin's inverter?
      ...
      /*#p08.RYMA*/ BUS_CPU_D[0].tri6_nn(_LAVO_HOLDn_new, ext_bus.SOMA_EXT_DATA_LATCH_D0n.qp_new());
      /* p08.RUVO*/ BUS_CPU_D[1].tri6_nn(_LAVO_HOLDn_new, ext_bus.RONY_EXT_DATA_LATCH_D1n.qp_new());
      /* p08.RYKO*/ BUS_CPU_D[2].tri6_nn(_LAVO_HOLDn_new, ext_bus.RAXY_EXT_DATA_LATCH_D2n.qp_new());
      /* p08.TAVO*/ BUS_CPU_D[3].tri6_nn(_LAVO_HOLDn_new, ext_bus.SELO_EXT_DATA_LATCH_D3n.qp_new());
      /* p08.TEPE*/ BUS_CPU_D[4].tri6_nn(_LAVO_HOLDn_new, ext_bus.SODY_EXT_DATA_LATCH_D4n.qp_new());
      /* p08.SAFO*/ BUS_CPU_D[5].tri6_nn(_LAVO_HOLDn_new, ext_bus.SAGO_EXT_DATA_LATCH_D5n.qp_new());
      /* p08.SEVU*/ BUS_CPU_D[6].tri6_nn(_LAVO_HOLDn_new, ext_bus.RUPA_EXT_DATA_LATCH_D6n.qp_new());
      /* p08.TAJU*/ BUS_CPU_D[7].tri6_nn(_LAVO_HOLDn_new, ext_bus.SAZY_EXT_DATA_LATCH_D7n.qp_new());
    }
  }
  //();
  ...
  */
  ...
  [
    ...
    CUNU_SYS_RSTn_new,
    ABUZ_xxCDEFGH_clk,
    _TEXO_8000_9FFFn_ext,
    _SYRO_FE00_FFFFp_ext,
    ASOT_CPU_RDp_ext,
    _APOV_CPU_WRp_xxxxEFGx_clk,
    XANE_VRAM_LOCKn_new,
    LUFA_DMA_VRAMp_new,
    TEXY_SFETCHINGp_new,
    PORE_WIN_MODEp_new,
    _NAKO_BFETCH_S1n_new,
    _NOFU_BFETCH_S2n_new,
    _SOSE_8000_9FFFp_ext,
    _TACU_SPR_SEQ_5_TRIG_new,
    LEKO_CPU_RDp_ext
  ](){

    {
      ...
      /* p25.XAKY*/ BUS_VRAM_An[ 0].tri6_nn(_XEDU_VRAM_LOCKp_new, BUS_CPU_A[ 0].qp_ext());
      /* p25.XUXU*/ BUS_VRAM_An[ 1].tri6_nn(_XEDU_VRAM_LOCKp_new, BUS_CPU_A[ 1].qp_ext());
      /* p25.XYNE*/ BUS_VRAM_An[ 2].tri6_nn(_XEDU_VRAM_LOCKp_new, BUS_CPU_A[ 2].qp_ext());
      /* p25.XODY*/ BUS_VRAM_An[ 3].tri6_nn(_XEDU_VRAM_LOCKp_new, BUS_CPU_A[ 3].qp_ext());
      /* p25.XECA*/ BUS_VRAM_An[ 4].tri6_nn(_XEDU_VRAM_LOCKp_new, BUS_CPU_A[ 4].qp_ext());
      /* p25.XOBA*/ BUS_VRAM_An[ 5].tri6_nn(_XEDU_VRAM_LOCKp_new, BUS_CPU_A[ 5].qp_ext());
      /* p25.XOPO*/ BUS_VRAM_An[ 6].tri6_nn(_XEDU_VRAM_LOCKp_new, BUS_CPU_A[ 6].qp_ext());
      /* p25.XYBO*/ BUS_VRAM_An[ 7].tri6_nn(_XEDU_VRAM_LOCKp_new, BUS_CPU_A[ 7].qp_ext());
      /* p25.RYSU*/ BUS_VRAM_An[ 8].tri6_nn(_XEDU_VRAM_LOCKp_new, BUS_CPU_A[ 8].qp_ext());
      /* p25.RESE*/ BUS_VRAM_An[ 9].tri6_nn(_XEDU_VRAM_LOCKp_new, BUS_CPU_A[ 9].qp_ext());
      /* p25.RUSE*/ BUS_VRAM_An[10].tri6_nn(_XEDU_VRAM_LOCKp_new, BUS_CPU_A[10].qp_ext());
      /* p25.RYNA*/ BUS_VRAM_An[11].tri6_nn(_XEDU_VRAM_LOCKp_new, BUS_CPU_A[11].qp_ext());
      /* p25.RUMO*/ BUS_VRAM_An[12].tri6_nn(_XEDU_VRAM_LOCKp_new, BUS_CPU_A[12].qp_ext());
    }
...

    {
      ...
      /*#p29.FUGY*/ BUS_VRAM_An[ 5].tri6_nn(_ABON_SFETCHINGn_new, oam_bus.XEGU_OAM_DA1p.qp_new());
      /* p29.GAVO*/ BUS_VRAM_An[ 6].tri6_nn(_ABON_SFETCHINGn_new, oam_bus.YJEX_OAM_DA2p.qp_new());
      /* p29.WYGA*/ BUS_VRAM_An[ 7].tri6_nn(_ABON_SFETCHINGn_new, oam_bus.XYJU_OAM_DA3p.qp_new());
      /* p29.WUNE*/ BUS_VRAM_An[ 8].tri6_nn(_ABON_SFETCHINGn_new, oam_bus.YBOG_OAM_DA4p.qp_new());
      /* p29.GOTU*/ BUS_VRAM_An[ 9].tri6_nn(_ABON_SFETCHINGn_new, oam_bus.WYSO_OAM_DA5p.qp_new());
      /* p29.GEGU*/ BUS_VRAM_An[10].tri6_nn(_ABON_SFETCHINGn_new, oam_bus.XOTE_OAM_DA6p.qp_new());
      /* p29.XEHE*/ BUS_VRAM_An[11].tri6_nn(_ABON_SFETCHINGn_new, oam_bus.YZAB_OAM_DA7p.qp_new());
      /* p29.DYSO*/ BUS_VRAM_An[12].tri6_nn(_ABON_SFETCHINGn_new, 0);   // sprites always in low half of tile store
    }

    {
      // Background & window map/tile read VRAM address driver
...
#pragma warning(pop)
    ...
    /*#p25.TEGU*/ wire _TEGU_CPU_VRAM_WRn_ext = nand2(_SOSE_8000_9FFFp_ext, PIN_CPU_WRp.qp_old());  // Schematic wrong, second input is PIN_CPU_WRp
    ///*#p25.TAVY*/ wire _TAVY_MOEp         = not1(vram_bus.PIN_VRAM_OEn.qn_new());
    /*#p25.SALE*/ wire SALE_CPU_VRAM_WRn_ext = /*mux2p(_TUTO_DBG_VRAMp, _TAVY_MOEp,*/ _TEGU_CPU_VRAM_WRn_ext /*)*/;
    ...
    /*#p25.TUCA*/ wire _TUCA_CPU_VRAM_RDp_ext = and2(_SOSE_8000_9FFFp_ext, ABUZ_xxCDEFGH_clk);
    ...
    /*#p25.SERE*/ wire SERE_CPU_VRM_RDp_new = and2(_TOLE_CPU_VRAM_RDp_ext, _ROPY_RENDERINGn_new);

    /*#p25.SAZO*/ wire _SAZO_CBD_TO_VPDp_new = and2(SERE_CPU_VRM_RDp_new, _RUVY_CPU_VRAM_WRp_new);
    ...
    /* p25.RAHU*/ wire RAHU_CBD_TO_VPDn_new = not1(_ROCY_CBD_TO_VPDp_new);
    /*#p25.RENA*/ wire RENA_CBD_TO_VPDn_new = not1(_RELA_CBD_TO_VPDp_new);

    {
      // CPU to VRAM write
      /* p25.TEME*/ BUS_VRAM_Dp[0].tri10_np(RAHU_CBD_TO_VPDn_new, BUS_CPU_D[0].qp_ext());
      /* p25.TEWU*/ BUS_VRAM_Dp[1].tri10_np(RAHU_CBD_TO_VPDn_new, BUS_CPU_D[1].qp_ext());
      /*#p25.TYGO*/ BUS_VRAM_Dp[2].tri10_np(RAHU_CBD_TO_VPDn_new, BUS_CPU_D[2].qp_ext());
      /* p25.SOTE*/ BUS_VRAM_Dp[3].tri10_np(RAHU_CBD_TO_VPDn_new, BUS_CPU_D[3].qp_ext());
      /* p25.SEKE*/ BUS_VRAM_Dp[4].tri10_np(RAHU_CBD_TO_VPDn_new, BUS_CPU_D[4].qp_ext());
      /* p25.RUJO*/ BUS_VRAM_Dp[5].tri10_np(RAHU_CBD_TO_VPDn_new, BUS_CPU_D[5].qp_ext());
      /* p25.TOFA*/ BUS_VRAM_Dp[6].tri10_np(RAHU_CBD_TO_VPDn_new, BUS_CPU_D[6].qp_ext());
      /* p25.SUZA*/ BUS_VRAM_Dp[7].tri10_np(RAHU_CBD_TO_VPDn_new, BUS_CPU_D[7].qp_ext());
    }
    ...
    {
      // VRAM data pin write driver
      /*#p25.ROVE*/ wire _ROVE_CBD_TO_VPDp_new = not1(RAHU_CBD_TO_VPDn_new);
      /*#p25.SEFA*/ wire _SEFA_D0p_new = and2(BUS_VRAM_Dp[0].qp_ext(), _ROVE_CBD_TO_VPDp_new);
      /* p25.SOGO*/ wire _SOGO_D1p_new = and2(BUS_VRAM_Dp[1].qp_ext(), _ROVE_CBD_TO_VPDp_new);
      /* p25.SEFU*/ wire _SEFU_D2p_new = and2(BUS_VRAM_Dp[2].qp_ext(), _ROVE_CBD_TO_VPDp_new);
      /* p25.SUNA*/ wire _SUNA_D3p_new = and2(BUS_VRAM_Dp[3].qp_ext(), _ROVE_CBD_TO_VPDp_new);
      /* p25.SUMO*/ wire _SUMO_D4p_new = and2(BUS_VRAM_Dp[4].qp_ext(), _ROVE_CBD_TO_VPDp_new);
      /* p25.SAZU*/ wire _SAZU_D5p_new = and2(BUS_VRAM_Dp[5].qp_ext(), _ROVE_CBD_TO_VPDp_new);
      /* p25.SAMO*/ wire _SAMO_D6p_new = and2(BUS_VRAM_Dp[6].qp_ext(), _ROVE_CBD_TO_VPDp_new);
      /* p25.SUKE*/ wire _SUKE_D7p_new = and2(BUS_VRAM_Dp[7].qp_ext(), _ROVE_CBD_TO_VPDp_new);

      /*#p25.SYNU*/ wire _SYNU_D0p_new = or2(RAHU_CBD_TO_VPDn_new, BUS_VRAM_Dp[0].qp_ext());
      /* p25.SYMA*/ wire _SYMA_D1p_new = or2(RAHU_CBD_TO_VPDn_new, BUS_VRAM_Dp[1].qp_ext());
      /* p25.ROKO*/ wire _ROKO_D2p_new = or2(RAHU_CBD_TO_VPDn_new, BUS_VRAM_Dp[2].qp_ext());
      /* p25.SYBU*/ wire _SYBU_D3p_new = or2(RAHU_CBD_TO_VPDn_new, BUS_VRAM_Dp[3].qp_ext());
      /* p25.SAKO*/ wire _SAKO_D4p_new = or2(RAHU_CBD_TO_VPDn_new, BUS_VRAM_Dp[4].qp_ext());
      /* p25.SEJY*/ wire _SEJY_D5p_new = or2(RAHU_CBD_TO_VPDn_new, BUS_VRAM_Dp[5].qp_ext());
      /* p25.SEDO*/ wire _SEDO_D6p_new = or2(RAHU_CBD_TO_VPDn_new, BUS_VRAM_Dp[6].qp_ext());
      /* p25.SAWU*/ wire _SAWU_D7p_new = or2(RAHU_CBD_TO_VPDn_new, BUS_VRAM_Dp[7].qp_ext());
      ...
      /*#p25.ROFA*/ wire _ROFA_CBD_TO_VPDp_new = not1(RENA_CBD_TO_VPDn_new);
...

    {
      ...
      /*#p25.SUTU*/ wire _SUTU_MCSn_new   = nor4(_LENA_BGW_VRAM_RDp_new, LUFA_DMA_VRAMp_new, TEXY_SFETCHINGp_new, SERE_CPU_VRM_RDp_new);
...

    {
      ...
      /* p25.SOHY*/ wire _SOHY_MWRn_new   = nand2(_TYJY_VRAM_WRp_new, SERE_CPU_VRM_RDp_new);
    ...
    {
      /* p25.SOHO*/ wire _SOHO_SPR_VRAM_RDp_new = and2(_TACU_SPR_SEQ_5_TRIG_new, TEXY_SFETCHINGp_new);
    ...
    if (!PIN_VRAM_WRn.qp_new()) {
      uint16_t vram_addr = pack_u16p(13, PIN_VRAM_Ap);
      vid_ram[vram_addr] = pack_u8p (8,  PIN_VRAM_Dp);
    }

    {
      // VRAM data pin read driver
      if (!PIN_VRAM_OEn.qp_new()) {
        uint16_t vram_addr = pack_u16p(13, PIN_VRAM_Ap);
        uint8_t vram_data = vid_ram[vram_addr];
        PIN_VRAM_Dp[0].set(vram_data & 0x01);
        PIN_VRAM_Dp[1].set(vram_data & 0x02);
        PIN_VRAM_Dp[2].set(vram_data & 0x04);
        PIN_VRAM_Dp[3].set(vram_data & 0x08);
        PIN_VRAM_Dp[4].set(vram_data & 0x10);
        PIN_VRAM_Dp[5].set(vram_data & 0x20);
        PIN_VRAM_Dp[6].set(vram_data & 0x40);
        PIN_VRAM_Dp[7].set(vram_data & 0x80);
      }
    }

    /* p25.RODY*/ BUS_VRAM_Dp[0].tri6_pn(RENA_CBD_TO_VPDn_new, PIN_VRAM_Dp[0].qn_new());
    /* p25.REBA*/ BUS_VRAM_Dp[1].tri6_pn(RENA_CBD_TO_VPDn_new, PIN_VRAM_Dp[1].qn_new());
    /* p25.RYDO*/ BUS_VRAM_Dp[2].tri6_pn(RENA_CBD_TO_VPDn_new, PIN_VRAM_Dp[2].qn_new());
    /* p25.REMO*/ BUS_VRAM_Dp[3].tri6_pn(RENA_CBD_TO_VPDn_new, PIN_VRAM_Dp[3].qn_new());
    /* p25.ROCE*/ BUS_VRAM_Dp[4].tri6_pn(RENA_CBD_TO_VPDn_new, PIN_VRAM_Dp[4].qn_new());
    /* p25.ROPU*/ BUS_VRAM_Dp[5].tri6_pn(RENA_CBD_TO_VPDn_new, PIN_VRAM_Dp[5].qn_new());
    /* p25.RETA*/ BUS_VRAM_Dp[6].tri6_pn(RENA_CBD_TO_VPDn_new, PIN_VRAM_Dp[6].qn_new());
    /* p25.RAKU*/ BUS_VRAM_Dp[7].tri6_pn(RENA_CBD_TO_VPDn_new, PIN_VRAM_Dp[7].qn_new());

    {
      // CPU VRAM data read driver
      /* p25.RERY*/ wire _RERY_VBUS_D0n_ext = not1(BUS_VRAM_Dp[0].qp_new());
      /* p25.RUNA*/ wire _RUNA_VBUS_D1n_ext = not1(BUS_VRAM_Dp[1].qp_new());
      /* p25.RONA*/ wire _RONA_VBUS_D2n_ext = not1(BUS_VRAM_Dp[2].qp_new());
      /* p25.RUNO*/ wire _RUNO_VBUS_D3n_ext = not1(BUS_VRAM_Dp[3].qp_new());
      /* p25.SANA*/ wire _SANA_VBUS_D4n_ext = not1(BUS_VRAM_Dp[4].qp_new());
      /* p25.RORO*/ wire _RORO_VBUS_D5n_ext = not1(BUS_VRAM_Dp[5].qp_new());
      /* p25.RABO*/ wire _RABO_VBUS_D6n_ext = not1(BUS_VRAM_Dp[6].qp_new());
      /* p25.SAME*/ wire _SAME_VBUS_D7n_ext = not1(BUS_VRAM_Dp[7].qp_new());

      /* p25.TYVY*/ wire _TYVY_VBD_TO_CBDn_new = nand2(SERE_CPU_VRM_RDp_new, LEKO_CPU_RDp_ext);
      /* p25.SEBY*/ wire _SEBY_VBD_TO_CBDp_new = not1(_TYVY_VBD_TO_CBDn_new);

      /*#p25.RUGA*/ BUS_CPU_D[0].tri6_pn(_SEBY_VBD_TO_CBDp_new, _RERY_VBUS_D0n_ext);
      /* p25.ROTA*/ BUS_CPU_D[1].tri6_pn(_SEBY_VBD_TO_CBDp_new, _RUNA_VBUS_D1n_ext);
      /* p25.RYBU*/ BUS_CPU_D[2].tri6_pn(_SEBY_VBD_TO_CBDp_new, _RONA_VBUS_D2n_ext);
      /* p25.RAJU*/ BUS_CPU_D[3].tri6_pn(_SEBY_VBD_TO_CBDp_new, _RUNO_VBUS_D3n_ext);
      /* p25.TYJA*/ BUS_CPU_D[4].tri6_pn(_SEBY_VBD_TO_CBDp_new, _SANA_VBUS_D4n_ext);
      /* p25.REXU*/ BUS_CPU_D[5].tri6_pn(_SEBY_VBD_TO_CBDp_new, _RORO_VBUS_D5n_ext);
      /* p25.RUPY*/ BUS_CPU_D[6].tri6_pn(_SEBY_VBD_TO_CBDp_new, _RABO_VBUS_D6n_ext);
      /* p25.TOKU*/ BUS_CPU_D[7].tri6_pn(_SEBY_VBD_TO_CBDp_new, _SAME_VBUS_D7n_ext);
    }
  }
  ();
  ...
  [
    this,
    ASOT_CPU_RDp_ext,
    _SARO_FE00_FEFFp_ext,
    CUNU_SYS_RSTn_new,
    _ZEME_AxCxExGx_clk,
    _UVYT_ABCDxxxx_clk,
    _CUPA_CPU_WRp_xxxxEFGx_clk,
    _BOGE_DMA_RUNNINGn_new,
    _ACYL_SCANNINGp_new,
    LUMA_DMA_CARTp_new,
    LUFA_DMA_VRAMp_new,
    _MOPA_xxxxEFGH_clk,
    _TUVO_PPU_OAM_RDp_new,
    LEKO_CPU_RDp_ext,
    CATY_LATCH_EXTp_ext,
    _XOCE_xBCxxFGx_clknew
  ]()
  {
    BUS_OAM_An[0].reset();
    BUS_OAM_An[1].reset();
    ...
    wire GND = 0;
    wire _WEFE_VCC = 1;
    /* p28.AJON*/ wire _AJON_RENDERINGp_new = and2(_BOGE_DMA_RUNNINGn_new, pix_pipe.XYMU_RENDERINGn.qn_new()); // def AND. ppu can read oam when there's rendering but no dma

    {
      ...
      /* p28.GARO*/ BUS_OAM_An[0].tri6_nn(_ASAM_CPU_OAM_RDn_new, BUS_CPU_A[ 0].qp_ext());
      /* p28.WACU*/ BUS_OAM_An[1].tri6_nn(_ASAM_CPU_OAM_RDn_new, BUS_CPU_A[ 1].qp_ext());
      /* p28.GOSE*/ BUS_OAM_An[2].tri6_nn(_ASAM_CPU_OAM_RDn_new, BUS_CPU_A[ 2].qp_ext());
      /* p28.WAPE*/ BUS_OAM_An[3].tri6_nn(_ASAM_CPU_OAM_RDn_new, BUS_CPU_A[ 3].qp_ext());
      /* p28.FEVU*/ BUS_OAM_An[4].tri6_nn(_ASAM_CPU_OAM_RDn_new, BUS_CPU_A[ 4].qp_ext());
      /* p28.GERA*/ BUS_OAM_An[5].tri6_nn(_ASAM_CPU_OAM_RDn_new, BUS_CPU_A[ 5].qp_ext());
      /* p28.WAXA*/ BUS_OAM_An[6].tri6_nn(_ASAM_CPU_OAM_RDn_new, BUS_CPU_A[ 6].qp_ext());
      /* p28.FOBY*/ BUS_OAM_An[7].tri6_nn(_ASAM_CPU_OAM_RDn_new, BUS_CPU_A[ 7].qp_ext());
    }

    {
      // OAM address from DMA
...

    {
      ...
      /* p28.BETE*/ wire _BETE_SFETCHINGn_new = not1(_AJON_RENDERINGp_new);
      /* p28.GECA*/ BUS_OAM_An[0].tri6_nn(_BETE_SFETCHINGn_new, _WEFE_VCC);
      /* p28.WYDU*/ BUS_OAM_An[1].tri6_nn(_BETE_SFETCHINGn_new, _WEFE_VCC);
      /* p28.GYBU*/ BUS_OAM_An[2].tri6_nn(_BETE_SFETCHINGn_new, SPR_TRI_I[0].qp_ext());
      /* p28.GYKA*/ BUS_OAM_An[3].tri6_nn(_BETE_SFETCHINGn_new, SPR_TRI_I[1].qp_ext());
      /* p28.FABY*/ BUS_OAM_An[4].tri6_nn(_BETE_SFETCHINGn_new, SPR_TRI_I[2].qp_ext());
      /* p28.FACO*/ BUS_OAM_An[5].tri6_nn(_BETE_SFETCHINGn_new, SPR_TRI_I[3].qp_ext());
      /* p28.FUGU*/ BUS_OAM_An[6].tri6_nn(_BETE_SFETCHINGn_new, SPR_TRI_I[4].qp_ext());
      /* p28.FYKE*/ BUS_OAM_An[7].tri6_nn(_BETE_SFETCHINGn_new, SPR_TRI_I[5].qp_ext());
    }
...

    {
      ...
      /* p28.WUZU*/ BUS_OAM_DAn[0].tri6_nn(_AZAR_VBD_TO_OBDn_new, BUS_VRAM_Dp[0].qp_ext());
      /* p28.AXER*/ BUS_OAM_DAn[1].tri6_nn(_AZAR_VBD_TO_OBDn_new, BUS_VRAM_Dp[1].qp_ext());
      /* p28.ASOX*/ BUS_OAM_DAn[2].tri6_nn(_AZAR_VBD_TO_OBDn_new, BUS_VRAM_Dp[2].qp_ext());
      /* p28.CETU*/ BUS_OAM_DAn[3].tri6_nn(_AZAR_VBD_TO_OBDn_new, BUS_VRAM_Dp[3].qp_ext());
      /* p28.ARYN*/ BUS_OAM_DAn[4].tri6_nn(_AZAR_VBD_TO_OBDn_new, BUS_VRAM_Dp[4].qp_ext());
      /* p28.ACOT*/ BUS_OAM_DAn[5].tri6_nn(_AZAR_VBD_TO_OBDn_new, BUS_VRAM_Dp[5].qp_ext());
      /* p28.CUJE*/ BUS_OAM_DAn[6].tri6_nn(_AZAR_VBD_TO_OBDn_new, BUS_VRAM_Dp[6].qp_ext());
      /* p28.ATER*/ BUS_OAM_DAn[7].tri6_nn(_AZAR_VBD_TO_OBDn_new, BUS_VRAM_Dp[7].qp_ext());

      /* p28.WOWA*/ BUS_OAM_DBn[0].tri6_nn(_AZAR_VBD_TO_OBDn_new, BUS_VRAM_Dp[0].qp_ext());
      /* p28.AVEB*/ BUS_OAM_DBn[1].tri6_nn(_AZAR_VBD_TO_OBDn_new, BUS_VRAM_Dp[1].qp_ext());
      /* p28.AMUH*/ BUS_OAM_DBn[2].tri6_nn(_AZAR_VBD_TO_OBDn_new, BUS_VRAM_Dp[2].qp_ext());
      /* p28.COFO*/ BUS_OAM_DBn[3].tri6_nn(_AZAR_VBD_TO_OBDn_new, BUS_VRAM_Dp[3].qp_ext());
      /* p28.AZOZ*/ BUS_OAM_DBn[4].tri6_nn(_AZAR_VBD_TO_OBDn_new, BUS_VRAM_Dp[4].qp_ext());
      /* p28.AGYK*/ BUS_OAM_DBn[5].tri6_nn(_AZAR_VBD_TO_OBDn_new, BUS_VRAM_Dp[5].qp_ext());
      /* p28.BUSE*/ BUS_OAM_DBn[6].tri6_nn(_AZAR_VBD_TO_OBDn_new, BUS_VRAM_Dp[6].qp_ext());
      /* p28.ANUM*/ BUS_OAM_DBn[7].tri6_nn(_AZAR_VBD_TO_OBDn_new, BUS_VRAM_Dp[7].qp_ext());
    }

    /* p28.AJUJ*/ wire _AJUJ_OAM_BUSYn_new   = nor3(dma_reg.MATU_DMA_RUNNINGp.qp_new(), _ACYL_SCANNINGp_new, _AJON_RENDERINGp_new); // def nor
...

    {
      ...
      /* p28.WUJE*/ oam_bus.WUJE_CPU_OAM_WRn.nor_latch(_XYNY_ABCDxxxx_clk, _XUTO_CPU_OAM_WRp_ext); // slightly weird
      ...
      /* p28.ZAXA*/ BUS_OAM_DAn[0].tri6_nn(_AZUL_CBD_TO_OBDn_new, BUS_CPU_D[0].qp_ext());
      /* p28.ZAKY*/ BUS_OAM_DAn[1].tri6_nn(_AZUL_CBD_TO_OBDn_new, BUS_CPU_D[1].qp_ext());
      /* p28.WULE*/ BUS_OAM_DAn[2].tri6_nn(_AZUL_CBD_TO_OBDn_new, BUS_CPU_D[2].qp_ext());
      /* p28.ZOZO*/ BUS_OAM_DAn[3].tri6_nn(_AZUL_CBD_TO_OBDn_new, BUS_CPU_D[3].qp_ext());
      /* p28.ZUFO*/ BUS_OAM_DAn[4].tri6_nn(_AZUL_CBD_TO_OBDn_new, BUS_CPU_D[4].qp_ext());
      /* p28.ZATO*/ BUS_OAM_DAn[5].tri6_nn(_AZUL_CBD_TO_OBDn_new, BUS_CPU_D[5].qp_ext());
      /* p28.YVUC*/ BUS_OAM_DAn[6].tri6_nn(_AZUL_CBD_TO_OBDn_new, BUS_CPU_D[6].qp_ext());
      /* p28.ZUFE*/ BUS_OAM_DAn[7].tri6_nn(_AZUL_CBD_TO_OBDn_new, BUS_CPU_D[7].qp_ext());

      /* p28.ZAMY*/ BUS_OAM_DBn[0].tri6_nn(_AZUL_CBD_TO_OBDn_new, BUS_CPU_D[0].qp_ext());
      /* p28.ZOPU*/ BUS_OAM_DBn[1].tri6_nn(_AZUL_CBD_TO_OBDn_new, BUS_CPU_D[1].qp_ext());
      /* p28.WYKY*/ BUS_OAM_DBn[2].tri6_nn(_AZUL_CBD_TO_OBDn_new, BUS_CPU_D[2].qp_ext());
      /* p28.ZAJA*/ BUS_OAM_DBn[3].tri6_nn(_AZUL_CBD_TO_OBDn_new, BUS_CPU_D[3].qp_ext());
      /* p28.ZUGA*/ BUS_OAM_DBn[4].tri6_nn(_AZUL_CBD_TO_OBDn_new, BUS_CPU_D[4].qp_ext());
      /* p28.ZUMO*/ BUS_OAM_DBn[5].tri6_nn(_AZUL_CBD_TO_OBDn_new, BUS_CPU_D[5].qp_ext());
      /* p28.XYTO*/ BUS_OAM_DBn[6].tri6_nn(_AZUL_CBD_TO_OBDn_new, BUS_CPU_D[6].qp_ext());
      /* p28.ZYFA*/ BUS_OAM_DBn[7].tri6_nn(_AZUL_CBD_TO_OBDn_new, BUS_CPU_D[7].qp_ext());
    }
    ...
    // The actual OAM memory stuff

    uint8_t oam_addr_latch = pack_u8n(7, &BUS_OAM_An[1]);

    if (!oam_clk.qp_old() && PIN_OAM_CLKn.qn_new()) {
      if (PIN_OAM_WRn_A.qn_new()) {
        oam_ram[(oam_addr_latch << 1) + 0] = pack_u8n(8, &BUS_OAM_DAn[0]);
      }

      if (PIN_OAM_WRn_B.qn_new()) {
        oam_ram[(oam_addr_latch << 1) + 1] = pack_u8n(8, &BUS_OAM_DBn[0]);
      }
    }

    oam_clk.set(PIN_OAM_CLKn.qn_new());

    uint8_t oam_data_latch_a = oam_ram[(oam_addr_latch << 1) + 0];
    uint8_t oam_data_latch_b = oam_ram[(oam_addr_latch << 1) + 1];

    {
      ...
      /*#p28.BOTA*/ wire   _BOTA_OAM_OEn_new  = nand3(_BOFE_LATCH_EXTn_new, _SARO_FE00_FEFFp_ext, ASOT_CPU_RDp_ext); // Schematic wrong, this is NAND
      ...
      /* p29.YDYV*/ oam_bus.YDYV_OAM_LATCH_DA0n.tp_latch(_BODE_OAM_OEp_new, BUS_OAM_DAn[0].qp_ext());
      /* p29.YCEB*/ oam_bus.YCEB_OAM_LATCH_DA1n.tp_latch(_BODE_OAM_OEp_new, BUS_OAM_DAn[1].qp_ext());
      /* p29.ZUCA*/ oam_bus.ZUCA_OAM_LATCH_DA2n.tp_latch(_BODE_OAM_OEp_new, BUS_OAM_DAn[2].qp_ext());
      /* p29.WONE*/ oam_bus.WONE_OAM_LATCH_DA3n.tp_latch(_BODE_OAM_OEp_new, BUS_OAM_DAn[3].qp_ext());
      /* p29.ZAXE*/ oam_bus.ZAXE_OAM_LATCH_DA4n.tp_latch(_BODE_OAM_OEp_new, BUS_OAM_DAn[4].qp_ext());
      /* p29.XAFU*/ oam_bus.XAFU_OAM_LATCH_DA5n.tp_latch(_BODE_OAM_OEp_new, BUS_OAM_DAn[5].qp_ext());
      /* p29.YSES*/ oam_bus.YSES_OAM_LATCH_DA6n.tp_latch(_BODE_OAM_OEp_new, BUS_OAM_DAn[6].qp_ext());
      /* p29.ZECA*/ oam_bus.ZECA_OAM_LATCH_DA7n.tp_latch(_BODE_OAM_OEp_new, BUS_OAM_DAn[7].qp_ext());

      /*#p31.XYKY*/ oam_bus.XYKY_OAM_LATCH_DB0n.tp_latch(_BODE_OAM_OEp_new, BUS_OAM_DBn[0].qp_ext());
      /* p31.YRUM*/ oam_bus.YRUM_OAM_LATCH_DB1n.tp_latch(_BODE_OAM_OEp_new, BUS_OAM_DBn[1].qp_ext());
      /* p31.YSEX*/ oam_bus.YSEX_OAM_LATCH_DB2n.tp_latch(_BODE_OAM_OEp_new, BUS_OAM_DBn[2].qp_ext());
      /* p31.YVEL*/ oam_bus.YVEL_OAM_LATCH_DB3n.tp_latch(_BODE_OAM_OEp_new, BUS_OAM_DBn[3].qp_ext());
      /* p31.WYNO*/ oam_bus.WYNO_OAM_LATCH_DB4n.tp_latch(_BODE_OAM_OEp_new, BUS_OAM_DBn[4].qp_ext());
      /* p31.CYRA*/ oam_bus.CYRA_OAM_LATCH_DB5n.tp_latch(_BODE_OAM_OEp_new, BUS_OAM_DBn[5].qp_ext());
      /* p31.ZUVE*/ oam_bus.ZUVE_OAM_LATCH_DB6n.tp_latch(_BODE_OAM_OEp_new, BUS_OAM_DBn[6].qp_ext());
      /* p31.ECED*/ oam_bus.ECED_OAM_LATCH_DB7n.tp_latch(_BODE_OAM_OEp_new, BUS_OAM_DBn[7].qp_ext());
    }

    {
      // OAM data latch A to CPU
      /* p28.GUKO*/ wire _GUKO_OBL_TO_CBDp_new = and3(LEKO_CPU_RDp_ext, _AMAB_CPU_OAM_ENp_new, _WAFO_OAM_A0n_new);
      /* p28.WUME*/ wire _WUME_OBL_TO_CBDn_new = not1(_GUKO_OBL_TO_CBDp_new);
      /* p29.YFAP*/ BUS_CPU_D[0].tri10_np(_WUME_OBL_TO_CBDn_new, oam_bus.YDYV_OAM_LATCH_DA0n.qn_new());
      /* p29.XELE*/ BUS_CPU_D[1].tri10_np(_WUME_OBL_TO_CBDn_new, oam_bus.YCEB_OAM_LATCH_DA1n.qn_new());
      /* p29.YPON*/ BUS_CPU_D[2].tri10_np(_WUME_OBL_TO_CBDn_new, oam_bus.ZUCA_OAM_LATCH_DA2n.qn_new());
      /* p29.XUVO*/ BUS_CPU_D[3].tri10_np(_WUME_OBL_TO_CBDn_new, oam_bus.WONE_OAM_LATCH_DA3n.qn_new());
      /* p29.ZYSA*/ BUS_CPU_D[4].tri10_np(_WUME_OBL_TO_CBDn_new, oam_bus.ZAXE_OAM_LATCH_DA4n.qn_new());
      /* p29.YWEG*/ BUS_CPU_D[5].tri10_np(_WUME_OBL_TO_CBDn_new, oam_bus.XAFU_OAM_LATCH_DA5n.qn_new());
      /* p29.XABU*/ BUS_CPU_D[6].tri10_np(_WUME_OBL_TO_CBDn_new, oam_bus.YSES_OAM_LATCH_DA6n.qn_new());
      /* p29.YTUX*/ BUS_CPU_D[7].tri10_np(_WUME_OBL_TO_CBDn_new, oam_bus.ZECA_OAM_LATCH_DA7n.qn_new());
    }

    {
      // OAM data latch B to CPU
      /* p28.WUKU*/ wire _WUKU_OBL_TO_CBDp_new = and3(LEKO_CPU_RDp_ext, _AMAB_CPU_OAM_ENp_new, _GEKA_OAM_A0p_new);
      /* p28.WEWU*/ wire _WEWU_OBL_TO_CBDn_new = not1(_WUKU_OBL_TO_CBDp_new);
      /* p31.XACA*/ BUS_CPU_D[0].tri10_np(_WEWU_OBL_TO_CBDn_new, oam_bus.XYKY_OAM_LATCH_DB0n.qn_new());
      /* p31.XAGU*/ BUS_CPU_D[1].tri10_np(_WEWU_OBL_TO_CBDn_new, oam_bus.YRUM_OAM_LATCH_DB1n.qn_new());
      /* p31.XEPU*/ BUS_CPU_D[2].tri10_np(_WEWU_OBL_TO_CBDn_new, oam_bus.YSEX_OAM_LATCH_DB2n.qn_new());
      /* p31.XYGU*/ BUS_CPU_D[3].tri10_np(_WEWU_OBL_TO_CBDn_new, oam_bus.YVEL_OAM_LATCH_DB3n.qn_new());
      /* p31.XUNA*/ BUS_CPU_D[4].tri10_np(_WEWU_OBL_TO_CBDn_new, oam_bus.WYNO_OAM_LATCH_DB4n.qn_new());
      /* p31.DEVE*/ BUS_CPU_D[5].tri10_np(_WEWU_OBL_TO_CBDn_new, oam_bus.CYRA_OAM_LATCH_DB5n.qn_new());
      /* p31.ZEHA*/ BUS_CPU_D[6].tri10_np(_WEWU_OBL_TO_CBDn_new, oam_bus.ZUVE_OAM_LATCH_DB6n.qn_new());
      /* p31.FYRA*/ BUS_CPU_D[7].tri10_np(_WEWU_OBL_TO_CBDn_new, oam_bus.ECED_OAM_LATCH_DB7n.qn_new());
    }
  }
  ();
  ...
  [this, cpu_addr, TEDO_CPU_RDp_ext, _TAPU_CPU_WRp_xxxxEFGx_clk]()
  {
    ...
    if ((cpu_addr >= 0xFF80) && (cpu_addr <= 0xFFFE)) {
      if (_TAPU_CPU_WRp_xxxxEFGx_clk) {
        zero_ram[cpu_addr & 0x007F] = pack_u8p(8, &BUS_CPU_D[0]);
      }

      BUS_CPU_D[0].tri(TEDO_CPU_RDp_ext, wire(zero_ram[cpu_addr & 0x007F] & 0x01));
      BUS_CPU_D[1].tri(TEDO_CPU_RDp_ext, wire(zero_ram[cpu_addr & 0x007F] & 0x02));
      BUS_CPU_D[2].tri(TEDO_CPU_RDp_ext, wire(zero_ram[cpu_addr & 0x007F] & 0x04));
      BUS_CPU_D[3].tri(TEDO_CPU_RDp_ext, wire(zero_ram[cpu_addr & 0x007F] & 0x08));
      BUS_CPU_D[4].tri(TEDO_CPU_RDp_ext, wire(zero_ram[cpu_addr & 0x007F] & 0x10));
      BUS_CPU_D[5].tri(TEDO_CPU_RDp_ext, wire(zero_ram[cpu_addr & 0x007F] & 0x20));
      BUS_CPU_D[6].tri(TEDO_CPU_RDp_ext, wire(zero_ram[cpu_addr & 0x007F] & 0x40));
      BUS_CPU_D[7].tri(TEDO_CPU_RDp_ext, wire(zero_ram[cpu_addr & 0x007F] & 0x80));
    }
  }
  ();
}
