...
void GateBoy::tock_slow() {
  ...
  /* p06.SARE*/ wire _SARE_XX00_XX07p_ext = nor5 (BUS_CPU_A[ 7], BUS_CPU_A[ 6], BUS_CPU_A[ 5],
                                                  BUS_CPU_A[ 4], BUS_CPU_A[ 3]);
  /* p07.TUNA*/ wire _TUNA_0000_FDFFp_ext = nand7(BUS_CPU_A[15], BUS_CPU_A[14], BUS_CPU_A[13],
                                                  BUS_CPU_A[12], BUS_CPU_A[11], BUS_CPU_A[10],
                                                  BUS_CPU_A[ 9]);

  /* p07.TULO*/ wire _TULO_00000000_XXp_ext = nor8(BUS_CPU_A[15], BUS_CPU_A[14], BUS_CPU_A[13], BUS_CPU_A[12],
  ...
  /* p22.XALY*/ wire _XALY_XX_0x00xxxxp_ext = nor3(BUS_CPU_A[ 7], BUS_CPU_A[ 5], BUS_CPU_A[ 4]);
  /* p10.AMUS*/ wire _AMUS_XX_0xx00000p_ext = nor6(BUS_CPU_A[ 0], BUS_CPU_A[ 1], BUS_CPU_A[ 2], BUS_CPU_A[ 3], BUS_CPU_A[ 4], BUS_CPU_A[ 7]);
  /* p07.TYRO*/ wire _TYFO_XX_0x0x0000p_ext = nor6(BUS_CPU_A[ 7], BUS_CPU_A[ 5], BUS_CPU_A[ 3], BUS_CPU_A[ 2], BUS_CPU_A[ 1], BUS_CPU_A[ 0]);
  /* p07.TUFA*/ wire _TUFA_XX_x1x1xxxxp_ext = and2(BUS_CPU_A[ 4], BUS_CPU_A[ 6]);

  /* p03.TOVY*/ wire _TOVY_A00n_ext = not1(BUS_CPU_A[ 0]);
  /* p22.XOLA*/ wire _XOLA_A00n_ext = not1(BUS_CPU_A[ 0]);
  /* p08.TOLA*/ wire _TOLA_A01n_ext = not1(BUS_CPU_A[ 1]);
  /* p22.XENO*/ wire _XENO_A01n_ext = not1(BUS_CPU_A[ 1]);
  /* p06.SEFY*/ wire _SEFY_A02n_ext = not1(BUS_CPU_A[ 2]);
  /* p22.XUSY*/ wire _XUSY_A02n_ext = not1(BUS_CPU_A[ 2]);
  /* p22.XERA*/ wire _XERA_A03n_ext = not1(BUS_CPU_A[ 3]);
  /* p10.BYKO*/ wire _BYKO_A05n_ext = not1(BUS_CPU_A[ 5]);
  /* p10.AKUG*/ wire _AKUG_A06n_ext = not1(BUS_CPU_A[ 6]);
  /* p07.TONA*/ wire _TONA_A08n_ext = not1(BUS_CPU_A[ 8]);
  /* p08.SOGY*/ wire _SOGY_A14n_ext = not1(BUS_CPU_A[14]);
  /*#p08.SORE*/ wire _SORE_A15n_ext = not1(BUS_CPU_A[15]);
  ...
  /* p03.RYFO*/ wire _RYFO_FF04_FF07p_ext  = and3(_SYKE_FF00_FFFFp_ext, BUS_CPU_A[ 2], _SARE_XX00_XX07p_ext);
  ...
  /*#p08.TEVY*/ wire _TEVY_8000_9FFFn_ext  = or3(BUS_CPU_A[13], BUS_CPU_A[14], _SORE_A15n_ext);
  /* p06.SANO*/ wire _SANO_FF00_FF03p_ext  = and3(_SARE_XX00_XX07p_ext, _SEFY_A02n_ext, _SYKE_FF00_FFFFp_ext);
  /* p22.WUTU*/ wire _WUTU_FF40_FF4Fn_ext  = nand3(_SYKE_FF00_FFFFp_ext, BUS_CPU_A[ 6], _XALY_XX_0x00xxxxp_ext);
...

  {
    ...
    /* p01.AFUR*/ clk_reg.AFUR_xxxxEFGHp_s.dff9(!_ATAL_xBxDxFxH_clk, _UPOJ_MODE_PRODn_ext, AFUR_xxxxEFGHp_old);
    /* p01.ALEF*/ clk_reg.ALEF_AxxxxFGHp_s.dff9( _ATAL_xBxDxFxH_clk, _UPOJ_MODE_PRODn_ext, ALEF_AxxxxFGHn_old);
    /* p01.APUK*/ clk_reg.APUK_ABxxxxGHp_s.dff9(!_ATAL_xBxDxFxH_clk, _UPOJ_MODE_PRODn_ext, APUK_ABxxxxGHn_old);
    /* p01.ADYK*/ clk_reg.ADYK_ABCxxxxHp_s.dff9( _ATAL_xBxDxFxH_clk, _UPOJ_MODE_PRODn_ext, ADYK_ABCxxxxHn_old);
  }
  ...
  /* p01.AREV*/ wire _AREV_CPU_WRn_ABCDxxxH_clk = nand2(PIN_CPU_WRp.qp_new(), _AFAS_xxxxEFGx_clk);
  ...
  /* p06.URYS*/ wire _URYS_FF01_WRn_clk = nand4(_TAPU_CPU_WRp_xxxxEFGx_clk, _SANO_FF00_FF03p_ext, BUS_CPU_A[ 0], _TOLA_A01n_ext);
  /* p06.UWAM*/ wire _UWAM_FF02_WRn_clk = nand4(_TAPU_CPU_WRp_xxxxEFGx_clk, _SANO_FF00_FF03p_ext, _TOVY_A00n_ext, BUS_CPU_A[ 1]);
  /* p01.TAPE*/ wire _TAPE_FF04_WRp_clk =  and4(_TAPU_CPU_WRp_xxxxEFGx_clk, _RYFO_FF04_FF07p_ext,  _TOLA_A01n_ext, _TOVY_A00n_ext);
  /*#p03.TOPE*/ wire _TOPE_FF05_WRn_clk = nand4(_TAPU_CPU_WRp_xxxxEFGx_clk, _RYFO_FF04_FF07p_ext,  BUS_CPU_A[ 0], _TOLA_A01n_ext);
  /* p03.TYJU*/ wire _TYJU_FF06_WRn_clk = nand4(_TAPU_CPU_WRp_xxxxEFGx_clk, _RYFO_FF04_FF07p_ext,  BUS_CPU_A[ 1], _TOVY_A00n_ext);
  /* p03.SARA*/ wire _SARA_FF07_WRn_clk = nand4(_TAPU_CPU_WRp_xxxxEFGx_clk, _RYFO_FF04_FF07p_ext,  BUS_CPU_A[ 1], BUS_CPU_A[ 0]);
  ...
  /* p07.UJYV*/ wire _UJYV_CPU_RDn_ext = mux2n(_UNOR_MODE_DBG2p_ext, /*PIN_EXT_RDn.qn_new()*/ 0, PIN_CPU_RDp.qp_new());
  ...
  /* p06.UFEG*/ wire _UFEG_FF01_RDp_ext =  and4(_TEDO_CPU_RDp_ext, _SANO_FF00_FF03p_ext,   BUS_CPU_A[ 0],      _TOLA_A01n_ext);
  /* p06.UCOM*/ wire _UCOM_FF02_RDp_ext =  and4(_TEDO_CPU_RDp_ext, _SANO_FF00_FF03p_ext,   _TOVY_A00n_ext,         BUS_CPU_A[ 1]);
  /* p01.TAGY*/ wire _TAGY_FF04_RDp_ext =  and4(_TEDO_CPU_RDp_ext, _RYFO_FF04_FF07p_ext,   _TOLA_A01n_ext,         _TOVY_A00n_ext);
  /*#p03.TEDA*/ wire _TEDA_FF05_RDp_ext =  and4(_TEDO_CPU_RDp_ext, _RYFO_FF04_FF07p_ext,   _TOLA_A01n_ext,         BUS_CPU_A[ 0]);
  /* p03.TUBY*/ wire _TUBY_FF06_RDp_ext =  and4(_TEDO_CPU_RDp_ext, _RYFO_FF04_FF07p_ext,   BUS_CPU_A[ 1],      _TOVY_A00n_ext);
  /* p03.SORA*/ wire _SORA_FF07_RDp_ext =  and4(_TEDO_CPU_RDp_ext, _RYFO_FF04_FF07p_ext,   BUS_CPU_A[ 1],      BUS_CPU_A[ 0]);
...
#pragma endregion
  ...
  /*#p08.TEXO*/ wire _TEXO_8000_9FFFn_new  = and2(PIN_CPU_EXT_BUSp.qp_new(), _TEVY_8000_9FFFn_ext);
  /*#p25.TEFA*/ wire _TEFA_8000_9FFFp_new  = nor2(_SYRO_FE00_FFFFp_ext, _TEXO_8000_9FFFn_new);
  ...
  /*#p01.AWOD*/ wire _AWOD_ABxxxxxx_new = nor2(_UNOR_MODE_DBG2p_ext, _AGUT_xxCDEFGH_new);
  /*#p01.ABUZ*/ wire _ABUZ_xxCDEFGH_new = not1(_AWOD_ABxxxxxx_new);

  /* p08.MOCA*/ wire _MOCA_DBG_EXT_RD_new = nor2(_TEXO_8000_9FFFn_new, _UMUT_MODE_DBG1p_ext);
  ...
  {
    /*#p25.SYCY*/ wire _SYCY_DBG_CLOCKn_new = not1(_UNOR_MODE_DBG2p_ext);
...
#pragma region Timer
  {
    ...
    /*#p03.MUZU*/ wire _MUZU_CPU_LOAD_TIMAn_ext  = or2(PIN_CPU_LATCH_EXT.qp_new(), _TOPE_FF05_WRn_clk);
    ...
    // FF06 TMA
    /* p03.SABU*/ tim_reg.SABU_TMA0p.dff17(_TYJU_FF06_WRn_clk, _ALUR_SYS_RSTn_new, BUS_CPU_Dp_old[0].qp_new());
    /* p03.NYKE*/ tim_reg.NYKE_TMA1p.dff17(_TYJU_FF06_WRn_clk, _ALUR_SYS_RSTn_new, BUS_CPU_Dp_old[1].qp_new());
    /* p03.MURU*/ tim_reg.MURU_TMA2p.dff17(_TYJU_FF06_WRn_clk, _ALUR_SYS_RSTn_new, BUS_CPU_Dp_old[2].qp_new());
    /* p03.TYVA*/ tim_reg.TYVA_TMA3p.dff17(_TYJU_FF06_WRn_clk, _ALUR_SYS_RSTn_new, BUS_CPU_Dp_old[3].qp_new());
    /* p03.TYRU*/ tim_reg.TYRU_TMA4p.dff17(_TYJU_FF06_WRn_clk, _ALUR_SYS_RSTn_new, BUS_CPU_Dp_old[4].qp_new());
    /* p03.SUFY*/ tim_reg.SUFY_TMA5p.dff17(_TYJU_FF06_WRn_clk, _ALUR_SYS_RSTn_new, BUS_CPU_Dp_old[5].qp_new());
    /* p03.PETO*/ tim_reg.PETO_TMA6p.dff17(_TYJU_FF06_WRn_clk, _ALUR_SYS_RSTn_new, BUS_CPU_Dp_old[6].qp_new());
    /* p03.SETA*/ tim_reg.SETA_TMA7p.dff17(_TYJU_FF06_WRn_clk, _ALUR_SYS_RSTn_new, BUS_CPU_Dp_old[7].qp_new());

    // FF07 TAC
    /* p03.SOPU*/ tim_reg.SOPU_TAC0p.dff17(_SARA_FF07_WRn_clk, _ALUR_SYS_RSTn_new, BUS_CPU_Dp_old[0].qp_new());
    /* p03.SAMY*/ tim_reg.SAMY_TAC1p.dff17(_SARA_FF07_WRn_clk, _ALUR_SYS_RSTn_new, BUS_CPU_Dp_old[1].qp_new());
    /* p03.SABO*/ tim_reg.SABO_TAC2p.dff17(_SARA_FF07_WRn_clk, _ALUR_SYS_RSTn_new, BUS_CPU_Dp_old[2].qp_new());

    /*#p03.ROKE*/ wire _ROKE_TIMA_D0_new = mux2n(_TOPE_FF05_WRn_clk, tim_reg.SABU_TMA0p.qp_new(), BUS_CPU_Dp_old[0].qp_new());
    /*#p03.PETU*/ wire _PETU_TIMA_D1_new = mux2n(_TOPE_FF05_WRn_clk, tim_reg.NYKE_TMA1p.qp_new(), BUS_CPU_Dp_old[1].qp_new());
    /*#p03.NYKU*/ wire _NYKU_TIMA_D2_new = mux2n(_TOPE_FF05_WRn_clk, tim_reg.MURU_TMA2p.qp_new(), BUS_CPU_Dp_old[2].qp_new());
    /*#p03.SOCE*/ wire _SOCE_TIMA_D3_new = mux2n(_TOPE_FF05_WRn_clk, tim_reg.TYVA_TMA3p.qp_new(), BUS_CPU_Dp_old[3].qp_new());
    /*#p03.SALA*/ wire _SALA_TIMA_D4_new = mux2n(_TOPE_FF05_WRn_clk, tim_reg.TYRU_TMA4p.qp_new(), BUS_CPU_Dp_old[4].qp_new());
    /*#p03.SYRU*/ wire _SYRU_TIMA_D5_new = mux2n(_TOPE_FF05_WRn_clk, tim_reg.SUFY_TMA5p.qp_new(), BUS_CPU_Dp_old[5].qp_new());
    /*#p03.REFU*/ wire _REFU_TIMA_D6_new = mux2n(_TOPE_FF05_WRn_clk, tim_reg.PETO_TMA6p.qp_new(), BUS_CPU_Dp_old[6].qp_new());
    /*#p03.RATO*/ wire _RATO_TIMA_D7_new = mux2n(_TOPE_FF05_WRn_clk, tim_reg.SETA_TMA7p.qp_new(), BUS_CPU_Dp_old[7].qp_new());
...
#pragma endregion
  ...
  /*#p28.BOGE*/ wire _BOGE_DMA_RUNNINGn_old = not1(dma_reg.MATU_DMA_RUNNINGp.qp_old());
  /*#p28.ACYL*/ wire _ACYL_SCANNINGp_old = and2(_BOGE_DMA_RUNNINGn_old, _BESU_SCANNINGp_old);
  ...
  /*#p27.PALO*/ wire _PALO_WY_MATCH_HIn_old  = nand5(pix_pipe.WYMO_LCDC_WINENn.qn_old(), _NOJO_WY_MATCH4p_old, _PAGA_WY_MATCH5p_old, _PEZO_WY_MATCH6p_old, _NUPA_WY_MATCH7p_old);
  ...
  /*#p29.AROR*/ wire _AROR_MATCH_ENp_old     = and2(_AZEM_RENDERINGp_old, pix_pipe.XYLO_LCDC_SPENn.qn_old());
  ...
  Bus2 SPR_TRI_I_in_old[6]; // to sprite store
  Bus2 SPR_TRI_L_in_old[4]; // to sprite store

  bool _GESE_SCAN_MATCH_Yp_old;
  {
    // this is using an adder as a subtracter by inverting the first input.

    /*#p29.EBOS*/ wire _EBOS_LY0n_old = not1(lcd_reg.MUWY_LY0p.qp_old());
    /* p29.DASA*/ wire _DASA_LY1n_old = not1(lcd_reg.MYRO_LY1p.qp_old());
    /* p29.FUKY*/ wire _FUKY_LY2n_old = not1(lcd_reg.LEXA_LY2p.qp_old());
    /* p29.FUVE*/ wire _FUVE_LY3n_old = not1(lcd_reg.LYDO_LY3p.qp_old());
    /* p29.FEPU*/ wire _FEPU_LY4n_old = not1(lcd_reg.LOVU_LY4p.qp_old());
    /* p29.FOFA*/ wire _FOFA_LY5n_old = not1(lcd_reg.LEMA_LY5p.qp_old());
    /* p29.FEMO*/ wire _FEMO_LY6n_old = not1(lcd_reg.MATO_LY6p.qp_old());
    /* p29.GUSU*/ wire _GUSU_LY7n_old = not1(lcd_reg.LAFO_LY7p.qp_old());

    /* p29.ERUC*/ wire _ERUC_YDIFF_S0_old = add_s(_EBOS_LY0n_old, oam_bus.XUSO_OAM_DA0p.qp_old(), GND);
    /* p29.ERUC*/ wire _ERUC_YDIFF_C0_old = add_c(_EBOS_LY0n_old, oam_bus.XUSO_OAM_DA0p.qp_old(), GND);
    /* p29.ENEF*/ wire _ENEF_YDIFF_S1_old = add_s(_DASA_LY1n_old, oam_bus.XEGU_OAM_DA1p.qp_old(), _ERUC_YDIFF_C0_old);
    /* p29.ENEF*/ wire _ENEF_YDIFF_C1_old = add_c(_DASA_LY1n_old, oam_bus.XEGU_OAM_DA1p.qp_old(), _ERUC_YDIFF_C0_old);
    /* p29.FECO*/ wire _FECO_YDIFF_S2_old = add_s(_FUKY_LY2n_old, oam_bus.YJEX_OAM_DA2p.qp_old(), _ENEF_YDIFF_C1_old);
    /* p29.FECO*/ wire _FECO_YDIFF_C2_old = add_c(_FUKY_LY2n_old, oam_bus.YJEX_OAM_DA2p.qp_old(), _ENEF_YDIFF_C1_old);
    /* p29.GYKY*/ wire _GYKY_YDIFF_S3_old = add_s(_FUVE_LY3n_old, oam_bus.XYJU_OAM_DA3p.qp_old(), _FECO_YDIFF_C2_old);
    /* p29.GYKY*/ wire _GYKY_YDIFF_C3_old = add_c(_FUVE_LY3n_old, oam_bus.XYJU_OAM_DA3p.qp_old(), _FECO_YDIFF_C2_old);
    /* p29.GOPU*/ wire _GOPU_YDIFF_S4_old = add_s(_FEPU_LY4n_old, oam_bus.YBOG_OAM_DA4p.qp_old(), _GYKY_YDIFF_C3_old);
    /* p29.GOPU*/ wire _GOPU_YDIFF_C4_old = add_c(_FEPU_LY4n_old, oam_bus.YBOG_OAM_DA4p.qp_old(), _GYKY_YDIFF_C3_old);
    /* p29.FUWA*/ wire _FUWA_YDIFF_S5_old = add_s(_FOFA_LY5n_old, oam_bus.WYSO_OAM_DA5p.qp_old(), _GOPU_YDIFF_C4_old);
    /* p29.FUWA*/ wire _FUWA_YDIFF_C5_old = add_c(_FOFA_LY5n_old, oam_bus.WYSO_OAM_DA5p.qp_old(), _GOPU_YDIFF_C4_old);
    /* p29.GOJU*/ wire _GOJU_YDIFF_S6_old = add_s(_FEMO_LY6n_old, oam_bus.XOTE_OAM_DA6p.qp_old(), _FUWA_YDIFF_C5_old);
    /* p29.GOJU*/ wire _GOJU_YDIFF_C6_old = add_c(_FEMO_LY6n_old, oam_bus.XOTE_OAM_DA6p.qp_old(), _FUWA_YDIFF_C5_old);
    /* p29.WUHU*/ wire _WUHU_YDIFF_S7_old = add_s(_GUSU_LY7n_old, oam_bus.YZAB_OAM_DA7p.qp_old(), _GOJU_YDIFF_C6_old);
    /* p29.WUHU*/ wire _WUHU_YDIFF_C7_old = add_c(_GUSU_LY7n_old, oam_bus.YZAB_OAM_DA7p.qp_old(), _GOJU_YDIFF_C6_old);

    /* p29.GACE*/ wire _GACE_SPRITE_DELTA4_old = not1(_GOPU_YDIFF_S4_old);
    /* p29.GUVU*/ wire _GUVU_SPRITE_DELTA5_old = not1(_FUWA_YDIFF_S5_old);
    /* p29.GYDA*/ wire _GYDA_SPRITE_DELTA6_old = not1(_GOJU_YDIFF_S6_old);
    /* p29.GEWY*/ wire _GEWY_SPRITE_DELTA7_old = not1(_WUHU_YDIFF_S7_old);
    /*#p29.GOVU*/ wire _GOVU_SPSIZE_MATCH_old = or2(pix_pipe.XYMO_LCDC_SPSIZEn.qn_old(), _GYKY_YDIFF_S3_old);

    /* p29.WOTA*/ wire _WOTA_SCAN_MATCH_Yn_old = nand6(_GACE_SPRITE_DELTA4_old, _GUVU_SPRITE_DELTA5_old, _GYDA_SPRITE_DELTA6_old, _GEWY_SPRITE_DELTA7_old, _WUHU_YDIFF_C7_old, _GOVU_SPSIZE_MATCH_old);

    /*#p29.BUZA*/ wire _BUZA_STORE_SPRITE_INDXn_old = and2(sprite_scanner.CENO_SCANNINGp.qn_old(), pix_pipe.XYMU_RENDERINGn.qn_old());
    /*#p30.WUZY*/ SPR_TRI_I_in_old[0].tri6_nn(_BUZA_STORE_SPRITE_INDXn_old, sprite_scanner.XADU_SPRITE_IDX0p.qn_old());
    /* p30.WYSE*/ SPR_TRI_I_in_old[1].tri6_nn(_BUZA_STORE_SPRITE_INDXn_old, sprite_scanner.XEDY_SPRITE_IDX1p.qn_old());
    /* p30.ZYSU*/ SPR_TRI_I_in_old[2].tri6_nn(_BUZA_STORE_SPRITE_INDXn_old, sprite_scanner.ZUZE_SPRITE_IDX2p.qn_old());
    /* p30.WYDA*/ SPR_TRI_I_in_old[3].tri6_nn(_BUZA_STORE_SPRITE_INDXn_old, sprite_scanner.XOBE_SPRITE_IDX3p.qn_old());
    /* p30.WUCO*/ SPR_TRI_I_in_old[4].tri6_nn(_BUZA_STORE_SPRITE_INDXn_old, sprite_scanner.YDUF_SPRITE_IDX4p.qn_old());
    /* p30.WEZA*/ SPR_TRI_I_in_old[5].tri6_nn(_BUZA_STORE_SPRITE_INDXn_old, sprite_scanner.XECU_SPRITE_IDX5p.qn_old());

    /* p29.DEGE*/ wire _DEGE_SPRITE_DELTA0_old = not1(_ERUC_YDIFF_S0_old);
    /* p29.DABY*/ wire _DABY_SPRITE_DELTA1_old = not1(_ENEF_YDIFF_S1_old);
    /* p29.DABU*/ wire _DABU_SPRITE_DELTA2_old = not1(_FECO_YDIFF_S2_old);
    /* p29.GYSA*/ wire _GYSA_SPRITE_DELTA3_old = not1(_GYKY_YDIFF_S3_old);

    // FIXME old/new
    /*#p30.CUCU*/ SPR_TRI_L_in_old[0].tri6_nn(_FEPO_STORE_MATCHp_old, _DEGE_SPRITE_DELTA0_old);
    /*#p30.CUCA*/ SPR_TRI_L_in_old[1].tri6_nn(_FEPO_STORE_MATCHp_old, _DABY_SPRITE_DELTA1_old);
    /*#p30.CEGA*/ SPR_TRI_L_in_old[2].tri6_nn(_FEPO_STORE_MATCHp_old, _DABU_SPRITE_DELTA2_old);
    /*#p30.WENU*/ SPR_TRI_L_in_old[3].tri6_nn(_FEPO_STORE_MATCHp_old, _GYSA_SPRITE_DELTA3_old);

    /* p29.GESE*/ _GESE_SCAN_MATCH_Yp_old = not1(_WOTA_SCAN_MATCH_Yn_old);
  }
...
#pragma region Regs_Write
  {
    ...
    /* p05.JUTE*/ joypad.JUTE_JOYP_RA     .dff17(_ATOZ_FF00_WRn_clk, _ALUR_SYS_RSTn_new, BUS_CPU_Dp_old[0].qp_new());
    /* p05.KECY*/ joypad.KECY_JOYP_LB     .dff17(_ATOZ_FF00_WRn_clk, _ALUR_SYS_RSTn_new, BUS_CPU_Dp_old[1].qp_new());
    /* p05.JALE*/ joypad.JALE_JOYP_UC     .dff17(_ATOZ_FF00_WRn_clk, _ALUR_SYS_RSTn_new, BUS_CPU_Dp_old[2].qp_new());
    /* p05.KYME*/ joypad.KYME_JOYP_DS     .dff17(_ATOZ_FF00_WRn_clk, _ALUR_SYS_RSTn_new, BUS_CPU_Dp_old[3].qp_new());
    /* p05.KELY*/ joypad.KELY_JOYP_UDLRp  .dff17(_ATOZ_FF00_WRn_clk, _ALUR_SYS_RSTn_new, BUS_CPU_Dp_old[4].qp_new());
    /* p05.COFY*/ joypad.COFY_JOYP_ABCSp  .dff17(_ATOZ_FF00_WRn_clk, _ALUR_SYS_RSTn_new, BUS_CPU_Dp_old[5].qp_new());
    /* p05.KUKO*/ joypad.KUKO_DBG_FF00_D6n.dff17(_ATOZ_FF00_WRn_clk, _ALUR_SYS_RSTn_new, BUS_CPU_Dp_old[6].qp_new());
    /* p05.KERU*/ joypad.KERU_DBG_FF00_D7n.dff17(_ATOZ_FF00_WRn_clk, _ALUR_SYS_RSTn_new, BUS_CPU_Dp_old[7].qp_new());
  }
  {
    // FF40 LCDC
    /*#p23.VYXE*/ pix_pipe.VYXE_LCDC_BGENn  .dff9(_XUBO_FF40_WRn_clk, _XARE_SYS_RSTn_new, BUS_CPU_Dp_old[0].qp_new());
    /* p23.XYLO*/ pix_pipe.XYLO_LCDC_SPENn  .dff9(_XUBO_FF40_WRn_clk, _XARE_SYS_RSTn_new, BUS_CPU_Dp_old[1].qp_new());
    /* p23.XYMO*/ pix_pipe.XYMO_LCDC_SPSIZEn.dff9(_XUBO_FF40_WRn_clk, _XARE_SYS_RSTn_new, BUS_CPU_Dp_old[2].qp_new());
    /* p23.XAFO*/ pix_pipe.XAFO_LCDC_BGMAPn .dff9(_XUBO_FF40_WRn_clk, _XARE_SYS_RSTn_new, BUS_CPU_Dp_old[3].qp_new());
    /* p23.WEXU*/ pix_pipe.WEXU_LCDC_BGTILEn.dff9(_XUBO_FF40_WRn_clk, _XARE_SYS_RSTn_new, BUS_CPU_Dp_old[4].qp_new());
    /* p23.WYMO*/ pix_pipe.WYMO_LCDC_WINENn .dff9(_XUBO_FF40_WRn_clk, _XARE_SYS_RSTn_new, BUS_CPU_Dp_old[5].qp_new());
    /* p23.WOKY*/ pix_pipe.WOKY_LCDC_WINMAPn.dff9(_XUBO_FF40_WRn_clk, _XARE_SYS_RSTn_new, BUS_CPU_Dp_old[6].qp_new());
    /* p23.XONA*/ pix_pipe.XONA_LCDC_LCDENn .dff9(_XUBO_FF40_WRn_clk, _XARE_SYS_RSTn_new, BUS_CPU_Dp_old[7].qp_new());
  }
  {
    // FF41 STAT
    /* p21.ROXE*/ pix_pipe.ROXE_STAT_HBI_ENn.dff9(_RYVE_FF41_WRn_clk, _WESY_SYS_RSTn_new, BUS_CPU_Dp_old[3].qp_new());
    /* p21.RUFO*/ pix_pipe.RUFO_STAT_VBI_ENn.dff9(_RYVE_FF41_WRn_clk, _WESY_SYS_RSTn_new, BUS_CPU_Dp_old[4].qp_new());
    /* p21.REFE*/ pix_pipe.REFE_STAT_OAI_ENn.dff9(_RYVE_FF41_WRn_clk, _WESY_SYS_RSTn_new, BUS_CPU_Dp_old[5].qp_new());
    /* p21.RUGU*/ pix_pipe.RUGU_STAT_LYI_ENn.dff9(_RYVE_FF41_WRn_clk, _WESY_SYS_RSTn_new, BUS_CPU_Dp_old[6].qp_new());
  }
  {
    // FF42 SCY
    /* p23.GAVE*/ pix_pipe.GAVE_SCY0n.dff9(_CAVO_FF42_WRn_clk, _CUNU_SYS_RSTn_new, BUS_CPU_Dp_old[0].qp_new());
    /* p23.FYMO*/ pix_pipe.FYMO_SCY1n.dff9(_CAVO_FF42_WRn_clk, _CUNU_SYS_RSTn_new, BUS_CPU_Dp_old[1].qp_new());
    /* p23.FEZU*/ pix_pipe.FEZU_SCY2n.dff9(_CAVO_FF42_WRn_clk, _CUNU_SYS_RSTn_new, BUS_CPU_Dp_old[2].qp_new());
    /* p23.FUJO*/ pix_pipe.FUJO_SCY3n.dff9(_CAVO_FF42_WRn_clk, _CUNU_SYS_RSTn_new, BUS_CPU_Dp_old[3].qp_new());
    /* p23.DEDE*/ pix_pipe.DEDE_SCY4n.dff9(_CAVO_FF42_WRn_clk, _CUNU_SYS_RSTn_new, BUS_CPU_Dp_old[4].qp_new());
    /* p23.FOTY*/ pix_pipe.FOTY_SCY5n.dff9(_CAVO_FF42_WRn_clk, _CUNU_SYS_RSTn_new, BUS_CPU_Dp_old[5].qp_new());
    /* p23.FOHA*/ pix_pipe.FOHA_SCY6n.dff9(_CAVO_FF42_WRn_clk, _CUNU_SYS_RSTn_new, BUS_CPU_Dp_old[6].qp_new());
    /* p23.FUNY*/ pix_pipe.FUNY_SCY7n.dff9(_CAVO_FF42_WRn_clk, _CUNU_SYS_RSTn_new, BUS_CPU_Dp_old[7].qp_new());
  }
  {
    // FF43 SCX
    /* p23.DATY*/ pix_pipe.DATY_SCX0n.dff9(_AMUN_FF43_WRn_clk, _CUNU_SYS_RSTn_new, BUS_CPU_Dp_old[0].qp_new());
    /* p23.DUZU*/ pix_pipe.DUZU_SCX1n.dff9(_AMUN_FF43_WRn_clk, _CUNU_SYS_RSTn_new, BUS_CPU_Dp_old[1].qp_new());
    /* p23.CYXU*/ pix_pipe.CYXU_SCX2n.dff9(_AMUN_FF43_WRn_clk, _CUNU_SYS_RSTn_new, BUS_CPU_Dp_old[2].qp_new());
    /* p23.GUBO*/ pix_pipe.GUBO_SCX3n.dff9(_AMUN_FF43_WRn_clk, _CUNU_SYS_RSTn_new, BUS_CPU_Dp_old[3].qp_new());
    /* p23.BEMY*/ pix_pipe.BEMY_SCX4n.dff9(_AMUN_FF43_WRn_clk, _CUNU_SYS_RSTn_new, BUS_CPU_Dp_old[4].qp_new());
    /* p23.CUZY*/ pix_pipe.CUZY_SCX5n.dff9(_AMUN_FF43_WRn_clk, _CUNU_SYS_RSTn_new, BUS_CPU_Dp_old[5].qp_new());
    /* p23.CABU*/ pix_pipe.CABU_SCX6n.dff9(_AMUN_FF43_WRn_clk, _CUNU_SYS_RSTn_new, BUS_CPU_Dp_old[6].qp_new());
    /* p23.BAKE*/ pix_pipe.BAKE_SCX7n.dff9(_AMUN_FF43_WRn_clk, _CUNU_SYS_RSTn_new, BUS_CPU_Dp_old[7].qp_new());
  }
  {
    // FF45 LYC
    /* p23.SYRY*/ lcd_reg.SYRY_LYC0n_s.dff9(_WANE_FF45_WRp_clk, _WESY_SYS_RSTn_new, BUS_CPU_Dp_old[0].qp_new());
    /* p23.VUCE*/ lcd_reg.VUCE_LYC1n_s.dff9(_WANE_FF45_WRp_clk, _WESY_SYS_RSTn_new, BUS_CPU_Dp_old[1].qp_new());
    /* p23.SEDY*/ lcd_reg.SEDY_LYC2n_s.dff9(_WANE_FF45_WRp_clk, _WESY_SYS_RSTn_new, BUS_CPU_Dp_old[2].qp_new());
    /* p23.SALO*/ lcd_reg.SALO_LYC3n_s.dff9(_WANE_FF45_WRp_clk, _WESY_SYS_RSTn_new, BUS_CPU_Dp_old[3].qp_new());
    /* p23.SOTA*/ lcd_reg.SOTA_LYC4n_s.dff9(_WANE_FF45_WRp_clk, _WESY_SYS_RSTn_new, BUS_CPU_Dp_old[4].qp_new());
    /* p23.VAFA*/ lcd_reg.VAFA_LYC5n_s.dff9(_WANE_FF45_WRp_clk, _WESY_SYS_RSTn_new, BUS_CPU_Dp_old[5].qp_new());
    /* p23.VEVO*/ lcd_reg.VEVO_LYC6n_s.dff9(_WANE_FF45_WRp_clk, _WESY_SYS_RSTn_new, BUS_CPU_Dp_old[6].qp_new());
    /* p23.RAHA*/ lcd_reg.RAHA_LYC7n_s.dff9(_WANE_FF45_WRp_clk, _WESY_SYS_RSTn_new, BUS_CPU_Dp_old[7].qp_new());
  }
  {
    // FF47 BGP
    /*#p36.PAVO*/ pix_pipe.PAVO_BGP_D0n.dff8p(_TEPO_FF47_WRp_clk, BUS_CPU_Dp_old[0].qp_new());
    /* p36.NUSY*/ pix_pipe.NUSY_BGP_D1n.dff8p(_TEPO_FF47_WRp_clk, BUS_CPU_Dp_old[1].qp_new());
    /* p36.PYLU*/ pix_pipe.PYLU_BGP_D2n.dff8p(_TEPO_FF47_WRp_clk, BUS_CPU_Dp_old[2].qp_new());
    /* p36.MAXY*/ pix_pipe.MAXY_BGP_D3n.dff8p(_TEPO_FF47_WRp_clk, BUS_CPU_Dp_old[3].qp_new());
    /* p36.MUKE*/ pix_pipe.MUKE_BGP_D4n.dff8p(_TEPO_FF47_WRp_clk, BUS_CPU_Dp_old[4].qp_new());
    /* p36.MORU*/ pix_pipe.MORU_BGP_D5n.dff8p(_TEPO_FF47_WRp_clk, BUS_CPU_Dp_old[5].qp_new());
    /* p36.MOGY*/ pix_pipe.MOGY_BGP_D6n.dff8p(_TEPO_FF47_WRp_clk, BUS_CPU_Dp_old[6].qp_new());
    /* p36.MENA*/ pix_pipe.MENA_BGP_D7n.dff8p(_TEPO_FF47_WRp_clk, BUS_CPU_Dp_old[7].qp_new());
  }
  {
    // FF48 OBP0
    /* p36.XUFU*/ pix_pipe.XUFU_OBP0_D0n.dff8p(_XELO_FF48_WRn_clk, BUS_CPU_Dp_old[0].qp_new());
    /* p36.XUKY*/ pix_pipe.XUKY_OBP0_D1n.dff8p(_XELO_FF48_WRn_clk, BUS_CPU_Dp_old[1].qp_new());
    /* p36.XOVA*/ pix_pipe.XOVA_OBP0_D2n.dff8p(_XELO_FF48_WRn_clk, BUS_CPU_Dp_old[2].qp_new());
    /* p36.XALO*/ pix_pipe.XALO_OBP0_D3n.dff8p(_XELO_FF48_WRn_clk, BUS_CPU_Dp_old[3].qp_new());
    /* p36.XERU*/ pix_pipe.XERU_OBP0_D4n.dff8p(_XELO_FF48_WRn_clk, BUS_CPU_Dp_old[4].qp_new());
    /* p36.XYZE*/ pix_pipe.XYZE_OBP0_D5n.dff8p(_XELO_FF48_WRn_clk, BUS_CPU_Dp_old[5].qp_new());
    /* p36.XUPO*/ pix_pipe.XUPO_OBP0_D6n.dff8p(_XELO_FF48_WRn_clk, BUS_CPU_Dp_old[6].qp_new());
    /* p36.XANA*/ pix_pipe.XANA_OBP0_D7n.dff8p(_XELO_FF48_WRn_clk, BUS_CPU_Dp_old[7].qp_new());
  }
  {
    // FF49 OBP1
    /* p36.MOXY*/ pix_pipe.MOXY_OBP1_D0n.dff8p(_LEHO_FF49_WRn_clk, BUS_CPU_Dp_old[0].qp_new());
    /* p36.LAWO*/ pix_pipe.LAWO_OBP1_D1n.dff8p(_LEHO_FF49_WRn_clk, BUS_CPU_Dp_old[1].qp_new());
    /* p36.MOSA*/ pix_pipe.MOSA_OBP1_D2n.dff8p(_LEHO_FF49_WRn_clk, BUS_CPU_Dp_old[2].qp_new());
    /* p36.LOSE*/ pix_pipe.LOSE_OBP1_D3n.dff8p(_LEHO_FF49_WRn_clk, BUS_CPU_Dp_old[3].qp_new());
    /* p36.LUNE*/ pix_pipe.LUNE_OBP1_D4n.dff8p(_LEHO_FF49_WRn_clk, BUS_CPU_Dp_old[4].qp_new());
    /* p36.LUGU*/ pix_pipe.LUGU_OBP1_D5n.dff8p(_LEHO_FF49_WRn_clk, BUS_CPU_Dp_old[5].qp_new());
    /* p36.LEPU*/ pix_pipe.LEPU_OBP1_D6n.dff8p(_LEHO_FF49_WRn_clk, BUS_CPU_Dp_old[6].qp_new());
    /* p36.LUXO*/ pix_pipe.LUXO_OBP1_D7n.dff8p(_LEHO_FF49_WRn_clk, BUS_CPU_Dp_old[7].qp_new());
  }
  {
    // FF4A WY
    /* p23.NESO*/ pix_pipe.NESO_WY0n.dff9(_VEFU_FF4A_WRn_clk, _WALU_SYS_RSTn_new, BUS_CPU_Dp_old[0].qp_new());
    /* p23.NYRO*/ pix_pipe.NYRO_WY1n.dff9(_VEFU_FF4A_WRn_clk, _WALU_SYS_RSTn_new, BUS_CPU_Dp_old[1].qp_new());
    /* p23.NAGA*/ pix_pipe.NAGA_WY2n.dff9(_VEFU_FF4A_WRn_clk, _WALU_SYS_RSTn_new, BUS_CPU_Dp_old[2].qp_new());
    /* p23.MELA*/ pix_pipe.MELA_WY3n.dff9(_VEFU_FF4A_WRn_clk, _WALU_SYS_RSTn_new, BUS_CPU_Dp_old[3].qp_new());
    /* p23.NULO*/ pix_pipe.NULO_WY4n.dff9(_VEFU_FF4A_WRn_clk, _WALU_SYS_RSTn_new, BUS_CPU_Dp_old[4].qp_new());
    /* p23.NENE*/ pix_pipe.NENE_WY5n.dff9(_VEFU_FF4A_WRn_clk, _WALU_SYS_RSTn_new, BUS_CPU_Dp_old[5].qp_new());
    /* p23.NUKA*/ pix_pipe.NUKA_WY6n.dff9(_VEFU_FF4A_WRn_clk, _WALU_SYS_RSTn_new, BUS_CPU_Dp_old[6].qp_new());
    /* p23.NAFU*/ pix_pipe.NAFU_WY7n.dff9(_VEFU_FF4A_WRn_clk, _WALU_SYS_RSTn_new, BUS_CPU_Dp_old[7].qp_new());
  }
  {
    // FF4B WX
    /* p23.MYPA*/ pix_pipe.MYPA_WX0n.dff9(_VOXU_FF4B_WRn_clk, _WALU_SYS_RSTn_new, BUS_CPU_Dp_old[0].qp_new());
    /* p23.NOFE*/ pix_pipe.NOFE_WX1n.dff9(_VOXU_FF4B_WRn_clk, _WALU_SYS_RSTn_new, BUS_CPU_Dp_old[1].qp_new());
    /* p23.NOKE*/ pix_pipe.NOKE_WX2n.dff9(_VOXU_FF4B_WRn_clk, _WALU_SYS_RSTn_new, BUS_CPU_Dp_old[2].qp_new());
    /* p23.MEBY*/ pix_pipe.MEBY_WX3n.dff9(_VOXU_FF4B_WRn_clk, _WALU_SYS_RSTn_new, BUS_CPU_Dp_old[3].qp_new());
    /* p23.MYPU*/ pix_pipe.MYPU_WX4n.dff9(_VOXU_FF4B_WRn_clk, _WALU_SYS_RSTn_new, BUS_CPU_Dp_old[4].qp_new());
    /* p23.MYCE*/ pix_pipe.MYCE_WX5n.dff9(_VOXU_FF4B_WRn_clk, _WALU_SYS_RSTn_new, BUS_CPU_Dp_old[5].qp_new());
    /* p23.MUVO*/ pix_pipe.MUVO_WX6n.dff9(_VOXU_FF4B_WRn_clk, _WALU_SYS_RSTn_new, BUS_CPU_Dp_old[6].qp_new());
    /* p23.NUKU*/ pix_pipe.NUKU_WX7n.dff9(_VOXU_FF4B_WRn_clk, _WALU_SYS_RSTn_new, BUS_CPU_Dp_old[7].qp_new());
  }
#pragma endregion
  ...
  /*#p29.XOCE*/ wire _XOCE_xBCxxFGx_clkold = not1(clk_reg.WOSU_AxxDExxHp.qp_old());
  ///*#p29.XUPY*/ wire _XUPY_ABxxEFxx_clkold = not1(clk_reg.WUVU_ABxxEFxxp.qn_old());
  ///*#p21.TALU*/ wire _TALU_xxCDEFxx_clkold = not1(clk_reg.VENA_xxCDEFxxp.qn_old());
  ///*#p21.SONO*/ wire _SONO_ABxxxxGH_clkold = not1(_TALU_xxCDEFxx_clkold);
  ///*#p28.AWOH*/ wire _AWOH_xxCDxxGH_clkold = not1(_XUPY_ABxxEFxx_clkold);
...
#pragma region DMA_Registers
  ...
  /*#p04.NAKY*/ wire _NAKY_DMA_A00p_old = dma_reg.NAKY_DMA_A00p.qp_old();
  /*#p04.PYRO*/ wire _PYRO_DMA_A01p_old = dma_reg.PYRO_DMA_A01p.qp_old();
  /* p04.NEFY*/ wire _NEFY_DMA_A02p_old = dma_reg.NEFY_DMA_A02p.qp_old();
  /* p04.MUTY*/ wire _MUTY_DMA_A03p_old = dma_reg.MUTY_DMA_A03p.qp_old();
  /* p04.NYKO*/ wire _NYKO_DMA_A04p_old = dma_reg.NYKO_DMA_A04p.qp_old();
  /* p04.PYLO*/ wire _PYLO_DMA_A05p_old = dma_reg.PYLO_DMA_A05p.qp_old();
  /* p04.NUTO*/ wire _NUTO_DMA_A06p_old = dma_reg.NUTO_DMA_A06p.qp_old();
  /* p04.MUGU*/ wire _MUGU_DMA_A07p_old = dma_reg.MUGU_DMA_A07p.qp_old();

  {
    ...
    /*#p04.MATU*/ dma_reg.MATU_DMA_RUNNINGp.dff17(_UVYT_ABCDxxxx_clk, _CUNU_SYS_RSTn_new, _LOKY_DMA_LATCHp_old);
  }
...
#pragma endregion
  ...
  /*#p29.AVAP*/ wire _AVAP_SCAN_DONE_TRIGp_new = [&]() {
    ...
    /* p28.GAVA*/ wire _GAVA_ABxxEFxx_old = or2(_FETO_SCAN_DONEp_old, _XUPY_ABxxEFxx_clknew); // this old/new is ok because it's a clock, i think...
    ...
    /* p28.YFEL*/ sprite_scanner.YFEL_SCAN0.clknew(_GAVA_ABxxEFxx_new);
    ...
    /*#p29.CENO*/ sprite_scanner.CENO_SCANNINGp.dff17(_XUPY_ABxxEFxx_clknew, _ABEZ_VID_RSTn_new,  _BESU_SCANNINGp_old);
  ...
  /*#p24.VYBO*/ wire _VYBO_CLKPIPE_xBxDxFxH_clkold = nor3(_FEPO_STORE_MATCHp_old, _WODU_HBLANKp_old, _MYVO_AxCxExGx_clk); // FIXME old/old/new? this is ok i think.
  ...
  /*#p24.VYBO*/ wire _VYBO_CLKPIPE_xBxDxFxH_clknew = nor3(_FEPO_STORE_MATCHp_old, _WODU_HBLANKp_old, _MYVO_AxCxExGx_clk);
  ...
  /* p24.NYKA*/ tile_fetcher.NYKA_FETCH_DONEp.dff17(_ALET_xBxDxFxH_clk, _NAFY_RENDERING_AND_NOT_WIN_TRIG_new, _LYRY_BFETCH_DONEp_old);
  ...
  /* p27.LAXU*/ tile_fetcher.LAXU_BFETCH_S0p.dff17(_LEBO_AxCxExGx_clkold,                 _NYXU_FETCH_TRIGn_new, tile_fetcher.LAXU_BFETCH_S0p.qn_old());
  ...
  /* p27.LEBO*/ wire _LEBO_AxCxExGx_clknew = nand2(_ALET_xBxDxFxH_clk, _MOCE_BFETCH_DONEn_new);
  /* p27.LAXU*/ tile_fetcher.LAXU_BFETCH_S0p.clknew(_LEBO_AxCxExGx_clknew);
  ...
  /*#p24.SACU*/ wire _SACU_CLKPIPE_AxCxExGx_clkold = or2(_SEGU_CLKPIPE_AxCxExGx_clkold, pix_pipe.ROXY_SCX_FINE_MATCH_LATCHn.qp_old()); // Schematic wrong, this is OR
  ...
  /*#p24.ROXO*/ wire _ROXO_CLKPIPE_xBxDxFxH_clknew = not1(_SEGU_CLKPIPE_AxCxExGx_clknew);
  {
    ...
    /*#p27.RYKU*/ pix_pipe.RYKU_FINE_CNT0.clknew(_PECU_FINE_CLK_AxCxExGx_clknew);
  ...
  /*#p29.TOXE*/ sprite_fetcher.TOXE_SFETCH_S0p.clknew(_TOMA_SFETCH_xBxDxFxH_clknew);
  ...
  Bus2 SPR_TRI_I_out_old[6]; // from sprite store
  Bus2 SPR_TRI_L_out_old[4]; // from sprite store
  Bus2 BUS_OAM_An_old[8]; // not yet stable

  {
    /* p30.ZETU*/ SPR_TRI_I_out_old[0].tri6_nn(_FURO_SPRITE0_GETn_old, sprite_store.YGUS_STORE0_I0n.qp_old());
    /* p30.ZECE*/ SPR_TRI_I_out_old[1].tri6_nn(_FURO_SPRITE0_GETn_old, sprite_store.YSOK_STORE0_I1n.qp_old());
    /* p30.ZAVE*/ SPR_TRI_I_out_old[2].tri6_nn(_FURO_SPRITE0_GETn_old, sprite_store.YZEP_STORE0_I2n.qp_old());
    /* p30.WOKO*/ SPR_TRI_I_out_old[3].tri6_nn(_FURO_SPRITE0_GETn_old, sprite_store.WYTE_STORE0_I3n.qp_old());
    /* p30.ZUMU*/ SPR_TRI_I_out_old[4].tri6_nn(_FURO_SPRITE0_GETn_old, sprite_store.ZONY_STORE0_I4n.qp_old());
    /*#p30.ZEDY*/ SPR_TRI_I_out_old[5].tri6_nn(_FURO_SPRITE0_GETn_old, sprite_store.YWAK_STORE0_I5n.qp_old());
    /* p30.WEHE*/ SPR_TRI_L_out_old[0].tri6_nn(_FURO_SPRITE0_GETn_old, sprite_store.GYHO_STORE0_L0n.qp_old());
    /* p30.BUKY*/ SPR_TRI_L_out_old[1].tri6_nn(_FURO_SPRITE0_GETn_old, sprite_store.CUFO_STORE0_L1n.qp_old());
    /* p30.AJAL*/ SPR_TRI_L_out_old[2].tri6_nn(_FURO_SPRITE0_GETn_old, sprite_store.BOZU_STORE0_L2n.qp_old());
    /* p30.GOFO*/ SPR_TRI_L_out_old[3].tri6_nn(_FURO_SPRITE0_GETn_old, sprite_store.FYHY_STORE0_L3n.qp_old());

    /*#p30.CUBO*/ SPR_TRI_I_out_old[0].tri6_nn(_DYDO_SPRITE1_GETn_old, sprite_store.CADU_STORE1_I0n.qp_old());
    /* p30.CELU*/ SPR_TRI_I_out_old[1].tri6_nn(_DYDO_SPRITE1_GETn_old, sprite_store.CEBO_STORE1_I1n.qp_old());
    /* p30.CEGY*/ SPR_TRI_I_out_old[2].tri6_nn(_DYDO_SPRITE1_GETn_old, sprite_store.CUFA_STORE1_I2n.qp_old());
    /* p30.BETY*/ SPR_TRI_I_out_old[3].tri6_nn(_DYDO_SPRITE1_GETn_old, sprite_store.COMA_STORE1_I3n.qp_old());
    /* p30.CYBY*/ SPR_TRI_I_out_old[4].tri6_nn(_DYDO_SPRITE1_GETn_old, sprite_store.CUZA_STORE1_I4n.qp_old());
    /* p30.BEMO*/ SPR_TRI_I_out_old[5].tri6_nn(_DYDO_SPRITE1_GETn_old, sprite_store.CAJY_STORE1_I5n.qp_old());
    /* p30.BYRO*/ SPR_TRI_L_out_old[0].tri6_nn(_DYDO_SPRITE1_GETn_old, sprite_store.AMES_STORE1_L0n.qp_old());
    /* p30.AHUM*/ SPR_TRI_L_out_old[1].tri6_nn(_DYDO_SPRITE1_GETn_old, sprite_store.AROF_STORE1_L1n.qp_old());
    /* p30.BACO*/ SPR_TRI_L_out_old[2].tri6_nn(_DYDO_SPRITE1_GETn_old, sprite_store.ABOP_STORE1_L2n.qp_old());
    /* p30.BEFE*/ SPR_TRI_L_out_old[3].tri6_nn(_DYDO_SPRITE1_GETn_old, sprite_store.ABUG_STORE1_L3n.qp_old());

    /* p30.CUBE*/ SPR_TRI_I_out_old[0].tri6_nn(_FAME_SPRITE2_GETn_old, sprite_store.BUHE_STORE2_I0n.qp_old());
    /* p30.AFOZ*/ SPR_TRI_I_out_old[1].tri6_nn(_FAME_SPRITE2_GETn_old, sprite_store.BYHU_STORE2_I1n.qp_old());
    /* p30.APON*/ SPR_TRI_I_out_old[2].tri6_nn(_FAME_SPRITE2_GETn_old, sprite_store.BECA_STORE2_I2n.qp_old());
    /* p30.CUVU*/ SPR_TRI_I_out_old[3].tri6_nn(_FAME_SPRITE2_GETn_old, sprite_store.BULU_STORE2_I3n.qp_old());
    /* p30.CYRO*/ SPR_TRI_I_out_old[4].tri6_nn(_FAME_SPRITE2_GETn_old, sprite_store.BUNA_STORE2_I4n.qp_old());
    /* p30.AXEC*/ SPR_TRI_I_out_old[5].tri6_nn(_FAME_SPRITE2_GETn_old, sprite_store.BOXA_STORE2_I5n.qp_old());
    /* p30.ZUKE*/ SPR_TRI_L_out_old[0].tri6_nn(_FAME_SPRITE2_GETn_old, sprite_store.YLOV_STORE2_L0n.qp_old());
    /* p30.WERE*/ SPR_TRI_L_out_old[1].tri6_nn(_FAME_SPRITE2_GETn_old, sprite_store.XOSY_STORE2_L1n.qp_old());
    /* p30.WUXE*/ SPR_TRI_L_out_old[2].tri6_nn(_FAME_SPRITE2_GETn_old, sprite_store.XAZY_STORE2_L2n.qp_old());
    /* p30.ZABY*/ SPR_TRI_L_out_old[3].tri6_nn(_FAME_SPRITE2_GETn_old, sprite_store.YKUK_STORE2_L3n.qp_old());

    /* p30.ENAP*/ SPR_TRI_I_out_old[0].tri6_nn(_GYMA_SPRITE3_GETn_old, sprite_store.DEVY_STORE3_I0n.qp_old());
    /* p30.DYGO*/ SPR_TRI_I_out_old[1].tri6_nn(_GYMA_SPRITE3_GETn_old, sprite_store.DESE_STORE3_I1n.qp_old());
    /* p30.DOWA*/ SPR_TRI_I_out_old[2].tri6_nn(_GYMA_SPRITE3_GETn_old, sprite_store.DUNY_STORE3_I2n.qp_old());
    /* p30.DONY*/ SPR_TRI_I_out_old[3].tri6_nn(_GYMA_SPRITE3_GETn_old, sprite_store.DUHA_STORE3_I3n.qp_old());
    /* p30.EFUD*/ SPR_TRI_I_out_old[4].tri6_nn(_GYMA_SPRITE3_GETn_old, sprite_store.DEBA_STORE3_I4n.qp_old());
    /* p30.DEZU*/ SPR_TRI_I_out_old[5].tri6_nn(_GYMA_SPRITE3_GETn_old, sprite_store.DAFU_STORE3_I5n.qp_old());
    /* p30.ZEXE*/ SPR_TRI_L_out_old[0].tri6_nn(_GYMA_SPRITE3_GETn_old, sprite_store.ZURO_STORE3_L0n.qp_old());
    /* p30.YWAV*/ SPR_TRI_L_out_old[1].tri6_nn(_GYMA_SPRITE3_GETn_old, sprite_store.ZYLU_STORE3_L1n.qp_old());
    /* p30.YJEM*/ SPR_TRI_L_out_old[2].tri6_nn(_GYMA_SPRITE3_GETn_old, sprite_store.ZENE_STORE3_L2n.qp_old());
    /* p30.ZYPO*/ SPR_TRI_L_out_old[3].tri6_nn(_GYMA_SPRITE3_GETn_old, sprite_store.ZURY_STORE3_L3n.qp_old());

    /* p30.WUXU*/ SPR_TRI_I_out_old[0].tri6_nn(_GOWO_SPRITE4_GETn_old, sprite_store.XAVE_STORE4_I0n.qp_old());
    /* p30.WEPY*/ SPR_TRI_I_out_old[1].tri6_nn(_GOWO_SPRITE4_GETn_old, sprite_store.XEFE_STORE4_I1n.qp_old());
    /* p30.WERU*/ SPR_TRI_I_out_old[2].tri6_nn(_GOWO_SPRITE4_GETn_old, sprite_store.WANU_STORE4_I2n.qp_old());
    /* p30.XYRE*/ SPR_TRI_I_out_old[3].tri6_nn(_GOWO_SPRITE4_GETn_old, sprite_store.XABO_STORE4_I3n.qp_old());
    /* p30.WOXY*/ SPR_TRI_I_out_old[4].tri6_nn(_GOWO_SPRITE4_GETn_old, sprite_store.XEGE_STORE4_I4n.qp_old());
    /* p30.WAJA*/ SPR_TRI_I_out_old[5].tri6_nn(_GOWO_SPRITE4_GETn_old, sprite_store.XYNU_STORE4_I5n.qp_old());
    /* p30.BUCE*/ SPR_TRI_L_out_old[0].tri6_nn(_GOWO_SPRITE4_GETn_old, sprite_store.CAPO_STORE4_L0n.qp_old());
    /* p30.BEVY*/ SPR_TRI_L_out_old[1].tri6_nn(_GOWO_SPRITE4_GETn_old, sprite_store.CAJU_STORE4_L1n.qp_old());
    /* p30.BOVE*/ SPR_TRI_L_out_old[2].tri6_nn(_GOWO_SPRITE4_GETn_old, sprite_store.CONO_STORE4_L2n.qp_old());
    /* p30.BYDO*/ SPR_TRI_L_out_old[3].tri6_nn(_GOWO_SPRITE4_GETn_old, sprite_store.CUMU_STORE4_L3n.qp_old());

    /* p30.DOBO*/ SPR_TRI_I_out_old[0].tri6_nn(_GYGY_SPRITE5_GETn_old, sprite_store.EKOP_STORE5_I0n.qp_old());
    /* p30.DYNY*/ SPR_TRI_I_out_old[1].tri6_nn(_GYGY_SPRITE5_GETn_old, sprite_store.ETYM_STORE5_I1n.qp_old());
    /* p30.WAGA*/ SPR_TRI_I_out_old[2].tri6_nn(_GYGY_SPRITE5_GETn_old, sprite_store.GORU_STORE5_I2n.qp_old());
    /* p30.DUZA*/ SPR_TRI_I_out_old[3].tri6_nn(_GYGY_SPRITE5_GETn_old, sprite_store.EBEX_STORE5_I3n.qp_old());
    /* p30.DALY*/ SPR_TRI_I_out_old[4].tri6_nn(_GYGY_SPRITE5_GETn_old, sprite_store.ETAV_STORE5_I4n.qp_old());
    /* p30.DALO*/ SPR_TRI_I_out_old[5].tri6_nn(_GYGY_SPRITE5_GETn_old, sprite_store.EKAP_STORE5_I5n.qp_old());
    /* p30.BACE*/ SPR_TRI_L_out_old[0].tri6_nn(_GYGY_SPRITE5_GETn_old, sprite_store.ACEP_STORE5_L0n.qp_old());
    /* p30.BUJA*/ SPR_TRI_L_out_old[1].tri6_nn(_GYGY_SPRITE5_GETn_old, sprite_store.ABEG_STORE5_L1n.qp_old());
    /* p30.BODU*/ SPR_TRI_L_out_old[2].tri6_nn(_GYGY_SPRITE5_GETn_old, sprite_store.ABUX_STORE5_L2n.qp_old());
    /* p30.AWAT*/ SPR_TRI_L_out_old[3].tri6_nn(_GYGY_SPRITE5_GETn_old, sprite_store.ANED_STORE5_L3n.qp_old());

    /* p30.WATO*/ SPR_TRI_I_out_old[0].tri6_nn(_XYME_SPRITE6_GETn_old, sprite_store.GABO_STORE6_I0n.qp_old());
    /* p30.WYWY*/ SPR_TRI_I_out_old[1].tri6_nn(_XYME_SPRITE6_GETn_old, sprite_store.GACY_STORE6_I1n.qp_old());
    /* p30.EZOC*/ SPR_TRI_I_out_old[2].tri6_nn(_XYME_SPRITE6_GETn_old, sprite_store.FOGO_STORE6_I2n.qp_old());
    /* p30.WABO*/ SPR_TRI_I_out_old[3].tri6_nn(_XYME_SPRITE6_GETn_old, sprite_store.GOHU_STORE6_I3n.qp_old());
    /* p30.ELYC*/ SPR_TRI_I_out_old[4].tri6_nn(_XYME_SPRITE6_GETn_old, sprite_store.FOXY_STORE6_I4n.qp_old());
    /* p30.WOCY*/ SPR_TRI_I_out_old[5].tri6_nn(_XYME_SPRITE6_GETn_old, sprite_store.GECU_STORE6_I5n.qp_old());
    /* p30.YBUK*/ SPR_TRI_L_out_old[0].tri6_nn(_XYME_SPRITE6_GETn_old, sprite_store.ZUMY_STORE6_L0n.qp_old());
    /* p30.YKOZ*/ SPR_TRI_L_out_old[1].tri6_nn(_XYME_SPRITE6_GETn_old, sprite_store.ZAFU_STORE6_L1n.qp_old());
    /* p30.ZYTO*/ SPR_TRI_L_out_old[2].tri6_nn(_XYME_SPRITE6_GETn_old, sprite_store.ZEXO_STORE6_L2n.qp_old());
    /* p30.ZUDO*/ SPR_TRI_L_out_old[3].tri6_nn(_XYME_SPRITE6_GETn_old, sprite_store.ZUBE_STORE6_L3n.qp_old());

    /* p30.WAKO*/ SPR_TRI_I_out_old[0].tri6_nn(_GUGY_SPRITE7_GETn_old, sprite_store.GULE_STORE7_I0n.qp_old());
    /* p30.WYGO*/ SPR_TRI_I_out_old[1].tri6_nn(_GUGY_SPRITE7_GETn_old, sprite_store.GYNO_STORE7_I1n.qp_old());
    /* p30.ELEP*/ SPR_TRI_I_out_old[2].tri6_nn(_GUGY_SPRITE7_GETn_old, sprite_store.FEFA_STORE7_I2n.qp_old());
    /* p30.ETAD*/ SPR_TRI_I_out_old[3].tri6_nn(_GUGY_SPRITE7_GETn_old, sprite_store.FYSU_STORE7_I3n.qp_old());
    /* p30.WABA*/ SPR_TRI_I_out_old[4].tri6_nn(_GUGY_SPRITE7_GETn_old, sprite_store.GESY_STORE7_I4n.qp_old());
    /* p30.EVYT*/ SPR_TRI_I_out_old[5].tri6_nn(_GUGY_SPRITE7_GETn_old, sprite_store.FUZO_STORE7_I5n.qp_old());
    /* p30.WAXE*/ SPR_TRI_L_out_old[0].tri6_nn(_GUGY_SPRITE7_GETn_old, sprite_store.XYNA_STORE7_L0n.qp_old());
    /* p30.YPOZ*/ SPR_TRI_L_out_old[1].tri6_nn(_GUGY_SPRITE7_GETn_old, sprite_store.YGUM_STORE7_L1n.qp_old());
    /* p30.WABU*/ SPR_TRI_L_out_old[2].tri6_nn(_GUGY_SPRITE7_GETn_old, sprite_store.XAKU_STORE7_L2n.qp_old());
    /* p30.WANA*/ SPR_TRI_L_out_old[3].tri6_nn(_GUGY_SPRITE7_GETn_old, sprite_store.XYGO_STORE7_L3n.qp_old());

    /* p30.APOC*/ SPR_TRI_I_out_old[0].tri6_nn(_DENY_SPRITE8_GETn_old, sprite_store.AXUV_STORE8_I0n.qp_old());
    /* p30.AKYH*/ SPR_TRI_I_out_old[1].tri6_nn(_DENY_SPRITE8_GETn_old, sprite_store.BADA_STORE8_I1n.qp_old());
    /* p30.AFEN*/ SPR_TRI_I_out_old[2].tri6_nn(_DENY_SPRITE8_GETn_old, sprite_store.APEV_STORE8_I2n.qp_old());
    /* p30.APYV*/ SPR_TRI_I_out_old[3].tri6_nn(_DENY_SPRITE8_GETn_old, sprite_store.BADO_STORE8_I3n.qp_old());
    /* p30.APOB*/ SPR_TRI_I_out_old[4].tri6_nn(_DENY_SPRITE8_GETn_old, sprite_store.BEXY_STORE8_I4n.qp_old());
    /* p30.ADYB*/ SPR_TRI_I_out_old[5].tri6_nn(_DENY_SPRITE8_GETn_old, sprite_store.BYHE_STORE8_I5n.qp_old());
    /* p30.BOSO*/ SPR_TRI_L_out_old[0].tri6_nn(_DENY_SPRITE8_GETn_old, sprite_store.AZAP_STORE8_L0n.qp_old());
    /* p30.BAZU*/ SPR_TRI_L_out_old[1].tri6_nn(_DENY_SPRITE8_GETn_old, sprite_store.AFYX_STORE8_L1n.qp_old());
    /* p30.AHAC*/ SPR_TRI_L_out_old[2].tri6_nn(_DENY_SPRITE8_GETn_old, sprite_store.AFUT_STORE8_L2n.qp_old());
    /* p30.BUJY*/ SPR_TRI_L_out_old[3].tri6_nn(_DENY_SPRITE8_GETn_old, sprite_store.AFYM_STORE8_L3n.qp_old());

    /* p30.ZARO*/ SPR_TRI_I_out_old[0].tri6_nn(_FADO_SPRITE9_GETn_old, sprite_store.YBER_STORE9_I0n.qp_old());
    /* p30.ZOJY*/ SPR_TRI_I_out_old[1].tri6_nn(_FADO_SPRITE9_GETn_old, sprite_store.YZOR_STORE9_I1n.qp_old());
    /* p30.YNEV*/ SPR_TRI_I_out_old[2].tri6_nn(_FADO_SPRITE9_GETn_old, sprite_store.XYFE_STORE9_I2n.qp_old());
    /* p30.XYRA*/ SPR_TRI_I_out_old[3].tri6_nn(_FADO_SPRITE9_GETn_old, sprite_store.XOTU_STORE9_I3n.qp_old());
    /* p30.YRAD*/ SPR_TRI_I_out_old[4].tri6_nn(_FADO_SPRITE9_GETn_old, sprite_store.XUTE_STORE9_I4n.qp_old());
    /* p30.YHAL*/ SPR_TRI_I_out_old[5].tri6_nn(_FADO_SPRITE9_GETn_old, sprite_store.XUFO_STORE9_I5n.qp_old());
    /* p30.BYME*/ SPR_TRI_L_out_old[0].tri6_nn(_FADO_SPRITE9_GETn_old, sprite_store.CANA_STORE9_L0n.qp_old());
    /* p30.GATE*/ SPR_TRI_L_out_old[1].tri6_nn(_FADO_SPRITE9_GETn_old, sprite_store.FOFO_STORE9_L1n.qp_old());
    /* p30.COHO*/ SPR_TRI_L_out_old[2].tri6_nn(_FADO_SPRITE9_GETn_old, sprite_store.DYSY_STORE9_L2n.qp_old());
    /* p30.CAWO*/ SPR_TRI_L_out_old[3].tri6_nn(_FADO_SPRITE9_GETn_old, sprite_store.DEWU_STORE9_L3n.qp_old());

    /* SCAN  -> OBA */
    // FIXME old/new
    /* p28.APAR*/ wire _APAR_SCANNINGn = not1(_ACYL_SCANNINGp_old);
    /* p28.GEFY*/ BUS_OAM_An_old[0].tri6_nn(_APAR_SCANNINGn, GND);
    /* p28.WUWE*/ BUS_OAM_An_old[1].tri6_nn(_APAR_SCANNINGn, GND);
    /* p28.GUSE*/ BUS_OAM_An_old[2].tri6_nn(_APAR_SCANNINGn, _YFEL_SCAN0_old); // _MUST_ be qp17_old, but WHYYYY. probably related to oam clock or something.
    /* p28.GEMA*/ BUS_OAM_An_old[3].tri6_nn(_APAR_SCANNINGn, _WEWY_SCAN1_old);
    /* p28.FUTO*/ BUS_OAM_An_old[4].tri6_nn(_APAR_SCANNINGn, _GOSO_SCAN2_old);
    /* p28.FAKU*/ BUS_OAM_An_old[5].tri6_nn(_APAR_SCANNINGn, _ELYN_SCAN3_old);
    /* p28.GAMA*/ BUS_OAM_An_old[6].tri6_nn(_APAR_SCANNINGn, _FAHA_SCAN4_old);
    /* p28.GOBY*/ BUS_OAM_An_old[7].tri6_nn(_APAR_SCANNINGn, _FONY_SCAN5_old);

    /* DBA   -> OBA */
    /* p28.FODO*/ BUS_OAM_An_old[0].tri6_nn(_DUGA_DMA_OAM_RDn_new, _NAKY_DMA_A00p_old);
    /* p28.FESA*/ BUS_OAM_An_old[1].tri6_nn(_DUGA_DMA_OAM_RDn_new, _PYRO_DMA_A01p_old);
    /* p28.FAGO*/ BUS_OAM_An_old[2].tri6_nn(_DUGA_DMA_OAM_RDn_new, _NEFY_DMA_A02p_old);
    /* p28.FYKY*/ BUS_OAM_An_old[3].tri6_nn(_DUGA_DMA_OAM_RDn_new, _MUTY_DMA_A03p_old);
    /* p28.ELUG*/ BUS_OAM_An_old[4].tri6_nn(_DUGA_DMA_OAM_RDn_new, _NYKO_DMA_A04p_old);
    /* p28.EDOL*/ BUS_OAM_An_old[5].tri6_nn(_DUGA_DMA_OAM_RDn_new, _PYLO_DMA_A05p_old);
    /* p28.FYDU*/ BUS_OAM_An_old[6].tri6_nn(_DUGA_DMA_OAM_RDn_new, _NUTO_DMA_A06p_old);
    /* p28.FETU*/ BUS_OAM_An_old[7].tri6_nn(_DUGA_DMA_OAM_RDn_new, _MUGU_DMA_A07p_old);

    /* CBA   -> OBA */
    /* p28.GARO*/ BUS_OAM_An_old[0].tri6_nn(_ASAM_CPU_OAM_RDn_new, BUS_CPU_A[ 0]);
    /* p28.WACU*/ BUS_OAM_An_old[1].tri6_nn(_ASAM_CPU_OAM_RDn_new, BUS_CPU_A[ 1]);
    /* p28.GOSE*/ BUS_OAM_An_old[2].tri6_nn(_ASAM_CPU_OAM_RDn_new, BUS_CPU_A[ 2]);
    /* p28.WAPE*/ BUS_OAM_An_old[3].tri6_nn(_ASAM_CPU_OAM_RDn_new, BUS_CPU_A[ 3]);
    /* p28.FEVU*/ BUS_OAM_An_old[4].tri6_nn(_ASAM_CPU_OAM_RDn_new, BUS_CPU_A[ 4]);
    /* p28.GERA*/ BUS_OAM_An_old[5].tri6_nn(_ASAM_CPU_OAM_RDn_new, BUS_CPU_A[ 5]);
    /* p28.WAXA*/ BUS_OAM_An_old[6].tri6_nn(_ASAM_CPU_OAM_RDn_new, BUS_CPU_A[ 6]);
    /* p28.FOBY*/ BUS_OAM_An_old[7].tri6_nn(_ASAM_CPU_OAM_RDn_new, BUS_CPU_A[ 7]);

    /* SPR_I -> OBA */
    /* p28.GECA*/ BUS_OAM_An_old[0].tri6_nn(_BETE_PPU_OAM_RDn_new, _WEFE_VCC);
    /* p28.WYDU*/ BUS_OAM_An_old[1].tri6_nn(_BETE_PPU_OAM_RDn_new, _WEFE_VCC);
    /* p28.GYBU*/ BUS_OAM_An_old[2].tri6_nn(_BETE_PPU_OAM_RDn_new, SPR_TRI_I_out_old[0].qp_new());
    /* p28.GYKA*/ BUS_OAM_An_old[3].tri6_nn(_BETE_PPU_OAM_RDn_new, SPR_TRI_I_out_old[1].qp_new());
    /* p28.FABY*/ BUS_OAM_An_old[4].tri6_nn(_BETE_PPU_OAM_RDn_new, SPR_TRI_I_out_old[2].qp_new());
    /* p28.FACO*/ BUS_OAM_An_old[5].tri6_nn(_BETE_PPU_OAM_RDn_new, SPR_TRI_I_out_old[3].qp_new());
    /* p28.FUGU*/ BUS_OAM_An_old[6].tri6_nn(_BETE_PPU_OAM_RDn_new, SPR_TRI_I_out_old[4].qp_new());
    /* p28.FYKE*/ BUS_OAM_An_old[7].tri6_nn(_BETE_PPU_OAM_RDn_new, SPR_TRI_I_out_old[5].qp_new());

    /* p28.YFOT*/ wire _YFOT_OAM_A2p_old = not1(BUS_OAM_An_old[2].qp_new());
    /* p28.YFOC*/ wire _YFOC_OAM_A3p_old = not1(BUS_OAM_An_old[3].qp_new());
    /* p28.YVOM*/ wire _YVOM_OAM_A4p_old = not1(BUS_OAM_An_old[4].qp_new());
    /* p28.YMEV*/ wire _YMEV_OAM_A5p_old = not1(BUS_OAM_An_old[5].qp_new());
    /* p28.XEMU*/ wire _XEMU_OAM_A6p_old = not1(BUS_OAM_An_old[6].qp_new());
    /* p28.YZET*/ wire _YZET_OAM_A7p_old = not1(BUS_OAM_An_old[7].qp_new());
    ...
    if (DELTA_AB || DELTA_CD || DELTA_EF || DELTA_GH) {
      oam_addr_latch = pack_u8n_new(7, &BUS_OAM_An_old[1]);
    }
  }
...
#if 0
    /*#p27.NAZE*/ wire _NAZE_WY_MATCH0p_new = xnor2(pix_pipe.NESO_WY0n.qn_new(), lcd_reg.MUWY_LY0p.qp_new());
    /* p27.PEBO*/ wire _PEBO_WY_MATCH1p_new = xnor2(pix_pipe.NYRO_WY1n.qn_new(), lcd_reg.MYRO_LY1p.qp_new());
    /* p27.POMO*/ wire _POMO_WY_MATCH2p_new = xnor2(pix_pipe.NAGA_WY2n.qn_new(), lcd_reg.LEXA_LY2p.qp_new());
    /* p27.NEVU*/ wire _NEVU_WY_MATCH3p_new = xnor2(pix_pipe.MELA_WY3n.qn_new(), lcd_reg.LYDO_LY3p.qp_new());
    /* p27.NOJO*/ wire _NOJO_WY_MATCH4p_new = xnor2(pix_pipe.NULO_WY4n.qn_new(), lcd_reg.LOVU_LY4p.qp_new());
    /* p27.PAGA*/ wire _PAGA_WY_MATCH5p_new = xnor2(pix_pipe.NENE_WY5n.qn_new(), lcd_reg.LEMA_LY5p.qp_new());
    /* p27.PEZO*/ wire _PEZO_WY_MATCH6p_new = xnor2(pix_pipe.NUKA_WY6n.qn_new(), lcd_reg.MATO_LY6p.qp_new());
    /* p27.NUPA*/ wire _NUPA_WY_MATCH7p_new = xnor2(pix_pipe.NAFU_WY7n.qn_new(), lcd_reg.LAFO_LY7p.qp_new());

    /*#p27.PALO*/ wire _PALO_WY_MATCH_HIn_new  = nand5(pix_pipe.WYMO_LCDC_WINENn.qn_new(), _NOJO_WY_MATCH4p_new, _PAGA_WY_MATCH5p_new, _PEZO_WY_MATCH6p_new, _NUPA_WY_MATCH7p_new);
    /* p27.NELE*/ wire _NELE_WY_MATCH_HIp_new  = not1(_PALO_WY_MATCH_HIn_new);
    /* p27.PAFU*/ wire _PAFU_WY_MATCHn_new     = nand5(_NELE_WY_MATCH_HIp_new, _NAZE_WY_MATCH0p_new, _PEBO_WY_MATCH1p_new, _POMO_WY_MATCH2p_new, _NEVU_WY_MATCH3p_new);
    /* p27.ROGE*/ wire _ROGE_WY_MATCHp_new     = not1(_PAFU_WY_MATCHn_new);
#endif
...

  {
    ...
    PIN_OAM_CLK.pin_in(1, _COTA_AxxxxExxx_clknew);
  ...
  Bus2 SPR_TRI_I_in_new[6]; // to sprite store
  Bus2 SPR_TRI_L_in_new[4]; // to sprite store

  bool _GESE_SCAN_MATCH_Yp_new;
  {
    // this is using an adder as a subtracter by inverting the first input.
    ...
    // FIXME old/new
    /*#p30.CUCU*/ SPR_TRI_L_in_new[0].tri6_nn(_FEPO_STORE_MATCHp_old, _DEGE_SPRITE_DELTA0_new);
    /*#p30.CUCA*/ SPR_TRI_L_in_new[1].tri6_nn(_FEPO_STORE_MATCHp_old, _DABY_SPRITE_DELTA1_new);
    /*#p30.CEGA*/ SPR_TRI_L_in_new[2].tri6_nn(_FEPO_STORE_MATCHp_old, _DABU_SPRITE_DELTA2_new);
    /*#p30.WENU*/ SPR_TRI_L_in_new[3].tri6_nn(_FEPO_STORE_MATCHp_old, _GYSA_SPRITE_DELTA3_new);

    /* p29.GESE*/ _GESE_SCAN_MATCH_Yp_new = not1(_WOTA_SCAN_MATCH_Yn_new);
  }
...

  {
    ...
    BUS_OAM_DAn_new[0].tri6_nn(PIN_OAM_OEn.qp_new(), (oam_data_a & 0x01));
    BUS_OAM_DAn_new[1].tri6_nn(PIN_OAM_OEn.qp_new(), (oam_data_a & 0x02));
    BUS_OAM_DAn_new[2].tri6_nn(PIN_OAM_OEn.qp_new(), (oam_data_a & 0x04));
    BUS_OAM_DAn_new[3].tri6_nn(PIN_OAM_OEn.qp_new(), (oam_data_a & 0x08));
    BUS_OAM_DAn_new[4].tri6_nn(PIN_OAM_OEn.qp_new(), (oam_data_a & 0x10));
    BUS_OAM_DAn_new[5].tri6_nn(PIN_OAM_OEn.qp_new(), (oam_data_a & 0x20));
    BUS_OAM_DAn_new[6].tri6_nn(PIN_OAM_OEn.qp_new(), (oam_data_a & 0x40));
    BUS_OAM_DAn_new[7].tri6_nn(PIN_OAM_OEn.qp_new(), (oam_data_a & 0x80));

    BUS_OAM_DBn_new[0].tri6_nn(PIN_OAM_OEn.qp_new(), (oam_data_b & 0x01));
    BUS_OAM_DBn_new[1].tri6_nn(PIN_OAM_OEn.qp_new(), (oam_data_b & 0x02));
    BUS_OAM_DBn_new[2].tri6_nn(PIN_OAM_OEn.qp_new(), (oam_data_b & 0x04));
    BUS_OAM_DBn_new[3].tri6_nn(PIN_OAM_OEn.qp_new(), (oam_data_b & 0x08));
    BUS_OAM_DBn_new[4].tri6_nn(PIN_OAM_OEn.qp_new(), (oam_data_b & 0x10));
    BUS_OAM_DBn_new[5].tri6_nn(PIN_OAM_OEn.qp_new(), (oam_data_b & 0x20));
    BUS_OAM_DBn_new[6].tri6_nn(PIN_OAM_OEn.qp_new(), (oam_data_b & 0x40));
    BUS_OAM_DBn_new[7].tri6_nn(PIN_OAM_OEn.qp_new(), (oam_data_b & 0x80));

    // OPD -> OBL
    /* p29.YDYV*/ oam_bus.YDYV_OAM_LATCH_DA0n.tp_latch(_BODE_OAM_OEp_new, BUS_OAM_DAn_new[0].qp_new());
    /* p29.YCEB*/ oam_bus.YCEB_OAM_LATCH_DA1n.tp_latch(_BODE_OAM_OEp_new, BUS_OAM_DAn_new[1].qp_new());
    /* p29.ZUCA*/ oam_bus.ZUCA_OAM_LATCH_DA2n.tp_latch(_BODE_OAM_OEp_new, BUS_OAM_DAn_new[2].qp_new());
    /* p29.WONE*/ oam_bus.WONE_OAM_LATCH_DA3n.tp_latch(_BODE_OAM_OEp_new, BUS_OAM_DAn_new[3].qp_new());
    /* p29.ZAXE*/ oam_bus.ZAXE_OAM_LATCH_DA4n.tp_latch(_BODE_OAM_OEp_new, BUS_OAM_DAn_new[4].qp_new());
    /* p29.XAFU*/ oam_bus.XAFU_OAM_LATCH_DA5n.tp_latch(_BODE_OAM_OEp_new, BUS_OAM_DAn_new[5].qp_new());
    /* p29.YSES*/ oam_bus.YSES_OAM_LATCH_DA6n.tp_latch(_BODE_OAM_OEp_new, BUS_OAM_DAn_new[6].qp_new());
    /* p29.ZECA*/ oam_bus.ZECA_OAM_LATCH_DA7n.tp_latch(_BODE_OAM_OEp_new, BUS_OAM_DAn_new[7].qp_new());

    /*#p31.XYKY*/ oam_bus.XYKY_OAM_LATCH_DB0n.tp_latch(_BODE_OAM_OEp_new, BUS_OAM_DBn_new[0].qp_new());
    /* p31.YRUM*/ oam_bus.YRUM_OAM_LATCH_DB1n.tp_latch(_BODE_OAM_OEp_new, BUS_OAM_DBn_new[1].qp_new());
    /* p31.YSEX*/ oam_bus.YSEX_OAM_LATCH_DB2n.tp_latch(_BODE_OAM_OEp_new, BUS_OAM_DBn_new[2].qp_new());
    /* p31.YVEL*/ oam_bus.YVEL_OAM_LATCH_DB3n.tp_latch(_BODE_OAM_OEp_new, BUS_OAM_DBn_new[3].qp_new());
    /* p31.WYNO*/ oam_bus.WYNO_OAM_LATCH_DB4n.tp_latch(_BODE_OAM_OEp_new, BUS_OAM_DBn_new[4].qp_new());
    /* p31.CYRA*/ oam_bus.CYRA_OAM_LATCH_DB5n.tp_latch(_BODE_OAM_OEp_new, BUS_OAM_DBn_new[5].qp_new());
    /* p31.ZUVE*/ oam_bus.ZUVE_OAM_LATCH_DB6n.tp_latch(_BODE_OAM_OEp_new, BUS_OAM_DBn_new[6].qp_new());
    /* p31.ECED*/ oam_bus.ECED_OAM_LATCH_DB7n.tp_latch(_BODE_OAM_OEp_new, BUS_OAM_DBn_new[7].qp_new());
  }

  //----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

  /* p27.LOVY*/ tile_fetcher.LOVY_FETCH_DONEp.dff17(_MYVO_AxCxExGx_clk, _NYXU_FETCH_TRIGn_new, _LYRY_BFETCH_DONEp_old);
...
#pragma endregion
...

  {
    ...
    /* Sprite fetcher read */
    {
      ...
      /*#p29.CYVU*/ wire _CYVU_L0_new = xor2(_WUKY_FLIP_Yp_new, SPR_TRI_L_out_old[0].qp_new());
      /*#p29.BORE*/ wire _BORE_L1_new = xor2(_WUKY_FLIP_Yp_new, SPR_TRI_L_out_old[1].qp_new());
      /*#p29.BUVY*/ wire _BUVY_L2_new = xor2(_WUKY_FLIP_Yp_new, SPR_TRI_L_out_old[2].qp_new());
      /*#p29.WAGO*/ wire _WAGO_L3_new = xor2(_WUKY_FLIP_Yp_new, SPR_TRI_L_out_old[3].qp_new());
...
//    /* p26.ACUL*/ wire _ACUL_MAP_X4C_new  = add_c(pix_pipe.SYBE_PX7p.qp_new(), pix_pipe.BAKE_SCX7n.qn_new(), _BYCA_MAP_X3C_new);
  ...
  {
    ///* p29.EDEN*/ wire _EDEN_SPRITE_COUNT0n_old = not1(sprite_store.BESE_SPRITE_COUNT0.qp_old());
    ///* p29.CYPY*/ wire _CYPY_SPRITE_COUNT1n_old = not1(sprite_store.CUXY_SPRITE_COUNT1.qp_old());
    ///* p29.CAPE*/ wire _CAPE_SPRITE_COUNT2n_old = not1(sprite_store.BEGO_SPRITE_COUNT2.qp_old());
    ...
    /* p29.CARE*/ wire _CARE_STORE_ENp_ABxxEFxx_old = and3(_XOCE_xBCxxFGx_clkold, _CEHA_SCANNINGp_old, _GESE_SCAN_MATCH_Yp_old); // Dots on VCC, this is AND. Die shot and schematic wrong.
    /* p29.DYTY*/ wire _DYTY_STORE_ENn_xxCDxxGH_old = not1(_CARE_STORE_ENp_ABxxEFxx_old);
    /* p29.DEZY*/ sprite_store.DEZY_STORE_ENn.dff17(_ZEME_AxCxExGx_clk, _XAPO_VID_RSTn_new, _DYTY_STORE_ENn_xxCDxxGH_old);
    ...
    {
      // FIXME this clock is super weird

      ///* p29.DEZO*/ wire _DEZO_STORE0_SELn_old = nand4(_EDEN_SPRITE_COUNT0n_old, _CYPY_SPRITE_COUNT1n_old, _CAPE_SPRITE_COUNT2n_old, _CAXU_SPRITE_COUNT3n_old);
      ///* p29.CEMY*/ wire _CEMY_STORE0_CLKp_old = or2(_DYTY_STORE_ENn_xxCDxxGH_old, _DEZO_STORE0_SELn_old);
      ///* p29.DYHU*/ wire _DYHU_STORE0_CLKn_old = not1(_CEMY_STORE0_CLKp_old);
      ///* p29.GENY*/ wire _GENY_STORE0_CLKp_old = not1(_DYHU_STORE0_CLKn_old);
      ///* p29.ENOB*/ wire _ENOB_STORE0_CLKp_old = not1(_DYHU_STORE0_CLKn_old);
      ///* p29.FUXU*/ wire _FUXU_STORE0_CLKp_old = not1(_DYHU_STORE0_CLKn_old);
      ...
      /* p29.CEMY*/ wire _CEMY_STORE0_CLKp_new = or2(_DYTY_STORE_ENn_xxCDxxGH_new, _DEZO_STORE0_SELn_new);
      ...
      /* p30.YGUS*/ sprite_store.YGUS_STORE0_I0n.dff8n(_GENY_STORE0_CLKp_new, SPR_TRI_I_in_old[0].qp_new());
      /* p30.YSOK*/ sprite_store.YSOK_STORE0_I1n.dff8n(_GENY_STORE0_CLKp_new, SPR_TRI_I_in_old[1].qp_new());
      /* p30.YZEP*/ sprite_store.YZEP_STORE0_I2n.dff8n(_GENY_STORE0_CLKp_new, SPR_TRI_I_in_old[2].qp_new());
      /* p30.WYTE*/ sprite_store.WYTE_STORE0_I3n.dff8n(_GENY_STORE0_CLKp_new, SPR_TRI_I_in_old[3].qp_new());
      /* p30.ZONY*/ sprite_store.ZONY_STORE0_I4n.dff8n(_GENY_STORE0_CLKp_new, SPR_TRI_I_in_old[4].qp_new());
      /* p30.YWAK*/ sprite_store.YWAK_STORE0_I5n.dff8n(_GENY_STORE0_CLKp_new, SPR_TRI_I_in_old[5].qp_new());
      /* p30.GYHO*/ sprite_store.GYHO_STORE0_L0n.dff8n(_ENOB_STORE0_CLKp_new, SPR_TRI_L_in_old[0].qp_new());
      /* p30.CUFO*/ sprite_store.CUFO_STORE0_L1n.dff8n(_ENOB_STORE0_CLKp_new, SPR_TRI_L_in_old[1].qp_new());
      /* p30.BOZU*/ sprite_store.BOZU_STORE0_L2n.dff8n(_ENOB_STORE0_CLKp_new, SPR_TRI_L_in_old[2].qp_new());
      /* p30.FYHY*/ sprite_store.FYHY_STORE0_L3n.dff8n(_ENOB_STORE0_CLKp_new, SPR_TRI_L_in_old[3].qp_new());

      /* p29.EBOJ*/ sprite_store.EBOJ_STORE0_RSTp.dff17(_WUTY_SPRITE_DONEp_new, _BYVA_LINE_RSTn_new, _GUVA_SPRITE0_GETp_old);
      ...
      /*#p31.XEPE*/ sprite_store.XEPE_STORE0_X0p.dff9(_FUXU_STORE0_CLKp_new, _DYNA_STORE0_RSTn_new, _ZAGO_SPX0n_old); // FIXME data should be old
...

    {
      ...
      /* p29.BYBY*/ wire _BYBY_STORE1_CLKp_new = or2(_DYTY_STORE_ENn_xxCDxxGH_new, _CUVA_STORE1_SELn_new);
      ...
      /* p30.CADU*/ sprite_store.CADU_STORE1_I0n.dff8n(_BYVY_STORE1_CLKp_new, SPR_TRI_I_in_old[0].qp_new());
      /* p30.CEBO*/ sprite_store.CEBO_STORE1_I1n.dff8n(_BYVY_STORE1_CLKp_new, SPR_TRI_I_in_old[1].qp_new());
      /* p30.CUFA*/ sprite_store.CUFA_STORE1_I2n.dff8n(_BYVY_STORE1_CLKp_new, SPR_TRI_I_in_old[2].qp_new());
      /* p30.COMA*/ sprite_store.COMA_STORE1_I3n.dff8n(_BYVY_STORE1_CLKp_new, SPR_TRI_I_in_old[3].qp_new());
      /* p30.CUZA*/ sprite_store.CUZA_STORE1_I4n.dff8n(_BYVY_STORE1_CLKp_new, SPR_TRI_I_in_old[4].qp_new());
      /* p30.CAJY*/ sprite_store.CAJY_STORE1_I5n.dff8n(_BYVY_STORE1_CLKp_new, SPR_TRI_I_in_old[5].qp_new());
      /* p30.AMES*/ sprite_store.AMES_STORE1_L0n.dff8n(_AHOF_STORE1_CLKp_new, SPR_TRI_L_in_old[0].qp_new());
      /* p30.AROF*/ sprite_store.AROF_STORE1_L1n.dff8n(_AHOF_STORE1_CLKp_new, SPR_TRI_L_in_old[1].qp_new());
      /* p30.ABOP*/ sprite_store.ABOP_STORE1_L2n.dff8n(_AHOF_STORE1_CLKp_new, SPR_TRI_L_in_old[2].qp_new());
      /* p30.ABUG*/ sprite_store.ABUG_STORE1_L3n.dff8n(_AHOF_STORE1_CLKp_new, SPR_TRI_L_in_old[3].qp_new());

      /* p29.CEDY*/ sprite_store.CEDY_STORE1_RSTp.dff17(_WUTY_SPRITE_DONEp_new, _BYVA_LINE_RSTn_new, _ENUT_SPRITE1_GETp_old);
...

    {
      ...
      /* p29.WYXO*/ wire _WYXO_STORE2_CLKp_new = or2(_DYTY_STORE_ENn_xxCDxxGH_new, _GEBU_STORE2_SELn_new);
      ...
      /* p30.BUHE*/ sprite_store.BUHE_STORE2_I0n.dff8n(_BUZY_STORE2_CLKp_new, SPR_TRI_I_in_old[0].qp_new());
      /* p30.BYHU*/ sprite_store.BYHU_STORE2_I1n.dff8n(_BUZY_STORE2_CLKp_new, SPR_TRI_I_in_old[1].qp_new());
      /* p30.BECA*/ sprite_store.BECA_STORE2_I2n.dff8n(_BUZY_STORE2_CLKp_new, SPR_TRI_I_in_old[2].qp_new());
      /* p30.BULU*/ sprite_store.BULU_STORE2_I3n.dff8n(_BUZY_STORE2_CLKp_new, SPR_TRI_I_in_old[3].qp_new());
      /* p30.BUNA*/ sprite_store.BUNA_STORE2_I4n.dff8n(_BUZY_STORE2_CLKp_new, SPR_TRI_I_in_old[4].qp_new());
      /* p30.BOXA*/ sprite_store.BOXA_STORE2_I5n.dff8n(_BUZY_STORE2_CLKp_new, SPR_TRI_I_in_old[5].qp_new());
      /* p30.YLOV*/ sprite_store.YLOV_STORE2_L0n.dff8n(_FUKE_STORE2_CLKp_new, SPR_TRI_L_in_old[0].qp_new());
      /* p30.XOSY*/ sprite_store.XOSY_STORE2_L1n.dff8n(_FUKE_STORE2_CLKp_new, SPR_TRI_L_in_old[1].qp_new());
      /* p30.XAZY*/ sprite_store.XAZY_STORE2_L2n.dff8n(_FUKE_STORE2_CLKp_new, SPR_TRI_L_in_old[2].qp_new());
      /* p30.YKUK*/ sprite_store.YKUK_STORE2_L3n.dff8n(_FUKE_STORE2_CLKp_new, SPR_TRI_L_in_old[3].qp_new());

      /* p29.EGAV*/ sprite_store.EGAV_STORE2_RSTp.dff17(_WUTY_SPRITE_DONEp_new, _BYVA_LINE_RSTn_new, _EMOL_SPRITE2_GETp_old);
...

    {
      ...
      /* p29.GUVE*/ wire _GUVE_STORE3_CLKp_new = or2(_DYTY_STORE_ENn_xxCDxxGH_new, _FOCO_STORE3_SELn_new);
      ...
      /* p30.DEVY*/ sprite_store.DEVY_STORE3_I0n.dff8n(_FEKA_STORE3_CLKp_new, SPR_TRI_I_in_old[0].qp_new());
      /* p30.DESE*/ sprite_store.DESE_STORE3_I1n.dff8n(_FEKA_STORE3_CLKp_new, SPR_TRI_I_in_old[1].qp_new());
      /* p30.DUNY*/ sprite_store.DUNY_STORE3_I2n.dff8n(_FEKA_STORE3_CLKp_new, SPR_TRI_I_in_old[2].qp_new());
      /* p30.DUHA*/ sprite_store.DUHA_STORE3_I3n.dff8n(_FEKA_STORE3_CLKp_new, SPR_TRI_I_in_old[3].qp_new());
      /* p30.DEBA*/ sprite_store.DEBA_STORE3_I4n.dff8n(_FEKA_STORE3_CLKp_new, SPR_TRI_I_in_old[4].qp_new());
      /* p30.DAFU*/ sprite_store.DAFU_STORE3_I5n.dff8n(_FEKA_STORE3_CLKp_new, SPR_TRI_I_in_old[5].qp_new());
      /* p30.ZURO*/ sprite_store.ZURO_STORE3_L0n.dff8n(_XYHA_STORE3_CLKp_new, SPR_TRI_L_in_old[0].qp_new());
      /* p30.ZYLU*/ sprite_store.ZYLU_STORE3_L1n.dff8n(_XYHA_STORE3_CLKp_new, SPR_TRI_L_in_old[1].qp_new());
      /* p30.ZENE*/ sprite_store.ZENE_STORE3_L2n.dff8n(_XYHA_STORE3_CLKp_new, SPR_TRI_L_in_old[2].qp_new());
      /* p30.ZURY*/ sprite_store.ZURY_STORE3_L3n.dff8n(_XYHA_STORE3_CLKp_new, SPR_TRI_L_in_old[3].qp_new());

      /* p29.GOTA*/ sprite_store.GOTA_STORE3_RSTp.dff17(_WUTY_SPRITE_DONEp_new, _BYVA_LINE_RSTn_new, _GYFY_SPRITE3_GETp_old);
...

    {
      ...
      /* p29.CUPE*/ wire _CUPE_STORE4_SELn = nand4(_EDEN_SPRITE_COUNT0n_new, _CYPY_SPRITE_COUNT1n_new, _EKUD_SPRITE_COUNT2p_new, _CAXU_SPRITE_COUNT3n_new);
      /* p29.CECU*/ wire CECU_STORE4_CLKp = or2(_DYTY_STORE_ENn_xxCDxxGH_new, _CUPE_STORE4_SELn);
      ...
      /* p30.XAVE*/ sprite_store.XAVE_STORE4_I0n.dff8n(WYLU_STORE4_CLKp, SPR_TRI_I_in_old[0].qp_new());
      /* p30.XEFE*/ sprite_store.XEFE_STORE4_I1n.dff8n(WYLU_STORE4_CLKp, SPR_TRI_I_in_old[1].qp_new());
      /* p30.WANU*/ sprite_store.WANU_STORE4_I2n.dff8n(WYLU_STORE4_CLKp, SPR_TRI_I_in_old[2].qp_new());
      /* p30.XABO*/ sprite_store.XABO_STORE4_I3n.dff8n(WYLU_STORE4_CLKp, SPR_TRI_I_in_old[3].qp_new());
      /* p30.XEGE*/ sprite_store.XEGE_STORE4_I4n.dff8n(WYLU_STORE4_CLKp, SPR_TRI_I_in_old[4].qp_new());
      /* p30.XYNU*/ sprite_store.XYNU_STORE4_I5n.dff8n(WYLU_STORE4_CLKp, SPR_TRI_I_in_old[5].qp_new());
      /* p30.CAPO*/ sprite_store.CAPO_STORE4_L0n.dff8n(EWOT_STORE4_CLKp, SPR_TRI_L_in_old[0].qp_new());
      /* p30.CAJU*/ sprite_store.CAJU_STORE4_L1n.dff8n(EWOT_STORE4_CLKp, SPR_TRI_L_in_old[1].qp_new());
      /* p30.CONO*/ sprite_store.CONO_STORE4_L2n.dff8n(EWOT_STORE4_CLKp, SPR_TRI_L_in_old[2].qp_new());
      /* p30.CUMU*/ sprite_store.CUMU_STORE4_L3n.dff8n(EWOT_STORE4_CLKp, SPR_TRI_L_in_old[3].qp_new());

      /* p29.XUDY*/ sprite_store.XUDY_STORE4_RSTp.dff17(_WUTY_SPRITE_DONEp_new, _BYVA_LINE_RSTn_new, _GONO_SPRITE4_GETp_old);
      /* p29.WOHU*/ wire _WOHU_STORE4_RSTp = or2(_DYBA_LINE_RSTp_new, sprite_store.XUDY_STORE4_RSTp.qp_new());
      /* p29.WUNU*/ wire _WUNU_STORE4_RSTn = not1(_WOHU_STORE4_RSTp);

      /* p31.WEDU*/ sprite_store.WEDU_STORE4_X0p.dff9(WOFO_STORE4_CLKp, _WUNU_STORE4_RSTn, _ZAGO_SPX0n_old);
      /* p31.YGAJ*/ sprite_store.YGAJ_STORE4_X1p.dff9(WOFO_STORE4_CLKp, _WUNU_STORE4_RSTn, _ZOCY_SPX1n_old);
      /* p31.ZYJO*/ sprite_store.ZYJO_STORE4_X2p.dff9(WOFO_STORE4_CLKp, _WUNU_STORE4_RSTn, _YPUR_SPX2n_old);
      /* p31.XURY*/ sprite_store.XURY_STORE4_X3p.dff9(WOFO_STORE4_CLKp, _WUNU_STORE4_RSTn, _YVOK_SPX3n_old);
      /* p31.YBED*/ sprite_store.YBED_STORE4_X4p.dff9(WOFO_STORE4_CLKp, _WUNU_STORE4_RSTn, _COSE_SPX4n_old);
      /* p31.ZALA*/ sprite_store.ZALA_STORE4_X5p.dff9(WOFO_STORE4_CLKp, _WUNU_STORE4_RSTn, _AROP_SPX5n_old);
      /* p31.WYDE*/ sprite_store.WYDE_STORE4_X6p.dff9(WOFO_STORE4_CLKp, _WUNU_STORE4_RSTn, _XATU_SPX6n_old);
      /* p31.XEPA*/ sprite_store.XEPA_STORE4_X7p.dff9(WOFO_STORE4_CLKp, _WUNU_STORE4_RSTn, _BADY_SPX7n_old);
    }

    {

      /* p29.CUGU*/ wire _CUGU_STORE5_SELn = nand4(_FYCU_SPRITE_COUNT0p_new, _CYPY_SPRITE_COUNT1n_new, _EKUD_SPRITE_COUNT2p_new, _CAXU_SPRITE_COUNT3n_new);
      /* p29.CADO*/ wire CADO_STORE5_CLKp = or2(_DYTY_STORE_ENn_xxCDxxGH_new, _CUGU_STORE5_SELn);
      ...
      /* p30.EKOP*/ sprite_store.EKOP_STORE5_I0n.dff8n(DYMO_STORE5_CLKp, SPR_TRI_I_in_old[0].qp_new());
      /* p30.ETYM*/ sprite_store.ETYM_STORE5_I1n.dff8n(DYMO_STORE5_CLKp, SPR_TRI_I_in_old[1].qp_new());
      /* p30.GORU*/ sprite_store.GORU_STORE5_I2n.dff8n(DYMO_STORE5_CLKp, SPR_TRI_I_in_old[2].qp_new());
      /* p30.EBEX*/ sprite_store.EBEX_STORE5_I3n.dff8n(DYMO_STORE5_CLKp, SPR_TRI_I_in_old[3].qp_new());
      /* p30.ETAV*/ sprite_store.ETAV_STORE5_I4n.dff8n(DYMO_STORE5_CLKp, SPR_TRI_I_in_old[4].qp_new());
      /* p30.EKAP*/ sprite_store.EKAP_STORE5_I5n.dff8n(DYMO_STORE5_CLKp, SPR_TRI_I_in_old[5].qp_new());
      /* p30.ACEP*/ sprite_store.ACEP_STORE5_L0n.dff8n(BUCY_STORE5_CLKp, SPR_TRI_L_in_old[0].qp_new());
      /* p30.ABEG*/ sprite_store.ABEG_STORE5_L1n.dff8n(BUCY_STORE5_CLKp, SPR_TRI_L_in_old[1].qp_new());
      /* p30.ABUX*/ sprite_store.ABUX_STORE5_L2n.dff8n(BUCY_STORE5_CLKp, SPR_TRI_L_in_old[2].qp_new());
      /* p30.ANED*/ sprite_store.ANED_STORE5_L3n.dff8n(BUCY_STORE5_CLKp, SPR_TRI_L_in_old[3].qp_new());

      /* p29.WAFY*/ sprite_store.WAFY_STORE5_RSTp.dff17(_WUTY_SPRITE_DONEp_new, _BYVA_LINE_RSTn_new, _GEGA_SPRITE5_GETp_old);
      /* p29.FEVE*/ wire _FEVE_STORE5_RSTp = or2(_DYBA_LINE_RSTp_new, sprite_store.WAFY_STORE5_RSTp.qp_new());
      /* p29.EJAD*/ wire _EJAD_STORE5_RSTn = not1(_FEVE_STORE5_RSTp);

      /* p31.FUSA*/ sprite_store.FUSA_STORE5_X0p.dff9(CYLA_STORE5_CLKp, _EJAD_STORE5_RSTn, _ZAGO_SPX0n_old);
      /* p31.FAXA*/ sprite_store.FAXA_STORE5_X1p.dff9(CYLA_STORE5_CLKp, _EJAD_STORE5_RSTn, _ZOCY_SPX1n_old);
      /* p31.FOZY*/ sprite_store.FOZY_STORE5_X2p.dff9(CYLA_STORE5_CLKp, _EJAD_STORE5_RSTn, _YPUR_SPX2n_old);
      /* p31.FESY*/ sprite_store.FESY_STORE5_X3p.dff9(CYLA_STORE5_CLKp, _EJAD_STORE5_RSTn, _YVOK_SPX3n_old);
      /* p31.CYWE*/ sprite_store.CYWE_STORE5_X4p.dff9(CYLA_STORE5_CLKp, _EJAD_STORE5_RSTn, _COSE_SPX4n_old);
      /* p31.DYBY*/ sprite_store.DYBY_STORE5_X5p.dff9(CYLA_STORE5_CLKp, _EJAD_STORE5_RSTn, _AROP_SPX5n_old);
      /* p31.DURY*/ sprite_store.DURY_STORE5_X6p.dff9(CYLA_STORE5_CLKp, _EJAD_STORE5_RSTn, _XATU_SPX6n_old);
      /* p31.CUVY*/ sprite_store.CUVY_STORE5_X7p.dff9(CYLA_STORE5_CLKp, _EJAD_STORE5_RSTn, _BADY_SPX7n_old);
    }

    {

      /* p29.WOMU*/ wire _WOMU_STORE6_SELn = nand4(_EDEN_SPRITE_COUNT0n_new, _FONE_SPRITE_COUNT1p_new, _EKUD_SPRITE_COUNT2p_new, _CAXU_SPRITE_COUNT3n_new);
      /* p29.XUJO*/ wire XUJO_STORE6_CLKp = or2(_DYTY_STORE_ENn_xxCDxxGH_new, _WOMU_STORE6_SELn);
      ...
      /* p30.GABO*/ sprite_store.GABO_STORE6_I0n.dff8n(WUSE_STORE6_CLKp, SPR_TRI_I_in_old[0].qp_new());
      /* p30.GACY*/ sprite_store.GACY_STORE6_I1n.dff8n(WUSE_STORE6_CLKp, SPR_TRI_I_in_old[1].qp_new());
      /* p30.FOGO*/ sprite_store.FOGO_STORE6_I2n.dff8n(WUSE_STORE6_CLKp, SPR_TRI_I_in_old[2].qp_new());
      /* p30.GOHU*/ sprite_store.GOHU_STORE6_I3n.dff8n(WUSE_STORE6_CLKp, SPR_TRI_I_in_old[3].qp_new());
      /* p30.FOXY*/ sprite_store.FOXY_STORE6_I4n.dff8n(WUSE_STORE6_CLKp, SPR_TRI_I_in_old[4].qp_new());
      /* p30.GECU*/ sprite_store.GECU_STORE6_I5n.dff8n(WUSE_STORE6_CLKp, SPR_TRI_I_in_old[5].qp_new());
      /* p30.ZUMY*/ sprite_store.ZUMY_STORE6_L0n.dff8n(ZURU_STORE6_CLKp, SPR_TRI_L_in_old[0].qp_new());
      /* p30.ZAFU*/ sprite_store.ZAFU_STORE6_L1n.dff8n(ZURU_STORE6_CLKp, SPR_TRI_L_in_old[1].qp_new());
      /* p30.ZEXO*/ sprite_store.ZEXO_STORE6_L2n.dff8n(ZURU_STORE6_CLKp, SPR_TRI_L_in_old[2].qp_new());
      /* p30.ZUBE*/ sprite_store.ZUBE_STORE6_L3n.dff8n(ZURU_STORE6_CLKp, SPR_TRI_L_in_old[3].qp_new());

      /* p29.WOMY*/ sprite_store.WOMY_STORE6_RSTp.dff17(_WUTY_SPRITE_DONEp_new, _BYVA_LINE_RSTn_new, _XOJA_SPRITE6_GETp_old);
      /* p29.WACY*/ wire _WACY_STORE6_RSTp = or2(_DYBA_LINE_RSTp_new, sprite_store.WOMY_STORE6_RSTp.qp_new());
      /* p29.XAHO*/ wire _XAHO_STORE6_RSTn = not1(_WACY_STORE6_RSTp);

      /* p31.YCOL*/ sprite_store.YCOL_STORE6_X0p.dff9(ZAPE_STORE6_CLKp, _XAHO_STORE6_RSTn, _ZAGO_SPX0n_old);
      /* p31.YRAC*/ sprite_store.YRAC_STORE6_X1p.dff9(ZAPE_STORE6_CLKp, _XAHO_STORE6_RSTn, _ZOCY_SPX1n_old);
      /* p31.YMEM*/ sprite_store.YMEM_STORE6_X2p.dff9(ZAPE_STORE6_CLKp, _XAHO_STORE6_RSTn, _YPUR_SPX2n_old);
      /* p31.YVAG*/ sprite_store.YVAG_STORE6_X3p.dff9(ZAPE_STORE6_CLKp, _XAHO_STORE6_RSTn, _YVOK_SPX3n_old);
      /* p31.ZOLY*/ sprite_store.ZOLY_STORE6_X4p.dff9(ZAPE_STORE6_CLKp, _XAHO_STORE6_RSTn, _COSE_SPX4n_old);
      /* p31.ZOGO*/ sprite_store.ZOGO_STORE6_X5p.dff9(ZAPE_STORE6_CLKp, _XAHO_STORE6_RSTn, _AROP_SPX5n_old);
      /* p31.ZECU*/ sprite_store.ZECU_STORE6_X6p.dff9(ZAPE_STORE6_CLKp, _XAHO_STORE6_RSTn, _XATU_SPX6n_old);
      /* p31.ZESA*/ sprite_store.ZESA_STORE6_X7p.dff9(ZAPE_STORE6_CLKp, _XAHO_STORE6_RSTn, _BADY_SPX7n_old);
    }

    {

      /* p29.GUNA*/ wire _GUNA_STORE7_SELn = nand4(_FYCU_SPRITE_COUNT0p_new, _FONE_SPRITE_COUNT1p_new, _EKUD_SPRITE_COUNT2p_new, _CAXU_SPRITE_COUNT3n_new);
      /* p29.GAPE*/ wire GAPE_STORE7_CLKp = or2(_DYTY_STORE_ENn_xxCDxxGH_new, _GUNA_STORE7_SELn);
      ...
      /* p30.GULE*/ sprite_store.GULE_STORE7_I0n.dff8n(FEFO_STORE7_CLKp, SPR_TRI_I_in_old[0].qp_new());
      /* p30.GYNO*/ sprite_store.GYNO_STORE7_I1n.dff8n(FEFO_STORE7_CLKp, SPR_TRI_I_in_old[1].qp_new());
      /* p30.FEFA*/ sprite_store.FEFA_STORE7_I2n.dff8n(FEFO_STORE7_CLKp, SPR_TRI_I_in_old[2].qp_new());
      /* p30.FYSU*/ sprite_store.FYSU_STORE7_I3n.dff8n(FEFO_STORE7_CLKp, SPR_TRI_I_in_old[3].qp_new());
      /* p30.GESY*/ sprite_store.GESY_STORE7_I4n.dff8n(FEFO_STORE7_CLKp, SPR_TRI_I_in_old[4].qp_new());
      /* p30.FUZO*/ sprite_store.FUZO_STORE7_I5n.dff8n(FEFO_STORE7_CLKp, SPR_TRI_I_in_old[5].qp_new());
      /* p30.XYNA*/ sprite_store.XYNA_STORE7_L0n.dff8n(WABE_STORE7_CLKp, SPR_TRI_L_in_old[0].qp_new());
      /* p30.YGUM*/ sprite_store.YGUM_STORE7_L1n.dff8n(WABE_STORE7_CLKp, SPR_TRI_L_in_old[1].qp_new());
      /* p30.XAKU*/ sprite_store.XAKU_STORE7_L2n.dff8n(WABE_STORE7_CLKp, SPR_TRI_L_in_old[2].qp_new());
      /* p30.XYGO*/ sprite_store.XYGO_STORE7_L3n.dff8n(WABE_STORE7_CLKp, SPR_TRI_L_in_old[3].qp_new());

      /* p29.WAPO*/ sprite_store.WAPO_STORE7_RSTp.dff17(_WUTY_SPRITE_DONEp_new, _BYVA_LINE_RSTn_new, _GUTU_SPRITE7_GETp_old);
      /* p29.GUKY*/ wire _GUKY_STORE7_RSTp = or2(_DYBA_LINE_RSTp_new, sprite_store.WAPO_STORE7_RSTp.qp_new());
      /* p29.GAFY*/ wire _GAFY_STORE7_RSTn = not1(_GUKY_STORE7_RSTp);

      /* p31.ERAZ*/ sprite_store.ERAZ_STORE7_X0p.dff9(GECY_STORE7_CLKp, _GAFY_STORE7_RSTn, _ZAGO_SPX0n_old);
      /* p31.EPUM*/ sprite_store.EPUM_STORE7_X1p.dff9(GECY_STORE7_CLKp, _GAFY_STORE7_RSTn, _ZOCY_SPX1n_old);
      /* p31.EROL*/ sprite_store.EROL_STORE7_X2p.dff9(GECY_STORE7_CLKp, _GAFY_STORE7_RSTn, _YPUR_SPX2n_old);
      /* p31.EHYN*/ sprite_store.EHYN_STORE7_X3p.dff9(GECY_STORE7_CLKp, _GAFY_STORE7_RSTn, _YVOK_SPX3n_old);
      /* p31.FAZU*/ sprite_store.FAZU_STORE7_X4p.dff9(GECY_STORE7_CLKp, _GAFY_STORE7_RSTn, _COSE_SPX4n_old);
      /* p31.FAXE*/ sprite_store.FAXE_STORE7_X5p.dff9(GECY_STORE7_CLKp, _GAFY_STORE7_RSTn, _AROP_SPX5n_old);
      /* p31.EXUK*/ sprite_store.EXUK_STORE7_X6p.dff9(GECY_STORE7_CLKp, _GAFY_STORE7_RSTn, _XATU_SPX6n_old);
      /* p31.FEDE*/ sprite_store.FEDE_STORE7_X7p.dff9(GECY_STORE7_CLKp, _GAFY_STORE7_RSTn, _BADY_SPX7n_old);
    }

    {

      /* p29.DEWY*/ wire _DEWY_STORE8_SELn = nand4(_EDEN_SPRITE_COUNT0n_new, _CYPY_SPRITE_COUNT1n_new, _CAPE_SPRITE_COUNT2n_new, _ELYG_SPRITE_COUNT3p_new);
      /* p29.CAHO*/ wire _CAHO_STORE8_CLKp = or2(_DYTY_STORE_ENn_xxCDxxGH_new, _DEWY_STORE8_SELn);
      ...
      /* p30.AXUV*/ sprite_store.AXUV_STORE8_I0n.dff8n(_AKOL_STORE8_CLKp, SPR_TRI_I_in_old[0].qp_new());
      /* p30.BADA*/ sprite_store.BADA_STORE8_I1n.dff8n(_AKOL_STORE8_CLKp, SPR_TRI_I_in_old[1].qp_new());
      /* p30.APEV*/ sprite_store.APEV_STORE8_I2n.dff8n(_AKOL_STORE8_CLKp, SPR_TRI_I_in_old[2].qp_new());
      /* p30.BADO*/ sprite_store.BADO_STORE8_I3n.dff8n(_AKOL_STORE8_CLKp, SPR_TRI_I_in_old[3].qp_new());
      /* p30.BEXY*/ sprite_store.BEXY_STORE8_I4n.dff8n(_AKOL_STORE8_CLKp, SPR_TRI_I_in_old[4].qp_new());
      /* p30.BYHE*/ sprite_store.BYHE_STORE8_I5n.dff8n(_AKOL_STORE8_CLKp, SPR_TRI_I_in_old[5].qp_new());
      /* p30.AZAP*/ sprite_store.AZAP_STORE8_L0n.dff8n(_BYMY_STORE8_CLKp, SPR_TRI_L_in_old[0].qp_new());
      /* p30.AFYX*/ sprite_store.AFYX_STORE8_L1n.dff8n(_BYMY_STORE8_CLKp, SPR_TRI_L_in_old[1].qp_new());
      /* p30.AFUT*/ sprite_store.AFUT_STORE8_L2n.dff8n(_BYMY_STORE8_CLKp, SPR_TRI_L_in_old[2].qp_new());
      /* p30.AFYM*/ sprite_store.AFYM_STORE8_L3n.dff8n(_BYMY_STORE8_CLKp, SPR_TRI_L_in_old[3].qp_new());

      /* p29.EXUQ*/ sprite_store.EXUQ_STORE8_RSTp.dff17(_WUTY_SPRITE_DONEp_new, _BYVA_LINE_RSTn_new, _FOXA_SPRITE8_GETp_old);
      /* p29.GORO*/ wire _GORO_STORE8_RSTp = or2(_DYBA_LINE_RSTp_new, sprite_store.EXUQ_STORE8_RSTp.qp_new());
      /* p29.WUZO*/ wire _WUZO_STORE8_RSTn = not1(_GORO_STORE8_RSTp);

      /* p31.EZUF*/ sprite_store.EZUF_STORE8_X0p.dff9(_CEXU_STORE8_CLKp, _WUZO_STORE8_RSTn, _ZAGO_SPX0n_old);
      /* p31.ENAD*/ sprite_store.ENAD_STORE8_X1p.dff9(_CEXU_STORE8_CLKp, _WUZO_STORE8_RSTn, _ZOCY_SPX1n_old);
      /* p31.EBOW*/ sprite_store.EBOW_STORE8_X2p.dff9(_CEXU_STORE8_CLKp, _WUZO_STORE8_RSTn, _YPUR_SPX2n_old);
      /* p31.FYCA*/ sprite_store.FYCA_STORE8_X3p.dff9(_CEXU_STORE8_CLKp, _WUZO_STORE8_RSTn, _YVOK_SPX3n_old);
      /* p31.GAVY*/ sprite_store.GAVY_STORE8_X4p.dff9(_CEXU_STORE8_CLKp, _WUZO_STORE8_RSTn, _COSE_SPX4n_old);
      /* p31.GYPU*/ sprite_store.GYPU_STORE8_X5p.dff9(_CEXU_STORE8_CLKp, _WUZO_STORE8_RSTn, _AROP_SPX5n_old);
      /* p31.GADY*/ sprite_store.GADY_STORE8_X6p.dff9(_CEXU_STORE8_CLKp, _WUZO_STORE8_RSTn, _XATU_SPX6n_old);
      /* p31.GAZA*/ sprite_store.GAZA_STORE8_X7p.dff9(_CEXU_STORE8_CLKp, _WUZO_STORE8_RSTn, _BADY_SPX7n_old);
    }

    {
      /* p29.DOGU*/ wire _DOGU_STORE9_SELn = nand4(_FYCU_SPRITE_COUNT0p_new, _CYPY_SPRITE_COUNT1n_new, _CAPE_SPRITE_COUNT2n_new, _ELYG_SPRITE_COUNT3p_new);
      /* p29.CATO*/ wire _CATO_STORE9_CLKp = or2(_DYTY_STORE_ENn_xxCDxxGH_new, _DOGU_STORE9_SELn);
      ...
      /* p30.YBER*/ sprite_store.YBER_STORE9_I0n.dff8n(_WUFA_STORE9_CLKp, SPR_TRI_I_in_old[0].qp_new());
      /* p30.YZOR*/ sprite_store.YZOR_STORE9_I1n.dff8n(_WUFA_STORE9_CLKp, SPR_TRI_I_in_old[1].qp_new());
      /* p30.XYFE*/ sprite_store.XYFE_STORE9_I2n.dff8n(_WUFA_STORE9_CLKp, SPR_TRI_I_in_old[2].qp_new());
      /* p30.XOTU*/ sprite_store.XOTU_STORE9_I3n.dff8n(_WUFA_STORE9_CLKp, SPR_TRI_I_in_old[3].qp_new());
      /* p30.XUTE*/ sprite_store.XUTE_STORE9_I4n.dff8n(_WUFA_STORE9_CLKp, SPR_TRI_I_in_old[4].qp_new());
      /* p30.XUFO*/ sprite_store.XUFO_STORE9_I5n.dff8n(_WUFA_STORE9_CLKp, SPR_TRI_I_in_old[5].qp_new());
      /* p30.CANA*/ sprite_store.CANA_STORE9_L0n.dff8n(_FAKA_STORE9_CLKp, SPR_TRI_L_in_old[0].qp_new());
      /* p30.FOFO*/ sprite_store.FOFO_STORE9_L1n.dff8n(_FAKA_STORE9_CLKp, SPR_TRI_L_in_old[1].qp_new());
      /* p30.DYSY*/ sprite_store.DYSY_STORE9_L2n.dff8n(_FAKA_STORE9_CLKp, SPR_TRI_L_in_old[2].qp_new());
      /* p30.DEWU*/ sprite_store.DEWU_STORE9_L3n.dff8n(_FAKA_STORE9_CLKp, SPR_TRI_L_in_old[3].qp_new());

      /* p29.FONO*/ sprite_store.FONO_STORE9_RSTp.dff17(_WUTY_SPRITE_DONEp_new, _BYVA_LINE_RSTn_new, _GUZE_SPRITE9_GETp_old);
      /* p29.DUBU*/ wire _DUBU_STORE9_RSTp = or2(_DYBA_LINE_RSTp_new, sprite_store.FONO_STORE9_RSTp.qp_new());
      /* p29.DOSY*/ wire _DOSY_STORE9_RSTn = not1(_DUBU_STORE9_RSTp);

      /* p31.XUVY*/ sprite_store.XUVY_STORE9_X0p.dff9(_WEME_STORE9_CLKp, _DOSY_STORE9_RSTn, _ZAGO_SPX0n_old);
      /* p31.XERE*/ sprite_store.XERE_STORE9_X1p.dff9(_WEME_STORE9_CLKp, _DOSY_STORE9_RSTn, _ZOCY_SPX1n_old);
      /* p31.XUZO*/ sprite_store.XUZO_STORE9_X2p.dff9(_WEME_STORE9_CLKp, _DOSY_STORE9_RSTn, _YPUR_SPX2n_old);
      /* p31.XEXA*/ sprite_store.XEXA_STORE9_X3p.dff9(_WEME_STORE9_CLKp, _DOSY_STORE9_RSTn, _YVOK_SPX3n_old);
      /* p31.YPOD*/ sprite_store.YPOD_STORE9_X4p.dff9(_WEME_STORE9_CLKp, _DOSY_STORE9_RSTn, _COSE_SPX4n_old);
      /* p31.YROP*/ sprite_store.YROP_STORE9_X5p.dff9(_WEME_STORE9_CLKp, _DOSY_STORE9_RSTn, _AROP_SPX5n_old);
      /* p31.YNEP*/ sprite_store.YNEP_STORE9_X6p.dff9(_WEME_STORE9_CLKp, _DOSY_STORE9_RSTn, _XATU_SPX6n_old);
      /* p31.YZOF*/ sprite_store.YZOF_STORE9_X7p.dff9(_WEME_STORE9_CLKp, _DOSY_STORE9_RSTn, _BADY_SPX7n_old);
    }
  }
  ...
  {
    /* p08.LOXO*/ wire _LOXO_HOLDn = and_or3(_MULE_MODE_DBG1n_ext, _TEXO_8000_9FFFn_new, _UMUT_MODE_DBG1p_ext);
    ...
    /* p08.KUPO*/ wire _KUPO = nand2(_AMET_A00p, _TOVA_MODE_DBG2n_ext);
    /* p08.CABA*/ wire _CABA = nand2(_ATOL_A01p, _TOVA_MODE_DBG2n_ext);
    /* p08.BOKU*/ wire _BOKU = nand2(_APOK_A02p, _TOVA_MODE_DBG2n_ext);
    /* p08.BOTY*/ wire _BOTY = nand2(_AMER_A03p, _TOVA_MODE_DBG2n_ext);
    /* p08.BYLA*/ wire _BYLA = nand2(_ATEM_A04p, _TOVA_MODE_DBG2n_ext);
    /* p08.BADU*/ wire _BADU = nand2(_ATOV_A05p, _TOVA_MODE_DBG2n_ext);
    /* p08.CEPU*/ wire _CEPU = nand2(_ATYR_A06p, _TOVA_MODE_DBG2n_ext);
    /* p08.DEFY*/ wire _DEFY = nand2(_ASUR_A07p, _TOVA_MODE_DBG2n_ext);
    /* p08.MYNY*/ wire _MYNY = nand2(_MANO_A08p, _TOVA_MODE_DBG2n_ext);
    /* p08.MUNE*/ wire _MUNE = nand2(_MASU_A09p, _TOVA_MODE_DBG2n_ext);
    /* p08.ROXU*/ wire _ROXU = nand2(_PAMY_A10p, _TOVA_MODE_DBG2n_ext);
    /* p08.LEPY*/ wire _LEPY = nand2(_MALE_A11p, _TOVA_MODE_DBG2n_ext);
    /* p08.LUCE*/ wire _LUCE = nand2(_MOJY_A12p, _TOVA_MODE_DBG2n_ext);
    /* p08.LABE*/ wire _LABE = nand2(_MUCE_A13p, _TOVA_MODE_DBG2n_ext);
    /* p08.PUHE*/ wire _PUHE = nand2(_PEGE_A14p, _TOVA_MODE_DBG2n_ext);

    /* p08.KOTY*/ wire _KOTY = nor2 (_AMET_A00p, _UNOR_MODE_DBG2p_ext);
    /* p08.COTU*/ wire _COTU = nor2 (_ATOL_A01p, _UNOR_MODE_DBG2p_ext);
    /* p08.BAJO*/ wire _BAJO = nor2 (_APOK_A02p, _UNOR_MODE_DBG2p_ext);
    /* p08.BOLA*/ wire _BOLA = nor2 (_AMER_A03p, _UNOR_MODE_DBG2p_ext);
    /* p08.BEVO*/ wire _BEVO = nor2 (_ATEM_A04p, _UNOR_MODE_DBG2p_ext);
    /* p08.AJAV*/ wire _AJAV = nor2 (_ATOV_A05p, _UNOR_MODE_DBG2p_ext);
    /* p08.CYKA*/ wire _CYKA = nor2 (_ATYR_A06p, _UNOR_MODE_DBG2p_ext);
    /* p08.COLO*/ wire _COLO = nor2 (_ASUR_A07p, _UNOR_MODE_DBG2p_ext);
    /* p08.MEGO*/ wire _MEGO = nor2 (_MANO_A08p, _UNOR_MODE_DBG2p_ext);
    /* p08.MENY*/ wire _MENY = nor2 (_MASU_A09p, _UNOR_MODE_DBG2p_ext);
    /* p08.RORE*/ wire _RORE = nor2 (_PAMY_A10p, _UNOR_MODE_DBG2p_ext);
    /* p08.LYNY*/ wire _LYNY = nor2 (_MALE_A11p, _UNOR_MODE_DBG2p_ext);
    /* p08.LOSO*/ wire _LOSO = nor2 (_MOJY_A12p, _UNOR_MODE_DBG2p_ext);
    /* p08.LEVA*/ wire _LEVA = nor2 (_MUCE_A13p, _UNOR_MODE_DBG2p_ext);
    /* p08.PAHY*/ wire _PAHY = nor2 (_PEGE_A14p, _UNOR_MODE_DBG2p_ext);
    ...
    /* p08.SUZE*/ wire _SUZE_PIN_EXT_A15n = nand2(_TAZY_A15p, _RYCA_MODE_DBG2n_ext);
    /* p08.RULO*/ wire _RULO_PIN_EXT_A15n = nor2 (_TAZY_A15p, _UNOR_MODE_DBG2p_ext);
    ...
    /* p08.UGAC*/ wire _UGAC_RD_A = nand2(_TYMU_EXT_RDn, _TOVA_MODE_DBG2n_ext);
    /* p08.URUN*/ wire _URUN_RD_D = nor2 (_TYMU_EXT_RDn, _UNOR_MODE_DBG2p_ext);
    PIN_EXT_RDn.pin_out(1, _UGAC_RD_A, _URUN_RD_D);

    /* p08.MEXO*/ wire _MEXO_CPU_WRn_ABCDxxxH = not1(_APOV_CPU_WRp_xxxxEFGx_clk);
    ...
    /* p08.UVER*/ wire _UVER_WR_A = nand2(_PUVA_EXT_WRn, _TOVA_MODE_DBG2n_ext);
    /* p08.USUF*/ wire _USUF_WR_D = nor2 (_PUVA_EXT_WRn, _UNOR_MODE_DBG2p_ext);
    PIN_EXT_WRn.pin_out(1, _UVER_WR_A, _USUF_WR_D);

    /* p08.TOZA*/ wire _TOZA_PIN_EXT_CS_A_xxCDEFGH = and3(_ABUZ_xxCDEFGH_new, _TYNU_A000_FFFFp_ext, _TUNA_0000_FDFFp_ext);
...

  {
    ...
    /* p08.RORU*/ wire _RORU_CBD_TO_EPDn = mux2p(_UNOR_MODE_DBG2p_ext, _REDU_CPU_RDn_ext, _MOTY_CPU_EXT_RD_new);
...
#pragma region LYC_Matcher
  {
    ...
    /*#p21.ROPO*/ lcd_reg.ROPO_LY_MATCH_SYNCp.dff17(_TALU_xxCDEFxx_clknew,  _WESY_SYS_RSTn_new, _PALY_LY_MATCHa);
  }
#pragma endregion
...
#pragma region Pixel_Pipes
  // Reload all the pipes using set/rst
  {
    ...
    /* p32.PYBO*/ pix_pipe.PYBO_BG_PIPE_A7.dff22(_SACU_CLKPIPE_AxCxExGx_clknew, BG_PIPE_A_SET7, BG_PIPE_A_RST7, pix_pipe.NEDA_BG_PIPE_A6.qp_old());
    /* p32.NEDA*/ pix_pipe.NEDA_BG_PIPE_A6.dff22(_SACU_CLKPIPE_AxCxExGx_clknew, BG_PIPE_A_SET6, BG_PIPE_A_RST6, pix_pipe.MODU_BG_PIPE_A5.qp_old());
    /* p32.MODU*/ pix_pipe.MODU_BG_PIPE_A5.dff22(_SACU_CLKPIPE_AxCxExGx_clknew, BG_PIPE_A_SET5, BG_PIPE_A_RST5, pix_pipe.NEPO_BG_PIPE_A4.qp_old());
    /* p32.NEPO*/ pix_pipe.NEPO_BG_PIPE_A4.dff22(_SACU_CLKPIPE_AxCxExGx_clknew, BG_PIPE_A_SET4, BG_PIPE_A_RST4, pix_pipe.MACU_BG_PIPE_A3.qp_old());
    /* p32.MACU*/ pix_pipe.MACU_BG_PIPE_A3.dff22(_SACU_CLKPIPE_AxCxExGx_clknew, BG_PIPE_A_SET3, BG_PIPE_A_RST3, pix_pipe.MOJU_BG_PIPE_A2.qp_old());
    /* p32.MOJU*/ pix_pipe.MOJU_BG_PIPE_A2.dff22(_SACU_CLKPIPE_AxCxExGx_clknew, BG_PIPE_A_SET2, BG_PIPE_A_RST2, pix_pipe.NOZO_BG_PIPE_A1.qp_old());
    /* p32.NOZO*/ pix_pipe.NOZO_BG_PIPE_A1.dff22(_SACU_CLKPIPE_AxCxExGx_clknew, BG_PIPE_A_SET1, BG_PIPE_A_RST1, pix_pipe.MYDE_BG_PIPE_A0.qp_old());
    /* p32.MYDE*/ pix_pipe.MYDE_BG_PIPE_A0.dff22(_SACU_CLKPIPE_AxCxExGx_clknew, BG_PIPE_A_SET0, BG_PIPE_A_RST0, GND);
  }

  {
    ...
    /* p32.SOHU*/ pix_pipe.SOHU_BG_PIPE_B7.dff22(_SACU_CLKPIPE_AxCxExGx_clknew, BG_PIPE_B_SET7, BG_PIPE_B_RST7, pix_pipe.RALU_BG_PIPE_B6.qp_old());
    /* p32.RALU*/ pix_pipe.RALU_BG_PIPE_B6.dff22(_SACU_CLKPIPE_AxCxExGx_clknew, BG_PIPE_B_SET6, BG_PIPE_B_RST6, pix_pipe.SETU_BG_PIPE_B5.qp_old());
    /* p32.SETU*/ pix_pipe.SETU_BG_PIPE_B5.dff22(_SACU_CLKPIPE_AxCxExGx_clknew, BG_PIPE_B_SET5, BG_PIPE_B_RST5, pix_pipe.SOBO_BG_PIPE_B4.qp_old());
    /* p32.SOBO*/ pix_pipe.SOBO_BG_PIPE_B4.dff22(_SACU_CLKPIPE_AxCxExGx_clknew, BG_PIPE_B_SET4, BG_PIPE_B_RST4, pix_pipe.RYSA_BG_PIPE_B3.qp_old());
    /* p32.RYSA*/ pix_pipe.RYSA_BG_PIPE_B3.dff22(_SACU_CLKPIPE_AxCxExGx_clknew, BG_PIPE_B_SET3, BG_PIPE_B_RST3, pix_pipe.SADY_BG_PIPE_B2.qp_old());
    /* p32.SADY*/ pix_pipe.SADY_BG_PIPE_B2.dff22(_SACU_CLKPIPE_AxCxExGx_clknew, BG_PIPE_B_SET2, BG_PIPE_B_RST2, pix_pipe.TACA_BG_PIPE_B1.qp_old());
    /* p32.TACA*/ pix_pipe.TACA_BG_PIPE_B1.dff22(_SACU_CLKPIPE_AxCxExGx_clknew, BG_PIPE_B_SET1, BG_PIPE_B_RST1, pix_pipe.TOMY_BG_PIPE_B0.qp_old());
    /* p32.TOMY*/ pix_pipe.TOMY_BG_PIPE_B0.dff22(_SACU_CLKPIPE_AxCxExGx_clknew, BG_PIPE_B_SET0, BG_PIPE_B_RST0, GND);
  }

  {
    ...
    // Sprite pipe A
    {
      ...
      /* p33.WUFY*/ pix_pipe.WUFY_SPR_PIPE_A7.dff22(_SACU_CLKPIPE_AxCxExGx_clknew, VUNE_SPR_PIX_SET7, XYVE_SPR_PIX_RST7, pix_pipe.VAFO_SPR_PIPE_A6.qp_old());
      /* p33.VAFO*/ pix_pipe.VAFO_SPR_PIPE_A6.dff22(_SACU_CLKPIPE_AxCxExGx_clknew, TUXA_SPR_PIX_SET6, TUPE_SPR_PIX_RST6, pix_pipe.WORA_SPR_PIPE_A5.qp_old());
      /* p33.WORA*/ pix_pipe.WORA_SPR_PIPE_A5.dff22(_SACU_CLKPIPE_AxCxExGx_clknew, VABY_SPR_PIX_SET5, XEXU_SPR_PIX_RST5, pix_pipe.WYHO_SPR_PIPE_A4.qp_old());
      /* p33.WYHO*/ pix_pipe.WYHO_SPR_PIPE_A4.dff22(_SACU_CLKPIPE_AxCxExGx_clknew, VEXU_SPR_PIX_SET4, XATO_SPR_PIX_RST4, pix_pipe.LESU_SPR_PIPE_A3.qp_old());
      /* p33.LESU*/ pix_pipe.LESU_SPR_PIPE_A3.dff22(_SACU_CLKPIPE_AxCxExGx_clknew, MAME_SPR_PIX_SET3, LUFY_SPR_PIX_RST3, pix_pipe.LEFE_SPR_PIPE_A2.qp_old());
      /* p33.LEFE*/ pix_pipe.LEFE_SPR_PIPE_A2.dff22(_SACU_CLKPIPE_AxCxExGx_clknew, LELA_SPR_PIX_SET2, LYDE_SPR_PIX_RST2, pix_pipe.MASO_SPR_PIPE_A1.qp_old());
      /* p33.MASO*/ pix_pipe.MASO_SPR_PIPE_A1.dff22(_SACU_CLKPIPE_AxCxExGx_clknew, MYTO_SPR_PIX_SET1, MADA_SPR_PIX_RST1, pix_pipe.NURO_SPR_PIPE_A0.qp_old());
      /* p33.NURO*/ pix_pipe.NURO_SPR_PIPE_A0.dff22(_SACU_CLKPIPE_AxCxExGx_clknew, PABE_SPR_PIX_SET0, PYZU_SPR_PIX_RST0, GND);
    }
    ...
    // Sprite pipe B
    {
      ...
      /* p33.VUPY*/ pix_pipe.VUPY_SPR_PIPE_B7.dff22(_SACU_CLKPIPE_AxCxExGx_clknew, TESO_SPR_PIX_SET7, TULA_SPR_PIX_RST7, pix_pipe.VANU_SPR_PIPE_B6.qp_old());
      /* p33.VANU*/ pix_pipe.VANU_SPR_PIPE_B6.dff22(_SACU_CLKPIPE_AxCxExGx_clknew, TAPO_SPR_PIX_SET6, TABY_SPR_PIX_RST6, pix_pipe.WEBA_SPR_PIPE_B5.qp_old());
      /* p33.WEBA*/ pix_pipe.WEBA_SPR_PIPE_B5.dff22(_SACU_CLKPIPE_AxCxExGx_clknew, VUME_SPR_PIX_SET5, XOLE_SPR_PIX_RST5, pix_pipe.VARE_SPR_PIPE_B4.qp_old());
      /* p33.VARE*/ pix_pipe.VARE_SPR_PIPE_B4.dff22(_SACU_CLKPIPE_AxCxExGx_clknew, TYGA_SPR_PIX_SET4, WAXO_SPR_PIX_RST4, pix_pipe.PYJO_SPR_PIPE_B3.qp_old());
      /* p33.PYJO*/ pix_pipe.PYJO_SPR_PIPE_B3.dff22(_SACU_CLKPIPE_AxCxExGx_clknew, RANO_SPR_PIX_SET3, REHU_SPR_PIX_RST3, pix_pipe.NATY_SPR_PIPE_B2.qp_old());
      /* p33.NATY*/ pix_pipe.NATY_SPR_PIPE_B2.dff22(_SACU_CLKPIPE_AxCxExGx_clknew, MYXA_SPR_PIX_SET2, MAJO_SPR_PIX_RST2, pix_pipe.PEFU_SPR_PIPE_B1.qp_old());
      /* p33.PEFU*/ pix_pipe.PEFU_SPR_PIPE_B1.dff22(_SACU_CLKPIPE_AxCxExGx_clknew, RUSY_SPR_PIX_SET1, RUCA_SPR_PIX_RST1, pix_pipe.NYLU_SPR_PIPE_B0.qp_old());
      /* p33.NYLU*/ pix_pipe.NYLU_SPR_PIPE_B0.dff22(_SACU_CLKPIPE_AxCxExGx_clknew, MEZU_SPR_PIX_SET0, MOFY_SPR_PIX_RST0, GND);
    }
    ...
    // Palette pipe
    {
      ...
      /* p34.LYME*/ pix_pipe.LYME_PAL_PIPE_7.dff22(_SACU_CLKPIPE_AxCxExGx_clknew, LAMY_PAL_PIPE_SET7n, LUNU_PAL_PIPE_RST7n, pix_pipe.MODA_PAL_PIPE_6.qp_old());
      /* p34.MODA*/ pix_pipe.MODA_PAL_PIPE_6.dff22(_SACU_CLKPIPE_AxCxExGx_clknew, LUKE_PAL_PIPE_SET6n, LOWA_PAL_PIPE_RST6n, pix_pipe.NUKE_PAL_PIPE_5.qp_old());
      /* p34.NUKE*/ pix_pipe.NUKE_PAL_PIPE_5.dff22(_SACU_CLKPIPE_AxCxExGx_clknew, MENE_PAL_PIPE_SET5n, PAZO_PAL_PIPE_RST5n, pix_pipe.PALU_PAL_PIPE_4.qp_old());
      /* p34.PALU*/ pix_pipe.PALU_PAL_PIPE_4.dff22(_SACU_CLKPIPE_AxCxExGx_clknew, RORA_PAL_PIPE_SET4n, RUDU_PAL_PIPE_RST4n, pix_pipe.SOMY_PAL_PIPE_3.qp_old());
      /* p34.SOMY*/ pix_pipe.SOMY_PAL_PIPE_3.dff22(_SACU_CLKPIPE_AxCxExGx_clknew, SUKY_PAL_PIPE_SET3n, TOWA_PAL_PIPE_RST3n, pix_pipe.ROSA_PAL_PIPE_2.qp_old());
      /* p34.ROSA*/ pix_pipe.ROSA_PAL_PIPE_2.dff22(_SACU_CLKPIPE_AxCxExGx_clknew, PAMO_PAL_PIPE_SET2n, PYZY_PAL_PIPE_RST2n, pix_pipe.SATA_PAL_PIPE_1.qp_old());
      /* p34.SATA*/ pix_pipe.SATA_PAL_PIPE_1.dff22(_SACU_CLKPIPE_AxCxExGx_clknew, SORO_PAL_PIPE_SET1n, TAFA_PAL_PIPE_RST1n, pix_pipe.RUGO_PAL_PIPE_0.qp_old());
      /* p34.RUGO*/ pix_pipe.RUGO_PAL_PIPE_0.dff22(_SACU_CLKPIPE_AxCxExGx_clknew, PUME_PAL_PIPE_SET0n, SUCO_PAL_PIPE_RST0n, GND);
    }
    ...
    // Background mask pipe
    {
      ...
      /* p26.VAVA*/ pix_pipe.VAVA_MASK_PIPE_7.dff22(_SACU_CLKPIPE_AxCxExGx_clknew, TUWU_MASK_PIPE_SET7, WUBU_MASK_PIPE_RST7, pix_pipe.VUMO_MASK_PIPE_6.qp_old());
      /* p26.VUMO*/ pix_pipe.VUMO_MASK_PIPE_6.dff22(_SACU_CLKPIPE_AxCxExGx_clknew, TYKO_MASK_PIPE_SET6, TENA_MASK_PIPE_RST6, pix_pipe.WODA_MASK_PIPE_5.qp_old());
      /* p26.WODA*/ pix_pipe.WODA_MASK_PIPE_5.dff22(_SACU_CLKPIPE_AxCxExGx_clknew, XELY_MASK_PIPE_SET5, WUJA_MASK_PIPE_RST5, pix_pipe.XETE_MASK_PIPE_4.qp_old());
      /* p26.XETE*/ pix_pipe.XETE_MASK_PIPE_4.dff22(_SACU_CLKPIPE_AxCxExGx_clknew, XUKU_MASK_PIPE_SET4, WEDY_MASK_PIPE_RST4, pix_pipe.WYFU_MASK_PIPE_3.qp_old());
      /* p26.WYFU*/ pix_pipe.WYFU_MASK_PIPE_3.dff22(_SACU_CLKPIPE_AxCxExGx_clknew, XYRU_MASK_PIPE_SET3, WEVO_MASK_PIPE_RST3, pix_pipe.VOSA_MASK_PIPE_2.qp_old());
      /* p26.VOSA*/ pix_pipe.VOSA_MASK_PIPE_2.dff22(_SACU_CLKPIPE_AxCxExGx_clknew, TYRA_MASK_PIPE_SET2, TUFO_MASK_PIPE_RST2, pix_pipe.WURU_MASK_PIPE_1.qp_old());
      /* p26.WURU*/ pix_pipe.WURU_MASK_PIPE_1.dff22(_SACU_CLKPIPE_AxCxExGx_clknew, XALA_MASK_PIPE_SET1, WEDE_MASK_PIPE_RST1, pix_pipe.VEZO_MASK_PIPE_0.qp_old());
      /* p26.VEZO*/ pix_pipe.VEZO_MASK_PIPE_0.dff22(_SACU_CLKPIPE_AxCxExGx_clknew, TEDE_MASK_PIPE_SET0, WOKA_MASK_PIPE_RST0, _VYPO_VCC);
    }
  }
#pragma endregion
...
#pragma region Joypad
  {
    ...
    */
...

    {
      ...
      /* p05.KEVU*/ joypad.KEVU_JOYP_L0n.tp_latch(_BYZO_FF00_RDn_ext, PIN_JOY_P10.qn_new());
      /* p05.KAPA*/ joypad.KAPA_JOYP_L1n.tp_latch(_BYZO_FF00_RDn_ext, PIN_JOY_P11.qn_new());
      /* p05.KEJA*/ joypad.KEJA_JOYP_L2n.tp_latch(_BYZO_FF00_RDn_ext, PIN_JOY_P12.qn_new());
      /* p05.KOLO*/ joypad.KOLO_JOYP_L3n.tp_latch(_BYZO_FF00_RDn_ext, PIN_JOY_P13.qn_new());
    }
  }
#pragma endregion
...
#pragma region Serial
  {
    ...
    /* p06.CULY*/ ser_reg.CULY_XFER_DIR.dff17(_UWAM_FF02_WRn_clk, _ALUR_SYS_RSTn_new, BUS_CPU_Dp_old[0].qp_new());
    ...
    /* p06.CUFU*/ wire _CUFU_SER_DATA0_SETn = nand2(BUS_CPU_Dp_old[0].qp_new(), _DAKU_FF01_WRp_clk);
    /* p06.DOCU*/ wire _DOCU_SER_DATA1_SETn = nand2(BUS_CPU_Dp_old[1].qp_new(), _DAKU_FF01_WRp_clk);
    /* p06.DELA*/ wire _DELA_SER_DATA2_SETn = nand2(BUS_CPU_Dp_old[2].qp_new(), _DAKU_FF01_WRp_clk);
    /* p06.DYGE*/ wire _DYGE_SER_DATA3_SETn = nand2(BUS_CPU_Dp_old[3].qp_new(), _DAKU_FF01_WRp_clk);
    /* p06.DOLA*/ wire _DOLA_SER_DATA4_SETn = nand2(BUS_CPU_Dp_old[4].qp_new(), _DAKU_FF01_WRp_clk);
    /* p06.ELOK*/ wire _ELOK_SER_DATA5_SETn = nand2(BUS_CPU_Dp_old[5].qp_new(), _DAKU_FF01_WRp_clk);
    /* p06.EDEL*/ wire _EDEL_SER_DATA6_SETn = nand2(BUS_CPU_Dp_old[6].qp_new(), _DAKU_FF01_WRp_clk);
    /* p06.EFEF*/ wire _EFEL_SER_DATA7_SETn = nand2(BUS_CPU_Dp_old[7].qp_new(), _DAKU_FF01_WRp_clk);

    /* p06.COHY*/ wire _COHY_SER_DATA0_RSTn = or_and3(_URYS_FF01_WRn_clk, BUS_CPU_Dp_old[0].qp_new(), _ALUR_SYS_RSTn_new);
    /* p06.DUMO*/ wire _DUMO_SER_DATA1_RSTn = or_and3(_URYS_FF01_WRn_clk, BUS_CPU_Dp_old[1].qp_new(), _ALUR_SYS_RSTn_new);
    /* p06.DYBO*/ wire _DYBO_SER_DATA2_RSTn = or_and3(_URYS_FF01_WRn_clk, BUS_CPU_Dp_old[2].qp_new(), _ALUR_SYS_RSTn_new);
    /* p06.DAJU*/ wire _DAJU_SER_DATA3_RSTn = or_and3(_URYS_FF01_WRn_clk, BUS_CPU_Dp_old[3].qp_new(), _ALUR_SYS_RSTn_new);
    /* p06.DYLY*/ wire _DYLY_SER_DATA4_RSTn = or_and3(_URYS_FF01_WRn_clk, BUS_CPU_Dp_old[4].qp_new(), _ALUR_SYS_RSTn_new);
    /* p06.EHUJ*/ wire _EHUJ_SER_DATA5_RSTn = or_and3(_URYS_FF01_WRn_clk, BUS_CPU_Dp_old[5].qp_new(), _ALUR_SYS_RSTn_new);
    /* p06.EFAK*/ wire _EFAK_SER_DATA6_RSTn = or_and3(_URYS_FF01_WRn_clk, BUS_CPU_Dp_old[6].qp_new(), _ALUR_SYS_RSTn_new);
    /* p06.EGUV*/ wire _EGUV_SER_DATA7_RSTn = or_and3(_URYS_FF01_WRn_clk, BUS_CPU_Dp_old[7].qp_new(), _ALUR_SYS_RSTn_new);
    ...
    /* p06.CARO*/ wire _CARO_SER_RST = and2(_UWAM_FF02_WRn_clk, _ALUR_SYS_RSTn_new);
    ...
    /* p06.ETAF*/ ser_reg.ETAF_SER_RUNNING.dff17(_UWAM_FF02_WRn_clk, _CABY_XFER_RESET, BUS_CPU_Dp_old[7].qp_new());
...
#pragma region Interrupts
  {
    ...
    /* p02.MYZU*/ wire _MYZU_FF0F_SET0n = nand3(_ROTU_FF0F_WRp_clk, _LETY_INT_VBL_ACKn,  BUS_CPU_Dp_old[0].qp_new());
    /* p02.MODY*/ wire _MODY_FF0F_SET1n = nand3(_ROTU_FF0F_WRp_clk, _LEJA_INT_STAT_ACKn, BUS_CPU_Dp_old[1].qp_new());
    /* p02.PYHU*/ wire _PYHU_FF0F_SET2n = nand3(_ROTU_FF0F_WRp_clk, _LESA_INT_TIM_ACKn,  BUS_CPU_Dp_old[2].qp_new());
    /* p02.TOME*/ wire _TOME_FF0F_SET3n = nand3(_ROTU_FF0F_WRp_clk, _LUFE_INT_SER_ACKn,  BUS_CPU_Dp_old[3].qp_new());
    /* p02.TOGA*/ wire _TOGA_FF0F_SET4n = nand3(_ROTU_FF0F_WRp_clk, _LAMO_INT_JOY_ACKn,  BUS_CPU_Dp_old[4].qp_new());

    /*#p02.MUXE*/ wire _MUXE_INT0_WRn = or2(BUS_CPU_Dp_old[0].qp_new(), _REFA_FF0F_WRn_clk);
    /* p02.NABE*/ wire _NABE_INT1_WRn = or2(BUS_CPU_Dp_old[1].qp_new(), _REFA_FF0F_WRn_clk);
    /* p02.RAKE*/ wire _RAKE_INT2_WRn = or2(BUS_CPU_Dp_old[2].qp_new(), _REFA_FF0F_WRn_clk);
    /* p02.SULO*/ wire _SULO_INT3_WRn = or2(BUS_CPU_Dp_old[3].qp_new(), _REFA_FF0F_WRn_clk);
    /* p02.SEME*/ wire _SEME_INT4_WRn = or2(BUS_CPU_Dp_old[4].qp_new(), _REFA_FF0F_WRn_clk);
...

    {
      ...
      wire FFFF_WRn = nand2(_TAPU_CPU_WRp_xxxxEFGx_clk, FFFF_HIT_ext);
...
#pragma endregion
  ...
  /*#p28.GEKA*/ wire _GEKA_OAM_A0p = not1(BUS_OAM_An_old[0].qp_new());
  ...
  /* p28.AMAB*/ wire _AMAB_CPU_OAM_ENp = and2(_SARO_FE00_FEFFp_ext, _AJUJ_OAM_BUSYn); // def and
...
#pragma region OAM_write
  ...
  {
    /* p28.XUTO*/ wire _XUTO_CPU_OAM_WRp = and2(_SARO_FE00_FEFFp_ext, _CUPA_CPU_WRp_xxxxEFGx_clk);
    ...
    /* p28.APAG*/ wire _APAG_CBD_TO_OBDp = amux2(_XUPA_CPU_OAM_WRp, _AMAB_CPU_OAM_ENp, _AJUJ_OAM_BUSYn, _ADAH_FE00_FEFFn_ext);
  ...
  {
    /* p04.MAKA*/ oam_bus.MAKA_HOLD_MEMp.dff17(_ZEME_AxCxExGx_clk, _CUNU_SYS_RSTn_new, _CATY_LATCH_EXTp_new);
    /* p04.NAXY*/ wire _NAXY_DMA_OAM_WRp = nor2(_UVYT_ABCDxxxx_clk, oam_bus.MAKA_HOLD_MEMp.qp_new()); // def nor2
    /* p04.POWU*/ wire _POWU_DMA_OAM_WRp  = and2(dma_reg.MATU_DMA_RUNNINGp.qp_new(), _NAXY_DMA_OAM_WRp); // def and
    /* p04.WYJA*/ wire _WYJA_OAM_WRp   = and_or3(_AMAB_CPU_OAM_ENp, _CUPA_CPU_WRp_xxxxEFGx_clk, _POWU_DMA_OAM_WRp);
...
#pragma region VRAM_write
  {
    ...
    {
      /* p25.TUJA*/ wire _TUJA_CPU_VRAM_WRp = and2(_SOSE_8000_9FFFp_new, _APOV_CPU_WRp_xxxxEFGx_clk);
...
#pragma endregion
  ...
  /* LCD Pixel Pipe */
  {
...

    {
      ...
      /*#p21.SYGU*/ lcd_reg.SYGU_LINE_STROBE.dff17(_SONO_ABxxxxGH_clknew,  _LYFE_VID_RSTn_new, _TEGY_STROBE);
...

    {
      ...
      /*#p21.TOBA*/ wire _TOBA_LCD_CLOCK = and2(pix_pipe.WUSA_LCD_CLOCK_GATE.qp_new(), _SACU_CLKPIPE_AxCxExGx_clkold);
...
#pragma region BUS_CPU_Dp_out_Drivers
  {
    /* FF00 JOYP */
    /* p05.KEMA*/ BUS_CPU_Dp_new[0].tri6_nn(_BYZO_FF00_RDn_ext, joypad.KEVU_JOYP_L0n.qp_new());
    /* p05.KURO*/ BUS_CPU_Dp_new[1].tri6_nn(_BYZO_FF00_RDn_ext, joypad.KAPA_JOYP_L1n.qp_new());
    /* p05.KUVE*/ BUS_CPU_Dp_new[2].tri6_nn(_BYZO_FF00_RDn_ext, joypad.KEJA_JOYP_L2n.qp_new());
    /* p05.JEKU*/ BUS_CPU_Dp_new[3].tri6_nn(_BYZO_FF00_RDn_ext, joypad.KOLO_JOYP_L3n.qp_new());
    /* p05.KOCE*/ BUS_CPU_Dp_new[4].tri6_nn(_BYZO_FF00_RDn_ext, joypad.KELY_JOYP_UDLRp.qn_new());
    /* p05.CUDY*/ BUS_CPU_Dp_new[5].tri6_nn(_BYZO_FF00_RDn_ext, joypad.COFY_JOYP_ABCSp.qn_new());
    /* p??.????*/ BUS_CPU_Dp_new[6].tri6_nn(_BYZO_FF00_RDn_ext, joypad.KUKO_DBG_FF00_D6n.qp_new());
    /* p??.????*/ BUS_CPU_Dp_new[7].tri6_nn(_BYZO_FF00_RDn_ext, joypad.KERU_DBG_FF00_D7n.qp_new());
  }
  {
    /* FF01 SER */
    /*#p06.CUGY*/ BUS_CPU_Dp_new[0].tri6_pn(_UFEG_FF01_RDp_ext, ser_reg.CUBA_SER_DATA0.qn_new());
    /* p06.DUDE*/ BUS_CPU_Dp_new[1].tri6_pn(_UFEG_FF01_RDp_ext, ser_reg.DEGU_SER_DATA1.qn_new());
    /* p06.DETU*/ BUS_CPU_Dp_new[2].tri6_pn(_UFEG_FF01_RDp_ext, ser_reg.DYRA_SER_DATA2.qn_new());
    /* p06.DASO*/ BUS_CPU_Dp_new[3].tri6_pn(_UFEG_FF01_RDp_ext, ser_reg.DOJO_SER_DATA3.qn_new());
    /* p06.DAME*/ BUS_CPU_Dp_new[4].tri6_pn(_UFEG_FF01_RDp_ext, ser_reg.DOVU_SER_DATA4.qn_new());
    /* p06.EVOK*/ BUS_CPU_Dp_new[5].tri6_pn(_UFEG_FF01_RDp_ext, ser_reg.EJAB_SER_DATA5.qn_new());
    /* p06.EFAB*/ BUS_CPU_Dp_new[6].tri6_pn(_UFEG_FF01_RDp_ext, ser_reg.EROD_SER_DATA6.qn_new());
    /*#p06.ETAK*/ BUS_CPU_Dp_new[7].tri6_pn(_UFEG_FF01_RDp_ext, ser_reg.EDER_SER_DATA7.qn_new());

    /* FF02 SER */
    /* p06.CORE*/ BUS_CPU_Dp_new[0].tri6_pn(_UCOM_FF02_RDp_ext, ser_reg.CULY_XFER_DIR.qn_new());
    /* p06.ELUV*/ BUS_CPU_Dp_new[7].tri6_pn(_UCOM_FF02_RDp_ext, ser_reg.ETAF_SER_RUNNING.qn_new());
  }

  {
    ...
    /* p01.TAWU*/ BUS_CPU_Dp_new[0].tri6_pn(_TAGY_FF04_RDp_ext, _UMEK_DIV06n);
    /* p01.TAKU*/ BUS_CPU_Dp_new[1].tri6_pn(_TAGY_FF04_RDp_ext, _UREK_DIV07n);
    /* p01.TEMU*/ BUS_CPU_Dp_new[2].tri6_pn(_TAGY_FF04_RDp_ext, _UTOK_DIV08n);
    /* p01.TUSE*/ BUS_CPU_Dp_new[3].tri6_pn(_TAGY_FF04_RDp_ext, _SAPY_DIV09n);
    /* p01.UPUG*/ BUS_CPU_Dp_new[4].tri6_pn(_TAGY_FF04_RDp_ext, _UMER_DIV10n); // Schematic wrong, UPUG/SEPU driving D5/D4
    /* p01.SEPU*/ BUS_CPU_Dp_new[5].tri6_pn(_TAGY_FF04_RDp_ext, _RAVE_DIV11n);
    /* p01.SAWA*/ BUS_CPU_Dp_new[6].tri6_pn(_TAGY_FF04_RDp_ext, _RYSO_DIV12n);
    /* p01.TATU*/ BUS_CPU_Dp_new[7].tri6_pn(_TAGY_FF04_RDp_ext, _UDOR_DIV13n);
  }

  {
    /* FF05 TIMA */
    /*#p03.SOKU*/ BUS_CPU_Dp_new[0].tri6_pn(_TEDA_FF05_RDp_ext, tim_reg.REGA_TIMA0p.qn_new());
    /*#p03.RACY*/ BUS_CPU_Dp_new[1].tri6_pn(_TEDA_FF05_RDp_ext, tim_reg.POVY_TIMA1p.qn_new());
    /*#p03.RAVY*/ BUS_CPU_Dp_new[2].tri6_pn(_TEDA_FF05_RDp_ext, tim_reg.PERU_TIMA2p.qn_new());
    /*#p03.SOSY*/ BUS_CPU_Dp_new[3].tri6_pn(_TEDA_FF05_RDp_ext, tim_reg.RATE_TIMA3p.qn_new());
    /*#p03.SOMU*/ BUS_CPU_Dp_new[4].tri6_pn(_TEDA_FF05_RDp_ext, tim_reg.RUBY_TIMA4p.qn_new());
    /*#p03.SURO*/ BUS_CPU_Dp_new[5].tri6_pn(_TEDA_FF05_RDp_ext, tim_reg.RAGE_TIMA5p.qn_new());
    /*#p03.ROWU*/ BUS_CPU_Dp_new[6].tri6_pn(_TEDA_FF05_RDp_ext, tim_reg.PEDA_TIMA6p.qn_new());
    /*#p03.PUSO*/ BUS_CPU_Dp_new[7].tri6_pn(_TEDA_FF05_RDp_ext, tim_reg.NUGA_TIMA7p.qn_new());
  }

  {
    /* FF06 TMA */
    /*#p03.SETE*/ BUS_CPU_Dp_new[0].tri6_pn(_TUBY_FF06_RDp_ext, tim_reg.SABU_TMA0p.qn_new());
    /*#p03.PYRE*/ BUS_CPU_Dp_new[1].tri6_pn(_TUBY_FF06_RDp_ext, tim_reg.NYKE_TMA1p.qn_new());
    /*#p03.NOLA*/ BUS_CPU_Dp_new[2].tri6_pn(_TUBY_FF06_RDp_ext, tim_reg.MURU_TMA2p.qn_new());
    /*#p03.SALU*/ BUS_CPU_Dp_new[3].tri6_pn(_TUBY_FF06_RDp_ext, tim_reg.TYVA_TMA3p.qn_new());
    /*#p03.SUPO*/ BUS_CPU_Dp_new[4].tri6_pn(_TUBY_FF06_RDp_ext, tim_reg.TYRU_TMA4p.qn_new());
    /*#p03.SOTU*/ BUS_CPU_Dp_new[5].tri6_pn(_TUBY_FF06_RDp_ext, tim_reg.SUFY_TMA5p.qn_new());
    /*#p03.REVA*/ BUS_CPU_Dp_new[6].tri6_pn(_TUBY_FF06_RDp_ext, tim_reg.PETO_TMA6p.qn_new());
    /*#p03.SAPU*/ BUS_CPU_Dp_new[7].tri6_pn(_TUBY_FF06_RDp_ext, tim_reg.SETA_TMA7p.qn_new());
  }

  {
    /* FF07 TAC */
    /*#p03.RYLA*/ BUS_CPU_Dp_new[0].tri6_pn(_SORA_FF07_RDp_ext, tim_reg.SOPU_TAC0p.qn_new());
    /*#p03.ROTE*/ BUS_CPU_Dp_new[1].tri6_pn(_SORA_FF07_RDp_ext, tim_reg.SAMY_TAC1p.qn_new());
    /*#p03.SUPE*/ BUS_CPU_Dp_new[2].tri6_pn(_SORA_FF07_RDp_ext, tim_reg.SABO_TAC2p.qn_new());
  }

  {
    ...
    /*#p02.NELA*/ BUS_CPU_Dp_new[0].tri6_pn(_POLA_FF0F_RDp_ext, int_reg.MATY_FF0F_L0p.qn_new());
    /*#p02.NABO*/ BUS_CPU_Dp_new[1].tri6_pn(_POLA_FF0F_RDp_ext, int_reg.MOPO_FF0F_L1p.qn_new());
    /*#p02.ROVA*/ BUS_CPU_Dp_new[2].tri6_pn(_POLA_FF0F_RDp_ext, int_reg.PAVY_FF0F_L2p.qn_new());
    /*#p02.PADO*/ BUS_CPU_Dp_new[3].tri6_pn(_POLA_FF0F_RDp_ext, int_reg.NEJY_FF0F_L3p.qn_new());
    /*#p02.PEGY*/ BUS_CPU_Dp_new[4].tri6_pn(_POLA_FF0F_RDp_ext, int_reg.NUTY_FF0F_L4p.qn_new());
  }

  {
    /* FF40 LCDC */
    /*#p23.WYPO*/ BUS_CPU_Dp_new[0].tri6_nn(_WYCE_FF40_RDn_ext, pix_pipe.VYXE_LCDC_BGENn  .qp_new());
    /*#p23.XERO*/ BUS_CPU_Dp_new[1].tri6_nn(_WYCE_FF40_RDn_ext, pix_pipe.XYLO_LCDC_SPENn  .qp_new());
    /* p23.WYJU*/ BUS_CPU_Dp_new[2].tri6_nn(_WYCE_FF40_RDn_ext, pix_pipe.XYMO_LCDC_SPSIZEn.qp_new());
    /* p23.WUKA*/ BUS_CPU_Dp_new[3].tri6_nn(_WYCE_FF40_RDn_ext, pix_pipe.XAFO_LCDC_BGMAPn .qp_new());
    /* p23.VOKE*/ BUS_CPU_Dp_new[4].tri6_nn(_WYCE_FF40_RDn_ext, pix_pipe.WEXU_LCDC_BGTILEn.qp_new());
    /* p23.VATO*/ BUS_CPU_Dp_new[5].tri6_nn(_WYCE_FF40_RDn_ext, pix_pipe.WYMO_LCDC_WINENn .qp_new());
    /*#p23.VAHA*/ BUS_CPU_Dp_new[6].tri6_nn(_WYCE_FF40_RDn_ext, pix_pipe.WOKY_LCDC_WINMAPn.qp_new());
    /*#p23.XEBU*/ BUS_CPU_Dp_new[7].tri6_nn(_WYCE_FF40_RDn_ext, pix_pipe.XONA_LCDC_LCDENn .qp_new());
  }

  {
    /* FF41 STAT */
    // This latch isn't actually used as a latch, it's effectively an inverter.
    /* p21.PAGO*/ wire _PAGO_LYC_MATCH_RST = or2(_WESY_SYS_RSTn_new, _RYJU_FF41_WRn_clk);
    ...
    /*#p21.TEBY*/ BUS_CPU_Dp_new[0].tri6_pn(_TOBE_FF41_RDp_ext, _SADU_STAT_MODE0n);
    /*#p21.WUGA*/ BUS_CPU_Dp_new[1].tri6_pn(_TOBE_FF41_RDp_ext, _XATY_STAT_MODE1n);
    /*#p21.SEGO*/ BUS_CPU_Dp_new[2].tri6_pn(_TOBE_FF41_RDp_ext, pix_pipe.RUPO_LYC_MATCH_LATCHn.qp_new());
    /* p21.PUZO*/ BUS_CPU_Dp_new[3].tri6_nn(_VAVE_FF41_RDn_ext, pix_pipe.ROXE_STAT_HBI_ENn.qp_new());
    /* p21.POFO*/ BUS_CPU_Dp_new[4].tri6_nn(_VAVE_FF41_RDn_ext, pix_pipe.RUFO_STAT_VBI_ENn.qp_new());
    /* p21.SASY*/ BUS_CPU_Dp_new[5].tri6_nn(_VAVE_FF41_RDn_ext, pix_pipe.REFE_STAT_OAI_ENn.qp_new());
    /* p21.POTE*/ BUS_CPU_Dp_new[6].tri6_nn(_VAVE_FF41_RDn_ext, pix_pipe.RUGU_STAT_LYI_ENn.qp_new());
  }

  {
    /* FF42 SCY */
    /*#p23.WARE*/ BUS_CPU_Dp_new[0].tri6_nn(_BUWY_FF42_RDn_ext, pix_pipe.GAVE_SCY0n.qp_new());
    /* p23.GOBA*/ BUS_CPU_Dp_new[1].tri6_nn(_BUWY_FF42_RDn_ext, pix_pipe.FYMO_SCY1n.qp_new());
    /* p23.GONU*/ BUS_CPU_Dp_new[2].tri6_nn(_BUWY_FF42_RDn_ext, pix_pipe.FEZU_SCY2n.qp_new());
    /* p23.GODO*/ BUS_CPU_Dp_new[3].tri6_nn(_BUWY_FF42_RDn_ext, pix_pipe.FUJO_SCY3n.qp_new());
    /* p23.CUSA*/ BUS_CPU_Dp_new[4].tri6_nn(_BUWY_FF42_RDn_ext, pix_pipe.DEDE_SCY4n.qp_new());
    /* p23.GYZO*/ BUS_CPU_Dp_new[5].tri6_nn(_BUWY_FF42_RDn_ext, pix_pipe.FOTY_SCY5n.qp_new());
    /* p23.GUNE*/ BUS_CPU_Dp_new[6].tri6_nn(_BUWY_FF42_RDn_ext, pix_pipe.FOHA_SCY6n.qp_new());
    /* p23.GYZA*/ BUS_CPU_Dp_new[7].tri6_nn(_BUWY_FF42_RDn_ext, pix_pipe.FUNY_SCY7n.qp_new());
  }

  {
    /* FF43 SCX */
    /*#p23.EDOS*/ BUS_CPU_Dp_new[0].tri6_nn(_BEBA_FF43_RDn_ext, pix_pipe.DATY_SCX0n.qp_new());
    /* p23.EKOB*/ BUS_CPU_Dp_new[1].tri6_nn(_BEBA_FF43_RDn_ext, pix_pipe.DUZU_SCX1n.qp_new());
    /* p23.CUGA*/ BUS_CPU_Dp_new[2].tri6_nn(_BEBA_FF43_RDn_ext, pix_pipe.CYXU_SCX2n.qp_new());
    /* p23.WONY*/ BUS_CPU_Dp_new[3].tri6_nn(_BEBA_FF43_RDn_ext, pix_pipe.GUBO_SCX3n.qp_new());
    /* p23.CEDU*/ BUS_CPU_Dp_new[4].tri6_nn(_BEBA_FF43_RDn_ext, pix_pipe.BEMY_SCX4n.qp_new());
    /* p23.CATA*/ BUS_CPU_Dp_new[5].tri6_nn(_BEBA_FF43_RDn_ext, pix_pipe.CUZY_SCX5n.qp_new());
    /* p23.DOXE*/ BUS_CPU_Dp_new[6].tri6_nn(_BEBA_FF43_RDn_ext, pix_pipe.CABU_SCX6n.qp_new());
    /* p23.CASY*/ BUS_CPU_Dp_new[7].tri6_nn(_BEBA_FF43_RDn_ext, pix_pipe.BAKE_SCX7n.qp_new());
  }

  {
    ...
    /* p23.VEGA*/ BUS_CPU_Dp_new[0].tri6_nn(_VARO_FF44_RDn_ext, _WURY_LY0n);
    /* p23.WUVA*/ BUS_CPU_Dp_new[1].tri6_nn(_VARO_FF44_RDn_ext, _XEPO_LY1n);
    /* p23.LYCO*/ BUS_CPU_Dp_new[2].tri6_nn(_VARO_FF44_RDn_ext, _MYFA_LY2n);
    /* p23.WOJY*/ BUS_CPU_Dp_new[3].tri6_nn(_VARO_FF44_RDn_ext, _XUHY_LY3n);
    /* p23.VYNE*/ BUS_CPU_Dp_new[4].tri6_nn(_VARO_FF44_RDn_ext, _WATA_LY4n);
    /* p23.WAMA*/ BUS_CPU_Dp_new[5].tri6_nn(_VARO_FF44_RDn_ext, _XAGA_LY5n);
    /* p23.WAVO*/ BUS_CPU_Dp_new[6].tri6_nn(_VARO_FF44_RDn_ext, _XUCE_LY6n);
    /* p23.WEZE*/ BUS_CPU_Dp_new[7].tri6_nn(_VARO_FF44_RDn_ext, _XOWO_LY7n);
  }

  {
    /* FF45 LYC */
    /*#p23.RETU*/ BUS_CPU_Dp_new[0].tri6_nn(_WEKU_FF45_RDn_ext, lcd_reg.SYRY_LYC0n_s.qp_new());
    /* p23.VOJO*/ BUS_CPU_Dp_new[1].tri6_nn(_WEKU_FF45_RDn_ext, lcd_reg.VUCE_LYC1n_s.qp_new());
    /* p23.RAZU*/ BUS_CPU_Dp_new[2].tri6_nn(_WEKU_FF45_RDn_ext, lcd_reg.SEDY_LYC2n_s.qp_new());
    /* p23.REDY*/ BUS_CPU_Dp_new[3].tri6_nn(_WEKU_FF45_RDn_ext, lcd_reg.SALO_LYC3n_s.qp_new());
    /* p23.RACE*/ BUS_CPU_Dp_new[4].tri6_nn(_WEKU_FF45_RDn_ext, lcd_reg.SOTA_LYC4n_s.qp_new());
    /*#p23.VAZU*/ BUS_CPU_Dp_new[5].tri6_nn(_WEKU_FF45_RDn_ext, lcd_reg.VAFA_LYC5n_s.qp_new());
    /* p23.VAFE*/ BUS_CPU_Dp_new[6].tri6_nn(_WEKU_FF45_RDn_ext, lcd_reg.VEVO_LYC6n_s.qp_new());
    /* p23.PUFY*/ BUS_CPU_Dp_new[7].tri6_nn(_WEKU_FF45_RDn_ext, lcd_reg.RAHA_LYC7n_s.qp_new());
  }

  {
    /* FF46 DMA */
    /*#p04.POLY*/ BUS_CPU_Dp_new[0].tri6_pn(_PUSY_FF46_RDp_ext, dma_reg.NAFA_DMA_A08n.qp_new());
    /* p04.ROFO*/ BUS_CPU_Dp_new[1].tri6_pn(_PUSY_FF46_RDp_ext, dma_reg.PYNE_DMA_A09n.qp_new());
    /* p04.REMA*/ BUS_CPU_Dp_new[2].tri6_pn(_PUSY_FF46_RDp_ext, dma_reg.PARA_DMA_A10n.qp_new());
    /* p04.PANE*/ BUS_CPU_Dp_new[3].tri6_pn(_PUSY_FF46_RDp_ext, dma_reg.NYDO_DMA_A11n.qp_new());
    /* p04.PARE*/ BUS_CPU_Dp_new[4].tri6_pn(_PUSY_FF46_RDp_ext, dma_reg.NYGY_DMA_A12n.qp_new());
    /* p04.RALY*/ BUS_CPU_Dp_new[5].tri6_pn(_PUSY_FF46_RDp_ext, dma_reg.PULA_DMA_A13n.qp_new());
    /* p04.RESU*/ BUS_CPU_Dp_new[6].tri6_pn(_PUSY_FF46_RDp_ext, dma_reg.POKU_DMA_A14n.qp_new());
    /* p04.NUVY*/ BUS_CPU_Dp_new[7].tri6_pn(_PUSY_FF46_RDp_ext, dma_reg.MARU_DMA_A15n.qp_new());
  }

  {
    /* FF47 BGP */
    /*#p36.RARO*/ BUS_CPU_Dp_new[0].tri6_nn(_TEPY_FF47_RDn_ext, pix_pipe.PAVO_BGP_D0n.qp_new());
    /* p36.PABA*/ BUS_CPU_Dp_new[1].tri6_nn(_TEPY_FF47_RDn_ext, pix_pipe.NUSY_BGP_D1n.qp_new());
    /* p36.REDO*/ BUS_CPU_Dp_new[2].tri6_nn(_TEPY_FF47_RDn_ext, pix_pipe.PYLU_BGP_D2n.qp_new());
    /* p36.LOBE*/ BUS_CPU_Dp_new[3].tri6_nn(_TEPY_FF47_RDn_ext, pix_pipe.MAXY_BGP_D3n.qp_new());
    /* p36.LACE*/ BUS_CPU_Dp_new[4].tri6_nn(_TEPY_FF47_RDn_ext, pix_pipe.MUKE_BGP_D4n.qp_new());
    /* p36.LYKA*/ BUS_CPU_Dp_new[5].tri6_nn(_TEPY_FF47_RDn_ext, pix_pipe.MORU_BGP_D5n.qp_new());
    /* p36.LODY*/ BUS_CPU_Dp_new[6].tri6_nn(_TEPY_FF47_RDn_ext, pix_pipe.MOGY_BGP_D6n.qp_new());
    /* p36.LARY*/ BUS_CPU_Dp_new[7].tri6_nn(_TEPY_FF47_RDn_ext, pix_pipe.MENA_BGP_D7n.qp_new());
  }

  {
    /* FF48 OBP0 */
    /*#p36.XARY*/ BUS_CPU_Dp_new[0].tri6_nn(_XOZY_FF48_RDn_ext, pix_pipe.XUFU_OBP0_D0n.qp_new());
    /* p36.XOKE*/ BUS_CPU_Dp_new[1].tri6_nn(_XOZY_FF48_RDn_ext, pix_pipe.XUKY_OBP0_D1n.qp_new());
    /* p36.XUNO*/ BUS_CPU_Dp_new[2].tri6_nn(_XOZY_FF48_RDn_ext, pix_pipe.XOVA_OBP0_D2n.qp_new());
    /* p36.XUBY*/ BUS_CPU_Dp_new[3].tri6_nn(_XOZY_FF48_RDn_ext, pix_pipe.XALO_OBP0_D3n.qp_new());
    /* p36.XAJU*/ BUS_CPU_Dp_new[4].tri6_nn(_XOZY_FF48_RDn_ext, pix_pipe.XERU_OBP0_D4n.qp_new());
    /* p36.XOBO*/ BUS_CPU_Dp_new[5].tri6_nn(_XOZY_FF48_RDn_ext, pix_pipe.XYZE_OBP0_D5n.qp_new());
    /* p36.XAXA*/ BUS_CPU_Dp_new[6].tri6_nn(_XOZY_FF48_RDn_ext, pix_pipe.XUPO_OBP0_D6n.qp_new());
    /* p36.XAWO*/ BUS_CPU_Dp_new[7].tri6_nn(_XOZY_FF48_RDn_ext, pix_pipe.XANA_OBP0_D7n.qp_new());
  }

  {
    /* FF49 OBP1 */
    /*#p36.LAJU*/ BUS_CPU_Dp_new[0].tri6_nn(_LOTE_FF49_RDn_ext, pix_pipe.MOXY_OBP1_D0n.qp_new());
    /* p36.LEPA*/ BUS_CPU_Dp_new[1].tri6_nn(_LOTE_FF49_RDn_ext, pix_pipe.LAWO_OBP1_D1n.qp_new());
    /* p36.LODE*/ BUS_CPU_Dp_new[2].tri6_nn(_LOTE_FF49_RDn_ext, pix_pipe.MOSA_OBP1_D2n.qp_new());
    /* p36.LYZA*/ BUS_CPU_Dp_new[3].tri6_nn(_LOTE_FF49_RDn_ext, pix_pipe.LOSE_OBP1_D3n.qp_new());
    /* p36.LUKY*/ BUS_CPU_Dp_new[4].tri6_nn(_LOTE_FF49_RDn_ext, pix_pipe.LUNE_OBP1_D4n.qp_new());
    /* p36.LUGA*/ BUS_CPU_Dp_new[5].tri6_nn(_LOTE_FF49_RDn_ext, pix_pipe.LUGU_OBP1_D5n.qp_new());
    /* p36.LEBA*/ BUS_CPU_Dp_new[6].tri6_nn(_LOTE_FF49_RDn_ext, pix_pipe.LEPU_OBP1_D6n.qp_new());
    /* p36.LELU*/ BUS_CPU_Dp_new[7].tri6_nn(_LOTE_FF49_RDn_ext, pix_pipe.LUXO_OBP1_D7n.qp_new());
  }

  {
    /* FF4A WY */
    /*#p23.PUNU*/ BUS_CPU_Dp_new[0].tri6_nn(_VOMY_FF4A_RDn_ext, pix_pipe.NESO_WY0n.qp_new());
    /* p23.PODA*/ BUS_CPU_Dp_new[1].tri6_nn(_VOMY_FF4A_RDn_ext, pix_pipe.NYRO_WY1n.qp_new());
    /* p23.PYGU*/ BUS_CPU_Dp_new[2].tri6_nn(_VOMY_FF4A_RDn_ext, pix_pipe.NAGA_WY2n.qp_new());
    /* p23.LOKA*/ BUS_CPU_Dp_new[3].tri6_nn(_VOMY_FF4A_RDn_ext, pix_pipe.MELA_WY3n.qp_new());
    /* p23.MEGA*/ BUS_CPU_Dp_new[4].tri6_nn(_VOMY_FF4A_RDn_ext, pix_pipe.NULO_WY4n.qp_new());
    /* p23.PELA*/ BUS_CPU_Dp_new[5].tri6_nn(_VOMY_FF4A_RDn_ext, pix_pipe.NENE_WY5n.qp_new());
    /* p23.POLO*/ BUS_CPU_Dp_new[6].tri6_nn(_VOMY_FF4A_RDn_ext, pix_pipe.NUKA_WY6n.qp_new());
    /* p23.MERA*/ BUS_CPU_Dp_new[7].tri6_nn(_VOMY_FF4A_RDn_ext, pix_pipe.NAFU_WY7n.qp_new());
  }

  {
    /* FF4B WX */
    /*#p23.LOVA*/ BUS_CPU_Dp_new[0].tri6_nn(_VYCU_FF4B_RDn_ext, pix_pipe.MYPA_WX0n.qp_new());
    /* p23.MUKA*/ BUS_CPU_Dp_new[1].tri6_nn(_VYCU_FF4B_RDn_ext, pix_pipe.NOFE_WX1n.qp_new());
    /* p23.MOKO*/ BUS_CPU_Dp_new[2].tri6_nn(_VYCU_FF4B_RDn_ext, pix_pipe.NOKE_WX2n.qp_new());
    /* p23.LOLE*/ BUS_CPU_Dp_new[3].tri6_nn(_VYCU_FF4B_RDn_ext, pix_pipe.MEBY_WX3n.qp_new());
    /* p23.MELE*/ BUS_CPU_Dp_new[4].tri6_nn(_VYCU_FF4B_RDn_ext, pix_pipe.MYPU_WX4n.qp_new());
    /* p23.MUFE*/ BUS_CPU_Dp_new[5].tri6_nn(_VYCU_FF4B_RDn_ext, pix_pipe.MYCE_WX5n.qp_new());
    /* p23.MULY*/ BUS_CPU_Dp_new[6].tri6_nn(_VYCU_FF4B_RDn_ext, pix_pipe.MUVO_WX6n.qp_new());
    /* p23.MARA*/ BUS_CPU_Dp_new[7].tri6_nn(_VYCU_FF4B_RDn_ext, pix_pipe.NUKU_WX7n.qp_new());
  }

  {
    /* FF50 BOOT */
    /* p07.SYPU*/ BUS_CPU_Dp_new[0].tri6_pn(_TEXE_FF50_RDp_ext, BOOT_BITn.qp_new());
  }

  {
    /* FFFF IE */ // This is technically in the CPU, but we're going to implement it here for now.
    BUS_CPU_Dp_new[0].tri6_nn(FFFF_RDn_ext, IE_D0.qn_new());
    BUS_CPU_Dp_new[1].tri6_nn(FFFF_RDn_ext, IE_D1.qn_new());
    BUS_CPU_Dp_new[2].tri6_nn(FFFF_RDn_ext, IE_D2.qn_new());
    BUS_CPU_Dp_new[3].tri6_nn(FFFF_RDn_ext, IE_D3.qn_new());
    BUS_CPU_Dp_new[4].tri6_nn(FFFF_RDn_ext, IE_D4.qn_new());
  }
  ...
  /* p07.ZYRA*/ wire BOOTROM_A7n    = not1(BUS_CPU_A[ 7]);
    ...
    /* p07.YAZA*/ wire _YAZA_MODE_DBG1n = not1(_UMUT_MODE_DBG1p_ext);
    /* p07.YULA*/ wire _YULA_BOOT_RDp   = and3(_TEDO_CPU_RDp_ext, _YAZA_MODE_DBG1n, _TUTU_ADDR_BOOTp_new); // def AND
    /* p07.ZADO*/ wire _ZADO_BOOT_CSn   = nand2(_YULA_BOOT_RDp, _ZUFA_0000_00FFp_ext);
  ...
  {
    /* p28.MYNU*/ wire _MYNU_CPU_RDn = nand2(_ASOT_CPU_RDp_ext, _CATY_LATCH_EXTp_new);
...

  {
    ...
    if ((cpu_bus_addr >= 0xFF80) && (cpu_bus_addr <= 0xFFFE)) {
      ...
      BUS_CPU_Dp_new[0].tri(_TEDO_CPU_RDp_ext, wire(zero_ram[cpu_bus_addr & 0x007F] & 0x01));
      BUS_CPU_Dp_new[1].tri(_TEDO_CPU_RDp_ext, wire(zero_ram[cpu_bus_addr & 0x007F] & 0x02));
      BUS_CPU_Dp_new[2].tri(_TEDO_CPU_RDp_ext, wire(zero_ram[cpu_bus_addr & 0x007F] & 0x04));
      BUS_CPU_Dp_new[3].tri(_TEDO_CPU_RDp_ext, wire(zero_ram[cpu_bus_addr & 0x007F] & 0x08));
      BUS_CPU_Dp_new[4].tri(_TEDO_CPU_RDp_ext, wire(zero_ram[cpu_bus_addr & 0x007F] & 0x10));
      BUS_CPU_Dp_new[5].tri(_TEDO_CPU_RDp_ext, wire(zero_ram[cpu_bus_addr & 0x007F] & 0x20));
      BUS_CPU_Dp_new[6].tri(_TEDO_CPU_RDp_ext, wire(zero_ram[cpu_bus_addr & 0x007F] & 0x40));
      BUS_CPU_Dp_new[7].tri(_TEDO_CPU_RDp_ext, wire(zero_ram[cpu_bus_addr & 0x007F] & 0x80));
    }
  }
