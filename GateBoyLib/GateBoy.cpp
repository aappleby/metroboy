...
#pragma endregion
  ...
  /*#p29.TOMA*/ wire _TOMA_SFETCH_xBxDxFxH_clk_old = nand2(_LAPE_AxCxExGx_new, _TAME_SFETCH_CLK_GATE_old);
  ...
  /*#p29.TOMA*/ wire _TOMA_SFETCH_xBxDxFxH_clk_new = nand2(_LAPE_AxCxExGx_new, _TAME_SFETCH_CLK_GATE_new);
