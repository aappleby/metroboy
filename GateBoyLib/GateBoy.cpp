...
#pragma endregion
  ...
  */
...

  {
    ...
    /* FF00 JOYP */
    /* p05.KEMA*/ BUS_CPU_D[0].tri6_nn(_BYZO_FF00_RDn_t0, _KEVU_JOYP_L0n_t0);
    /* p05.KURO*/ BUS_CPU_D[1].tri6_nn(_BYZO_FF00_RDn_t0, _KAPA_JOYP_L1n_t0);
    /* p05.KUVE*/ BUS_CPU_D[2].tri6_nn(_BYZO_FF00_RDn_t0, _KEJA_JOYP_L2n_t0);
    /* p05.JEKU*/ BUS_CPU_D[3].tri6_nn(_BYZO_FF00_RDn_t0, _KOLO_JOYP_L3n_t0);
    /* p05.KOCE*/ BUS_CPU_D[4].tri6_nn(_BYZO_FF00_RDn_t0, _KELY_JOYP_UDLRn_t0);
    /* p05.CUDY*/ BUS_CPU_D[5].tri6_nn(_BYZO_FF00_RDn_t0, _COFY_JOYP_ABCSn_t0);
    /* p??.????*/ BUS_CPU_D[6].tri6_nn(_BYZO_FF00_RDn_t0, _KUKO_DBG_FF00_D6n_t0);
    /* p??.????*/ BUS_CPU_D[7].tri6_nn(_BYZO_FF00_RDn_t0, _KERU_DBG_FF00_D7n_t0);
  }
...

  {
    ...
    {
      /* CBD -> VBD */
      /* p25.TEME*/ BUS_VRAM_Dp[0].tri10_np(_RAHU_CBD_TO_VPDn_t2, BUS_CPU_D[0].to_wire());
      /* p25.TEWU*/ BUS_VRAM_Dp[1].tri10_np(_RAHU_CBD_TO_VPDn_t2, BUS_CPU_D[1].to_wire());
      /*#p25.TYGO*/ BUS_VRAM_Dp[2].tri10_np(_RAHU_CBD_TO_VPDn_t2, BUS_CPU_D[2].to_wire());
      /* p25.SOTE*/ BUS_VRAM_Dp[3].tri10_np(_RAHU_CBD_TO_VPDn_t2, BUS_CPU_D[3].to_wire());
      /* p25.SEKE*/ BUS_VRAM_Dp[4].tri10_np(_RAHU_CBD_TO_VPDn_t2, BUS_CPU_D[4].to_wire());
      /* p25.RUJO*/ BUS_VRAM_Dp[5].tri10_np(_RAHU_CBD_TO_VPDn_t2, BUS_CPU_D[5].to_wire());
      /* p25.TOFA*/ BUS_VRAM_Dp[6].tri10_np(_RAHU_CBD_TO_VPDn_t2, BUS_CPU_D[6].to_wire());
      /* p25.SUZA*/ BUS_VRAM_Dp[7].tri10_np(_RAHU_CBD_TO_VPDn_t2, BUS_CPU_D[7].to_wire());
    }
...

  {
    ...
    {
      /* p28.ZAXA*/ BUS_OAM_DAn[0].tri6_nn(_AZUL_CBD_TO_OBDn, BUS_CPU_D[0].to_wire());
      /* p28.ZAKY*/ BUS_OAM_DAn[1].tri6_nn(_AZUL_CBD_TO_OBDn, BUS_CPU_D[1].to_wire());
      /* p28.WULE*/ BUS_OAM_DAn[2].tri6_nn(_AZUL_CBD_TO_OBDn, BUS_CPU_D[2].to_wire());
      /* p28.ZOZO*/ BUS_OAM_DAn[3].tri6_nn(_AZUL_CBD_TO_OBDn, BUS_CPU_D[3].to_wire());
      /* p28.ZUFO*/ BUS_OAM_DAn[4].tri6_nn(_AZUL_CBD_TO_OBDn, BUS_CPU_D[4].to_wire());
      /* p28.ZATO*/ BUS_OAM_DAn[5].tri6_nn(_AZUL_CBD_TO_OBDn, BUS_CPU_D[5].to_wire());
      /* p28.YVUC*/ BUS_OAM_DAn[6].tri6_nn(_AZUL_CBD_TO_OBDn, BUS_CPU_D[6].to_wire());
      /* p28.ZUFE*/ BUS_OAM_DAn[7].tri6_nn(_AZUL_CBD_TO_OBDn, BUS_CPU_D[7].to_wire());

      /* p28.ZAMY*/ BUS_OAM_DBn[0].tri6_nn(_AZUL_CBD_TO_OBDn, BUS_CPU_D[0].to_wire());
      /* p28.ZOPU*/ BUS_OAM_DBn[1].tri6_nn(_AZUL_CBD_TO_OBDn, BUS_CPU_D[1].to_wire());
      /* p28.WYKY*/ BUS_OAM_DBn[2].tri6_nn(_AZUL_CBD_TO_OBDn, BUS_CPU_D[2].to_wire());
      /* p28.ZAJA*/ BUS_OAM_DBn[3].tri6_nn(_AZUL_CBD_TO_OBDn, BUS_CPU_D[3].to_wire());
      /* p28.ZUGA*/ BUS_OAM_DBn[4].tri6_nn(_AZUL_CBD_TO_OBDn, BUS_CPU_D[4].to_wire());
      /* p28.ZUMO*/ BUS_OAM_DBn[5].tri6_nn(_AZUL_CBD_TO_OBDn, BUS_CPU_D[5].to_wire());
      /* p28.XYTO*/ BUS_OAM_DBn[6].tri6_nn(_AZUL_CBD_TO_OBDn, BUS_CPU_D[6].to_wire());
      /* p28.ZYFA*/ BUS_OAM_DBn[7].tri6_nn(_AZUL_CBD_TO_OBDn, BUS_CPU_D[7].to_wire());
  ...
  {
    /* FF01 SER */
    /*#p06.CUGY*/ BUS_CPU_D[0].tri6_pn(_UFEG_FF01_RDp_t0, ser_reg.CUBA_SER_DATA0.qn15_old());
    /* p06.DUDE*/ BUS_CPU_D[1].tri6_pn(_UFEG_FF01_RDp_t0, ser_reg.DEGU_SER_DATA1.qn15_old());
    /* p06.DETU*/ BUS_CPU_D[2].tri6_pn(_UFEG_FF01_RDp_t0, ser_reg.DYRA_SER_DATA2.qn15_old());
    /* p06.DASO*/ BUS_CPU_D[3].tri6_pn(_UFEG_FF01_RDp_t0, ser_reg.DOJO_SER_DATA3.qn15_old());
    /* p06.DAME*/ BUS_CPU_D[4].tri6_pn(_UFEG_FF01_RDp_t0, ser_reg.DOVU_SER_DATA4.qn15_old());
    /* p06.EVOK*/ BUS_CPU_D[5].tri6_pn(_UFEG_FF01_RDp_t0, ser_reg.EJAB_SER_DATA5.qn15_old());
    /* p06.EFAB*/ BUS_CPU_D[6].tri6_pn(_UFEG_FF01_RDp_t0, ser_reg.EROD_SER_DATA6.qn15_old());
    /*#p06.ETAK*/ BUS_CPU_D[7].tri6_pn(_UFEG_FF01_RDp_t0, ser_reg.EDER_SER_DATA7.qn15_old());

    /* FF02 SER */
    /* p06.CORE*/ BUS_CPU_D[0].tri6_pn(_UCOM_FF02_RDp_t0, ser_reg.CULY_XFER_DIR.qn16_old());
    /* p06.ELUV*/ BUS_CPU_D[7].tri6_pn(_UCOM_FF02_RDp_t0, ser_reg.ETAF_SER_RUNNING.qn16_old());

    /* FF04 DIV */
    /* p01.TAWU*/ BUS_CPU_D[0].tri6_pn(_TAGY_FF04_RDp_t0, _UMEK_DIV06n_t0);
    /* p01.TAKU*/ BUS_CPU_D[1].tri6_pn(_TAGY_FF04_RDp_t0, _UREK_DIV07n_t0);
    /* p01.TEMU*/ BUS_CPU_D[2].tri6_pn(_TAGY_FF04_RDp_t0, _UTOK_DIV08n_t0);
    /* p01.TUSE*/ BUS_CPU_D[3].tri6_pn(_TAGY_FF04_RDp_t0, _SAPY_DIV09n_t0);
    /* p01.UPUG*/ BUS_CPU_D[4].tri6_pn(_TAGY_FF04_RDp_t0, _UMER_DIV10n_t0); // Schematic wrong, UPUG/SEPU driving D5/D4
    /* p01.SEPU*/ BUS_CPU_D[5].tri6_pn(_TAGY_FF04_RDp_t0, _RAVE_DIV11n_t0);
    /* p01.SAWA*/ BUS_CPU_D[6].tri6_pn(_TAGY_FF04_RDp_t0, _RYSO_DIV12n_t0);
    /* p01.TATU*/ BUS_CPU_D[7].tri6_pn(_TAGY_FF04_RDp_t0, _UDOR_DIV13n_t0);

    /* FF05 TIMA */
    /*#p03.SOKU*/ BUS_CPU_D[0].tri6_pn(_TEDA_FF05_RDp_t0, tim_reg.REGA_TIMA0p.qn17_old());
    /*#p03.RACY*/ BUS_CPU_D[1].tri6_pn(_TEDA_FF05_RDp_t0, tim_reg.POVY_TIMA1p.qn17_old());
    /*#p03.RAVY*/ BUS_CPU_D[2].tri6_pn(_TEDA_FF05_RDp_t0, tim_reg.PERU_TIMA2p.qn17_old());
    /*#p03.SOSY*/ BUS_CPU_D[3].tri6_pn(_TEDA_FF05_RDp_t0, tim_reg.RATE_TIMA3p.qn17_old());
    /*#p03.SOMU*/ BUS_CPU_D[4].tri6_pn(_TEDA_FF05_RDp_t0, tim_reg.RUBY_TIMA4p.qn17_old());
    /*#p03.SURO*/ BUS_CPU_D[5].tri6_pn(_TEDA_FF05_RDp_t0, tim_reg.RAGE_TIMA5p.qn17_old());
    /*#p03.ROWU*/ BUS_CPU_D[6].tri6_pn(_TEDA_FF05_RDp_t0, tim_reg.PEDA_TIMA6p.qn17_old());
    /*#p03.PUSO*/ BUS_CPU_D[7].tri6_pn(_TEDA_FF05_RDp_t0, tim_reg.NUGA_TIMA7p.qn17_old());

    /* FF06 TMA */
    /*#p03.SETE*/ BUS_CPU_D[0].tri6_pn(_TUBY_FF06_RDp_t0, tim_reg.SABU_TMA0p.qn16_old());
    /*#p03.PYRE*/ BUS_CPU_D[1].tri6_pn(_TUBY_FF06_RDp_t0, tim_reg.NYKE_TMA1p.qn16_old());
    /*#p03.NOLA*/ BUS_CPU_D[2].tri6_pn(_TUBY_FF06_RDp_t0, tim_reg.MURU_TMA2p.qn16_old());
    /*#p03.SALU*/ BUS_CPU_D[3].tri6_pn(_TUBY_FF06_RDp_t0, tim_reg.TYVA_TMA3p.qn16_old());
    /*#p03.SUPO*/ BUS_CPU_D[4].tri6_pn(_TUBY_FF06_RDp_t0, tim_reg.TYRU_TMA4p.qn16_old());
    /*#p03.SOTU*/ BUS_CPU_D[5].tri6_pn(_TUBY_FF06_RDp_t0, tim_reg.SUFY_TMA5p.qn16_old());
    /*#p03.REVA*/ BUS_CPU_D[6].tri6_pn(_TUBY_FF06_RDp_t0, tim_reg.PETO_TMA6p.qn16_old());
    /*#p03.SAPU*/ BUS_CPU_D[7].tri6_pn(_TUBY_FF06_RDp_t0, tim_reg.SETA_TMA7p.qn16_old());

    /* FF07 TAC */
    /*#p03.RYLA*/ BUS_CPU_D[0].tri6_pn(_SORA_FF07_RDp_t0, tim_reg.SOPU_TAC0p.qn16_old());
    /*#p03.ROTE*/ BUS_CPU_D[1].tri6_pn(_SORA_FF07_RDp_t0, tim_reg.SAMY_TAC1p.qn16_old());
    /*#p03.SUPE*/ BUS_CPU_D[2].tri6_pn(_SORA_FF07_RDp_t0, tim_reg.SABO_TAC2p.qn16_old());

    /* FF0F INTF */
    /*#p02.NELA*/ BUS_CPU_D[0].tri6_pn(_POLA_FF0F_RDp_t0, int_reg.MATY_FF0F_L0p.qn10());
    /*#p02.NABO*/ BUS_CPU_D[1].tri6_pn(_POLA_FF0F_RDp_t0, int_reg.MOPO_FF0F_L1p.qn10());
    /*#p02.ROVA*/ BUS_CPU_D[2].tri6_pn(_POLA_FF0F_RDp_t0, int_reg.PAVY_FF0F_L2p.qn10());
    /*#p02.PADO*/ BUS_CPU_D[3].tri6_pn(_POLA_FF0F_RDp_t0, int_reg.NEJY_FF0F_L3p.qn10());
    /*#p02.PEGY*/ BUS_CPU_D[4].tri6_pn(_POLA_FF0F_RDp_t0, int_reg.NUTY_FF0F_L4p.qn10());

    /* FF40 LCDC */
    /*#p23.WYPO*/ BUS_CPU_D[0].tri6_nn(_WYCE_FF40_RDn_t0, _VYXE_LCDC_BGENn_t0);
    /*#p23.XERO*/ BUS_CPU_D[1].tri6_nn(_WYCE_FF40_RDn_t0, _XYLO_LCDC_SPENn_t0);
    /* p23.WYJU*/ BUS_CPU_D[2].tri6_nn(_WYCE_FF40_RDn_t0, _XYMO_LCDC_SPSIZEn_t0);
    /* p23.WUKA*/ BUS_CPU_D[3].tri6_nn(_WYCE_FF40_RDn_t0, _XAFO_LCDC_BGMAPn_t0);
    /* p23.VOKE*/ BUS_CPU_D[4].tri6_nn(_WYCE_FF40_RDn_t0, _WEXU_LCDC_BGTILEn_t0);
    /* p23.VATO*/ BUS_CPU_D[5].tri6_nn(_WYCE_FF40_RDn_t0, _WYMO_LCDC_WINENn_t0);
    /*#p23.VAHA*/ BUS_CPU_D[6].tri6_nn(_WYCE_FF40_RDn_t0, _WOKY_LCDC_WINMAPn_t0);
    /*#p23.XEBU*/ BUS_CPU_D[7].tri6_nn(_WYCE_FF40_RDn_t0, _XONA_LCDC_LCDENn_t0);

    /* FF41 STAT */
    /*#p21.TEBY*/ BUS_CPU_D[0].tri6_pn(_TOBE_FF41_RDp_t0, _SADU_STAT_MODE0n);
    /*#p21.WUGA*/ BUS_CPU_D[1].tri6_pn(_TOBE_FF41_RDp_t0, _XATY_STAT_MODE1n);
    /*#p21.SEGO*/ BUS_CPU_D[2].tri6_pn(_TOBE_FF41_RDp_t0, pix_pipe.RUPO_LYC_MATCH_LATCHn.qp04());
    /* p21.PUZO*/ BUS_CPU_D[3].tri6_nn(_VAVE_FF41_RDn_t0, pix_pipe.ROXE_STAT_HBI_ENn.qp09_old());
    /* p21.POFO*/ BUS_CPU_D[4].tri6_nn(_VAVE_FF41_RDn_t0, pix_pipe.RUFO_STAT_VBI_ENn.qp09_old());
    /* p21.SASY*/ BUS_CPU_D[5].tri6_nn(_VAVE_FF41_RDn_t0, pix_pipe.REFE_STAT_OAI_ENn.qp09_old());
    /* p21.POTE*/ BUS_CPU_D[6].tri6_nn(_VAVE_FF41_RDn_t0, pix_pipe.RUGU_STAT_LYI_ENn.qp09_old());

    /* FF42 SCY */
    /*#p23.WARE*/ BUS_CPU_D[0].tri6_nn(_BUWY_FF42_RDn_t0, pix_pipe.GAVE_SCY0n.qp09_old());
    /* p23.GOBA*/ BUS_CPU_D[1].tri6_nn(_BUWY_FF42_RDn_t0, pix_pipe.FYMO_SCY1n.qp09_old());
    /* p23.GONU*/ BUS_CPU_D[2].tri6_nn(_BUWY_FF42_RDn_t0, pix_pipe.FEZU_SCY2n.qp09_old());
    /* p23.GODO*/ BUS_CPU_D[3].tri6_nn(_BUWY_FF42_RDn_t0, pix_pipe.FUJO_SCY3n.qp09_old());
    /* p23.CUSA*/ BUS_CPU_D[4].tri6_nn(_BUWY_FF42_RDn_t0, pix_pipe.DEDE_SCY4n.qp09_old());
    /* p23.GYZO*/ BUS_CPU_D[5].tri6_nn(_BUWY_FF42_RDn_t0, pix_pipe.FOTY_SCY5n.qp09_old());
    /* p23.GUNE*/ BUS_CPU_D[6].tri6_nn(_BUWY_FF42_RDn_t0, pix_pipe.FOHA_SCY6n.qp09_old());
    /* p23.GYZA*/ BUS_CPU_D[7].tri6_nn(_BUWY_FF42_RDn_t0, pix_pipe.FUNY_SCY7n.qp09_old());

    /* FF43 SCX */
    /*#p23.EDOS*/ BUS_CPU_D[0].tri6_nn(_BEBA_FF43_RDn_t0, pix_pipe.DATY_SCX0n.qp09_old());
    /* p23.EKOB*/ BUS_CPU_D[1].tri6_nn(_BEBA_FF43_RDn_t0, pix_pipe.DUZU_SCX1n.qp09_old());
    /* p23.CUGA*/ BUS_CPU_D[2].tri6_nn(_BEBA_FF43_RDn_t0, pix_pipe.CYXU_SCX2n.qp09_old());
    /* p23.WONY*/ BUS_CPU_D[3].tri6_nn(_BEBA_FF43_RDn_t0, pix_pipe.GUBO_SCX3n.qp09_old());
    /* p23.CEDU*/ BUS_CPU_D[4].tri6_nn(_BEBA_FF43_RDn_t0, pix_pipe.BEMY_SCX4n.qp09_old());
    /* p23.CATA*/ BUS_CPU_D[5].tri6_nn(_BEBA_FF43_RDn_t0, pix_pipe.CUZY_SCX5n.qp09_old());
    /* p23.DOXE*/ BUS_CPU_D[6].tri6_nn(_BEBA_FF43_RDn_t0, pix_pipe.CABU_SCX6n.qp09_old());
    /* p23.CASY*/ BUS_CPU_D[7].tri6_nn(_BEBA_FF43_RDn_t0, pix_pipe.BAKE_SCX7n.qp09_old());

    /* FF44 LY */
    /* p23.VEGA*/ BUS_CPU_D[0].tri6_nn(_VARO_FF44_RDn_t0, _WURY_LY0n_t0);
    /* p23.WUVA*/ BUS_CPU_D[1].tri6_nn(_VARO_FF44_RDn_t0, _XEPO_LY1n_t0);
    /* p23.LYCO*/ BUS_CPU_D[2].tri6_nn(_VARO_FF44_RDn_t0, _MYFA_LY2n_t0);
    /* p23.WOJY*/ BUS_CPU_D[3].tri6_nn(_VARO_FF44_RDn_t0, _XUHY_LY3n_t0);
    /* p23.VYNE*/ BUS_CPU_D[4].tri6_nn(_VARO_FF44_RDn_t0, _WATA_LY4n_t0);
    /* p23.WAMA*/ BUS_CPU_D[5].tri6_nn(_VARO_FF44_RDn_t0, _XAGA_LY5n_t0);
    /* p23.WAVO*/ BUS_CPU_D[6].tri6_nn(_VARO_FF44_RDn_t0, _XUCE_LY6n_t0);
    /* p23.WEZE*/ BUS_CPU_D[7].tri6_nn(_VARO_FF44_RDn_t0, _XOWO_LY7n_t0);

    /* FF45 LYC */
    /*#p23.RETU*/ BUS_CPU_D[0].tri6_nn(_WEKU_FF45_RDn_t0, lcd_reg.SYRY_LYC0n.qp09_old());
    /* p23.VOJO*/ BUS_CPU_D[1].tri6_nn(_WEKU_FF45_RDn_t0, lcd_reg.VUCE_LYC1n.qp09_old());
    /* p23.RAZU*/ BUS_CPU_D[2].tri6_nn(_WEKU_FF45_RDn_t0, lcd_reg.SEDY_LYC2n.qp09_old());
    /* p23.REDY*/ BUS_CPU_D[3].tri6_nn(_WEKU_FF45_RDn_t0, lcd_reg.SALO_LYC3n.qp09_old());
    /* p23.RACE*/ BUS_CPU_D[4].tri6_nn(_WEKU_FF45_RDn_t0, lcd_reg.SOTA_LYC4n.qp09_old());
    /*#p23.VAZU*/ BUS_CPU_D[5].tri6_nn(_WEKU_FF45_RDn_t0, lcd_reg.VAFA_LYC5n.qp09_old());
    /* p23.VAFE*/ BUS_CPU_D[6].tri6_nn(_WEKU_FF45_RDn_t0, lcd_reg.VEVO_LYC6n.qp09_old());
    /* p23.PUFY*/ BUS_CPU_D[7].tri6_nn(_WEKU_FF45_RDn_t0, lcd_reg.RAHA_LYC7n.qp09_old());

    /* FF46 DMA */
    /*#p04.POLY*/ BUS_CPU_D[0].tri6_pn(_PUSY_FF46_RDp_t0, dma_reg.NAFA_DMA_A08n.qp08_old());
    /* p04.ROFO*/ BUS_CPU_D[1].tri6_pn(_PUSY_FF46_RDp_t0, dma_reg.PYNE_DMA_A09n.qp08_old());
    /* p04.REMA*/ BUS_CPU_D[2].tri6_pn(_PUSY_FF46_RDp_t0, dma_reg.PARA_DMA_A10n.qp08_old());
    /* p04.PANE*/ BUS_CPU_D[3].tri6_pn(_PUSY_FF46_RDp_t0, dma_reg.NYDO_DMA_A11n.qp08_old());
    /* p04.PARE*/ BUS_CPU_D[4].tri6_pn(_PUSY_FF46_RDp_t0, dma_reg.NYGY_DMA_A12n.qp08_old());
    /* p04.RALY*/ BUS_CPU_D[5].tri6_pn(_PUSY_FF46_RDp_t0, dma_reg.PULA_DMA_A13n.qp08_old());
    /* p04.RESU*/ BUS_CPU_D[6].tri6_pn(_PUSY_FF46_RDp_t0, dma_reg.POKU_DMA_A14n.qp08_old());
    /* p04.NUVY*/ BUS_CPU_D[7].tri6_pn(_PUSY_FF46_RDp_t0, dma_reg.MARU_DMA_A15n.qp08_old());

    /* FF47 BGP */
    /*#p36.RARO*/ BUS_CPU_D[0].tri6_nn(_TEPY_FF47_RDn_t0, pix_pipe.PAVO_BGP_D0n.qp08_old());
    /* p36.PABA*/ BUS_CPU_D[1].tri6_nn(_TEPY_FF47_RDn_t0, pix_pipe.NUSY_BGP_D1n.qp08_old());
    /* p36.REDO*/ BUS_CPU_D[2].tri6_nn(_TEPY_FF47_RDn_t0, pix_pipe.PYLU_BGP_D2n.qp08_old());
    /* p36.LOBE*/ BUS_CPU_D[3].tri6_nn(_TEPY_FF47_RDn_t0, pix_pipe.MAXY_BGP_D3n.qp08_old());
    /* p36.LACE*/ BUS_CPU_D[4].tri6_nn(_TEPY_FF47_RDn_t0, pix_pipe.MUKE_BGP_D4n.qp08_old());
    /* p36.LYKA*/ BUS_CPU_D[5].tri6_nn(_TEPY_FF47_RDn_t0, pix_pipe.MORU_BGP_D5n.qp08_old());
    /* p36.LODY*/ BUS_CPU_D[6].tri6_nn(_TEPY_FF47_RDn_t0, pix_pipe.MOGY_BGP_D6n.qp08_old());
    /* p36.LARY*/ BUS_CPU_D[7].tri6_nn(_TEPY_FF47_RDn_t0, pix_pipe.MENA_BGP_D7n.qp08_old());

    /* FF48 OBP0 */
    /*#p36.XARY*/ BUS_CPU_D[0].tri6_nn(_XOZY_FF48_RDn_t0, pix_pipe.XUFU_OBP0_D0n.qp08_old());
    /* p36.XOKE*/ BUS_CPU_D[1].tri6_nn(_XOZY_FF48_RDn_t0, pix_pipe.XUKY_OBP0_D1n.qp08_old());
    /* p36.XUNO*/ BUS_CPU_D[2].tri6_nn(_XOZY_FF48_RDn_t0, pix_pipe.XOVA_OBP0_D2n.qp08_old());
    /* p36.XUBY*/ BUS_CPU_D[3].tri6_nn(_XOZY_FF48_RDn_t0, pix_pipe.XALO_OBP0_D3n.qp08_old());
    /* p36.XAJU*/ BUS_CPU_D[4].tri6_nn(_XOZY_FF48_RDn_t0, pix_pipe.XERU_OBP0_D4n.qp08_old());
    /* p36.XOBO*/ BUS_CPU_D[5].tri6_nn(_XOZY_FF48_RDn_t0, pix_pipe.XYZE_OBP0_D5n.qp08_old());
    /* p36.XAXA*/ BUS_CPU_D[6].tri6_nn(_XOZY_FF48_RDn_t0, pix_pipe.XUPO_OBP0_D6n.qp08_old());
    /* p36.XAWO*/ BUS_CPU_D[7].tri6_nn(_XOZY_FF48_RDn_t0, pix_pipe.XANA_OBP0_D7n.qp08_old());

    /* FF49 OBP1 */
    /*#p36.LAJU*/ BUS_CPU_D[0].tri6_nn(_LOTE_FF49_RDn_t0, pix_pipe.MOXY_OBP1_D0n.qp08_old());
    /* p36.LEPA*/ BUS_CPU_D[1].tri6_nn(_LOTE_FF49_RDn_t0, pix_pipe.LAWO_OBP1_D1n.qp08_old());
    /* p36.LODE*/ BUS_CPU_D[2].tri6_nn(_LOTE_FF49_RDn_t0, pix_pipe.MOSA_OBP1_D2n.qp08_old());
    /* p36.LYZA*/ BUS_CPU_D[3].tri6_nn(_LOTE_FF49_RDn_t0, pix_pipe.LOSE_OBP1_D3n.qp08_old());
    /* p36.LUKY*/ BUS_CPU_D[4].tri6_nn(_LOTE_FF49_RDn_t0, pix_pipe.LUNE_OBP1_D4n.qp08_old());
    /* p36.LUGA*/ BUS_CPU_D[5].tri6_nn(_LOTE_FF49_RDn_t0, pix_pipe.LUGU_OBP1_D5n.qp08_old());
    /* p36.LEBA*/ BUS_CPU_D[6].tri6_nn(_LOTE_FF49_RDn_t0, pix_pipe.LEPU_OBP1_D6n.qp08_old());
    /* p36.LELU*/ BUS_CPU_D[7].tri6_nn(_LOTE_FF49_RDn_t0, pix_pipe.LUXO_OBP1_D7n.qp08_old());

    /* FF4A WY */
    /*#p23.PUNU*/ BUS_CPU_D[0].tri6_nn(_VOMY_FF4A_RDn_t0, _NESO_WY0n_t0);
    /* p23.PODA*/ BUS_CPU_D[1].tri6_nn(_VOMY_FF4A_RDn_t0, _NYRO_WY1n_t0);
    /* p23.PYGU*/ BUS_CPU_D[2].tri6_nn(_VOMY_FF4A_RDn_t0, _NAGA_WY2n_t0);
    /* p23.LOKA*/ BUS_CPU_D[3].tri6_nn(_VOMY_FF4A_RDn_t0, _MELA_WY3n_t0);
    /* p23.MEGA*/ BUS_CPU_D[4].tri6_nn(_VOMY_FF4A_RDn_t0, _NULO_WY4n_t0);
    /* p23.PELA*/ BUS_CPU_D[5].tri6_nn(_VOMY_FF4A_RDn_t0, _NENE_WY5n_t0);
    /* p23.POLO*/ BUS_CPU_D[6].tri6_nn(_VOMY_FF4A_RDn_t0, _NUKA_WY6n_t0);
    /* p23.MERA*/ BUS_CPU_D[7].tri6_nn(_VOMY_FF4A_RDn_t0, _NAFU_WY7n_t0);

    /* FF4B WX */
    /*#p23.LOVA*/ BUS_CPU_D[0].tri6_nn(_VYCU_FF4B_RDn_t0, _MYPA_WX0n_t0);
    /* p23.MUKA*/ BUS_CPU_D[1].tri6_nn(_VYCU_FF4B_RDn_t0, _NOFE_WX1n_t0);
    /* p23.MOKO*/ BUS_CPU_D[2].tri6_nn(_VYCU_FF4B_RDn_t0, _NOKE_WX2n_t0);
    /* p23.LOLE*/ BUS_CPU_D[3].tri6_nn(_VYCU_FF4B_RDn_t0, _MEBY_WX3n_t0);
    /* p23.MELE*/ BUS_CPU_D[4].tri6_nn(_VYCU_FF4B_RDn_t0, _MYPU_WX4n_t0);
    /* p23.MUFE*/ BUS_CPU_D[5].tri6_nn(_VYCU_FF4B_RDn_t0, _MYCE_WX5n_t0);
    /* p23.MULY*/ BUS_CPU_D[6].tri6_nn(_VYCU_FF4B_RDn_t0, _MUVO_WX6n_t0);
    /* p23.MARA*/ BUS_CPU_D[7].tri6_nn(_VYCU_FF4B_RDn_t0, _NUKU_WX7n_t0);
    ...
    if ((cpu_bus_addr >= 0xFF80) && (cpu_bus_addr <= 0xFFFE)) {
      if (_TAPU_CPU_WRp_xxxxEFGx_t1) {
        zero_ram[cpu_bus_addr & 0x007F] = pack_u8(8, &BUS_CPU_D[0]);
      }

      BUS_CPU_D[0].tri(_TEDO_CPU_RDp_t0, wire(zero_ram[cpu_bus_addr & 0x007F] & 0x01));
      BUS_CPU_D[1].tri(_TEDO_CPU_RDp_t0, wire(zero_ram[cpu_bus_addr & 0x007F] & 0x02));
      BUS_CPU_D[2].tri(_TEDO_CPU_RDp_t0, wire(zero_ram[cpu_bus_addr & 0x007F] & 0x04));
      BUS_CPU_D[3].tri(_TEDO_CPU_RDp_t0, wire(zero_ram[cpu_bus_addr & 0x007F] & 0x08));
      BUS_CPU_D[4].tri(_TEDO_CPU_RDp_t0, wire(zero_ram[cpu_bus_addr & 0x007F] & 0x10));
      BUS_CPU_D[5].tri(_TEDO_CPU_RDp_t0, wire(zero_ram[cpu_bus_addr & 0x007F] & 0x20));
      BUS_CPU_D[6].tri(_TEDO_CPU_RDp_t0, wire(zero_ram[cpu_bus_addr & 0x007F] & 0x40));
      BUS_CPU_D[7].tri(_TEDO_CPU_RDp_t0, wire(zero_ram[cpu_bus_addr & 0x007F] & 0x80));
    }
  }
...

  {
    ...
    // FF06 TMA
    /* p03.SABU*/ tim_reg.SABU_TMA0p.dff17_ff(_TYJU_FF06_WRn_t1, BUS_CPU_D[0].to_wire());
    /* p03.NYKE*/ tim_reg.NYKE_TMA1p.dff17_ff(_TYJU_FF06_WRn_t1, BUS_CPU_D[1].to_wire());
    /* p03.MURU*/ tim_reg.MURU_TMA2p.dff17_ff(_TYJU_FF06_WRn_t1, BUS_CPU_D[2].to_wire());
    /* p03.TYVA*/ tim_reg.TYVA_TMA3p.dff17_ff(_TYJU_FF06_WRn_t1, BUS_CPU_D[3].to_wire());
    /* p03.TYRU*/ tim_reg.TYRU_TMA4p.dff17_ff(_TYJU_FF06_WRn_t1, BUS_CPU_D[4].to_wire());
    /* p03.SUFY*/ tim_reg.SUFY_TMA5p.dff17_ff(_TYJU_FF06_WRn_t1, BUS_CPU_D[5].to_wire());
    /* p03.PETO*/ tim_reg.PETO_TMA6p.dff17_ff(_TYJU_FF06_WRn_t1, BUS_CPU_D[6].to_wire());
    /* p03.SETA*/ tim_reg.SETA_TMA7p.dff17_ff(_TYJU_FF06_WRn_t1, BUS_CPU_D[7].to_wire());

    // FF07 TAC
    /* p03.SOPU*/ tim_reg.SOPU_TAC0p.dff17_ff(_SARA_FF07_WRn_t1, BUS_CPU_D[0].to_wire());
    /* p03.SAMY*/ tim_reg.SAMY_TAC1p.dff17_ff(_SARA_FF07_WRn_t1, BUS_CPU_D[1].to_wire());
    /* p03.SABO*/ tim_reg.SABO_TAC2p.dff17_ff(_SARA_FF07_WRn_t1, BUS_CPU_D[2].to_wire());
  }
...

  {
    ...
    /*#p03.ROKE*/ wire _ROKE_TIMA_D0 = mux2n(_TOPE_FF05_WRn_t1, tim_reg.SABU_TMA0p.qp17_new(), BUS_CPU_D[0]);
    /*#p03.PETU*/ wire _PETU_TIMA_D1 = mux2n(_TOPE_FF05_WRn_t1, tim_reg.NYKE_TMA1p.qp17_new(), BUS_CPU_D[1]);
    /*#p03.NYKU*/ wire _NYKU_TIMA_D2 = mux2n(_TOPE_FF05_WRn_t1, tim_reg.MURU_TMA2p.qp17_new(), BUS_CPU_D[2]);
    /*#p03.SOCE*/ wire _SOCE_TIMA_D3 = mux2n(_TOPE_FF05_WRn_t1, tim_reg.TYVA_TMA3p.qp17_new(), BUS_CPU_D[3]);
    /*#p03.SALA*/ wire _SALA_TIMA_D4 = mux2n(_TOPE_FF05_WRn_t1, tim_reg.TYRU_TMA4p.qp17_new(), BUS_CPU_D[4]);
    /*#p03.SYRU*/ wire _SYRU_TIMA_D5 = mux2n(_TOPE_FF05_WRn_t1, tim_reg.SUFY_TMA5p.qp17_new(), BUS_CPU_D[5]);
    /*#p03.REFU*/ wire _REFU_TIMA_D6 = mux2n(_TOPE_FF05_WRn_t1, tim_reg.PETO_TMA6p.qp17_new(), BUS_CPU_D[6]);
    /*#p03.RATO*/ wire _RATO_TIMA_D7 = mux2n(_TOPE_FF05_WRn_t1, tim_reg.SETA_TMA7p.qp17_new(), BUS_CPU_D[7]);
...

  {
    ...
    /* p02.MYZU*/ wire _MYZU_FF0F_SET0n_t1 = nand3(_ROTU_FF0F_WRp_t1, _LETY_INT_VBL_ACKn_t0,  BUS_CPU_D[0]);
    /* p02.MODY*/ wire _MODY_FF0F_SET1n_t1 = nand3(_ROTU_FF0F_WRp_t1, _LEJA_INT_STAT_ACKn_t0, BUS_CPU_D[1]);
    /* p02.PYHU*/ wire _PYHU_FF0F_SET2n_t1 = nand3(_ROTU_FF0F_WRp_t1, _LESA_INT_TIM_ACKn_t0,  BUS_CPU_D[2]);
    /* p02.TOME*/ wire _TOME_FF0F_SET3n_t1 = nand3(_ROTU_FF0F_WRp_t1, _LUFE_INT_SER_ACKn_t0,  BUS_CPU_D[3]);
    /* p02.TOGA*/ wire _TOGA_FF0F_SET4n_t1 = nand3(_ROTU_FF0F_WRp_t1, _LAMO_INT_JOY_ACKn_t0,  BUS_CPU_D[4]);

    /*#p02.MUXE*/ wire _MUXE_INT0_WRn_t1 = or2(BUS_CPU_D[0], _REFA_FF0F_WRn_t1);
    /* p02.NABE*/ wire _NABE_INT1_WRn_t1 = or2(BUS_CPU_D[1], _REFA_FF0F_WRn_t1);
    /* p02.RAKE*/ wire _RAKE_INT2_WRn_t1 = or2(BUS_CPU_D[2], _REFA_FF0F_WRn_t1);
    /* p02.SULO*/ wire _SULO_INT3_WRn_t1 = or2(BUS_CPU_D[3], _REFA_FF0F_WRn_t1);
    /* p02.SEME*/ wire _SEME_INT4_WRn_t1 = or2(BUS_CPU_D[4], _REFA_FF0F_WRn_t1);
...

  {
    ...
    /* p06.COHY*/ wire _COHY_SER_DATA0_RSTn = or_and3(_URYS_FF01_WRn, BUS_CPU_D[0], _ALUR_SYS_RSTn_t0);
    /* p06.DUMO*/ wire _DUMO_SER_DATA1_RSTn = or_and3(_URYS_FF01_WRn, BUS_CPU_D[1], _ALUR_SYS_RSTn_t0);
    /* p06.DYBO*/ wire _DYBO_SER_DATA2_RSTn = or_and3(_URYS_FF01_WRn, BUS_CPU_D[2], _ALUR_SYS_RSTn_t0);
    /* p06.DAJU*/ wire _DAJU_SER_DATA3_RSTn = or_and3(_URYS_FF01_WRn, BUS_CPU_D[3], _ALUR_SYS_RSTn_t0);
    /* p06.DYLY*/ wire _DYLY_SER_DATA4_RSTn = or_and3(_URYS_FF01_WRn, BUS_CPU_D[4], _ALUR_SYS_RSTn_t0);
    /* p06.EHUJ*/ wire _EHUJ_SER_DATA5_RSTn = or_and3(_URYS_FF01_WRn, BUS_CPU_D[5], _ALUR_SYS_RSTn_t0);
    /* p06.EFAK*/ wire _EFAK_SER_DATA6_RSTn = or_and3(_URYS_FF01_WRn, BUS_CPU_D[6], _ALUR_SYS_RSTn_t0);
    /* p06.EGUV*/ wire _EGUV_SER_DATA7_RSTn = or_and3(_URYS_FF01_WRn, BUS_CPU_D[7], _ALUR_SYS_RSTn_t0);
...

  {
    ...
    /* p05.JUTE*/ joypad.JUTE_JOYP_RA     .dff17_ff(_ATOZ_FF00_WRn_t1, BUS_CPU_D[0].to_wire());
    /* p05.KECY*/ joypad.KECY_JOYP_LB     .dff17_ff(_ATOZ_FF00_WRn_t1, BUS_CPU_D[1].to_wire());
    /* p05.JALE*/ joypad.JALE_JOYP_UC     .dff17_ff(_ATOZ_FF00_WRn_t1, BUS_CPU_D[2].to_wire());
    /* p05.KYME*/ joypad.KYME_JOYP_DS     .dff17_ff(_ATOZ_FF00_WRn_t1, BUS_CPU_D[3].to_wire());
    /* p05.KELY*/ joypad.KELY_JOYP_UDLRp  .dff17_ff(_ATOZ_FF00_WRn_t1, BUS_CPU_D[4].to_wire());
    /* p05.COFY*/ joypad.COFY_JOYP_ABCSp  .dff17_ff(_ATOZ_FF00_WRn_t1, BUS_CPU_D[5].to_wire());
    /* p05.KUKO*/ joypad.KUKO_DBG_FF00_D6n.dff17_ff(_ATOZ_FF00_WRn_t1, BUS_CPU_D[6].to_wire());
    /* p05.KERU*/ joypad.KERU_DBG_FF00_D7n.dff17_ff(_ATOZ_FF00_WRn_t1, BUS_CPU_D[7].to_wire());
...

  {
...

    {
      ...
      /*#p04.NAFA*/ dma_reg.NAFA_DMA_A08n.dff8p_ff(_LORU_FF46_WRn, BUS_CPU_D[0].to_wire()); // BOTH OUTPUTS USED
      /* p04.PYNE*/ dma_reg.PYNE_DMA_A09n.dff8p_ff(_LORU_FF46_WRn, BUS_CPU_D[1].to_wire());
      /* p04.PARA*/ dma_reg.PARA_DMA_A10n.dff8p_ff(_LORU_FF46_WRn, BUS_CPU_D[2].to_wire());
      /* p04.NYDO*/ dma_reg.NYDO_DMA_A11n.dff8p_ff(_LORU_FF46_WRn, BUS_CPU_D[3].to_wire());
      /* p04.NYGY*/ dma_reg.NYGY_DMA_A12n.dff8p_ff(_LORU_FF46_WRn, BUS_CPU_D[4].to_wire());
      /* p04.PULA*/ dma_reg.PULA_DMA_A13n.dff8p_ff(_LORU_FF46_WRn, BUS_CPU_D[5].to_wire());
      /* p04.POKU*/ dma_reg.POKU_DMA_A14n.dff8p_ff(_LORU_FF46_WRn, BUS_CPU_D[6].to_wire());
      /* p04.MARU*/ dma_reg.MARU_DMA_A15n.dff8p_ff(_LORU_FF46_WRn, BUS_CPU_D[7].to_wire());
    }
  }
...

  {
    ...
    /* p21.ROXE*/ pix_pipe.ROXE_STAT_HBI_ENn.dff9_ff(_RYVE_FF41_WRn_t1, BUS_CPU_D[3].to_wire());
    /* p21.RUFO*/ pix_pipe.RUFO_STAT_VBI_ENn.dff9_ff(_RYVE_FF41_WRn_t1, BUS_CPU_D[4].to_wire());
    /* p21.REFE*/ pix_pipe.REFE_STAT_OAI_ENn.dff9_ff(_RYVE_FF41_WRn_t1, BUS_CPU_D[5].to_wire());
    /* p21.RUGU*/ pix_pipe.RUGU_STAT_LYI_ENn.dff9_ff(_RYVE_FF41_WRn_t1, BUS_CPU_D[6].to_wire());
...

  {
    ...
    /* p23.GAVE*/ pix_pipe.GAVE_SCY0n.dff9_ff(_CAVO_FF42_WRn_t1, BUS_CPU_D[0].to_wire());
    /* p23.FYMO*/ pix_pipe.FYMO_SCY1n.dff9_ff(_CAVO_FF42_WRn_t1, BUS_CPU_D[1].to_wire());
    /* p23.FEZU*/ pix_pipe.FEZU_SCY2n.dff9_ff(_CAVO_FF42_WRn_t1, BUS_CPU_D[2].to_wire());
    /* p23.FUJO*/ pix_pipe.FUJO_SCY3n.dff9_ff(_CAVO_FF42_WRn_t1, BUS_CPU_D[3].to_wire());
    /* p23.DEDE*/ pix_pipe.DEDE_SCY4n.dff9_ff(_CAVO_FF42_WRn_t1, BUS_CPU_D[4].to_wire());
    /* p23.FOTY*/ pix_pipe.FOTY_SCY5n.dff9_ff(_CAVO_FF42_WRn_t1, BUS_CPU_D[5].to_wire());
    /* p23.FOHA*/ pix_pipe.FOHA_SCY6n.dff9_ff(_CAVO_FF42_WRn_t1, BUS_CPU_D[6].to_wire());
    /* p23.FUNY*/ pix_pipe.FUNY_SCY7n.dff9_ff(_CAVO_FF42_WRn_t1, BUS_CPU_D[7].to_wire());
...

  {
    ...
    /* p23.DATY*/ pix_pipe.DATY_SCX0n.dff9_ff(_AMUN_FF43_WRn_t1, BUS_CPU_D[0].to_wire());
    /* p23.DUZU*/ pix_pipe.DUZU_SCX1n.dff9_ff(_AMUN_FF43_WRn_t1, BUS_CPU_D[1].to_wire());
    /* p23.CYXU*/ pix_pipe.CYXU_SCX2n.dff9_ff(_AMUN_FF43_WRn_t1, BUS_CPU_D[2].to_wire());
    /* p23.GUBO*/ pix_pipe.GUBO_SCX3n.dff9_ff(_AMUN_FF43_WRn_t1, BUS_CPU_D[3].to_wire());
    /* p23.BEMY*/ pix_pipe.BEMY_SCX4n.dff9_ff(_AMUN_FF43_WRn_t1, BUS_CPU_D[4].to_wire());
    /* p23.CUZY*/ pix_pipe.CUZY_SCX5n.dff9_ff(_AMUN_FF43_WRn_t1, BUS_CPU_D[5].to_wire());
    /* p23.CABU*/ pix_pipe.CABU_SCX6n.dff9_ff(_AMUN_FF43_WRn_t1, BUS_CPU_D[6].to_wire());
    /* p23.BAKE*/ pix_pipe.BAKE_SCX7n.dff9_ff(_AMUN_FF43_WRn_t1, BUS_CPU_D[7].to_wire());
...

  {
    ...
    /*#p36.PAVO*/ pix_pipe.PAVO_BGP_D0n.dff8p_ff(_TEPO_FF47_WRp_t1, BUS_CPU_D[0].to_wire());
    /* p36.NUSY*/ pix_pipe.NUSY_BGP_D1n.dff8p_ff(_TEPO_FF47_WRp_t1, BUS_CPU_D[1].to_wire());
    /* p36.PYLU*/ pix_pipe.PYLU_BGP_D2n.dff8p_ff(_TEPO_FF47_WRp_t1, BUS_CPU_D[2].to_wire());
    /* p36.MAXY*/ pix_pipe.MAXY_BGP_D3n.dff8p_ff(_TEPO_FF47_WRp_t1, BUS_CPU_D[3].to_wire());
    /* p36.MUKE*/ pix_pipe.MUKE_BGP_D4n.dff8p_ff(_TEPO_FF47_WRp_t1, BUS_CPU_D[4].to_wire());
    /* p36.MORU*/ pix_pipe.MORU_BGP_D5n.dff8p_ff(_TEPO_FF47_WRp_t1, BUS_CPU_D[5].to_wire());
    /* p36.MOGY*/ pix_pipe.MOGY_BGP_D6n.dff8p_ff(_TEPO_FF47_WRp_t1, BUS_CPU_D[6].to_wire());
    /* p36.MENA*/ pix_pipe.MENA_BGP_D7n.dff8p_ff(_TEPO_FF47_WRp_t1, BUS_CPU_D[7].to_wire());
  }
...

  {
    ...
    /* p36.XUFU*/ pix_pipe.XUFU_OBP0_D0n.dff8p_ff(_XELO_FF48_WRn_t1, BUS_CPU_D[0].to_wire());
    /* p36.XUKY*/ pix_pipe.XUKY_OBP0_D1n.dff8p_ff(_XELO_FF48_WRn_t1, BUS_CPU_D[1].to_wire());
    /* p36.XOVA*/ pix_pipe.XOVA_OBP0_D2n.dff8p_ff(_XELO_FF48_WRn_t1, BUS_CPU_D[2].to_wire());
    /* p36.XALO*/ pix_pipe.XALO_OBP0_D3n.dff8p_ff(_XELO_FF48_WRn_t1, BUS_CPU_D[3].to_wire());
    /* p36.XERU*/ pix_pipe.XERU_OBP0_D4n.dff8p_ff(_XELO_FF48_WRn_t1, BUS_CPU_D[4].to_wire());
    /* p36.XYZE*/ pix_pipe.XYZE_OBP0_D5n.dff8p_ff(_XELO_FF48_WRn_t1, BUS_CPU_D[5].to_wire());
    /* p36.XUPO*/ pix_pipe.XUPO_OBP0_D6n.dff8p_ff(_XELO_FF48_WRn_t1, BUS_CPU_D[6].to_wire());
    /* p36.XANA*/ pix_pipe.XANA_OBP0_D7n.dff8p_ff(_XELO_FF48_WRn_t1, BUS_CPU_D[7].to_wire());
  }
...

  {
    ...
    /* p36.MOXY*/ pix_pipe.MOXY_OBP1_D0n.dff8p_ff(_LEHO_FF49_WRn_t1, BUS_CPU_D[0].to_wire());
    /* p36.LAWO*/ pix_pipe.LAWO_OBP1_D1n.dff8p_ff(_LEHO_FF49_WRn_t1, BUS_CPU_D[1].to_wire());
    /* p36.MOSA*/ pix_pipe.MOSA_OBP1_D2n.dff8p_ff(_LEHO_FF49_WRn_t1, BUS_CPU_D[2].to_wire());
    /* p36.LOSE*/ pix_pipe.LOSE_OBP1_D3n.dff8p_ff(_LEHO_FF49_WRn_t1, BUS_CPU_D[3].to_wire());
    /* p36.LUNE*/ pix_pipe.LUNE_OBP1_D4n.dff8p_ff(_LEHO_FF49_WRn_t1, BUS_CPU_D[4].to_wire());
    /* p36.LUGU*/ pix_pipe.LUGU_OBP1_D5n.dff8p_ff(_LEHO_FF49_WRn_t1, BUS_CPU_D[5].to_wire());
    /* p36.LEPU*/ pix_pipe.LEPU_OBP1_D6n.dff8p_ff(_LEHO_FF49_WRn_t1, BUS_CPU_D[6].to_wire());
    /* p36.LUXO*/ pix_pipe.LUXO_OBP1_D7n.dff8p_ff(_LEHO_FF49_WRn_t1, BUS_CPU_D[7].to_wire());
  }
...

  {
    ...
    /* p23.NESO*/ pix_pipe.NESO_WY0n.dff9_ff(_VEFU_FF4A_WRn_t1, BUS_CPU_D[0].to_wire());
    /* p23.NYRO*/ pix_pipe.NYRO_WY1n.dff9_ff(_VEFU_FF4A_WRn_t1, BUS_CPU_D[1].to_wire());
    /* p23.NAGA*/ pix_pipe.NAGA_WY2n.dff9_ff(_VEFU_FF4A_WRn_t1, BUS_CPU_D[2].to_wire());
    /* p23.MELA*/ pix_pipe.MELA_WY3n.dff9_ff(_VEFU_FF4A_WRn_t1, BUS_CPU_D[3].to_wire());
    /* p23.NULO*/ pix_pipe.NULO_WY4n.dff9_ff(_VEFU_FF4A_WRn_t1, BUS_CPU_D[4].to_wire());
    /* p23.NENE*/ pix_pipe.NENE_WY5n.dff9_ff(_VEFU_FF4A_WRn_t1, BUS_CPU_D[5].to_wire());
    /* p23.NUKA*/ pix_pipe.NUKA_WY6n.dff9_ff(_VEFU_FF4A_WRn_t1, BUS_CPU_D[6].to_wire());
    /* p23.NAFU*/ pix_pipe.NAFU_WY7n.dff9_ff(_VEFU_FF4A_WRn_t1, BUS_CPU_D[7].to_wire());
...

  {
    ...
    /* p23.MYPA*/ pix_pipe.MYPA_WX0n.dff9_ff(_VOXU_FF4B_WRn_t1, BUS_CPU_D[0].to_wire());
    /* p23.NOFE*/ pix_pipe.NOFE_WX1n.dff9_ff(_VOXU_FF4B_WRn_t1, BUS_CPU_D[1].to_wire());
    /* p23.NOKE*/ pix_pipe.NOKE_WX2n.dff9_ff(_VOXU_FF4B_WRn_t1, BUS_CPU_D[2].to_wire());
    /* p23.MEBY*/ pix_pipe.MEBY_WX3n.dff9_ff(_VOXU_FF4B_WRn_t1, BUS_CPU_D[3].to_wire());
    /* p23.MYPU*/ pix_pipe.MYPU_WX4n.dff9_ff(_VOXU_FF4B_WRn_t1, BUS_CPU_D[4].to_wire());
    /* p23.MYCE*/ pix_pipe.MYCE_WX5n.dff9_ff(_VOXU_FF4B_WRn_t1, BUS_CPU_D[5].to_wire());
    /* p23.MUVO*/ pix_pipe.MUVO_WX6n.dff9_ff(_VOXU_FF4B_WRn_t1, BUS_CPU_D[6].to_wire());
    /* p23.NUKU*/ pix_pipe.NUKU_WX7n.dff9_ff(_VOXU_FF4B_WRn_t1, BUS_CPU_D[7].to_wire());
  ...
  // FF45 LYC
  /* p23.SYRY*/ lcd_reg.SYRY_LYC0n.dff9_ff(_WANE_FF45_WRp_t1, BUS_CPU_D[0].to_wire());
  /* p23.VUCE*/ lcd_reg.VUCE_LYC1n.dff9_ff(_WANE_FF45_WRp_t1, BUS_CPU_D[1].to_wire());
  /* p23.SEDY*/ lcd_reg.SEDY_LYC2n.dff9_ff(_WANE_FF45_WRp_t1, BUS_CPU_D[2].to_wire());
  /* p23.SALO*/ lcd_reg.SALO_LYC3n.dff9_ff(_WANE_FF45_WRp_t1, BUS_CPU_D[3].to_wire());
  /* p23.SOTA*/ lcd_reg.SOTA_LYC4n.dff9_ff(_WANE_FF45_WRp_t1, BUS_CPU_D[4].to_wire());
  /* p23.VAFA*/ lcd_reg.VAFA_LYC5n.dff9_ff(_WANE_FF45_WRp_t1, BUS_CPU_D[5].to_wire());
  /* p23.VEVO*/ lcd_reg.VEVO_LYC6n.dff9_ff(_WANE_FF45_WRp_t1, BUS_CPU_D[6].to_wire());
  /* p23.RAHA*/ lcd_reg.RAHA_LYC7n.dff9_ff(_WANE_FF45_WRp_t1, BUS_CPU_D[7].to_wire());
  ...
  // FF40 LCDC
  /*#p23.VYXE*/ pix_pipe.VYXE_LCDC_BGENn  .dff9_ff(_XUBO_FF40_WRn_t1, BUS_CPU_D[0].to_wire());
  /* p23.XYLO*/ pix_pipe.XYLO_LCDC_SPENn  .dff9_ff(_XUBO_FF40_WRn_t1, BUS_CPU_D[1].to_wire());
  /* p23.XYMO*/ pix_pipe.XYMO_LCDC_SPSIZEn.dff9_ff(_XUBO_FF40_WRn_t1, BUS_CPU_D[2].to_wire());
  /* p23.XAFO*/ pix_pipe.XAFO_LCDC_BGMAPn .dff9_ff(_XUBO_FF40_WRn_t1, BUS_CPU_D[3].to_wire());
  /* p23.WEXU*/ pix_pipe.WEXU_LCDC_BGTILEn.dff9_ff(_XUBO_FF40_WRn_t1, BUS_CPU_D[4].to_wire());
  /* p23.WYMO*/ pix_pipe.WYMO_LCDC_WINENn .dff9_ff(_XUBO_FF40_WRn_t1, BUS_CPU_D[5].to_wire());
  /* p23.WOKY*/ pix_pipe.WOKY_LCDC_WINMAPn.dff9_ff(_XUBO_FF40_WRn_t1, BUS_CPU_D[6].to_wire());
  /* p23.XONA*/ pix_pipe.XONA_LCDC_LCDENn .dff9_ff(_XUBO_FF40_WRn_t1, BUS_CPU_D[7].to_wire());
