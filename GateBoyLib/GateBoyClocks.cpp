...
void GateBoyClock::tock(const GateBoyResetDebug& rst) {
  ...
  /*PIN_73*/ PIN_73_CLK_DRIVE.pin_out_dp(PIN_74_CLK.qp_int_new_clk());

  /* p01.ARYS*/ wire ARYS = not1(PIN_74_CLK.qp_int_new_clk());
  /* p01.AVET*/ AVET = nand2(ANOS, ARYS);
  /* p01.ANOS*/ ANOS = nand2(PIN_74_CLK.qp_int_new_clk(), AVET);
  /* p01.AVET*/ AVET = nand2(ANOS, ARYS);
  /* p01.ANOS*/ ANOS = nand2(PIN_74_CLK.qp_int_new_clk(), AVET);
