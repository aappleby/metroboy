...
void GateBoy::set_cpu_pins()
{
  ...
  /*SIG_CPU_UNOR_DBG*/ cpu_bus.SIG_CPU_UNOR_DBG.sig_out(rst.UNOR_MODE_DBG2p());
  /*SIG_CPU_UMUT_DBG*/ cpu_bus.SIG_CPU_UMUT_DBG.sig_out(rst.UMUT_MODE_DBG1p());
  ...
  /* p07.UBAL*/ wire _UBAL_CPU_WRn = not1(cpu_bus.APOV_CPU_WRp);
