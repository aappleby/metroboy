...
struct GateBoyCpuBus {
  ...
  /* p07.TUNA*/ wire TUNA_0000_FDFF    () const { return nand7(BUS_CPU_A[15], BUS_CPU_A[14], BUS_CPU_A[13], BUS_CPU_A[12], BUS_CPU_A[11], BUS_CPU_A[10], BUS_CPU_A[9]); }
  ...
  /* p03.TOVY*/ wire TOVY_A00n         () const { return not1(BUS_CPU_A[0]); }
  /* p08.TOLA*/ wire TOLA_A01n         () const { return not1(BUS_CPU_A[1]); }
  /* p22.XOLA*/ wire XOLA_A00n         () const { return not1(BUS_CPU_A[0]); }
  /* p22.XENO*/ wire XENO_A01n         () const { return not1(BUS_CPU_A[1]); }
  /* p22.XUSY*/ wire XUSY_A02n         () const { return not1(BUS_CPU_A[2]); }
  /* p22.XERA*/ wire XERA_A03n         () const { return not1(BUS_CPU_A[3]); }
  /* p07.TONA*/ wire TONA_A08n         () const { return not1(BUS_CPU_A[8]); }
  /*#p08.SORE*/ wire SORE_A15n         () const { return not1(BUS_CPU_A[15]); }
  /* p06.SEFY*/ wire SEFY_A02n         () const { return not1(BUS_CPU_A[2]); }
  /* p10.BYKO*/ wire BYKO_A05n         () const { return not1(BUS_CPU_A[5]); }
  /* p10.AKUG*/ wire AKUG_A06n         () const { return not1(BUS_CPU_A[6]); }
  /* p08.SOGY*/ wire SOGY_A14n         () const { return not1(BUS_CPU_A[14]); }
  ...
  /* p07.TYRO*/ wire TYRO_XX_0x0x0000p () const { return nor6(BUS_CPU_A[ 7], BUS_CPU_A[ 5], BUS_CPU_A[ 3], BUS_CPU_A[ 2], BUS_CPU_A[ 1], BUS_CPU_A[ 0]); }
  /* p07.TUFA*/ wire TUFA_XX_x1x1xxxxp () const { return and2(BUS_CPU_A[ 4], BUS_CPU_A[ 6]); }
  ...
  /* p22.XALY*/ wire XALY_0x00xxxx     () const { return nor3(BUS_CPU_A[7], BUS_CPU_A[5], BUS_CPU_A[4]); }
  /* p06.SARE*/ wire SARE_XX00_XX07p   () const { return nor5 (BUS_CPU_A[7], BUS_CPU_A[6], BUS_CPU_A[5], BUS_CPU_A[4], BUS_CPU_A[3]); }
  /* p03.RYFO*/ wire RYFO_FF04_FF07p   () const { return and3(SYKE_ADDR_HIp(), BUS_CPU_A[2], SARE_XX00_XX07p()); }
  /* p10.AMUS*/ wire AMUS_XX_0xx00000p () const { return nor6(BUS_CPU_A[0], BUS_CPU_A[1], BUS_CPU_A[2], BUS_CPU_A[3], BUS_CPU_A[4], BUS_CPU_A[7]); }
  /* p07.SAPA*/ wire SAPA_XX_xxxx1111p () const { return and4(BUS_CPU_A[0], BUS_CPU_A[1], BUS_CPU_A[2], BUS_CPU_A[3]); }
  /* p07.SEMY*/ wire SEMY_XX_0000xxxxp () const { return nor4(BUS_CPU_A[7], BUS_CPU_A[6], BUS_CPU_A[5], BUS_CPU_A[4]); }
  ...
  /*#p08.TEVY*/ wire TEVY_ADDR_VRAMn   () const { return or3(BUS_CPU_A[13], BUS_CPU_A[14], SORE_A15n()); }
  ...
  /*#p25.SOSE*/ wire SOSE_ADDR_VRAMp   () const { return and2(TEFA_ADDR_VRAMp(), BUS_CPU_A[15]); }
  /* p08.LEVO*/ wire LEVO_ADDR_VRAMn   () const { return not1(TEXO_ADDR_VRAMn()); }

  /* p25.TUJA*/ wire TUJA_CPU_VRAM_WRp () const { return and2(SOSE_ADDR_VRAMp(), APOV_CPU_WRp); }
