...
struct GateBoyCpuBus {
  ...
  /*#p08.TEXO*/ wire TEXO_ADDR_VRAMn   () const { return and2(SIG_CPU_EXT_BUSp, TEVY_ADDR_VRAMn()); }
  ...
  wire TOLE_CPU_VRAM_RDp()
  {
   // Ignoring debug for now
    ...
    /*#p25.TUCA*/ wire _TUCA_CPU_VRAM_RDp = nand2(SOSE_ADDR_VRAMp(), ABUZ_EXT_RAM_CS_CLK);
  ...
  wire SALE_CPU_VRAM_WRn()
  {
    ...
    /*#p25.TEGU*/ wire _TEGU_CPU_VRAM_WRn = and2(SOSE_ADDR_VRAMp(), SIG_CPU_WRp);  // Schematic wrong, second input is SIG_CPU_WRp
