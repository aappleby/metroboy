...
wire2 GateBoyDMA::LUMA_DMA_CARTp() const {
  /*#p04.LEBU*/ wire2 _LEBU_DMA_A15n  = not1b(MARU_DMA_A15n.qn_new());
  /*#p04.MUDA*/ wire2 _MUDA_DMA_VRAMp = nor3b(PULA_DMA_A13n.qn_new(), POKU_DMA_A14n.qn_new(), _LEBU_DMA_A15n);
  /* p04.LOGO*/ wire2 _LOGO_DMA_VRAMn = not1b(_MUDA_DMA_VRAMp);
  /* p04.MORY*/ wire2 _MORY_DMA_CARTn = nand2b(MATU_DMA_RUNNINGp.qp_new(), _LOGO_DMA_VRAMn);
...
wire2 GateBoyDMA::LUFA_DMA_VRAMp() const {
  /*#p04.LEBU*/ wire2 _LEBU_DMA_A15n  = not1b(MARU_DMA_A15n.qn_new());
  /*#p04.MUDA*/ wire2 _MUDA_DMA_VRAMp = nor3b(PULA_DMA_A13n.qn_new(), POKU_DMA_A14n.qn_new(), _LEBU_DMA_A15n);
  /* p04.MUHO*/ wire2 _MUHO_DMA_VRAMp = nand2b(MATU_DMA_RUNNINGp.qp_new(), _MUDA_DMA_VRAMp);
...
void GateBoyDMA::write_dma_sync(GateBoyCpuBus& cpu_bus) {
  /*#p04.LAVY*/ wire2 LAVY_FF46_WRp = and2(CUPA_CPU_WRp(cpu_bus.TAPU_CPU_WRp.qp_new()), XEDA_FF46p(cpu_bus.BUS_CPU_A));
...
{
  /*#p04.LAVY*/ wire2 LAVY_FF46_WRp = and2(CUPA_CPU_WRp(cpu_bus.TAPU_CPU_WRp.qp_new()), XEDA_FF46p(cpu_bus.BUS_CPU_A));
  /*#p04.LUPA*/ wire2 _LUPA_DMA_TRIG_old = nor2b(LAVY_FF46_WRp, LYXE_DMA_LATCHp.qn_old());
  ...
  /*#p04.LOKO*/ wire2 _LOKO_DMA_RSTp = nand2b(LENE_DMA_TRIG_d4.qn_new(), rst.CUNU_SYS_RSTn());
  /*#p04.LYXE*/ LYXE_DMA_LATCHp.nor_latch(LAVY_FF46_WRp, _LOKO_DMA_RSTp);

  /*#p04.LAPA*/ wire2 _LAPA_DMA_RSTn = not1b(_LOKO_DMA_RSTp);

  /*#p04.NAVO*/ wire2 _NAVO_DMA_DONEn_old = nand6b(NAKY_DMA_A00p.qp_old(), PYRO_DMA_A01p.qp_old(),  // 128+16+8+4+2+1 = 159
  ...
  /* p04.LARA*/ LARA_DMA_LATCHn.set(nand3b(LOKY_DMA_LATCHp.qp_old(), MYTE_DMA_DONE.qn_new(), rst.CUNU_SYS_RSTn()));
  /*#p04.LOKY*/ LOKY_DMA_LATCHp.set(nand2b(LARA_DMA_LATCHn.qp_new(), LENE_DMA_TRIG_d4.qn_new()));
  /* p04.LARA*/ LARA_DMA_LATCHn.set(nand3b(LOKY_DMA_LATCHp.qp_new(), MYTE_DMA_DONE.qn_new(), rst.CUNU_SYS_RSTn()));
...
void GateBoyDMA::read_dma(GateBoyCpuBus& cpu_bus) {
  /*#p04.MOLU*/ wire2 MOLU_FF46_RDp = and2(ASOT_CPU_RDp(cpu_bus.TEDO_CPU_RDp.qp_new()), XEDA_FF46p(cpu_bus.BUS_CPU_A));
