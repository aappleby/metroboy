...
void GateBoy::reg_dma_tock()
{
  ...
  /*#p04.LENE*/ dma.LENE_DMA_TRIG_d4.dff17(clk.MOPA_xxxxEFGH(), rst.CUNU_SYS_RSTn(), dma.LUVY_DMA_TRIG_d0.qp_old());
  /*#p04.LUVY*/ dma.LUVY_DMA_TRIG_d0.dff17(clk.UVYT_ABCDxxxx(), rst.CUNU_SYS_RSTn(), _LUPA_DMA_TRIG_old);
  ...
  /*#p04.MYTE*/ dma.MYTE_DMA_DONE.dff17(clk.MOPA_xxxxEFGH(), _LAPA_DMA_RSTn, _NOLO_DMA_DONEp_old);

  /*#p04.MATU*/ dma.MATU_DMA_RUNNINGp.dff17(clk.UVYT_ABCDxxxx(), rst.CUNU_SYS_RSTn(), dma.LOKY_DMA_LATCHp);
  ...
  /*#p04.META*/ wire _META_DMA_CLKp = and2(clk.UVYT_ABCDxxxx(), dma.LOKY_DMA_LATCHp);
