...
wire2 GateBoyDMA::LUMA_DMA_CARTp() const {
  /*#p04.LEBU*/ wire2 _LEBU_DMA_A15n  = not1(MARU_DMA_A15n.qn_new());
  /*#p04.MUDA*/ wire2 _MUDA_DMA_VRAMp = nor3(PULA_DMA_A13n.qn_new(), POKU_DMA_A14n.qn_new(), _LEBU_DMA_A15n);
  /* p04.LOGO*/ wire2 _LOGO_DMA_VRAMn = not1(_MUDA_DMA_VRAMp);
  /* p04.MORY*/ wire2 _MORY_DMA_CARTn = nand2(MATU_DMA_RUNNINGp.qp_new(), _LOGO_DMA_VRAMn);
  /* p04.LUMA*/ wire2 _LUMA_DMA_CARTp = not1(_MORY_DMA_CARTn);
...
wire2 GateBoyDMA::LUFA_DMA_VRAMp() const {
  /*#p04.LEBU*/ wire2 _LEBU_DMA_A15n  = not1(MARU_DMA_A15n.qn_new());
  /*#p04.MUDA*/ wire2 _MUDA_DMA_VRAMp = nor3(PULA_DMA_A13n.qn_new(), POKU_DMA_A14n.qn_new(), _LEBU_DMA_A15n);
  /* p04.MUHO*/ wire2 _MUHO_DMA_VRAMp = nand2(MATU_DMA_RUNNINGp.qp_new(), _MUDA_DMA_VRAMp);
  /* p04.LUFA*/ wire2 _LUFA_DMA_VRAMp = not1(_MUHO_DMA_VRAMp);
...
void GateBoyDMA::write_dma_sync(GateBoyCpuBus& cpu_bus) {
  ...
  /*#p04.LORU*/ wire2 LORU_FF46_WRn = not1(LAVY_FF46_WRp);
...
{
  /*#p04.LAVY*/ wire2 LAVY_FF46_WRp = and2(CUPA_CPU_WRp(cpu_bus.TAPU_CPU_WRp.qp_new()), XEDA_FF46p(cpu_bus.BUS_CPU_A));
  /*#p04.LUPA*/ wire2 _LUPA_DMA_TRIG_old = nor2(LAVY_FF46_WRp, LYXE_DMA_LATCHp.qn_old());
  ...
  /*#p04.LOKO*/ wire2 _LOKO_DMA_RSTp = nand2(LENE_DMA_TRIG_d4.qn_new(), rst.CUNU_SYS_RSTn());
  /*#p04.LYXE*/ LYXE_DMA_LATCHp.nor_latch(LAVY_FF46_WRp, _LOKO_DMA_RSTp);

  /*#p04.LAPA*/ wire2 _LAPA_DMA_RSTn = not1(_LOKO_DMA_RSTp);

  /*#p04.NAVO*/ wire2 _NAVO_DMA_DONEn_old = nand6(NAKY_DMA_A00p.qp_old(), PYRO_DMA_A01p.qp_old(),  // 128+16+8+4+2+1 = 159
                                                  NEFY_DMA_A02p.qp_old(), MUTY_DMA_A03p.qp_old(),
                                                  NYKO_DMA_A04p.qp_old(), MUGU_DMA_A07p.qp_old());
  /*#p04.NOLO*/ wire2 _NOLO_DMA_DONEp_old = not1(_NAVO_DMA_DONEn_old);
...
void GateBoyDMA::read_dma(GateBoyCpuBus& cpu_bus) {
  ...
  /*#p04.NYGO*/ wire2 NYGO_FF46_RDn = not1(MOLU_FF46_RDp);
  /*#p04.PUSY*/ wire2 PUSY_FF46_RDp = not1(NYGO_FF46_RDn);
