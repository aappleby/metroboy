...
void GateBoy::tock_dma() {
  ...
  /* p04.PYNE*/ dma.PYNE_DMA_A09n.dff8p(LORU_FF46_WRn, old_bus.BUS_CPU_D01p.out_old());
  /* p04.PARA*/ dma.PARA_DMA_A10n.dff8p(LORU_FF46_WRn, old_bus.BUS_CPU_D02p.out_old());
  /* p04.NYDO*/ dma.NYDO_DMA_A11n.dff8p(LORU_FF46_WRn, old_bus.BUS_CPU_D03p.out_old());
  /* p04.NYGY*/ dma.NYGY_DMA_A12n.dff8p(LORU_FF46_WRn, old_bus.BUS_CPU_D04p.out_old());
  /* p04.PULA*/ dma.PULA_DMA_A13n.dff8p(LORU_FF46_WRn, old_bus.BUS_CPU_D05p.out_old());
  /* p04.POKU*/ dma.POKU_DMA_A14n.dff8p(LORU_FF46_WRn, old_bus.BUS_CPU_D06p.out_old());
  /* p04.MARU*/ dma.MARU_DMA_A15n.dff8p(LORU_FF46_WRn, old_bus.BUS_CPU_D07p.out_old());
  ...
  /* p04.LARA*/ dma.LARA_DMA_LATCHn = nand3(dma.LOKY_DMA_LATCHp.out_mid(), dma.MYTE_DMA_DONE.qn_any(), CUNU_SYS_RSTn());
  ...
  /* p04.NEFY*/ dma.NEFY_DMA_A02p.dff17(dma.PYRO_DMA_A01p.qn_new(), LAPA_DMA_RSTn, dma.NEFY_DMA_A02p.qn_old());
  /* p04.MUTY*/ dma.MUTY_DMA_A03p.dff17(dma.NEFY_DMA_A02p.qn_new(), LAPA_DMA_RSTn, dma.MUTY_DMA_A03p.qn_old());
  /* p04.NYKO*/ dma.NYKO_DMA_A04p.dff17(dma.MUTY_DMA_A03p.qn_new(), LAPA_DMA_RSTn, dma.NYKO_DMA_A04p.qn_old());
  /* p04.PYLO*/ dma.PYLO_DMA_A05p.dff17(dma.NYKO_DMA_A04p.qn_new(), LAPA_DMA_RSTn, dma.PYLO_DMA_A05p.qn_old());
  /* p04.NUTO*/ dma.NUTO_DMA_A06p.dff17(dma.PYLO_DMA_A05p.qn_new(), LAPA_DMA_RSTn, dma.NUTO_DMA_A06p.qn_old());
  /* p04.MUGU*/ dma.MUGU_DMA_A07p.dff17(dma.NUTO_DMA_A06p.qn_new(), LAPA_DMA_RSTn, dma.MUGU_DMA_A07p.qn_old());
  ...
  /*#p04.POLY_DMA0_TO_CD0*/ triwire POLY_DMA0_TO_CD0 = tri6_pn(PUSY_FF46_RDp, dma.NAFA_DMA_A08n.qp_new());
  /* p04.ROFO_DMA1_TO_CD1*/ triwire ROFO_DMA1_TO_CD1 = tri6_pn(PUSY_FF46_RDp, dma.PYNE_DMA_A09n.qp_new());
  /* p04.REMA_DMA2_TO_CD2*/ triwire REMA_DMA2_TO_CD2 = tri6_pn(PUSY_FF46_RDp, dma.PARA_DMA_A10n.qp_new());
  /* p04.PANE_DMA3_TO_CD3*/ triwire PANE_DMA3_TO_CD3 = tri6_pn(PUSY_FF46_RDp, dma.NYDO_DMA_A11n.qp_new());
  /* p04.PARE_DMA4_TO_CD4*/ triwire PARE_DMA4_TO_CD4 = tri6_pn(PUSY_FF46_RDp, dma.NYGY_DMA_A12n.qp_new());
  /* p04.RALY_DMA5_TO_CD5*/ triwire RALY_DMA5_TO_CD5 = tri6_pn(PUSY_FF46_RDp, dma.PULA_DMA_A13n.qp_new());
  /* p04.RESU_DMA6_TO_CD6*/ triwire RESU_DMA6_TO_CD6 = tri6_pn(PUSY_FF46_RDp, dma.POKU_DMA_A14n.qp_new());
  /* p04.NUVY_DMA7_TO_CD7*/ triwire NUVY_DMA7_TO_CD7 = tri6_pn(PUSY_FF46_RDp, dma.MARU_DMA_A15n.qp_new());
