...
void GateBoyDMA::write_dma_sync(GateBoyCpuBus& cpu_bus) {
  /*#p04.LAVY*/ wire LAVY_FF46_WRp = and2(CUPA_CPU_WRp(cpu_bus.TAPU_CPU_WRp.qp_new2()), XEDA_FF46p(cpu_bus.BUS_CPU_A));
...
void GateBoyDMA::read_dma(GateBoyCpuBus& cpu_bus) {
  /*#p04.MOLU*/ wire MOLU_FF46_RDp = and2(ASOT_CPU_RDp(cpu_bus.TEDO_CPU_RDp.qp_new2()), XEDA_FF46p(cpu_bus.BUS_CPU_A));
