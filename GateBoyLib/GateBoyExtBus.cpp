...
void GateBoyExtBus::copy_cpu_addr_to_addr_latch(const GateBoyResetDebug& rst, const GateBoyCpuBus& cpu_bus)
{
  ...
  /* p08.ALOR*/ ext_addr_latch.ALOR_EXT_ADDR_LATCH_00p.tp_latchn(_MATE_HOLDn, cpu_bus.BUS_CPU_A00p.qp_new());
  /* p08.APUR*/ ext_addr_latch.APUR_EXT_ADDR_LATCH_01p.tp_latchn(_MATE_HOLDn, cpu_bus.BUS_CPU_A01p.qp_new());
  /* p08.ALYR*/ ext_addr_latch.ALYR_EXT_ADDR_LATCH_02p.tp_latchn(_MATE_HOLDn, cpu_bus.BUS_CPU_A02p.qp_new());
  /* p08.ARET*/ ext_addr_latch.ARET_EXT_ADDR_LATCH_03p.tp_latchn(_MATE_HOLDn, cpu_bus.BUS_CPU_A03p.qp_new());
  /* p08.AVYS*/ ext_addr_latch.AVYS_EXT_ADDR_LATCH_04p.tp_latchn(_MATE_HOLDn, cpu_bus.BUS_CPU_A04p.qp_new());
  /* p08.ATEV*/ ext_addr_latch.ATEV_EXT_ADDR_LATCH_05p.tp_latchn(_MATE_HOLDn, cpu_bus.BUS_CPU_A05p.qp_new());
  /* p08.AROS*/ ext_addr_latch.AROS_EXT_ADDR_LATCH_06p.tp_latchn(_MATE_HOLDn, cpu_bus.BUS_CPU_A06p.qp_new());
  /* p08.ARYM*/ ext_addr_latch.ARYM_EXT_ADDR_LATCH_07p.tp_latchn(_MATE_HOLDn, cpu_bus.BUS_CPU_A07p.qp_new());
  /* p08.LUNO*/ ext_addr_latch.LUNO_EXT_ADDR_LATCH_08p.tp_latchn(_MATE_HOLDn, cpu_bus.BUS_CPU_A08p.qp_new());
  /* p08.LYSA*/ ext_addr_latch.LYSA_EXT_ADDR_LATCH_09p.tp_latchn(_MATE_HOLDn, cpu_bus.BUS_CPU_A09p.qp_new());
  /* p08.PATE*/ ext_addr_latch.PATE_EXT_ADDR_LATCH_10p.tp_latchn(_MATE_HOLDn, cpu_bus.BUS_CPU_A10p.qp_new());
  /* p08.LUMY*/ ext_addr_latch.LUMY_EXT_ADDR_LATCH_11p.tp_latchn(_MATE_HOLDn, cpu_bus.BUS_CPU_A11p.qp_new());
  /* p08.LOBU*/ ext_addr_latch.LOBU_EXT_ADDR_LATCH_12p.tp_latchn(_MATE_HOLDn, cpu_bus.BUS_CPU_A12p.qp_new());
  /* p08.LONU*/ ext_addr_latch.LONU_EXT_ADDR_LATCH_13p.tp_latchn(_MATE_HOLDn, cpu_bus.BUS_CPU_A13p.qp_new());
  /* p08.NYRE*/ ext_addr_latch.NYRE_EXT_ADDR_LATCH_14p.tp_latchn(_MATE_HOLDn, cpu_bus.BUS_CPU_A14p.qp_new());
}

//------------------------------------------------------------------------------------------------------------------------

void GateBoyExtBus::copy_addr_latch_to_pins(const GateBoyResetDebug& rst, const GateBoyCpuBus& cpu_bus, const GateBoyDMA& dma)
{
  ...
  /*PIN01*/ PIN01_A00.pin_out_hilo(_KUPO, _KOTY);
  /*PIN02*/ PIN02_A01.pin_out_hilo(_CABA, _COTU);
  /*PIN03*/ PIN03_A02.pin_out_hilo(_BOKU, _BAJO);
  /*PIN04*/ PIN04_A03.pin_out_hilo(_BOTY, _BOLA);
  /*PIN05*/ PIN05_A04.pin_out_hilo(_BYLA, _BEVO);
  /*PIN06*/ PIN06_A05.pin_out_hilo(_BADU, _AJAV);
  /*PIN07*/ PIN07_A06.pin_out_hilo(_CEPU, _CYKA);
  /*PIN08*/ PIN08_A07.pin_out_hilo(_DEFY, _COLO);
  /*PIN09*/ PIN09_A08.pin_out_hilo(_MYNY, _MEGO);
  /*PIN10*/ PIN10_A09.pin_out_hilo(_MUNE, _MENY);
  /*PIN11*/ PIN11_A10.pin_out_hilo(_ROXU, _RORE);
  /*PIN12*/ PIN12_A11.pin_out_hilo(_LEPY, _LYNY);
  /*PIN13*/ PIN13_A12.pin_out_hilo(_LUCE, _LOSO);
  /*PIN14*/ PIN14_A13.pin_out_hilo(_LABE, _LEVA);
  /*PIN15*/ PIN15_A14.pin_out_hilo(_PUHE, _PAHY);

  // A15 is "special"
  /* p08.SOBY*/ wire _SOBY_A15n = nor2 (cpu_bus.BUS_CPU_A15p.qp_new(), cpu_bus.TUTU_READ_BOOTROMp());
  ...
  /*PIN16*/ PIN16_A15.pin_out_hilo(_SUZE_A15n, _RULO_A15n);
}
...
void GateBoyExtBus::copy_pins_to_data_latch(const GateBoyCpuBus& cpu_bus)
{
  ...
  /*#p08.SOMA*/ ext_data_latch.SOMA_EXT_DATA_LATCH_D0n.tp_latchn(_LAVO_HOLDn, PIN17_D00.int_qp_new());
  /* p08.RONY*/ ext_data_latch.RONY_EXT_DATA_LATCH_D1n.tp_latchn(_LAVO_HOLDn, PIN18_D01.int_qp_new());
  /* p08.RAXY*/ ext_data_latch.RAXY_EXT_DATA_LATCH_D2n.tp_latchn(_LAVO_HOLDn, PIN19_D02.int_qp_new());
  /* p08.SELO*/ ext_data_latch.SELO_EXT_DATA_LATCH_D3n.tp_latchn(_LAVO_HOLDn, PIN20_D03.int_qp_new());
  /* p08.SODY*/ ext_data_latch.SODY_EXT_DATA_LATCH_D4n.tp_latchn(_LAVO_HOLDn, PIN21_D04.int_qp_new());
  /* p08.SAGO*/ ext_data_latch.SAGO_EXT_DATA_LATCH_D5n.tp_latchn(_LAVO_HOLDn, PIN22_D05.int_qp_new());
  /* p08.RUPA*/ ext_data_latch.RUPA_EXT_DATA_LATCH_D6n.tp_latchn(_LAVO_HOLDn, PIN23_D06.int_qp_new());
  /* p08.SAZY*/ ext_data_latch.SAZY_EXT_DATA_LATCH_D7n.tp_latchn(_LAVO_HOLDn, PIN24_D07.int_qp_new());
}
...
{
  /* p08.LAVO*/ wire _LAVO_HOLDn = nand3(cpu_bus.SIG_CPU_RDp.qp_new(), cpu_bus.TEXO_ADDR_VRAMn(), cpu_bus.SIG_CPU_LATCH_EXT.qp_new());
  /*#p08.RYMA*/ cpu_bus.BUS_CPU_D00p.tri6_nn(_LAVO_HOLDn, ext_data_latch.SOMA_EXT_DATA_LATCH_D0n.qp_new());
  /* p08.RUVO*/ cpu_bus.BUS_CPU_D01p.tri6_nn(_LAVO_HOLDn, ext_data_latch.RONY_EXT_DATA_LATCH_D1n.qp_new());
  /* p08.RYKO*/ cpu_bus.BUS_CPU_D02p.tri6_nn(_LAVO_HOLDn, ext_data_latch.RAXY_EXT_DATA_LATCH_D2n.qp_new());
  /* p08.TAVO*/ cpu_bus.BUS_CPU_D03p.tri6_nn(_LAVO_HOLDn, ext_data_latch.SELO_EXT_DATA_LATCH_D3n.qp_new());
  /* p08.TEPE*/ cpu_bus.BUS_CPU_D04p.tri6_nn(_LAVO_HOLDn, ext_data_latch.SODY_EXT_DATA_LATCH_D4n.qp_new());
  /* p08.SAFO*/ cpu_bus.BUS_CPU_D05p.tri6_nn(_LAVO_HOLDn, ext_data_latch.SAGO_EXT_DATA_LATCH_D5n.qp_new());
  /* p08.SEVU*/ cpu_bus.BUS_CPU_D06p.tri6_nn(_LAVO_HOLDn, ext_data_latch.RUPA_EXT_DATA_LATCH_D6n.qp_new());
  /* p08.TAJU*/ cpu_bus.BUS_CPU_D07p.tri6_nn(_LAVO_HOLDn, ext_data_latch.SAZY_EXT_DATA_LATCH_D7n.qp_new());
}
...
void GateBoyExtBus::copy_cpu_data_to_pins(const GateBoyResetDebug& rst, const GateBoyCpuBus& cpu_bus)
{
  ...
  /* p25.RUXA*/ wire _RUXA = nand2(cpu_bus.BUS_CPU_D00p.qp_new(), _LULA_CBD_TO_EPDp);
  /* p25.RUJA*/ wire _RUJA = nand2(cpu_bus.BUS_CPU_D01p.qp_new(), _LULA_CBD_TO_EPDp);
  /* p25.RABY*/ wire _RABY = nand2(cpu_bus.BUS_CPU_D02p.qp_new(), _LULA_CBD_TO_EPDp);
  /* p25.RERA*/ wire _RERA = nand2(cpu_bus.BUS_CPU_D03p.qp_new(), _LULA_CBD_TO_EPDp);
  /* p25.RORY*/ wire _RORY = nand2(cpu_bus.BUS_CPU_D04p.qp_new(), _LULA_CBD_TO_EPDp);
  /* p25.RYVO*/ wire _RYVO = nand2(cpu_bus.BUS_CPU_D05p.qp_new(), _LULA_CBD_TO_EPDp);
  /* p25.RAFY*/ wire _RAFY = nand2(cpu_bus.BUS_CPU_D06p.qp_new(), _LULA_CBD_TO_EPDp);
  /* p25.RAVU*/ wire _RAVU = nand2(cpu_bus.BUS_CPU_D07p.qp_new(), _LULA_CBD_TO_EPDp);

  /* p08.RUNE*/ wire _RUNE = nor2 (cpu_bus.BUS_CPU_D00p.qp_new(), _RORU_CBD_TO_EPDn);
  /* p08.RYPU*/ wire _RYPU = nor2 (cpu_bus.BUS_CPU_D01p.qp_new(), _RORU_CBD_TO_EPDn);
  /* p08.SULY*/ wire _SULY = nor2 (cpu_bus.BUS_CPU_D02p.qp_new(), _RORU_CBD_TO_EPDn);
  /* p08.SEZE*/ wire _SEZE = nor2 (cpu_bus.BUS_CPU_D03p.qp_new(), _RORU_CBD_TO_EPDn);
  /* p08.RESY*/ wire _RESY = nor2 (cpu_bus.BUS_CPU_D04p.qp_new(), _RORU_CBD_TO_EPDn);
  /* p08.TAMU*/ wire _TAMU = nor2 (cpu_bus.BUS_CPU_D05p.qp_new(), _RORU_CBD_TO_EPDn);
  ...
  /*PIN17*/ PIN17_D00.pin_out_pull_hilo(_LULA_CBD_TO_EPDp, _RUXA, _RUNE);
  /*PIN18*/ PIN18_D01.pin_out_pull_hilo(_LULA_CBD_TO_EPDp, _RUJA, _RYPU);
  /*PIN19*/ PIN19_D02.pin_out_pull_hilo(_LULA_CBD_TO_EPDp, _RABY, _SULY);
  /*PIN20*/ PIN20_D03.pin_out_pull_hilo(_LULA_CBD_TO_EPDp, _RERA, _SEZE);
  /*PIN21*/ PIN21_D04.pin_out_pull_hilo(_LULA_CBD_TO_EPDp, _RORY, _RESY);
  /*PIN22*/ PIN22_D05.pin_out_pull_hilo(_LULA_CBD_TO_EPDp, _RYVO, _TAMU);
  /*PIN23*/ PIN23_D06.pin_out_pull_hilo(_LULA_CBD_TO_EPDp, _RAFY, _ROGY);
  /*PIN24*/ PIN24_D07.pin_out_pull_hilo(_LULA_CBD_TO_EPDp, _RAVU, _RYDA);
}
  ...
  const GateBoyDMA& dma)
{
...

  {
    ...
    /*PIN79*/ PIN79_RDn.pin_out_hilo(_UGAC_RD_A, _URUN_RD_D);
  }

  {
    ...
    /*PIN78*/ PIN78_WRn.pin_out_hilo(_UVER_WR_A, _USUF_WR_D);
  }

  {
    /* p08.TOZA*/ wire _TOZA_CS_A = and3(cpu_bus.ABUZ_EXT_RAM_CS_CLK.qp_new(), cpu_bus.TYNU_A000_FFFFp(), cpu_bus.TUNA_0000_FDFF());
    /* p08.TYHO*/ wire _TYHO_CS_A = mux2p(dma.LUMA_DMA_CARTp(), dma.MARU_DMA_A15n.qn_new(), _TOZA_CS_A);
    /*PIN80*/ PIN80_CSn.pin_out_dp(_TYHO_CS_A);
  }
}
...
void GateBoyExtBus::read_ext_to_pins(const uint8_t* cart_buf, const uint8_t* cart_ram, const uint8_t* int_ram) {
  uint16_t addr = (uint16_t)BitBase::pack_ext_new(16, &PIN01_A00);
  wire data = 0xFF;
  ...
  // Internal RAM read
  //wire iram_CS1n = PIN80_CSn.qp_new();
  //wire iram_CS2p = PIN01_ADDR[14].qp_new();
  //wire iram_OEp  = bit(~iram_CS1n) && iram_CS2p && bit(~PIN79_RDn.qp_new());
  ...
  //wire eram_OEp  = bit(~eram_CS1n) && eram_CS2p && bit(~PIN79_RDn.qp_new());
  ...
  PIN17_D00.pin_in_oedp(ext_OEp, (data >> 0) & 1);
  PIN18_D01.pin_in_oedp(ext_OEp, (data >> 1) & 1);
  PIN19_D02.pin_in_oedp(ext_OEp, (data >> 2) & 1);
  PIN20_D03.pin_in_oedp(ext_OEp, (data >> 3) & 1);
  PIN21_D04.pin_in_oedp(ext_OEp, (data >> 4) & 1);
  PIN22_D05.pin_in_oedp(ext_OEp, (data >> 5) & 1);
  PIN23_D06.pin_in_oedp(ext_OEp, (data >> 6) & 1);
  PIN24_D07.pin_in_oedp(ext_OEp, (data >> 7) & 1);
}
...
void GateBoyExtBus::write_pins_to_ext(uint8_t* cart_ram, uint8_t* int_ram) {
  uint16_t addr = (uint16_t)BitBase::pack_ext_new(16, &PIN01_A00);
  wire data = (wire)BitBase::pack_ext_new(8, &PIN17_D00);

  // Cart RAM write
  //wire cram_CS1n = PIN80_CSn.qp_new();
  //wire cram_CS2p = PIN01_ADDR[13].qp_new() && bit(~PIN01_ADDR[14].qp_new()) && PIN01_ADDR[15].qp_new();
  //wire cram_WRp  = bit(~cram_CS1n) && cram_CS2p && bit(~PIN78_WRn.qp_new());
  ...
  //wire iram_CS1n = PIN80_CSn.qp_new();
  //wire iram_CS2p = PIN01_ADDR[14].qp_new();
  //wire iram_WRp  = bit(~iram_CS1n) && iram_CS2p && bit(~PIN78_WRn.qp_new());
  ...
  //wire eram_CS1n = PIN80_CSn.qp_new();
  //wire eram_CS2p = PIN01_ADDR[14].qp_new();
  //wire eram_WRp  = bit(~eram_CS1n) && iram_CS2p && bit(~PIN78_WRn.qp_new());
