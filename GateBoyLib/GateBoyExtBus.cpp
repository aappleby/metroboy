...
void GateBoyExtBus::copy_addr_latch_to_pins(const GateBoyResetDebug& rst, const GateBoyCpuBus& cpu_bus, const GateBoyDMA& dma, wire2 ABUZ_EXT_RAM_CS_CLK)
{
  ...
  // A15 is "special"
  /* p08.SOBY*/ wire2 _SOBY_A15n = nor2b (cpu_bus.BUS_CPU_A[15].qp_new(), cpu_bus.TUTU_READ_BOOTROMp());
...
{
  /* p08.LAVO*/ wire2 _LAVO_HOLDn = nand3b(cpu_bus.SIG_CPU_RDp.qp_new(), cpu_bus.TEXO_ADDR_VRAMn(), cpu_bus.SIG_CPU_LATCH_EXT.qp_new());
...
void GateBoyExtBus::copy_cpu_data_to_pins(const GateBoyResetDebug& rst, const GateBoyCpuBus& cpu_bus)
{
  ...
  /* p25.RUXA*/ wire2 _RUXA = nand2b(cpu_bus.BUS_CPU_D[0].qp_new(), _LULA_CBD_TO_EPDp);
  /* p25.RUJA*/ wire2 _RUJA = nand2b(cpu_bus.BUS_CPU_D[1].qp_new(), _LULA_CBD_TO_EPDp);
  /* p25.RABY*/ wire2 _RABY = nand2b(cpu_bus.BUS_CPU_D[2].qp_new(), _LULA_CBD_TO_EPDp);
  /* p25.RERA*/ wire2 _RERA = nand2b(cpu_bus.BUS_CPU_D[3].qp_new(), _LULA_CBD_TO_EPDp);
  /* p25.RORY*/ wire2 _RORY = nand2b(cpu_bus.BUS_CPU_D[4].qp_new(), _LULA_CBD_TO_EPDp);
  /* p25.RYVO*/ wire2 _RYVO = nand2b(cpu_bus.BUS_CPU_D[5].qp_new(), _LULA_CBD_TO_EPDp);
  /* p25.RAFY*/ wire2 _RAFY = nand2b(cpu_bus.BUS_CPU_D[6].qp_new(), _LULA_CBD_TO_EPDp);
  /* p25.RAVU*/ wire2 _RAVU = nand2b(cpu_bus.BUS_CPU_D[7].qp_new(), _LULA_CBD_TO_EPDp);

  /* p08.RUNE*/ wire2 _RUNE = nor2b (cpu_bus.BUS_CPU_D[0].qp_new(), _RORU_CBD_TO_EPDn);
  /* p08.RYPU*/ wire2 _RYPU = nor2b (cpu_bus.BUS_CPU_D[1].qp_new(), _RORU_CBD_TO_EPDn);
  /* p08.SULY*/ wire2 _SULY = nor2b (cpu_bus.BUS_CPU_D[2].qp_new(), _RORU_CBD_TO_EPDn);
  /* p08.SEZE*/ wire2 _SEZE = nor2b (cpu_bus.BUS_CPU_D[3].qp_new(), _RORU_CBD_TO_EPDn);
  /* p08.RESY*/ wire2 _RESY = nor2b (cpu_bus.BUS_CPU_D[4].qp_new(), _RORU_CBD_TO_EPDn);
  /* p08.TAMU*/ wire2 _TAMU = nor2b (cpu_bus.BUS_CPU_D[5].qp_new(), _RORU_CBD_TO_EPDn);
  /* p08.ROGY*/ wire2 _ROGY = nor2b (cpu_bus.BUS_CPU_D[6].qp_new(), _RORU_CBD_TO_EPDn);
  /* p08.RYDA*/ wire2 _RYDA = nor2b (cpu_bus.BUS_CPU_D[7].qp_new(), _RORU_CBD_TO_EPDn);
