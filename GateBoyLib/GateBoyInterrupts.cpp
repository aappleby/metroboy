  ...
  BusOut BUS_CPU_D_out[8])
{
  ...
  /* p07.ROLO*/ wire _ROLO_FF0F_RDn = nand4(TEDO_CPU_RDp, SYKE_ADDR_HIp(BUS_CPU_A),  SEMY_XX_0000xxxxp(BUS_CPU_A), SAPA_XX_xxxx1111p(BUS_CPU_A)); // schematic wrong, is NAND
  /* p07.REFA*/ wire _REFA_FF0F_WRn = nand4(TAPU_CPU_WRp, SYKE_ADDR_HIp(BUS_CPU_A),  SEMY_XX_0000xxxxp(BUS_CPU_A), SAPA_XX_xxxx1111p(BUS_CPU_A)); // schematic wrong, is NAND
  ...
  /*#p02.NELA*/ BUS_CPU_D_out[0].tri6_pn(_POLA_FF0F_RDp, MATY_FF0F_L0p.qn_new());
  /*#p02.NABO*/ BUS_CPU_D_out[1].tri6_pn(_POLA_FF0F_RDp, MOPO_FF0F_L1p.qn_new());
  /*#p02.ROVA*/ BUS_CPU_D_out[2].tri6_pn(_POLA_FF0F_RDp, PAVY_FF0F_L2p.qn_new());
  /*#p02.PADO*/ BUS_CPU_D_out[3].tri6_pn(_POLA_FF0F_RDp, NEJY_FF0F_L3p.qn_new());
  /*#p02.PEGY*/ BUS_CPU_D_out[4].tri6_pn(_POLA_FF0F_RDp, NUTY_FF0F_L4p.qn_new());
