...
void GateBoy::tock_interrupts()
{
  ...
  /* p21.ROXE*/ reg_stat.ROXE_STAT_HBI_ENn.dff9(RYVE_FF41_WRn, WESY_SYS_RSTn(), old_bus.BUS_CPU_D03p.qp_old());
  /* p21.RUFO*/ reg_stat.RUFO_STAT_VBI_ENn.dff9(RYVE_FF41_WRn, WESY_SYS_RSTn(), old_bus.BUS_CPU_D04p.qp_old());
  /* p21.REFE*/ reg_stat.REFE_STAT_OAI_ENn.dff9(RYVE_FF41_WRn, WESY_SYS_RSTn(), old_bus.BUS_CPU_D05p.qp_old());
  /* p21.RUGU*/ reg_stat.RUGU_STAT_LYI_ENn.dff9(RYVE_FF41_WRn, WESY_SYS_RSTn(), old_bus.BUS_CPU_D06p.qp_old());
  ...
  /*#p21.XATY*/ wire XATY_STAT_MODE1n = nor2(sprite_scanner.ACYL_SCANNINGp.qp_new(), XYMU_RENDERINGn.qn_new()); // die NOR
  ...
  /*#p21.TARU*/ wire TARU_INT_HBL   = and2(WODU_HBLANKp.qp_new(), TOLU_VBLANKn);
  ...
  /* p07.REFA*/ wire REFA_FF0F_WRn = nand4(cpu_signals.TAPU_CPU_WRp.qp_new(), new_bus.SYKE_ADDR_HIp(), new_bus.SEMY_XX_0000xxxxp(), new_bus.SAPA_XX_xxxx1111p()); // schematic wrong, is NAND

  /* p02.LETY*/ wire LETY_INT_VBL_ACKn  = not1(interrupts.SIG_CPU_ACK_VBLANK.qp_new());
  /* p02.LEJA*/ wire LEJA_INT_STAT_ACKn = not1(interrupts.SIG_CPU_ACK_STAT.qp_new());
  /* p02.LESA*/ wire LESA_INT_TIM_ACKn  = not1(interrupts.SIG_CPU_ACK_TIMER.qp_new());
  /* p02.LUFE*/ wire LUFE_INT_SER_ACKn  = not1(interrupts.SIG_CPU_ACK_SERIAL.qp_new());
  /* p02.LAMO*/ wire LAMO_INT_JOY_ACKn  = not1(interrupts.SIG_CPU_ACK_JOYPAD.qp_new());

  /* p02.ROTU*/ wire ROTU_FF0F_WRp   = not1(REFA_FF0F_WRn);
  /* p02.MYZU*/ wire MYZU_FF0F_SET0n = nand3(ROTU_FF0F_WRp, LETY_INT_VBL_ACKn,  new_bus.BUS_CPU_D00p.qp_new());
  /* p02.MODY*/ wire MODY_FF0F_SET1n = nand3(ROTU_FF0F_WRp, LEJA_INT_STAT_ACKn, new_bus.BUS_CPU_D01p.qp_new());
  /* p02.PYHU*/ wire PYHU_FF0F_SET2n = nand3(ROTU_FF0F_WRp, LESA_INT_TIM_ACKn,  new_bus.BUS_CPU_D02p.qp_new());
  /* p02.TOME*/ wire TOME_FF0F_SET3n = nand3(ROTU_FF0F_WRp, LUFE_INT_SER_ACKn,  new_bus.BUS_CPU_D03p.qp_new());
  /* p02.TOGA*/ wire TOGA_FF0F_SET4n = nand3(ROTU_FF0F_WRp, LAMO_INT_JOY_ACKn,  new_bus.BUS_CPU_D04p.qp_new());

  /*#p02.MUXE*/ wire MUXE_INT0_WRn = or2(new_bus.BUS_CPU_D00p.qp_new(), REFA_FF0F_WRn);
  /* p02.NABE*/ wire NABE_INT1_WRn = or2(new_bus.BUS_CPU_D01p.qp_new(), REFA_FF0F_WRn);
  /* p02.RAKE*/ wire RAKE_INT2_WRn = or2(new_bus.BUS_CPU_D02p.qp_new(), REFA_FF0F_WRn);
  /* p02.SULO*/ wire SULO_INT3_WRn = or2(new_bus.BUS_CPU_D03p.qp_new(), REFA_FF0F_WRn);
  /* p02.SEME*/ wire SEME_INT4_WRn = or2(new_bus.BUS_CPU_D04p.qp_new(), REFA_FF0F_WRn);
  ...
  /* p02.LOPE*/ interrupts.LOPE_FF0F_D0p.dff22(VYPU_INT_VBLANKp,                    MYZU_FF0F_SET0n, LYTA_FF0F_RST0n, SIG_VCC.qp_new());
  /* p02.LALU*/ interrupts.LALU_FF0F_D1p.dff22(VOTY_INT_STATp,                      MODY_FF0F_SET1n, MOVU_FF0F_RST1n, SIG_VCC.qp_new());
  /* p02.NYBO*/ interrupts.NYBO_FF0F_D2p.dff22(timer.MOBA_TIMER_OVERFLOWp.qp_new(), PYHU_FF0F_SET2n, PYGA_FF0F_RST2n, SIG_VCC.qp_new());
  /* p02.UBUL*/ interrupts.UBUL_FF0F_D3p.dff22(serial.CALY_SER_CNT3.qp_new(),       TOME_FF0F_SET3n, TUNY_FF0F_RST3n, SIG_VCC.qp_new());
  /* p02.ULAK*/ interrupts.ULAK_FF0F_D4p.dff22(ASOK_INT_JOYp,                       TOGA_FF0F_SET4n, TYME_FF0F_RST4n, SIG_VCC.qp_new());
  ...
  /* p07.ROLO*/ wire ROLO_FF0F_RDn = nand4(cpu_signals.TEDO_CPU_RDp.qp_new(), new_bus.SYKE_ADDR_HIp(), new_bus.SEMY_XX_0000xxxxp(), new_bus.SAPA_XX_xxxx1111p()); // schematic wrong, is NAND
