...
void GateBoy::reg_joy_write() {
  ...
  ///* p05.JUTE*/ JUTE_DBG_D0    .dff17(_ATOZ_FF00_WRn, ALUR_SYS_RSTn(), cpu_bus.BUS_CPU_D[0].qp_old());
  ///* p05.KECY*/ KECY_DBG_D1    .dff17(_ATOZ_FF00_WRn, ALUR_SYS_RSTn(), cpu_bus.BUS_CPU_D[1].qp_old());
  ///* p05.JALE*/ JALE_DBG_D2    .dff17(_ATOZ_FF00_WRn, ALUR_SYS_RSTn(), cpu_bus.BUS_CPU_D[2].qp_old());
  ///* p05.KYME*/ KYME_DBG_D3    .dff17(_ATOZ_FF00_WRn, ALUR_SYS_RSTn(), cpu_bus.BUS_CPU_D[3].qp_old());
  /* p05.KELY*/ joy.KELY_JOYP_UDLRp.dff17(_ATOZ_FF00_WRn, ALUR_SYS_RSTn(), old_bus.BUS_CPU_D04p.qp_old());
  /* p05.COFY*/ joy.COFY_JOYP_ABCSp.dff17(_ATOZ_FF00_WRn, ALUR_SYS_RSTn(), old_bus.BUS_CPU_D05p.qp_old());
  ///* p05.KUKO*/ KUKO_DBG_D6    .dff17(_ATOZ_FF00_WRn, ALUR_SYS_RSTn(), cpu_bus.BUS_CPU_D[6].qp_old());
  ///* p05.KERU*/ KERU_DBG_D7    .dff17(_ATOZ_FF00_WRn, ALUR_SYS_RSTn(), cpu_bus.BUS_CPU_D[7].qp_old());
}
