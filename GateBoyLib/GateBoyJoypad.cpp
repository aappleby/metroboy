...
void GateBoyJoypad::tock2(GateBoyResetDebug& rst, GateBoyClock& clk, uint8_t sys_buttons)
{
  ...
  /* p07.BURO*/ wire _BURO_FF60_D0p = not1(PIN32_GND); // FIXME hacking out debug stuff
  ...
  */
  ...
  /*PIN63*/ PIN63_JOY_P14.pin_out_hilo(_KARU, KELY_JOYP_UDLRp.qn_new());
  /*PIN62*/ PIN62_JOY_P15.pin_out_hilo(_CELA, COFY_JOYP_ABCSp.qn_new());
