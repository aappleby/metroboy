...
void GateBoyJoypad::read(GateBoyCpuBus& cpu_bus) {
  /* p10.ACAT*/ wire2 _ACAT_FF00_RDp =  and4(cpu_bus.TEDO_CPU_RDp.qp_new2(), cpu_bus.ANAP_FF_0xx00000(), cpu_bus.AKUG_A06n(), cpu_bus.BYKO_A05n());
...
void GateBoyJoypad::write_sync(GateBoyResetDebug& rst, GateBoyCpuBus& cpu_bus) {
  /* p10.ATOZ*/ wire2 _ATOZ_FF00_WRn = nand4b(cpu_bus.TAPU_CPU_WRp.qp_new2(), cpu_bus.ANAP_FF_0xx00000(), cpu_bus.AKUG_A06n(), cpu_bus.BYKO_A05n());
...
void GateBoyJoypad::tock2(GateBoyResetDebug& rst, GateBoyClock& clk, uint8_t sys_buttons)
{
  ...
  */
  ...
  /* p05.KARU*/ wire2 _KARU = or2(KELY_JOYP_UDLRp.qn_new2(), _KURA_JOYP_DBGn_new);
  /* p05.CELA*/ wire2 _CELA = or2(COFY_JOYP_ABCSp.qn_new2(), _KURA_JOYP_DBGn_new);
  ...
  wire2 _AWOB_WAKE_CPUp = AWOB_WAKE_CPU.qp_new2();
