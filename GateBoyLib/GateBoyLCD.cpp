...
void GateBoy::tock_lyc() {
...

  {
    ...
    /*#p23.RETU_LYC0_TO_CD0*/ wire RETU_LYC0_TO_CD0 = tri6_nn(_WEKU_FF45_RDn, reg_lyc.SYRY_LYC0n.qp_new());
    /* p23.VOJO_LYC1_TO_CD1*/ wire VOJO_LYC1_TO_CD1 = tri6_nn(_WEKU_FF45_RDn, reg_lyc.VUCE_LYC1n.qp_new());
    /* p23.RAZU_LYC2_TO_CD2*/ wire RAZU_LYC2_TO_CD2 = tri6_nn(_WEKU_FF45_RDn, reg_lyc.SEDY_LYC2n.qp_new());
    /* p23.REDY_LYC3_TO_CD3*/ wire REDY_LYC3_TO_CD3 = tri6_nn(_WEKU_FF45_RDn, reg_lyc.SALO_LYC3n.qp_new());
    /* p23.RACE_LYC4_TO_CD4*/ wire RACE_LYC4_TO_CD4 = tri6_nn(_WEKU_FF45_RDn, reg_lyc.SOTA_LYC4n.qp_new());
    /*#p23.VAZU_LYC5_TO_CD5*/ wire VAZU_LYC5_TO_CD5 = tri6_nn(_WEKU_FF45_RDn, reg_lyc.VAFA_LYC5n.qp_new());
    /* p23.VAFE_LYC6_TO_CD6*/ wire VAFE_LYC6_TO_CD6 = tri6_nn(_WEKU_FF45_RDn, reg_lyc.VEVO_LYC6n.qp_new());
    /* p23.PUFY_LYC7_TO_CD7*/ wire PUFY_LYC7_TO_CD7 = tri6_nn(_WEKU_FF45_RDn, reg_lyc.RAHA_LYC7n.qp_new());

    /* BUS_CPU_D00p*/ new_bus.BUS_CPU_D00p.tri(RETU_LYC0_TO_CD0);
    /* BUS_CPU_D01p*/ new_bus.BUS_CPU_D01p.tri(VOJO_LYC1_TO_CD1);
    /* BUS_CPU_D02p*/ new_bus.BUS_CPU_D02p.tri(RAZU_LYC2_TO_CD2);
    /* BUS_CPU_D03p*/ new_bus.BUS_CPU_D03p.tri(REDY_LYC3_TO_CD3);
    /* BUS_CPU_D04p*/ new_bus.BUS_CPU_D04p.tri(RACE_LYC4_TO_CD4);
    /* BUS_CPU_D05p*/ new_bus.BUS_CPU_D05p.tri(VAZU_LYC5_TO_CD5);
    /* BUS_CPU_D06p*/ new_bus.BUS_CPU_D06p.tri(VAFE_LYC6_TO_CD6);
    /* BUS_CPU_D07p*/ new_bus.BUS_CPU_D07p.tri(PUFY_LYC7_TO_CD7);
  }
...
void GateBoy::tock_lcd() {
  ...
  {
    /*#p21.TOCU*/ wire _TOCU_LX0n_old = not1(reg_lx.SAXO_LX0p.qp_old());
    /*#p21.VEPE*/ wire _VEPE_LX1n_old = not1(reg_lx.TYPO_LX1p.qp_old());
    /* p21.VUTY*/ wire _VUTY_LX2n_old = not1(reg_lx.VYZO_LX2p.qp_old());
    /* p21.VATE*/ wire _VATE_LX3n_old = not1(reg_lx.TELU_LX3p.qp_old());
    /* p21.TUDA*/ wire _TUDA_LX4n_old = not1(reg_lx.SUDE_LX4p.qp_old());
    /* p21.TAFY*/ wire _TAFY_LX5n_old = not1(reg_lx.TAHA_LX5p.qp_old());
    /* p21.TUJU*/ wire _TUJU_LX6n_old = not1(reg_lx.TYRY_LX6p.qp_old());

    /* p21.VOKU*/ wire _VOKU_LX000n_old = nand7(_TUJU_LX6n_old,            _TAFY_LX5n_old,            _TUDA_LX4n_old,            _VATE_LX3n_old,            _VUTY_LX2n_old,            _VEPE_LX1n_old,            _TOCU_LX0n_old);            // 0000000 == 0
    /* p21.TOZU*/ wire _TOZU_LX007n_old = nand7(_TUJU_LX6n_old,            _TAFY_LX5n_old,            _TUDA_LX4n_old,            _VATE_LX3n_old,            reg_lx.VYZO_LX2p.qp_old(), reg_lx.TYPO_LX1p.qp_old(), reg_lx.SAXO_LX0p.qp_old()); // 0000111 == 7
    /* p21.TECE*/ wire _TECE_LX045n_old = nand7(_TUJU_LX6n_old,            reg_lx.TAHA_LX5p.qp_old(), _TUDA_LX4n_old,            reg_lx.TELU_LX3p.qp_old(), reg_lx.VYZO_LX2p.qp_old(), _VEPE_LX1n_old,            reg_lx.SAXO_LX0p.qp_old()); // 0101101 == 45
    /*#p21.TEBO*/ wire _TEBO_LX083n_old = nand7(reg_lx.TYRY_LX6p.qp_old(), _TAFY_LX5n_old,            reg_lx.SUDE_LX4p.qp_old(), _VATE_LX3n_old,            _VUTY_LX2n_old,            reg_lx.TYPO_LX1p.qp_old(), reg_lx.SAXO_LX0p.qp_old()); // 1010011 == 83

    /*#p21.TEGY*/ wire _TEGY_STROBE_old = nand4(_VOKU_LX000n_old, _TOZU_LX007n_old, _TECE_LX045n_old, _TEBO_LX083n_old);

    /*#p21.SYGU*/ lcd.SYGU_LINE_STROBE.dff17(SONO_ABxxxxGH(), LYFE_VID_RSTn(), _TEGY_STROBE_old);
  }

  {
    /*#p21.MUDE*/ wire _MUDE_X_RSTn = nor2(lcd.RUTU_x113p.qp_new(), LYHA_VID_RSTp());
  ...
  {
    /*#p21.LAMA*/ wire _LAMA_Y_RSTn = nor2(lcd.MYTA_y153p.qp_new(), LYHA_VID_RSTp());
    /*#p21.MUWY*/ reg_ly.MUWY_LY0p.dff17(lcd.RUTU_x113p.qp_new(), _LAMA_Y_RSTn, reg_ly.MUWY_LY0p.qn_old());
...

  {
    ...
    /* p23.VEGA_LY0_TO_CD0*/ wire VEGA_LY0_TO_CD0 = tri6_nn(_VARO_FF44_RDn, _WURY_LY0n);
    /* p23.WUVA_LY1_TO_CD1*/ wire WUVA_LY1_TO_CD1 = tri6_nn(_VARO_FF44_RDn, _XEPO_LY1n);
    /* p23.LYCO_LY2_TO_CD2*/ wire LYCO_LY2_TO_CD2 = tri6_nn(_VARO_FF44_RDn, _MYFA_LY2n);
    /* p23.WOJY_LY3_TO_CD3*/ wire WOJY_LY3_TO_CD3 = tri6_nn(_VARO_FF44_RDn, _XUHY_LY3n);
    /* p23.VYNE_LY4_TO_CD4*/ wire VYNE_LY4_TO_CD4 = tri6_nn(_VARO_FF44_RDn, _WATA_LY4n);
    /* p23.WAMA_LY5_TO_CD5*/ wire WAMA_LY5_TO_CD5 = tri6_nn(_VARO_FF44_RDn, _XAGA_LY5n);
    /* p23.WAVO_LY6_TO_CD6*/ wire WAVO_LY6_TO_CD6 = tri6_nn(_VARO_FF44_RDn, _XUCE_LY6n);
    /* p23.WEZE_LY7_TO_CD7*/ wire WEZE_LY7_TO_CD7 = tri6_nn(_VARO_FF44_RDn, _XOWO_LY7n);

    /* BUS_CPU_D00p*/ new_bus.BUS_CPU_D00p.tri(VEGA_LY0_TO_CD0);
    /* BUS_CPU_D01p*/ new_bus.BUS_CPU_D01p.tri(WUVA_LY1_TO_CD1);
    /* BUS_CPU_D02p*/ new_bus.BUS_CPU_D02p.tri(LYCO_LY2_TO_CD2);
    /* BUS_CPU_D03p*/ new_bus.BUS_CPU_D03p.tri(WOJY_LY3_TO_CD3);
    /* BUS_CPU_D04p*/ new_bus.BUS_CPU_D04p.tri(VYNE_LY4_TO_CD4);
    /* BUS_CPU_D05p*/ new_bus.BUS_CPU_D05p.tri(WAMA_LY5_TO_CD5);
    /* BUS_CPU_D06p*/ new_bus.BUS_CPU_D06p.tri(WAVO_LY6_TO_CD6);
    /* BUS_CPU_D07p*/ new_bus.BUS_CPU_D07p.tri(WEZE_LY7_TO_CD7);
  }
}
...
void GateBoy::set_lcd_pins(wire SACU_CLKPIPE_evn) {
  ...
  /*PIN_52*/ lcd.PIN_52_LCD_CNTRL.set_pin_int(_POGU);
  ...
  /*PIN_56*/ lcd.PIN_56_LCD_FLIPS.set_pin_int(_KOFO);
  ...
  /*PIN_57*/ lcd.PIN_57_LCD_VSYNC.set_pin_int(_MURE_VSYNC);
  ...
  /*PIN_54*/ lcd.PIN_54_LCD_HSYNC.set_pin_int( _RUZE_HSYNCn);

  /*PIN_51*/ lcd.PIN_51_LCD_DATA0.set_pin_int(pix_pipes.REMY_LD0n.qp_new());
  /*PIN_50*/ lcd.PIN_50_LCD_DATA1.set_pin_int(pix_pipes.RAVO_LD1n.qp_new());

  /* p01.UMEK*/ wire _UMEK_DIV06n = not1(div.UGOT_DIV06p.qp_new());
  /*#p21.PURE*/ wire _PURE_x113n = not1(lcd.RUTU_x113p.qp_new());
  /*#p24.KASA*/ wire _KASA_LINE_ENDp = not1(_PURE_x113n);
  ...
  /*PIN_55*/ lcd.PIN_55_LCD_LATCH.set_pin_int(_KYMO_LINE_ENDn);
  ...
  /*PIN_53*/ lcd.PIN_53_LCD_CLOCK.set_pin_int(_RYPO_LCD_CLOCK);
