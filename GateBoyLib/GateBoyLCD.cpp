...
void GateBoy::tock_lyc() {
  {
    ...
    /* p21.RYME*/ wire RYME_LY_MATCH0n_old = xor2(reg_ly.MUWY_LY0p.qp_old(), reg_lyc.SYRY_LYC0n.qn_old());
    /* p21.TYDE*/ wire TYDE_LY_MATCH1n_old = xor2(reg_ly.MYRO_LY1p.qp_old(), reg_lyc.VUCE_LYC1n.qn_old());
    /* p21.REDA*/ wire REDA_LY_MATCH2n_old = xor2(reg_ly.LEXA_LY2p.qp_old(), reg_lyc.SEDY_LYC2n.qn_old());
    /* p21.RASY*/ wire RASY_LY_MATCH3n_old = xor2(reg_ly.LYDO_LY3p.qp_old(), reg_lyc.SALO_LYC3n.qn_old());
    /* p21.TYKU*/ wire TYKU_LY_MATCH4n_old = xor2(reg_ly.LOVU_LY4p.qp_old(), reg_lyc.SOTA_LYC4n.qn_old());
    /* p21.TUCY*/ wire TUCY_LY_MATCH5n_old = xor2(reg_ly.LEMA_LY5p.qp_old(), reg_lyc.VAFA_LYC5n.qn_old());
    /* p21.TERY*/ wire TERY_LY_MATCH6n_old = xor2(reg_ly.MATO_LY6p.qp_old(), reg_lyc.VEVO_LYC6n.qn_old());
    /* p21.SYFU*/ wire SYFU_LY_MATCH7n_old = xor2(reg_ly.LAFO_LY7p.qp_old(), reg_lyc.RAHA_LYC7n.qn_old());
...

  {
    ...
    /* p21.RUPO*/ reg_stat.RUPO_LYC_MATCHn.nor_latch(PAGO_LYC_MATCH_RST, reg_lyc.ROPO_LY_MATCH_SYNCp.qp_new());
  }
}
...
void GateBoy::tock_lcd() {
...

  {
    ...
    /* p21.VUTY*/ wire VUTY_LX2n_old = not1(reg_lx.VYZO_LX2p.qp_old());
    /* p21.VATE*/ wire VATE_LX3n_old = not1(reg_lx.TELU_LX3p.qp_old());
    /* p21.TUDA*/ wire TUDA_LX4n_old = not1(reg_lx.SUDE_LX4p.qp_old());
    /* p21.TAFY*/ wire TAFY_LX5n_old = not1(reg_lx.TAHA_LX5p.qp_old());
    /* p21.TUJU*/ wire TUJU_LX6n_old = not1(reg_lx.TYRY_LX6p.qp_old());

    /* p21.VOKU*/ wire VOKU_LX000n_old = nand7(TUJU_LX6n_old,            TAFY_LX5n_old,            TUDA_LX4n_old,            VATE_LX3n_old,            VUTY_LX2n_old,            VEPE_LX1n_old,            TOCU_LX0n_old);            // 0000000 == 0
    /* p21.TOZU*/ wire TOZU_LX007n_old = nand7(TUJU_LX6n_old,            TAFY_LX5n_old,            TUDA_LX4n_old,            VATE_LX3n_old,            reg_lx.VYZO_LX2p.qp_old(), reg_lx.TYPO_LX1p.qp_old(), reg_lx.SAXO_LX0p.qp_old()); // 0000111 == 7
    /* p21.TECE*/ wire TECE_LX045n_old = nand7(TUJU_LX6n_old,            reg_lx.TAHA_LX5p.qp_old(), TUDA_LX4n_old,            reg_lx.TELU_LX3p.qp_old(), reg_lx.VYZO_LX2p.qp_old(), VEPE_LX1n_old,            reg_lx.SAXO_LX0p.qp_old()); // 0101101 == 45
  ...
  {
    /* p23.WAFU*/ wire WAFU_FF44_RDp = and2(ASOT_CPU_RDp(), new_bus.XOGY_FF44p());
    /* p23.VARO*/ wire VARO_FF44_RDn = not1(WAFU_FF44_RDp);

    /*#p23.WURY*/ wire WURY_LY0n = not1(reg_ly.MUWY_LY0p.qp_new());
    /* p23.XEPO*/ wire XEPO_LY1n = not1(reg_ly.MYRO_LY1p.qp_new());
    /* p23.MYFA*/ wire MYFA_LY2n = not1(reg_ly.LEXA_LY2p.qp_new());
    /* p23.XUHY*/ wire XUHY_LY3n = not1(reg_ly.LYDO_LY3p.qp_new());
    /* p23.WATA*/ wire WATA_LY4n = not1(reg_ly.LOVU_LY4p.qp_new());
    /* p23.XAGA*/ wire XAGA_LY5n = not1(reg_ly.LEMA_LY5p.qp_new());
...
void GateBoy::set_lcd_pins(wire SACU_CLKPIPE_evn) {
  ...
  /*PIN_52*/ lcd.PIN_52_LCD_CNTRL.pin_out(POGU, POGU);
  ...
  /*PIN_56*/ lcd.PIN_56_LCD_FLIPS.pin_out(KOFO, KOFO);
  ...
  /*PIN_57*/ lcd.PIN_57_LCD_VSYNC.pin_out(MURE_VSYNC, MURE_VSYNC);
  ...
  /*PIN_55*/ lcd.PIN_55_LCD_LATCH.pin_out(KYMO_LINE_ENDn, KYMO_LINE_ENDn);
  ...
  /*PIN_53*/ lcd.PIN_53_LCD_CLOCK.pin_out(RYPO_LCD_CLOCK, RYPO_LCD_CLOCK);
