...
wire2 GateBoyLCD::ATEJ_LINE_RSTp_old() const {
  /* p28.ABAF*/ wire2 _ABAF_LINE_P000n_old = not1b(CATU_LINE_P000p.qp_old());
...
wire2 GateBoyLCD::ATEJ_LINE_RSTp_new() const {
  /* p28.ABAF*/ wire2 _ABAF_LINE_P000n_new = not1b(CATU_LINE_P000p.qp_new());
...
void GateBoyLCD::set_pin_vsync(GateBoyResetDebug& rst) {
  ...
  /*#p24.MURE*/ wire2 _MURE_VSYNC = not1b(MEDA_VSYNC_OUTn.qp_new());
...
void GateBoyLCD::set_pin_hsync(GateBoyResetDebug& rst, wire2 TYFA_CLKPIPE_odd, wire2 XYMU_RENDERINGp, wire2 XYDO_PX3p, wire2 AVAP_SCAN_DONE_TRIGp) {
  ...
  /*#p24.POME*/ POME.set(nor2b(AVAP_SCAN_DONE_TRIGp, POFY.qp_old()));
  /*#p24.RUJU*/ RUJU.set(or3(PAHO_X_8_SYNC.qp_new(), rst.TOFU_VID_RSTp(), POME.qp_new()));
  /*#p24.POFY*/ POFY.set(not1b(RUJU.qp_new()));
  /*#p24.POME*/ POME.set(nor2b(AVAP_SCAN_DONE_TRIGp, POFY.qp_new()));
  /*#p24.RUJU*/ RUJU.set(or3(PAHO_X_8_SYNC.qp_new(), rst.TOFU_VID_RSTp(), POME.qp_new()));
  /*#p24.POFY*/ POFY.set(not1b(RUJU.qp_new()));

  /*#p24.RUZE*/ wire2 _RUZE_HSYNCn = not1b(POFY.qp_new());
...
void GateBoyLCD::set_pin_latch(GateBoyDiv& div, RegLCDC& reg_lcdc) {
  /* p01.UMEK*/ wire2 _UMEK_DIV06n = not1b(div.UGOT_DIV06p.qp_new());
  /*#p24.KASA*/ wire2 _KASA_LINE_ENDp = not1b(reg_lx.PURE_LINE_ENDn());
  /*#p24.UMOB*/ wire2 _UMOB_DIV_06p = not1b(_UMEK_DIV06n);
  /*#p24.KEDY*/ wire2 _KEDY_LCDC_ENn = not1b(reg_lcdc.XONA_LCDC_LCDENn.qn_new());
