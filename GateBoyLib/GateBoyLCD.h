...
struct GateBoyLCD {
  ...
  /*#p28.ANOM*/ wire2 ANOM_LINE_RSTn_old() const { return nor2b(ATEJ_LINE_RSTp_old(), ATAR_VID_RSTp(_XODO_VID_RSTp.qp_old2())); }
  /* p28.ABAK*/ wire2 ABAK_LINE_RSTp_old() const { return  or2(ATEJ_LINE_RSTp_old(), AMYG_VID_RSTp(_XODO_VID_RSTp.qp_old2())); }
  ...
  /* p21.TADY*/ wire2 TADY_LINE_RSTn_old() const { return nor2b(ATEJ_LINE_RSTp_old(), TOFU_VID_RSTp(_XODO_VID_RSTp.qp_old2())); }
