  ...
  wire XUJA_SPR_OAM_LATCHn)
{
  ...
  /*#p28.BOTA*/ wire _BOTA_OAM_OEn  = nand3(cpu_bus.BOFE_LATCH_EXTn(), new_bus.SARO_ADDR_OAMp(), cpu_bus.ASOT_CPU_RDp()); // Schematic wrong, this is NAND
  ...
  /* p29.YDYV*/ oam_latch_a.YDYV_OAM_LATCH_DA0n.tp_latchn(_BODE_OAM_OEp, new_bus.BUS_OAM_DA00n.qp_new());
  /* p29.YCEB*/ oam_latch_a.YCEB_OAM_LATCH_DA1n.tp_latchn(_BODE_OAM_OEp, new_bus.BUS_OAM_DA01n.qp_new());
  /* p29.ZUCA*/ oam_latch_a.ZUCA_OAM_LATCH_DA2n.tp_latchn(_BODE_OAM_OEp, new_bus.BUS_OAM_DA02n.qp_new());
  /* p29.WONE*/ oam_latch_a.WONE_OAM_LATCH_DA3n.tp_latchn(_BODE_OAM_OEp, new_bus.BUS_OAM_DA03n.qp_new());
  /* p29.ZAXE*/ oam_latch_a.ZAXE_OAM_LATCH_DA4n.tp_latchn(_BODE_OAM_OEp, new_bus.BUS_OAM_DA04n.qp_new());
  /* p29.XAFU*/ oam_latch_a.XAFU_OAM_LATCH_DA5n.tp_latchn(_BODE_OAM_OEp, new_bus.BUS_OAM_DA05n.qp_new());
  /* p29.YSES*/ oam_latch_a.YSES_OAM_LATCH_DA6n.tp_latchn(_BODE_OAM_OEp, new_bus.BUS_OAM_DA06n.qp_new());
  /* p29.ZECA*/ oam_latch_a.ZECA_OAM_LATCH_DA7n.tp_latchn(_BODE_OAM_OEp, new_bus.BUS_OAM_DA07n.qp_new());

  /*#p31.XYKY*/ oam_latch_b.XYKY_OAM_LATCH_DB0n.tp_latchn(_BODE_OAM_OEp, new_bus.BUS_OAM_DB00n.qp_new());
  /* p31.YRUM*/ oam_latch_b.YRUM_OAM_LATCH_DB1n.tp_latchn(_BODE_OAM_OEp, new_bus.BUS_OAM_DB01n.qp_new());
  /* p31.YSEX*/ oam_latch_b.YSEX_OAM_LATCH_DB2n.tp_latchn(_BODE_OAM_OEp, new_bus.BUS_OAM_DB02n.qp_new());
  /* p31.YVEL*/ oam_latch_b.YVEL_OAM_LATCH_DB3n.tp_latchn(_BODE_OAM_OEp, new_bus.BUS_OAM_DB03n.qp_new());
  /* p31.WYNO*/ oam_latch_b.WYNO_OAM_LATCH_DB4n.tp_latchn(_BODE_OAM_OEp, new_bus.BUS_OAM_DB04n.qp_new());
  /* p31.CYRA*/ oam_latch_b.CYRA_OAM_LATCH_DB5n.tp_latchn(_BODE_OAM_OEp, new_bus.BUS_OAM_DB05n.qp_new());
  /* p31.ZUVE*/ oam_latch_b.ZUVE_OAM_LATCH_DB6n.tp_latchn(_BODE_OAM_OEp, new_bus.BUS_OAM_DB06n.qp_new());
  /* p31.ECED*/ oam_latch_b.ECED_OAM_LATCH_DB7n.tp_latchn(_BODE_OAM_OEp, new_bus.BUS_OAM_DB07n.qp_new());
}
  ...
  wire XUJY_OAM_CLKENp)
{
  ...
  /* p25.CUFE*/ wire _CUFE_OAM_CLKp = not_or_and3(new_bus.SARO_ADDR_OAMp(), MATU_DMA_RUNNINGp.qp_new(), clk.MOPA_xxxxEFGH()); // CUFE looks like BYHA minus an inverter
...
void GateBoyOamBus::ext_to_data_bus(GateBoyBuses& new_bus, const GateBoyDMA& dma, const GateBoyExtBus& ext_bus)
{
...
void GateBoyOamBus::vram_to_data_bus(GateBoyBuses& new_bus, const GateBoyDMA& dma, const GateBoyVramBus& vram_bus)
{
  (void)vram_bus;
...
void GateBoyOamBus::dma_to_addr_bus(GateBoyBuses& new_bus, GateBoyDMA& dma) {
  // DMA OAM write address driver
  /* p28.FODO_DMA0_TO_OA0*/ new_bus.BUS_OAM_A00n.tri6_nn(dma.DUGA_DMA_RUNNINGn(), dma.NAKY_DMA_A00p.qp_new());
  /* p28.FESA_DMA1_TO_OA1*/ new_bus.BUS_OAM_A01n.tri6_nn(dma.DUGA_DMA_RUNNINGn(), dma.PYRO_DMA_A01p.qp_new());
  /* p28.FAGO_DMA2_TO_OA2*/ new_bus.BUS_OAM_A02n.tri6_nn(dma.DUGA_DMA_RUNNINGn(), dma.NEFY_DMA_A02p.qp_new());
  /* p28.FYKY_DMA3_TO_OA3*/ new_bus.BUS_OAM_A03n.tri6_nn(dma.DUGA_DMA_RUNNINGn(), dma.MUTY_DMA_A03p.qp_new());
  /* p28.ELUG_DMA4_TO_OA4*/ new_bus.BUS_OAM_A04n.tri6_nn(dma.DUGA_DMA_RUNNINGn(), dma.NYKO_DMA_A04p.qp_new());
  /* p28.EDOL_DMA5_TO_OA5*/ new_bus.BUS_OAM_A05n.tri6_nn(dma.DUGA_DMA_RUNNINGn(), dma.PYLO_DMA_A05p.qp_new());
  /* p28.FYDU_DMA6_TO_OA6*/ new_bus.BUS_OAM_A06n.tri6_nn(dma.DUGA_DMA_RUNNINGn(), dma.NUTO_DMA_A06p.qp_new());
  /* p28.FETU_DMA7_TO_OA7*/ new_bus.BUS_OAM_A07n.tri6_nn(dma.DUGA_DMA_RUNNINGn(), dma.MUGU_DMA_A07p.qp_new());
};

//------------------------------------------------------------------------------------------------------------------------

void GateBoyOamBus::sprite_index_to_addr_bus(GateBoyBuses& new_bus, const GateBoyDMA& dma, const GateBoySpriteStore& sprite_store, NorLatch XYMU_RENDERINGn){
  (void)sprite_store;
  SigIn SIG_VCC = 1;
...
void GateBoyOamBus::scan_index_to_addr_bus(GateBoyBuses& new_bus, SpriteScanner& sprite_scanner, wire ACYL_SCANNINGp) {
...
void GateBoyOamBus::cpu_to_data_bus(
  ...
  wire ACYL_SCANNINGp)
{
  /* p28.XUTO*/ wire _XUTO_CPU_OAM_WRp = and2(new_bus.SARO_ADDR_OAMp(), cpu_bus.CUPA_CPU_WRp());
...
void GateBoyOamBus::tock(GateBoyBuses& new_bus, GateBoyCpuBus& cpu_bus, wire XOCE_xBCxxFGx, wire ACYL_SCANNINGp, wire XUJA_SPR_OAM_LATCHn, uint8_t* oam_ram) {
