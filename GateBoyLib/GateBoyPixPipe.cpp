  ...
  wire NYXU_BFETCH_RSTn)
{
...

  {
    ...
    /* p32.MYDE*/ MYDE_BGW_PIPE_A0.dff22(SACU_CLKPIPE_evn, _LAKY_BG_PIX_SET0, _LOTY_BG_PIX_RST0, PIN36_GND);
  }

  {
    ...
    /* p32.TOMY*/ TOMY_BGW_PIPE_B0.dff22(SACU_CLKPIPE_evn, _TUXE_BG_PIX_SET0, _SEJA_BG_PIX_RST0, PIN36_GND);
  }
}
  ...
  wire SACU_CLKPIPE_evn)
{
  ...
  /* p29.XEFY*/ wire _XEFY_SPRITE_DONEn  = not1b(WUTY_SFETCH_DONE_TRIGp);
  /* p34.MEFU*/ wire _MEFU_SPRITE_MASK0n = or3(_XEFY_SPRITE_DONEn, NYLU_SPR_PIPE_B0.qp_old2(), NURO_SPR_PIPE_A0.qp_old2());
  /* p34.MEVE*/ wire _MEVE_SPRITE_MASK1n = or3(_XEFY_SPRITE_DONEn, PEFU_SPR_PIPE_B1.qp_old2(), MASO_SPR_PIPE_A1.qp_old2());
  /* p34.MYZO*/ wire _MYZO_SPRITE_MASK2n = or3(_XEFY_SPRITE_DONEn, NATY_SPR_PIPE_B2.qp_old2(), LEFE_SPR_PIPE_A2.qp_old2());
  /* p34.RUDA*/ wire _RUDA_SPRITE_MASK3n = or3(_XEFY_SPRITE_DONEn, PYJO_SPR_PIPE_B3.qp_old2(), LESU_SPR_PIPE_A3.qp_old2());
  /* p34.VOTO*/ wire _VOTO_SPRITE_MASK4n = or3(_XEFY_SPRITE_DONEn, VARE_SPR_PIPE_B4.qp_old2(), WYHO_SPR_PIPE_A4.qp_old2());
  /* p34.VYSA*/ wire _VYSA_SPRITE_MASK5n = or3(_XEFY_SPRITE_DONEn, WEBA_SPR_PIPE_B5.qp_old2(), WORA_SPR_PIPE_A5.qp_old2());
  /* p34.TORY*/ wire _TORY_SPRITE_MASK6n = or3(_XEFY_SPRITE_DONEn, VANU_SPR_PIPE_B6.qp_old2(), VAFO_SPR_PIPE_A6.qp_old2());
  /* p34.WOPE*/ wire _WOPE_SPRITE_MASK7n = or3(_XEFY_SPRITE_DONEn, VUPY_SPR_PIPE_B7.qp_old2(), WUFY_SPR_PIPE_A7.qp_old2());
  ...
  // Sprite pipe A
  {
    ...
    /* p33.NURO*/ NURO_SPR_PIPE_A0.dff22(SACU_CLKPIPE_evn, _PABE_SPR_PIX_SET0, _PYZU_SPR_PIX_RST0, PIN36_GND);
  }
  ...
  // Sprite pipe B
  {
    ...
    /* p33.NYLU*/ NYLU_SPR_PIPE_B0.dff22(SACU_CLKPIPE_evn, _MEZU_SPR_PIX_SET0, _MOFY_SPR_PIX_RST0, PIN36_GND);
  }
}
  ...
  wire SACU_CLKPIPE_evn)
{
...

  {
    ...
    /* p26.VEZO*/ VEZO_MASK_PIPE_0.dff22(SACU_CLKPIPE_evn, _TEDE_MASK_PIPE_SET0, _WOKA_MASK_PIPE_RST0, PIN58_VCC);
  }
}
  ...
  wire SACU_CLKPIPE_evn)
{
...

  {
    ...
    /* p34.RUGO*/ RUGO_PAL_PIPE_D0.dff22(SACU_CLKPIPE_evn, _PUME_PAL_PIPE_SET0, _SUCO_PAL_PIPE_RST0, PIN36_GND);
  }
}
  ...
  RegOBP1 _reg_obp1)
{
  ...
  /*#p35.WUFU*/ wire WUFU_COL_OBP0_HI = amux4(_reg_obp0.XANA_OBP0_D7n.qp_any2(), VYRO_PAL_OBP0D, _reg_obp0.XYZE_OBP0_D5n.qp_any2(), VATA_PAL_OBP0C, _reg_obp0.XALO_OBP0_D3n.qp_any2(), VOLO_PAL_OBP0B, _reg_obp0.XUKY_OBP0_D1n.qp_any2(), VUGO_PAL_OBP0A);
  /*#p35.WALY*/ wire WALY_COL_OBP0_LO = amux4(_reg_obp0.XUPO_OBP0_D6n.qp_any2(), VYRO_PAL_OBP0D, _reg_obp0.XERU_OBP0_D4n.qp_any2(), VATA_PAL_OBP0C, _reg_obp0.XOVA_OBP0_D2n.qp_any2(), VOLO_PAL_OBP0B, _reg_obp0.XUFU_OBP0_D0n.qp_any2(), VUGO_PAL_OBP0A);
  ...
  /*#p35.MOKA*/ wire MOKA_COL_OBP1_HI = amux4(_reg_obp1.LUXO_OBP1_D7n.qp_any2(), LEDO_PAL_OBP1D, _reg_obp1.LUGU_OBP1_D5n.qp_any2(), LARU_PAL_OBP1C, _reg_obp1.LOSE_OBP1_D3n.qp_any2(), LYKY_PAL_OBP1B, _reg_obp1.LAWO_OBP1_D1n.qp_any2(), LOPU_PAL_OBP1A);
  /*#p35.MUFA*/ wire MUFA_COL_OBP1_LO = amux4(LEDO_PAL_OBP1D, _reg_obp1.LEPU_OBP1_D6n.qp_any2(), LARU_PAL_OBP1C, _reg_obp1.LUNE_OBP1_D4n.qp_any2(), LYKY_PAL_OBP1B, _reg_obp1.MOSA_OBP1_D2n.qp_any2(), LOPU_PAL_OBP1A, _reg_obp1.MOXY_OBP1_D0n.qp_any2());
  ...
  /*#p35.NELO*/ wire NELO_COL_BG_LO = amux4(NYPO_PAL_BGPD, _reg_bgp.MOGY_BGP_D6n.qp_any2(), NUMA_PAL_BGPC, _reg_bgp.MUKE_BGP_D4n.qp_any2(), NUXO_PAL_BGPB, _reg_bgp.PYLU_BGP_D2n.qp_any2(), POBU_PAL_BGPA, _reg_bgp.PAVO_BGP_D0n.qp_any2());
  /*#p35.NURA*/ wire NURA_COL_BG_HI = amux4(_reg_bgp.MENA_BGP_D7n.qp_any2(), NYPO_PAL_BGPD, _reg_bgp.MORU_BGP_D5n.qp_any2(), NUMA_PAL_BGPC, _reg_bgp.MAXY_BGP_D3n.qp_any2(), NUXO_PAL_BGPB, _reg_bgp.NUSY_BGP_D1n.qp_any2(), POBU_PAL_BGPA);
  ...
  REMY_LD0n.set(_REMY_LD0n);
  RAVO_LD1n.set(_RAVO_LD1n);
}
