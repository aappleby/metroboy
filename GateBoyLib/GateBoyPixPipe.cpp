  ...
  wire NYXU_BFETCH_RSTn)
{
...

  {
    ...
    /* p32.MYDE*/ MYDE_BGW_PIPE_A0.dff22(SACU_CLKPIPE_evn, _LAKY_BG_PIX_SET0, _LOTY_BG_PIX_RST0, PIN32_GND);
  }

  {
    ...
    /* p32.TOMY*/ TOMY_BGW_PIPE_B0.dff22(SACU_CLKPIPE_evn, _TUXE_BG_PIX_SET0, _SEJA_BG_PIX_RST0, PIN32_GND);
  }
}
  ...
  wire SACU_CLKPIPE_evn)
{
  ...
  // Sprite pipe A
  {
    ...
    /* p33.NURO*/ NURO_SPR_PIPE_A0.dff22(SACU_CLKPIPE_evn, _PABE_SPR_PIX_SET0, _PYZU_SPR_PIX_RST0, PIN32_GND);
  }
  ...
  // Sprite pipe B
  {
    ...
    /* p33.NYLU*/ NYLU_SPR_PIPE_B0.dff22(SACU_CLKPIPE_evn, _MEZU_SPR_PIX_SET0, _MOFY_SPR_PIX_RST0, PIN32_GND);
  }
}
  ...
  wire SACU_CLKPIPE_evn)
{
...

  {
    ...
    /* p34.RUGO*/ RUGO_PAL_PIPE_D0.dff22(SACU_CLKPIPE_evn, _PUME_PAL_PIPE_SET0, _SUCO_PAL_PIPE_RST0, PIN32_GND);
  }
}
