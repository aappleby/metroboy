...
{
  // FF41 STAT
  /* p21.SEPA*/ wire _SEPA_FF41_WRp = and2(CUPA_CPU_WRp(TAPU_CPU_WRp), cpu_bus.VARY_FF41p());
  /* p21.RYVE*/ wire _RYVE_FF41_WRn = not1(_SEPA_FF41_WRp);
  /* p21.ROXE*/ ROXE_STAT_HBI_ENn.dff9(_RYVE_FF41_WRn, WESY_SYS_RSTn(AVOR_SYS_RSTp), cpu_bus.BUS_CPU_D[3]);
  /* p21.RUFO*/ RUFO_STAT_VBI_ENn.dff9(_RYVE_FF41_WRn, WESY_SYS_RSTn(AVOR_SYS_RSTp), cpu_bus.BUS_CPU_D[4]);
  /* p21.REFE*/ REFE_STAT_OAI_ENn.dff9(_RYVE_FF41_WRn, WESY_SYS_RSTn(AVOR_SYS_RSTp), cpu_bus.BUS_CPU_D[5]);
  /* p21.RUGU*/ RUGU_STAT_LYI_ENn.dff9(_RYVE_FF41_WRn, WESY_SYS_RSTn(AVOR_SYS_RSTp), cpu_bus.BUS_CPU_D[6]);

  /* p21.RYJU*/ wire _RYJU_FF41_WRn = not1(_SEPA_FF41_WRp);
  /* p21.PAGO*/ wire _PAGO_LYC_MATCH_RST = or2(WESY_SYS_RSTn(AVOR_SYS_RSTp), _RYJU_FF41_WRn);
  ...
  /* p21.TOBE*/ wire _TOBE_FF41_RDp = and2(ASOT_CPU_RDp(TEDO_CPU_RDp), cpu_bus.VARY_FF41p());
  ...
  wire ROZE_FINE_COUNT_7n)
{
  ...
  /* p27.PYCO*/ PYCO_WIN_MATCHp.dff17(_ROCO_CLKPIPE_odd, XAPO_VID_RSTn, NUKO_WX_MATCHp);

  /* p01.XAPO*/ wire _XAPO_VID_RSTn = not1(XODO_VID_RSTp);
  /* p27.SOVY*/ SOVY_WIN_HITp.dff17(ALET_xBxDxFxH, _XAPO_VID_RSTn, RYDY_WIN_HITp.qp_old());
