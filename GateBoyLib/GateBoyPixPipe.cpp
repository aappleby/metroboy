...
void GateBoy::tock_window(DFF9 WYMO_LCDC_WINENn_old) {
  ...
  /* p27.POMO*/ wire _POMO_WY_MATCH2p = xnor2(reg_wy.NAGA_WY2n.qn_old(), lcd.reg_ly.LEXA_LY2p.qp_old());
  /* p27.NEVU*/ wire _NEVU_WY_MATCH3p = xnor2(reg_wy.MELA_WY3n.qn_old(), lcd.reg_ly.LYDO_LY3p.qp_old());
  /* p27.NOJO*/ wire _NOJO_WY_MATCH4p = xnor2(reg_wy.NULO_WY4n.qn_old(), lcd.reg_ly.LOVU_LY4p.qp_old());
  /* p27.PAGA*/ wire _PAGA_WY_MATCH5p = xnor2(reg_wy.NENE_WY5n.qn_old(), lcd.reg_ly.LEMA_LY5p.qp_old());
  /* p27.PEZO*/ wire _PEZO_WY_MATCH6p = xnor2(reg_wy.NUKA_WY6n.qn_old(), lcd.reg_ly.MATO_LY6p.qp_old());
  /* p27.NUPA*/ wire _NUPA_WY_MATCH7p = xnor2(reg_wy.NAFU_WY7n.qn_old(), lcd.reg_ly.LAFO_LY7p.qp_old());
  ...
  /* p27.PUKY*/ wire _PUKY_WX_MATCHn  = nand5(win_reg.REJO_WY_MATCH_LATCHp.qp_old(), _NEZO_WX_MATCH4p, _NORY_WX_MATCH5p, _NONO_WX_MATCH6p, _PASE_WX_MATCH7p);
  ...
  /* p22.WYVO*/ wire WYVO_FF4An = nand5(new_bus.WERO_ADDR_PPUp(), new_bus.XOLA_A00n(), new_bus.WESA_A01p(), new_bus.XUSY_A02n(), new_bus.WEPO_A03p());
  /* p22.WAGE*/ wire WAGE_FF4Bn = nand5(new_bus.WERO_ADDR_PPUp(), new_bus.WADO_A00p(), new_bus.WESA_A01p(), new_bus.XUSY_A02n(), new_bus.WEPO_A03p());
  /* p22.VYGA*/ wire VYGA_FF4Ap = not1(WYVO_FF4An);
  /* p22.VUMY*/ wire VUMY_FF4Bp = not1(WAGE_FF4Bn);

  /* p23.WEKO*/ wire _WEKO_FF4A_WRp = and2(CUPA_CPU_WRp(), VYGA_FF4Ap);
  /* p23.VEFU*/ wire _VEFU_FF4A_WRn = not1(_WEKO_FF4A_WRp);
  /* p23.WUZA*/ wire _WUZA_FF4B_WRp = and2(CUPA_CPU_WRp(), VUMY_FF4Bp);
  ...
  /* p27.SARY*/ win_reg.SARY_WY_MATCHp.dff17(TALU_xxCDEFxx(), XAPO_VID_RSTn(), _ROGE_WY_MATCHp);
  ...
  /* p23.WAXU*/ wire _WAXU_FF4A_RDp = and2(ASOT_CPU_RDp(), VYGA_FF4Ap);
  /* p23.VOMY*/ wire _VOMY_FF4A_RDn = not1(_WAXU_FF4A_RDp);
  /* p23.WYZE*/ wire _WYZE_FF4B_RDp = and2(ASOT_CPU_RDp(), VUMY_FF4Bp);
...
void GateBoy::tock_pix_output()
{
  ...
  /*#p35.WUFU*/ wire WUFU_COL_OBP0_HI = amux4(pix_pipes.reg_obp0.XANA_OBP0_D7n.qp_any(), VYRO_PAL_OBP0D, pix_pipes.reg_obp0.XYZE_OBP0_D5n.qp_any(), VATA_PAL_OBP0C, pix_pipes.reg_obp0.XALO_OBP0_D3n.qp_any(), VOLO_PAL_OBP0B, pix_pipes.reg_obp0.XUKY_OBP0_D1n.qp_any(), VUGO_PAL_OBP0A);
  /*#p35.WALY*/ wire WALY_COL_OBP0_LO = amux4(pix_pipes.reg_obp0.XUPO_OBP0_D6n.qp_any(), VYRO_PAL_OBP0D, pix_pipes.reg_obp0.XERU_OBP0_D4n.qp_any(), VATA_PAL_OBP0C, pix_pipes.reg_obp0.XOVA_OBP0_D2n.qp_any(), VOLO_PAL_OBP0B, pix_pipes.reg_obp0.XUFU_OBP0_D0n.qp_any(), VUGO_PAL_OBP0A);
  ...
  /*#p35.MOKA*/ wire MOKA_COL_OBP1_HI = amux4(pix_pipes.reg_obp1.LUXO_OBP1_D7n.qp_any(), LEDO_PAL_OBP1D, pix_pipes.reg_obp1.LUGU_OBP1_D5n.qp_any(), LARU_PAL_OBP1C, pix_pipes.reg_obp1.LOSE_OBP1_D3n.qp_any(), LYKY_PAL_OBP1B, pix_pipes.reg_obp1.LAWO_OBP1_D1n.qp_any(), LOPU_PAL_OBP1A);
  /*#p35.MUFA*/ wire MUFA_COL_OBP1_LO = amux4(LEDO_PAL_OBP1D, pix_pipes.reg_obp1.LEPU_OBP1_D6n.qp_any(), LARU_PAL_OBP1C, pix_pipes.reg_obp1.LUNE_OBP1_D4n.qp_any(), LYKY_PAL_OBP1B, pix_pipes.reg_obp1.MOSA_OBP1_D2n.qp_any(), LOPU_PAL_OBP1A, pix_pipes.reg_obp1.MOXY_OBP1_D0n.qp_any());
  ...
  /*#p35.NELO*/ wire NELO_COL_BG_LO = amux4(NYPO_PAL_BGPD, pix_pipes.reg_bgp.MOGY_BGP_D6n.qp_any(), NUMA_PAL_BGPC, pix_pipes.reg_bgp.MUKE_BGP_D4n.qp_any(), NUXO_PAL_BGPB, pix_pipes.reg_bgp.PYLU_BGP_D2n.qp_any(), POBU_PAL_BGPA, pix_pipes.reg_bgp.PAVO_BGP_D0n.qp_any());
  /*#p35.NURA*/ wire NURA_COL_BG_HI = amux4(pix_pipes.reg_bgp.MENA_BGP_D7n.qp_any(), NYPO_PAL_BGPD, pix_pipes.reg_bgp.MORU_BGP_D5n.qp_any(), NUMA_PAL_BGPC, pix_pipes.reg_bgp.MAXY_BGP_D3n.qp_any(), NUXO_PAL_BGPB, pix_pipes.reg_bgp.NUSY_BGP_D1n.qp_any(), POBU_PAL_BGPA);
