...
wire RegLX::TEGY_STROBE() const {
  /* p21.SAXO*/ wire _SAXO_LX0p = this->SAXO_LX0p.qp_new();
  /* p21.TYPO*/ wire _TYPO_LX1p = this->TYPO_LX1p.qp_new();
  /* p21.VYZO*/ wire _VYZO_LX2p = this->VYZO_LX2p.qp_new();
  /* p21.TELU*/ wire _TELU_LX3p = this->TELU_LX3p.qp_new();
  /* p21.SUDE*/ wire _SUDE_LX4p = this->SUDE_LX4p.qp_new();
  /* p21.TAHA*/ wire _TAHA_LX5p = this->TAHA_LX5p.qp_new();
  /* p21.TYRY*/ wire _TYRY_LX6p = this->TYRY_LX6p.qp_new();
