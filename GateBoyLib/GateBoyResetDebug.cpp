...
void GateBoyResetDebug::tock(const GateBoyClock& clk, wire2 sys_clkreq, wire2 sys_clkgood, wire2 UPOF_DIV15p) {
  ...
  /* p01.UNUT*/ wire2 _UNUT_POR_TRIGn = and2(TUBO_WAITINGp.qp_new2(), UPOF_DIV15p);
  /* p01.TABA*/ wire2 _TABA_POR_TRIGn = or3(UNOR_MODE_DBG2p(), UMUT_MODE_DBG1p(), _UNUT_POR_TRIGn);
  /*#p01.ALYP*/ wire2 _ALYP_RSTn = not1b(_TABA_POR_TRIGn);
  /*#p01.AFAR*/ wire2 _AFAR_RSTp  = nor2b(PIN71_RST.int_qp_new(), _ALYP_RSTn);
  ...
  /*#p25.SYCY*/ wire2 _SYCY_MODE_DBG2n = not1b(UNOR_MODE_DBG2p());
