...
void GateBoy::tock_reset(DFF17 UPOF_DIV15p) {
  ...
  /* p01.AFER*/ rst.AFER_SYS_RSTp.dff13(clk.BOGA_Axxxxxxx(), rst.UPOJ_MODE_PRODn(), rst.ASOL_POR_DONEn.qp_old());

  /* p01.UPYF*/ wire _UPYF = or2(rst.PIN_71_RST.qp_new(), clk.UCOB_CLKBADp());
