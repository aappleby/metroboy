...
void GateBoyResetDebug::tock(const GateBoyClock& clk, wire sys_clkreq, wire sys_clkgood, wire UPOF_DIV15p) {
  ...
  /* p01.UPYF*/ wire _UPYF = or2(PIN71_RST.qp_new(), clk.UCOB_CLKBADp());
  ...
  /*#p01.AFAR*/ wire _AFAR_RSTp  = nor2(PIN71_RST.qp_new(), _ALYP_RSTn);
  /* p01.ASOL*/ ASOL_POR_DONEn.nor_latch(PIN71_RST.qp_new(), _AFAR_RSTp); // Schematic wrong, this is a latch.

  SIG_CPU_EXT_CLKGOOD.set_new(sys_clkgood);
  SIG_CPU_EXT_RESETp.set_new(PIN71_RST.qp_new());
