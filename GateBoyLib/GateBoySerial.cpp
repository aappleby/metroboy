...
void GateBoySerial::read_sb(GateBoyCpuBus& cpu_bus, GateBoyBuses& new_bus)
{
  ...
  /*#p06.CUGY_SD0_TO_CD0*/ new_bus.BUS_CPU_D00p.tri6_pn(_UFEG_FF01_RDp, CUBA_SER_DATA0.qn_new());
  /* p06.DUDE_SD1_TO_CD1*/ new_bus.BUS_CPU_D01p.tri6_pn(_UFEG_FF01_RDp, DEGU_SER_DATA1.qn_new());
  /* p06.DETU_SD2_TO_CD2*/ new_bus.BUS_CPU_D02p.tri6_pn(_UFEG_FF01_RDp, DYRA_SER_DATA2.qn_new());
  /* p06.DASO_SD3_TO_CD3*/ new_bus.BUS_CPU_D03p.tri6_pn(_UFEG_FF01_RDp, DOJO_SER_DATA3.qn_new());
  /* p06.DAME_SD4_TO_CD4*/ new_bus.BUS_CPU_D04p.tri6_pn(_UFEG_FF01_RDp, DOVU_SER_DATA4.qn_new());
  /* p06.EVOK_SD5_TO_CD5*/ new_bus.BUS_CPU_D05p.tri6_pn(_UFEG_FF01_RDp, EJAB_SER_DATA5.qn_new());
  /* p06.EFAB_SD6_TO_CD6*/ new_bus.BUS_CPU_D06p.tri6_pn(_UFEG_FF01_RDp, EROD_SER_DATA6.qn_new());
  /*#p06.ETAK_SD7_TO_CD7*/ new_bus.BUS_CPU_D07p.tri6_pn(_UFEG_FF01_RDp, EDER_SER_DATA7.qn_new());
}

//------------------------------------------------------------------------------------------------------------------------

void GateBoySerial::read_sc(GateBoyCpuBus& cpu_bus, GateBoyBuses& new_bus)
{
  ...
  /* p06.CORE_SER0_TO_CD0*/ new_bus.BUS_CPU_D00p.tri6_pn(_UCOM_FF02_RDp, CULY_SER_DIR.qn_new());
  /* p06.ELUV_SER1_TO_CD1*/ new_bus.BUS_CPU_D07p.tri6_pn(_UCOM_FF02_RDp, ETAF_SER_RUNNING.qn_new());
}

//------------------------------------------------------------------------------------------------------------------------

void GateBoySerial::tock1(GateBoyResetDebug& rst, GateBoyCpuBus& cpu_bus, GateBoyDiv& div, GateBoyBuses& new_bus)
{
  ...
  /*#p06.CULY*/ CULY_SER_DIR.dff17(_UWAM_FF02_WRn, rst.ALUR_SYS_RSTn(), new_bus.BUS_CPU_D00p.qp_old());
  ...
  for (int rep = 0; rep < 2; rep++) {
...

    {
      ...
      /*#p06.ETAF*/ ETAF_SER_RUNNING.dff17_any(_UWAM_FF02_WRn, _CABY_XFER_RESET, new_bus.BUS_CPU_D07p.qp_old());
    }

    {
      ...
      /*PIN_68*/ PIN_68_SCK.pin_io_out_pull_hilo_any(CULY_SER_DIR.qp_new(), _KEXU, _KUJO);
      PIN_68_SCK.pin_io_in_oedp_any(0, 1);
    }
  }
  ...
  {
    /*#p06.CAVE*/ wire _CAVE_SER_CLK = mux2n(CULY_SER_DIR.qp_new(), COTY_SER_CLK.qp_new(), PIN_68_SCK.qp_new());
...
void GateBoySerial::tock2(GateBoyResetDebug& rst, GateBoyCpuBus& cpu_bus, GateBoyBuses& new_bus) {
  ...
  /* p06.CAGE*/ wire _CAGE_SER_IN_new  = not1(PIN_69_SIN.qp_new());
