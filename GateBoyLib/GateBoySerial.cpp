...
void GateBoySerial::tock(GateBoyResetDebug& rst, GateBoyCpuBus& cpu_bus, GateBoyDiv& div)
{
  ...
  {
    /* FF01 SER */
    /*#p06.CUGY*/ cpu_bus.BUS_CPU_D_out[0].tri6_pn(_UFEG_FF01_RDp, CUBA_SER_DATA0.qn_new());
    /* p06.DUDE*/ cpu_bus.BUS_CPU_D_out[1].tri6_pn(_UFEG_FF01_RDp, DEGU_SER_DATA1.qn_new());
    /* p06.DETU*/ cpu_bus.BUS_CPU_D_out[2].tri6_pn(_UFEG_FF01_RDp, DYRA_SER_DATA2.qn_new());
    /* p06.DASO*/ cpu_bus.BUS_CPU_D_out[3].tri6_pn(_UFEG_FF01_RDp, DOJO_SER_DATA3.qn_new());
    /* p06.DAME*/ cpu_bus.BUS_CPU_D_out[4].tri6_pn(_UFEG_FF01_RDp, DOVU_SER_DATA4.qn_new());
    /* p06.EVOK*/ cpu_bus.BUS_CPU_D_out[5].tri6_pn(_UFEG_FF01_RDp, EJAB_SER_DATA5.qn_new());
    /* p06.EFAB*/ cpu_bus.BUS_CPU_D_out[6].tri6_pn(_UFEG_FF01_RDp, EROD_SER_DATA6.qn_new());
    /*#p06.ETAK*/ cpu_bus.BUS_CPU_D_out[7].tri6_pn(_UFEG_FF01_RDp, EDER_SER_DATA7.qn_new());

    /* FF02 SER */
    /* p06.CORE*/ cpu_bus.BUS_CPU_D_out[0].tri6_pn(_UCOM_FF02_RDp, CULY_SER_DIR.qn_new());
    /* p06.ELUV*/ cpu_bus.BUS_CPU_D_out[7].tri6_pn(_UCOM_FF02_RDp, ETAF_SER_RUNNING.qn_new());
  }
}
