...
{
  /* p06.UFEG*/ wire _UFEG_FF01_RDp =  and4(cpu_bus.TEDO_CPU_RDp.qp_new2(), cpu_bus.SANO_FF00_FF03p(), cpu_bus.TOLA_A01n(), cpu_bus.BUS_CPU_A[ 0].qp_new2());
  /*#p06.CUGY*/ cpu_bus.BUS_CPU_D[0].tri6_pn(_UFEG_FF01_RDp, CUBA_SER_DATA0.qn_new2());
  /* p06.DUDE*/ cpu_bus.BUS_CPU_D[1].tri6_pn(_UFEG_FF01_RDp, DEGU_SER_DATA1.qn_new2());
  /* p06.DETU*/ cpu_bus.BUS_CPU_D[2].tri6_pn(_UFEG_FF01_RDp, DYRA_SER_DATA2.qn_new2());
  /* p06.DASO*/ cpu_bus.BUS_CPU_D[3].tri6_pn(_UFEG_FF01_RDp, DOJO_SER_DATA3.qn_new2());
  /* p06.DAME*/ cpu_bus.BUS_CPU_D[4].tri6_pn(_UFEG_FF01_RDp, DOVU_SER_DATA4.qn_new2());
  /* p06.EVOK*/ cpu_bus.BUS_CPU_D[5].tri6_pn(_UFEG_FF01_RDp, EJAB_SER_DATA5.qn_new2());
  /* p06.EFAB*/ cpu_bus.BUS_CPU_D[6].tri6_pn(_UFEG_FF01_RDp, EROD_SER_DATA6.qn_new2());
  /*#p06.ETAK*/ cpu_bus.BUS_CPU_D[7].tri6_pn(_UFEG_FF01_RDp, EDER_SER_DATA7.qn_new2());
}
...
{
  /* p06.UCOM*/ wire _UCOM_FF02_RDp =  and4(cpu_bus.TEDO_CPU_RDp.qp_new2(), cpu_bus.SANO_FF00_FF03p(), cpu_bus.BUS_CPU_A[ 1].qp_new2(), cpu_bus.TOVY_A00n());
  /* p06.CORE*/ cpu_bus.BUS_CPU_D[0].tri6_pn(_UCOM_FF02_RDp, CULY_SER_DIR.qn_new2());
  /* p06.ELUV*/ cpu_bus.BUS_CPU_D[7].tri6_pn(_UCOM_FF02_RDp, ETAF_SER_RUNNING.qn_new2());
}
...
void GateBoySerial::tock1(GateBoyResetDebug& rst, GateBoyCpuBus& cpu_bus, GateBoyDiv& div)
{
  ...
  /*#p06.UWAM*/ wire _UWAM_FF02_WRn = nand4b(cpu_bus.TOVY_A00n(), cpu_bus.BUS_CPU_A[ 1].qp_new2(), cpu_bus.TAPU_CPU_WRp.qp_new2(), cpu_bus.SANO_FF00_FF03p());
...
void GateBoySerial::tock2(GateBoyResetDebug& rst, GateBoyCpuBus& cpu_bus) {
  ...
  /* p06.URYS*/ wire _URYS_FF01_WRn = nand4b(cpu_bus.TAPU_CPU_WRp.qp_new2(), cpu_bus.SANO_FF00_FF03p(), cpu_bus.TOLA_A01n(),   cpu_bus.BUS_CPU_A[ 0].qp_new2());
  /* p06.COHY*/ wire _COHY_SER_DATA0_RSTn = or_and3(_URYS_FF01_WRn, cpu_bus.BUS_CPU_D[0].qp_new2(), rst.ALUR_SYS_RSTn());
  /* p06.DUMO*/ wire _DUMO_SER_DATA1_RSTn = or_and3(_URYS_FF01_WRn, cpu_bus.BUS_CPU_D[1].qp_new2(), rst.ALUR_SYS_RSTn());
  /* p06.DYBO*/ wire _DYBO_SER_DATA2_RSTn = or_and3(_URYS_FF01_WRn, cpu_bus.BUS_CPU_D[2].qp_new2(), rst.ALUR_SYS_RSTn());
  /* p06.DAJU*/ wire _DAJU_SER_DATA3_RSTn = or_and3(_URYS_FF01_WRn, cpu_bus.BUS_CPU_D[3].qp_new2(), rst.ALUR_SYS_RSTn());
  /* p06.DYLY*/ wire _DYLY_SER_DATA4_RSTn = or_and3(_URYS_FF01_WRn, cpu_bus.BUS_CPU_D[4].qp_new2(), rst.ALUR_SYS_RSTn());
  /* p06.EHUJ*/ wire _EHUJ_SER_DATA5_RSTn = or_and3(_URYS_FF01_WRn, cpu_bus.BUS_CPU_D[5].qp_new2(), rst.ALUR_SYS_RSTn());
  /* p06.EFAK*/ wire _EFAK_SER_DATA6_RSTn = or_and3(_URYS_FF01_WRn, cpu_bus.BUS_CPU_D[6].qp_new2(), rst.ALUR_SYS_RSTn());
  /* p06.EGUV*/ wire _EGUV_SER_DATA7_RSTn = or_and3(_URYS_FF01_WRn, cpu_bus.BUS_CPU_D[7].qp_new2(), rst.ALUR_SYS_RSTn());

  /* p06.DAKU*/ wire _DAKU_FF01_WRp = not1b(_URYS_FF01_WRn);
  /* p06.CUFU*/ wire _CUFU_SER_DATA0_SETn = nand2b(cpu_bus.BUS_CPU_D[0].qp_new2(), _DAKU_FF01_WRp);
  /* p06.DOCU*/ wire _DOCU_SER_DATA1_SETn = nand2b(cpu_bus.BUS_CPU_D[1].qp_new2(), _DAKU_FF01_WRp);
  /* p06.DELA*/ wire _DELA_SER_DATA2_SETn = nand2b(cpu_bus.BUS_CPU_D[2].qp_new2(), _DAKU_FF01_WRp);
  /* p06.DYGE*/ wire _DYGE_SER_DATA3_SETn = nand2b(cpu_bus.BUS_CPU_D[3].qp_new2(), _DAKU_FF01_WRp);
