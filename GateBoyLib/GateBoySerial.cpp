...
{
  /* p06.UFEG*/ wire2 _UFEG_FF01_RDp =  and4(cpu_bus.TEDO_CPU_RDp.qp_new2(), cpu_bus.SANO_FF00_FF03p(), cpu_bus.TOLA_A01n(), cpu_bus.BUS_CPU_A[ 0].qp_new2());
...
{
  /* p06.UCOM*/ wire2 _UCOM_FF02_RDp =  and4(cpu_bus.TEDO_CPU_RDp.qp_new2(), cpu_bus.SANO_FF00_FF03p(), cpu_bus.BUS_CPU_A[ 1].qp_new2(), cpu_bus.TOVY_A00n());
...
void GateBoySerial::tock1(GateBoyResetDebug& rst, GateBoyCpuBus& cpu_bus, GateBoyDiv& div)
{
  ...
  for (int rep = 0; rep < 2; rep++) {
    /*#p06.CAVE*/ wire2 _CAVE_SER_CLK = mux2nb(CULY_SER_DIR.qp_new2(), COTY_SER_CLK.qp_new2(), PIN68_SCK.qn_any2());
    /*#p06.DAWA*/ wire2 _DAWA_SER_CLK = or2(_CAVE_SER_CLK, ETAF_SER_RUNNING.qn_any2());
    ...
    {
      /*#p06.KEXU*/ wire2 _KEXU = nand2b(_DAWA_SER_CLK, CULY_SER_DIR.qp_new2()); // schematic wrong, first input is DAWA
      /*#p06.JAGO*/ wire2 _JAGO =  not1b(CULY_SER_DIR.qp_new2());
...
void GateBoySerial::tock2(GateBoyResetDebug& rst, GateBoyCpuBus& cpu_bus) {
  ...
  /* p06.URYS*/ wire2 _URYS_FF01_WRn = nand4b(cpu_bus.TAPU_CPU_WRp.qp_new2(), cpu_bus.SANO_FF00_FF03p(), cpu_bus.TOLA_A01n(),   cpu_bus.BUS_CPU_A[ 0].qp_new2());
  /* p06.COHY*/ wire2 _COHY_SER_DATA0_RSTn = or_and3(_URYS_FF01_WRn, cpu_bus.BUS_CPU_D[0].qp_new2(), rst.ALUR_SYS_RSTn());
  /* p06.DUMO*/ wire2 _DUMO_SER_DATA1_RSTn = or_and3(_URYS_FF01_WRn, cpu_bus.BUS_CPU_D[1].qp_new2(), rst.ALUR_SYS_RSTn());
  /* p06.DYBO*/ wire2 _DYBO_SER_DATA2_RSTn = or_and3(_URYS_FF01_WRn, cpu_bus.BUS_CPU_D[2].qp_new2(), rst.ALUR_SYS_RSTn());
  /* p06.DAJU*/ wire2 _DAJU_SER_DATA3_RSTn = or_and3(_URYS_FF01_WRn, cpu_bus.BUS_CPU_D[3].qp_new2(), rst.ALUR_SYS_RSTn());
  /* p06.DYLY*/ wire2 _DYLY_SER_DATA4_RSTn = or_and3(_URYS_FF01_WRn, cpu_bus.BUS_CPU_D[4].qp_new2(), rst.ALUR_SYS_RSTn());
  /* p06.EHUJ*/ wire2 _EHUJ_SER_DATA5_RSTn = or_and3(_URYS_FF01_WRn, cpu_bus.BUS_CPU_D[5].qp_new2(), rst.ALUR_SYS_RSTn());
  /* p06.EFAK*/ wire2 _EFAK_SER_DATA6_RSTn = or_and3(_URYS_FF01_WRn, cpu_bus.BUS_CPU_D[6].qp_new2(), rst.ALUR_SYS_RSTn());
  /* p06.EGUV*/ wire2 _EGUV_SER_DATA7_RSTn = or_and3(_URYS_FF01_WRn, cpu_bus.BUS_CPU_D[7].qp_new2(), rst.ALUR_SYS_RSTn());

  /* p06.DAKU*/ wire2 _DAKU_FF01_WRp = not1b(_URYS_FF01_WRn);
  /* p06.CUFU*/ wire2 _CUFU_SER_DATA0_SETn = nand2b(cpu_bus.BUS_CPU_D[0].qp_new2(), _DAKU_FF01_WRp);
  /* p06.DOCU*/ wire2 _DOCU_SER_DATA1_SETn = nand2b(cpu_bus.BUS_CPU_D[1].qp_new2(), _DAKU_FF01_WRp);
  /* p06.DELA*/ wire2 _DELA_SER_DATA2_SETn = nand2b(cpu_bus.BUS_CPU_D[2].qp_new2(), _DAKU_FF01_WRp);
  /* p06.DYGE*/ wire2 _DYGE_SER_DATA3_SETn = nand2b(cpu_bus.BUS_CPU_D[3].qp_new2(), _DAKU_FF01_WRp);
  /* p06.DOLA*/ wire2 _DOLA_SER_DATA4_SETn = nand2b(cpu_bus.BUS_CPU_D[4].qp_new2(), _DAKU_FF01_WRp);
  /* p06.ELOK*/ wire2 _ELOK_SER_DATA5_SETn = nand2b(cpu_bus.BUS_CPU_D[5].qp_new2(), _DAKU_FF01_WRp);
  /* p06.EDEL*/ wire2 _EDEL_SER_DATA6_SETn = nand2b(cpu_bus.BUS_CPU_D[6].qp_new2(), _DAKU_FF01_WRp);
