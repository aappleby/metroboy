...
void GateBoySerial::tock1(GateBoyResetDebug& rst, GateBoyCpuBus& cpu_bus, GateBoyDiv& div)
{
  ...
  /*#p06.UWAM*/ wire2 _UWAM_FF02_WRn = nand4(cpu_bus.TOVY_A00n(), cpu_bus.BUS_CPU_A[ 1].qp_new(), cpu_bus.TAPU_CPU_WRp.qp_new(), cpu_bus.SANO_FF00_FF03p());
  ...
  for (int rep = 0; rep < 2; rep++) {
    ...
    {
      /*#p06.COBA*/ wire2 _COBA_SER_CNT3n = not1(CALY_SER_CNT3.qp_any());
    ...
    {
      /*#p06.KEXU*/ wire2 _KEXU = nand2(_DAWA_SER_CLK, CULY_SER_DIR.qp_new()); // schematic wrong, first input is DAWA
      /*#p06.JAGO*/ wire2 _JAGO =  not1(CULY_SER_DIR.qp_new());
...

  {
    ...
    /*#p06.EDYL*/ wire2 _EDYL_SER_CLK = not1(_DAWA_SER_CLK);
...
void GateBoySerial::tock2(GateBoyResetDebug& rst, GateBoyCpuBus& cpu_bus) {
  ...
  /*#p06.DAWA*/ wire2 _DAWA_SER_CLK = or2(_CAVE_SER_CLK, ETAF_SER_RUNNING.qn_new());
  /*#p06.EDYL*/ wire2 _EDYL_SER_CLK = not1(_DAWA_SER_CLK);
  /* p06.EPYT*/ wire2 _EPYT_SER_CLK = not1(_EDYL_SER_CLK);
  /* p06.DEHO*/ wire2 _DEHO_SER_CLK = not1(_EPYT_SER_CLK);
  /* p06.DAWE*/ wire2 _DAWE_SER_CLK = not1(_DEHO_SER_CLK);

  // this pin has 4 wire2s attached, but they're not traced
  PIN69_SIN.pin_in_dp(1);

  /* p06.URYS*/ wire2 _URYS_FF01_WRn = nand4(cpu_bus.TAPU_CPU_WRp.qp_new(), cpu_bus.SANO_FF00_FF03p(), cpu_bus.TOLA_A01n(),   cpu_bus.BUS_CPU_A[ 0].qp_new());
  ...
  /* p06.DAKU*/ wire2 _DAKU_FF01_WRp = not1(_URYS_FF01_WRn);
  ...
  /* p06.CAGE*/ wire2 _CAGE_SER_IN_new  = not1(PIN69_SIN.int_qp_new());
