  ...
  wire TEKY_SFETCH_REQp_old)
{
  ...
  /* p27.SUDA*/ SUDA_SFETCH_REQp.dff17(clk.LAPE_AxCxExGx(), SIG_VCC, SOBU_SFETCH_REQp.qp_old());
  /* p27.SOBU*/ SOBU_SFETCH_REQp.dff17(clk.TAVA_xBxDxFxH(), SIG_VCC, TEKY_SFETCH_REQp_old);

  /*#p29.TYFO*/ TYFO_SFETCH_S0p_D1.dff17(clk.LAPE_AxCxExGx(), SIG_VCC,                TOXE_SFETCH_S0p.qp_old());
