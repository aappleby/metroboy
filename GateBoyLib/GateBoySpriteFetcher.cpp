  ...
  wire2 TEKY_SFETCH_REQp_old)
{
  ...
  /*#p27.SECA*/ wire2 _SECA_SFETCH_RSTn = nor3(_RYCE_SFETCH_TRIGp, rst.ROSY_VID_RSTp(), ATEJ_LINE_RSTp);

  // Feedback loop
  for (int feedback = 0; feedback < 2; feedback++) {
    /*#p29.TAME*/ wire2 _TAME_SFETCH_CLK_GATE = nand2(TESE_SFETCH_S2p.qp_any(), TOXE_SFETCH_S0p.qp_any());
    /*#p29.TOMA*/ wire2 _TOMA_SFETCH_xBxDxFxH_= nand2(clk.LAPE_AxCxExGx(), _TAME_SFETCH_CLK_GATE);
  ...
  /* p27.VEKU*/ wire2 _VEKU_SFETCH_RUNNING_RSTn = nor2(WUTY_SFETCH_DONE_TRIGp(), TAVE_PRELOAD_DONE_TRIGp); // def nor
