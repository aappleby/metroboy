...
void GateBoy::tock_sprite_scanner() {
  ...
  /*#p29.BYBA*/ sprite_scanner.BYBA_SCAN_DONE_Ap.dff17(clk.XUPY_ABxxEFxx(), lcd.BAGY_LINE_RSTn_new(), sprite_scanner.FETO_SCAN_DONEp_old());

  /*#p29.BEBU*/ wire BEBU_SCAN_DONE_TRIGn = or3(sprite_scanner.DOBA_SCAN_DONE_Bp.qp_new(), lcd.BALU_LINE_RSTp_new(), sprite_scanner.BYBA_SCAN_DONE_Ap.qn_new());
  /*#p29.AVAP*/ wire AVAP_SCAN_DONE_TRIGp = not1(BEBU_SCAN_DONE_TRIGn);
  /*#p28.ASEN*/ wire ASEN_SCAN_DONE_TRIGp = or2(rst.ATAR_VID_RSTp(), AVAP_SCAN_DONE_TRIGp);

  /*#p29.CENO*/ sprite_scanner.CENO_SCANNINGn.dff17(clk.XUPY_ABxxEFxx(), rst.ABEZ_VID_RSTn(),  sprite_scanner.BESU_SCANNINGp.qp_old());
  ...
  /* p30.XADU*/ sprite_scanner.XADU_SPRITE_IDX0p.dff13(clk.WUDA_xxCDxxGH(), SIG_VCC, _YFOT_OAM_A2p_old);
  /* p30.XEDY*/ sprite_scanner.XEDY_SPRITE_IDX1p.dff13(clk.WUDA_xxCDxxGH(), SIG_VCC, _YFOC_OAM_A3p_old);
  /* p30.ZUZE*/ sprite_scanner.ZUZE_SPRITE_IDX2p.dff13(clk.WUDA_xxCDxxGH(), SIG_VCC, _YVOM_OAM_A4p_old);
  /* p30.XOBE*/ sprite_scanner.XOBE_SPRITE_IDX3p.dff13(clk.WUDA_xxCDxxGH(), SIG_VCC, _YMEV_OAM_A5p_old);
  /* p30.YDUF*/ sprite_scanner.YDUF_SPRITE_IDX4p.dff13(clk.WUDA_xxCDxxGH(), SIG_VCC, _XEMU_OAM_A6p_old);
  /* p30.XECU*/ sprite_scanner.XECU_SPRITE_IDX5p.dff13(clk.WUDA_xxCDxxGH(), SIG_VCC, _YZET_OAM_A7p_old);
  ...
  for (int feedback = 0; feedback < 2; feedback++) {
    /* p28.GAVA*/ wire GAVA_SCAN_CLOCKp = or2(sprite_scanner.FETO_SCAN_DONEp_any(), clk.XUPY_ABxxEFxx());
    /* p28.YFEL*/ sprite_scanner.YFEL_SCAN0.dff17_any(GAVA_SCAN_CLOCKp,                   lcd.ANOM_LINE_RSTn_new(), sprite_scanner.YFEL_SCAN0.qn_any());
    /* p28.WEWY*/ sprite_scanner.WEWY_SCAN1.dff17_any(sprite_scanner.YFEL_SCAN0.qn_any(), lcd.ANOM_LINE_RSTn_new(), sprite_scanner.WEWY_SCAN1.qn_any());
    /* p28.GOSO*/ sprite_scanner.GOSO_SCAN2.dff17_any(sprite_scanner.WEWY_SCAN1.qn_any(), lcd.ANOM_LINE_RSTn_new(), sprite_scanner.GOSO_SCAN2.qn_any());
    /* p28.ELYN*/ sprite_scanner.ELYN_SCAN3.dff17_any(sprite_scanner.GOSO_SCAN2.qn_any(), lcd.ANOM_LINE_RSTn_new(), sprite_scanner.ELYN_SCAN3.qn_any());
    /* p28.FAHA*/ sprite_scanner.FAHA_SCAN4.dff17_any(sprite_scanner.ELYN_SCAN3.qn_any(), lcd.ANOM_LINE_RSTn_new(), sprite_scanner.FAHA_SCAN4.qn_any());
    /* p28.FONY*/ sprite_scanner.FONY_SCAN5.dff17_any(sprite_scanner.FAHA_SCAN4.qn_any(), lcd.ANOM_LINE_RSTn_new(), sprite_scanner.FONY_SCAN5.qn_any());
  }
}
