...
void SpriteScanner::tock(wire2 XUPY_ABxxEFxx, wire2 ANOM_LINE_RSTn) {
  ...
  for (int feedback = 0; feedback < 2; feedback++) {
    ...
    /* p28.ELYN*/ ELYN_SCAN3.dff17_any(GOSO_SCAN2.qn_any(), ANOM_LINE_RSTn, ELYN_SCAN3.qn_any());
    /* p28.FAHA*/ FAHA_SCAN4.dff17_any(ELYN_SCAN3.qn_any(), ANOM_LINE_RSTn, FAHA_SCAN4.qn_any());
    /* p28.FONY*/ FONY_SCAN5.dff17_any(FAHA_SCAN4.qn_any(), ANOM_LINE_RSTn, FONY_SCAN5.qn_any());
  }
}
