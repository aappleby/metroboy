...
void SpriteScanner::tock(GateBoyResetDebug& rst, GateBoyClock& clk, GateBoyLCD& lcd, GateBoySpriteStore& sprite_store, GateBoyOamBus& oam_bus, NorLatch XYMU_RENDERINGn) {
  SigIn SIG_VCC = 1;
  ...
  /*#p30.WUZY_STORE_I0*/ sprite_store.BUS_SPR_I0.tri6_nn(_BUZA_STORE_SPRITE_INDXn_new, XADU_SPRITE_IDX0p.qn_new());
  /* p30.WYSE_STORE_I1*/ sprite_store.BUS_SPR_I1.tri6_nn(_BUZA_STORE_SPRITE_INDXn_new, XEDY_SPRITE_IDX1p.qn_new());
  /* p30.ZYSU_STORE_I2*/ sprite_store.BUS_SPR_I2.tri6_nn(_BUZA_STORE_SPRITE_INDXn_new, ZUZE_SPRITE_IDX2p.qn_new());
  /* p30.WYDA_STORE_I3*/ sprite_store.BUS_SPR_I3.tri6_nn(_BUZA_STORE_SPRITE_INDXn_new, XOBE_SPRITE_IDX3p.qn_new());
  /* p30.WUCO_STORE_I4*/ sprite_store.BUS_SPR_I4.tri6_nn(_BUZA_STORE_SPRITE_INDXn_new, YDUF_SPRITE_IDX4p.qn_new());
  /* p30.WEZA_STORE_I5*/ sprite_store.BUS_SPR_I5.tri6_nn(_BUZA_STORE_SPRITE_INDXn_new, XECU_SPRITE_IDX5p.qn_new());
