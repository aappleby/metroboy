...
struct SpriteScanner {
  ...
  wire FETO_SCAN_DONEp_old() const {
    /*#p28.FETO*/ wire _FETO_SCAN_DONEp_old = and4(YFEL_SCAN0.qp_old2(), WEWY_SCAN1.qp_old2(), GOSO_SCAN2.qp_old2(), FONY_SCAN5.qp_old2()); // 32 + 4 + 2 + 1 = 39
    return _FETO_SCAN_DONEp_old;
  }

  wire FETO_SCAN_DONEp_new() const {
    /*#p28.FETO*/ wire _FETO_SCAN_DONEp_new = and4(YFEL_SCAN0.qp_new2(), WEWY_SCAN1.qp_new2(), GOSO_SCAN2.qp_new2(), FONY_SCAN5.qp_new2()); // 32 + 4 + 2 + 1 = 39
    return _FETO_SCAN_DONEp_new;
  }

  wire FETO_SCAN_DONEp_any() const {
    /*#p28.FETO*/ wire _FETO_SCAN_DONEp_any = and4(YFEL_SCAN0.qp_any2(), WEWY_SCAN1.qp_any2(), GOSO_SCAN2.qp_any2(), FONY_SCAN5.qp_any2()); // 32 + 4 + 2 + 1 = 39
    return _FETO_SCAN_DONEp_any;
  }

  wire AVAP_SCAN_DONE_TRIGp_old(wire BALU_LINE_RSTp) const {
    /*#p29.BEBU*/ wire _BEBU_SCAN_DONE_TRIGn_old = or3(DOBA_SCAN_DONE_Bp.qp_old2(), BALU_LINE_RSTp, BYBA_SCAN_DONE_Ap.qn_old2());
    /*#p29.AVAP*/ wire _AVAP_SCAN_DONE_TRIGp_old = not1b(_BEBU_SCAN_DONE_TRIGn_old);
    return _AVAP_SCAN_DONE_TRIGp_old;
  }

  wire AVAP_SCAN_DONE_TRIGp_new(wire BALU_LINE_RSTp) const {
    /*#p29.BEBU*/ wire _BEBU_SCAN_DONE_TRIGn_new = or3(DOBA_SCAN_DONE_Bp.qp_new2(), BALU_LINE_RSTp, BYBA_SCAN_DONE_Ap.qn_new2());
    /*#p29.AVAP*/ wire _AVAP_SCAN_DONE_TRIGp_new = not1b(_BEBU_SCAN_DONE_TRIGn_new);
    return _AVAP_SCAN_DONE_TRIGp_new;
  }

  /* p29.CEHA*/ wire CEHA_SCANNINGp() const { return not1b(CENO_SCANNINGp.qn_new2()); }
  /*#p29.BYJO*/ wire BYJO_SCANNINGn() const { return not1b(CEHA_SCANNINGp()); }
