...
void SpriteStore::get_sprite(SpriteFirstMatch first_match) {
  ...
  /* p30.ZETU*/ BUS_SPR_I0.tri6_nn(_FURO_SPRITE0_GETn, YGUS_STORE0_I0n_odd.qp_new());
  /* p30.ZECE*/ BUS_SPR_I1.tri6_nn(_FURO_SPRITE0_GETn, YSOK_STORE0_I1n_odd.qp_new());
  /* p30.ZAVE*/ BUS_SPR_I2.tri6_nn(_FURO_SPRITE0_GETn, YZEP_STORE0_I2n_odd.qp_new());
  /* p30.WOKO*/ BUS_SPR_I3.tri6_nn(_FURO_SPRITE0_GETn, WYTE_STORE0_I3n_odd.qp_new());
  /* p30.ZUMU*/ BUS_SPR_I4.tri6_nn(_FURO_SPRITE0_GETn, ZONY_STORE0_I4n_odd.qp_new());
  /*#p30.ZEDY*/ BUS_SPR_I5.tri6_nn(_FURO_SPRITE0_GETn, YWAK_STORE0_I5n_odd.qp_new());
  /* p30.WEHE*/ BUS_SPR_L0.tri6_nn(_FURO_SPRITE0_GETn, GYHO_STORE0_L0n_odd.qp_new());
  /* p30.BUKY*/ BUS_SPR_L1.tri6_nn(_FURO_SPRITE0_GETn, CUFO_STORE0_L1n_odd.qp_new());
  /* p30.AJAL*/ BUS_SPR_L2.tri6_nn(_FURO_SPRITE0_GETn, BOZU_STORE0_L2n_odd.qp_new());
  /* p30.GOFO*/ BUS_SPR_L3.tri6_nn(_FURO_SPRITE0_GETn, FYHY_STORE0_L3n_odd.qp_new());

  /*#p30.CUBO*/ BUS_SPR_I0.tri6_nn(_DYDO_SPRITE1_GETn, CADU_STORE1_I0n_odd.qp_new());
  /* p30.CELU*/ BUS_SPR_I1.tri6_nn(_DYDO_SPRITE1_GETn, CEBO_STORE1_I1n_odd.qp_new());
  /* p30.CEGY*/ BUS_SPR_I2.tri6_nn(_DYDO_SPRITE1_GETn, CUFA_STORE1_I2n_odd.qp_new());
  /* p30.BETY*/ BUS_SPR_I3.tri6_nn(_DYDO_SPRITE1_GETn, COMA_STORE1_I3n_odd.qp_new());
  /* p30.CYBY*/ BUS_SPR_I4.tri6_nn(_DYDO_SPRITE1_GETn, CUZA_STORE1_I4n_odd.qp_new());
  /* p30.BEMO*/ BUS_SPR_I5.tri6_nn(_DYDO_SPRITE1_GETn, CAJY_STORE1_I5n_odd.qp_new());
  /* p30.BYRO*/ BUS_SPR_L0.tri6_nn(_DYDO_SPRITE1_GETn, AMES_STORE1_L0n_odd.qp_new());
  /* p30.AHUM*/ BUS_SPR_L1.tri6_nn(_DYDO_SPRITE1_GETn, AROF_STORE1_L1n_odd.qp_new());
  /* p30.BACO*/ BUS_SPR_L2.tri6_nn(_DYDO_SPRITE1_GETn, ABOP_STORE1_L2n_odd.qp_new());
  /* p30.BEFE*/ BUS_SPR_L3.tri6_nn(_DYDO_SPRITE1_GETn, ABUG_STORE1_L3n_odd.qp_new());

  /* p30.CUBE*/ BUS_SPR_I0.tri6_nn(_FAME_SPRITE2_GETn, BUHE_STORE2_I0n_odd.qp_new());
  /* p30.AFOZ*/ BUS_SPR_I1.tri6_nn(_FAME_SPRITE2_GETn, BYHU_STORE2_I1n_odd.qp_new());
  /* p30.APON*/ BUS_SPR_I2.tri6_nn(_FAME_SPRITE2_GETn, BECA_STORE2_I2n_odd.qp_new());
  /* p30.CUVU*/ BUS_SPR_I3.tri6_nn(_FAME_SPRITE2_GETn, BULU_STORE2_I3n_odd.qp_new());
  /* p30.CYRO*/ BUS_SPR_I4.tri6_nn(_FAME_SPRITE2_GETn, BUNA_STORE2_I4n_odd.qp_new());
  /* p30.AXEC*/ BUS_SPR_I5.tri6_nn(_FAME_SPRITE2_GETn, BOXA_STORE2_I5n_odd.qp_new());
  /* p30.ZUKE*/ BUS_SPR_L0.tri6_nn(_FAME_SPRITE2_GETn, YLOV_STORE2_L0n_odd.qp_new());
  /* p30.WERE*/ BUS_SPR_L1.tri6_nn(_FAME_SPRITE2_GETn, XOSY_STORE2_L1n_odd.qp_new());
  /* p30.WUXE*/ BUS_SPR_L2.tri6_nn(_FAME_SPRITE2_GETn, XAZY_STORE2_L2n_odd.qp_new());
  /* p30.ZABY*/ BUS_SPR_L3.tri6_nn(_FAME_SPRITE2_GETn, YKUK_STORE2_L3n_odd.qp_new());

  /* p30.ENAP*/ BUS_SPR_I0.tri6_nn(_GYMA_SPRITE3_GETn, DEVY_STORE3_I0n_odd.qp_new());
  /* p30.DYGO*/ BUS_SPR_I1.tri6_nn(_GYMA_SPRITE3_GETn, DESE_STORE3_I1n_odd.qp_new());
  /* p30.DOWA*/ BUS_SPR_I2.tri6_nn(_GYMA_SPRITE3_GETn, DUNY_STORE3_I2n_odd.qp_new());
  /* p30.DONY*/ BUS_SPR_I3.tri6_nn(_GYMA_SPRITE3_GETn, DUHA_STORE3_I3n_odd.qp_new());
  /* p30.EFUD*/ BUS_SPR_I4.tri6_nn(_GYMA_SPRITE3_GETn, DEBA_STORE3_I4n_odd.qp_new());
  /* p30.DEZU*/ BUS_SPR_I5.tri6_nn(_GYMA_SPRITE3_GETn, DAFU_STORE3_I5n_odd.qp_new());
  /* p30.ZEXE*/ BUS_SPR_L0.tri6_nn(_GYMA_SPRITE3_GETn, ZURO_STORE3_L0n_odd.qp_new());
  /* p30.YWAV*/ BUS_SPR_L1.tri6_nn(_GYMA_SPRITE3_GETn, ZYLU_STORE3_L1n_odd.qp_new());
  /* p30.YJEM*/ BUS_SPR_L2.tri6_nn(_GYMA_SPRITE3_GETn, ZENE_STORE3_L2n_odd.qp_new());
  /* p30.ZYPO*/ BUS_SPR_L3.tri6_nn(_GYMA_SPRITE3_GETn, ZURY_STORE3_L3n_odd.qp_new());

  /* p30.WUXU*/ BUS_SPR_I0.tri6_nn(_GOWO_SPRITE4_GETn, XAVE_STORE4_I0n_odd.qp_new());
  /* p30.WEPY*/ BUS_SPR_I1.tri6_nn(_GOWO_SPRITE4_GETn, XEFE_STORE4_I1n_odd.qp_new());
  /* p30.WERU*/ BUS_SPR_I2.tri6_nn(_GOWO_SPRITE4_GETn, WANU_STORE4_I2n_odd.qp_new());
  /* p30.XYRE*/ BUS_SPR_I3.tri6_nn(_GOWO_SPRITE4_GETn, XABO_STORE4_I3n_odd.qp_new());
  /* p30.WOXY*/ BUS_SPR_I4.tri6_nn(_GOWO_SPRITE4_GETn, XEGE_STORE4_I4n_odd.qp_new());
  /* p30.WAJA*/ BUS_SPR_I5.tri6_nn(_GOWO_SPRITE4_GETn, XYNU_STORE4_I5n_odd.qp_new());
  /* p30.BUCE*/ BUS_SPR_L0.tri6_nn(_GOWO_SPRITE4_GETn, CAPO_STORE4_L0n_odd.qp_new());
  /* p30.BEVY*/ BUS_SPR_L1.tri6_nn(_GOWO_SPRITE4_GETn, CAJU_STORE4_L1n_odd.qp_new());
  /* p30.BOVE*/ BUS_SPR_L2.tri6_nn(_GOWO_SPRITE4_GETn, CONO_STORE4_L2n_odd.qp_new());
  /* p30.BYDO*/ BUS_SPR_L3.tri6_nn(_GOWO_SPRITE4_GETn, CUMU_STORE4_L3n_odd.qp_new());

  /* p30.DOBO*/ BUS_SPR_I0.tri6_nn(_GYGY_SPRITE5_GETn, EKOP_STORE5_I0n_odd.qp_new());
  /* p30.DYNY*/ BUS_SPR_I1.tri6_nn(_GYGY_SPRITE5_GETn, ETYM_STORE5_I1n_odd.qp_new());
  /* p30.WAGA*/ BUS_SPR_I2.tri6_nn(_GYGY_SPRITE5_GETn, GORU_STORE5_I2n_odd.qp_new());
  /* p30.DUZA*/ BUS_SPR_I3.tri6_nn(_GYGY_SPRITE5_GETn, EBEX_STORE5_I3n_odd.qp_new());
  /* p30.DALY*/ BUS_SPR_I4.tri6_nn(_GYGY_SPRITE5_GETn, ETAV_STORE5_I4n_odd.qp_new());
  /* p30.DALO*/ BUS_SPR_I5.tri6_nn(_GYGY_SPRITE5_GETn, EKAP_STORE5_I5n_odd.qp_new());
  /* p30.BACE*/ BUS_SPR_L0.tri6_nn(_GYGY_SPRITE5_GETn, ACEP_STORE5_L0n_odd.qp_new());
  /* p30.BUJA*/ BUS_SPR_L1.tri6_nn(_GYGY_SPRITE5_GETn, ABEG_STORE5_L1n_odd.qp_new());
  /* p30.BODU*/ BUS_SPR_L2.tri6_nn(_GYGY_SPRITE5_GETn, ABUX_STORE5_L2n_odd.qp_new());
  /* p30.AWAT*/ BUS_SPR_L3.tri6_nn(_GYGY_SPRITE5_GETn, ANED_STORE5_L3n_odd.qp_new());

  /* p30.WATO*/ BUS_SPR_I0.tri6_nn(_XYME_SPRITE6_GETn, GABO_STORE6_I0n_odd.qp_new());
  /* p30.WYWY*/ BUS_SPR_I1.tri6_nn(_XYME_SPRITE6_GETn, GACY_STORE6_I1n_odd.qp_new());
  /* p30.EZOC*/ BUS_SPR_I2.tri6_nn(_XYME_SPRITE6_GETn, FOGO_STORE6_I2n_odd.qp_new());
  /* p30.WABO*/ BUS_SPR_I3.tri6_nn(_XYME_SPRITE6_GETn, GOHU_STORE6_I3n_odd.qp_new());
  /* p30.ELYC*/ BUS_SPR_I4.tri6_nn(_XYME_SPRITE6_GETn, FOXY_STORE6_I4n_odd.qp_new());
  /* p30.WOCY*/ BUS_SPR_I5.tri6_nn(_XYME_SPRITE6_GETn, GECU_STORE6_I5n_odd.qp_new());
  /* p30.YBUK*/ BUS_SPR_L0.tri6_nn(_XYME_SPRITE6_GETn, ZUMY_STORE6_L0n_odd.qp_new());
  /* p30.YKOZ*/ BUS_SPR_L1.tri6_nn(_XYME_SPRITE6_GETn, ZAFU_STORE6_L1n_odd.qp_new());
  /* p30.ZYTO*/ BUS_SPR_L2.tri6_nn(_XYME_SPRITE6_GETn, ZEXO_STORE6_L2n_odd.qp_new());
  /* p30.ZUDO*/ BUS_SPR_L3.tri6_nn(_XYME_SPRITE6_GETn, ZUBE_STORE6_L3n_odd.qp_new());

  /* p30.WAKO*/ BUS_SPR_I0.tri6_nn(_GUGY_SPRITE7_GETn, GULE_STORE7_I0n_odd.qp_new());
  /* p30.WYGO*/ BUS_SPR_I1.tri6_nn(_GUGY_SPRITE7_GETn, GYNO_STORE7_I1n_odd.qp_new());
  /* p30.ELEP*/ BUS_SPR_I2.tri6_nn(_GUGY_SPRITE7_GETn, FEFA_STORE7_I2n_odd.qp_new());
  /* p30.ETAD*/ BUS_SPR_I3.tri6_nn(_GUGY_SPRITE7_GETn, FYSU_STORE7_I3n_odd.qp_new());
  /* p30.WABA*/ BUS_SPR_I4.tri6_nn(_GUGY_SPRITE7_GETn, GESY_STORE7_I4n_odd.qp_new());
  /* p30.EVYT*/ BUS_SPR_I5.tri6_nn(_GUGY_SPRITE7_GETn, FUZO_STORE7_I5n_odd.qp_new());
  /* p30.WAXE*/ BUS_SPR_L0.tri6_nn(_GUGY_SPRITE7_GETn, XYNA_STORE7_L0n_odd.qp_new());
  /* p30.YPOZ*/ BUS_SPR_L1.tri6_nn(_GUGY_SPRITE7_GETn, YGUM_STORE7_L1n_odd.qp_new());
  /* p30.WABU*/ BUS_SPR_L2.tri6_nn(_GUGY_SPRITE7_GETn, XAKU_STORE7_L2n_odd.qp_new());
  /* p30.WANA*/ BUS_SPR_L3.tri6_nn(_GUGY_SPRITE7_GETn, XYGO_STORE7_L3n_odd.qp_new());

  /* p30.APOC*/ BUS_SPR_I0.tri6_nn(_DENY_SPRITE8_GETn, AXUV_STORE8_I0n_odd.qp_new());
  /* p30.AKYH*/ BUS_SPR_I1.tri6_nn(_DENY_SPRITE8_GETn, BADA_STORE8_I1n_odd.qp_new());
  /* p30.AFEN*/ BUS_SPR_I2.tri6_nn(_DENY_SPRITE8_GETn, APEV_STORE8_I2n_odd.qp_new());
  /* p30.APYV*/ BUS_SPR_I3.tri6_nn(_DENY_SPRITE8_GETn, BADO_STORE8_I3n_odd.qp_new());
  /* p30.APOB*/ BUS_SPR_I4.tri6_nn(_DENY_SPRITE8_GETn, BEXY_STORE8_I4n_odd.qp_new());
  /* p30.ADYB*/ BUS_SPR_I5.tri6_nn(_DENY_SPRITE8_GETn, BYHE_STORE8_I5n_odd.qp_new());
  /* p30.BOSO*/ BUS_SPR_L0.tri6_nn(_DENY_SPRITE8_GETn, AZAP_STORE8_L0n_odd.qp_new());
  /* p30.BAZU*/ BUS_SPR_L1.tri6_nn(_DENY_SPRITE8_GETn, AFYX_STORE8_L1n_odd.qp_new());
  /* p30.AHAC*/ BUS_SPR_L2.tri6_nn(_DENY_SPRITE8_GETn, AFUT_STORE8_L2n_odd.qp_new());
  /* p30.BUJY*/ BUS_SPR_L3.tri6_nn(_DENY_SPRITE8_GETn, AFYM_STORE8_L3n_odd.qp_new());

  /* p30.ZARO*/ BUS_SPR_I0.tri6_nn(_FADO_SPRITE9_GETn, YBER_STORE9_I0n_odd.qp_new());
  /* p30.ZOJY*/ BUS_SPR_I1.tri6_nn(_FADO_SPRITE9_GETn, YZOR_STORE9_I1n_odd.qp_new());
  /* p30.YNEV*/ BUS_SPR_I2.tri6_nn(_FADO_SPRITE9_GETn, XYFE_STORE9_I2n_odd.qp_new());
  /* p30.XYRA*/ BUS_SPR_I3.tri6_nn(_FADO_SPRITE9_GETn, XOTU_STORE9_I3n_odd.qp_new());
  /* p30.YRAD*/ BUS_SPR_I4.tri6_nn(_FADO_SPRITE9_GETn, XUTE_STORE9_I4n_odd.qp_new());
  /* p30.YHAL*/ BUS_SPR_I5.tri6_nn(_FADO_SPRITE9_GETn, XUFO_STORE9_I5n_odd.qp_new());
  /* p30.BYME*/ BUS_SPR_L0.tri6_nn(_FADO_SPRITE9_GETn, CANA_STORE9_L0n_odd.qp_new());
  /* p30.GATE*/ BUS_SPR_L1.tri6_nn(_FADO_SPRITE9_GETn, FOFO_STORE9_L1n_odd.qp_new());
  /* p30.COHO*/ BUS_SPR_L2.tri6_nn(_FADO_SPRITE9_GETn, DYSY_STORE9_L2n_odd.qp_new());
  /* p30.CAWO*/ BUS_SPR_L3.tri6_nn(_FADO_SPRITE9_GETn, DEWU_STORE9_L3n_odd.qp_new());
}
...
void SpriteStore::ly_to_sprite_line(wire FEPO_STORE_MATCHp, const RegLY& reg_ly, const OamTempA& oam_temp_a) {
  ...
  /*#p30.CUCU*/ BUS_SPR_L0.tri6_nn(FEPO_STORE_MATCHp, _DEGE_SPRITE_DELTA0_new);
  /*#p30.CUCA*/ BUS_SPR_L1.tri6_nn(FEPO_STORE_MATCHp, _DABY_SPRITE_DELTA1_new);
  /*#p30.CEGA*/ BUS_SPR_L2.tri6_nn(FEPO_STORE_MATCHp, _DABU_SPRITE_DELTA2_new);
  /*#p30.WENU*/ BUS_SPR_L3.tri6_nn(FEPO_STORE_MATCHp, _GYSA_SPRITE_DELTA3_new);
}
