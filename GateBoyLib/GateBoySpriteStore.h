...
struct SpriteMatchFlag {
  ...
  wire2 FEPO_STORE_MATCHp() const {
    /* p29.FEFY*/ wire2 _FEFY_STORE_MATCHp_new_evn = nand5b(XAGE_STORE4_MATCHn, YLOZ_STORE3_MATCHn, DEGO_STORE2_MATCHn, DYDU_STORE1_MATCHn, YDUG_STORE0_MATCHn);
    /* p29.FOVE*/ wire2 _FOVE_STORE_MATCHp_new_evn = nand5b(YGEM_STORE9_MATCHn, EFYL_STORE8_MATCHn, DYKA_STORE7_MATCHn, YBEZ_STORE6_MATCHn, EGOM_STORE5_MATCHn);
  ...
  /*#p21.XENA*/ wire2 XENA_STORE_MATCHn() const { return not1b(FEPO_STORE_MATCHp()); }
