...
struct SpriteMatchFlag {
  ...
  wire FEPO_STORE_MATCHp() const {
    /* p29.FEFY*/ wire _FEFY_STORE_MATCHp = nand5b(XAGE_STORE4_MATCHn, YLOZ_STORE3_MATCHn, DEGO_STORE2_MATCHn, DYDU_STORE1_MATCHn, YDUG_STORE0_MATCHn);
    /* p29.FOVE*/ wire _FOVE_STORE_MATCHp = nand5b(YGEM_STORE9_MATCHn, EFYL_STORE8_MATCHn, DYKA_STORE7_MATCHn, YBEZ_STORE6_MATCHn, EGOM_STORE5_MATCHn);
