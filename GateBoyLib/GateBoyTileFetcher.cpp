...
void TileFetcher::tock(GateBoyClock& clk, Bus BUS_VRAM_Dp[8], wire2 XYMU_RENDERINGp, wire2 NYXU_BFETCH_RSTn, wire2 MOCE_BFETCH_DONEn_old)
{
  ...
  /* p27.LURY*/ wire2 _LURY_BG_FETCH_DONEn = and2(LOVY_FETCH_DONEp.qn_new2(), XYMU_RENDERINGp);
...
wire2 TileFetcher::LOMA_LATCH_TILE_DAn() const {
  /* p24.LOBY*/ wire2 _LOBY_RENDERINGn_new_xxx = not1b(_XYMU_RENDERINGp.qp_new2());

  /* p27.LAXU*/ wire2 LAXU_BFETCH_S0p = _LAXU_BFETCH_S0p.qp_new2();
  /* p27.MESU*/ wire2 MESU_BFETCH_S1p = _MESU_BFETCH_S1p.qp_new2();
  /* p27.NYVA*/ wire2 NYVA_BFETCH_S2p = _NYVA_BFETCH_S2p.qp_new2();

  /*#p27.LAXE*/ wire2 _LAXE_BFETCH_S0n = not1b(LAXU_BFETCH_S0p);
  /*#p27.NOFU*/ wire2 _NOFU_BFETCH_S2n = not1b(NYVA_BFETCH_S2p);

  /*#p27.MYSO*/ wire2 _MYSO_STORE_VRAM_DATA_TRIGp = nor3b(_LOBY_RENDERINGn_new_xxx, _LAXE_BFETCH_S0n, _LYZU_BFETCH_S0p_D1.qp_new2()); // MYSO fires on fetch phase 2, 6, 10
...
wire2 TileFetcher::LABU_LATCH_TILE_DBn() const {
  ...
  /*#p27.MYSO*/ wire2 _MYSO_STORE_VRAM_DATA_TRIGp = nor3b(_LOBY_RENDERINGn, _LAXE_BFETCH_S0n, _LYZU_BFETCH_S0p_D1.qp_new2()); // MYSO fires on fetch phase 2, 6, 10
