...
struct TileFetcher {
  ...
  wire2 TAVE_PRELOAD_DONE_TRIGp_old() const {
    /* p27.ROMO*/ wire2 _ROMO_PRELOAD_DONEn_old      = not1(POKY_PRELOAD_LATCHp.qp_old());
    /* p27.SUVU*/ wire2 _SUVU_PRELOAD_DONE_TRIGn_old = nand4(_XYMU_RENDERINGp.qp_old(), _ROMO_PRELOAD_DONEn_old, NYKA_FETCH_DONEp.qp_old(), PORY_FETCH_DONEp.qp_old());
    /* p27.TAVE*/ wire2 _TAVE_PRELOAD_DONE_TRIGp_old = not1(_SUVU_PRELOAD_DONE_TRIGn_old);
    return _TAVE_PRELOAD_DONE_TRIGp_old;
  }

  wire2 TAVE_PRELOAD_DONE_TRIGp_new() const {
    /* p27.ROMO*/ wire2 _ROMO_PRELOAD_DONEn_new      = not1(POKY_PRELOAD_LATCHp.qp_new());
    /* p27.SUVU*/ wire2 _SUVU_PRELOAD_DONE_TRIGn_new = nand4(_XYMU_RENDERINGp.qp_new(), _ROMO_PRELOAD_DONEn_new, NYKA_FETCH_DONEp.qp_new(), PORY_FETCH_DONEp.qp_new());
    /* p27.TAVE*/ wire2 _TAVE_PRELOAD_DONE_TRIGp_new = not1(_SUVU_PRELOAD_DONE_TRIGn_new);
    return _TAVE_PRELOAD_DONE_TRIGp_new;
  }

  /* p27.MOCE*/ wire2 MOCE_BFETCH_DONEn_old(wire2 NYXU_BFETCH_RSTn_old) const { return nand3(_LAXU_BFETCH_S0p.qp_old(), _NYVA_BFETCH_S2p.qp_old(), NYXU_BFETCH_RSTn_old); }
  /* p27.LYRY*/ wire2 LYRY_BFETCH_DONEp_old(wire2 NYXU_BFETCH_RSTn_old) const { return not1(MOCE_BFETCH_DONEn_old(NYXU_BFETCH_RSTn_old)); }

  /* p27.MOCE*/ wire2 MOCE_BFETCH_DONEn_new(wire2 NYXU_BFETCH_RSTn_new) const { return nand3(_LAXU_BFETCH_S0p.qp_new(), _NYVA_BFETCH_S2p.qp_new(), NYXU_BFETCH_RSTn_new); }
  /* p27.LYRY*/ wire2 LYRY_BFETCH_DONEp_new(wire2 NYXU_BFETCH_RSTn_new) const { return not1(MOCE_BFETCH_DONEn_new(NYXU_BFETCH_RSTn_new)); }

  /* p27.MOCE*/ wire2 MOCE_BFETCH_DONEn_any(wire2 NYXU_BFETCH_RSTn_new) const { return nand3(_LAXU_BFETCH_S0p.qp_any(), _NYVA_BFETCH_S2p.qp_any(), NYXU_BFETCH_RSTn_new); }
  /* p27.LYRY*/ wire2 LYRY_BFETCH_DONEp_any(wire2 NYXU_BFETCH_RSTn_new) const { return not1(MOCE_BFETCH_DONEn_any(NYXU_BFETCH_RSTn_new)); }

  /* p27.LUSU*/ wire2 LUSU_FETCHINGn()      const { return not1(LONY_FETCHINGp.qp_new()); }
  ...
  /* p27.LENA*/ wire2 LENA_BFETCHINGp()     const { return not1(LUSU_FETCHINGn()); }
  /*#p27.NAKO*/ wire2 NAKO_BFETCH_S1n()     const { return not1(MESU_BFETCH_S1p()); }
  /*#p27.NOFU*/ wire2 NOFU_BFETCH_S2n()     const { return not1(NYVA_BFETCH_S2p()); }
  /* p27.NOGU*/ wire2 NOGU_BFETCH_01p()     const { return nand2(NAKO_BFETCH_S1n(), NOFU_BFETCH_S2n()); }
  /* p27.NENY*/ wire2 NENY_BFETCH_01n()     const { return not1(NOGU_BFETCH_01p()); }
  ...
  /*#p27.XUHA*/ wire2 XUHA_FETCH_HILOp()    const { return not1(NOFU_BFETCH_S2n()); }
