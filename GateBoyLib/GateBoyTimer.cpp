...
void GateBoyDiv::tock(GateBoyResetDebug& rst, GateBoyClock& clk, GateBoyCpuBus& cpu_bus)
{
  ...
  /* p01.UFOL*/ wire2 _UFOL_DIV_RSTn = nor3(clk.UCOB_CLKBADp(), rst.PIN71_RST.int_qp_new(), _TAPE_FF04_WRp);
...
#else
  /* p01.UMEK*/ wire2 _UMEK_DIV06n_evn = not1(UGOT_DIV06p.qp_new());
  /* p01.UREK*/ wire2 _UREK_DIV07n_evn = not1(TULU_DIV07p.qp_new());
  /* p01.UTOK*/ wire2 _UTOK_DIV08n_evn = not1(TUGO_DIV08p.qp_new());
  /* p01.SAPY*/ wire2 _SAPY_DIV09n_evn = not1(TOFE_DIV09p.qp_new());
  /* p01.UMER*/ wire2 _UMER_DIV10n_evn = not1(TERU_DIV10p.qp_new());
  /* p01.RAVE*/ wire2 _RAVE_DIV11n_evn = not1(SOLA_DIV11p.qp_new());
  /* p01.RYSO*/ wire2 _RYSO_DIV12n_evn = not1(SUBU_DIV12p.qp_new());
  /* p01.UDOR*/ wire2 _UDOR_DIV13n_evn = not1(TEKA_DIV13p.qp_new());
...
void GateBoyTimer::write_tma_sync(GateBoyResetDebug& rst, GateBoyCpuBus& cpu_bus) {
  /* p03.TYJU*/ wire2 _TYJU_FF06_WRn = nand4(cpu_bus.TAPU_CPU_WRp.qp_new(), cpu_bus.RYFO_FF04_FF07p(),  cpu_bus.BUS_CPU_A[ 1].qp_new(), cpu_bus.TOVY_A00n());
...
void GateBoyTimer::write_tac_sync(GateBoyResetDebug& rst, GateBoyCpuBus& cpu_bus) {
  /* p03.SARA*/ wire2 _SARA_FF07_WRn = nand4(cpu_bus.TAPU_CPU_WRp.qp_new(), cpu_bus.RYFO_FF04_FF07p(),  cpu_bus.BUS_CPU_A[ 1].qp_new(), cpu_bus.BUS_CPU_A[ 0].qp_new());
  ...
  const GateBoyDiv& div)
{
  ...
  /*#p03.MERY*/ wire2 _MERY_TIMER_OVERFLOWp_old = nor2(NUGA_TIMA7p.qp_old(), NYDU_TIMA7p_DELAY.qn_old());
  ...
  /*#p03.MUGY*/ wire2 _MUGY_TIMA_MAX_RSTn   = not1(_MEXU_TIMA_LOADp);
  /*#p03.NYDU*/ NYDU_TIMA7p_DELAY.dff17(clk.BOGA_Axxxxxxx(), _MUGY_TIMA_MAX_RSTn, NUGA_TIMA7p.qp_old());

  /*#p03.UBOT*/ wire2 _UBOT_DIV01n = not1(div.UFOR_DIV01p.qp_new());
  /*#p03.UVYR*/ wire2 _UVYR_DIV03n = not1(div.TERO_DIV03p.qp_new());
  /* p01.UVYN*/ wire2 _UVYN_DIV05n = not1(div.TAMA_DIV05p.qp_new());
  /* p01.UREK*/ wire2 _UREK_DIV07n = not1(div.TULU_DIV07p.qp_new());

  /*#p03.UKAP*/ wire2 _UKAP_CLK_MUXa  = mux2n(SOPU_TAC0p.qp_new(), _UVYN_DIV05n, _UVYR_DIV03n);
  /*#p03.TEKO*/ wire2 _TEKO_CLK_MUXb  = mux2n(SOPU_TAC0p.qp_new(), _UBOT_DIV01n, _UREK_DIV07n);
  /*#p03.TECY*/ wire2 _TECY_CLK_MUXc  = mux2n(SAMY_TAC1p.qp_new(), _UKAP_CLK_MUXa, _TEKO_CLK_MUXb);
  /*#p03.SOGU*/ wire2 _SOGU_TIMA_CLKn = nor2(_TECY_CLK_MUXc, SABO_TAC2p.qn_new());

  ///*#p03.TOPE*/ wire2 _TOPE_FF05_WRn = nand4(cpu_bus.TAPU_CPU_WRp.qp_new(), cpu_bus.RYFO_FF04_FF07p(),  cpu_bus.TOLA_A01n(), cpu_bus.BUS_CPU_A[ 0].qp_new());

  /*#p03.ROKE*/ wire2 _ROKE_TIMA_D0 = mux2n(_TOPE_FF05_WRn, SABU_TMA0p.qp_new(), cpu_bus.BUS_CPU_D[0].qp_new());
  /*#p03.PETU*/ wire2 _PETU_TIMA_D1 = mux2n(_TOPE_FF05_WRn, NYKE_TMA1p.qp_new(), cpu_bus.BUS_CPU_D[1].qp_new());
  /*#p03.NYKU*/ wire2 _NYKU_TIMA_D2 = mux2n(_TOPE_FF05_WRn, MURU_TMA2p.qp_new(), cpu_bus.BUS_CPU_D[2].qp_new());
  /*#p03.SOCE*/ wire2 _SOCE_TIMA_D3 = mux2n(_TOPE_FF05_WRn, TYVA_TMA3p.qp_new(), cpu_bus.BUS_CPU_D[3].qp_new());
  /*#p03.SALA*/ wire2 _SALA_TIMA_D4 = mux2n(_TOPE_FF05_WRn, TYRU_TMA4p.qp_new(), cpu_bus.BUS_CPU_D[4].qp_new());
  /*#p03.SYRU*/ wire2 _SYRU_TIMA_D5 = mux2n(_TOPE_FF05_WRn, SUFY_TMA5p.qp_new(), cpu_bus.BUS_CPU_D[5].qp_new());
  /*#p03.REFU*/ wire2 _REFU_TIMA_D6 = mux2n(_TOPE_FF05_WRn, PETO_TMA6p.qp_new(), cpu_bus.BUS_CPU_D[6].qp_new());
  /*#p03.RATO*/ wire2 _RATO_TIMA_D7 = mux2n(_TOPE_FF05_WRn, SETA_TMA7p.qp_new(), cpu_bus.BUS_CPU_D[7].qp_new());

  /*#p03.PUXY*/ wire2 _PUXY_TIMA_D0 = nor2(rst.MULO_SYS_RSTn(), _ROKE_TIMA_D0);
  /*#p03.NERO*/ wire2 _NERO_TIMA_D1 = nor2(rst.MULO_SYS_RSTn(), _PETU_TIMA_D1);
  /*#p03.NADA*/ wire2 _NADA_TIMA_D2 = nor2(rst.MULO_SYS_RSTn(), _NYKU_TIMA_D2);
  /*#p03.REPA*/ wire2 _REPA_TIMA_D3 = nor2(rst.MULO_SYS_RSTn(), _SOCE_TIMA_D3);
  /*#p03.ROLU*/ wire2 _ROLU_TIMA_D4 = nor2(rst.MULO_SYS_RSTn(), _SALA_TIMA_D4);
  /*#p03.RUGY*/ wire2 _RUGY_TIMA_D5 = nor2(rst.MULO_SYS_RSTn(), _SYRU_TIMA_D5);
  /*#p03.PYMA*/ wire2 _PYMA_TIMA_D6 = nor2(rst.MULO_SYS_RSTn(), _REFU_TIMA_D6);
  /*#p03.PAGU*/ wire2 _PAGU_TIMA_D7 = nor2(rst.MULO_SYS_RSTn(), _RATO_TIMA_D7);
