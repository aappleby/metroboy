...
void GateBoy::tock_div() {
  /* p01.TAPE*/ wire TAPE_FF04_WRp = and4(cpu_signals.TAPU_CPU_WRp.out_new(), new_bus.RYFO_FF04_FF07p(), new_bus.TOLA_A01n(), new_bus.TOVY_A00n());
...
void GateBoy::tock_timer() {
  /* p03.TYJU*/ wire TYJU_FF06_WRn = nand4(cpu_signals.TAPU_CPU_WRp.out_new(), new_bus.RYFO_FF04_FF07p(), new_bus.BUS_CPU_A01p.out_new(), new_bus.TOVY_A00n());
  /* p03.SABU*/ timer.SABU_TMA0p.dff17(TYJU_FF06_WRn, ALUR_SYS_RSTn(), old_bus.BUS_CPU_D00p.out_old());
  /* p03.NYKE*/ timer.NYKE_TMA1p.dff17(TYJU_FF06_WRn, ALUR_SYS_RSTn(), old_bus.BUS_CPU_D01p.out_old());
  /* p03.MURU*/ timer.MURU_TMA2p.dff17(TYJU_FF06_WRn, ALUR_SYS_RSTn(), old_bus.BUS_CPU_D02p.out_old());
  /* p03.TYVA*/ timer.TYVA_TMA3p.dff17(TYJU_FF06_WRn, ALUR_SYS_RSTn(), old_bus.BUS_CPU_D03p.out_old());
  /* p03.TYRU*/ timer.TYRU_TMA4p.dff17(TYJU_FF06_WRn, ALUR_SYS_RSTn(), old_bus.BUS_CPU_D04p.out_old());
  /* p03.SUFY*/ timer.SUFY_TMA5p.dff17(TYJU_FF06_WRn, ALUR_SYS_RSTn(), old_bus.BUS_CPU_D05p.out_old());
  /* p03.PETO*/ timer.PETO_TMA6p.dff17(TYJU_FF06_WRn, ALUR_SYS_RSTn(), old_bus.BUS_CPU_D06p.out_old());
  /* p03.SETA*/ timer.SETA_TMA7p.dff17(TYJU_FF06_WRn, ALUR_SYS_RSTn(), old_bus.BUS_CPU_D07p.out_old());

  /* p03.SARA*/ wire SARA_FF07_WRn = nand4(cpu_signals.TAPU_CPU_WRp.out_new(), new_bus.RYFO_FF04_FF07p(), new_bus.BUS_CPU_A01p.out_new(), new_bus.BUS_CPU_A00p.out_new());
  /* p03.SOPU*/ timer.SOPU_TAC0p.dff17(SARA_FF07_WRn, ALUR_SYS_RSTn(), old_bus.BUS_CPU_D00p.out_old());
  /* p03.SAMY*/ timer.SAMY_TAC1p.dff17(SARA_FF07_WRn, ALUR_SYS_RSTn(), old_bus.BUS_CPU_D01p.out_old());
  /* p03.SABO*/ timer.SABO_TAC2p.dff17(SARA_FF07_WRn, ALUR_SYS_RSTn(), old_bus.BUS_CPU_D02p.out_old());
