...
void GateBoyTimer::read_tima(GateBoyCpuBus& cpu_bus) {
  /*#p03.TEDA*/ wire _TEDA_FF05_RDp =  and4(cpu_bus.TEDO_CPU_RDp.qp_new2(), cpu_bus.RYFO_FF04_FF07p(),  cpu_bus.TOLA_A01n(), cpu_bus.BUS_CPU_A[ 0].qp_new2());
...
void GateBoyTimer::read_tma(GateBoyCpuBus& cpu_bus) {
  /* p03.TUBY*/ wire _TUBY_FF06_RDp =  and4(cpu_bus.TEDO_CPU_RDp.qp_new2(), cpu_bus.RYFO_FF04_FF07p(),  cpu_bus.BUS_CPU_A[ 1].qp_new2(), cpu_bus.TOVY_A00n());
...
void GateBoyTimer::write_tma_sync(GateBoyResetDebug& rst, GateBoyCpuBus& cpu_bus) {
  /* p03.TYJU*/ wire _TYJU_FF06_WRn = nand4b(cpu_bus.TAPU_CPU_WRp.qp_new2(), cpu_bus.RYFO_FF04_FF07p(),  cpu_bus.BUS_CPU_A[ 1].qp_new2(), cpu_bus.TOVY_A00n());
...
void GateBoyTimer::read_tac(GateBoyCpuBus& cpu_bus) {
  /* p03.SORA*/ wire _SORA_FF07_RDp =  and4(cpu_bus.TEDO_CPU_RDp.qp_new2(), cpu_bus.RYFO_FF04_FF07p(),  cpu_bus.BUS_CPU_A[ 1].qp_new2(), cpu_bus.BUS_CPU_A[ 0].qp_new2());
...
void GateBoyTimer::write_tac_sync(GateBoyResetDebug& rst, GateBoyCpuBus& cpu_bus) {
  /* p03.SARA*/ wire _SARA_FF07_WRn = nand4b(cpu_bus.TAPU_CPU_WRp.qp_new2(), cpu_bus.RYFO_FF04_FF07p(),  cpu_bus.BUS_CPU_A[ 1].qp_new2(), cpu_bus.BUS_CPU_A[ 0].qp_new2());
  ...
  const GateBoyDiv& div)
{
  ...
  /*#p03.TOPE*/ wire _TOPE_FF05_WRn = nand4b(cpu_bus.TAPU_CPU_WRp.qp_new2(), cpu_bus.RYFO_FF04_FF07p(),  cpu_bus.TOLA_A01n(), cpu_bus.BUS_CPU_A[ 0].qp_new2());
  ...
  ///*#p03.TOPE*/ wire _TOPE_FF05_WRn = nand4(cpu_bus.TAPU_CPU_WRp.qp_new2(), cpu_bus.RYFO_FF04_FF07p(),  cpu_bus.TOLA_A01n(), cpu_bus.BUS_CPU_A[ 0].qp_new2());

  /*#p03.ROKE*/ wire _ROKE_TIMA_D0 = mux2nb(_TOPE_FF05_WRn, SABU_TMA0p.qp_new2(), cpu_bus.BUS_CPU_D[0].qp_new2());
  /*#p03.PETU*/ wire _PETU_TIMA_D1 = mux2nb(_TOPE_FF05_WRn, NYKE_TMA1p.qp_new2(), cpu_bus.BUS_CPU_D[1].qp_new2());
  /*#p03.NYKU*/ wire _NYKU_TIMA_D2 = mux2nb(_TOPE_FF05_WRn, MURU_TMA2p.qp_new2(), cpu_bus.BUS_CPU_D[2].qp_new2());
  /*#p03.SOCE*/ wire _SOCE_TIMA_D3 = mux2nb(_TOPE_FF05_WRn, TYVA_TMA3p.qp_new2(), cpu_bus.BUS_CPU_D[3].qp_new2());
  /*#p03.SALA*/ wire _SALA_TIMA_D4 = mux2nb(_TOPE_FF05_WRn, TYRU_TMA4p.qp_new2(), cpu_bus.BUS_CPU_D[4].qp_new2());
  /*#p03.SYRU*/ wire _SYRU_TIMA_D5 = mux2nb(_TOPE_FF05_WRn, SUFY_TMA5p.qp_new2(), cpu_bus.BUS_CPU_D[5].qp_new2());
  /*#p03.REFU*/ wire _REFU_TIMA_D6 = mux2nb(_TOPE_FF05_WRn, PETO_TMA6p.qp_new2(), cpu_bus.BUS_CPU_D[6].qp_new2());
  /*#p03.RATO*/ wire _RATO_TIMA_D7 = mux2nb(_TOPE_FF05_WRn, SETA_TMA7p.qp_new2(), cpu_bus.BUS_CPU_D[7].qp_new2());
