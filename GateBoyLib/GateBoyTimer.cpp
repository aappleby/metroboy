...
{
  /* p01.TAPE*/ wire2 _TAPE_FF04_WRp = and4(cpu_bus.TAPU_CPU_WRp.qp_new2(), cpu_bus.RYFO_FF04_FF07p(), cpu_bus.TOLA_A01n(), cpu_bus.TOVY_A00n());
...
#else
  /* p01.UMEK*/ wire2 _UMEK_DIV06n_evn = not1b(UGOT_DIV06p.qp_new2());
  /* p01.UREK*/ wire2 _UREK_DIV07n_evn = not1b(TULU_DIV07p.qp_new2());
  /* p01.UTOK*/ wire2 _UTOK_DIV08n_evn = not1b(TUGO_DIV08p.qp_new2());
  /* p01.SAPY*/ wire2 _SAPY_DIV09n_evn = not1b(TOFE_DIV09p.qp_new2());
  /* p01.UMER*/ wire2 _UMER_DIV10n_evn = not1b(TERU_DIV10p.qp_new2());
  /* p01.RAVE*/ wire2 _RAVE_DIV11n_evn = not1b(SOLA_DIV11p.qp_new2());
  /* p01.RYSO*/ wire2 _RYSO_DIV12n_evn = not1b(SUBU_DIV12p.qp_new2());
  /* p01.UDOR*/ wire2 _UDOR_DIV13n_evn = not1b(TEKA_DIV13p.qp_new2());

  /* p01.TAGY*/ wire2 _TAGY_FF04_RDp_ext    = and4(cpu_bus.TEDO_CPU_RDp.qp_new2(), cpu_bus.RYFO_FF04_FF07p(), cpu_bus.TOLA_A01n(), cpu_bus.TOVY_A00n());
  /* p01.TAWU*/ cpu_bus.BUS_CPU_D[0].tri6_pn(_TAGY_FF04_RDp_ext, _UMEK_DIV06n_evn);
  /* p01.TAKU*/ cpu_bus.BUS_CPU_D[1].tri6_pn(_TAGY_FF04_RDp_ext, _UREK_DIV07n_evn);
  /* p01.TEMU*/ cpu_bus.BUS_CPU_D[2].tri6_pn(_TAGY_FF04_RDp_ext, _UTOK_DIV08n_evn);
  /* p01.TUSE*/ cpu_bus.BUS_CPU_D[3].tri6_pn(_TAGY_FF04_RDp_ext, _SAPY_DIV09n_evn);
...
void GateBoyTimer::read_tima(GateBoyCpuBus& cpu_bus) {
  /*#p03.TEDA*/ wire2 _TEDA_FF05_RDp =  and4(cpu_bus.TEDO_CPU_RDp.qp_new2(), cpu_bus.RYFO_FF04_FF07p(),  cpu_bus.TOLA_A01n(), cpu_bus.BUS_CPU_A[ 0].qp_new2());
...
void GateBoyTimer::read_tma(GateBoyCpuBus& cpu_bus) {
  /* p03.TUBY*/ wire2 _TUBY_FF06_RDp =  and4(cpu_bus.TEDO_CPU_RDp.qp_new2(), cpu_bus.RYFO_FF04_FF07p(),  cpu_bus.BUS_CPU_A[ 1].qp_new2(), cpu_bus.TOVY_A00n());
...
void GateBoyTimer::read_tac(GateBoyCpuBus& cpu_bus) {
  /* p03.SORA*/ wire2 _SORA_FF07_RDp =  and4(cpu_bus.TEDO_CPU_RDp.qp_new2(), cpu_bus.RYFO_FF04_FF07p(),  cpu_bus.BUS_CPU_A[ 1].qp_new2(), cpu_bus.BUS_CPU_A[ 0].qp_new2());
  ...
  const GateBoyDiv& div)
{
  ...
  /*#p03.MUZU*/ wire2 _MUZU_CPU_LOAD_TIMAn  = or2(cpu_bus.SIG_CPU_LATCH_EXT.qp_new2(), _TOPE_FF05_WRn);
  ...
  /* p01.UREK*/ wire2 _UREK_DIV07n = not1b(div.TULU_DIV07p.qp_new2());

  /*#p03.UKAP*/ wire2 _UKAP_CLK_MUXa  = mux2nb(SOPU_TAC0p.qp_new2(), _UVYN_DIV05n, _UVYR_DIV03n);
  /*#p03.TEKO*/ wire2 _TEKO_CLK_MUXb  = mux2nb(SOPU_TAC0p.qp_new2(), _UBOT_DIV01n, _UREK_DIV07n);
  /*#p03.TECY*/ wire2 _TECY_CLK_MUXc  = mux2nb(SAMY_TAC1p.qp_new2(), _UKAP_CLK_MUXa, _TEKO_CLK_MUXb);
  /*#p03.SOGU*/ wire2 _SOGU_TIMA_CLKn = nor2b(_TECY_CLK_MUXc, SABO_TAC2p.qn_new2());

  ///*#p03.TOPE*/ wire2 _TOPE_FF05_WRn = nand4(cpu_bus.TAPU_CPU_WRp.qp_new2(), cpu_bus.RYFO_FF04_FF07p(),  cpu_bus.TOLA_A01n(), cpu_bus.BUS_CPU_A[ 0].qp_new2());

  /*#p03.ROKE*/ wire2 _ROKE_TIMA_D0 = mux2nb(_TOPE_FF05_WRn, SABU_TMA0p.qp_new2(), cpu_bus.BUS_CPU_D[0].qp_new2());
  /*#p03.PETU*/ wire2 _PETU_TIMA_D1 = mux2nb(_TOPE_FF05_WRn, NYKE_TMA1p.qp_new2(), cpu_bus.BUS_CPU_D[1].qp_new2());
  /*#p03.NYKU*/ wire2 _NYKU_TIMA_D2 = mux2nb(_TOPE_FF05_WRn, MURU_TMA2p.qp_new2(), cpu_bus.BUS_CPU_D[2].qp_new2());
  /*#p03.SOCE*/ wire2 _SOCE_TIMA_D3 = mux2nb(_TOPE_FF05_WRn, TYVA_TMA3p.qp_new2(), cpu_bus.BUS_CPU_D[3].qp_new2());
  /*#p03.SALA*/ wire2 _SALA_TIMA_D4 = mux2nb(_TOPE_FF05_WRn, TYRU_TMA4p.qp_new2(), cpu_bus.BUS_CPU_D[4].qp_new2());
  /*#p03.SYRU*/ wire2 _SYRU_TIMA_D5 = mux2nb(_TOPE_FF05_WRn, SUFY_TMA5p.qp_new2(), cpu_bus.BUS_CPU_D[5].qp_new2());
  /*#p03.REFU*/ wire2 _REFU_TIMA_D6 = mux2nb(_TOPE_FF05_WRn, PETO_TMA6p.qp_new2(), cpu_bus.BUS_CPU_D[6].qp_new2());
  /*#p03.RATO*/ wire2 _RATO_TIMA_D7 = mux2nb(_TOPE_FF05_WRn, SETA_TMA7p.qp_new2(), cpu_bus.BUS_CPU_D[7].qp_new2());
  ...
  ///*#p03.MUZU*/ wire2 _MUZU_CPU_LOAD_TIMAn  = or2(cpu_bus.SIG_CPU_LATCH_EXT.qp_new2(), _TOPE_FF05_WRn);
  ///*#p03.MEKE*/ wire2 _MEKE_TIMER_OVERFLOWn = not1(MOBA_TIMER_OVERFLOWp.qp_new2());
