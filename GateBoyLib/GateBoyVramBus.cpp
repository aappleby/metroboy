...
void GateBoyVramBus::cpu_addr_to_vram_addr(const GateBoyCpuBus& cpu_bus, NorLatch XYMU_RENDERINGn, wire LUFA_DMA_VRAMp) {
  ...
  /* p25.XAKY_CA00_TO_VA00*/ BUS_VRAM_A00n.tri6_nn(_XEDU_VRAM_LOCKp, cpu_bus.BUS_CPU_A00p.qp_new());
  /* p25.XUXU_CA01_TO_VA01*/ BUS_VRAM_A01n.tri6_nn(_XEDU_VRAM_LOCKp, cpu_bus.BUS_CPU_A01p.qp_new());
  /* p25.XYNE_CA02_TO_VA02*/ BUS_VRAM_A02n.tri6_nn(_XEDU_VRAM_LOCKp, cpu_bus.BUS_CPU_A02p.qp_new());
  /* p25.XODY_CA03_TO_VA03*/ BUS_VRAM_A03n.tri6_nn(_XEDU_VRAM_LOCKp, cpu_bus.BUS_CPU_A03p.qp_new());
  /* p25.XECA_CA04_TO_VA04*/ BUS_VRAM_A04n.tri6_nn(_XEDU_VRAM_LOCKp, cpu_bus.BUS_CPU_A04p.qp_new());
  /* p25.XOBA_CA05_TO_VA05*/ BUS_VRAM_A05n.tri6_nn(_XEDU_VRAM_LOCKp, cpu_bus.BUS_CPU_A05p.qp_new());
  /* p25.XOPO_CA06_TO_VA06*/ BUS_VRAM_A06n.tri6_nn(_XEDU_VRAM_LOCKp, cpu_bus.BUS_CPU_A06p.qp_new());
  /* p25.XYBO_CA07_TO_VA07*/ BUS_VRAM_A07n.tri6_nn(_XEDU_VRAM_LOCKp, cpu_bus.BUS_CPU_A07p.qp_new());
  /* p25.RYSU_CA08_TO_VA08*/ BUS_VRAM_A08n.tri6_nn(_XEDU_VRAM_LOCKp, cpu_bus.BUS_CPU_A08p.qp_new());
  /* p25.RESE_CA09_TO_VA09*/ BUS_VRAM_A09n.tri6_nn(_XEDU_VRAM_LOCKp, cpu_bus.BUS_CPU_A09p.qp_new());
  /* p25.RUSE_CA10_TO_VA10*/ BUS_VRAM_A10n.tri6_nn(_XEDU_VRAM_LOCKp, cpu_bus.BUS_CPU_A10p.qp_new());
  /* p25.RYNA_CA11_TO_VA11*/ BUS_VRAM_A11n.tri6_nn(_XEDU_VRAM_LOCKp, cpu_bus.BUS_CPU_A11p.qp_new());
  /* p25.RUMO_CA12_TO_VA12*/ BUS_VRAM_A12n.tri6_nn(_XEDU_VRAM_LOCKp, cpu_bus.BUS_CPU_A12p.qp_new());
}
...
void GateBoyVramBus::dma_addr_to_vram_addr(const GateBoyDMA& dma) {
  ...
  /* p04.ECAL_DA00_TO_VA00*/ BUS_VRAM_A00n.tri6_nn(_AHOC_DMA_VRAMn_new, dma.NAKY_DMA_A00p.qp_new());
  /* p04.EGEZ_DA01_TO_VA01*/ BUS_VRAM_A01n.tri6_nn(_AHOC_DMA_VRAMn_new, dma.PYRO_DMA_A01p.qp_new());
  /* p04.FUHE_DA02_TO_VA02*/ BUS_VRAM_A02n.tri6_nn(_AHOC_DMA_VRAMn_new, dma.NEFY_DMA_A02p.qp_new());
  /* p04.FYZY_DA03_TO_VA03*/ BUS_VRAM_A03n.tri6_nn(_AHOC_DMA_VRAMn_new, dma.MUTY_DMA_A03p.qp_new());
  /* p04.DAMU_DA04_TO_VA04*/ BUS_VRAM_A04n.tri6_nn(_AHOC_DMA_VRAMn_new, dma.NYKO_DMA_A04p.qp_new());
  /* p04.DAVA_DA05_TO_VA05*/ BUS_VRAM_A05n.tri6_nn(_AHOC_DMA_VRAMn_new, dma.PYLO_DMA_A05p.qp_new());
  /* p04.ETEG_DA06_TO_VA06*/ BUS_VRAM_A06n.tri6_nn(_AHOC_DMA_VRAMn_new, dma.NUTO_DMA_A06p.qp_new());
  /*#p04.EREW_DA07_TO_VA07*/ BUS_VRAM_A07n.tri6_nn(_AHOC_DMA_VRAMn_new, dma.MUGU_DMA_A07p.qp_new());
  /*#p04.EVAX_DA08_TO_VA08*/ BUS_VRAM_A08n.tri6_nn(_AHOC_DMA_VRAMn_new, dma.NAFA_DMA_A08n.qn_new());
  /* p04.DUVE_DA09_TO_VA09*/ BUS_VRAM_A09n.tri6_nn(_AHOC_DMA_VRAMn_new, dma.PYNE_DMA_A09n.qn_new());
  /* p04.ERAF_DA10_TO_VA10*/ BUS_VRAM_A10n.tri6_nn(_AHOC_DMA_VRAMn_new, dma.PARA_DMA_A10n.qn_new());
  /* p04.FUSY_DA11_TO_VA11*/ BUS_VRAM_A11n.tri6_nn(_AHOC_DMA_VRAMn_new, dma.NYDO_DMA_A11n.qn_new());
  /* p04.EXYF_DA12_TO_VA12*/ BUS_VRAM_A12n.tri6_nn(_AHOC_DMA_VRAMn_new, dma.NYGY_DMA_A12n.qn_new());
}
...
void GateBoyVramBus::scroll_to_addr(BGScrollX scroll_x, BGScrollY scroll_y, wire POTU_BGW_MAP_READp, wire AXAD_WIN_MODEn, DFF9 XAFO_LCDC_BGMAPn) {
  ...
  /* p26.AXEP_MX00_TO_VA00*/ BUS_VRAM_A00n.tri6_nn(_BAFY_BG_MAP_READn,  scroll_x.BABE_MAP_X0.sum);
  /* p26.AFEB_MX01_TO_VA01*/ BUS_VRAM_A01n.tri6_nn(_BAFY_BG_MAP_READn,  scroll_x.ABOD_MAP_X1.sum);
  /* p26.ALEL_MX02_TO_VA02*/ BUS_VRAM_A02n.tri6_nn(_BAFY_BG_MAP_READn,  scroll_x.BEWY_MAP_X2.sum);
  /* p26.COLY_MX03_TO_VA03*/ BUS_VRAM_A03n.tri6_nn(_BAFY_BG_MAP_READn,  scroll_x.BYCA_MAP_X3.sum);
  /* p26.AJAN_MX04_TO_VA04*/ BUS_VRAM_A04n.tri6_nn(_BAFY_BG_MAP_READn,  scroll_x.ACUL_MAP_X4.sum);
  /* p26.DUHO_MY00_TO_VA05*/ BUS_VRAM_A05n.tri6_nn(_BAFY_BG_MAP_READn,  scroll_y.ETAM_MAP_Y0.sum);
  /* p26.CASE_MY01_TO_VA06*/ BUS_VRAM_A06n.tri6_nn(_BAFY_BG_MAP_READn,  scroll_y.DOTO_MAP_Y1.sum);
  /* p26.CYPO_MY02_TO_VA07*/ BUS_VRAM_A07n.tri6_nn(_BAFY_BG_MAP_READn,  scroll_y.DABA_MAP_Y2.sum);
  /* p26.CETA_MY03_TO_VA08*/ BUS_VRAM_A08n.tri6_nn(_BAFY_BG_MAP_READn,  scroll_y.EFYK_MAP_Y3.sum);
  /* p26.DAFE_MY04_TO_VA09*/ BUS_VRAM_A09n.tri6_nn(_BAFY_BG_MAP_READn,  scroll_y.EJOK_MAP_Y4.sum);
  /*#p26.AMUV_BMAP_TO_VA10*/ BUS_VRAM_A10n.tri6_nn(_BAFY_BG_MAP_READn, XAFO_LCDC_BGMAPn.qn_new());
  /* p26.COVE_BMAP_TO_VA11*/ BUS_VRAM_A11n.tri6_nn(_BAFY_BG_MAP_READn, SIG_VCC);
  /* p26.COXO_BMAP_TO_VA12*/ BUS_VRAM_A12n.tri6_nn(_BAFY_BG_MAP_READn, SIG_VCC);
}
...
void GateBoyVramBus::win_to_addr(const WinMapX& win_map_x, const WinLineY& win_line_y, wire POTU_BGW_MAP_READp, wire PORE_WIN_MODEp, DFF9 WOKY_LCDC_WINMAPn) {
  ...
  /*#p27.XEJA_WX03_TO_VA00*/ BUS_VRAM_A00n.tri6_nn(_WUKO_WIN_MAP_READn, win_map_x.WYKA_WIN_X3.qp_new());
  /* p27.XAMO_WX04_TO_VA01*/ BUS_VRAM_A01n.tri6_nn(_WUKO_WIN_MAP_READn, win_map_x.WODY_WIN_X4.qp_new());
  /* p27.XAHE_WX05_TO_VA02*/ BUS_VRAM_A02n.tri6_nn(_WUKO_WIN_MAP_READn, win_map_x.WOBO_WIN_X5.qp_new());
  /* p27.XULO_WX06_TO_VA03*/ BUS_VRAM_A03n.tri6_nn(_WUKO_WIN_MAP_READn, win_map_x.WYKO_WIN_X6.qp_new());
  /* p27.WUJU_WX07_TO_VA04*/ BUS_VRAM_A04n.tri6_nn(_WUKO_WIN_MAP_READn, win_map_x.XOLO_WIN_X7.qp_new());
  /*#p27.VYTO_WY03_TO_VA05*/ BUS_VRAM_A05n.tri6_nn(_WUKO_WIN_MAP_READn, win_line_y.TUFU_WIN_Y3.qp_new());
  /* p27.VEHA_WY04_TO_VA06*/ BUS_VRAM_A06n.tri6_nn(_WUKO_WIN_MAP_READn, win_line_y.TAXA_WIN_Y4.qp_new());
  /* p27.VACE_WY05_TO_VA07*/ BUS_VRAM_A07n.tri6_nn(_WUKO_WIN_MAP_READn, win_line_y.TOZO_WIN_Y5.qp_new());
  /* p27.VOVO_WY06_TO_VA08*/ BUS_VRAM_A08n.tri6_nn(_WUKO_WIN_MAP_READn, win_line_y.TATE_WIN_Y6.qp_new());
  /* p27.VULO_WY07_TO_VA09*/ BUS_VRAM_A09n.tri6_nn(_WUKO_WIN_MAP_READn, win_line_y.TEKE_WIN_Y7.qp_new());
  /*#p27.VEVY_WMAP_TO_VA10*/ BUS_VRAM_A10n.tri6_nn(_WUKO_WIN_MAP_READn, WOKY_LCDC_WINMAPn.qn_new());
  /* p27.VEZA_WMAP_TO_VA11*/ BUS_VRAM_A11n.tri6_nn(_WUKO_WIN_MAP_READn, SIG_VCC);
  /* p27.VOGU_WMAP_TO_VA12*/ BUS_VRAM_A12n.tri6_nn(_WUKO_WIN_MAP_READn, SIG_VCC);
}
...
void GateBoyVramBus::tile_to_addr(const BGScrollY scroll_y, const WinLineY win_line_y, const TileTempB tile_temp_b, wire NETA_BGW_TILE_READp, wire XUHA_FETCH_HILOp, DFF9 WEXU_LCDC_BGTILEn, wire PORE_WIN_MODEp, wire AXAD_WIN_MODEn) {
  ...
  /*#p26.ASUM_HILO_TO_VA00*/ BUS_VRAM_A00n.tri6_nn(_BEJE_BG_TILE_READn, XUHA_FETCH_HILOp);
  /* p26.EVAD_TLY0_TO_VA01*/ BUS_VRAM_A01n.tri6_nn(_BEJE_BG_TILE_READn, scroll_y.FAFO_TILE_Y0.sum);
  /* p26.DAHU_TLY1_TO_VA02*/ BUS_VRAM_A02n.tri6_nn(_BEJE_BG_TILE_READn, scroll_y.EMUX_TILE_Y1.sum);
  /* p26.DODE_TLY2_TO_VA03*/ BUS_VRAM_A03n.tri6_nn(_BEJE_BG_TILE_READn, scroll_y.ECAB_TILE_Y2.sum);

  /*#p25.XONU_HILO_TO_VA00*/ BUS_VRAM_A00n.tri6_nn(_XUCY_WIN_TILE_READn, XUHA_FETCH_HILOp);
  /*#p25.WUDO_WNY0_TO_VA01*/ BUS_VRAM_A01n.tri6_nn(_XUCY_WIN_TILE_READn, win_line_y.VYNO_WIN_Y0.qp_new());
  /*#p25.WAWE_WNY1_TO_VA02*/ BUS_VRAM_A02n.tri6_nn(_XUCY_WIN_TILE_READn, win_line_y.VUJO_WIN_Y1.qp_new());
  /*#p25.WOLU_WNY2_TO_VA03*/ BUS_VRAM_A03n.tri6_nn(_XUCY_WIN_TILE_READn, win_line_y.VYMU_WIN_Y2.qp_new());

  /*#p25.VAPY_TEMP_TO_VA04*/ BUS_VRAM_A04n.tri6_pn(NETA_BGW_TILE_READp, tile_temp_b.RAWU_TILE_DB0p.qp_new());
  /*#p25.SEZU_TEMP_TO_VA05*/ BUS_VRAM_A05n.tri6_pn(NETA_BGW_TILE_READp, tile_temp_b.POZO_TILE_DB1p.qp_new());
  /*#p25.VEJY_TEMP_TO_VA06*/ BUS_VRAM_A06n.tri6_pn(NETA_BGW_TILE_READp, tile_temp_b.PYZO_TILE_DB2p.qp_new());
  /*#p25.RUSA_TEMP_TO_VA07*/ BUS_VRAM_A07n.tri6_pn(NETA_BGW_TILE_READp, tile_temp_b.POXA_TILE_DB3p.qp_new());
  /*#p25.ROHA_TEMP_TO_VA08*/ BUS_VRAM_A08n.tri6_pn(NETA_BGW_TILE_READp, tile_temp_b.PULO_TILE_DB4p.qp_new());
  /*#p25.RESO_TEMP_TO_VA09*/ BUS_VRAM_A09n.tri6_pn(NETA_BGW_TILE_READp, tile_temp_b.POJU_TILE_DB5p.qp_new());
  /*#p25.SUVO_TEMP_TO_VA10*/ BUS_VRAM_A10n.tri6_pn(NETA_BGW_TILE_READp, tile_temp_b.POWY_TILE_DB6p.qp_new());
  /*#p25.TOBO_TEMP_TO_VA11*/ BUS_VRAM_A11n.tri6_pn(NETA_BGW_TILE_READp, tile_temp_b.PYJU_TILE_DB7p.qp_new());

  /*#p25.VUZA*/ wire _VUZA_TILE_BANKp = nor2(tile_temp_b.PYJU_TILE_DB7p.qp_new(), WEXU_LCDC_BGTILEn.qn_new());
  /*#p25.VURY_BANK_TO_VA12*/ BUS_VRAM_A12n.tri6_pn(NETA_BGW_TILE_READp, _VUZA_TILE_BANKp);
}
...
void GateBoyVramBus::sprite_to_addr(const GateBoySpriteStore& sprite_store, const OamTempA& oam_temp_a, const OamTempB& oam_temp_b, wire XUQU_SPRITE_AB, wire SAKY_SFETCHn, NorLatch XYMU_RENDERINGn, DFF9 XYMO_LCDC_SPSIZEn) {
  ...
  /* p29.ABEM_HILO_TO_VA00*/ BUS_VRAM_A00n.tri6_nn(_ABON_SFETCHINGn, XUQU_SPRITE_AB);
  /* p29.BAXE_SPL0_TO_VA01*/ BUS_VRAM_A01n.tri6_nn(_ABON_SFETCHINGn, _CYVU_L0);
  /* p29.ARAS_SPL1_TO_VA02*/ BUS_VRAM_A02n.tri6_nn(_ABON_SFETCHINGn, _BORE_L1);
  /* p29.AGAG_SPL2_TO_VA03*/ BUS_VRAM_A03n.tri6_nn(_ABON_SFETCHINGn, _BUVY_L2);
  /* p29.FAMU_SPL3_TO_VA04*/ BUS_VRAM_A04n.tri6_nn(_ABON_SFETCHINGn, _GEJY_L3);
  /*#p29.FUGY_ODA1_TO_VA05*/ BUS_VRAM_A05n.tri6_nn(_ABON_SFETCHINGn, oam_temp_a.XEGU_OAM_DA1p.qp_new());
  /* p29.GAVO_ODA2_TO_VA06*/ BUS_VRAM_A06n.tri6_nn(_ABON_SFETCHINGn, oam_temp_a.YJEX_OAM_DA2p.qp_new());
  /* p29.WYGA_ODA3_TO_VA07*/ BUS_VRAM_A07n.tri6_nn(_ABON_SFETCHINGn, oam_temp_a.XYJU_OAM_DA3p.qp_new());
  /* p29.WUNE_ODA4_TO_VA08*/ BUS_VRAM_A08n.tri6_nn(_ABON_SFETCHINGn, oam_temp_a.YBOG_OAM_DA4p.qp_new());
  /* p29.GOTU_ODA5_TO_VA09*/ BUS_VRAM_A09n.tri6_nn(_ABON_SFETCHINGn, oam_temp_a.WYSO_OAM_DA5p.qp_new());
  /* p29.GEGU_ODA6_TO_VA10*/ BUS_VRAM_A10n.tri6_nn(_ABON_SFETCHINGn, oam_temp_a.XOTE_OAM_DA6p.qp_new());
  /* p29.XEHE_ODA7_TO_VA11*/ BUS_VRAM_A11n.tri6_nn(_ABON_SFETCHINGn, oam_temp_a.YZAB_OAM_DA7p.qp_new());
  /* p29.DYSO_BANK_TO_VA12*/ BUS_VRAM_A12n.tri6_nn(_ABON_SFETCHINGn, SIG_GND);   // sprites always in low half of tile store
}
...
void GateBoyVramBus::cpu_data_to_bus_data(const GateBoyCpuBus& cpu_bus, wire SERE_CPU_VRAM_RDp, wire SALE_CPU_VRAM_WRn) {
  ...
  /* p25.TEME_CD0_TO_VD0*/ BUS_VRAM_D00p.tri10_np(_RAHU_CBD_TO_VPDn, cpu_bus.BUS_CPU_D00p.qp_new());
  /* p25.TEWU_CD1_TO_VD1*/ BUS_VRAM_D01p.tri10_np(_RAHU_CBD_TO_VPDn, cpu_bus.BUS_CPU_D01p.qp_new());
  /*#p25.TYGO_CD2_TO_VD2*/ BUS_VRAM_D02p.tri10_np(_RAHU_CBD_TO_VPDn, cpu_bus.BUS_CPU_D02p.qp_new());
  /* p25.SOTE_CD3_TO_VD3*/ BUS_VRAM_D03p.tri10_np(_RAHU_CBD_TO_VPDn, cpu_bus.BUS_CPU_D03p.qp_new());
  /* p25.SEKE_CD4_TO_VD4*/ BUS_VRAM_D04p.tri10_np(_RAHU_CBD_TO_VPDn, cpu_bus.BUS_CPU_D04p.qp_new());
  /* p25.RUJO_CD5_TO_VD5*/ BUS_VRAM_D05p.tri10_np(_RAHU_CBD_TO_VPDn, cpu_bus.BUS_CPU_D05p.qp_new());
  /* p25.TOFA_CD6_TO_VD6*/ BUS_VRAM_D06p.tri10_np(_RAHU_CBD_TO_VPDn, cpu_bus.BUS_CPU_D06p.qp_new());
  /* p25.SUZA_CD7_TO_VD7*/ BUS_VRAM_D07p.tri10_np(_RAHU_CBD_TO_VPDn, cpu_bus.BUS_CPU_D07p.qp_new());
}
...
void GateBoyVramBus::pins_to_data_bus(wire SERE_CPU_VRAM_RDp, wire SALE_CPU_VRAM_WRn) {
  ...
  /* p25.RODY_VP0_TO_VD0*/ BUS_VRAM_D00p.tri6_pn(_RENA_CBD_TO_VPDn, PIN_33_VRAM_D00.qp_new());
  /* p25.REBA_VP1_TO_VD1*/ BUS_VRAM_D01p.tri6_pn(_RENA_CBD_TO_VPDn, PIN_31_VRAM_D01.qp_new());
  /* p25.RYDO_VP2_TO_VD2*/ BUS_VRAM_D02p.tri6_pn(_RENA_CBD_TO_VPDn, PIN_30_VRAM_D02.qp_new());
  /* p25.REMO_VP3_TO_VD3*/ BUS_VRAM_D03p.tri6_pn(_RENA_CBD_TO_VPDn, PIN_29_VRAM_D03.qp_new());
  /* p25.ROCE_VP4_TO_VD4*/ BUS_VRAM_D04p.tri6_pn(_RENA_CBD_TO_VPDn, PIN_28_VRAM_D04.qp_new());
  /* p25.ROPU_VP5_TO_VD5*/ BUS_VRAM_D05p.tri6_pn(_RENA_CBD_TO_VPDn, PIN_27_VRAM_D05.qp_new());
  /* p25.RETA_VP6_TO_VD6*/ BUS_VRAM_D06p.tri6_pn(_RENA_CBD_TO_VPDn, PIN_26_VRAM_D06.qp_new());
  /* p25.RAKU_VP7_TO_VD7*/ BUS_VRAM_D07p.tri6_pn(_RENA_CBD_TO_VPDn, PIN_25_VRAM_D07.qp_new());
}
...
void GateBoyVramBus::data_bus_to_cpu_bus(GateBoyCpuBus& cpu_bus, wire SERE_CPU_VRAM_RDp) {
  ...
  /*#p25.RUGA_VD0_TO_CD0*/ cpu_bus.BUS_CPU_D00p.tri6_pn(_SEBY_VBD_TO_CBDp, _RERY_VBUS_D0n);
  /* p25.ROTA_VD1_TO_CD1*/ cpu_bus.BUS_CPU_D01p.tri6_pn(_SEBY_VBD_TO_CBDp, _RUNA_VBUS_D1n);
  /* p25.RYBU_VD2_TO_CD2*/ cpu_bus.BUS_CPU_D02p.tri6_pn(_SEBY_VBD_TO_CBDp, _RONA_VBUS_D2n);
  /* p25.RAJU_VD3_TO_CD3*/ cpu_bus.BUS_CPU_D03p.tri6_pn(_SEBY_VBD_TO_CBDp, _RUNO_VBUS_D3n);
  /* p25.TYJA_VD4_TO_CD4*/ cpu_bus.BUS_CPU_D04p.tri6_pn(_SEBY_VBD_TO_CBDp, _SANA_VBUS_D4n);
  /* p25.REXU_VD5_TO_CD5*/ cpu_bus.BUS_CPU_D05p.tri6_pn(_SEBY_VBD_TO_CBDp, _RORO_VBUS_D5n);
  /* p25.RUPY_VD6_TO_CD6*/ cpu_bus.BUS_CPU_D06p.tri6_pn(_SEBY_VBD_TO_CBDp, _RABO_VBUS_D6n);
  /* p25.TOKU_VD7_TO_CD7*/ cpu_bus.BUS_CPU_D07p.tri6_pn(_SEBY_VBD_TO_CBDp, _SAME_VBUS_D7n);
}
