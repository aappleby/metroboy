...
void GateBoyVramBus::dma_addr_to_vram_addr(const GateBoyDMA& dma) {
  /* p04.NAKY*/ wire2 _NAKY_DMA_A00p_new = dma.NAKY_DMA_A00p.qp_new2();
  /* p04.PYRO*/ wire2 _PYRO_DMA_A01p_new = dma.PYRO_DMA_A01p.qp_new2();
  /* p04.NEFY*/ wire2 _NEFY_DMA_A02p_new = dma.NEFY_DMA_A02p.qp_new2();
  /* p04.MUTY*/ wire2 _MUTY_DMA_A03p_new = dma.MUTY_DMA_A03p.qp_new2();
  /* p04.NYKO*/ wire2 _NYKO_DMA_A04p_new = dma.NYKO_DMA_A04p.qp_new2();
  /* p04.PYLO*/ wire2 _PYLO_DMA_A05p_new = dma.PYLO_DMA_A05p.qp_new2();
  /* p04.NUTO*/ wire2 _NUTO_DMA_A06p_new = dma.NUTO_DMA_A06p.qp_new2();
  /* p04.MUGU*/ wire2 _MUGU_DMA_A07p_new = dma.MUGU_DMA_A07p.qp_new2();
  /* p04.NAFA*/ wire2 _NAFA_DMA_A08p_new = dma.NAFA_DMA_A08n.qn_new2();
  /* p04.PYNE*/ wire2 _PYNE_DMA_A09p_new = dma.PYNE_DMA_A09n.qn_new2();
  /* p04.PARA*/ wire2 _PARA_DMA_A10p_new = dma.PARA_DMA_A10n.qn_new2();
  /* p04.NYDO*/ wire2 _NYDO_DMA_A11p_new = dma.NYDO_DMA_A11n.qn_new2();
  /* p04.NYGY*/ wire2 _NYGY_DMA_A12p_new = dma.NYGY_DMA_A12n.qn_new2();
...
void GateBoyVramBus::tile_to_addr(const BGScrollY scroll_y, const WinLineY win_line_y, const TileTempB tile_temp_b, wire2 NETA_BGW_TILE_READp, wire2 XUHA_FETCH_HILOp, wire2 WEXU_LCDC_BGTILEp, wire2 PORE_WIN_MODEp, wire2 AXAD_WIN_MODEn) {
  ...
  /*#p25.VUZA*/ wire2 _VUZA_TILE_BANKp = nor2b(tile_temp_b.PYJU_TILE_DB7p.qp_new2(), WEXU_LCDC_BGTILEp);
...
void GateBoyVramBus::sprite_to_addr(Bus SPR_TRI_L[4], const OamTempA& oam_temp_a, const OamTempB& oam_temp_b, wire2 XUQU_SPRITE_AB, wire2 SAKY_SFETCHn, wire2 XYMU_RENDERINGp, wire2 XYMO_LCDC_SPSIZEp) {
  /*#p29.WUKY*/ wire2 _WUKY_FLIP_Yp = not1b(oam_temp_b.YZOS_OAM_DB6p.qp_new2());
  /*#p29.FUFO*/ wire2 _FUFO_LCDC_SPSIZEn = not1b(XYMO_LCDC_SPSIZEp);

  /*#p29.CYVU*/ wire2 _CYVU_L0 = xor2(_WUKY_FLIP_Yp, SPR_TRI_L[0].qp_new2());
  /*#p29.BORE*/ wire2 _BORE_L1 = xor2(_WUKY_FLIP_Yp, SPR_TRI_L[1].qp_new2());
  /*#p29.BUVY*/ wire2 _BUVY_L2 = xor2(_WUKY_FLIP_Yp, SPR_TRI_L[2].qp_new2());
  /*#p29.WAGO*/ wire2 _WAGO_L3 = xor2(_WUKY_FLIP_Yp, SPR_TRI_L[3].qp_new2());
  /*#p29.GEJY*/ wire2 _GEJY_L3 = amux2(oam_temp_a.XUSO_OAM_DA0p.qp_new2(), _FUFO_LCDC_SPSIZEn, XYMO_LCDC_SPSIZEp, _WAGO_L3);
...
void GateBoyVramBus::addr_to_pins() {
  /* p25.MYFU*/ wire2 _MYFUp = not1b(BUS_VRAM_An[ 0].qp_new2());
  /* p25.MASA*/ wire2 _MASAp = not1b(BUS_VRAM_An[ 1].qp_new2());
  /* p25.MYRE*/ wire2 _MYREp = not1b(BUS_VRAM_An[ 2].qp_new2());
  /* p25.MAVU*/ wire2 _MAVUp = not1b(BUS_VRAM_An[ 3].qp_new2());
  /* p25.MEPA*/ wire2 _MEPAp = not1b(BUS_VRAM_An[ 4].qp_new2());
  /* p25.MYSA*/ wire2 _MYSAp = not1b(BUS_VRAM_An[ 5].qp_new2());
  /* p25.MEWY*/ wire2 _MEWYp = not1b(BUS_VRAM_An[ 6].qp_new2());
  /* p25.MUME*/ wire2 _MUMEp = not1b(BUS_VRAM_An[ 7].qp_new2());
  /* p25.VOVA*/ wire2 _VOVAp = not1b(BUS_VRAM_An[ 8].qp_new2());
  /* p25.VODE*/ wire2 _VODEp = not1b(BUS_VRAM_An[ 9].qp_new2());
  /* p25.RUKY*/ wire2 _RUKYp = not1b(BUS_VRAM_An[10].qp_new2());
  /* p25.RUMA*/ wire2 _RUMAp = not1b(BUS_VRAM_An[11].qp_new2());
  /* p25.REHO*/ wire2 _REHOp = not1b(BUS_VRAM_An[12].qp_new2());
...
void GateBoyVramBus::bus_data_to_pins(wire2 SERE_CPU_VRAM_RDp, wire2 SALE_CPU_VRAM_WRn) {
  ...
  /*#p25.SEFA*/ wire2 _SEFA_D0p = and2(BUS_VRAM_Dp[0].qp_new2(), _ROVE_CBD_TO_VPDp);
  /* p25.SOGO*/ wire2 _SOGO_D1p = and2(BUS_VRAM_Dp[1].qp_new2(), _ROVE_CBD_TO_VPDp);
  /* p25.SEFU*/ wire2 _SEFU_D2p = and2(BUS_VRAM_Dp[2].qp_new2(), _ROVE_CBD_TO_VPDp);
  /* p25.SUNA*/ wire2 _SUNA_D3p = and2(BUS_VRAM_Dp[3].qp_new2(), _ROVE_CBD_TO_VPDp);
  /* p25.SUMO*/ wire2 _SUMO_D4p = and2(BUS_VRAM_Dp[4].qp_new2(), _ROVE_CBD_TO_VPDp);
  /* p25.SAZU*/ wire2 _SAZU_D5p = and2(BUS_VRAM_Dp[5].qp_new2(), _ROVE_CBD_TO_VPDp);
  /* p25.SAMO*/ wire2 _SAMO_D6p = and2(BUS_VRAM_Dp[6].qp_new2(), _ROVE_CBD_TO_VPDp);
  /* p25.SUKE*/ wire2 _SUKE_D7p = and2(BUS_VRAM_Dp[7].qp_new2(), _ROVE_CBD_TO_VPDp);

  /*#p25.SYNU*/ wire2 _SYNU_D0p = or2(_RAHU_CBD_TO_VPDn, BUS_VRAM_Dp[0].qp_new2());
  /* p25.SYMA*/ wire2 _SYMA_D1p = or2(_RAHU_CBD_TO_VPDn, BUS_VRAM_Dp[1].qp_new2());
  /* p25.ROKO*/ wire2 _ROKO_D2p = or2(_RAHU_CBD_TO_VPDn, BUS_VRAM_Dp[2].qp_new2());
  /* p25.SYBU*/ wire2 _SYBU_D3p = or2(_RAHU_CBD_TO_VPDn, BUS_VRAM_Dp[3].qp_new2());
  /* p25.SAKO*/ wire2 _SAKO_D4p = or2(_RAHU_CBD_TO_VPDn, BUS_VRAM_Dp[4].qp_new2());
  /* p25.SEJY*/ wire2 _SEJY_D5p = or2(_RAHU_CBD_TO_VPDn, BUS_VRAM_Dp[5].qp_new2());
  /* p25.SEDO*/ wire2 _SEDO_D6p = or2(_RAHU_CBD_TO_VPDn, BUS_VRAM_Dp[6].qp_new2());
  /* p25.SAWU*/ wire2 _SAWU_D7p = or2(_RAHU_CBD_TO_VPDn, BUS_VRAM_Dp[7].qp_new2());
...
void GateBoyVramBus::set_pin_wr(wire2 TUTO_VRAM_DBGp, wire2 SERE_CPU_VRAM_RDp, wire2 TUJA_CPU_VRAM_WRp) {
  /* p25.SUDO*/ wire2 _SUDO_MWRp = not1b(/*vram_bus.PIN_VRAM_WRn.qn_new2()*/ 1); // Ignoring debug stuff for now
...
void GateBoyVramBus::data_bus_to_cpu_bus(GateBoyCpuBus& cpu_bus, wire2 SERE_CPU_VRAM_RDp) {
  /* p25.RERY*/ wire2 _RERY_VBUS_D0n = not1b(BUS_VRAM_Dp[0].qp_new2());
  /* p25.RUNA*/ wire2 _RUNA_VBUS_D1n = not1b(BUS_VRAM_Dp[1].qp_new2());
  /* p25.RONA*/ wire2 _RONA_VBUS_D2n = not1b(BUS_VRAM_Dp[2].qp_new2());
  /* p25.RUNO*/ wire2 _RUNO_VBUS_D3n = not1b(BUS_VRAM_Dp[3].qp_new2());
  /* p25.SANA*/ wire2 _SANA_VBUS_D4n = not1b(BUS_VRAM_Dp[4].qp_new2());
  /* p25.RORO*/ wire2 _RORO_VBUS_D5n = not1b(BUS_VRAM_Dp[5].qp_new2());
  /* p25.RABO*/ wire2 _RABO_VBUS_D6n = not1b(BUS_VRAM_Dp[6].qp_new2());
  /* p25.SAME*/ wire2 _SAME_VBUS_D7n = not1b(BUS_VRAM_Dp[7].qp_new2());
