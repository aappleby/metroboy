...
struct GateBoyVramBus {
  ...
  void sprite_to_addr(const GateBoySpriteStore& sprite_store, const OamTempA& oam_temp_a, const OamTempB& oam_temp_b, wire XUQU_SPRITE_AB, wire SAKY_SFETCHn, NorLatch XYMU_RENDERINGp, DFF9 XYMO_LCDC_SPSIZEn);
  void addr_to_pins();
