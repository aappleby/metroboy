...
void DmaRegisters::tock(const SchematicTop& top, CpuBus& cpu_bus) {
  ...
  // FF46 DMA
  {
    ...
    /* p04.NYGY*/ NYGY_DMA_A12n = dff8_AB_inv(LORU_FF46_WRn, top.cpu_bus.BUS_CPU_D4p.tp());
    /* p04.PULA*/ PULA_DMA_A13n = dff8_AB_inv(LORU_FF46_WRn, top.cpu_bus.BUS_CPU_D5p.tp());
    /* p04.POKU*/ POKU_DMA_A14n = dff8_AB_inv(LORU_FF46_WRn, top.cpu_bus.BUS_CPU_D6p.tp());
    /* p04.MARU*/ MARU_DMA_A15n = dff8_AB_inv(LORU_FF46_WRn, top.cpu_bus.BUS_CPU_D7p.tp());
