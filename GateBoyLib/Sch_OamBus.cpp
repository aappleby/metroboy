...
void OamBus::dump(Dumper& d) const {
  ...
  int oam_tri_addr = pack_p(OAM_BUS_A0n.c(), OAM_BUS_A1n.c(), OAM_BUS_A2n.c(), OAM_BUS_A3n.c(),
                            OAM_BUS_A4n.c(), OAM_BUS_A5n.c(), OAM_BUS_A6n.c(), OAM_BUS_A7n.c());

  d("OAM TRI ADDR   %03d %02x %c%c%c%c%c%c%c%c\n", 
    oam_tri_addr,
    oam_tri_addr,
    OAM_BUS_A7n.c(), OAM_BUS_A6n.c(), OAM_BUS_A5n.c(), OAM_BUS_A4n.c(),
    OAM_BUS_A3n.c(), OAM_BUS_A2n.c(), OAM_BUS_A1n.c(), OAM_BUS_A0n.c());
...
void OamBus::tock(SchematicTop& top) {
  ...
  /*#p28.GEKA*/ wire GEKA_OAM_A0p = not1(OAM_BUS_A0n.tp()); // -> WAFO, YLYC, WUKU
  /* p28.ZYFO*/ wire ZYFO_OAM_A1p = not1(OAM_BUS_A1n.tp());
  /* p28.YFOT*/ wire YFOT_OAM_A2p = not1(OAM_BUS_A2n.tp());
  /* p28.YFOC*/ wire YFOC_OAM_A3p = not1(OAM_BUS_A3n.tp());
  /* p28.YVOM*/ wire YVOM_OAM_A4p = not1(OAM_BUS_A4n.tp());
  /* p28.YMEV*/ wire YMEV_OAM_A5p = not1(OAM_BUS_A5n.tp());
  /* p28.XEMU*/ wire XEMU_OAM_A6p = not1(OAM_BUS_A6n.tp());
  /* p28.YZET*/ wire YZET_OAM_A7p = not1(OAM_BUS_A7n.tp());
  ...
  /*p28.GEFY*/ OAM_BUS_A0n = tribuf_6nn(APAR_SCAN_OAM_RDn, GND);
  /*p28.WUWE*/ OAM_BUS_A1n = tribuf_6nn(APAR_SCAN_OAM_RDn, GND);
  /*p28.GUSE*/ OAM_BUS_A2n = tribuf_6nn(APAR_SCAN_OAM_RDn, top.sprite_scanner.YFEL_SCAN0.qp());
  /*p28.GEMA*/ OAM_BUS_A3n = tribuf_6nn(APAR_SCAN_OAM_RDn, top.sprite_scanner.WEWY_SCAN1.qp());
  /*p28.FUTO*/ OAM_BUS_A4n = tribuf_6nn(APAR_SCAN_OAM_RDn, top.sprite_scanner.GOSO_SCAN2.qp());
  /*p28.FAKU*/ OAM_BUS_A5n = tribuf_6nn(APAR_SCAN_OAM_RDn, top.sprite_scanner.ELYN_SCAN3.qp());
  /*p28.GAMA*/ OAM_BUS_A6n = tribuf_6nn(APAR_SCAN_OAM_RDn, top.sprite_scanner.FAHA_SCAN4.qp());
  /*p28.GOBY*/ OAM_BUS_A7n = tribuf_6nn(APAR_SCAN_OAM_RDn, top.sprite_scanner.FONY_SCAN5.qp());

  // DMA addr -> OAM addr
  /*p28.FODO*/ OAM_BUS_A0n = tribuf_6nn(DUGA_DMA_OAM_RDn, top.dma_reg.NAKY_DMA_A00p.qp());
  /*p28.FESA*/ OAM_BUS_A1n = tribuf_6nn(DUGA_DMA_OAM_RDn, top.dma_reg.PYRO_DMA_A01p.qp());
  /*p28.FAGO*/ OAM_BUS_A2n = tribuf_6nn(DUGA_DMA_OAM_RDn, top.dma_reg.NEFY_DMA_A02p.qp());
  /*p28.FYKY*/ OAM_BUS_A3n = tribuf_6nn(DUGA_DMA_OAM_RDn, top.dma_reg.MUTY_DMA_A03p.qp());
  /*p28.ELUG*/ OAM_BUS_A4n = tribuf_6nn(DUGA_DMA_OAM_RDn, top.dma_reg.NYKO_DMA_A04p.qp());
  /*p28.EDOL*/ OAM_BUS_A5n = tribuf_6nn(DUGA_DMA_OAM_RDn, top.dma_reg.PYLO_DMA_A05p.qp());
  /*p28.FYDU*/ OAM_BUS_A6n = tribuf_6nn(DUGA_DMA_OAM_RDn, top.dma_reg.NUTO_DMA_A06p.qp());
  /*p28.FETU*/ OAM_BUS_A7n = tribuf_6nn(DUGA_DMA_OAM_RDn, top.dma_reg.MUGU_DMA_A07p.qp());

  // CPU addr -> OAM addr
  /*p28.GARO*/ OAM_BUS_A0n = tribuf_6nn(ASAM_CPU_OAM_RDn, top.cpu_bus.CPU_BUS_A00.tp());
  /*p28.WACU*/ OAM_BUS_A1n = tribuf_6nn(ASAM_CPU_OAM_RDn, top.cpu_bus.CPU_BUS_A01.tp());
  /*p28.GOSE*/ OAM_BUS_A2n = tribuf_6nn(ASAM_CPU_OAM_RDn, top.cpu_bus.CPU_BUS_A02.tp());
  /*p28.WAPE*/ OAM_BUS_A3n = tribuf_6nn(ASAM_CPU_OAM_RDn, top.cpu_bus.CPU_BUS_A03.tp());
  /*p28.FEVU*/ OAM_BUS_A4n = tribuf_6nn(ASAM_CPU_OAM_RDn, top.cpu_bus.CPU_BUS_A04.tp());
  /*p28.GERA*/ OAM_BUS_A5n = tribuf_6nn(ASAM_CPU_OAM_RDn, top.cpu_bus.CPU_BUS_A05.tp());
  /*p28.WAXA*/ OAM_BUS_A6n = tribuf_6nn(ASAM_CPU_OAM_RDn, top.cpu_bus.CPU_BUS_A06.tp());
  /*p28.FOBY*/ OAM_BUS_A7n = tribuf_6nn(ASAM_CPU_OAM_RDn, top.cpu_bus.CPU_BUS_A07.tp());

  // PPU addr -> OAM addr
  /*p28.GECA*/ OAM_BUS_A0n = tribuf_6nn(BETE_PPU_OAM_RDn, WEFE_VCC);
  /*p28.WYDU*/ OAM_BUS_A1n = tribuf_6nn(BETE_PPU_OAM_RDn, WEFE_VCC);
  /*p28.GYBU*/ OAM_BUS_A2n = tribuf_6nn(BETE_PPU_OAM_RDn, top.sprite_store.SPR_TRI_I0p.tp());
  /*p28.GYKA*/ OAM_BUS_A3n = tribuf_6nn(BETE_PPU_OAM_RDn, top.sprite_store.SPR_TRI_I1p.tp());
  /*p28.FABY*/ OAM_BUS_A4n = tribuf_6nn(BETE_PPU_OAM_RDn, top.sprite_store.SPR_TRI_I2p.tp());
  /*p28.FACO*/ OAM_BUS_A5n = tribuf_6nn(BETE_PPU_OAM_RDn, top.sprite_store.SPR_TRI_I3p.tp());
  /*p28.FUGU*/ OAM_BUS_A6n = tribuf_6nn(BETE_PPU_OAM_RDn, top.sprite_store.SPR_TRI_I4p.tp());
  /*p28.FYKE*/ OAM_BUS_A7n = tribuf_6nn(BETE_PPU_OAM_RDn, top.sprite_store.SPR_TRI_I5p.tp());
...

  {
    ...
    /*p04.POWU*/ wire _POWU_DMA_OAM_WRp     = and2(top.dma_reg.MATU_DMA_RUNNINGp.qp(), _NAXY_DMA_OAM_WENp); // def and
  ...
  // VBD -> OPD
  {
    ...
    /*p28.WUZU*/ OAM_PIN_DA0n = tribuf_6nn(AZAR_VBD_TO_OBDn, !RERY_VRM_BUS_D0p);
    /*p28.AXER*/ OAM_PIN_DA1n = tribuf_6nn(AZAR_VBD_TO_OBDn, !RUNA_VRM_BUS_D1p);
    /*p28.ASOX*/ OAM_PIN_DA2n = tribuf_6nn(AZAR_VBD_TO_OBDn, !RONA_VRM_BUS_D2p);
    /*p28.CETU*/ OAM_PIN_DA3n = tribuf_6nn(AZAR_VBD_TO_OBDn, !RUNO_VRM_BUS_D3p);
    /*p28.ARYN*/ OAM_PIN_DA4n = tribuf_6nn(AZAR_VBD_TO_OBDn, !SANA_VRM_BUS_D4p);
    /*p28.ACOT*/ OAM_PIN_DA5n = tribuf_6nn(AZAR_VBD_TO_OBDn, !RORO_VRM_BUS_D5p);
    /*p28.CUJE*/ OAM_PIN_DA6n = tribuf_6nn(AZAR_VBD_TO_OBDn, !RABO_VRM_BUS_D6p);
    /*p28.ATER*/ OAM_PIN_DA7n = tribuf_6nn(AZAR_VBD_TO_OBDn, !SAME_VRM_BUS_D7p);

    /*p28.WOWA*/ OAM_PIN_DB0n = tribuf_6nn(AZAR_VBD_TO_OBDn, !RERY_VRM_BUS_D0p);
    /*p28.AVEB*/ OAM_PIN_DB1n = tribuf_6nn(AZAR_VBD_TO_OBDn, !RUNA_VRM_BUS_D1p);
    /*p28.AMUH*/ OAM_PIN_DB2n = tribuf_6nn(AZAR_VBD_TO_OBDn, !RONA_VRM_BUS_D2p);
    /*p28.COFO*/ OAM_PIN_DB3n = tribuf_6nn(AZAR_VBD_TO_OBDn, !RUNO_VRM_BUS_D3p);
    /*p28.AZOZ*/ OAM_PIN_DB4n = tribuf_6nn(AZAR_VBD_TO_OBDn, !SANA_VRM_BUS_D4p);
    /*p28.AGYK*/ OAM_PIN_DB5n = tribuf_6nn(AZAR_VBD_TO_OBDn, !RORO_VRM_BUS_D5p);
    /*p28.BUSE*/ OAM_PIN_DB6n = tribuf_6nn(AZAR_VBD_TO_OBDn, !RABO_VRM_BUS_D6p);
    /*p28.ANUM*/ OAM_PIN_DB7n = tribuf_6nn(AZAR_VBD_TO_OBDn, !SAME_VRM_BUS_D7p);
  }
  ...
  // OPD -> OBL
  {
    ...
    /*p29.YDYV*/ YDYV_OAM_LATCH_DA0n = tp_latch_AB(BODE_OBD_TO_OBLp, OAM_PIN_DA0n); // -> XUSO, YFAP
    /*p29.YCEB*/ YCEB_OAM_LATCH_DA1n = tp_latch_AB(BODE_OBD_TO_OBLp, OAM_PIN_DA1n);
    /*p29.ZUCA*/ ZUCA_OAM_LATCH_DA2n = tp_latch_AB(BODE_OBD_TO_OBLp, OAM_PIN_DA2n);
    /*p29.WONE*/ WONE_OAM_LATCH_DA3n = tp_latch_AB(BODE_OBD_TO_OBLp, OAM_PIN_DA3n);
    /*p29.ZAXE*/ ZAXE_OAM_LATCH_DA4n = tp_latch_AB(BODE_OBD_TO_OBLp, OAM_PIN_DA4n);
    /*p29.XAFU*/ XAFU_OAM_LATCH_DA5n = tp_latch_AB(BODE_OBD_TO_OBLp, OAM_PIN_DA5n);
    /*p29.YSES*/ YSES_OAM_LATCH_DA6n = tp_latch_AB(BODE_OBD_TO_OBLp, OAM_PIN_DA6n);
    /*p29.ZECA*/ ZECA_OAM_LATCH_DA7n = tp_latch_AB(BODE_OBD_TO_OBLp, OAM_PIN_DA7n);

    /*p31.XYKY*/ XYKY_OAM_LATCH_DB0n = tp_latch_AB(BODE_OBD_TO_OBLp, OAM_PIN_DB0n);
    /*p31.YRUM*/ YRUM_OAM_LATCH_DB1n = tp_latch_AB(BODE_OBD_TO_OBLp, OAM_PIN_DB1n);
    /*p31.YSEX*/ YSEX_OAM_LATCH_DB2n = tp_latch_AB(BODE_OBD_TO_OBLp, OAM_PIN_DB2n);
    /*p31.YVEL*/ YVEL_OAM_LATCH_DB3n = tp_latch_AB(BODE_OBD_TO_OBLp, OAM_PIN_DB3n);
    /*p31.WYNO*/ WYNO_OAM_LATCH_DB4n = tp_latch_AB(BODE_OBD_TO_OBLp, OAM_PIN_DB4n);
    /*p31.CYRA*/ CYRA_OAM_LATCH_DB5n = tp_latch_AB(BODE_OBD_TO_OBLp, OAM_PIN_DB5n);
    /*p31.ZUVE*/ ZUVE_OAM_LATCH_DB6n = tp_latch_AB(BODE_OBD_TO_OBLp, OAM_PIN_DB6n);
    /*p31.ECED*/ ECED_OAM_LATCH_DB7n = tp_latch_AB(BODE_OBD_TO_OBLp, OAM_PIN_DB7n);
  }
  ...
  // OBL -> CBD
  {
    ...
    /* p29.YFAP*/ top.cpu_bus.CPU_BUS_D0p = tribuf_10nn(WUME_OBL_TO_CBDn, YDYV_OAM_LATCH_DA0n.qn());
    /* p29.XELE*/ top.cpu_bus.CPU_BUS_D1p = tribuf_10nn(WUME_OBL_TO_CBDn, YCEB_OAM_LATCH_DA1n.qn());
    /* p29.YPON*/ top.cpu_bus.CPU_BUS_D2p = tribuf_10nn(WUME_OBL_TO_CBDn, ZUCA_OAM_LATCH_DA2n.qn());
    /* p29.XUVO*/ top.cpu_bus.CPU_BUS_D3p = tribuf_10nn(WUME_OBL_TO_CBDn, WONE_OAM_LATCH_DA3n.qn());
    /* p29.ZYSA*/ top.cpu_bus.CPU_BUS_D4p = tribuf_10nn(WUME_OBL_TO_CBDn, ZAXE_OAM_LATCH_DA4n.qn());
    /* p29.YWEG*/ top.cpu_bus.CPU_BUS_D5p = tribuf_10nn(WUME_OBL_TO_CBDn, XAFU_OAM_LATCH_DA5n.qn());
    /* p29.XABU*/ top.cpu_bus.CPU_BUS_D6p = tribuf_10nn(WUME_OBL_TO_CBDn, YSES_OAM_LATCH_DA6n.qn());
    /* p29.YTUX*/ top.cpu_bus.CPU_BUS_D7p = tribuf_10nn(WUME_OBL_TO_CBDn, ZECA_OAM_LATCH_DA7n.qn());
       
    /* p28.WEWU*/ wire WEWU_OBL_TO_CBDn = not1(WUKU_OBL_TO_CBDp);
    /* p31.XACA*/ top.cpu_bus.CPU_BUS_D0p = tribuf_10nn(WEWU_OBL_TO_CBDn, XYKY_OAM_LATCH_DB0n.qn());
    /* p31.XAGU*/ top.cpu_bus.CPU_BUS_D1p = tribuf_10nn(WEWU_OBL_TO_CBDn, YRUM_OAM_LATCH_DB1n.qn());
    /* p31.XEPU*/ top.cpu_bus.CPU_BUS_D2p = tribuf_10nn(WEWU_OBL_TO_CBDn, YSEX_OAM_LATCH_DB2n.qn());
    /* p31.XYGU*/ top.cpu_bus.CPU_BUS_D3p = tribuf_10nn(WEWU_OBL_TO_CBDn, YVEL_OAM_LATCH_DB3n.qn());
    /* p31.XUNA*/ top.cpu_bus.CPU_BUS_D4p = tribuf_10nn(WEWU_OBL_TO_CBDn, WYNO_OAM_LATCH_DB4n.qn());
    /* p31.DEVE*/ top.cpu_bus.CPU_BUS_D5p = tribuf_10nn(WEWU_OBL_TO_CBDn, CYRA_OAM_LATCH_DB5n.qn());
    /* p31.ZEHA*/ top.cpu_bus.CPU_BUS_D6p = tribuf_10nn(WEWU_OBL_TO_CBDn, ZUVE_OAM_LATCH_DB6n.qn());
    /* p31.FYRA*/ top.cpu_bus.CPU_BUS_D7p = tribuf_10nn(WEWU_OBL_TO_CBDn, ECED_OAM_LATCH_DB7n.qn());
  }
}
