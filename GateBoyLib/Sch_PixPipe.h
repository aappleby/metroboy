...
struct PixelPipe {
  ...
  /*p27.SOVY*/ Reg SOVY_WIN_FIRST_TILE_B = REG_D0C0;

  // Pixel counter
  /*p21.XEHO*/ Reg XEHO_X0p = REG_D0C0;
  /*p21.SAVY*/ Reg  SAVY_X1p = REG_D0C0;
  /*p21.XODU*/ Reg  XODU_X2p = REG_D0C0;
  /*p21.XYDO*/ Reg  XYDO_X3p = REG_D0C0;
  /*p21.TUHU*/ Reg TUHU_X4p = REG_D0C0;
  /*p21.TUKY*/ Reg  TUKY_X5p = REG_D0C0;
  /*p21.TAKO*/ Reg  TAKO_X6p = REG_D0C0;
  /*p21.SYBE*/ Reg  SYBE_X7p = REG_D0C0;

  // Current window pixel coord
  /*p27.WYKA*/ Reg WYKA_WIN_X3 = REG_D0C0;
  /*p27.WODY*/ Reg WODY_WIN_X4 = REG_D0C0;
  /*p27.WOBO*/ Reg WOBO_WIN_X5 = REG_D0C0;
  /*p27.WYKO*/ Reg WYKO_WIN_X6 = REG_D0C0;
  /*p27.XOLO*/ Reg XOLO_WIN_X7 = REG_D0C0;

  /*p27.VYNO*/ Reg VYNO_WIN_Y0 = REG_D0C0;
  /*p27.VUJO*/ Reg VUJO_WIN_Y1 = REG_D0C0;
  /*p27.VYMU*/ Reg VYMU_WIN_Y2 = REG_D0C0;
  /*p27.TUFU*/ Reg TUFU_WIN_Y3 = REG_D0C0;
  /*p27.TAXA*/ Reg TAXA_WIN_Y4 = REG_D0C0;
  /*p27.TOZO*/ Reg TOZO_WIN_Y5 = REG_D0C0;
  /*p27.TATE*/ Reg TATE_WIN_Y6 = REG_D0C0;
  /*p27.TEKE*/ Reg TEKE_WIN_Y7 = REG_D0C0;
...
private:
  ...
  /*p27.NOPA*/ Reg  NOPA_WIN_MODE_B       = REG_D0C0;
  /*p27.REJO*/ Tri    REJO_WY_MATCH_LATCH   = TRI_D0NP;
  /*p27.SARY*/ Reg  SARY_WY_MATCH         = REG_D0C0;
  /*p27.RYFA*/ Reg RYFA_FETCHn_A      = REG_D0C0;
  /*p27.RENE*/ Reg RENE_FETCHn_B      = REG_D0C0;
  /*p27.PYCO*/ Reg  PYCO_WX_MATCH_A       = REG_D0C0;
  /*p27.NUNU*/ Reg  NUNU_WX_MATCH_B       = REG_D0C0;

  /*p??.ROXY*/ Latch ROXY_SCX_FINE_MATCH_LATCHn = TRI_D1NP;

  /*p27.RYKU*/ Reg RYKU_FINE_CNT0 = REG_D0C0;
  /*p27.ROGA*/ Reg ROGA_FINE_CNT1 = REG_D0C0;
  /*p27.RUBU*/ Reg RUBU_FINE_CNT2 = REG_D0C0;

  /*p21.RUPO*/ Tri RUPO_LYC_MATCH_LATCHn = TRI_D0NP;

  /*p21.WUSA*/ Tri WUSA_LCD_CLOCK_GATE = TRI_D0NP;
  /*p21.VOGA*/ Reg VOGA_HBLANKp = REG_D0C0;
  /*p??.PUXA*/ Reg PUXA_SCX_FINE_MATCH_A = REG_D0C0;
  /*p27.NYZE*/ Reg NYZE_SCX_FINE_MATCH_B = REG_D0C0;

  /*p24.PAHO*/ Reg PAHO_X_8_SYNC = REG_D0C0;
