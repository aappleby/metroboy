...
void SerialRegisters::tock(const SchematicTop& top, CpuBus& cpu_bus) {
  ...
  /*p06.CAVE*/ wire CAVE_SER_CLK_MUXn = mux2_n(COTY_SER_CLK.qp(), SCK_C.tp(), CULY_XFER_DIR.qp());
  ...
  /*p06.CALY*/ CALY_SER_INTp = dff17_AB(CYDE_SER_CNT2.qn(), CARO_SER_RST, CALY_SER_INTp.qn());
  ...
  /*p05.KENA*/ SOUTn = ELYS_SER_OUT.qp();
