...
void SerialRegisters::tock(const SchematicTop& top, CpuBus& cpu_bus) {
  ...
  /*p06.DEGU*/ DEGU_SER_DATA1.dff22(DAWE_SER_CLK, DOCU_SER_DATA1_SETn, DUMO_SER_DATA1_RSTn, CUBA_SER_DATA0.q16());
  /*p06.DYRA*/ DYRA_SER_DATA2.dff22(DAWE_SER_CLK, DELA_SER_DATA2_SETn, DYBO_SER_DATA2_RSTn, DEGU_SER_DATA1.q16());
  /*p06.DOJO*/ DOJO_SER_DATA3.dff22(DAWE_SER_CLK, DYGE_SER_DATA3_SETn, DAJU_SER_DATA3_RSTn, DYRA_SER_DATA2.q16());
  /*p06.DOVU*/ DOVU_SER_DATA4.dff22(EPYT_SER_CLK, DOLA_SER_DATA4_SETn, DYLY_SER_DATA4_RSTn, DOJO_SER_DATA3.q16());
  /*p06.EJAB*/ EJAB_SER_DATA5.dff22(EPYT_SER_CLK, ELOK_SER_DATA5_SETn, EHUJ_SER_DATA5_RSTn, DOVU_SER_DATA4.q16());
  /*p06.EROD*/ EROD_SER_DATA6.dff22(EPYT_SER_CLK, EDEL_SER_DATA6_SETn, EFAK_SER_DATA6_RSTn, EJAB_SER_DATA5.q16());
  /*p06.EDER*/ EDER_SER_DATA7.dff22(EPYT_SER_CLK, EFEL_SER_DATA7_SETn, EGUV_SER_DATA7_RSTn, EROD_SER_DATA6.q16());

  /*p06.ELYS*/ ELYS_SER_OUT  .dff17(EDYL_SER_CLK, top.clk_reg.ALUR_SYS_RSTn, EDER_SER_DATA7.q16());
  ...
  /*#p06.CUGY*/ cpu_bus.BUS_CPU_D0p.tri_6pn(UFEG_FF01_RD, CUBA_SER_DATA0.q15());
  /* p06.DUDE*/ cpu_bus.BUS_CPU_D1p.tri_6pn(UFEG_FF01_RD, DEGU_SER_DATA1.q15());
  /* p06.DETU*/ cpu_bus.BUS_CPU_D2p.tri_6pn(UFEG_FF01_RD, DYRA_SER_DATA2.q15());
  /* p06.DASO*/ cpu_bus.BUS_CPU_D3p.tri_6pn(UFEG_FF01_RD, DOJO_SER_DATA3.q15());
  /* p06.DAME*/ cpu_bus.BUS_CPU_D4p.tri_6pn(UFEG_FF01_RD, DOVU_SER_DATA4.q15());
  /* p06.EVOK*/ cpu_bus.BUS_CPU_D5p.tri_6pn(UFEG_FF01_RD, EJAB_SER_DATA5.q15());
  /* p06.EFAB*/ cpu_bus.BUS_CPU_D6p.tri_6pn(UFEG_FF01_RD, EROD_SER_DATA6.q15());
  /*#p06.ETAK*/ cpu_bus.BUS_CPU_D7p.tri_6pn(UFEG_FF01_RD, EDER_SER_DATA7.q15());
}
