...
struct SerialRegisters {
  ...
  int get_data() const {
    return pack_p(EDER_SER_DATA7.q16(), EROD_SER_DATA6.q16(), EJAB_SER_DATA5.q16(), DOVU_SER_DATA4.q16(),
                  DOJO_SER_DATA3.q16(), DYRA_SER_DATA2.q16(), DEGU_SER_DATA1.q16(), CUBA_SER_DATA0.q16());
  }
