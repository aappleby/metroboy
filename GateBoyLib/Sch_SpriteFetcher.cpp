...
void SpriteFetcher::tock(SchematicTop& top) {
  ...
  /* p27.TEKY*/ wire _TEKY_SFETCH_REQp = and4(top.sprite_store.FEPO_STORE_MATCHp, TUKU_WIN_HITn, top.tile_fetcher.LYRY_BFETCH_DONEp, _SOWO_SFETCH_RUNNINGn);

  /* p27.SOBU*/ SOBU_SFETCH_REQp.dff17(TAVA_xBxDxFxH, VYPO, _TEKY_SFETCH_REQp);
  ...
  /*#p27.SECA*/ wire _SECA_SFETCH_RUNNING_SETn = nor3(_RYCE_SFETCH_TRIGp, ROSY_VID_RSTp, ATEJ_VID_LINE_END_TRIGp);
  ...
  /*#p29.TOMA*/ wire _TOMA_SFETCH_CLK_xBxDxFxH = nand2(LAPE_AxCxExGx, _TAME_SFETCH_CLK_GATE);
