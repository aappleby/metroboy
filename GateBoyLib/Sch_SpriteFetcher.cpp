...
void SpriteFetcher::tock(SchematicTop& top) {
  ...
  /* p27.SOBU*/ SOBU_SFETCH_REQp = dff17_B(TAVA_xBxDxFxH, VYPO, TEKY_SFETCH_REQp);
  /* p27.SUDA*/ SUDA_SFETCH_REQp = dff17_A(LAPE_AxCxExGx, VYPO, SOBU_SFETCH_REQp.qp());
  ...
  /*#p29.TOXE*/ TOXE_SFETCH_S0    = dff17_AB(TOMA_SFETCH_CLK_xBxDxFxH, SECA_SFETCH_RUNNING_SETn, TOXE_SFETCH_S0.qn());
  /*#p29.TYFO*/ TYFO_SFETCH_S0_D1 = dff17_AB(LAPE_AxCxExGx,            VYPO,                     TOXE_SFETCH_S0.qp());
  /*#p29.TULY*/ TULY_SFETCH_S1    = dff17_AB(TOXE_SFETCH_S0.qn(),      SECA_SFETCH_RUNNING_SETn, TULY_SFETCH_S1.qn());
  /*#p29.TOBU*/ TOBU_SFETCH_S1_D2 = dff17_B (TAVA_xBxDxFxH,            XYMU_RENDERINGp,          TULY_SFETCH_S1.qp());
  /*#p29.VONU*/ VONU_SFETCH_S1_D4 = dff17_AB(TAVA_xBxDxFxH,            XYMU_RENDERINGp,          TOBU_SFETCH_S1_D2.qp());
  /*#p29.SEBA*/ SEBA_SFETCH_S1_D5 = dff17_B (LAPE_AxCxExGx,            XYMU_RENDERINGp,          VONU_SFETCH_S1_D4.qp());
  /*#p29.TESE*/ TESE_SFETCH_S2    = dff17_AB(TULY_SFETCH_S1.qn(),      SECA_SFETCH_RUNNING_SETn, TESE_SFETCH_S2.qn());
}
