...
struct SpriteFetcher {
  ...
  /*p27.TAKA*/ NandLatch TAKA_SFETCH_RUNNINGp_xxx; // ABCDEFGH
  /*p27.SOBU*/ DFF17 SOBU_SFETCH_REQp_odd;         // xBxDxFxH
  /*p27.SUDA*/ DFF17 SUDA_SFETCH_REQp_evn;         // AxBxExGx

  /*p29.TOXE*/ DFF17 TOXE_SFETCH_S0p_xxx;          // ABxDxFxH weird
  /*p29.TULY*/ DFF17 TULY_SFETCH_S1p_odd;          // xBxDxFxH
  /*p29.TESE*/ DFF17 TESE_SFETCH_S2p_xxx;          // ABxDxFxH weird
