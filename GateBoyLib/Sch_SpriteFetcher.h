...
struct SpriteFetcher {
  ...
  void reset_boot() {
    ...
    TOXE_SFETCH_S0p_xxx.reset(REG_D0C0);
    TYFO_SFETCH_S0p_D1_evn.reset(REG_D0C0);
    TULY_SFETCH_S1p_odd.reset(REG_D0C0);
    TESE_SFETCH_S2p_xxx.reset(REG_D0C0);
    TOBU_SFETCH_S1p_D2_odd.reset(REG_D0C0);
    VONU_SFETCH_S1p_D4_odd.reset(REG_D0C0);
  ...
  /*p29.TOXE*/ DFF17 TOXE_SFETCH_S0p_xxx;          // ABxDxFxH Beginning of line, reset on A. During line, ticks and resets on odd.
  /*p29.TULY*/ DFF17 TULY_SFETCH_S1p_odd;          // ABxDxFxH Beginning of line, reset on A. During line, ticks and resets on odd.
  /*p29.TESE*/ DFF17 TESE_SFETCH_S2p_xxx;          // ABxDxFxH Beginning of line, reset on A. During line, ticks and resets on odd.
