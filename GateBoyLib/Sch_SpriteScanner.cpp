...
void SpriteScanner::tick(const SchematicTop& top) {
  ...
  /*p29.ERUC*/ wire ERUC_YDIFF_S0 = add_s(EBOS_Y0n, top.oam_bus.XUSO_OAM_DA0p.q08(), GND);
  /*p29.ERUC*/ wire ERUC_YDIFF_C0 = add_c(EBOS_Y0n, top.oam_bus.XUSO_OAM_DA0p.q08(), GND);
  /*p29.ENEF*/ wire ENEF_YDIFF_S1 = add_s(DASA_Y1n, top.oam_bus.XEGU_OAM_DA1p.q08(), ERUC_YDIFF_C0);
  /*p29.ENEF*/ wire ENEF_YDIFF_C1 = add_c(DASA_Y1n, top.oam_bus.XEGU_OAM_DA1p.q08(), ERUC_YDIFF_C0);
  /*p29.FECO*/ wire FECO_YDIFF_S2 = add_s(FUKY_Y2n, top.oam_bus.YJEX_OAM_DA2p.q08(), ENEF_YDIFF_C1);
  /*p29.FECO*/ wire FECO_YDIFF_C2 = add_c(FUKY_Y2n, top.oam_bus.YJEX_OAM_DA2p.q08(), ENEF_YDIFF_C1);
  /*p29.GYKY*/ wire GYKY_YDIFF_S3 = add_s(FUVE_Y3n, top.oam_bus.XYJU_OAM_DA3p.q08(), FECO_YDIFF_C2);
  /*p29.GYKY*/ wire GYKY_YDIFF_C3 = add_c(FUVE_Y3n, top.oam_bus.XYJU_OAM_DA3p.q08(), FECO_YDIFF_C2);
  /*p29.GOPU*/ wire GOPU_YDIFF_S4 = add_s(FEPU_Y4n, top.oam_bus.YBOG_OAM_DA4p.q08(), GYKY_YDIFF_C3);
  /*p29.GOPU*/ wire GOPU_YDIFF_C4 = add_c(FEPU_Y4n, top.oam_bus.YBOG_OAM_DA4p.q08(), GYKY_YDIFF_C3);
  /*p29.FUWA*/ wire FUWA_YDIFF_S5 = add_s(FOFA_Y5n, top.oam_bus.WYSO_OAM_DA5p.q08(), GOPU_YDIFF_C4);
  /*p29.FUWA*/ wire FUWA_YDIFF_C5 = add_c(FOFA_Y5n, top.oam_bus.WYSO_OAM_DA5p.q08(), GOPU_YDIFF_C4);
  /*p29.GOJU*/ wire GOJU_YDIFF_S6 = add_s(FEMO_Y6n, top.oam_bus.XOTE_OAM_DA6p.q08(), FUWA_YDIFF_C5);
  /*p29.GOJU*/ wire GOJU_YDIFF_C6 = add_c(FEMO_Y6n, top.oam_bus.XOTE_OAM_DA6p.q08(), FUWA_YDIFF_C5);
  /*p29.WUHU*/ wire WUHU_YDIFF_S7 = add_s(GUSU_Y7n, top.oam_bus.YZAB_OAM_DA7p.q08(), GOJU_YDIFF_C6);
  /*p29.WUHU*/ wire WUHU_YDIFF_C7 = add_c(GUSU_Y7n, top.oam_bus.YZAB_OAM_DA7p.q08(), GOJU_YDIFF_C6);
