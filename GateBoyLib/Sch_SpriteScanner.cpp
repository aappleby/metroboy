...
void SpriteScanner::tock(const SchematicTop& top) {
...

  {
    ...
    /*#p29.DOBA*/ DOBA_SCAN_DONE_B.dff17(ALET_xBxDxFxH, BAGY_LINE_RSTn, BYBA_SCAN_DONE_A.qp17());
...

  {
    ...
    /*p28.YFEL*/ YFEL_SCAN0.dff17(GAVA_SCAN_CLK,   ANOM_LINE_RSTn, YFEL_SCAN0.qn16());
