...
void SpriteStore::dump(Dumper& d) const {
  ...
  d("STORE1 M%d R%d I%02d L%02d X%03d\n",
    ...
    pack_p(AMES_STORE1_L0n.qp(), AROF_STORE1_L1n.qp(), ABOP_STORE1_L2n.qp(), ABUG_STORE1_L3n.qp()),
  ...
  d("STORE2 M%d R%d I%02d L%02d X%03d\n",
    ...
    pack_p(YLOV_STORE2_L0n.qp(), XOSY_STORE2_L1n.qp(), XAZY_STORE2_L2n.qp(), YKUK_STORE2_L3n.qp()),
  ...
  d("STORE3 M%d R%d I%02d L%02d X%03d\n",
    ...
    pack_p(ZURO_STORE3_L0n.qp(), ZYLU_STORE3_L1n.qp(), ZENE_STORE3_L2n.qp(), ZURY_STORE3_L3n.qp()),
  ...
  d("STORE4 M%d R%d I%02d L%02d X%03d\n",
    ...
    pack_p(CAPO_STORE4_L0n.qp(), CAJU_STORE4_L1n.qp(), CONO_STORE4_L2n.qp(), CUMU_STORE4_L3n.qp()),
  ...
  d("STORE5 M%d R%d I%02d L%02d X%03d\n",
    ...
    pack_p(ACEP_STORE5_L0n.qp(), ABEG_STORE5_L1n.qp(), ABUX_STORE5_L2n.qp(), ANED_STORE5_L3n.qp()),
  ...
  d("STORE6 M%d R%d I%02d L%02d X%03d\n",
    ...
    pack_p(ZUMY_STORE6_L0n.qp(), ZAFU_STORE6_L1n.qp(), ZEXO_STORE6_L2n.qp(), ZUBE_STORE6_L3n.qp()),
  ...
  d("STORE7 M%d R%d I%02d L%02d X%03d\n",
    ...
    pack_p(XYNA_STORE7_L0n.qp(), YGUM_STORE7_L1n.qp(), XAKU_STORE7_L2n.qp(), XYGO_STORE7_L3n.qp()),
  ...
  d("STORE8 M%d R%d I%02d L%02d X%03d\n",
    ...
    pack_p(AZAP_STORE8_L0n.qp(), AFYX_STORE8_L1n.qp(), AFUT_STORE8_L2n.qp(), AFYM_STORE8_L3n.qp()),
  ...
  d("STORE9 M%d R%d I%02d L%02d X%03d\n",
    ...
    pack_p(CANA_STORE9_L0n.qp(), FOFO_STORE9_L1n.qp(), DYSY_STORE9_L2n.qp(), DEWU_STORE9_L3n.qp()),
...
void SpriteStore::tock(const SchematicTop& top) {
...

  {
    ...
    /*#p30.CUCU*/ SPR_TRI_L0 = tribuf_6nn(FEPO_STORE_MATCHp, top.sprite_scanner.DEGE_SPRITE_DELTA0);
    /*#p30.CUCA*/ SPR_TRI_L1 = tribuf_6nn(FEPO_STORE_MATCHp, top.sprite_scanner.DABY_SPRITE_DELTA1);
    /*#p30.CEGA*/ SPR_TRI_L2 = tribuf_6nn(FEPO_STORE_MATCHp, top.sprite_scanner.DABU_SPRITE_DELTA2);
    /*#p30.WENU*/ SPR_TRI_L3 = tribuf_6nn(FEPO_STORE_MATCHp, top.sprite_scanner.GYSA_SPRITE_DELTA3);
...

  {
    ...
    /*p29.EBOJ*/ EBOJ_STORE0_RSTp = dff17_B(top.sprite_fetcher.WUTY_SPRITE_DONEp, BYVA_VID_LINE_TRIGn, GUVA_SPRITE0_GETp);
    /*p29.CEDY*/ CEDY_STORE1_RSTp = dff17_B(top.sprite_fetcher.WUTY_SPRITE_DONEp, BYVA_VID_LINE_TRIGn, ENUT_SPRITE1_GETp);
    /*p29.EGAV*/ EGAV_STORE2_RSTp = dff17_B(top.sprite_fetcher.WUTY_SPRITE_DONEp, BYVA_VID_LINE_TRIGn, EMOL_SPRITE2_GETp);
    /*p29.GOTA*/ GOTA_STORE3_RSTp = dff17_B(top.sprite_fetcher.WUTY_SPRITE_DONEp, BYVA_VID_LINE_TRIGn, GYFY_SPRITE3_GETp);
    /*p29.XUDY*/ XUDY_STORE4_RSTp = dff17_B(top.sprite_fetcher.WUTY_SPRITE_DONEp, BYVA_VID_LINE_TRIGn, GONO_SPRITE4_GETp);
    /*p29.WAFY*/ WAFY_STORE5_RSTp = dff17_B(top.sprite_fetcher.WUTY_SPRITE_DONEp, BYVA_VID_LINE_TRIGn, GEGA_SPRITE5_GETp);
    /*p29.WOMY*/ WOMY_STORE6_RSTp = dff17_B(top.sprite_fetcher.WUTY_SPRITE_DONEp, BYVA_VID_LINE_TRIGn, XOJA_SPRITE6_GETp);
    /*p29.WAPO*/ WAPO_STORE7_RSTp = dff17_B(top.sprite_fetcher.WUTY_SPRITE_DONEp, BYVA_VID_LINE_TRIGn, GUTU_SPRITE7_GETp);
    /*p29.EXUQ*/ EXUQ_STORE8_RSTp = dff17_B(top.sprite_fetcher.WUTY_SPRITE_DONEp, BYVA_VID_LINE_TRIGn, FOXA_SPRITE8_GETp);
    /*p29.FONO*/ FONO_STORE9_RSTp = dff17_B(top.sprite_fetcher.WUTY_SPRITE_DONEp, BYVA_VID_LINE_TRIGn, GUZE_SPRITE9_GETp);
...

  {
    ...
    /*p30.GYHO*/ GYHO_STORE0_L0 = dff8_B_inv(ENOB_STORE0_CLKp, !ENOB_STORE0_CLKp, SPR_TRI_L0.tp());
    /*p30.CUFO*/ CUFO_STORE0_L1 = dff8_B_inv(ENOB_STORE0_CLKp, !ENOB_STORE0_CLKp, SPR_TRI_L1.tp());
    /*p30.BOZU*/ BOZU_STORE0_L2 = dff8_B_inv(ENOB_STORE0_CLKp, !ENOB_STORE0_CLKp, SPR_TRI_L2.tp());
    /*p30.FYHY*/ FYHY_STORE0_L3 = dff8_B_inv(ENOB_STORE0_CLKp, !ENOB_STORE0_CLKp, SPR_TRI_L3.tp());
