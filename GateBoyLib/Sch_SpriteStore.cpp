...
void SpriteStore::tock(const SchematicTop& top) {
  ...
  /*#p31.ZAGO*/ wire ZAGO_X0n = not1(top.oam_bus.YLOR_OAM_DB0p.qp());
  /* p31.ZOCY*/ wire ZOCY_X1n = not1(top.oam_bus.ZYTY_OAM_DB1p.qp());
  /* p31.YPUR*/ wire YPUR_X2n = not1(top.oam_bus.ZYVE_OAM_DB2p.qp());
  /* p31.YVOK*/ wire YVOK_X3n = not1(top.oam_bus.ZEZY_OAM_DB3p.qp());
  /* p31.COSE*/ wire COSE_X4n = not1(top.oam_bus.GOMO_OAM_DB4p.qp());
  /* p31.AROP*/ wire AROP_X5n = not1(top.oam_bus.BAXO_OAM_DB5p.qp());
  /* p31.XATU*/ wire XATU_X6n = not1(top.oam_bus.YZOS_OAM_DB6p.qp());
  /* p31.BADY*/ wire BADY_X7n = not1(top.oam_bus.DEPO_OAM_DB7p.qp());
...

  {
    ...
    /*p30.BOZU*/ BOZU_STORE0_L2n = dff8_B_inv(ENOB_STORE0_CLKp, SPR_TRI_L2.tp());
    /*p30.FYHY*/ FYHY_STORE0_L3n = dff8_B_inv(ENOB_STORE0_CLKp, SPR_TRI_L3.tp());

    /*#p31.XEPE*/ XEPE_STORE0_X0p = dff9_A_inv(FUXU_STORE0_CLKp, DYNA_STORE0_RSTn, ZAGO_X0n);
    /* p31.YLAH*/ YLAH_STORE0_X1p = dff9_A_inv(FUXU_STORE0_CLKp, DYNA_STORE0_RSTn, ZOCY_X1n);
    /* p31.ZOLA*/ ZOLA_STORE0_X2p = dff9_A_inv(FUXU_STORE0_CLKp, DYNA_STORE0_RSTn, YPUR_X2n);
    /* p31.ZULU*/ ZULU_STORE0_X3p = dff9_A_inv(FUXU_STORE0_CLKp, DYNA_STORE0_RSTn, YVOK_X3n);
    /* p31.WELO*/ WELO_STORE0_X4p = dff9_A_inv(FUXU_STORE0_CLKp, DYNA_STORE0_RSTn, COSE_X4n);
    /* p31.XUNY*/ XUNY_STORE0_X5p = dff9_A_inv(FUXU_STORE0_CLKp, DYNA_STORE0_RSTn, AROP_X5n);
    /* p31.WOTE*/ WOTE_STORE0_X6p = dff9_A_inv(FUXU_STORE0_CLKp, DYNA_STORE0_RSTn, XATU_X6n);
    /* p31.XAKO*/ XAKO_STORE0_X7p = dff9_A_inv(FUXU_STORE0_CLKp, DYNA_STORE0_RSTn, BADY_X7n);
    ...
    /*p30.CADU*/ CADU_STORE1_I0n = dff8_B_inv(BYVU_STORE1_CLKp, SPR_TRI_I0p.tp());
    /*p30.CEBO*/ CEBO_STORE1_I1n = dff8_B_inv(BYVU_STORE1_CLKp, SPR_TRI_I1p.tp());
    /*p30.CUFA*/ CUFA_STORE1_I2n = dff8_B_inv(BYVU_STORE1_CLKp, SPR_TRI_I2p.tp());
    /*p30.COMA*/ COMA_STORE1_I3n = dff8_B_inv(BYVU_STORE1_CLKp, SPR_TRI_I3p.tp());
    /*p30.CUZA*/ CUZA_STORE1_I4n = dff8_B_inv(BYVU_STORE1_CLKp, SPR_TRI_I4p.tp());
    /*p30.CAJY*/ CAJY_STORE1_I5n = dff8_B_inv(BYVU_STORE1_CLKp, SPR_TRI_I5p.tp());

    /*p30.AMES*/ AMES_STORE1_L0n = dff8_B_inv(AHOF_STORE1_CLKp, SPR_TRI_L0.tp());
    /*p30.AROF*/ AROF_STORE1_L1n = dff8_B_inv(AHOF_STORE1_CLKp, SPR_TRI_L1.tp());
    /*p30.ABOP*/ ABOP_STORE1_L2n = dff8_B_inv(AHOF_STORE1_CLKp, SPR_TRI_L2.tp());
    /*p30.ABUG*/ ABUG_STORE1_L3n = dff8_B_inv(AHOF_STORE1_CLKp, SPR_TRI_L3.tp());

    /*p31.DANY*/ DANY_STORE1_X0p = dff9_A_inv(ASYS_STORE1_CLKp, DOKU_STORE1_RSTn, ZAGO_X0n);
    /*p31.DUKO*/ DUKO_STORE1_X1p = dff9_A_inv(ASYS_STORE1_CLKp, DOKU_STORE1_RSTn, ZOCY_X1n);
    /*p31.DESU*/ DESU_STORE1_X2p = dff9_A_inv(ASYS_STORE1_CLKp, DOKU_STORE1_RSTn, YPUR_X2n);
    /*p31.DAZO*/ DAZO_STORE1_X3p = dff9_A_inv(ASYS_STORE1_CLKp, DOKU_STORE1_RSTn, YVOK_X3n);
    /*p31.DAKE*/ DAKE_STORE1_X4p = dff9_A_inv(ASYS_STORE1_CLKp, DOKU_STORE1_RSTn, COSE_X4n);
    /*p31.CESO*/ CESO_STORE1_X5p = dff9_A_inv(ASYS_STORE1_CLKp, DOKU_STORE1_RSTn, AROP_X5n);
    /*p31.DYFU*/ DYFU_STORE1_X6p = dff9_A_inv(ASYS_STORE1_CLKp, DOKU_STORE1_RSTn, XATU_X6n);
    /*p31.CUSY*/ CUSY_STORE1_X7p = dff9_A_inv(ASYS_STORE1_CLKp, DOKU_STORE1_RSTn, BADY_X7n);
