...
void SpriteStore::tock(const SchematicTop& top) {
...

  {
    ...
    /*p30.GYHO*/ GYHO_STORE0_L0n = dff8_B_inv(ENOB_STORE0_CLKp, !ENOB_STORE0_CLKp, SPR_TRI_L0.tp());
    /*p30.CUFO*/ CUFO_STORE0_L1n = dff8_B_inv(ENOB_STORE0_CLKp, !ENOB_STORE0_CLKp, SPR_TRI_L1.tp());
    /*p30.BOZU*/ BOZU_STORE0_L2n = dff8_B_inv(ENOB_STORE0_CLKp, !ENOB_STORE0_CLKp, SPR_TRI_L2.tp());
    /*p30.FYHY*/ FYHY_STORE0_L3n = dff8_B_inv(ENOB_STORE0_CLKp, !ENOB_STORE0_CLKp, SPR_TRI_L3.tp());

    /*#p31.XEPE*/ XEPE_STORE0_X0p = dff9_A_inv(FUXU_STORE0_CLKp, !FUXU_STORE0_CLKp, DYNA_STORE0_RSTn, ZAGO_X0n);
    /* p31.YLAH*/ YLAH_STORE0_X1p = dff9_A_inv(FUXU_STORE0_CLKp, !FUXU_STORE0_CLKp, DYNA_STORE0_RSTn, ZOCY_X1n);
    /* p31.ZOLA*/ ZOLA_STORE0_X2p = dff9_A_inv(FUXU_STORE0_CLKp, !FUXU_STORE0_CLKp, DYNA_STORE0_RSTn, YPUR_X2n);
    /* p31.ZULU*/ ZULU_STORE0_X3p = dff9_A_inv(FUXU_STORE0_CLKp, !FUXU_STORE0_CLKp, DYNA_STORE0_RSTn, YVOK_X3n);
    /* p31.WELO*/ WELO_STORE0_X4p = dff9_A_inv(FUXU_STORE0_CLKp, !FUXU_STORE0_CLKp, DYNA_STORE0_RSTn, COSE_X4n);
    /* p31.XUNY*/ XUNY_STORE0_X5p = dff9_A_inv(FUXU_STORE0_CLKp, !FUXU_STORE0_CLKp, DYNA_STORE0_RSTn, AROP_X5n);
    /* p31.WOTE*/ WOTE_STORE0_X6p = dff9_A_inv(FUXU_STORE0_CLKp, !FUXU_STORE0_CLKp, DYNA_STORE0_RSTn, XATU_X6n);
    /* p31.XAKO*/ XAKO_STORE0_X7p = dff9_A_inv(FUXU_STORE0_CLKp, !FUXU_STORE0_CLKp, DYNA_STORE0_RSTn, BADY_X7n);
    ...
    /*p30.AMES*/ AMES_STORE1_L0n = dff8_B_inv(AHOF_STORE1_CLKp, !AHOF_STORE1_CLKp, SPR_TRI_L0.tp());
    /*p30.AROF*/ AROF_STORE1_L1n = dff8_B_inv(AHOF_STORE1_CLKp, !AHOF_STORE1_CLKp, SPR_TRI_L1.tp());
    /*p30.ABOP*/ ABOP_STORE1_L2n = dff8_B_inv(AHOF_STORE1_CLKp, !AHOF_STORE1_CLKp, SPR_TRI_L2.tp());
    /*p30.ABUG*/ ABUG_STORE1_L3n = dff8_B_inv(AHOF_STORE1_CLKp, !AHOF_STORE1_CLKp, SPR_TRI_L3.tp());

    /*p31.DANY*/ DANY_STORE1_X0p = dff9_A_inv(ASYS_STORE1_CLKp, !ASYS_STORE1_CLKp, DOKU_STORE1_RSTn, ZAGO_X0n);
    /*p31.DUKO*/ DUKO_STORE1_X1p = dff9_A_inv(ASYS_STORE1_CLKp, !ASYS_STORE1_CLKp, DOKU_STORE1_RSTn, ZOCY_X1n);
    /*p31.DESU*/ DESU_STORE1_X2p = dff9_A_inv(ASYS_STORE1_CLKp, !ASYS_STORE1_CLKp, DOKU_STORE1_RSTn, YPUR_X2n);
    /*p31.DAZO*/ DAZO_STORE1_X3p = dff9_A_inv(ASYS_STORE1_CLKp, !ASYS_STORE1_CLKp, DOKU_STORE1_RSTn, YVOK_X3n);
    /*p31.DAKE*/ DAKE_STORE1_X4p = dff9_A_inv(ASYS_STORE1_CLKp, !ASYS_STORE1_CLKp, DOKU_STORE1_RSTn, COSE_X4n);
    /*p31.CESO*/ CESO_STORE1_X5p = dff9_A_inv(ASYS_STORE1_CLKp, !ASYS_STORE1_CLKp, DOKU_STORE1_RSTn, AROP_X5n);
    /*p31.DYFU*/ DYFU_STORE1_X6p = dff9_A_inv(ASYS_STORE1_CLKp, !ASYS_STORE1_CLKp, DOKU_STORE1_RSTn, XATU_X6n);
    /*p31.CUSY*/ CUSY_STORE1_X7p = dff9_A_inv(ASYS_STORE1_CLKp, !ASYS_STORE1_CLKp, DOKU_STORE1_RSTn, BADY_X7n);
    ...
    /*p30.YLOV*/ YLOV_STORE2_L0n = dff8_B_inv(FUKE_STORE2_CLKp, !FUKE_STORE2_CLKp, SPR_TRI_L0.tp());
    /*p30.XOSY*/ XOSY_STORE2_L1n = dff8_B_inv(FUKE_STORE2_CLKp, !FUKE_STORE2_CLKp, SPR_TRI_L1.tp());
    /*p30.XAZY*/ XAZY_STORE2_L2n = dff8_B_inv(FUKE_STORE2_CLKp, !FUKE_STORE2_CLKp, SPR_TRI_L2.tp());
    /*p30.YKUK*/ YKUK_STORE2_L3n = dff8_B_inv(FUKE_STORE2_CLKp, !FUKE_STORE2_CLKp, SPR_TRI_L3.tp());

    /*p31.FOKA*/ FOKA_STORE2_X0p = dff9_A_inv(CACU_STORE2_CLKp, !CACU_STORE2_CLKp, GAMY_STORE2_RSTn, ZAGO_X0n);
    /*p31.FYTY*/ FYTY_STORE2_X1p = dff9_A_inv(CACU_STORE2_CLKp, !CACU_STORE2_CLKp, GAMY_STORE2_RSTn, ZOCY_X1n);
    /*p31.FUBY*/ FUBY_STORE2_X2p = dff9_A_inv(CACU_STORE2_CLKp, !CACU_STORE2_CLKp, GAMY_STORE2_RSTn, YPUR_X2n);
    /*p31.GOXU*/ GOXU_STORE2_X3p = dff9_A_inv(CACU_STORE2_CLKp, !CACU_STORE2_CLKp, GAMY_STORE2_RSTn, YVOK_X3n);
    /*p31.DUHY*/ DUHY_STORE2_X4p = dff9_A_inv(CACU_STORE2_CLKp, !CACU_STORE2_CLKp, GAMY_STORE2_RSTn, COSE_X4n);
    /*p31.EJUF*/ EJUF_STORE2_X5p = dff9_A_inv(CACU_STORE2_CLKp, !CACU_STORE2_CLKp, GAMY_STORE2_RSTn, AROP_X5n);
    /*p31.ENOR*/ ENOR_STORE2_X6p = dff9_A_inv(CACU_STORE2_CLKp, !CACU_STORE2_CLKp, GAMY_STORE2_RSTn, XATU_X6n);
    /*p31.DEPY*/ DEPY_STORE2_X7p = dff9_A_inv(CACU_STORE2_CLKp, !CACU_STORE2_CLKp, GAMY_STORE2_RSTn, BADY_X7n);
    ...
    /*p30.ZURO*/ ZURO_STORE3_L0n = dff8_B_inv(XYHA_STORE3_CLKp, !XYHA_STORE3_CLKp, SPR_TRI_L0.tp());
    /*p30.ZYLU*/ ZYLU_STORE3_L1n = dff8_B_inv(XYHA_STORE3_CLKp, !XYHA_STORE3_CLKp, SPR_TRI_L1.tp());
    /*p30.ZENE*/ ZENE_STORE3_L2n = dff8_B_inv(XYHA_STORE3_CLKp, !XYHA_STORE3_CLKp, SPR_TRI_L2.tp());
    /*p30.ZURY*/ ZURY_STORE3_L3n = dff8_B_inv(XYHA_STORE3_CLKp, !XYHA_STORE3_CLKp, SPR_TRI_L3.tp());

    /*p31.XOLY*/ XOLY_STORE3_X0p = dff9_A_inv(YFAG_STORE3_CLKp, !YFAG_STORE3_CLKp, WUPA_STORE3_RSTn, ZAGO_X0n);
    /*p31.XYBA*/ XYBA_STORE3_X1p = dff9_A_inv(YFAG_STORE3_CLKp, !YFAG_STORE3_CLKp, WUPA_STORE3_RSTn, ZOCY_X1n);
    /*p31.XABE*/ XABE_STORE3_X2p = dff9_A_inv(YFAG_STORE3_CLKp, !YFAG_STORE3_CLKp, WUPA_STORE3_RSTn, YPUR_X2n);
    /*p31.XEKA*/ XEKA_STORE3_X3p = dff9_A_inv(YFAG_STORE3_CLKp, !YFAG_STORE3_CLKp, WUPA_STORE3_RSTn, YVOK_X3n);
    /*p31.XOMY*/ XOMY_STORE3_X4p = dff9_A_inv(YFAG_STORE3_CLKp, !YFAG_STORE3_CLKp, WUPA_STORE3_RSTn, COSE_X4n);
    /*p31.WUHA*/ WUHA_STORE3_X5p = dff9_A_inv(YFAG_STORE3_CLKp, !YFAG_STORE3_CLKp, WUPA_STORE3_RSTn, AROP_X5n);
    /*p31.WYNA*/ WYNA_STORE3_X6p = dff9_A_inv(YFAG_STORE3_CLKp, !YFAG_STORE3_CLKp, WUPA_STORE3_RSTn, XATU_X6n);
    /*p31.WECO*/ WECO_STORE3_X7p = dff9_A_inv(YFAG_STORE3_CLKp, !YFAG_STORE3_CLKp, WUPA_STORE3_RSTn, BADY_X7n);
    ...
    /*p30.CAPO*/ CAPO_STORE4_L0n = dff8_B_inv(EWOT_STORE4_CLKp, !EWOT_STORE4_CLKp, SPR_TRI_L0.tp());
    /*p30.CAJU*/ CAJU_STORE4_L1n = dff8_B_inv(EWOT_STORE4_CLKp, !EWOT_STORE4_CLKp, SPR_TRI_L1.tp());
    /*p30.CONO*/ CONO_STORE4_L2n = dff8_B_inv(EWOT_STORE4_CLKp, !EWOT_STORE4_CLKp, SPR_TRI_L2.tp());
    /*p30.CUMU*/ CUMU_STORE4_L3n = dff8_B_inv(EWOT_STORE4_CLKp, !EWOT_STORE4_CLKp, SPR_TRI_L3.tp());

    /*p31.WEDU*/ WEDU_STORE4_X0p = dff9_A_inv(WOFO_STORE4_CLKp, !WOFO_STORE4_CLKp, WUNU_STORE4_RSTn, ZAGO_X0n);
    /*p31.YGAJ*/ YGAJ_STORE4_X1p = dff9_A_inv(WOFO_STORE4_CLKp, !WOFO_STORE4_CLKp, WUNU_STORE4_RSTn, ZOCY_X1n);
    /*p31.ZYJO*/ ZYJO_STORE4_X2p = dff9_A_inv(WOFO_STORE4_CLKp, !WOFO_STORE4_CLKp, WUNU_STORE4_RSTn, YPUR_X2n);
    /*p31.XURY*/ XURY_STORE4_X3p = dff9_A_inv(WOFO_STORE4_CLKp, !WOFO_STORE4_CLKp, WUNU_STORE4_RSTn, YVOK_X3n);
    /*p31.YBED*/ YBED_STORE4_X4p = dff9_A_inv(WOFO_STORE4_CLKp, !WOFO_STORE4_CLKp, WUNU_STORE4_RSTn, COSE_X4n);
    /*p31.ZALA*/ ZALA_STORE4_X5p = dff9_A_inv(WOFO_STORE4_CLKp, !WOFO_STORE4_CLKp, WUNU_STORE4_RSTn, AROP_X5n);
    /*p31.WYDE*/ WYDE_STORE4_X6p = dff9_A_inv(WOFO_STORE4_CLKp, !WOFO_STORE4_CLKp, WUNU_STORE4_RSTn, XATU_X6n);
    /*p31.XEPA*/ XEPA_STORE4_X7p = dff9_A_inv(WOFO_STORE4_CLKp, !WOFO_STORE4_CLKp, WUNU_STORE4_RSTn, BADY_X7n);
    ...
    /*p30.ACEP*/ ACEP_STORE5_L0n = dff8_B_inv(BUCY_STORE5_CLKp, !BUCY_STORE5_CLKp, SPR_TRI_L0.tp());
    /*p30.ABEG*/ ABEG_STORE5_L1n = dff8_B_inv(BUCY_STORE5_CLKp, !BUCY_STORE5_CLKp, SPR_TRI_L1.tp());
    /*p30.ABUX*/ ABUX_STORE5_L2n = dff8_B_inv(BUCY_STORE5_CLKp, !BUCY_STORE5_CLKp, SPR_TRI_L2.tp());
    /*p30.ANED*/ ANED_STORE5_L3n = dff8_B_inv(BUCY_STORE5_CLKp, !BUCY_STORE5_CLKp, SPR_TRI_L3.tp());

    /*p31.FUSA*/ FUSA_STORE5_X0p = dff9_A_inv(CYLA_STORE5_CLKp, !CYLA_STORE5_CLKp, EJAD_STORE5_RSTn, ZAGO_X0n);
    /*p31.FAXA*/ FAXA_STORE5_X1p = dff9_A_inv(CYLA_STORE5_CLKp, !CYLA_STORE5_CLKp, EJAD_STORE5_RSTn, ZOCY_X1n);
    /*p31.FOZY*/ FOZY_STORE5_X2p = dff9_A_inv(CYLA_STORE5_CLKp, !CYLA_STORE5_CLKp, EJAD_STORE5_RSTn, YPUR_X2n);
    /*p31.FESY*/ FESY_STORE5_X3p = dff9_A_inv(CYLA_STORE5_CLKp, !CYLA_STORE5_CLKp, EJAD_STORE5_RSTn, YVOK_X3n);
    /*p31.CYWE*/ CYWE_STORE5_X4p = dff9_A_inv(CYLA_STORE5_CLKp, !CYLA_STORE5_CLKp, EJAD_STORE5_RSTn, COSE_X4n);
    /*p31.DYBY*/ DYBY_STORE5_X5p = dff9_A_inv(CYLA_STORE5_CLKp, !CYLA_STORE5_CLKp, EJAD_STORE5_RSTn, AROP_X5n);
    /*p31.DURY*/ DURY_STORE5_X6p = dff9_A_inv(CYLA_STORE5_CLKp, !CYLA_STORE5_CLKp, EJAD_STORE5_RSTn, XATU_X6n);
    /*p31.CUVY*/ CUVY_STORE5_X7p = dff9_A_inv(CYLA_STORE5_CLKp, !CYLA_STORE5_CLKp, EJAD_STORE5_RSTn, BADY_X7n);
    ...
    /*p30.ZUMY*/ ZUMY_STORE6_L0n = dff8_B_inv(ZURU_STORE6_CLKp, !ZURU_STORE6_CLKp, SPR_TRI_L0.tp());
    /*p30.ZAFU*/ ZAFU_STORE6_L1n = dff8_B_inv(ZURU_STORE6_CLKp, !ZURU_STORE6_CLKp, SPR_TRI_L1.tp());
    /*p30.ZEXO*/ ZEXO_STORE6_L2n = dff8_B_inv(ZURU_STORE6_CLKp, !ZURU_STORE6_CLKp, SPR_TRI_L2.tp());
    /*p30.ZUBE*/ ZUBE_STORE6_L3n = dff8_B_inv(ZURU_STORE6_CLKp, !ZURU_STORE6_CLKp, SPR_TRI_L3.tp());

    /*p31.YCOL*/ YCOL_STORE6_X0p = dff9_A_inv(ZAPE_STORE6_CLKp, !ZAPE_STORE6_CLKp, XAHO_STORE6_RSTn, ZAGO_X0n);
    /*p31.YRAC*/ YRAC_STORE6_X1p = dff9_A_inv(ZAPE_STORE6_CLKp, !ZAPE_STORE6_CLKp, XAHO_STORE6_RSTn, ZOCY_X1n);
    /*p31.YMEM*/ YMEM_STORE6_X2p = dff9_A_inv(ZAPE_STORE6_CLKp, !ZAPE_STORE6_CLKp, XAHO_STORE6_RSTn, YPUR_X2n);
    /*p31.YVAG*/ YVAG_STORE6_X3p = dff9_A_inv(ZAPE_STORE6_CLKp, !ZAPE_STORE6_CLKp, XAHO_STORE6_RSTn, YVOK_X3n);
    /*p31.ZOLY*/ ZOLY_STORE6_X4p = dff9_A_inv(ZAPE_STORE6_CLKp, !ZAPE_STORE6_CLKp, XAHO_STORE6_RSTn, COSE_X4n);
    /*p31.ZOGO*/ ZOGO_STORE6_X5p = dff9_A_inv(ZAPE_STORE6_CLKp, !ZAPE_STORE6_CLKp, XAHO_STORE6_RSTn, AROP_X5n);
    /*p31.ZECU*/ ZECU_STORE6_X6p = dff9_A_inv(ZAPE_STORE6_CLKp, !ZAPE_STORE6_CLKp, XAHO_STORE6_RSTn, XATU_X6n);
    /*p31.ZESA*/ ZESA_STORE6_X7p = dff9_A_inv(ZAPE_STORE6_CLKp, !ZAPE_STORE6_CLKp, XAHO_STORE6_RSTn, BADY_X7n);
    ...
    /*p30.XYNA*/ XYNA_STORE7_L0n = dff8_B_inv(WABE_STORE7_CLKp, !WABE_STORE7_CLKp, SPR_TRI_L0.tp());
    /*p30.YGUM*/ YGUM_STORE7_L1n = dff8_B_inv(WABE_STORE7_CLKp, !WABE_STORE7_CLKp, SPR_TRI_L1.tp());
    /*p30.XAKU*/ XAKU_STORE7_L2n = dff8_B_inv(WABE_STORE7_CLKp, !WABE_STORE7_CLKp, SPR_TRI_L2.tp());
    /*p30.XYGO*/ XYGO_STORE7_L3n = dff8_B_inv(WABE_STORE7_CLKp, !WABE_STORE7_CLKp, SPR_TRI_L3.tp());

    /*p31.ERAZ*/ ERAZ_STORE7_X0p = dff9_A_inv(GECY_STORE7_CLKp, !GECY_STORE7_CLKp, GAFY_STORE7_RSTn, ZAGO_X0n);
    /*p31.EPUM*/ EPUM_STORE7_X1p = dff9_A_inv(GECY_STORE7_CLKp, !GECY_STORE7_CLKp, GAFY_STORE7_RSTn, ZOCY_X1n);
    /*p31.EROL*/ EROL_STORE7_X2p = dff9_A_inv(GECY_STORE7_CLKp, !GECY_STORE7_CLKp, GAFY_STORE7_RSTn, YPUR_X2n);
    /*p31.EHYN*/ EHYN_STORE7_X3p = dff9_A_inv(GECY_STORE7_CLKp, !GECY_STORE7_CLKp, GAFY_STORE7_RSTn, YVOK_X3n);
    /*p31.FAZU*/ FAZU_STORE7_X4p = dff9_A_inv(GECY_STORE7_CLKp, !GECY_STORE7_CLKp, GAFY_STORE7_RSTn, COSE_X4n);
    /*p31.FAXE*/ FAXE_STORE7_X5p = dff9_A_inv(GECY_STORE7_CLKp, !GECY_STORE7_CLKp, GAFY_STORE7_RSTn, AROP_X5n);
    /*p31.EXUK*/ EXUK_STORE7_X6p = dff9_A_inv(GECY_STORE7_CLKp, !GECY_STORE7_CLKp, GAFY_STORE7_RSTn, XATU_X6n);
    /*p31.FEDE*/ FEDE_STORE7_X7p = dff9_A_inv(GECY_STORE7_CLKp, !GECY_STORE7_CLKp, GAFY_STORE7_RSTn, BADY_X7n);
    ...
    /*p30.AZAP*/ AZAP_STORE8_L0n = dff8_B_inv(BYMY_STORE8_CLKp, !BYMY_STORE8_CLKp, SPR_TRI_L0.tp());
    /*p30.AFYX*/ AFYX_STORE8_L1n = dff8_B_inv(BYMY_STORE8_CLKp, !BYMY_STORE8_CLKp, SPR_TRI_L1.tp());
    /*p30.AFUT*/ AFUT_STORE8_L2n = dff8_B_inv(BYMY_STORE8_CLKp, !BYMY_STORE8_CLKp, SPR_TRI_L2.tp());
    /*p30.AFYM*/ AFYM_STORE8_L3n = dff8_B_inv(BYMY_STORE8_CLKp, !BYMY_STORE8_CLKp, SPR_TRI_L3.tp());

    /*p31.EZUF*/ EZUF_STORE8_X0p = dff9_A_inv(CEXU_STORE8_CLKp, !CEXU_STORE8_CLKp, WUZO_STORE8_RSTn, COSE_X4n);
    /*p31.ENAD*/ ENAD_STORE8_X1p = dff9_A_inv(CEXU_STORE8_CLKp, !CEXU_STORE8_CLKp, WUZO_STORE8_RSTn, AROP_X5n);
    /*p31.EBOW*/ EBOW_STORE8_X2p = dff9_A_inv(CEXU_STORE8_CLKp, !CEXU_STORE8_CLKp, WUZO_STORE8_RSTn, XATU_X6n);
    /*p31.FYCA*/ FYCA_STORE8_X3p = dff9_A_inv(CEXU_STORE8_CLKp, !CEXU_STORE8_CLKp, WUZO_STORE8_RSTn, BADY_X7n);
    /*p31.GAVY*/ GAVY_STORE8_X4p = dff9_A_inv(CEXU_STORE8_CLKp, !CEXU_STORE8_CLKp, WUZO_STORE8_RSTn, ZAGO_X0n);
    /*p31.GYPU*/ GYPU_STORE8_X5p = dff9_A_inv(CEXU_STORE8_CLKp, !CEXU_STORE8_CLKp, WUZO_STORE8_RSTn, ZOCY_X1n);
    /*p31.GADY*/ GADY_STORE8_X6p = dff9_A_inv(CEXU_STORE8_CLKp, !CEXU_STORE8_CLKp, WUZO_STORE8_RSTn, YPUR_X2n);
    /*p31.GAZA*/ GAZA_STORE8_X7p = dff9_A_inv(CEXU_STORE8_CLKp, !CEXU_STORE8_CLKp, WUZO_STORE8_RSTn, YVOK_X3n);
    ...
    /*p30.CANA*/ CANA_STORE9_L0n = dff8_B_inv(FAKA_STORE9_CLKp, !FAKA_STORE9_CLKp, SPR_TRI_L0.tp());
    /*p30.FOFO*/ FOFO_STORE9_L1n = dff8_B_inv(FAKA_STORE9_CLKp, !FAKA_STORE9_CLKp, SPR_TRI_L1.tp());
    /*p30.DYSY*/ DYSY_STORE9_L2n = dff8_B_inv(FAKA_STORE9_CLKp, !FAKA_STORE9_CLKp, SPR_TRI_L2.tp());
    /*p30.DEWU*/ DEWU_STORE9_L3n = dff8_B_inv(FAKA_STORE9_CLKp, !FAKA_STORE9_CLKp, SPR_TRI_L3.tp());

    /*p31.XUVY*/ XUVY_STORE9_X0p = dff9_A_inv(WEME_STORE9_CLKp, !WEME_STORE9_CLKp, DOSY_STORE9_RSTn, ZAGO_X0n);
    /*p31.XERE*/ XERE_STORE9_X1p = dff9_A_inv(WEME_STORE9_CLKp, !WEME_STORE9_CLKp, DOSY_STORE9_RSTn, ZOCY_X1n);
    /*p31.XUZO*/ XUZO_STORE9_X2p = dff9_A_inv(WEME_STORE9_CLKp, !WEME_STORE9_CLKp, DOSY_STORE9_RSTn, YPUR_X2n);
    /*p31.XEXA*/ XEXA_STORE9_X3p = dff9_A_inv(WEME_STORE9_CLKp, !WEME_STORE9_CLKp, DOSY_STORE9_RSTn, YVOK_X3n);
    /*p31.YPOD*/ YPOD_STORE9_X4p = dff9_A_inv(WEME_STORE9_CLKp, !WEME_STORE9_CLKp, DOSY_STORE9_RSTn, COSE_X4n);
    /*p31.YROP*/ YROP_STORE9_X5p = dff9_A_inv(WEME_STORE9_CLKp, !WEME_STORE9_CLKp, DOSY_STORE9_RSTn, AROP_X5n);
    /*p31.YNEP*/ YNEP_STORE9_X6p = dff9_A_inv(WEME_STORE9_CLKp, !WEME_STORE9_CLKp, DOSY_STORE9_RSTn, XATU_X6n);
    /*p31.YZOF*/ YZOF_STORE9_X7p = dff9_A_inv(WEME_STORE9_CLKp, !WEME_STORE9_CLKp, DOSY_STORE9_RSTn, BADY_X7n);
  }
}
