...
void SpriteStore::tick(const SchematicTop& top) {
  ...
  /*#p29.AZEM*/ wire AZEM_RENDERINGp = and2(BYJO_SCANNINGn, top.pix_pipe.XYMU_RENDERINGp.tp());
...
void SpriteStore::tock(const SchematicTop& top) {
...

  {
    ...
    /*p29.BESE*/ BESE_SPRITE_COUNT0 = dff17_AB(CAKE_CLKp,               AZYB_VID_LINE_TRIGn, BESE_SPRITE_COUNT0.qn());
    /*p29.CUXY*/ CUXY_SPRITE_COUNT1 = dff17_AB(BESE_SPRITE_COUNT0.qn(), AZYB_VID_LINE_TRIGn, CUXY_SPRITE_COUNT1.qn());
    /*p29.BEGO*/ BEGO_SPRITE_COUNT2 = dff17_AB(CUXY_SPRITE_COUNT1.qn(), AZYB_VID_LINE_TRIGn, BEGO_SPRITE_COUNT2.qn());
    /*p29.DYBE*/ DYBE_SPRITE_COUNT3 = dff17_AB(BEGO_SPRITE_COUNT2.qn(), AZYB_VID_LINE_TRIGn, DYBE_SPRITE_COUNT3.qn());
  }
...

  {
    ...
    /*#p30.CUCU*/ SPR_TRI_L0 = tribuf_6nn(FEPO_STORE_MATCHp, DEGE_SPRITE_DELTA0);
    /*#p30.CUCA*/ SPR_TRI_L1 = tribuf_6nn(FEPO_STORE_MATCHp, DABY_SPRITE_DELTA1);
    ...
    /* p29.DEZY*/ DEZY_STORE_ENn = dff17_B(ZEME_AxCxExGx, XAPO_VID_RSTn, DYTY_STORE_ENn_xxCDxxGH);
  }
...

  {
    ...
    /* p30.WEHE*/ SPR_TRI_L0 = tribuf_6nn(FURO_SPRITE0_GETn, GYHO_STORE0_L0n.qp());
    /* p30.BUKY*/ SPR_TRI_L1 = tribuf_6nn(FURO_SPRITE0_GETn, CUFO_STORE0_L1n.qp());
    /* p30.AJAL*/ SPR_TRI_L2 = tribuf_6nn(FURO_SPRITE0_GETn, BOZU_STORE0_L2n.qp());
    /* p30.GOFO*/ SPR_TRI_L3 = tribuf_6nn(FURO_SPRITE0_GETn, FYHY_STORE0_L3n.qp());
       
    /* p30.BYRO*/ SPR_TRI_L0 = tribuf_6nn(DYDO_SPRITE1_GETn, AMES_STORE1_L0n.qp());
    /* p30.AHUM*/ SPR_TRI_L1 = tribuf_6nn(DYDO_SPRITE1_GETn, AROF_STORE1_L1n.qp());
    /* p30.BACO*/ SPR_TRI_L2 = tribuf_6nn(DYDO_SPRITE1_GETn, ABOP_STORE1_L2n.qp());
    /* p30.BEFE*/ SPR_TRI_L3 = tribuf_6nn(DYDO_SPRITE1_GETn, ABUG_STORE1_L3n.qp());
       
    /* p30.ZUKE*/ SPR_TRI_L0 = tribuf_6nn(FAME_SPRITE2_GETn, YLOV_STORE2_L0n.qp());
    /* p30.WERE*/ SPR_TRI_L1 = tribuf_6nn(FAME_SPRITE2_GETn, XOSY_STORE2_L1n.qp());
    /* p30.WUXE*/ SPR_TRI_L2 = tribuf_6nn(FAME_SPRITE2_GETn, XAZY_STORE2_L2n.qp());
    /* p30.ZABY*/ SPR_TRI_L3 = tribuf_6nn(FAME_SPRITE2_GETn, YKUK_STORE2_L3n.qp());
       
    /* p30.ZEXE*/ SPR_TRI_L0 = tribuf_6nn(GYMA_SPRITE3_GETn, ZURO_STORE3_L0n.qp());
    /* p30.YWAV*/ SPR_TRI_L1 = tribuf_6nn(GYMA_SPRITE3_GETn, ZYLU_STORE3_L1n.qp());
    /* p30.YJEM*/ SPR_TRI_L2 = tribuf_6nn(GYMA_SPRITE3_GETn, ZENE_STORE3_L2n.qp());
    /* p30.ZYPO*/ SPR_TRI_L3 = tribuf_6nn(GYMA_SPRITE3_GETn, ZURY_STORE3_L3n.qp());
       
    /* p30.BUCE*/ SPR_TRI_L0 = tribuf_6nn(GOWO_SPRITE4_GETn, CAPO_STORE4_L0n.qp());
    /* p30.BEVY*/ SPR_TRI_L1 = tribuf_6nn(GOWO_SPRITE4_GETn, CAJU_STORE4_L1n.qp());
    /* p30.BOVE*/ SPR_TRI_L2 = tribuf_6nn(GOWO_SPRITE4_GETn, CONO_STORE4_L2n.qp());
    /* p30.BYDO*/ SPR_TRI_L3 = tribuf_6nn(GOWO_SPRITE4_GETn, CUMU_STORE4_L3n.qp());
       
    /* p30.BACE*/ SPR_TRI_L0 = tribuf_6nn(GYGY_SPRITE5_GETn, ACEP_STORE5_L0n.qp());
    /* p30.BUJA*/ SPR_TRI_L1 = tribuf_6nn(GYGY_SPRITE5_GETn, ABEG_STORE5_L1n.qp());
    /* p30.BODU*/ SPR_TRI_L2 = tribuf_6nn(GYGY_SPRITE5_GETn, ABUX_STORE5_L2n.qp());
    /* p30.AWAT*/ SPR_TRI_L3 = tribuf_6nn(GYGY_SPRITE5_GETn, ANED_STORE5_L3n.qp());
       
    /* p30.YBUK*/ SPR_TRI_L0 = tribuf_6nn(XYME_SPRITE6_GETn, ZUMY_STORE6_L0n.qp());
    /* p30.YKOZ*/ SPR_TRI_L1 = tribuf_6nn(XYME_SPRITE6_GETn, ZAFU_STORE6_L1n.qp());
    /* p30.ZYTO*/ SPR_TRI_L2 = tribuf_6nn(XYME_SPRITE6_GETn, ZEXO_STORE6_L2n.qp());
    /* p30.ZUDO*/ SPR_TRI_L3 = tribuf_6nn(XYME_SPRITE6_GETn, ZUBE_STORE6_L3n.qp());
       
    /* p30.WAXE*/ SPR_TRI_L0 = tribuf_6nn(GUGY_SPRITE7_GETn, XYNA_STORE7_L0n.qp());
    /* p30.YPOZ*/ SPR_TRI_L1 = tribuf_6nn(GUGY_SPRITE7_GETn, YGUM_STORE7_L1n.qp());
    /* p30.WABU*/ SPR_TRI_L2 = tribuf_6nn(GUGY_SPRITE7_GETn, XAKU_STORE7_L2n.qp());
    /* p30.WANA*/ SPR_TRI_L3 = tribuf_6nn(GUGY_SPRITE7_GETn, XYGO_STORE7_L3n.qp());
       
    /* p30.BOSO*/ SPR_TRI_L0 = tribuf_6nn(DENY_SPRITE8_GETn, AZAP_STORE8_L0n.qp());
    /* p30.BAZU*/ SPR_TRI_L1 = tribuf_6nn(DENY_SPRITE8_GETn, AFYX_STORE8_L1n.qp());
    /* p30.AHAC*/ SPR_TRI_L2 = tribuf_6nn(DENY_SPRITE8_GETn, AFUT_STORE8_L2n.qp());
    /* p30.BUJY*/ SPR_TRI_L3 = tribuf_6nn(DENY_SPRITE8_GETn, AFYM_STORE8_L3n.qp());
       
    /* p30.BYME*/ SPR_TRI_L0 = tribuf_6nn(FADO_SPRITE9_GETn, CANA_STORE9_L0n.qp());
    /* p30.GATE*/ SPR_TRI_L1 = tribuf_6nn(FADO_SPRITE9_GETn, FOFO_STORE9_L1n.qp());
    /* p30.COHO*/ SPR_TRI_L2 = tribuf_6nn(FADO_SPRITE9_GETn, DYSY_STORE9_L2n.qp());
    /* p30.CAWO*/ SPR_TRI_L3 = tribuf_6nn(FADO_SPRITE9_GETn, DEWU_STORE9_L3n.qp());
  }
...

  {
...

    {
      ...
      /*p30.GYHO*/ GYHO_STORE0_L0n.tock(ENOB_STORE0_CLKp, ENOB_STORE0_CLKn, SPR_TRI_L0.tp());
      /*p30.CUFO*/ CUFO_STORE0_L1n.tock(ENOB_STORE0_CLKp, ENOB_STORE0_CLKn, SPR_TRI_L1.tp());
      /*p30.BOZU*/ BOZU_STORE0_L2n.tock(ENOB_STORE0_CLKp, ENOB_STORE0_CLKn, SPR_TRI_L2.tp());
      /*p30.FYHY*/ FYHY_STORE0_L3n.tock(ENOB_STORE0_CLKp, ENOB_STORE0_CLKn, SPR_TRI_L3.tp());
...

    {
      ...
      /*p30.CADU*/ CADU_STORE1_I0n.tock(BYVY_STORE1_CLKp, BYVY_STORE1_CLKn, SPR_TRI_I0p.tp());
      /*p30.CEBO*/ CEBO_STORE1_I1n.tock(BYVY_STORE1_CLKp, BYVY_STORE1_CLKn, SPR_TRI_I1p.tp());
      /*p30.CUFA*/ CUFA_STORE1_I2n.tock(BYVY_STORE1_CLKp, BYVY_STORE1_CLKn, SPR_TRI_I2p.tp());
      /*p30.COMA*/ COMA_STORE1_I3n.tock(BYVY_STORE1_CLKp, BYVY_STORE1_CLKn, SPR_TRI_I3p.tp());
      /*p30.CUZA*/ CUZA_STORE1_I4n.tock(BYVY_STORE1_CLKp, BYVY_STORE1_CLKn, SPR_TRI_I4p.tp());
      /*p30.CAJY*/ CAJY_STORE1_I5n.tock(BYVY_STORE1_CLKp, BYVY_STORE1_CLKn, SPR_TRI_I5p.tp());

      /*p29.AHOF*/ wire AHOF_STORE1_CLKp = not1(BUCO_STORE1_CLKn);
      /*p29.AHOF*/ wire AHOF_STORE1_CLKn = not1(AHOF_STORE1_CLKp);

      /*p30.AMES*/ AMES_STORE1_L0n.tock(AHOF_STORE1_CLKp, AHOF_STORE1_CLKn, SPR_TRI_L0.tp());
      /*p30.AROF*/ AROF_STORE1_L1n.tock(AHOF_STORE1_CLKp, AHOF_STORE1_CLKn, SPR_TRI_L1.tp());
      /*p30.ABOP*/ ABOP_STORE1_L2n.tock(AHOF_STORE1_CLKp, AHOF_STORE1_CLKn, SPR_TRI_L2.tp());
      /*p30.ABUG*/ ABUG_STORE1_L3n.tock(AHOF_STORE1_CLKp, AHOF_STORE1_CLKn, SPR_TRI_L3.tp());
    ...
    /*p30.BUHE*/ BUHE_STORE2_I0n = dff8_B_inv(BUZY_STORE2_CLKp, SPR_TRI_I0p.tp());
    /*p30.BYHU*/ BYHU_STORE2_I1n = dff8_B_inv(BUZY_STORE2_CLKp, SPR_TRI_I1p.tp());
    /*p30.BECA*/ BECA_STORE2_I2n = dff8_B_inv(BUZY_STORE2_CLKp, SPR_TRI_I2p.tp());
    /*p30.BULU*/ BULU_STORE2_I3n = dff8_B_inv(BUZY_STORE2_CLKp, SPR_TRI_I3p.tp());
    /*p30.BUNA*/ BUNA_STORE2_I4n = dff8_B_inv(BUZY_STORE2_CLKp, SPR_TRI_I4p.tp());
    /*p30.BOXA*/ BOXA_STORE2_I5n = dff8_B_inv(BUZY_STORE2_CLKp, SPR_TRI_I5p.tp());

    /*p30.YLOV*/ YLOV_STORE2_L0n = dff8_B_inv(FUKE_STORE2_CLKp, SPR_TRI_L0.tp());
    /*p30.XOSY*/ XOSY_STORE2_L1n = dff8_B_inv(FUKE_STORE2_CLKp, SPR_TRI_L1.tp());
    /*p30.XAZY*/ XAZY_STORE2_L2n = dff8_B_inv(FUKE_STORE2_CLKp, SPR_TRI_L2.tp());
    /*p30.YKUK*/ YKUK_STORE2_L3n = dff8_B_inv(FUKE_STORE2_CLKp, SPR_TRI_L3.tp());

    /*p31.FOKA*/ FOKA_STORE2_X0p = dff9_A_inv(CACU_STORE2_CLKp, GAMY_STORE2_RSTn, ZAGO_X0n);
    /*p31.FYTY*/ FYTY_STORE2_X1p = dff9_A_inv(CACU_STORE2_CLKp, GAMY_STORE2_RSTn, ZOCY_X1n);
    /*p31.FUBY*/ FUBY_STORE2_X2p = dff9_A_inv(CACU_STORE2_CLKp, GAMY_STORE2_RSTn, YPUR_X2n);
    /*p31.GOXU*/ GOXU_STORE2_X3p = dff9_A_inv(CACU_STORE2_CLKp, GAMY_STORE2_RSTn, YVOK_X3n);
    /*p31.DUHY*/ DUHY_STORE2_X4p = dff9_A_inv(CACU_STORE2_CLKp, GAMY_STORE2_RSTn, COSE_X4n);
    /*p31.EJUF*/ EJUF_STORE2_X5p = dff9_A_inv(CACU_STORE2_CLKp, GAMY_STORE2_RSTn, AROP_X5n);
    /*p31.ENOR*/ ENOR_STORE2_X6p = dff9_A_inv(CACU_STORE2_CLKp, GAMY_STORE2_RSTn, XATU_X6n);
    /*p31.DEPY*/ DEPY_STORE2_X7p = dff9_A_inv(CACU_STORE2_CLKp, GAMY_STORE2_RSTn, BADY_X7n);
    ...
    /*p30.DEVY*/ DEVY_STORE3_I0n = dff8_B_inv(FEKA_STORE3_CLKp, SPR_TRI_I0p.tp());
    /*p30.DESE*/ DESE_STORE3_I1n = dff8_B_inv(FEKA_STORE3_CLKp, SPR_TRI_I1p.tp());
    /*p30.DUNY*/ DUNY_STORE3_I2n = dff8_B_inv(FEKA_STORE3_CLKp, SPR_TRI_I2p.tp());
    /*p30.DUHA*/ DUHA_STORE3_I3n = dff8_B_inv(FEKA_STORE3_CLKp, SPR_TRI_I3p.tp());
    /*p30.DEBA*/ DEBA_STORE3_I4n = dff8_B_inv(FEKA_STORE3_CLKp, SPR_TRI_I4p.tp());
    /*p30.DAFU*/ DAFU_STORE3_I5n = dff8_B_inv(FEKA_STORE3_CLKp, SPR_TRI_I5p.tp());
    
    /*p30.ZURO*/ ZURO_STORE3_L0n = dff8_B_inv(XYHA_STORE3_CLKp, SPR_TRI_L0.tp());
    /*p30.ZYLU*/ ZYLU_STORE3_L1n = dff8_B_inv(XYHA_STORE3_CLKp, SPR_TRI_L1.tp());
    /*p30.ZENE*/ ZENE_STORE3_L2n = dff8_B_inv(XYHA_STORE3_CLKp, SPR_TRI_L2.tp());
    /*p30.ZURY*/ ZURY_STORE3_L3n = dff8_B_inv(XYHA_STORE3_CLKp, SPR_TRI_L3.tp());

    /*p31.XOLY*/ XOLY_STORE3_X0p = dff9_A_inv(YFAG_STORE3_CLKp, WUPA_STORE3_RSTn, ZAGO_X0n);
    /*p31.XYBA*/ XYBA_STORE3_X1p = dff9_A_inv(YFAG_STORE3_CLKp, WUPA_STORE3_RSTn, ZOCY_X1n);
    /*p31.XABE*/ XABE_STORE3_X2p = dff9_A_inv(YFAG_STORE3_CLKp, WUPA_STORE3_RSTn, YPUR_X2n);
    /*p31.XEKA*/ XEKA_STORE3_X3p = dff9_A_inv(YFAG_STORE3_CLKp, WUPA_STORE3_RSTn, YVOK_X3n);
    /*p31.XOMY*/ XOMY_STORE3_X4p = dff9_A_inv(YFAG_STORE3_CLKp, WUPA_STORE3_RSTn, COSE_X4n);
    /*p31.WUHA*/ WUHA_STORE3_X5p = dff9_A_inv(YFAG_STORE3_CLKp, WUPA_STORE3_RSTn, AROP_X5n);
    /*p31.WYNA*/ WYNA_STORE3_X6p = dff9_A_inv(YFAG_STORE3_CLKp, WUPA_STORE3_RSTn, XATU_X6n);
    /*p31.WECO*/ WECO_STORE3_X7p = dff9_A_inv(YFAG_STORE3_CLKp, WUPA_STORE3_RSTn, BADY_X7n);
    ...
    /*p30.XAVE*/ XAVE_STORE4_I0n = dff8_B_inv(WYLU_STORE4_CLKp, SPR_TRI_I0p.tp());
    /*p30.XEFE*/ XEFE_STORE4_I1n = dff8_B_inv(WYLU_STORE4_CLKp, SPR_TRI_I1p.tp());
    /*p30.WANU*/ WANU_STORE4_I2n = dff8_B_inv(WYLU_STORE4_CLKp, SPR_TRI_I2p.tp());
    /*p30.XABO*/ XABO_STORE4_I3n = dff8_B_inv(WYLU_STORE4_CLKp, SPR_TRI_I3p.tp());
    /*p30.XEGE*/ XEGE_STORE4_I4n = dff8_B_inv(WYLU_STORE4_CLKp, SPR_TRI_I4p.tp());
    /*p30.XYNU*/ XYNU_STORE4_I5n = dff8_B_inv(WYLU_STORE4_CLKp, SPR_TRI_I5p.tp());

    /*p30.CAPO*/ CAPO_STORE4_L0n = dff8_B_inv(EWOT_STORE4_CLKp, SPR_TRI_L0.tp());
    /*p30.CAJU*/ CAJU_STORE4_L1n = dff8_B_inv(EWOT_STORE4_CLKp, SPR_TRI_L1.tp());
    /*p30.CONO*/ CONO_STORE4_L2n = dff8_B_inv(EWOT_STORE4_CLKp, SPR_TRI_L2.tp());
    /*p30.CUMU*/ CUMU_STORE4_L3n = dff8_B_inv(EWOT_STORE4_CLKp, SPR_TRI_L3.tp());

    /*p31.WEDU*/ WEDU_STORE4_X0p = dff9_A_inv(WOFO_STORE4_CLKp, WUNU_STORE4_RSTn, ZAGO_X0n);
    /*p31.YGAJ*/ YGAJ_STORE4_X1p = dff9_A_inv(WOFO_STORE4_CLKp, WUNU_STORE4_RSTn, ZOCY_X1n);
    /*p31.ZYJO*/ ZYJO_STORE4_X2p = dff9_A_inv(WOFO_STORE4_CLKp, WUNU_STORE4_RSTn, YPUR_X2n);
    /*p31.XURY*/ XURY_STORE4_X3p = dff9_A_inv(WOFO_STORE4_CLKp, WUNU_STORE4_RSTn, YVOK_X3n);
    /*p31.YBED*/ YBED_STORE4_X4p = dff9_A_inv(WOFO_STORE4_CLKp, WUNU_STORE4_RSTn, COSE_X4n);
    /*p31.ZALA*/ ZALA_STORE4_X5p = dff9_A_inv(WOFO_STORE4_CLKp, WUNU_STORE4_RSTn, AROP_X5n);
    /*p31.WYDE*/ WYDE_STORE4_X6p = dff9_A_inv(WOFO_STORE4_CLKp, WUNU_STORE4_RSTn, XATU_X6n);
    /*p31.XEPA*/ XEPA_STORE4_X7p = dff9_A_inv(WOFO_STORE4_CLKp, WUNU_STORE4_RSTn, BADY_X7n);
    ...
    /*p30.EKOP*/ EKOP_STORE5_I0n = dff8_B_inv(DYMO_STORE5_CLKp, SPR_TRI_I0p.tp());
    /*p30.ETYM*/ ETYM_STORE5_I1n = dff8_B_inv(DYMO_STORE5_CLKp, SPR_TRI_I1p.tp());
    /*p30.GORU*/ GORU_STORE5_I2n = dff8_B_inv(DYMO_STORE5_CLKp, SPR_TRI_I2p.tp());
    /*p30.EBEX*/ EBEX_STORE5_I3n = dff8_B_inv(DYMO_STORE5_CLKp, SPR_TRI_I3p.tp());
    /*p30.ETAV*/ ETAV_STORE5_I4n = dff8_B_inv(DYMO_STORE5_CLKp, SPR_TRI_I4p.tp());
    /*p30.EKAP*/ EKAP_STORE5_I5n = dff8_B_inv(DYMO_STORE5_CLKp, SPR_TRI_I5p.tp());

    /*p30.ACEP*/ ACEP_STORE5_L0n = dff8_B_inv(BUCY_STORE5_CLKp, SPR_TRI_L0.tp());
    /*p30.ABEG*/ ABEG_STORE5_L1n = dff8_B_inv(BUCY_STORE5_CLKp, SPR_TRI_L1.tp());
    /*p30.ABUX*/ ABUX_STORE5_L2n = dff8_B_inv(BUCY_STORE5_CLKp, SPR_TRI_L2.tp());
    /*p30.ANED*/ ANED_STORE5_L3n = dff8_B_inv(BUCY_STORE5_CLKp, SPR_TRI_L3.tp());

    /*p31.FUSA*/ FUSA_STORE5_X0p = dff9_A_inv(CYLA_STORE5_CLKp, EJAD_STORE5_RSTn, ZAGO_X0n);
    /*p31.FAXA*/ FAXA_STORE5_X1p = dff9_A_inv(CYLA_STORE5_CLKp, EJAD_STORE5_RSTn, ZOCY_X1n);
    /*p31.FOZY*/ FOZY_STORE5_X2p = dff9_A_inv(CYLA_STORE5_CLKp, EJAD_STORE5_RSTn, YPUR_X2n);
    /*p31.FESY*/ FESY_STORE5_X3p = dff9_A_inv(CYLA_STORE5_CLKp, EJAD_STORE5_RSTn, YVOK_X3n);
    /*p31.CYWE*/ CYWE_STORE5_X4p = dff9_A_inv(CYLA_STORE5_CLKp, EJAD_STORE5_RSTn, COSE_X4n);
    /*p31.DYBY*/ DYBY_STORE5_X5p = dff9_A_inv(CYLA_STORE5_CLKp, EJAD_STORE5_RSTn, AROP_X5n);
    /*p31.DURY*/ DURY_STORE5_X6p = dff9_A_inv(CYLA_STORE5_CLKp, EJAD_STORE5_RSTn, XATU_X6n);
    /*p31.CUVY*/ CUVY_STORE5_X7p = dff9_A_inv(CYLA_STORE5_CLKp, EJAD_STORE5_RSTn, BADY_X7n);
    ...
    /*p30.GABO*/ GABO_STORE6_I0n = dff8_B_inv(WUSE_STORE6_CLKp, SPR_TRI_I0p.tp());
    /*p30.GACY*/ GACY_STORE6_I1n = dff8_B_inv(WUSE_STORE6_CLKp, SPR_TRI_I1p.tp());
    /*p30.FOGO*/ FOGO_STORE6_I2n = dff8_B_inv(WUSE_STORE6_CLKp, SPR_TRI_I2p.tp());
    /*p30.GOHU*/ GOHU_STORE6_I3n = dff8_B_inv(WUSE_STORE6_CLKp, SPR_TRI_I3p.tp());
    /*p30.FOXY*/ FOXY_STORE6_I4n = dff8_B_inv(WUSE_STORE6_CLKp, SPR_TRI_I4p.tp());
    /*p30.GECU*/ GECU_STORE6_I5n = dff8_B_inv(WUSE_STORE6_CLKp, SPR_TRI_I5p.tp());

    /*p30.ZUMY*/ ZUMY_STORE6_L0n = dff8_B_inv(ZURU_STORE6_CLKp, SPR_TRI_L0.tp());
    /*p30.ZAFU*/ ZAFU_STORE6_L1n = dff8_B_inv(ZURU_STORE6_CLKp, SPR_TRI_L1.tp());
    /*p30.ZEXO*/ ZEXO_STORE6_L2n = dff8_B_inv(ZURU_STORE6_CLKp, SPR_TRI_L2.tp());
    /*p30.ZUBE*/ ZUBE_STORE6_L3n = dff8_B_inv(ZURU_STORE6_CLKp, SPR_TRI_L3.tp());

    /*p31.YCOL*/ YCOL_STORE6_X0p = dff9_A_inv(ZAPE_STORE6_CLKp, XAHO_STORE6_RSTn, ZAGO_X0n);
    /*p31.YRAC*/ YRAC_STORE6_X1p = dff9_A_inv(ZAPE_STORE6_CLKp, XAHO_STORE6_RSTn, ZOCY_X1n);
    /*p31.YMEM*/ YMEM_STORE6_X2p = dff9_A_inv(ZAPE_STORE6_CLKp, XAHO_STORE6_RSTn, YPUR_X2n);
    /*p31.YVAG*/ YVAG_STORE6_X3p = dff9_A_inv(ZAPE_STORE6_CLKp, XAHO_STORE6_RSTn, YVOK_X3n);
    /*p31.ZOLY*/ ZOLY_STORE6_X4p = dff9_A_inv(ZAPE_STORE6_CLKp, XAHO_STORE6_RSTn, COSE_X4n);
    /*p31.ZOGO*/ ZOGO_STORE6_X5p = dff9_A_inv(ZAPE_STORE6_CLKp, XAHO_STORE6_RSTn, AROP_X5n);
    /*p31.ZECU*/ ZECU_STORE6_X6p = dff9_A_inv(ZAPE_STORE6_CLKp, XAHO_STORE6_RSTn, XATU_X6n);
    /*p31.ZESA*/ ZESA_STORE6_X7p = dff9_A_inv(ZAPE_STORE6_CLKp, XAHO_STORE6_RSTn, BADY_X7n);
    ...
    /*p30.GULE*/ GULE_STORE7_I0n = dff8_B_inv(FEFO_STORE7_CLKp, SPR_TRI_I0p.tp());
    /*p30.GYNO*/ GYNO_STORE7_I1n = dff8_B_inv(FEFO_STORE7_CLKp, SPR_TRI_I1p.tp());
    /*p30.FEFA*/ FEFA_STORE7_I2n = dff8_B_inv(FEFO_STORE7_CLKp, SPR_TRI_I2p.tp());
    /*p30.FYSU*/ FYSU_STORE7_I3n = dff8_B_inv(FEFO_STORE7_CLKp, SPR_TRI_I3p.tp());
    /*p30.GESY*/ GESY_STORE7_I4n = dff8_B_inv(FEFO_STORE7_CLKp, SPR_TRI_I4p.tp());
    /*p30.FUZO*/ FUZO_STORE7_I5n = dff8_B_inv(FEFO_STORE7_CLKp, SPR_TRI_I5p.tp());

    /*p30.XYNA*/ XYNA_STORE7_L0n = dff8_B_inv(WABE_STORE7_CLKp, SPR_TRI_L0.tp());
    /*p30.YGUM*/ YGUM_STORE7_L1n = dff8_B_inv(WABE_STORE7_CLKp, SPR_TRI_L1.tp());
    /*p30.XAKU*/ XAKU_STORE7_L2n = dff8_B_inv(WABE_STORE7_CLKp, SPR_TRI_L2.tp());
    /*p30.XYGO*/ XYGO_STORE7_L3n = dff8_B_inv(WABE_STORE7_CLKp, SPR_TRI_L3.tp());

    /*p31.ERAZ*/ ERAZ_STORE7_X0p = dff9_A_inv(GECY_STORE7_CLKp, GAFY_STORE7_RSTn, ZAGO_X0n);
    /*p31.EPUM*/ EPUM_STORE7_X1p = dff9_A_inv(GECY_STORE7_CLKp, GAFY_STORE7_RSTn, ZOCY_X1n);
    /*p31.EROL*/ EROL_STORE7_X2p = dff9_A_inv(GECY_STORE7_CLKp, GAFY_STORE7_RSTn, YPUR_X2n);
    /*p31.EHYN*/ EHYN_STORE7_X3p = dff9_A_inv(GECY_STORE7_CLKp, GAFY_STORE7_RSTn, YVOK_X3n);
    /*p31.FAZU*/ FAZU_STORE7_X4p = dff9_A_inv(GECY_STORE7_CLKp, GAFY_STORE7_RSTn, COSE_X4n);
    /*p31.FAXE*/ FAXE_STORE7_X5p = dff9_A_inv(GECY_STORE7_CLKp, GAFY_STORE7_RSTn, AROP_X5n);
    /*p31.EXUK*/ EXUK_STORE7_X6p = dff9_A_inv(GECY_STORE7_CLKp, GAFY_STORE7_RSTn, XATU_X6n);
    /*p31.FEDE*/ FEDE_STORE7_X7p = dff9_A_inv(GECY_STORE7_CLKp, GAFY_STORE7_RSTn, BADY_X7n);
    ...
    /*p30.AXUV*/ AXUV_STORE8_I0n = dff8_B_inv(AKOL_STORE8_CLKp, SPR_TRI_I0p.tp());
    /*p30.BADA*/ BADA_STORE8_I1n = dff8_B_inv(AKOL_STORE8_CLKp, SPR_TRI_I1p.tp());
    /*p30.APEV*/ APEV_STORE8_I2n = dff8_B_inv(AKOL_STORE8_CLKp, SPR_TRI_I2p.tp());
    /*p30.BADO*/ BADO_STORE8_I3n = dff8_B_inv(AKOL_STORE8_CLKp, SPR_TRI_I3p.tp());
    /*p30.BEXY*/ BEXY_STORE8_I4n = dff8_B_inv(AKOL_STORE8_CLKp, SPR_TRI_I4p.tp());
    /*p30.BYHE*/ BYHE_STORE8_I5n = dff8_B_inv(AKOL_STORE8_CLKp, SPR_TRI_I5p.tp());

    /*p30.AZAP*/ AZAP_STORE8_L0n = dff8_B_inv(BYMY_STORE8_CLKp, SPR_TRI_L0.tp());
    /*p30.AFYX*/ AFYX_STORE8_L1n = dff8_B_inv(BYMY_STORE8_CLKp, SPR_TRI_L1.tp());
    /*p30.AFUT*/ AFUT_STORE8_L2n = dff8_B_inv(BYMY_STORE8_CLKp, SPR_TRI_L2.tp());
    /*p30.AFYM*/ AFYM_STORE8_L3n = dff8_B_inv(BYMY_STORE8_CLKp, SPR_TRI_L3.tp());

    /*p31.EZUF*/ EZUF_STORE8_X0p = dff9_A_inv(CEXU_STORE8_CLKp, WUZO_STORE8_RSTn, COSE_X4n);
    /*p31.ENAD*/ ENAD_STORE8_X1p = dff9_A_inv(CEXU_STORE8_CLKp, WUZO_STORE8_RSTn, AROP_X5n);
    /*p31.EBOW*/ EBOW_STORE8_X2p = dff9_A_inv(CEXU_STORE8_CLKp, WUZO_STORE8_RSTn, XATU_X6n);
    /*p31.FYCA*/ FYCA_STORE8_X3p = dff9_A_inv(CEXU_STORE8_CLKp, WUZO_STORE8_RSTn, BADY_X7n);
    /*p31.GAVY*/ GAVY_STORE8_X4p = dff9_A_inv(CEXU_STORE8_CLKp, WUZO_STORE8_RSTn, ZAGO_X0n);
    /*p31.GYPU*/ GYPU_STORE8_X5p = dff9_A_inv(CEXU_STORE8_CLKp, WUZO_STORE8_RSTn, ZOCY_X1n);
    /*p31.GADY*/ GADY_STORE8_X6p = dff9_A_inv(CEXU_STORE8_CLKp, WUZO_STORE8_RSTn, YPUR_X2n);
    /*p31.GAZA*/ GAZA_STORE8_X7p = dff9_A_inv(CEXU_STORE8_CLKp, WUZO_STORE8_RSTn, YVOK_X3n);
    ...
    /*p30.YBER*/ YBER_STORE9_I0n = dff8_B_inv(WUFA_STORE9_CLKp, SPR_TRI_I0p.tp());
    /*p30.YZOR*/ YZOR_STORE9_I1n = dff8_B_inv(WUFA_STORE9_CLKp, SPR_TRI_I1p.tp());
    /*p30.XYFE*/ XYFE_STORE9_I2n = dff8_B_inv(WUFA_STORE9_CLKp, SPR_TRI_I2p.tp());
    /*p30.XOTU*/ XOTU_STORE9_I3n = dff8_B_inv(WUFA_STORE9_CLKp, SPR_TRI_I3p.tp());
    /*p30.XUTE*/ XUTE_STORE9_I4n = dff8_B_inv(WUFA_STORE9_CLKp, SPR_TRI_I4p.tp());
    /*p30.XUFO*/ XUFO_STORE9_I5n = dff8_B_inv(WUFA_STORE9_CLKp, SPR_TRI_I5p.tp());

    /*p30.CANA*/ CANA_STORE9_L0n = dff8_B_inv(FAKA_STORE9_CLKp, SPR_TRI_L0.tp());
    /*p30.FOFO*/ FOFO_STORE9_L1n = dff8_B_inv(FAKA_STORE9_CLKp, SPR_TRI_L1.tp());
    /*p30.DYSY*/ DYSY_STORE9_L2n = dff8_B_inv(FAKA_STORE9_CLKp, SPR_TRI_L2.tp());
    /*p30.DEWU*/ DEWU_STORE9_L3n = dff8_B_inv(FAKA_STORE9_CLKp, SPR_TRI_L3.tp());

    /*p31.XUVY*/ XUVY_STORE9_X0p = dff9_A_inv(WEME_STORE9_CLKp, DOSY_STORE9_RSTn, ZAGO_X0n);
    /*p31.XERE*/ XERE_STORE9_X1p = dff9_A_inv(WEME_STORE9_CLKp, DOSY_STORE9_RSTn, ZOCY_X1n);
    /*p31.XUZO*/ XUZO_STORE9_X2p = dff9_A_inv(WEME_STORE9_CLKp, DOSY_STORE9_RSTn, YPUR_X2n);
    /*p31.XEXA*/ XEXA_STORE9_X3p = dff9_A_inv(WEME_STORE9_CLKp, DOSY_STORE9_RSTn, YVOK_X3n);
    /*p31.YPOD*/ YPOD_STORE9_X4p = dff9_A_inv(WEME_STORE9_CLKp, DOSY_STORE9_RSTn, COSE_X4n);
    /*p31.YROP*/ YROP_STORE9_X5p = dff9_A_inv(WEME_STORE9_CLKp, DOSY_STORE9_RSTn, AROP_X5n);
    /*p31.YNEP*/ YNEP_STORE9_X6p = dff9_A_inv(WEME_STORE9_CLKp, DOSY_STORE9_RSTn, XATU_X6n);
    /*p31.YZOF*/ YZOF_STORE9_X7p = dff9_A_inv(WEME_STORE9_CLKp, DOSY_STORE9_RSTn, BADY_X7n);
  }
}
