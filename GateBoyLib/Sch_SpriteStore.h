...
struct SpriteStore {
  ...
  void reset_boot() {
    DEZY_COUNT_CLKp_evn.reset(REG_D0C0);
    BESE_SPRITE_COUNT0_evn.reset(REG_D0C0);
    CUXY_SPRITE_COUNT1_evn.reset(REG_D0C0);
    BEGO_SPRITE_COUNT2_evn.reset(REG_D0C0);
    DYBE_SPRITE_COUNT3_evn.reset(REG_D0C0);
    ...
    XADU_SPRITE_IDX0p_evn.reset(REG_D0C0);
    XEDY_SPRITE_IDX1p_evn.reset(REG_D0C0);
    ZUZE_SPRITE_IDX2p_evn.reset(REG_D0C0);
    XOBE_SPRITE_IDX3p_evn.reset(REG_D0C0);
    YDUF_SPRITE_IDX4p_evn.reset(REG_D0C0);
    XECU_SPRITE_IDX5p_evn.reset(REG_D0C0);
