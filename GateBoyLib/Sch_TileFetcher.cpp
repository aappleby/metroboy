...
void TileFetcher::tock(SchematicTop& top) {
  ...
  /*p27.LAXU*/ LAXU_BFETCH_S0   .tock(LEBO_AxCxExGx,             top.NYXU_FETCH_TRIGn,   LAXU_BFETCH_S0.qn());
  /*p27.MESU*/ MESU_BFETCH_S1   .tock(LAXU_BFETCH_S0.qn(),       top.NYXU_FETCH_TRIGn,   MESU_BFETCH_S1.qn());
  /*p27.NYVA*/ NYVA_BFETCH_S2   .tock(MESU_BFETCH_S1.qn(),       top.NYXU_FETCH_TRIGn,   NYVA_BFETCH_S2.qn());
  /*p27.LYZU*/ LYZU_BFETCH_S0_D1.tock(ALET_xBxDxFxH, XYMU_RENDERINGp, LAXU_BFETCH_S0.qp());
  ...
  /*p24.NYKA*/ NYKA_FETCH_DONE_P11.tock(ALET_xBxDxFxH, NAFY_RENDERING_AND_NOT_WIN_TRIG, LYRY_BFETCH_DONEp);
