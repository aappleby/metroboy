...
void TileFetcher::tock(SchematicTop& top) {
  ...
  /*p27.LAXU*/ LAXU_BFETCH_S0    = dff17_AB(LEBO_AxCxExGx,             top.NYXU_FETCH_TRIGn,   LAXU_BFETCH_S0.qn());
  /*p27.MESU*/ MESU_BFETCH_S1    = dff17_AB(LAXU_BFETCH_S0.qn(),       top.NYXU_FETCH_TRIGn,   MESU_BFETCH_S1.qn());
  /*p27.NYVA*/ NYVA_BFETCH_S2    = dff17_AB(MESU_BFETCH_S1.qn(),       top.NYXU_FETCH_TRIGn,   NYVA_BFETCH_S2.qn());
  /*p27.LYZU*/ LYZU_BFETCH_S0_D1 = dff17_B(ALET_xBxDxFxH, XYMU_RENDERINGp, LAXU_BFETCH_S0.qp());
  ...
  /*p24.NYKA*/ NYKA_FETCH_DONE_P11 = dff17_B(ALET_xBxDxFxH, NAFY_RENDERING_AND_NOT_WIN_TRIG, LYRY_BFETCH_DONEp);
  /*p24.PORY*/ PORY_FETCH_DONE_P12 = dff17_B(MYVO_AxCxExGx, NAFY_RENDERING_AND_NOT_WIN_TRIG, NYKA_FETCH_DONE_P11.qp());
  /*p24.PYGO*/ PYGO_FETCH_DONE_P13 = dff17_B(ALET_xBxDxFxH, XYMU_RENDERINGp,   PORY_FETCH_DONE_P12.qp());

  /*p24.POKY*/ POKY_PRELOAD_LATCHp = nor_latch(PYGO_FETCH_DONE_P13.qp(), LOBY_RENDERINGn);

  /*p27.LOVY*/ LOVY_BG_FETCH_DONEp   = dff17_A(MYVO_AxCxExGx, top.NYXU_FETCH_TRIGn,     LYRY_BFETCH_DONEp);
