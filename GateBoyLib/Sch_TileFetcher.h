...
struct TileFetcher {
  ...
  void reset_boot() {
    ...
    NYKA_FETCH_DONEp_xxx.reset(REG_D0C0);
    PORY_FETCH_DONEp_xxx.reset(REG_D0C0);

    LAXU_BFETCH_S0p_evn.reset(REG_D0C0);
    MESU_BFETCH_S1p_evn.reset(REG_D0C0);
    NYVA_BFETCH_S2p_evn.reset(REG_D0C0);

    LOVY_FETCH_DONEp_evn.reset(REG_D0C0);
    PYGO_FETCH_DONEp_odd.reset(REG_D0C0);
    LYZU_BFETCH_S0p_D1_odd.reset(REG_D0C0);

    GAVE_SCY0n_h.reset(REG_D0C0);
    FYMO_SCY1n_h.reset(REG_D0C0);
    FEZU_SCY2n_h.reset(REG_D0C0);
    FUJO_SCY3n_h.reset(REG_D0C0);
    DEDE_SCY4n_h.reset(REG_D0C0);
    FOTY_SCY5n_h.reset(REG_D0C0);
    FOHA_SCY6n_h.reset(REG_D0C0);
    FUNY_SCY7n_h.reset(REG_D0C0);

    DATY_SCX0n_h.reset(REG_D0C0);
    DUZU_SCX1n_h.reset(REG_D0C0);
    CYXU_SCX2n_h.reset(REG_D0C0);
    GUBO_SCX3n_h.reset(REG_D0C0);
    BEMY_SCX4n_h.reset(REG_D0C0);
    CUZY_SCX5n_h.reset(REG_D0C0);
    CABU_SCX6n_h.reset(REG_D0C0);
    BAKE_SCX7n_h.reset(REG_D0C0);

    WYKA_WIN_X3_evn.reset(REG_D0C0);
    WODY_WIN_X4_evn.reset(REG_D0C0);
    WOBO_WIN_X5_evn.reset(REG_D0C0);
    WYKO_WIN_X6_evn.reset(REG_D0C0);
    XOLO_WIN_X7_evn.reset(REG_D0C0);

    VYNO_WIN_Y0_evn.reset(REG_D0C0);
    VUJO_WIN_Y1_evn.reset(REG_D0C0);
    VYMU_WIN_Y2_evn.reset(REG_D0C0);
    TUFU_WIN_Y3_evn.reset(REG_D0C0);
    TAXA_WIN_Y4_evn.reset(REG_D0C0);
    ...
    MUKU_TILE_DA2n_odd.reset(REG_D0C0);
    LUZO_TILE_DA3n_odd.reset(REG_D0C0);
    MEGU_TILE_DA4n_odd.reset(REG_D0C0);
    MYJY_TILE_DA5n_odd.reset(REG_D0C0);
    NASA_TILE_DA6n_odd.reset(REG_D0C0);
    NEFO_TILE_DA7n_odd.reset(REG_D0C0);
    RAWU_TILE_DB0p_odd.reset(REG_D0C0);
    POZO_TILE_DB1p_odd.reset(REG_D0C0);
    PYZO_TILE_DB2p_odd.reset(REG_D0C0);
    POXA_TILE_DB3p_odd.reset(REG_D0C0);
    PULO_TILE_DB4p_odd.reset(REG_D0C0);
    POJU_TILE_DB5p_odd.reset(REG_D0C0);
    POWY_TILE_DB6p_odd.reset(REG_D0C0);
    PYJU_TILE_DB7p_odd.reset(REG_D0C0);
  }
