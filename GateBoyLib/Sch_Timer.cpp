...
void Timer::tock(wire RST, const SchematicTop& top, CpuBus& cpu_bus) {
  ...
  // FF06 TMA
  {
    ...
    /*p03.SABU*/ SABU_TMA_D0.tock(TYJU_FF06_WRn, top.clk_reg.ALUR_SYS_RSTn, top.cpu_bus.BUS_CPU_D0p.tp());
    /*p03.NYKE*/ NYKE_TMA_D1.tock(TYJU_FF06_WRn, top.clk_reg.ALUR_SYS_RSTn, top.cpu_bus.BUS_CPU_D1p.tp());
    /*p03.MURU*/ MURU_TMA_D2.tock(TYJU_FF06_WRn, top.clk_reg.ALUR_SYS_RSTn, top.cpu_bus.BUS_CPU_D2p.tp());
    /*p03.TYVA*/ TYVA_TMA_D3.tock(TYJU_FF06_WRn, top.clk_reg.ALUR_SYS_RSTn, top.cpu_bus.BUS_CPU_D3p.tp());
    /*p03.TYRU*/ TYRU_TMA_D4.tock(TYJU_FF06_WRn, top.clk_reg.ALUR_SYS_RSTn, top.cpu_bus.BUS_CPU_D4p.tp());
    /*p03.SUFY*/ SUFY_TMA_D5.tock(TYJU_FF06_WRn, top.clk_reg.ALUR_SYS_RSTn, top.cpu_bus.BUS_CPU_D5p.tp());
    /*p03.PETO*/ PETO_TMA_D6.tock(TYJU_FF06_WRn, top.clk_reg.ALUR_SYS_RSTn, top.cpu_bus.BUS_CPU_D6p.tp());
    /*p03.SETA*/ SETA_TMA_D7.tock(TYJU_FF06_WRn, top.clk_reg.ALUR_SYS_RSTn, top.cpu_bus.BUS_CPU_D7p.tp());
  ...
  // FF07 TAC
  {
    ...
    /*p03.SOPU*/ SOPU_TAC_D0.tock(SARA_FF07_WRn, top.clk_reg.ALUR_SYS_RSTn, top.cpu_bus.BUS_CPU_D0p.tp());
    /*p03.SAMY*/ SAMY_TAC_D1.tock(SARA_FF07_WRn, top.clk_reg.ALUR_SYS_RSTn, top.cpu_bus.BUS_CPU_D1p.tp());
    /*p03.SABO*/ SABO_TAC_D2.tock(SARA_FF07_WRn, top.clk_reg.ALUR_SYS_RSTn, top.cpu_bus.BUS_CPU_D2p.tp());
