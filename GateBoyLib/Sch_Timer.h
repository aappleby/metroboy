...
struct TimerRegisters {
  ...
  int get_div() const  { return pack_u16(16, &UKUP_DIV00p); }
  int get_tima() const { return pack_u8(8, &REGA_TIMA0p); }
  int get_tma() const  { return pack_u8(8, &SABU_TMA0p); }
  int get_tac() const  { return pack_u8(8, &SOPU_TAC0p); }
