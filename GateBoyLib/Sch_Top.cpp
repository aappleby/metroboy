...
void SchematicTop::tock_slow(wire RST, wire CLK, wire CLKGOOD, wire T1n, wire T2n, wire CPUREADY,
  ...
  /* p04.LUMA*/ wire LUMA_DMA_CARTp = not1(_MORY_DMA_CARTn);

  /* p04.MUHO*/ wire _MUHO_DMA_VRAMp   = nand2(dma_reg.MATU_DMA_RUNNINGp.qp17(), _MUDA_DMA_VRAMp);
  /* p04.LUFA*/ wire LUFA_DMA_VRAMp = not1(_MUHO_DMA_VRAMp);

  //----------------------------------------

  /*p07.UBET*/ wire _UBET_T1p  = not1(T1n);
  /*p07.UVAR*/ wire _UVAR_T2p  = not1(T2n);
  /*p07.UMUT*/ wire UMUT_MODE_DBG1p = and2(T1n, _UVAR_T2p);
  /*p07.UNOR*/ wire UNOR_MODE_DBG2p = and2(T2n, _UBET_T1p);
  /*p07.UPOJ*/ wire UPOJ_MODE_PRODn = nand3(_UBET_T1p, _UVAR_T2p, RST);
  /*p25.TUTO*/ wire TUTO_DBG_VRAMp  = and2(UNOR_MODE_DBG2p, SOTO_DBG_VRAM.qn16());
  ...
  /*#p01.ATYP*/ wire ATYP_ABCDxxxx = not1(clk_reg.AFUR_xxxxEFGH.qp09());
  /*#p01.AJAX*/ wire AJAX_xxxxEFGH = not1(ATYP_ABCDxxxx);
  /*#p01.AROV*/ wire AROV_xxCDEFxx = not1(clk_reg.APUK_ABxxxxGH.qp09());

  /*#p01.AGUT*/ wire _AGUT_xxCDEFGH = or_and3(AROV_xxCDEFxx, AJAX_xxxxEFGH, cpu_bus.PIN_CPU_EXT_BUSp.qp());
  /*#p01.AWOD*/ wire _AWOD_ABxxxxxx = nor2(UNOR_MODE_DBG2p, _AGUT_xxCDEFGH);
  /*#p01.ABUZ*/ wire ABUZ_xxCDEFGH = not1(_AWOD_ABxxxxxx);
  ...
  /*#p08.TEXO*/ wire TEXO_ADDR_EXT_AND_NOT_VRAM = and2(cpu_bus.PIN_CPU_EXT_BUSp.qp(), _TEVY_8000_9FFFn);

  /* p04.DECY*/ wire _DECY_LATCH_EXTn = not1(cpu_bus.PIN_CPU_LATCH_EXT.qp());
  /* p04.CATY*/ wire CATY_LATCH_EXTp = not1(_DECY_LATCH_EXTn);

  /* p28.MYNU*/ wire _MYNU_CPU_RDn = nand2(ASOT_CPU_RDp, CATY_LATCH_EXTp);
  /* p28.LEKO*/ wire LEKO_CPU_RDp = not1(_MYNU_CPU_RDn);
  ...
  /*#p01.ALUR*/ wire ALUR_SYS_RSTn = not1(_AVOR_SYS_RSTp);
  ...
  /* p01.XAPO*/ wire XAPO_VID_RSTn = not1(_XODO_VID_RSTp);
  ...
  /* p01.UCOB*/ wire UCOB_CLKBADp = not1(CLKGOOD);
  ...
  /*p01.ZAXY*/ wire ZAXY_xBxDxFxH = not1(_AZOF_AxCxExGx);
  ...
  /*#p01.BALY*/ wire BALY_xBCDEFGH = not1(_BYJU_Axxxxxxx);
  /* p01.BOGA*/ wire BOGA_Axxxxxxx = not1(BALY_xBCDEFGH);

  /*#p01.ADAR*/ wire ADAR_ABCxxxxH = not1(clk_reg.ADYK_ABCxxxxH.qn08());
  /*#p29.XUPY*/ wire XUPY_ABxxEFxx = not1(clk_reg.WUVU_ABxxEFxx.qn16());
  /*#p21.TALU*/ wire TALU_xxCDEFxx = not1(clk_reg.VENA_xxCDEFxx.qn16());
  /*#p29.XOCE*/ wire XOCE_xBCxxFGx = not1(clk_reg.WOSU_AxxDExxH.qp17());
  /*#p29.WOJO*/ wire WOJO_AxxxExxx = nor2(clk_reg.WOSU_AxxDExxH.qn16(), clk_reg.WUVU_ABxxEFxx.qn16());
  /*#p01.AFAS*/ wire AFAS_xxxxEFGx = nor2(ADAR_ABCxxxxH, ATYP_ABCDxxxx);

  /*#p01.ZEME*/ wire ZEME_AxCxExGx = not1(ZAXY_xBxDxFxH);
  /* p01.UVYT*/ wire UVYT_ABCDxxxx = not1(BUDE_xxxxEFGH);
  ...
  /*#p01.BUKE*/ wire BUKE_AxxxxxGH = not1(_BASU_xBCDEFxx);
  ...
  /*#p01.BEDO*/ wire BEDO_Axxxxxxx = not1(_BYXO_xBCDEFGH);
  ...
  /* p29.YDUG*/ wire YDUG_STORE0_MATCHn = nand3(_AROR_MATCH_ENp, ZAKO_STORE0_MATCHAp, XEBA_STORE0_MATCHBp);
  /* p29.DYDU*/ wire DYDU_STORE1_MATCHn = nand3(_AROR_MATCH_ENp, EWAM_STORE1_MATCHAp, CYVY_STORE1_MATCHBp);
  /* p29.DEGO*/ wire DEGO_STORE2_MATCHn = nand3(_AROR_MATCH_ENp, CEHU_STORE2_MATCHAp, EKES_STORE2_MATCHBp);
  /* p29.YLOZ*/ wire YLOZ_STORE3_MATCHn = nand3(_AROR_MATCH_ENp, ZURE_STORE3_MATCHAp, YWOS_STORE3_MATCHBp);
  /* p29.XAGE*/ wire XAGE_STORE4_MATCHn = nand3(_AROR_MATCH_ENp, YKOK_STORE4_MATCHAp, YNAZ_STORE4_MATCHBp);
  /* p29.EGOM*/ wire EGOM_STORE5_MATCHn = nand3(_AROR_MATCH_ENp, COGY_STORE5_MATCHAp, FYMA_STORE5_MATCHBp);
  /* p29.YBEZ*/ wire YBEZ_STORE6_MATCHn = nand3(_AROR_MATCH_ENp, YWAP_STORE6_MATCHAp, YDOT_STORE6_MATCHBp);
  /* p29.DYKA*/ wire DYKA_STORE7_MATCHn = nand3(_AROR_MATCH_ENp, CYCO_STORE7_MATCHAp, DAJE_STORE7_MATCHBp);
  /* p29.EFYL*/ wire EFYL_STORE8_MATCHn = nand3(_AROR_MATCH_ENp, DAMA_STORE8_MATCHAp, FEHA_STORE8_MATCHBp);
  /* p29.YGEM*/ wire YGEM_STORE9_MATCHn = nand3(_AROR_MATCH_ENp, YLEV_STORE9_MATCHAp, YTUB_STORE9_MATCHBp);
  ...
  /* p29.FEPO*/ wire FEPO_STORE_MATCHp = or2(_FEFY_STORE_MATCHp, _FOVE_STORE_MATCHp);
  ...
  /*#p21.WODU*/ wire WODU_HBLANKp = and2(_XENA_STORE_MATCHn, _XANO_X_167p);

  /*#p21.TAPA*/ wire _TAPA_INT_OAM = and2(TOLU_VBLANKn, SELA_LINE_P908p);
  /*#p21.TARU*/ wire _TARU_INT_HBL = and2(WODU_HBLANKp, TOLU_VBLANKn);
  ...
  /*#p21.VOTY*/ wire VOTY_INT_STATp = not1(_TUVA_INT_STATn);

  /*#p27.NOCU*/ wire NOCU_WIN_MODEn = not1(pix_pipe.PYNU_WIN_MODE_A.qp04());
  ...
  /* p27.TUXY*/ wire _TUXY_WIN_FIRST_TILE_NE = nand2(SYLO_WIN_HITn, pix_pipe.SOVY_WIN_FIRST_TILE_B.qp17());
  /* p27.SUZU*/ wire SUZU_WIN_FIRST_TILEne = not1(_TUXY_WIN_FIRST_TILE_NE);

  /* p24.LOBY*/ wire LOBY_RENDERINGn = not1(pix_pipe.XYMU_RENDERINGn.qn03());
  ...
  /* p27.SEKO*/ wire SEKO_FETCH_TRIGp = nor2(pix_pipe.RYFA_FETCHn_A.qn16(), pix_pipe.RENE_FETCHn_B.qp17());
  /* p27.TAVE*/ wire TAVE_PRELOAD_DONE_TRIGp = not1(_SUVU_PRELOAD_DONE_TRIGn);
  /* p27.TEVO*/ wire TEVO_FETCH_TRIGp = or3(SEKO_FETCH_TRIGp, SUZU_WIN_FIRST_TILEne, TAVE_PRELOAD_DONE_TRIGp); // Schematic wrong, this is OR
  /*#p27.NUNY*/ wire NUNY_WX_MATCH_TRIGp = and2(pix_pipe.PYNU_WIN_MODE_A.qp04(), pix_pipe.NOPA_WIN_MODE_B.qn16());
  ...
  /*p01.AREV*/ wire _AREV_CPU_WRn_ABCDxxxH = nand2(cpu_bus.PIN_CPU_WRp.qp(), AFAS_xxxxEFGx);
  /*p01.APOV*/ wire APOV_CPU_WRp_xxxxEFGx      = not1(_AREV_CPU_WRn_ABCDxxxH);
  /*p07.UBAL*/ wire _UBAL_CPU_WRn_ABCDxxxH = mux2n(UNOR_MODE_DBG2p, ext_bus.PIN_EXT_WRn.qn(), APOV_CPU_WRp_xxxxEFGx);
  /*p07.TAPU*/ wire TAPU_CPU_WRp_xxxxEFGx      = not1(_UBAL_CPU_WRn_ABCDxxxH);
  /*p07.DYKY*/ wire _DYKY_CPU_WRn_ABCDxxxH = not1(TAPU_CPU_WRp_xxxxEFGx);
  /*p07.CUPA*/ wire CUPA_CPU_WRp_xxxxEFGx      = not1(_DYKY_CPU_WRn_ABCDxxxH);

  /*p07.TERA*/ wire _TERA_BOOT_BITp  = not1(bootrom.BOOT_BITn.qp17());
  /*p07.TUTU*/ wire TUTU_ADDR_BOOTp = and2(_TERA_BOOT_BITp, cpu_bus.TULO_ADDR_00XXp());

  //----------------------------------------
  // tim_reg.tick()

  /* p01.UVYN*/ wire UVYN_DIV_05n = not1(tim_reg.TAMA_DIV_05.qp17());
  /* p01.UMEK*/ wire UMEK_DIV_06n = not1(tim_reg.UGOT_DIV_06.qp17());
  /* p01.UREK*/ wire UREK_DIV_07n = not1(tim_reg.TULU_DIV_07.qp17());

  //----------------------------------------

  /*p02.ASOK*/ wire ASOK_INT_JOYp = and2(joypad.APUG_JP_GLITCH3.qp17(), joypad.BATU_JP_GLITCH0.qp17());
  ...
  /* p27.LENA*/ wire LENA_BGW_VRM_RDp = not1(_LUSU_BGW_VRAM_RDn);
  ...
  /* p27.NETA*/ wire NETA_TILE_READp = and2(LENA_BGW_VRM_RDp, _NOGU_FETCH_01p);
  /* p26.ASUL*/ wire _ASUL_BG_TILE_READp  = and2(NETA_TILE_READp, _AXAD_WIN_MODEn);
  /* p25.XUCY*/ wire XUCY_WIN_TILE_READn = nand2(NETA_TILE_READp, PORE_WIN_MODEp);
  /*#p25.WUKO*/ wire WUKO_WIN_MAP_READn  = not1(_XEZE_WIN_MAP_READp);
  /* p26.BAFY*/ wire BAFY_BG_MAP_READn   = not1(_ACEN_BG_MAP_READp);
  /* p26.BEJE*/ wire BEJE_BG_TILE_READn = not1(_ASUL_BG_TILE_READp);

  /* p27.MOCE*/ wire MOCE_BFETCH_DONEn = nand3(tile_fetcher.LAXU_BFETCH_S0.qp17(), tile_fetcher.NYVA_BFETCH_S2.qp17(), NYXU_FETCH_TRIGn);

  /*#p27.XUHA*/ wire XUHA_FETCH_S2p  = not1(_NOFU_BFETCH_S2n);

  // MYSO fires on fetch phase 2, 6, 10
  /*#p27.MYSO*/ wire _MYSO_BG_TRIGp   = nor3(LOBY_RENDERINGn, _LAXE_BFETCH_S0n, tile_fetcher.LYZU_BFETCH_S0_D1.qp17());
  ...
  /*#p32.METE*/ wire METE_LATCH_TILE_DAp   = not1(_NYDY_LATCH_TILE_DAn);

  // MOFU fires on fetch phase 2 and 10
  /*p27.MOFU*/ wire _MOFU_LATCH_TILE_DBp = and2(_MYSO_BG_TRIGp, _NAKO_BFETCH_S1n);
  /*p32.LESO*/ wire LESO_LATCH_TILE_DBn   = not1(_MOFU_LATCH_TILE_DBp);
  ...
  /* p29.WUTY*/ wire WUTY_SPRITE_DONEp = not1(_VUSA_SPRITE_DONEn);
  ...
  /* p28.WEFY*/ wire WEFY_SPR_READp = and2(_TUVO_PPU_OAM_RDp, sprite_fetcher.TYFO_SFETCH_S0_D1.qp17());
  ...
  /* p29.TEXY*/ wire TEXY_SPR_READ_VRAMp = not1(_TYSO_SPRITE_READn);
  /* p29.ABON*/ wire ABON_SPR_VRM_RDn = not1(TEXY_SPR_READ_VRAMp);
  /* p25.SOHO*/ wire SOHO_SPR_VRAM_RDp = and2(_TACU_SPR_SEQ_5_TRIG, TEXY_SPR_READ_VRAMp);
  /* p25.VAPE*/ wire VAPE_FETCH_OAM_CLK = and2(_TUVO_PPU_OAM_RDp, _TACU_SPR_SEQ_5_TRIG);
  /*#p29.XUQU*/ wire XUQU_SPRITE_AB = not1(sprite_fetcher.VONU_SFETCH_S1_D4.qn16());
  /* p29.SYCU*/ wire _SYCU_SFETCH_S0pe = nor3(_TYTU_SFETCH_S0n, LOBY_RENDERINGn, sprite_fetcher.TYFO_SFETCH_S0_D1.qp17());
  /*#p29.RACA*/ wire RACA_LATCH_SPPIXB = and2(sprite_fetcher.VONU_SFETCH_S1_D4.qp17(), _SYCU_SFETCH_S0pe);
  /*#p29.TOPU*/ wire TOPU_LATCH_SPPIXA = and2(sprite_fetcher.TULY_SFETCH_S1.qp17(), _SYCU_SFETCH_S0pe);
  ...
  /*p01.AFUR*/ clk_reg.AFUR_xxxxEFGH.dff9(!ATAL_xBxDxFxH, UPOJ_MODE_PRODn, clk_reg.ADYK_ABCxxxxH.qp09());
  /*p01.ALEF*/ clk_reg.ALEF_AxxxxFGH.dff9( ATAL_xBxDxFxH, UPOJ_MODE_PRODn, clk_reg.AFUR_xxxxEFGH.qn08());
  /*p01.APUK*/ clk_reg.APUK_ABxxxxGH.dff9(!ATAL_xBxDxFxH, UPOJ_MODE_PRODn, clk_reg.ALEF_AxxxxFGH.qn08());
  /*p01.ADYK*/ clk_reg.ADYK_ABCxxxxH.dff9( ATAL_xBxDxFxH, UPOJ_MODE_PRODn, clk_reg.APUK_ABxxxxGH.qn08());

  cpu_bus.PIN_CPU_EXT_CLKGOOD.set(CLKGOOD);

  cpu_bus.PIN_CPU_BOWA_Axxxxxxx.set(BOWA_xBCDEFGH);
  cpu_bus.PIN_CPU_BEDO_xBCDEFGH.set(BEDO_Axxxxxxx);

  cpu_bus.PIN_CPU_BEKO_ABCDxxxx.set(BEKO_ABCDxxxx);
  cpu_bus.PIN_CPU_BUDE_xxxxEFGH.set(BUDE_xxxxEFGH);

  cpu_bus.PIN_CPU_BOLO_ABCDEFxx.set(BOLO_ABCDEFxx);
  cpu_bus.PIN_CPU_BUKE_AxxxxxGH.set(BUKE_AxxxxxGH);

  cpu_bus.PIN_CPU_BOMA_xBCDEFGH.set(BOMA_xBCDEFGH);
  cpu_bus.PIN_CPU_BOGA_Axxxxxxx.set(BOGA_Axxxxxxx);

  ext_bus.PIN_EXT_CLK.io_pin(BUDE_xxxxEFGH, BUDE_xxxxEFGH);
  ...
  /* p01.AFER*/ clk_reg.AFER_SYS_RSTp.dff13(BOGA_Axxxxxxx, UPOJ_MODE_PRODn, clk_reg.ASOL_POR_DONEn.qp04());
  ...
  /*p29.WUVU*/ clk_reg.WUVU_ABxxEFxx.dff17(_XOTA_AxCxExGx,               XAPO_VID_RSTn, clk_reg.WUVU_ABxxEFxx.qn16());
  /*p21.VENA*/ clk_reg.VENA_xxCDEFxx.dff17(clk_reg.WUVU_ABxxEFxx.qn16(), XAPO_VID_RSTn, clk_reg.VENA_xxCDEFxx.qn16()); // inverting the clock to this reg doesn't seem to break anything, which is really weird
  /*p29.WOSU*/ clk_reg.WOSU_AxxDExxH.dff17(_XYFY_xBxDxFxH,               XAPO_VID_RSTn, clk_reg.WUVU_ABxxEFxx.qn16());
  ...
  // FF04 DIV
  {
    ...
    /*p01.UFOL*/ wire _UFOL_DIV_RSTn = nor3(UCOB_CLKBADp, RST, _TAPE_FF04_WRp);

    /* p01.UKUP*/ tim_reg.UKUP_DIV_00.dff17(BOGA_Axxxxxxx,      _UFOL_DIV_RSTn, tim_reg.UKUP_DIV_00.qn16());
  ...
  // FF05 TIMA
  {
    ...
    /*#p03.UKAP*/ wire _UKAP_CLK_MUXa = mux2n(tim_reg.SOPU_TAC_D0.qp17(), UVYN_DIV_05n, _UVYR_DIV_03n);
    /*#p03.TEKO*/ wire _TEKO_CLK_MUXb = mux2n(tim_reg.SOPU_TAC_D0.qp17(), _UBOT_DIV_01n, UREK_DIV_07n);
    ...
    /* p03.MULO*/ wire _MULO_SYS_RSTn = not1(ALUR_SYS_RSTn);
    ...
    /*#p03.NYDU*/ tim_reg.NYDU_TIMA_D7_DELAY.dff17(BOGA_Axxxxxxx, _MUGY_TIMA_MAX_RSTn, tim_reg.NUGA_TIMA_D7.qp01());

    /*#p03.MERY*/ wire _MERY_TIMER_OVERFLOWp = nor2(tim_reg.NUGA_TIMA_D7.qp01(), tim_reg.NYDU_TIMA_D7_DELAY.qn16());
    /*#p03.MOBA*/ tim_reg.MOBA_TIMER_OVERFLOWp.dff17(BOGA_Axxxxxxx, ALUR_SYS_RSTn, _MERY_TIMER_OVERFLOWp);
  }
  ...
  // FF06 TMA
  {
    ...
    /*p03.SABU*/ tim_reg.SABU_TMA_D0.dff17(_TYJU_FF06_WRn, ALUR_SYS_RSTn, cpu_bus.BUS_CPU_D0p.qp());
    /*p03.NYKE*/ tim_reg.NYKE_TMA_D1.dff17(_TYJU_FF06_WRn, ALUR_SYS_RSTn, cpu_bus.BUS_CPU_D1p.qp());
    /*p03.MURU*/ tim_reg.MURU_TMA_D2.dff17(_TYJU_FF06_WRn, ALUR_SYS_RSTn, cpu_bus.BUS_CPU_D2p.qp());
    /*p03.TYVA*/ tim_reg.TYVA_TMA_D3.dff17(_TYJU_FF06_WRn, ALUR_SYS_RSTn, cpu_bus.BUS_CPU_D3p.qp());
    /*p03.TYRU*/ tim_reg.TYRU_TMA_D4.dff17(_TYJU_FF06_WRn, ALUR_SYS_RSTn, cpu_bus.BUS_CPU_D4p.qp());
    /*p03.SUFY*/ tim_reg.SUFY_TMA_D5.dff17(_TYJU_FF06_WRn, ALUR_SYS_RSTn, cpu_bus.BUS_CPU_D5p.qp());
    /*p03.PETO*/ tim_reg.PETO_TMA_D6.dff17(_TYJU_FF06_WRn, ALUR_SYS_RSTn, cpu_bus.BUS_CPU_D6p.qp());
    /*p03.SETA*/ tim_reg.SETA_TMA_D7.dff17(_TYJU_FF06_WRn, ALUR_SYS_RSTn, cpu_bus.BUS_CPU_D7p.qp());
  ...
  // FF07 TAC
  {
    ...
    /*p03.SOPU*/ tim_reg.SOPU_TAC_D0.dff17(_SARA_FF07_WRn, ALUR_SYS_RSTn, cpu_bus.BUS_CPU_D0p.qp());
    /*p03.SAMY*/ tim_reg.SAMY_TAC_D1.dff17(_SARA_FF07_WRn, ALUR_SYS_RSTn, cpu_bus.BUS_CPU_D1p.qp());
    /*p03.SABO*/ tim_reg.SABO_TAC_D2.dff17(_SARA_FF07_WRn, ALUR_SYS_RSTn, cpu_bus.BUS_CPU_D2p.qp());
  ...
  // FF50 - disable bootrom bit
  {
    ...
    /*p07.TEPU*/ bootrom.BOOT_BITn.dff17(_TUGE_FF50_WRn, ALUR_SYS_RSTn, _SATO_BOOT_BIT_IN);
  }
  ...
  /*#p04.LOKO*/ wire _LOKO_DMA_RSTp = nand2(dma_reg.LENE_DMA_TRIG_d4.qn16(), CUNU_SYS_RSTn);
...

  {
    ...
    /*#p04.LUVY*/ dma_reg.LUVY_DMA_TRIG_d0  .dff17(UVYT_ABCDxxxx, CUNU_SYS_RSTn, _LUPA_DMA_TRIG);
    /*#p04.LENE*/ dma_reg.LENE_DMA_TRIG_d4  .dff17(MOPA_xxxxEFGH, CUNU_SYS_RSTn, dma_reg.LUVY_DMA_TRIG_d0.qp17());

    /*#p04.LOKY*/ dma_reg.LOKY_DMA_LATCHp.nand_latch(dma_reg.LENE_DMA_TRIG_d4.qn16(), and2(dma_reg.MYTE_DMA_DONE.qn16(), CUNU_SYS_RSTn));
    /*#p04.MATU*/ dma_reg.MATU_DMA_RUNNINGp .dff17(UVYT_ABCDxxxx, CUNU_SYS_RSTn, dma_reg.LOKY_DMA_LATCHp.qp03());
  }

  {
    ...
    /*#p04.MYTE*/ dma_reg.MYTE_DMA_DONE.dff17(MOPA_xxxxEFGH, _LAPA_DMA_RSTn, _NOLO_DMA_DONEp);
  }

  {
    /*#p04.META*/ wire _META_DMA_CLKp = and2(UVYT_ABCDxxxx, dma_reg.LOKY_DMA_LATCHp.qp03());
  ...
  /*p06.CULY*/ ser_reg.CULY_XFER_DIR  .dff17(_UWAM_FF02_WRn, ALUR_SYS_RSTn, cpu_bus.BUS_CPU_D0p.qp());
  ...
  /*p06.COTY*/ ser_reg.COTY_SER_CLK.dff17(UVYN_DIV_05n, _UWAM_FF02_WRn, ser_reg.COTY_SER_CLK.qn16());
  ...
  /* p06.CARO*/ wire _CARO_SER_RST = and2(_UWAM_FF02_WRn, ALUR_SYS_RSTn);
  ...
  /* p06.COHY*/ wire _COHY_SER_DATA0_RSTn = or_and3(_URYS_FF01_WRn, cpu_bus.BUS_CPU_D0p.qp(), ALUR_SYS_RSTn);
  /* p06.DUMO*/ wire _DUMO_SER_DATA1_RSTn = or_and3(_URYS_FF01_WRn, cpu_bus.BUS_CPU_D1p.qp(), ALUR_SYS_RSTn);
  /* p06.DYBO*/ wire _DYBO_SER_DATA2_RSTn = or_and3(_URYS_FF01_WRn, cpu_bus.BUS_CPU_D2p.qp(), ALUR_SYS_RSTn);
  /* p06.DAJU*/ wire _DAJU_SER_DATA3_RSTn = or_and3(_URYS_FF01_WRn, cpu_bus.BUS_CPU_D3p.qp(), ALUR_SYS_RSTn);
  /* p06.DYLY*/ wire _DYLY_SER_DATA4_RSTn = or_and3(_URYS_FF01_WRn, cpu_bus.BUS_CPU_D4p.qp(), ALUR_SYS_RSTn);
  /* p06.EHUJ*/ wire _EHUJ_SER_DATA5_RSTn = or_and3(_URYS_FF01_WRn, cpu_bus.BUS_CPU_D5p.qp(), ALUR_SYS_RSTn);
  /* p06.EFAK*/ wire _EFAK_SER_DATA6_RSTn = or_and3(_URYS_FF01_WRn, cpu_bus.BUS_CPU_D6p.qp(), ALUR_SYS_RSTn);
  /* p06.EGUV*/ wire _EGUV_SER_DATA7_RSTn = or_and3(_URYS_FF01_WRn, cpu_bus.BUS_CPU_D7p.qp(), ALUR_SYS_RSTn);
  ...
  /* p06.ELYS*/ ser_reg.ELYS_SER_OUT  .dff17(_EDYL_SER_CLK, ALUR_SYS_RSTn, ser_reg.EDER_SER_DATA7.qp16());
  ...
  {
    /*p02.AWOB*/ joypad.AWOB_WAKE_CPU.tp_latch(BOGA_Axxxxxxx, _KERY_ANY_BUTTONp);
    joypad.PIN_CPU_WAKE.set(joypad.AWOB_WAKE_CPU.qp08());
  }

  {
    /*p02.BATU*/ joypad.BATU_JP_GLITCH0.dff17(BOGA_Axxxxxxx, ALUR_SYS_RSTn, _KERY_ANY_BUTTONp);
    /*p02.ACEF*/ joypad.ACEF_JP_GLITCH1.dff17(BOGA_Axxxxxxx, ALUR_SYS_RSTn, joypad.BATU_JP_GLITCH0.qp17());
    /*p02.AGEM*/ joypad.AGEM_JP_GLITCH2.dff17(BOGA_Axxxxxxx, ALUR_SYS_RSTn, joypad.ACEF_JP_GLITCH1.qp17());
    /*p02.APUG*/ joypad.APUG_JP_GLITCH3.dff17(BOGA_Axxxxxxx, ALUR_SYS_RSTn, joypad.AGEM_JP_GLITCH2.qp17());
  }

  {
    /*p10.ATOZ*/ wire _ATOZ_FF00_WRn = nand4(TAPU_CPU_WRp_xxxxEFGx, _ANAP_FF_0xx00000, _AKUG_A06n, _BYKO_A05n);
    /*p05.JUTE*/ joypad.JUTE_JOYP_RA    .dff17(_ATOZ_FF00_WRn, ALUR_SYS_RSTn, cpu_bus.BUS_CPU_D0p.qp());
    /*p05.KECY*/ joypad.KECY_JOYP_LB    .dff17(_ATOZ_FF00_WRn, ALUR_SYS_RSTn, cpu_bus.BUS_CPU_D1p.qp());
    /*p05.JALE*/ joypad.JALE_JOYP_UC    .dff17(_ATOZ_FF00_WRn, ALUR_SYS_RSTn, cpu_bus.BUS_CPU_D2p.qp());
    /*p05.KYME*/ joypad.KYME_JOYP_DS    .dff17(_ATOZ_FF00_WRn, ALUR_SYS_RSTn, cpu_bus.BUS_CPU_D3p.qp());
    /*p05.KELY*/ joypad.KELY_JOYP_UDLR  .dff17(_ATOZ_FF00_WRn, ALUR_SYS_RSTn, cpu_bus.BUS_CPU_D4p.qp());
    /*p05.COFY*/ joypad.COFY_JOYP_ABCS  .dff17(_ATOZ_FF00_WRn, ALUR_SYS_RSTn, cpu_bus.BUS_CPU_D5p.qp());
    /*p05.KUKO*/ joypad.KUKO_DBG_FF00_D6.dff17(_ATOZ_FF00_WRn, ALUR_SYS_RSTn, cpu_bus.BUS_CPU_D6p.qp());
    /*p05.KERU*/ joypad.KERU_DBG_FF00_D7.dff17(_ATOZ_FF00_WRn, ALUR_SYS_RSTn, cpu_bus.BUS_CPU_D7p.qp());
  ...
  {
    /*#p30.CYKE*/ wire _CYKE_ABxxEFxx = not1(XUPY_ABxxEFxx);
  ...
  /* p01.LYHA*/ wire _LYHA_VID_RSTp = not1(XAPO_VID_RSTn);

  /*#p28.AWOH*/ wire _AWOH_xxCDxxGH = not1(XUPY_ABxxEFxx);
  /*#p21.SONO*/ wire _SONO_ABxxxxGH = not1(TALU_xxCDEFxx);
...

  {
    ...
    /*#p21.SAXO*/ lcd_reg.SAXO_X0p.dff17(TALU_xxCDEFxx,   _MUDE_X_RSTn, lcd_reg.SAXO_X0p.qn16());
...

  {
    ...
    /*#p24.USEC*/ wire _USEC_DIV_07p = not1(UREK_DIV_07n);
  ...
  // ly match
  {
    ...
    /*#p21.ROPO*/ lcd_reg.ROPO_LY_MATCH_SYNCp.dff17(TALU_xxCDEFxx, WESY_SYS_RSTn, _PALY_LY_MATCHa);
  }
  ...
  // FF45 LYC
  {
    ...
    /* p23.SYRY*/ lcd_reg.SYRY_LYC0n.dff9(_WANE_FF45_WRp, WESY_SYS_RSTn, cpu_bus.BUS_CPU_D0p.qp());
    /* p23.VUCE*/ lcd_reg.VUCE_LYC1n.dff9(_WANE_FF45_WRp, WESY_SYS_RSTn, cpu_bus.BUS_CPU_D1p.qp());
    /* p23.SEDY*/ lcd_reg.SEDY_LYC2n.dff9(_WANE_FF45_WRp, WESY_SYS_RSTn, cpu_bus.BUS_CPU_D2p.qp());
    /* p23.SALO*/ lcd_reg.SALO_LYC3n.dff9(_WANE_FF45_WRp, WESY_SYS_RSTn, cpu_bus.BUS_CPU_D3p.qp());
    /* p23.SOTA*/ lcd_reg.SOTA_LYC4n.dff9(_WANE_FF45_WRp, WESY_SYS_RSTn, cpu_bus.BUS_CPU_D4p.qp());
    /* p23.VAFA*/ lcd_reg.VAFA_LYC5n.dff9(_WANE_FF45_WRp, WESY_SYS_RSTn, cpu_bus.BUS_CPU_D5p.qp());
    /* p23.VEVO*/ lcd_reg.VEVO_LYC6n.dff9(_WANE_FF45_WRp, WESY_SYS_RSTn, cpu_bus.BUS_CPU_D6p.qp());
    /* p23.RAHA*/ lcd_reg.RAHA_LYC7n.dff9(_WANE_FF45_WRp, WESY_SYS_RSTn, cpu_bus.BUS_CPU_D7p.qp());
...

  {
    ...
    /*#p30.CUCU*/ sprite_store.SPR_TRI_L0.tri_6nn(FEPO_STORE_MATCHp, DEGE_SPRITE_DELTA0);
    /*#p30.CUCA*/ sprite_store.SPR_TRI_L1.tri_6nn(FEPO_STORE_MATCHp, DABY_SPRITE_DELTA1);
    /*#p30.CEGA*/ sprite_store.SPR_TRI_L2.tri_6nn(FEPO_STORE_MATCHp, DABU_SPRITE_DELTA2);
    /*#p30.WENU*/ sprite_store.SPR_TRI_L3.tri_6nn(FEPO_STORE_MATCHp, GYSA_SPRITE_DELTA3);
...

  {
    ...
    /*p29.EBOJ*/ sprite_store.EBOJ_STORE0_RSTp.dff17(WUTY_SPRITE_DONEp, _BYVA_VID_LINE_TRIGn, GUVA_SPRITE0_GETp);
    /*p29.CEDY*/ sprite_store.CEDY_STORE1_RSTp.dff17(WUTY_SPRITE_DONEp, _BYVA_VID_LINE_TRIGn, ENUT_SPRITE1_GETp);
    /*p29.EGAV*/ sprite_store.EGAV_STORE2_RSTp.dff17(WUTY_SPRITE_DONEp, _BYVA_VID_LINE_TRIGn, EMOL_SPRITE2_GETp);
    /*p29.GOTA*/ sprite_store.GOTA_STORE3_RSTp.dff17(WUTY_SPRITE_DONEp, _BYVA_VID_LINE_TRIGn, GYFY_SPRITE3_GETp);
    /*p29.XUDY*/ sprite_store.XUDY_STORE4_RSTp.dff17(WUTY_SPRITE_DONEp, _BYVA_VID_LINE_TRIGn, GONO_SPRITE4_GETp);
    /*p29.WAFY*/ sprite_store.WAFY_STORE5_RSTp.dff17(WUTY_SPRITE_DONEp, _BYVA_VID_LINE_TRIGn, GEGA_SPRITE5_GETp);
    /*p29.WOMY*/ sprite_store.WOMY_STORE6_RSTp.dff17(WUTY_SPRITE_DONEp, _BYVA_VID_LINE_TRIGn, XOJA_SPRITE6_GETp);
    /*p29.WAPO*/ sprite_store.WAPO_STORE7_RSTp.dff17(WUTY_SPRITE_DONEp, _BYVA_VID_LINE_TRIGn, GUTU_SPRITE7_GETp);
    /*p29.EXUQ*/ sprite_store.EXUQ_STORE8_RSTp.dff17(WUTY_SPRITE_DONEp, _BYVA_VID_LINE_TRIGn, FOXA_SPRITE8_GETp);
    /*p29.FONO*/ sprite_store.FONO_STORE9_RSTp.dff17(WUTY_SPRITE_DONEp, _BYVA_VID_LINE_TRIGn, GUZE_SPRITE9_GETp);
  ...
  /*#p01.WALU*/ wire _WALU_SYS_RSTn = not1(XORE_SYS_RSTp);
  /* p01.TOFU*/ wire _TOFU_VID_RSTp = not1(XAPO_VID_RSTn);
  /* p01.PYRY*/ wire _PYRY_VID_RSTp = not1(XAPO_VID_RSTn);

  /*#p27.MEHE*/ wire _MEHE_AxCxExGx = not1(ALET_xBxDxFxH);

  /*#p24.SOCY*/ wire _SOCY_WIN_HITn = not1(TOMU_WIN_HITp);

  /*#p24.VYBO*/ wire _VYBO_CLKPIPEp = nor3(FEPO_STORE_MATCHp, WODU_HBLANKp, MYVO_AxCxExGx);
  ...
  /*#p21.VOGA*/ pix_pipe.VOGA_HBLANKp.dff17(ALET_xBxDxFxH, _TADY_LINE_START_RSTn, WODU_HBLANKp);
...

  {
    ...
    /* p27.MOXE*/ wire _MOXE_AxCxExGx = not1(ALET_xBxDxFxH);
  ...
  /* p27.SARY*/ pix_pipe.SARY_WY_MATCH.dff17(TALU_xxCDEFxx, XAPO_VID_RSTn, _ROGE_WY_MATCHp);
  ...
  /*p27.PYCO*/ pix_pipe.PYCO_WX_MATCH_A.dff17(_ROCO_CLKPIPEp, XAPO_VID_RSTn, _NUKO_WX_MATCHp);
  /*p27.NUNU*/ pix_pipe.NUNU_WX_MATCH_B.dff17(_MEHE_AxCxExGx, XAPO_VID_RSTn, pix_pipe.PYCO_WX_MATCH_A.qp17());
  ...
  /*p27.RENE*/ pix_pipe.RENE_FETCHn_B.dff17(ALET_xBxDxFxH, pix_pipe.XYMU_RENDERINGn.qn03(), pix_pipe.RYFA_FETCHn_A.qp17());
...

  {
    ...
    /* p27.NOPA*/ pix_pipe.NOPA_WIN_MODE_B.dff17(ALET_xBxDxFxH, XAPO_VID_RSTn, pix_pipe.PYNU_WIN_MODE_A.qp04());

    /* p27.PUKU*/ pix_pipe.PUKU = nor2(NUNY_WX_MATCH_TRIGp, pix_pipe.RYDY);
    /* p27.RYDY*/ pix_pipe.RYDY = nor3(pix_pipe.PUKU, tile_fetcher.PORY_FETCH_DONE_P12.qp17(), _PYRY_VID_RSTp);

    /* p27.SOVY*/ pix_pipe.SOVY_WIN_FIRST_TILE_B.dff17(ALET_xBxDxFxH, XAPO_VID_RSTn, pix_pipe.RYDY);
  }
  ...
  {
    /*p27.VETU*/ wire _VETU_WIN_MAP_CLK = and2(TEVO_FETCH_TRIGp, PORE_WIN_MODEp);
  ...
  // Window y coordinate
  {
    /*p27.WAZY*/ wire _WAZY_WIN_Y_CLKp = not1(PORE_WIN_MODEp);
...

  {
    ...
    /*p32.LOZE*/ wire _LOZE_PIPE_A_LOADp = not1(NYXU_FETCH_TRIGn);
...

  {
    ...
    /*p32.LUXA*/ wire LUXA_PIPE_B_LOADp = not1(NYXU_FETCH_TRIGn);
...

  {
    ...
    /*p21.ROXE*/ pix_pipe.ROXE_STAT_HBI_ENn.dff9(_RYVE_FF41_WRn, WESY_SYS_RSTn, cpu_bus.BUS_CPU_D3p.qp());
    /*p21.RUFO*/ pix_pipe.RUFO_STAT_VBI_ENn.dff9(_RYVE_FF41_WRn, WESY_SYS_RSTn, cpu_bus.BUS_CPU_D4p.qp());
    /*p21.REFE*/ pix_pipe.REFE_STAT_OAI_ENn.dff9(_RYVE_FF41_WRn, WESY_SYS_RSTn, cpu_bus.BUS_CPU_D5p.qp());
    ...
    */
    ...
    /*#p21.TEBY*/ cpu_bus.BUS_CPU_D0p.tri_6pn(_TOBE_FF41_RDp, SADU_STAT_MODE0n);
    /*#p21.WUGA*/ cpu_bus.BUS_CPU_D1p.tri_6pn(_TOBE_FF41_RDp, XATY_STAT_MODE1n);
  ...
  // FF42 SCY
  {
    ...
    /*p23.GAVE*/ pix_pipe.GAVE_SCY0n.dff9(CAVO_FF42_WRn, CUNU_SYS_RSTn, cpu_bus.BUS_CPU_D0p.qp());
    /*p23.FYMO*/ pix_pipe.FYMO_SCY1n.dff9(CAVO_FF42_WRn, CUNU_SYS_RSTn, cpu_bus.BUS_CPU_D1p.qp());
    /*p23.FEZU*/ pix_pipe.FEZU_SCY2n.dff9(CAVO_FF42_WRn, CUNU_SYS_RSTn, cpu_bus.BUS_CPU_D2p.qp());
    /*p23.FUJO*/ pix_pipe.FUJO_SCY3n.dff9(CAVO_FF42_WRn, CUNU_SYS_RSTn, cpu_bus.BUS_CPU_D3p.qp());
    /*p23.DEDE*/ pix_pipe.DEDE_SCY4n.dff9(CAVO_FF42_WRn, CUNU_SYS_RSTn, cpu_bus.BUS_CPU_D4p.qp());
    /*p23.FOTY*/ pix_pipe.FOTY_SCY5n.dff9(CAVO_FF42_WRn, CUNU_SYS_RSTn, cpu_bus.BUS_CPU_D5p.qp());
    /*p23.FOHA*/ pix_pipe.FOHA_SCY6n.dff9(CAVO_FF42_WRn, CUNU_SYS_RSTn, cpu_bus.BUS_CPU_D6p.qp());
    /*p23.FUNY*/ pix_pipe.FUNY_SCY7n.dff9(CAVO_FF42_WRn, CUNU_SYS_RSTn, cpu_bus.BUS_CPU_D7p.qp());
  ...
  // FF43 SCX
  {
    ...
    /*p23.DATY*/ pix_pipe.DATY_SCX0n.dff9(AMUN_FF43_WRn, CUNU_SYS_RSTn, cpu_bus.BUS_CPU_D0p.qp());
    /*p23.DUZU*/ pix_pipe.DUZU_SCX1n.dff9(AMUN_FF43_WRn, CUNU_SYS_RSTn, cpu_bus.BUS_CPU_D1p.qp());
    /*p23.CYXU*/ pix_pipe.CYXU_SCX2n.dff9(AMUN_FF43_WRn, CUNU_SYS_RSTn, cpu_bus.BUS_CPU_D2p.qp());
    /*p23.GUBO*/ pix_pipe.GUBO_SCX3n.dff9(AMUN_FF43_WRn, CUNU_SYS_RSTn, cpu_bus.BUS_CPU_D3p.qp());
    /*p23.BEMY*/ pix_pipe.BEMY_SCX4n.dff9(AMUN_FF43_WRn, CUNU_SYS_RSTn, cpu_bus.BUS_CPU_D4p.qp());
    /*p23.CUZY*/ pix_pipe.CUZY_SCX5n.dff9(AMUN_FF43_WRn, CUNU_SYS_RSTn, cpu_bus.BUS_CPU_D5p.qp());
    /*p23.CABU*/ pix_pipe.CABU_SCX6n.dff9(AMUN_FF43_WRn, CUNU_SYS_RSTn, cpu_bus.BUS_CPU_D6p.qp());
    /*p23.BAKE*/ pix_pipe.BAKE_SCX7n.dff9(AMUN_FF43_WRn, CUNU_SYS_RSTn, cpu_bus.BUS_CPU_D7p.qp());
  ...
  /* p01.ROSY*/ wire _ROSY_VID_RSTp = not1(XAPO_VID_RSTn);
  /* p01.LAPE*/ wire _LAPE_AxCxExGx = not1(ALET_xBxDxFxH);
  /* p27.TAVA*/ wire _TAVA_xBxDxFxH = not1(_LAPE_AxCxExGx);

  //----------------------------------------

  /* p27.TUKU*/ wire _TUKU_WIN_HITn = not1(TOMU_WIN_HITp);

  /* p27.SOWO*/ wire _SOWO_SFETCH_RUNNINGn = not1(sprite_fetcher.TAKA_SFETCH_RUNNINGp.qp03());

  /* p27.TEKY*/ wire _TEKY_SFETCH_REQp = and4(FEPO_STORE_MATCHp, _TUKU_WIN_HITn, LYRY_BFETCH_DONEp, _SOWO_SFETCH_RUNNINGn);
  ...
  /* p27.VEKU*/ wire _VEKU_SFETCH_RUNNING_RSTn = nor2(WUTY_SPRITE_DONEp, TAVE_PRELOAD_DONE_TRIGp); // def nor
  ...
  /*p27.LAXU*/ tile_fetcher.LAXU_BFETCH_S0   .dff17(_LEBO_AxCxExGx,                             NYXU_FETCH_TRIGn,       tile_fetcher.LAXU_BFETCH_S0.qn16());
  /*p27.MESU*/ tile_fetcher.MESU_BFETCH_S1   .dff17(tile_fetcher.LAXU_BFETCH_S0.qn16(),     NYXU_FETCH_TRIGn,       tile_fetcher.MESU_BFETCH_S1.qn16());
  /*p27.NYVA*/ tile_fetcher.NYVA_BFETCH_S2   .dff17(tile_fetcher.MESU_BFETCH_S1.qn16(),     NYXU_FETCH_TRIGn,       tile_fetcher.NYVA_BFETCH_S2.qn16());
  /*p27.LYZU*/ tile_fetcher.LYZU_BFETCH_S0_D1.dff17(ALET_xBxDxFxH,                  pix_pipe.XYMU_RENDERINGn.qn03(), tile_fetcher.LAXU_BFETCH_S0.qp17());

  /*p24.NAFY*/ wire _NAFY_RENDERING_AND_NOT_WIN_TRIG = nor2(MOSU_WIN_FETCH_TRIGp, LOBY_RENDERINGn);

  /*p24.NYKA*/ tile_fetcher.NYKA_FETCH_DONE_P11.dff17(ALET_xBxDxFxH, _NAFY_RENDERING_AND_NOT_WIN_TRIG,      LYRY_BFETCH_DONEp);
  /*p24.PORY*/ tile_fetcher.PORY_FETCH_DONE_P12.dff17(MYVO_AxCxExGx, _NAFY_RENDERING_AND_NOT_WIN_TRIG,      tile_fetcher.NYKA_FETCH_DONE_P11.qp17());
  /*p24.PYGO*/ tile_fetcher.PYGO_FETCH_DONE_P13.dff17(ALET_xBxDxFxH, pix_pipe.XYMU_RENDERINGn.qn03(),   tile_fetcher.PORY_FETCH_DONE_P12.qp17());

  /*p24.POKY*/ tile_fetcher.POKY_PRELOAD_LATCHp.nor_latch(tile_fetcher.PYGO_FETCH_DONE_P13.qp17(), LOBY_RENDERINGn);

  /*p27.LOVY*/ tile_fetcher.LOVY_BG_FETCH_DONEp  .dff17(MYVO_AxCxExGx, NYXU_FETCH_TRIGn,     LYRY_BFETCH_DONEp);
  /*p27.LURY*/ wire _LURY_BG_FETCH_DONEn = and2(tile_fetcher.LOVY_BG_FETCH_DONEp.qn16(), pix_pipe.XYMU_RENDERINGn.qn03());
  /*p27.LONY*/ tile_fetcher.LONY_BG_FETCH_RUNNINGp.nand_latch(NYXU_FETCH_TRIGn, _LURY_BG_FETCH_DONEn);
  ...
  /*#p02.LYTA*/ wire _LYTA_FF0F_RST0n = and3(_MUXE_INT0_WRn, _LETY_INT_VBL_ACKn,  ALUR_SYS_RSTn);
  /* p02.MOVU*/ wire _MOVU_FF0F_RST1n = and3(_NABE_INT1_WRn, _LEJA_INT_STAT_ACKn, ALUR_SYS_RSTn);
  /* p02.PYGA*/ wire _PYGA_FF0F_RST2n = and3(_RAKE_INT2_WRn, _LESA_INT_TIM_ACKn,  ALUR_SYS_RSTn);
  ...
  /* p02.LALU*/ int_reg.LALU_FF0F_D1p.dff22(VOTY_INT_STATp,                      _MODY_FF0F_SET1n, _MOVU_FF0F_RST1n, _PESU_VCC);
  ...
  /* p02.ULAK*/ int_reg.ULAK_FF0F_D4p.dff22(ASOK_INT_JOYp,                       _TOGA_FF0F_SET4n, _TYME_FF0F_RST4n, _PESU_VCC);
...

  {
    ...
    /*p08.TYHO*/ wire _TYHO_PIN_EXT_CS_A_xxCDEFGH = mux2p(LUMA_DMA_CARTp, dma_reg.MARU_DMA_A15n.qn07(), _TOZA_PIN_EXT_CS_A_xxCDEFGH);
  ...
  // DMA address / CPU address latch -> ext addr pins
  {
    ...
    /* p08.AMET*/ wire _AMET_A00p = mux2p(LUMA_DMA_CARTp, dma_reg.NAKY_DMA_A00p.qp17(), ext_bus.ALOR_EXT_ADDR_LATCH_00p.qp08());
    /* p08.ATOL*/ wire _ATOL_A01p = mux2p(LUMA_DMA_CARTp, dma_reg.PYRO_DMA_A01p.qp17(), ext_bus.APUR_EXT_ADDR_LATCH_01p.qp08());
    /* p08.APOK*/ wire _APOK_A02p = mux2p(LUMA_DMA_CARTp, dma_reg.NEFY_DMA_A02p.qp17(), ext_bus.ALYR_EXT_ADDR_LATCH_02p.qp08());
    /* p08.AMER*/ wire _AMER_A03p = mux2p(LUMA_DMA_CARTp, dma_reg.MUTY_DMA_A03p.qp17(), ext_bus.ARET_EXT_ADDR_LATCH_03p.qp08());
    /* p08.ATEM*/ wire _ATEM_A04p = mux2p(LUMA_DMA_CARTp, dma_reg.NYKO_DMA_A04p.qp17(), ext_bus.AVYS_EXT_ADDR_LATCH_04p.qp08());
    /* p08.ATOV*/ wire _ATOV_A05p = mux2p(LUMA_DMA_CARTp, dma_reg.PYLO_DMA_A05p.qp17(), ext_bus.ATEV_EXT_ADDR_LATCH_05p.qp08());
    /* p08.ATYR*/ wire _ATYR_A06p = mux2p(LUMA_DMA_CARTp, dma_reg.NUTO_DMA_A06p.qp17(), ext_bus.AROS_EXT_ADDR_LATCH_06p.qp08());
    /*#p08.ASUR*/ wire _ASUR_A07p = mux2p(LUMA_DMA_CARTp, dma_reg.MUGU_DMA_A07p.qp17(), ext_bus.ARYM_EXT_ADDR_LATCH_07p.qp08());
    /*#p08.MANO*/ wire _MANO_A08p = mux2p(LUMA_DMA_CARTp, dma_reg.NAFA_DMA_A08n.qn07(), ext_bus.LUNO_EXT_ADDR_LATCH_08p.qp08());
    /* p08.MASU*/ wire _MASU_A09p = mux2p(LUMA_DMA_CARTp, dma_reg.PYNE_DMA_A09n.qn07(), ext_bus.LYSA_EXT_ADDR_LATCH_09p.qp08());
    /* p08.PAMY*/ wire _PAMY_A10p = mux2p(LUMA_DMA_CARTp, dma_reg.PARA_DMA_A10n.qn07(), ext_bus.PATE_EXT_ADDR_LATCH_10p.qp08());
    /* p08.MALE*/ wire _MALE_A11p = mux2p(LUMA_DMA_CARTp, dma_reg.NYDO_DMA_A11n.qn07(), ext_bus.LUMY_EXT_ADDR_LATCH_11p.qp08());
    /* p08.MOJY*/ wire _MOJY_A12p = mux2p(LUMA_DMA_CARTp, dma_reg.NYGY_DMA_A12n.qn07(), ext_bus.LOBU_EXT_ADDR_LATCH_12p.qp08());
    /* p08.MUCE*/ wire _MUCE_A13p = mux2p(LUMA_DMA_CARTp, dma_reg.PULA_DMA_A13n.qn07(), ext_bus.LONU_EXT_ADDR_LATCH_13p.qp08());
    /* p08.PEGE*/ wire _PEGE_A14p = mux2p(LUMA_DMA_CARTp, dma_reg.POKU_DMA_A14n.qn07(), ext_bus.NYRE_EXT_ADDR_LATCH_14p.qp08());
...

  {
    ...
    /* p08.TAZY*/ wire _TAZY_A15p = mux2p(LUMA_DMA_CARTp, dma_reg.MARU_DMA_A15n.qn07(), _SEPY_A15p_ABxxxxxx);
  ...
  /* p28.XYNY*/ wire _XYNY_ABCDxxxx = not1(MOPA_xxxxEFGH);
...

  {
    ...
    /*p04.MAKA*/ oam_bus.MAKA_HOLD_MEMp.dff17(ZEME_AxCxExGx, CUNU_SYS_RSTn, CATY_LATCH_EXTp);

    /*p04.NAXY*/ wire _NAXY_DMA_OAM_WRp = nor2(UVYT_ABCDxxxx, oam_bus.MAKA_HOLD_MEMp.qp17()); // def nor2
  ...
  /*#p25.XANE*/ wire _XANE_VRAM_LOCKn = nor2(LUFA_DMA_VRAMp, pix_pipe.XYMU_RENDERINGn.qn03());
...

  {
    ...
    /*p25.APAM*/ wire _APAM_DMA_VRAM_RDn = not1(LUFA_DMA_VRAMp);
  ...
  {
    /*#p25.SUTU*/ wire _SUTU_MCSn = nor4(LENA_BGW_VRM_RDp,
                                         LUFA_DMA_VRAMp,
                                         TEXY_SPR_READ_VRAMp,
                                         _SERE_CPU_VRM_RDp);
  ...
  {
    /* p04.AHOC*/ wire _AHOC_DMA_VRAM_RDn = not1(LUFA_DMA_VRAMp);
  ...
  // Sprite fetcher read
  {
    ...
    /* p29.ABEM*/ vram_bus.BUS_VRAM_A00n.tri_6nn(ABON_SPR_VRM_RDn, XUQU_SPRITE_AB);
    /* p29.BAXE*/ vram_bus.BUS_VRAM_A01n.tri_6nn(ABON_SPR_VRM_RDn, _CYVU_L0);
    /* p29.ARAS*/ vram_bus.BUS_VRAM_A02n.tri_6nn(ABON_SPR_VRM_RDn, _BORE_L1);
    /* p29.AGAG*/ vram_bus.BUS_VRAM_A03n.tri_6nn(ABON_SPR_VRM_RDn, _BUVY_L2);
    /* p29.FAMU*/ vram_bus.BUS_VRAM_A04n.tri_6nn(ABON_SPR_VRM_RDn, _GEJY_L3);
    /*#p29.FUGY*/ vram_bus.BUS_VRAM_A05n.tri_6nn(ABON_SPR_VRM_RDn, oam_bus.XEGU_OAM_DA1p.qp08());
    /* p29.GAVO*/ vram_bus.BUS_VRAM_A06n.tri_6nn(ABON_SPR_VRM_RDn, oam_bus.YJEX_OAM_DA2p.qp08());
    /* p29.WYGA*/ vram_bus.BUS_VRAM_A07n.tri_6nn(ABON_SPR_VRM_RDn, oam_bus.XYJU_OAM_DA3p.qp08());
    /* p29.WUNE*/ vram_bus.BUS_VRAM_A08n.tri_6nn(ABON_SPR_VRM_RDn, oam_bus.YBOG_OAM_DA4p.qp08());
    /* p29.GOTU*/ vram_bus.BUS_VRAM_A09n.tri_6nn(ABON_SPR_VRM_RDn, oam_bus.WYSO_OAM_DA5p.qp08());
    /* p29.GEGU*/ vram_bus.BUS_VRAM_A10n.tri_6nn(ABON_SPR_VRM_RDn, oam_bus.XOTE_OAM_DA6p.qp08());
    /* p29.XEHE*/ vram_bus.BUS_VRAM_A11n.tri_6nn(ABON_SPR_VRM_RDn, oam_bus.YZAB_OAM_DA7p.qp08());
    /* p29.DYSO*/ vram_bus.BUS_VRAM_A12n.tri_6nn(ABON_SPR_VRM_RDn, 0);   // sprites always in low half of tile store
  }
...
#pragma warning(pop)
    ...
    // Background map read
    {
      /* p26.AXEP*/ vram_bus.BUS_VRAM_A00n.tri_6nn(BAFY_BG_MAP_READn, _BABE_MAP_X0S);
      /* p26.AFEB*/ vram_bus.BUS_VRAM_A01n.tri_6nn(BAFY_BG_MAP_READn, _ABOD_MAP_X1S);
      /* p26.ALEL*/ vram_bus.BUS_VRAM_A02n.tri_6nn(BAFY_BG_MAP_READn, _BEWY_MAP_X2S);
      /* p26.COLY*/ vram_bus.BUS_VRAM_A03n.tri_6nn(BAFY_BG_MAP_READn, _BYCA_MAP_X3S);
      /* p26.AJAN*/ vram_bus.BUS_VRAM_A04n.tri_6nn(BAFY_BG_MAP_READn, _ACUL_MAP_X4S);
      /* p26.DUHO*/ vram_bus.BUS_VRAM_A05n.tri_6nn(BAFY_BG_MAP_READn, _ETAM_MAP_Y0S);
      /* p26.CASE*/ vram_bus.BUS_VRAM_A06n.tri_6nn(BAFY_BG_MAP_READn, _DOTO_MAP_Y1S);
      /* p26.CYPO*/ vram_bus.BUS_VRAM_A07n.tri_6nn(BAFY_BG_MAP_READn, _DABA_MAP_Y2S);
      /* p26.CETA*/ vram_bus.BUS_VRAM_A08n.tri_6nn(BAFY_BG_MAP_READn, _EFYK_MAP_Y3S);
      /* p26.DAFE*/ vram_bus.BUS_VRAM_A09n.tri_6nn(BAFY_BG_MAP_READn, _EJOK_MAP_Y4S);
      /*#p26.AMUV*/ vram_bus.BUS_VRAM_A10n.tri_6nn(BAFY_BG_MAP_READn, pix_pipe.XAFO_LCDC_BGMAPn.qn08());
      /* p26.COVE*/ vram_bus.BUS_VRAM_A11n.tri_6nn(BAFY_BG_MAP_READn, 1);
      /* p26.COXO*/ vram_bus.BUS_VRAM_A12n.tri_6nn(BAFY_BG_MAP_READn, 1);
    }

    // Window map read
    {
      /*#p27.XEJA*/ vram_bus.BUS_VRAM_A00n.tri_6nn(WUKO_WIN_MAP_READn, pix_pipe.WYKA_WIN_X3.qp17());
      /* p27.XAMO*/ vram_bus.BUS_VRAM_A01n.tri_6nn(WUKO_WIN_MAP_READn, pix_pipe.WODY_WIN_X4.qp17());
      /* p27.XAHE*/ vram_bus.BUS_VRAM_A02n.tri_6nn(WUKO_WIN_MAP_READn, pix_pipe.WOBO_WIN_X5.qp17());
      /* p27.XULO*/ vram_bus.BUS_VRAM_A03n.tri_6nn(WUKO_WIN_MAP_READn, pix_pipe.WYKO_WIN_X6.qp17());
      /* p27.WUJU*/ vram_bus.BUS_VRAM_A04n.tri_6nn(WUKO_WIN_MAP_READn, pix_pipe.XOLO_WIN_X7.qp17());
      /*#p27.VYTO*/ vram_bus.BUS_VRAM_A05n.tri_6nn(WUKO_WIN_MAP_READn, pix_pipe.TUFU_WIN_Y3.qp17());
      /* p27.VEHA*/ vram_bus.BUS_VRAM_A06n.tri_6nn(WUKO_WIN_MAP_READn, pix_pipe.TAXA_WIN_Y4.qp17());
      /* p27.VACE*/ vram_bus.BUS_VRAM_A07n.tri_6nn(WUKO_WIN_MAP_READn, pix_pipe.TOZO_WIN_Y5.qp17());
      /* p27.VOVO*/ vram_bus.BUS_VRAM_A08n.tri_6nn(WUKO_WIN_MAP_READn, pix_pipe.TATE_WIN_Y6.qp17());
      /* p27.VULO*/ vram_bus.BUS_VRAM_A09n.tri_6nn(WUKO_WIN_MAP_READn, pix_pipe.TEKE_WIN_Y7.qp17());
      /*#p27.VEVY*/ vram_bus.BUS_VRAM_A10n.tri_6nn(WUKO_WIN_MAP_READn, pix_pipe.WOKY_LCDC_WINMAPn.qn08());
      /* p27.VEZA*/ vram_bus.BUS_VRAM_A11n.tri_6nn(WUKO_WIN_MAP_READn, 1);
      /* p27.VOGU*/ vram_bus.BUS_VRAM_A12n.tri_6nn(WUKO_WIN_MAP_READn, 1);
    }

    // Background/window tile read
    {
      /*#p26.ASUM*/ vram_bus.BUS_VRAM_A00n.tri_6nn(BEJE_BG_TILE_READn,  XUHA_FETCH_S2p);
      /* p26.EVAD*/ vram_bus.BUS_VRAM_A01n.tri_6nn(BEJE_BG_TILE_READn,  _FAFO_TILE_Y0S);
      /* p26.DAHU*/ vram_bus.BUS_VRAM_A02n.tri_6nn(BEJE_BG_TILE_READn,  _EMUX_TILE_Y1S);
      /* p26.DODE*/ vram_bus.BUS_VRAM_A03n.tri_6nn(BEJE_BG_TILE_READn,  _ECAB_TILE_Y2S); // check outputs of ECAB

      /*#p25.XONU*/ vram_bus.BUS_VRAM_A00n.tri_6nn(XUCY_WIN_TILE_READn, XUHA_FETCH_S2p);
      /*#p25.WUDO*/ vram_bus.BUS_VRAM_A01n.tri_6nn(XUCY_WIN_TILE_READn, pix_pipe.VYNO_WIN_Y0.qp17());
      /*#p25.WAWE*/ vram_bus.BUS_VRAM_A02n.tri_6nn(XUCY_WIN_TILE_READn, pix_pipe.VUJO_WIN_Y1.qp17());
      /*#p25.WOLU*/ vram_bus.BUS_VRAM_A03n.tri_6nn(XUCY_WIN_TILE_READn, pix_pipe.VYMU_WIN_Y2.qp17());

      /*#p25.VUZA*/ wire _VUZA_TILE_BANKp = nor2(vram_bus.PYJU_TILE_DB7p.q11p(), pix_pipe.WEXU_LCDC_BGTILEn.qn08());

      /*#p25.VAPY*/ vram_bus.BUS_VRAM_A04n.tri_6pn(NETA_TILE_READp,     vram_bus.RAWU_TILE_DB0p.q11p());
      /*#p25.SEZU*/ vram_bus.BUS_VRAM_A05n.tri_6pn(NETA_TILE_READp,     vram_bus.POZO_TILE_DB1p.q11p());
      /*#p25.VEJY*/ vram_bus.BUS_VRAM_A06n.tri_6pn(NETA_TILE_READp,     vram_bus.PYZO_TILE_DB2p.q11p());
      /*#p25.RUSA*/ vram_bus.BUS_VRAM_A07n.tri_6pn(NETA_TILE_READp,     vram_bus.POXA_TILE_DB3p.q11p());
      /*#p25.ROHA*/ vram_bus.BUS_VRAM_A08n.tri_6pn(NETA_TILE_READp,     vram_bus.PULO_TILE_DB4p.q11p());
      /*#p25.RESO*/ vram_bus.BUS_VRAM_A09n.tri_6pn(NETA_TILE_READp,     vram_bus.POJU_TILE_DB5p.q11p());
      /*#p25.SUVO*/ vram_bus.BUS_VRAM_A10n.tri_6pn(NETA_TILE_READp,     vram_bus.POWY_TILE_DB6p.q11p());
      /*#p25.TOBO*/ vram_bus.BUS_VRAM_A11n.tri_6pn(NETA_TILE_READp,     vram_bus.PYJU_TILE_DB7p.q11p());
      /*#p25.VURY*/ vram_bus.BUS_VRAM_A12n.tri_6pn(NETA_TILE_READp,     _VUZA_TILE_BANKp);
    }
  }
  ...
  // VBD -> tile pix temp
  {
    /*#p32.LOMA*/ wire _LOMA_LATCH_TILE_DAn = not1(METE_LATCH_TILE_DAp);
    ...
    /*p??.LUVE*/ wire _LUVE_MATCH_TILE_DBp = not1(LESO_LATCH_TILE_DBn); // Schematic wrong, was labeled AJAR
  ...
  {
    /*#p29.XONO*/ wire _XONO_FLIP_X = and2(oam_bus.BAXO_OAM_DB5p.qp08(), TEXY_SPR_READ_VRAMp);
  ...
  tock_zram_bus(RST, zero_ram, TAPU_CPU_WRp_xxxxEFGx, TEDO_CPU_RDp);
