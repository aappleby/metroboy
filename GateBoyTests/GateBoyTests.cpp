...
int GateBoyTests::test_clk() {
  ...
  for (int i = 0; i < 32; i++) {
    ...
    EXPECT_CLK(top.clk.SIG_CPU_BOWA_Axxxxxxx,       0b10000000);
    EXPECT_CLK(top.clk.SIG_CPU_BEDO_xBCDEFGH,       0b01111111);
    EXPECT_CLK(top.clk.SIG_CPU_BEKO_ABCDxxxx,       0b11110000);
    EXPECT_CLK(top.clk.SIG_CPU_BUDE_xxxxEFGH,       0b00001111);
    EXPECT_CLK(top.clk.SIG_CPU_BOLO_ABCDEFxx,       0b11111100);
    EXPECT_CLK(top.clk.SIG_CPU_BUKE_AxxxxxGH,       0b10000011);
    EXPECT_CLK(top.clk.SIG_CPU_BOMA_xBCDEFGH,       0b01111111);
    EXPECT_CLK(top.clk.SIG_CPU_BOGA_Axxxxxxx,       0b10000000);
