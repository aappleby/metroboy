...
bool DieDB::parse_tag(DieCell& c, const std::string& tag_comment) {
...
bool DieDB::parse_cell_arg(DieCell& c, const std::string& arg) {
...
bool DieDB::parse_line(DieCell& c, const std::string& line) {
