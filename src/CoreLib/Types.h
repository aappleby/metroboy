...
#define DELTA_AB_OLD   (((sys.phase_total - 1) & 7) == 0)
#define DELTA_BC_OLD   (((sys.phase_total - 1) & 7) == 1)
#define DELTA_CD_OLD   (((sys.phase_total - 1) & 7) == 2)
#define DELTA_DE_OLD   (((sys.phase_total - 1) & 7) == 3)
#define DELTA_EF_OLD   (((sys.phase_total - 1) & 7) == 4)
#define DELTA_FG_OLD   (((sys.phase_total - 1) & 7) == 5)
#define DELTA_GH_OLD   (((sys.phase_total - 1) & 7) == 6)
#define DELTA_HA_OLD   (((sys.phase_total - 1) & 7) == 7)
