...
MemberOffset gb_offsets[] = {
  ...
  GEN_OFFSET(gb_state.SIG_VCC),
  GEN_OFFSET(gb_state.SIG_GND),
  GEN_OFFSET(gb_state.cpu_signals),
  GEN_OFFSET(gb_state.cpu_abus),
  GEN_OFFSET(gb_state.cpu_dbus),
  GEN_OFFSET(gb_state.vram_abus),
  GEN_OFFSET(gb_state.vram_dbus),
  GEN_OFFSET(gb_state.vram_ext_ctrl),
  GEN_OFFSET(gb_state.vram_ext_abus),
  GEN_OFFSET(gb_state.vram_ext_dbus),
  GEN_OFFSET(gb_state.sprite_ibus),
  GEN_OFFSET(gb_state.sprite_lbus),
  GEN_OFFSET(gb_state.oam_ctrl),
  GEN_OFFSET(gb_state.oam_abus),
  GEN_OFFSET(gb_state.oam_dbus_a),
  GEN_OFFSET(gb_state.oam_dbus_b),
  GEN_OFFSET(gb_state.oam_latch_a),
  GEN_OFFSET(gb_state.oam_latch_b),
  GEN_OFFSET(gb_state.oam_temp_a),
  GEN_OFFSET(gb_state.oam_temp_b),
  GEN_OFFSET(gb_state.ext_ctrl),
  GEN_OFFSET(gb_state.ext_abus.lo),
  GEN_OFFSET(gb_state.ext_abus.hi),
  GEN_OFFSET(gb_state.ext_dbus),
  GEN_OFFSET(gb_state.ext_data_latch),
  GEN_OFFSET(gb_state.ext_addr_latch),
  GEN_OFFSET(gb_state.ext_mbc),
  GEN_OFFSET(gb_state.zram_bus),
  GEN_OFFSET(gb_state.VOGA_HBLANKp),
  GEN_OFFSET(gb_state.XYMU_RENDERINGn),
  GEN_OFFSET(gb_state.sys_rst),
  GEN_OFFSET(gb_state.sys_clk),
  GEN_OFFSET(gb_state.reg_div),
  GEN_OFFSET(gb_state.reg_tima),
  GEN_OFFSET(gb_state.reg_tma),
  GEN_OFFSET(gb_state.reg_tac),
  GEN_OFFSET(gb_state.MATU_DMA_RUNNINGp),
  GEN_OFFSET(gb_state.dma_ctrl),
  GEN_OFFSET(gb_state.dma_lo),
  GEN_OFFSET(gb_state.reg_dma),
  GEN_OFFSET(gb_state.int_ctrl),
  GEN_OFFSET(gb_state.reg_if),
  GEN_OFFSET(gb_state.reg_ie),
  GEN_OFFSET(gb_state.int_latch),
  GEN_OFFSET(gb_state.cpu_int),
  GEN_OFFSET(gb_state.cpu_ack),
  GEN_OFFSET(gb_state.joy_int),
  GEN_OFFSET(gb_state.reg_joy),
  GEN_OFFSET(gb_state.joy_latch),
  GEN_OFFSET(gb_state.joy_ext),
  //GEN_OFFSET(serial),
  GEN_OFFSET(gb_state.store_i0),
  GEN_OFFSET(gb_state.store_i1),
  GEN_OFFSET(gb_state.store_i2),
  GEN_OFFSET(gb_state.store_i3),
  GEN_OFFSET(gb_state.store_i4),
  GEN_OFFSET(gb_state.store_i5),
  GEN_OFFSET(gb_state.store_i6),
  GEN_OFFSET(gb_state.store_i7),
  GEN_OFFSET(gb_state.store_i8),
  GEN_OFFSET(gb_state.store_i9),
  GEN_OFFSET(gb_state.store_l0),
  GEN_OFFSET(gb_state.store_l1),
  GEN_OFFSET(gb_state.store_l2),
  GEN_OFFSET(gb_state.store_l3),
  GEN_OFFSET(gb_state.store_l4),
  GEN_OFFSET(gb_state.store_l5),
  GEN_OFFSET(gb_state.store_l6),
  GEN_OFFSET(gb_state.store_l7),
  GEN_OFFSET(gb_state.store_l8),
  GEN_OFFSET(gb_state.store_l9),
  GEN_OFFSET(gb_state.store_x0),
  GEN_OFFSET(gb_state.store_x1),
  GEN_OFFSET(gb_state.store_x2),
  GEN_OFFSET(gb_state.store_x3),
  GEN_OFFSET(gb_state.store_x4),
  GEN_OFFSET(gb_state.store_x5),
  GEN_OFFSET(gb_state.store_x6),
  GEN_OFFSET(gb_state.store_x7),
  GEN_OFFSET(gb_state.store_x8),
  GEN_OFFSET(gb_state.store_x9),
  GEN_OFFSET(gb_state.sprite_counter),
  GEN_OFFSET(gb_state.FEPO_STORE_MATCHp),
  GEN_OFFSET(gb_state.sprite_match_flags),
  GEN_OFFSET(gb_state.sprite_reset_flags),
  GEN_OFFSET(gb_state.sprite_store_flags),
  GEN_OFFSET(gb_state.sprite_scanner),
  GEN_OFFSET(gb_state.scan_counter),
  GEN_OFFSET(gb_state.sprite_index),
  GEN_OFFSET(gb_state.sfetch_control),
  GEN_OFFSET(gb_state.sprite_pix_a),
  GEN_OFFSET(gb_state.sprite_pix_b),
  GEN_OFFSET(gb_state.tfetch_counter),
  GEN_OFFSET(gb_state.tfetch_control),
  GEN_OFFSET(gb_state.tile_temp_a),
  GEN_OFFSET(gb_state.tile_temp_b),
  GEN_OFFSET(gb_state.reg_lcdc),
  GEN_OFFSET(gb_state.reg_stat),
  GEN_OFFSET(gb_state.reg_scx),
  GEN_OFFSET(gb_state.reg_scy),
  GEN_OFFSET(gb_state.reg_wy),
  GEN_OFFSET(gb_state.reg_wx),
  GEN_OFFSET(gb_state.win_x.map),
  GEN_OFFSET(gb_state.win_y.tile),
  GEN_OFFSET(gb_state.win_y.map),
  GEN_OFFSET(gb_state.win_ctrl),
  GEN_OFFSET(gb_state.fine_count),
  GEN_OFFSET(gb_state.fine_scroll),
  GEN_OFFSET(gb_state.pix_count),
  GEN_OFFSET(gb_state.mask_pipe),
  GEN_OFFSET(gb_state.bgw_pipe_a),
  GEN_OFFSET(gb_state.bgw_pipe_b),
  GEN_OFFSET(gb_state.spr_pipe_a),
  GEN_OFFSET(gb_state.spr_pipe_b),
  GEN_OFFSET(gb_state.pal_pipe),
  GEN_OFFSET(gb_state.lcd.REMY_LD0n),
  GEN_OFFSET(gb_state.lcd.RAVO_LD1n),
  GEN_OFFSET(gb_state.lcd),
  GEN_OFFSET(gb_state.reg_lx),
  GEN_OFFSET(gb_state.reg_ly),
  GEN_OFFSET(gb_state.reg_lyc),
  GEN_OFFSET(gb_state.reg_bgp),
  GEN_OFFSET(gb_state.reg_obp0),
  GEN_OFFSET(gb_state.reg_obp1),
  GEN_OFFSET(gb_state.WODU_HBLANKp),
  GEN_OFFSET(gb_state.SATO_BOOT_BITn),
  GEN_OFFSET(gb_state.ATEJ_LINE_RSTp),
  GEN_OFFSET(gb_state.flipped_sprite),
...
void diff_gb(GateBoy* gba, GateBoy* gbb, uint8_t mask) {
  ...
  for (int i = 0; i < sizeof(uint64_t) + sizeof(GateBoyState); i++) {
