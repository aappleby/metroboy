...
void GateBoy::reset_to_bootrom(const blob& cart_blob, bool fastboot)
{
  ...
  gbs.cpu_abus_new.reset_to_bootrom();
  gbs.cpu_dbus_new.reset_to_bootrom();

  gbs.sprite_ibus.reset_to_bootrom();
  gbs.sprite_lbus.reset_to_bootrom();

  gbs.dma_hi.NAFA_DMA_A08n.state = 0b00011010;
  gbs.dma_hi.PYNE_DMA_A09n.state = 0b00011010;
  gbs.dma_hi.PARA_DMA_A10n.state = 0b00011010;
  gbs.dma_hi.NYDO_DMA_A11n.state = 0b00011010;
  gbs.dma_hi.NYGY_DMA_A12n.state = 0b00011010;
  gbs.dma_hi.PULA_DMA_A13n.state = 0b00011010;
  gbs.dma_hi.POKU_DMA_A14n.state = 0b00011010;
  gbs.dma_hi.MARU_DMA_A15n.state = 0b00011010;
  ...
  gbs.joy_int.reset_to_bootrom();
  gbs.joy_reg.reset_to_bootrom();
  ...
  CHECK_N(bit(gbs.clk.AFUR_xxxxEFGH.qp_old()));
  CHECK_P(bit(gbs.clk.ALEF_AxxxxFGH.qp_old()));
  CHECK_P(bit(gbs.clk.APUK_ABxxxxGH.qp_old()));
  CHECK_P(bit(gbs.clk.ADYK_ABCxxxxH.qp_old()));
...
;
  ...
  while(bit(~gbs.rst.SIG_CPU_STARTp.out_old())) {
  ...
  if (fastboot) {
    gbs.div.TERO_DIV03p.state = 0b00011010;
    gbs.div.UNYK_DIV04p.state = 0b00011010;
    gbs.div.UPOF_DIV15p.state = 0b00011011;
  }
...
void GateBoy::reset_to_cart(const blob& cart_blob) {
  ...
  gbs.VOGA_HBLANKp.state = 0b00011001;

  gbs.cpu_signals.reset_to_cart();
  gbs.cpu_abus_old.reset_to_cart_new();
  gbs.cpu_dbus_old.reset_to_cart_new();
  gbs.cpu_abus_new.reset_to_cart_new();
  gbs.cpu_dbus_new.reset_to_cart_new();

  gbs.vram_abus.reset_to_cart();
  gbs.vram_dbus.reset_to_cart();
  gbs.vram_ext_ctrl.reset_to_cart();
  gbs.vram_ext_abus.reset_to_cart();
  gbs.vram_ext_dbus.reset_to_cart();

  gbs.sprite_ibus.reset_to_cart();
  gbs.sprite_lbus.reset_to_cart();

  gbs.oam_ctrl.reset_to_cart();
  gbs.oam_abus.reset_to_cart();
  gbs.oam_dbus_a.reset_to_cart();
  gbs.oam_dbus_b.reset_to_cart();
  gbs.oam_latch_a.reset_to_cart();
  gbs.oam_latch_b.reset_to_cart();
  gbs.oam_temp_a.reset_to_cart();
  gbs.oam_temp_b.reset_to_cart();

  gbs.ext_ctrl.reset_to_cart();
  gbs.ext_abus.reset_to_cart();
  gbs.ext_dbus.reset_to_cart();
  gbs.ext_addr_latch.reset_to_cart();
  gbs.ext_data_latch.reset_to_cart();

  //zram_bus.reset_to_cart();



  gbs.rst.reset_to_cart();
  gbs.clk.reset_to_cart();
  gbs.div.reset_to_cart();
  
  //interrupts.reset_to_cart();
  gbs.reg_if.reset_to_cart();
  gbs.reg_ie.reset_to_cart();
  gbs.latch_if.reset_to_cart();
  gbs.cpu_int.reset_to_cart();
  gbs.cpu_ack.reset_to_cart();
  ...
  gbs.dma_lo.reset_to_cart();
  gbs.dma_hi.reset_to_cart();
  gbs.dma_ctrl.reset_to_cart();
  ...
  //joy.reset_to_cart();
  gbs.joy_int.reset_to_cart();
  gbs.joy_reg.reset_to_cart();
...
MemberOffset gb_offsets[] = {
  ...
  GEN_OFFSET(gbs.cpu_signals),
  GEN_OFFSET(gbs.cpu_abus_old),
  GEN_OFFSET(gbs.cpu_dbus_old),
  GEN_OFFSET(gbs.cpu_abus_new),
  GEN_OFFSET(gbs.cpu_dbus_new),
  GEN_OFFSET(gbs.vram_abus),
  GEN_OFFSET(gbs.vram_dbus),
  GEN_OFFSET(gbs.vram_ext_ctrl),
  GEN_OFFSET(gbs.vram_ext_abus),
  GEN_OFFSET(gbs.vram_ext_dbus),
  GEN_OFFSET(gbs.sprite_ibus),
  GEN_OFFSET(gbs.sprite_lbus),
  GEN_OFFSET(gbs.oam_ctrl),
  GEN_OFFSET(gbs.oam_abus),
  GEN_OFFSET(gbs.oam_dbus_a),
  GEN_OFFSET(gbs.oam_dbus_b),
  GEN_OFFSET(gbs.oam_latch_a),
  GEN_OFFSET(gbs.oam_latch_b),
  GEN_OFFSET(gbs.oam_temp_a),
  GEN_OFFSET(gbs.oam_temp_b),
  GEN_OFFSET(gbs.ext_ctrl),
  GEN_OFFSET(gbs.ext_abus),
  GEN_OFFSET(gbs.ext_dbus),
  GEN_OFFSET(gbs.ext_data_latch),
  GEN_OFFSET(gbs.ext_addr_latch),
  GEN_OFFSET(gbs.ext_mbc),
  GEN_OFFSET(gbs.zram_bus),
  GEN_OFFSET(gbs.VOGA_HBLANKp),
  GEN_OFFSET(gbs.XYMU_RENDERINGn),
  GEN_OFFSET(gbs.rst),
  GEN_OFFSET(gbs.clk),
  GEN_OFFSET(gbs.div),
  GEN_OFFSET(gbs.tima),
  GEN_OFFSET(gbs.tma),
  GEN_OFFSET(gbs.tac),
  GEN_OFFSET(gbs.dma_ctrl),
  GEN_OFFSET(gbs.dma_lo),
  GEN_OFFSET(gbs.dma_hi),
  GEN_OFFSET(gbs.int_ctrl),
  GEN_OFFSET(gbs.reg_if),
  GEN_OFFSET(gbs.reg_ie),
  GEN_OFFSET(gbs.latch_if),
  GEN_OFFSET(gbs.cpu_int),
  GEN_OFFSET(gbs.cpu_ack),
  GEN_OFFSET(gbs.joy_int),
  GEN_OFFSET(gbs.joy_reg),
  GEN_OFFSET(gbs.joy_latch),
  GEN_OFFSET(gbs.joy_ext),
  //GEN_OFFSET(serial),
  GEN_OFFSET(gbs.store_i0),
  GEN_OFFSET(gbs.store_i1),
  GEN_OFFSET(gbs.store_i2),
  GEN_OFFSET(gbs.store_i3),
  GEN_OFFSET(gbs.store_i4),
  GEN_OFFSET(gbs.store_i5),
  GEN_OFFSET(gbs.store_i6),
  GEN_OFFSET(gbs.store_i7),
  GEN_OFFSET(gbs.store_i8),
  GEN_OFFSET(gbs.store_i9),
  GEN_OFFSET(gbs.store_l0),
  GEN_OFFSET(gbs.store_l1),
  GEN_OFFSET(gbs.store_l2),
  GEN_OFFSET(gbs.store_l3),
  GEN_OFFSET(gbs.store_l4),
  GEN_OFFSET(gbs.store_l5),
  GEN_OFFSET(gbs.store_l6),
  GEN_OFFSET(gbs.store_l7),
  GEN_OFFSET(gbs.store_l8),
  GEN_OFFSET(gbs.store_l9),
  GEN_OFFSET(gbs.store_x0),
  GEN_OFFSET(gbs.store_x1),
  GEN_OFFSET(gbs.store_x2),
  GEN_OFFSET(gbs.store_x3),
  GEN_OFFSET(gbs.store_x4),
  GEN_OFFSET(gbs.store_x5),
  GEN_OFFSET(gbs.store_x6),
  GEN_OFFSET(gbs.store_x7),
  GEN_OFFSET(gbs.store_x8),
  GEN_OFFSET(gbs.store_x9),
...
void GateBoy::tock_cpu() {
  cpu_data_latch &= (uint8_t)bit_pack(gbs.cpu_dbus_new);
  imask_latch = (uint8_t)bit_pack(gbs.reg_ie);
  ...
  if (DELTA_HA) {
    ...
    if (bit(gbs.reg_if.NYBO_FF0F_D2p.state)) intf_halt_latch |= INT_TIMER_MASK;
  }
  ...
  if (DELTA_DE) {
    if (bit(gbs.reg_if.LOPE_FF0F_D0p.state)) intf_halt_latch |= INT_VBLANK_MASK;
    if (bit(gbs.reg_if.LALU_FF0F_D1p.state)) intf_halt_latch |= INT_STAT_MASK;
    if (bit(gbs.reg_if.UBUL_FF0F_D3p.state)) intf_halt_latch |= INT_SERIAL_MASK;
    if (bit(gbs.reg_if.ULAK_FF0F_D4p.state)) intf_halt_latch |= INT_JOYPAD_MASK;
  }
  ...
  // +ha -ab -bc -cd -de -ef -fg +gh
  if (DELTA_GH) {
    intf_latch = (uint8_t)bit_pack(gbs.reg_if);
  }
}
...
void GateBoy::tock_gates(const blob& cart_blob) {
  ...
  memset(&gbs.cpu_abus_new, BIT_NEW | BIT_PULLED | 1, sizeof(gbs.cpu_abus_new));
  memset(&gbs.cpu_dbus_new, BIT_NEW | BIT_PULLED | 1, sizeof(gbs.cpu_dbus_new));
...

  {
    ...
    if (DELTA_DE || DELTA_EF || DELTA_FG || DELTA_GH) {
      ...
      gbs.cpu_dbus_new.set_data(bus_req_new.write, bus_req_new.data_lo);
      EXT_cpu_latch_ext = bus_req_new.read;
    }
    else {
      gbs.cpu_dbus_new.set_data(false, 0);
      EXT_cpu_latch_ext = 0;
    }
    /*_SIG_IN_CPU_LATCH_EXT*/ gbs.cpu_signals.SIG_IN_CPU_LATCH_EXT.sig_in(EXT_cpu_latch_ext);

    bool EXT_addr_new = (bus_req_new.read || bus_req_new.write);
    bool in_bootrom = bit(~gbs.cpu_signals.TEPU_BOOT_BITn.qp_old());
    ...
    if (DELTA_HA) {
      EXT_cpu_rd = 0;
      EXT_cpu_wr = 0;
      gbs.cpu_abus_new.set_addr(bus_req_new.addr & 0x00FF);
      ...
      gbs.cpu_abus_new.set_addr(bus_req_new.addr);

      if (addr_high) EXT_addr_new = false;
      if (addr_boot) EXT_addr_new = false;
    }

    /*_SIG_IN_CPU_RDp*/ gbs.cpu_signals.SIG_IN_CPU_RDp.sig_in(EXT_cpu_rd);
    /*_SIG_IN_CPU_WRp*/ gbs.cpu_signals.SIG_IN_CPU_WRp.sig_in(EXT_cpu_wr);
    /*_SIG_IN_CPU_EXT_BUSp*/ gbs.cpu_signals.SIG_IN_CPU_EXT_BUSp.sig_in(EXT_addr_new);
  }
...

  {
    ...
    /*_PIN_74*/ gbs.clk.PIN_74_CLK.pin_clk(EXT_clkin, EXT_clkgood);
    /*_PIN_71*/ gbs.rst.PIN_71_RST.pin_in(EXT_sys_rst);
    /*_PIN_76*/ gbs.rst.PIN_76_T2.pin_in(EXT_sys_t2);
    /*_PIN_77*/ gbs.rst.PIN_77_T1.pin_in(EXT_sys_t1);
    ...
    /*_SIG_CPU_ACK_VBLANK*/ gbs.cpu_ack.SIG_CPU_ACK_VBLANK.sig_in(EXT_ack_vblank);
    /*_SIG_CPU_ACK_STAT  */ gbs.cpu_ack.SIG_CPU_ACK_STAT.sig_in(EXT_ack_stat);
    /*_SIG_CPU_ACK_TIMER */ gbs.cpu_ack.SIG_CPU_ACK_TIMER.sig_in(EXT_ack_timer);
    /*_SIG_CPU_ACK_SERIAL*/ gbs.cpu_ack.SIG_CPU_ACK_SERIAL.sig_in(EXT_ack_serial);
    /*_SIG_CPU_ACK_JOYPAD*/ gbs.cpu_ack.SIG_CPU_ACK_JOYPAD.sig_in(EXT_ack_joypad);

    /*_SIG_CPU_CLKREQ*/ gbs.clk.SIG_CPU_CLKREQ.sig_in(EXT_sys_clkreq);

    /*_SIG_CPU_ADDR_HIp*/ gbs.cpu_signals.SIG_CPU_ADDR_HIp.sig_out(gbs.cpu_abus_new.SYRO_FE00_FFFF());
    /*_SIG_CPU_UNOR_DBG*/ gbs.cpu_signals.SIG_CPU_UNOR_DBG.sig_out(UNOR_MODE_DBG2p());
    /*_SIG_CPU_UMUT_DBG*/ gbs.cpu_signals.SIG_CPU_UMUT_DBG.sig_out(UMUT_MODE_DBG1p());
  }
  ...
  /*_p07.UJYV*/ wire UJYV_CPU_RDn = not1(gbs.cpu_signals.SIG_IN_CPU_RDp.out_new());
  /*_p07.TEDO*/ gbs.cpu_signals.TEDO_CPU_RDp = not1(UJYV_CPU_RDn);

  /*#p01.AFAS*/ wire AFAS_xxxxEFGx = nor2(ADAR_ABCxxxxH(), ATYP_ABCDxxxx());
  /*_p01.AREV*/ wire AREV_CPU_WRn = nand2(gbs.cpu_signals.SIG_IN_CPU_WRp.out_new(), AFAS_xxxxEFGx);
  /*_p01.APOV*/ gbs.cpu_signals.APOV_CPU_WRp = not1(AREV_CPU_WRn);

  /*_p07.UBAL*/ wire UBAL_CPU_WRn = not1(gbs.cpu_signals.APOV_CPU_WRp.out_new());
  /*_p07.TAPU*/ gbs.cpu_signals.TAPU_CPU_WRp = not1(UBAL_CPU_WRn); // xxxxEFGx

  /*#p01.AGUT*/ wire AGUT_xxCDEFGH = or_and3(AROV_xxCDEFxx(), AJAX_xxxxEFGH(), gbs.cpu_signals.SIG_IN_CPU_EXT_BUSp.out_new());
  /*#p01.AWOD*/ wire AWOD_ABxxxxxx = nor2(UNOR_MODE_DBG2p(), AGUT_xxCDEFGH);
  /*#p01.ABUZ*/ gbs.cpu_signals.ABUZ_EXT_RAM_CS_CLK = not1(AWOD_ABxxxxxx);

  tock_div_gates();
  tock_reset_gates(bit(sys_fastboot) ? gbs.div.TERO_DIV03p : gbs.div.UPOF_DIV15p);
...

  {
    ...
    /*#p28.BOGE*/ wire BOGE_DMA_RUNNINGn = not1(gbs.dma_ctrl.MATU_DMA_RUNNINGp.qp_new());
    ...
    /*_p28.YFOT*/ wire YFOT_OAM_A2p_old = not1(gbs.oam_abus.BUS_OAM_A02n.out_old());
    /*_p28.YFOC*/ wire YFOC_OAM_A3p_old = not1(gbs.oam_abus.BUS_OAM_A03n.out_old());
    /*_p28.YVOM*/ wire YVOM_OAM_A4p_old = not1(gbs.oam_abus.BUS_OAM_A04n.out_old());
    /*_p28.YMEV*/ wire YMEV_OAM_A5p_old = not1(gbs.oam_abus.BUS_OAM_A05n.out_old());
    /*_p28.XEMU*/ wire XEMU_OAM_A6p_old = not1(gbs.oam_abus.BUS_OAM_A06n.out_old());
    /*_p28.YZET*/ wire YZET_OAM_A7p_old = not1(gbs.oam_abus.BUS_OAM_A07n.out_old());
  ...
  /*#p21.VOGA*/ gbs.VOGA_HBLANKp.dff17(ALET_xBxDxFxH(), TADY_LINE_RSTn, WODU_HBLANKp.out_old());
  /*#p21.WEGO*/ wire WEGO_HBLANKp = or2(TOFU_VID_RSTp(), gbs.VOGA_HBLANKp.qp_new());
  /*#p21.XYMU*/ gbs.XYMU_RENDERINGn.nor_latch(WEGO_HBLANKp, sprite_scanner.AVAP_SCAN_DONE_TRIGp.out_new());
  /*_p24.LOBY*/ wire LOBY_RENDERINGn = not1(gbs.XYMU_RENDERINGn.qn_new());
  /*#p27.PAHA*/ wire PAHA_RENDERINGn = not1(gbs.XYMU_RENDERINGn.qn_new());
  /*_p29.TEPA*/ wire TEPA_RENDERINGp = not1(gbs.XYMU_RENDERINGn.qn_new());
...

  {
    ...
    /*#p29.SEBA*/ sprite_fetcher.SEBA_SFETCH_S1p_D5.dff17(LAPE_AxCxExGx(), gbs.XYMU_RENDERINGn.qn_new(), sprite_fetcher.VONU_SFETCH_S1p_D4.qp_old());
    /*#p29.VONU*/ sprite_fetcher.VONU_SFETCH_S1p_D4.dff17(TAVA_xBxDxFxH(), gbs.XYMU_RENDERINGn.qn_new(), sprite_fetcher.TOBU_SFETCH_S1p_D2.qp_old());
    /*#p29.TOBU*/ sprite_fetcher.TOBU_SFETCH_S1p_D2.dff17(TAVA_xBxDxFxH(), gbs.XYMU_RENDERINGn.qn_new(), sprite_fetcher.TULY_SFETCH_S1p.qp_old());
  ...
  /*_p24.PYGO*/ tile_fetcher.PYGO_FETCH_DONEp.dff17(ALET_xBxDxFxH(), gbs.XYMU_RENDERINGn.qn_new(), tile_fetcher.PORY_FETCH_DONEp.qp_old());
  ...
  /*_p27.SUVU*/ wire SUVU_PRELOAD_DONE_TRIGn = nand4(gbs.XYMU_RENDERINGn.qn_new(), ROMO_PRELOAD_DONEn, tile_fetcher.NYKA_FETCH_DONEp.qp_new(), tile_fetcher.PORY_FETCH_DONEp.qp_new());
  ...
  auto oam_temp_b_old = gbs.oam_temp_b;

  //----------------------------------------
  // OAM latch from last cycle gets moved into temp registers.

  {
    /*_p25.CUFE*/ wire CUFE_OAM_CLKp = not_or_and3(gbs.cpu_abus_new.SARO_ADDR_OAMp(), gbs.dma_ctrl.MATU_DMA_RUNNINGp.qp_new(), MOPA_xxxxEFGH()); // CUFE looks like BYHA minus an inverter
    ...
    oam_latch_to_temp_a(COTA_OAM_CLKn, gbs.oam_latch_a, gbs.oam_temp_a);
    oam_latch_to_temp_b(COTA_OAM_CLKn, gbs.oam_latch_b, gbs.oam_temp_b);
  }
  ...
  //for (int feedback = 0; feedback < 2; feedback++) {
  {
    ...
    /*#p29.AZEM*/ wire AZEM_RENDERINGp = and2(gbs.XYMU_RENDERINGn.qn_new(), BYJO_SCANNINGn);
    ...
    /*#p27.NYZE*/ fine_scroll.NYZE_SCX_FINE_MATCH_B.dff17_any(MOXE_AxCxExGx(), gbs.XYMU_RENDERINGn.qn_new(), fine_scroll.PUXA_SCX_FINE_MATCH_A.qp_any());
    /*#p27.PUXA*/ fine_scroll.PUXA_SCX_FINE_MATCH_A.dff17_any(ROXO_CLKPIPE_odd, gbs.XYMU_RENDERINGn.qn_new(), POHU_SCX_FINE_MATCHp_old);
  ...
  /*_p24.PAHO*/ lcd.PAHO_X_8_SYNC.dff17(ROXO_CLKPIPE_odd, gbs.XYMU_RENDERINGn.qn_new(), XYDO_PX3p_old.qp_old());

  //----------------------------------------------------------------------------------------------------------------------------------------------------------------

  memset(&gbs.sprite_ibus, BIT_NEW | BIT_PULLED | 1, sizeof(gbs.sprite_ibus));
  memset(&gbs.sprite_lbus, BIT_NEW | BIT_PULLED | 1, sizeof(gbs.sprite_lbus));

  sprite_match_to_bus_gates(sprite_match_flags);
  sprite_scan_to_bus_gates(sprite_delta_y, gbs.XYMU_RENDERINGn, FEPO_STORE_MATCHp);
  ...
  /*_p27.LYZU*/ tile_fetcher.LYZU_BFETCH_S0p_D1.dff17(ALET_xBxDxFxH(), gbs.XYMU_RENDERINGn.qn_new(), tile_fetcher.LAXU_BFETCH_S0p.qp_old());
  ...
  /*_p27.LURY*/ wire LURY_BG_FETCH_DONEn = and2(tile_fetcher.LOVY_FETCH_DONEp.qn_new(), gbs.XYMU_RENDERINGn.qn_new());
  ...
  gbs.cpu_abus_old = gbs.cpu_abus_new;
  gbs.cpu_dbus_old = gbs.cpu_dbus_new;
  commit();
}
...
void GateBoy::tock_logic(const blob& cart_blob) {
  uint8_t phase_old = 1 << (7 - ((phase_total + 0) & 7));
  uint8_t phase_new = 1 << (7 - ((phase_total + 1) & 7));


  bool SYLO_WIN_HITn_old = !win_reg.RYDY_WIN_HITp;
  bool TOMU_WIN_HITp_old = !SYLO_WIN_HITn_old;
  bool SOCY_WIN_HITn_old = !TOMU_WIN_HITp_old;
  bool VYBO_CLKPIPE_old = !FEPO_STORE_MATCHp && !WODU_HBLANKp &&  !(phase_old & 0b10101010);
  bool TYFA_CLKPIPE_old = SOCY_WIN_HITn_old && tile_fetcher.POKY_PRELOAD_LATCHp && VYBO_CLKPIPE_old;
  bool SEGU_CLKPIPE_old = !TYFA_CLKPIPE_old;
  bool SACU_CLKPIPE_old = SEGU_CLKPIPE_old || fine_scroll.ROXY_FINE_SCROLL_DONEn;
  ...
  if (!gbs.XYMU_RENDERINGn && !tile_fetcher.POKY_PRELOAD_LATCHp && tile_fetcher.NYKA_FETCH_DONEp && tile_fetcher.PORY_FETCH_DONEp) TEVO_WIN_FETCH_TRIGp_old = 1;
  ...
  bool int_lcd_old = lcd.POPU_y144p.state;
  bool int_joy_old = !gbs.joy_int.APUG_JP_GLITCH3.state || !gbs.joy_int.BATU_JP_GLITCH0.state;
  bool int_tim_old = gbs.int_ctrl.MOBA_TIMER_OVERFLOWp.state;
  //wire int_ser_old = serial.CALY_SER_CNT3.state;
  bool int_ser_old = 0;


  bool UKAP_CLK_MUXa_old = gbs.tac.SOPU_TAC0p.state ? gbs.div.TAMA_DIV05p.state : gbs.div.TERO_DIV03p.state;
  bool TEKO_CLK_MUXb_old = gbs.tac.SOPU_TAC0p.state ? gbs.div.UFOR_DIV01p.state : gbs.div.TULU_DIV07p.state;
  bool TECY_CLK_MUXc_old = gbs.tac.SAMY_TAC1p.state ? UKAP_CLK_MUXa_old : TEKO_CLK_MUXb_old;
  bool SOGU_TIMA_CLKn_old = TECY_CLK_MUXc_old && gbs.tac.SABO_TAC2p.state;
  ...
  uint16_t cpu_addr_old = (uint16_t)bit_pack(gbs.cpu_abus_old);
  ...
  uint8_t cpu_data_old = (uint8_t)bit_pack(gbs.cpu_dbus_old);
  bool cpu_rd_old = gbs.cpu_signals.SIG_IN_CPU_RDp;
  bool cpu_wr_old = gbs.cpu_signals.SIG_IN_CPU_WRp;

  bit_set(gbs.cpu_abus_new);
  bit_set(gbs.cpu_dbus_new);

  if (DELTA_DE || DELTA_EF || DELTA_FG || DELTA_GH) {
    // Data has to be driven on EFGH or we fail the wave tests
    if (bus_req_new.write) bit_unpack(gbs.cpu_dbus_new, bus_req_new.data_lo);
    gbs.cpu_signals.SIG_IN_CPU_LATCH_EXT.state = bus_req_new.read;
  }
  else {
    gbs.cpu_signals.SIG_IN_CPU_LATCH_EXT.state = 0;
  }

  bool EXT_addr_new = (bus_req_new.read || bus_req_new.write);
  bool in_bootrom = !gbs.cpu_signals.TEPU_BOOT_BITn.state;
  bool addr_boot = (bus_req_new.addr <= 0x00FF) && in_bootrom;
  bool addr_vram = (bus_req_new.addr >= 0x8000) && (bus_req_new.addr < 0x9FFF);
  bool addr_high = (bus_req_new.addr >= 0xFE00);
  ...
  if (DELTA_HA) {
    EXT_cpu_rd = 0;
    EXT_cpu_wr = 0;
    bit_unpack(gbs.cpu_abus_new, bus_req_new.addr & 0x00FF);
    ...
    EXT_cpu_rd = bus_req_new.read;
    EXT_cpu_wr = bus_req_new.write;
    bit_unpack(gbs.cpu_abus_new, bus_req_new.addr);

    if (addr_high) EXT_addr_new = false;
    if (addr_boot) EXT_addr_new = false;
  }

  gbs.cpu_signals.SIG_IN_CPU_RDp.state = EXT_cpu_rd;
  gbs.cpu_signals.SIG_IN_CPU_WRp.state = EXT_cpu_wr;
  gbs.cpu_signals.SIG_IN_CPU_EXT_BUSp.state = EXT_addr_new;

  uint16_t cpu_addr_new = (uint16_t)bit_pack(gbs.cpu_abus_new);
  ...
  uint8_t cpu_data_new = (uint8_t)bit_pack(gbs.cpu_dbus_new);
  bool cpu_rd_new = gbs.cpu_signals.SIG_IN_CPU_RDp;
  bool cpu_wr_new = gbs.cpu_signals.SIG_IN_CPU_WRp;

  //-----------------------------------------------------------------------------

  gbs.clk.PIN_74_CLK.CLK.state = phase_total & 1;
  gbs.clk.PIN_74_CLK.CLKGOOD.state = 1;

  gbs.rst.PIN_71_RST = 0;
  gbs.rst.PIN_76_T2 = 0;
  gbs.rst.PIN_77_T1 = 0;

  gbs.cpu_ack.SIG_CPU_ACK_VBLANK = get_bit(gb_cpu.int_ack, BIT_VBLANK);
  gbs.cpu_ack.SIG_CPU_ACK_STAT   = get_bit(gb_cpu.int_ack, BIT_STAT);
  gbs.cpu_ack.SIG_CPU_ACK_TIMER  = get_bit(gb_cpu.int_ack, BIT_TIMER);
  gbs.cpu_ack.SIG_CPU_ACK_SERIAL = get_bit(gb_cpu.int_ack, BIT_SERIAL);
  gbs.cpu_ack.SIG_CPU_ACK_JOYPAD = get_bit(gb_cpu.int_ack, BIT_JOYPAD);

  gbs.clk.SIG_CPU_CLKREQ.state = 1;

  gbs.cpu_signals.SIG_CPU_ADDR_HIp.state = cpu_addr_new >= 0xFE00 && cpu_addr_new <= 0xFFFF;
  gbs.cpu_signals.SIG_CPU_UNOR_DBG.state = 0;
  gbs.cpu_signals.SIG_CPU_UMUT_DBG.state = 0;

  //-----------------------------------------------------------------------------
  // Sys clock signals

  gbs.clk.PIN_73_CLK_DRIVE.state = gbs.clk.PIN_74_CLK.CLK;
  gbs.clk.AVET_DEGLITCH = gbs.clk.PIN_74_CLK.CLK;
  gbs.clk.ANOS_DEGLITCH = !gbs.clk.PIN_74_CLK.CLK;
  ...
  gbs.clk.AFUR_xxxxEFGH = CLK_xxxxEFGH;
  gbs.clk.ALEF_AxxxxFGH = CLK_AxxxxFGH;
  gbs.clk.APUK_ABxxxxGH = CLK_ABxxxxGH;
  gbs.clk.ADYK_ABCxxxxH = CLK_ABCxxxxH;

  gbs.clk.PIN_75_CLK_OUT.state = CLK_xxxxEFGH;

  gbs.clk.SIG_CPU_BOWA_Axxxxxxx.state = !!(phase_new & 0b10000000);
  gbs.clk.SIG_CPU_BEDO_xBCDEFGH.state = !!(phase_new & 0b01111111);
  gbs.clk.SIG_CPU_BEKO_ABCDxxxx.state = !!(phase_new & 0b11110000);
  gbs.clk.SIG_CPU_BUDE_xxxxEFGH.state = !!(phase_new & 0b00001111);
  gbs.clk.SIG_CPU_BOLO_ABCDEFxx.state = !!(phase_new & 0b11111100);
  gbs.clk.SIG_CPU_BUKE_AxxxxxGH.state = !!(phase_new & 0b10000011);
  gbs.clk.SIG_CPU_BOMA_xBCDEFGH.state = !!(phase_new & 0b01111111);
  gbs.clk.SIG_CPU_BOGA_Axxxxxxx.state = !!(phase_new & 0b10000000);

  gbs.cpu_signals.TEDO_CPU_RDp = cpu_rd_new;
  gbs.cpu_signals.APOV_CPU_WRp = CLK_xxxxEFGx && cpu_wr_new;
  gbs.cpu_signals.TAPU_CPU_WRp = gbs.cpu_signals.APOV_CPU_WRp;
  gbs.cpu_signals.ABUZ_EXT_RAM_CS_CLK = CLK_xxCDEFGH && gbs.cpu_signals.SIG_IN_CPU_EXT_BUSp;

  //----------
  // DIV

  if (DELTA_HA) bit_unpack(gbs.div, bit_pack(gbs.div) + 1);
  if (cpu_addr_new == 0xFF04 && cpu_wr_new && CLK_xxxxEFGx) bit_unpack(gbs.div, 0);
  if (cpu_addr_new == 0xFF04 && cpu_rd_new) bit_unpack(gbs.cpu_dbus_new, bit_pack(gbs.div) >> 6);
  ...
  gbs.rst.AFER_SYS_RSTp = 0;
  gbs.rst.TUBO_WAITINGp = 0;
  gbs.rst.ASOL_POR_DONEn = 0;
  gbs.rst.SIG_CPU_EXT_CLKGOOD = 1;
  gbs.rst.SIG_CPU_EXT_RESETp = 0;
  gbs.rst.SIG_CPU_STARTp = 0;
  gbs.rst.SIG_CPU_INT_RESETp = 0;;
  gbs.rst.SOTO_DBG_VRAMp = 0;
  ...
  if (cpu_wr_new && cpu_addr_new == 0xFF40 && DELTA_GH) {
    bit_copy_inv(reg_lcdc, gbs.cpu_dbus_old);
  }

  if (cpu_rd_new && (cpu_addr_new == 0xFF40)) {
    bit_copy_inv(gbs.cpu_dbus_new, reg_lcdc);
  }
  ...
  gbs.clk.WOSU_AxxDExxH = !vid_rst_new && gen_clk_new(0b10011001);
  gbs.clk.WUVU_ABxxEFxx = !vid_rst_new && gen_clk_new(0b11001100);
  gbs.clk.VENA_xxCDEFxx = !vid_rst_new && gen_clk_new(0b00111100);

  //----------
  // LYC

  if (cpu_addr_new == 0xFF45) {
    if (cpu_rd_new) bit_copy_inv(gbs.cpu_dbus_new, reg_lyc);
    if (cpu_wr_new && DELTA_GH) bit_copy_inv(reg_lyc, gbs.cpu_dbus_old);
  }
  ...
  if (cpu_rd_new && (cpu_addr_new == 0xFF44)) {
    bit_copy(gbs.cpu_dbus_new, reg_ly);
  }
  ...
  if (gbs.cpu_signals.SIG_IN_CPU_WRp.state && cpu_addr_new == 0xFF00 && DELTA_GH) {
    gbs.joy_reg.KELY_JOYP_UDLRp.state = gbs.cpu_dbus_old.BUS_CPU_D04p.state;
    gbs.joy_reg.COFY_JOYP_ABCSp.state = gbs.cpu_dbus_old.BUS_CPU_D05p.state;
    gbs.joy_ext.PIN_63_JOY_P14.state = !gbs.joy_reg.KELY_JOYP_UDLRp.state;
    gbs.joy_ext.PIN_62_JOY_P15.state = !gbs.joy_reg.COFY_JOYP_ABCSp.state;
  }

  bool EXT_button0 = 0, EXT_button1 = 0, EXT_button2 = 0, EXT_button3 = 0;

  if (gbs.joy_ext.PIN_63_JOY_P14.state) {
  ...
  else if (gbs.joy_ext.PIN_62_JOY_P15.state) {
  ...
  gbs.joy_ext.PIN_67_JOY_P10.state = EXT_button0;
  gbs.joy_ext.PIN_66_JOY_P11.state = EXT_button1;
  gbs.joy_ext.PIN_65_JOY_P12.state = EXT_button2;
  gbs.joy_ext.PIN_64_JOY_P13.state = EXT_button3;

  wire any_button = EXT_button0 || EXT_button1 || EXT_button2 || EXT_button3;

  if (gen_clk_new(0b10000000)) {
    gbs.int_ctrl.AWOB_WAKE_CPU.state = !any_button;
    gbs.int_ctrl.SIG_CPU_WAKE.state = !any_button;
  }

  if (DELTA_HA) {
    gbs.joy_int.APUG_JP_GLITCH3.state = gbs.joy_int.AGEM_JP_GLITCH2.state;
    gbs.joy_int.AGEM_JP_GLITCH2.state = gbs.joy_int.ACEF_JP_GLITCH1.state;
    gbs.joy_int.ACEF_JP_GLITCH1.state = gbs.joy_int.BATU_JP_GLITCH0.state;
    gbs.joy_int.BATU_JP_GLITCH0.state = !any_button;
  }

  if (cpu_addr_new == 0xFF00 && gbs.cpu_signals.SIG_IN_CPU_RDp.state) {
    gbs.cpu_dbus_new.BUS_CPU_D00p.state = !gbs.joy_latch.KEVU_JOYP_L0n.state;
    gbs.cpu_dbus_new.BUS_CPU_D01p.state = !gbs.joy_latch.KAPA_JOYP_L1n.state;
    gbs.cpu_dbus_new.BUS_CPU_D02p.state = !gbs.joy_latch.KEJA_JOYP_L2n.state;
    gbs.cpu_dbus_new.BUS_CPU_D03p.state = !gbs.joy_latch.KOLO_JOYP_L3n.state;
    gbs.cpu_dbus_new.BUS_CPU_D04p.state =  gbs.joy_reg.KELY_JOYP_UDLRp.state;
    gbs.cpu_dbus_new.BUS_CPU_D05p.state =  gbs.joy_reg.COFY_JOYP_ABCSp.state;
  }
  else {
    gbs.joy_latch.KEVU_JOYP_L0n.state = gbs.joy_ext.PIN_67_JOY_P10.state;
    gbs.joy_latch.KAPA_JOYP_L1n.state = gbs.joy_ext.PIN_66_JOY_P11.state;
    gbs.joy_latch.KEJA_JOYP_L2n.state = gbs.joy_ext.PIN_65_JOY_P12.state;
    gbs.joy_latch.KOLO_JOYP_L3n.state = gbs.joy_ext.PIN_64_JOY_P13.state;
  }

  //tock_serial_logic();
  //tock_timer_logic();

  if (gbs.cpu_signals.SIG_IN_CPU_WRp.state && DELTA_GH) {
    if (cpu_addr_new == 0xFF06) bit_copy(gbs.tma, gbs.cpu_dbus_new);
    if (cpu_addr_new == 0xFF07) bit_copy(&gbs.tac, 3, &gbs.cpu_dbus_new);
  }

    
  if (!gen_clk_old(0b10000000) && gen_clk_new(0b10000000)) {
    wire MERY_TIMER_OVERFLOWp_old = !gbs.tima.NUGA_TIMA7p.state && gbs.int_ctrl.NYDU_TIMA7p_DELAY.state;
    gbs.int_ctrl.MOBA_TIMER_OVERFLOWp.state = MERY_TIMER_OVERFLOWp_old;
  }

  wire TOPE_FF05_WRn = !CLK_xxxxEFGx || !gbs.cpu_signals.SIG_IN_CPU_WRp.state || cpu_addr_new != 0xFF05;

  wire MUZU_CPU_LOAD_TIMAn = gbs.cpu_signals.SIG_IN_CPU_LATCH_EXT.state || TOPE_FF05_WRn;
  wire MEXU_TIMA_LOADp = !MUZU_CPU_LOAD_TIMAn || gbs.int_ctrl.MOBA_TIMER_OVERFLOWp.state;

  if (!gen_clk_old(0b10000000) && gen_clk_new(0b10000000)) {
    gbs.int_ctrl.NYDU_TIMA7p_DELAY.state = gbs.tima.NUGA_TIMA7p.state;
  }

  if (MEXU_TIMA_LOADp) {
    gbs.int_ctrl.NYDU_TIMA7p_DELAY.state = 0;
  }

  wire UKAP_CLK_MUXa_new = gbs.tac.SOPU_TAC0p.state ? gbs.div.TAMA_DIV05p.state : gbs.div.TERO_DIV03p.state;
  wire TEKO_CLK_MUXb_new = gbs.tac.SOPU_TAC0p.state ? gbs.div.UFOR_DIV01p.state : gbs.div.TULU_DIV07p.state;
  wire TECY_CLK_MUXc_new = gbs.tac.SAMY_TAC1p.state ? UKAP_CLK_MUXa_new : TEKO_CLK_MUXb_new;
  wire SOGU_TIMA_CLKn_new = TECY_CLK_MUXc_new && gbs.tac.SABO_TAC2p.state;

  if (SOGU_TIMA_CLKn_old && !SOGU_TIMA_CLKn_new) {
    bit_unpack(gbs.tima, bit_pack(gbs.tima) + 1);
  }

  if (MEXU_TIMA_LOADp) {
    if (TOPE_FF05_WRn) {
      bit_copy(gbs.tima, gbs.tma);
    }
    else {
      bit_copy(gbs.tima, gbs.cpu_dbus_new);
    }
  }

  if (gbs.cpu_signals.SIG_IN_CPU_RDp.state) {
    if (cpu_addr_new == 0xFF05) bit_copy(gbs.cpu_dbus_new, gbs.tima);
    if (cpu_addr_new == 0xFF06) bit_copy(gbs.cpu_dbus_new, gbs.tma);
    if (cpu_addr_new == 0xFF07) bit_copy(gbs.cpu_dbus_new, gbs.tac);
  }

  if (gbs.cpu_signals.SIG_IN_CPU_WRp.state && cpu_addr_new == 0xFF50 && DELTA_GH) {
    gbs.cpu_signals.TEPU_BOOT_BITn.state = SATO_BOOT_BITn.state;
  }

  gbs.cpu_signals.SIG_CPU_BOOTp.state = 0;
  gbs.cpu_signals.SIG_BOOT_CSp.state = 0;

  if (cpu_addr_new <= 0x00FF) {

    gbs.cpu_signals.SIG_CPU_BOOTp.state = !gbs.cpu_signals.TEPU_BOOT_BITn.state;

    if (gbs.cpu_signals.SIG_IN_CPU_RDp.state && !gbs.cpu_signals.TEPU_BOOT_BITn.state) {
      gbs.cpu_signals.SIG_BOOT_CSp.state = 1;
      bit_unpack(gbs.cpu_dbus_new, DMG_ROM_blob[cpu_addr_new & 0xFF]);
    }
  }

  if (gbs.cpu_signals.SIG_IN_CPU_RDp.state && (cpu_addr_new == 0xFF50)) {
    gbs.cpu_dbus_new.BUS_CPU_D00p.state = gbs.cpu_signals.TEPU_BOOT_BITn.state;
  }

  SATO_BOOT_BITn = gbs.cpu_dbus_new.BUS_CPU_D00p.state || gbs.cpu_signals.TEPU_BOOT_BITn.state;

  auto dma_addr_old = (bit_pack_inv(gbs.dma_hi) << 8) | bit_pack(gbs.dma_lo);
  bool dma_running_old = gbs.dma_ctrl.MATU_DMA_RUNNINGp;

  gbs.dma_ctrl.LYXE_DMA_LATCHp.state |= cpu_addr_new == 0xFF46 && gbs.cpu_signals.SIG_IN_CPU_WRp.state && CLK_xxxxEFGx;

  auto dma_lo_old = bit_pack(gbs.dma_lo);

  if (DELTA_DE) {
    if (dma_lo_old == 159) {
      gbs.dma_ctrl.MYTE_DMA_DONE.state = 1;
      gbs.dma_ctrl.LARA_DMA_LATCHn = 1;
      gbs.dma_ctrl.LOKY_DMA_LATCHp = 0;
    }

    gbs.dma_ctrl.LENE_DMA_TRIG_d4.state = gbs.dma_ctrl.LUVY_DMA_TRIG_d0.state;

    if (gbs.dma_ctrl.LUVY_DMA_TRIG_d0.state) {
      gbs.dma_ctrl.MYTE_DMA_DONE.state = 0;
      gbs.dma_ctrl.LYXE_DMA_LATCHp.state = 0;
      bit_clear(gbs.dma_lo);
      gbs.dma_ctrl.LARA_DMA_LATCHn = 0;
      gbs.dma_ctrl.LOKY_DMA_LATCHp = 1;
    }
  }

  if (cpu_addr_new == 0xFF46 && gbs.cpu_signals.SIG_IN_CPU_RDp.state) {
    bit_unpack(gbs.cpu_dbus_new, bit_pack_inv(gbs.dma_hi));
  }

  if (cpu_addr_new == 0xFF46 && gbs.cpu_signals.SIG_IN_CPU_WRp.state && DELTA_GH) {
    auto old_data = bit_pack(gbs.cpu_dbus_old);
    bit_unpack_inv(gbs.dma_hi, old_data);
  }

  if (DELTA_HA) {
    gbs.dma_ctrl.LUVY_DMA_TRIG_d0.state = (cpu_addr_new != 0xFF46 || !gbs.cpu_signals.SIG_IN_CPU_WRp.state || !CLK_xxxxEFGx) && gbs.dma_ctrl.LYXE_DMA_LATCHp.state;
    gbs.dma_ctrl.MATU_DMA_RUNNINGp.state = gbs.dma_ctrl.LOKY_DMA_LATCHp.state;

    if (gbs.dma_ctrl.LOKY_DMA_LATCHp.state && !gbs.dma_ctrl.LENE_DMA_TRIG_d4.state) {
      bit_unpack(gbs.dma_lo, dma_lo_old + 1);
    }
  }

  bool dma_running_new = gbs.dma_ctrl.MATU_DMA_RUNNINGp;
  auto dma_addr_new = (bit_pack_inv(gbs.dma_hi) << 8) | bit_pack(gbs.dma_lo);
  ...
  if (!vid_rst_new && (DELTA_HA || DELTA_DE)) {
    bit_copy_inv(&sprite_index, 6, &gbs.oam_abus.BUS_OAM_A02n);
  ...
  if (DELTA_EVEN) {
    gbs.VOGA_HBLANKp.state = wodu_hblank_old;
  }

  if (line_rst_new) {
    gbs.VOGA_HBLANKp.state = 0;
  }

  bool rendering_old = !gbs.XYMU_RENDERINGn.state;

  if (vid_rst_new) gbs.XYMU_RENDERINGn.state = 1;
  if (gbs.VOGA_HBLANKp.state) gbs.XYMU_RENDERINGn.state = 1;
  if (sprite_scanner.AVAP_SCAN_DONE_TRIGp.state) gbs.XYMU_RENDERINGn.state = 0;

  bool rendering_new = !gbs.XYMU_RENDERINGn.state;
  ...
  if (win_reg.PYNU_WIN_MODE_Ap.state && !win_reg.NOPA_WIN_MODE_Bp.state) {
...

  {
    ...
    if (!BYCU_OAM_CLKp_old && BYCU_OAM_CLKp_new) {
      bit_copy_inv(gbs.oam_temp_a, gbs.oam_latch_a);
      bit_copy_inv(gbs.oam_temp_b, gbs.oam_latch_b);
    }
  }
  ...
  auto pack_ly_new = bit_pack(reg_ly);
  auto pack_oam_temp_a = bit_pack(gbs.oam_temp_a);
  ...
  if (vid_rst_new) {
    DEZY_COUNT_CLKp.state = 0;

    bit_clear(sprite_counter);
    bit_clear(sprite_reset_flags);
    bit_clear(sprite_store_flags);

    bit_set(gbs.store_x0);
    bit_set(gbs.store_x1);
    bit_set(gbs.store_x2);
    bit_set(gbs.store_x3);
    bit_set(gbs.store_x4);
    bit_set(gbs.store_x5);
    bit_set(gbs.store_x6);
    bit_set(gbs.store_x7);
    bit_set(gbs.store_x8);
    bit_set(gbs.store_x9);
  }
  else if (line_rst_new) {
    ...
    auto ssf_clk =
      !CLK_xBCxxFGx ||
      !sprite_scanner.CENO_SCANNINGn.state ||
      ...
      (reg_lcdc.XYMO_LCDC_SPSIZEn.state && !sprite_delta_y.GYKY_YDIFF3.sum);



    if (DELTA_ODD) {
      if (!DEZY_COUNT_CLKp.state && ssf_clk) {
    ...
    if (!WUTY_SFETCH_DONE_TRIGp_old && sprite_fetcher.WUTY_SFETCH_DONE_TRIGp) {
    ...
    if (get_bit(store_clk_ne, 0)) bit_copy_inv(gbs.store_i0, gbs.sprite_ibus);
    if (get_bit(store_clk_ne, 1)) bit_copy_inv(gbs.store_i1, gbs.sprite_ibus);
    if (get_bit(store_clk_ne, 2)) bit_copy_inv(gbs.store_i2, gbs.sprite_ibus);
    if (get_bit(store_clk_ne, 3)) bit_copy_inv(gbs.store_i3, gbs.sprite_ibus);
    if (get_bit(store_clk_ne, 4)) bit_copy_inv(gbs.store_i4, gbs.sprite_ibus);
    if (get_bit(store_clk_ne, 5)) bit_copy_inv(gbs.store_i5, gbs.sprite_ibus);
    if (get_bit(store_clk_ne, 6)) bit_copy_inv(gbs.store_i6, gbs.sprite_ibus);
    if (get_bit(store_clk_ne, 7)) bit_copy_inv(gbs.store_i7, gbs.sprite_ibus);
    if (get_bit(store_clk_ne, 8)) bit_copy_inv(gbs.store_i8, gbs.sprite_ibus);
    if (get_bit(store_clk_ne, 9)) bit_copy_inv(gbs.store_i9, gbs.sprite_ibus);

    if (get_bit(store_clk_ne, 0)) bit_copy_inv(gbs.store_l0, gbs.sprite_lbus);
    if (get_bit(store_clk_ne, 1)) bit_copy_inv(gbs.store_l1, gbs.sprite_lbus);
    if (get_bit(store_clk_ne, 2)) bit_copy_inv(gbs.store_l2, gbs.sprite_lbus);
    if (get_bit(store_clk_ne, 3)) bit_copy_inv(gbs.store_l3, gbs.sprite_lbus);
    if (get_bit(store_clk_ne, 4)) bit_copy_inv(gbs.store_l4, gbs.sprite_lbus);
    if (get_bit(store_clk_ne, 5)) bit_copy_inv(gbs.store_l5, gbs.sprite_lbus);
    if (get_bit(store_clk_ne, 6)) bit_copy_inv(gbs.store_l6, gbs.sprite_lbus);
    if (get_bit(store_clk_ne, 7)) bit_copy_inv(gbs.store_l7, gbs.sprite_lbus);
    if (get_bit(store_clk_ne, 8)) bit_copy_inv(gbs.store_l8, gbs.sprite_lbus);
    if (get_bit(store_clk_ne, 9)) bit_copy_inv(gbs.store_l9, gbs.sprite_lbus);

    if (get_bit(store_clk_pe, 0)) bit_copy(gbs.store_x0, gbs.oam_temp_b);
    if (get_bit(store_clk_pe, 1)) bit_copy(gbs.store_x1, gbs.oam_temp_b);
    if (get_bit(store_clk_pe, 2)) bit_copy(gbs.store_x2, gbs.oam_temp_b);
    if (get_bit(store_clk_pe, 3)) bit_copy(gbs.store_x3, gbs.oam_temp_b);
    if (get_bit(store_clk_pe, 4)) bit_copy(gbs.store_x4, gbs.oam_temp_b);
    if (get_bit(store_clk_pe, 5)) bit_copy(gbs.store_x5, gbs.oam_temp_b);
    if (get_bit(store_clk_pe, 6)) bit_copy(gbs.store_x6, gbs.oam_temp_b);
    if (get_bit(store_clk_pe, 7)) bit_copy(gbs.store_x7, gbs.oam_temp_b);
    if (get_bit(store_clk_pe, 8)) bit_copy(gbs.store_x8, gbs.oam_temp_b);
    if (get_bit(store_clk_pe, 9)) bit_copy(gbs.store_x9, gbs.oam_temp_b);

    if (get_bit(store_rst, 0)) bit_set(gbs.store_x0);
    if (get_bit(store_rst, 1)) bit_set(gbs.store_x1);
    if (get_bit(store_rst, 2)) bit_set(gbs.store_x2);
    if (get_bit(store_rst, 3)) bit_set(gbs.store_x3);
    if (get_bit(store_rst, 4)) bit_set(gbs.store_x4);
    if (get_bit(store_rst, 5)) bit_set(gbs.store_x5);
    if (get_bit(store_rst, 6)) bit_set(gbs.store_x6);
    if (get_bit(store_rst, 7)) bit_set(gbs.store_x7);
    if (get_bit(store_rst, 8)) bit_set(gbs.store_x8);
    if (get_bit(store_rst, 9)) bit_set(gbs.store_x9);
  ...
  if (!rendering_new) {
    fine_scroll.ROXY_FINE_SCROLL_DONEn.state = 1;
    fine_scroll.NYZE_SCX_FINE_MATCH_B.state = 0;
    fine_scroll.PUXA_SCX_FINE_MATCH_A.state = 0;
  }

  if (fine_scroll.PUXA_SCX_FINE_MATCH_A.state && !fine_scroll.NYZE_SCX_FINE_MATCH_B.state) {
    fine_scroll.ROXY_FINE_SCROLL_DONEn.state = 0;
  }
  ...
  if (!rendering_new || sprite_scanner.CENO_SCANNINGn.state || reg_lcdc.XYLO_LCDC_SPENn.state) {
    ...
    bool M0 = px == bit_pack(gbs.store_x0);
    bool M1 = px == bit_pack(gbs.store_x1);
    bool M2 = px == bit_pack(gbs.store_x2);
    bool M3 = px == bit_pack(gbs.store_x3);
    bool M4 = px == bit_pack(gbs.store_x4);
    bool M5 = px == bit_pack(gbs.store_x5);
    bool M6 = px == bit_pack(gbs.store_x6);
    bool M7 = px == bit_pack(gbs.store_x7);
    bool M8 = px == bit_pack(gbs.store_x8);
    bool M9 = px == bit_pack(gbs.store_x9);
  ...
  // Pix counter triggers HBLANK if there's no sprite store match and enables the pixel pipe clocks for later
  WODU_HBLANKp = !FEPO_STORE_MATCHp.state && (bit_pack(pix_count) & 167) == 167; // WODU goes high on odd, cleared on H
  ...
  bit_set(gbs.sprite_ibus);
  bit_set(gbs.sprite_lbus);

  if (sprite_match_flags.GUVA_SPRITE0_GETp.state) bit_copy_inv(gbs.sprite_ibus, gbs.store_i0);
  if (sprite_match_flags.ENUT_SPRITE1_GETp.state) bit_copy_inv(gbs.sprite_ibus, gbs.store_i1);
  if (sprite_match_flags.EMOL_SPRITE2_GETp.state) bit_copy_inv(gbs.sprite_ibus, gbs.store_i2);
  if (sprite_match_flags.GYFY_SPRITE3_GETp.state) bit_copy_inv(gbs.sprite_ibus, gbs.store_i3);
  if (sprite_match_flags.GONO_SPRITE4_GETp.state) bit_copy_inv(gbs.sprite_ibus, gbs.store_i4);
  if (sprite_match_flags.GEGA_SPRITE5_GETp.state) bit_copy_inv(gbs.sprite_ibus, gbs.store_i5);
  if (sprite_match_flags.XOJA_SPRITE6_GETp.state) bit_copy_inv(gbs.sprite_ibus, gbs.store_i6);
  if (sprite_match_flags.GUTU_SPRITE7_GETp.state) bit_copy_inv(gbs.sprite_ibus, gbs.store_i7);
  if (sprite_match_flags.FOXA_SPRITE8_GETp.state) bit_copy_inv(gbs.sprite_ibus, gbs.store_i8);
  if (sprite_match_flags.GUZE_SPRITE9_GETp.state) bit_copy_inv(gbs.sprite_ibus, gbs.store_i9);

  if (sprite_match_flags.GUVA_SPRITE0_GETp.state) bit_copy_inv(gbs.sprite_lbus, gbs.store_l0);
  if (sprite_match_flags.ENUT_SPRITE1_GETp.state) bit_copy_inv(gbs.sprite_lbus, gbs.store_l1);
  if (sprite_match_flags.EMOL_SPRITE2_GETp.state) bit_copy_inv(gbs.sprite_lbus, gbs.store_l2);
  if (sprite_match_flags.GYFY_SPRITE3_GETp.state) bit_copy_inv(gbs.sprite_lbus, gbs.store_l3);
  if (sprite_match_flags.GONO_SPRITE4_GETp.state) bit_copy_inv(gbs.sprite_lbus, gbs.store_l4);
  if (sprite_match_flags.GEGA_SPRITE5_GETp.state) bit_copy_inv(gbs.sprite_lbus, gbs.store_l5);
  if (sprite_match_flags.XOJA_SPRITE6_GETp.state) bit_copy_inv(gbs.sprite_lbus, gbs.store_l6);
  if (sprite_match_flags.GUTU_SPRITE7_GETp.state) bit_copy_inv(gbs.sprite_lbus, gbs.store_l7);
  if (sprite_match_flags.FOXA_SPRITE8_GETp.state) bit_copy_inv(gbs.sprite_lbus, gbs.store_l8);
  if (sprite_match_flags.GUZE_SPRITE9_GETp.state) bit_copy_inv(gbs.sprite_lbus, gbs.store_l9);

  if (sprite_scanner.CENO_SCANNINGn.state || !rendering_new) {
    auto pack_sprite_index = bit_pack(sprite_index);
    bit_unpack(gbs.sprite_ibus, pack_sprite_index);
  }

  if (!FEPO_STORE_MATCHp.state) {
    bit_unpack(&gbs.sprite_lbus, 4, pack_ydiff);
  }
  ...
  {
    wire VYBO_CLKPIPE_odd = !FEPO_STORE_MATCHp.state && !WODU_HBLANKp.state && gen_clk_new(0b01010101);
  ...
  if (gbs.cpu_signals.SIG_IN_CPU_WRp.state && DELTA_GH) {
    if (cpu_addr_new == 0xFF4A) bit_copy_inv(reg_wy, gbs.cpu_dbus_old);
    if (cpu_addr_new == 0xFF4B) bit_copy_inv(reg_wx, gbs.cpu_dbus_old);
  }

  if (gbs.cpu_signals.SIG_IN_CPU_RDp.state) {
    if (cpu_addr_new == 0xFF4A) bit_copy_inv(gbs.cpu_dbus_new, reg_wy);
    if (cpu_addr_new == 0xFF4B) bit_copy_inv(gbs.cpu_dbus_new, reg_wx);
  }
  ...
  win_reg.ROGE_WY_MATCHp = (bit_pack(reg_ly) == bit_pack_inv(reg_wy)) && winen_new;
  ...
  win_reg.NUKO_WX_MATCHp = (bit_pack_inv(reg_wx) == bit_pack(pix_count)) && win_reg.REJO_WY_MATCH_LATCHp.state;
  ...
  if (!gbs.XYMU_RENDERINGn.state && !tile_fetcher.POKY_PRELOAD_LATCHp.state && tile_fetcher.NYKA_FETCH_DONEp.state && tile_fetcher.PORY_FETCH_DONEp.state) TEVO_WIN_FETCH_TRIGp_new = 1;

  {
    ...
    if (TEVO_WIN_FETCH_TRIGp_new || gbs.XYMU_RENDERINGn.state) {
  ...
  wire SACU_CLKPIPE_new =
    CLK_AxCxExGx ||
    win_reg.RYDY_WIN_HITp.state ||
    !tile_fetcher.POKY_PRELOAD_LATCHp.state ||
    FEPO_STORE_MATCHp.state ||
    wodu_hblank_new ||
    fine_scroll.ROXY_FINE_SCROLL_DONEn.state;
...

  {
    ...
    if (rendering_old) {
      if ((bfetch_phase_old == 6) && (bfetch_phase_new == 7 || !rendering_new)) {
        bit_copy_inv(tile_temp_a, gbs.vram_dbus);
      }

      if ((bfetch_phase_old == 2) && (bfetch_phase_new == 3 || !rendering_new)) {
        bit_copy(tile_temp_b, gbs.vram_dbus);
      }
    ...
    if (gbs.cpu_signals.SIG_IN_CPU_WRp.state && gen_clk_new(0b00000001)) {
      if (cpu_addr_new == 0xFF47) bit_copy_inv(reg_bgp,  gbs.cpu_dbus_old);
      if (cpu_addr_new == 0xFF48) bit_copy_inv(reg_obp0, gbs.cpu_dbus_old);
      if (cpu_addr_new == 0xFF49) bit_copy_inv(reg_obp1, gbs.cpu_dbus_old);
    }

    if (gbs.cpu_signals.SIG_IN_CPU_RDp.state) {
      if (cpu_addr_new == 0xFF47) bit_copy_inv(gbs.cpu_dbus_new, reg_bgp);
      if (cpu_addr_new == 0xFF48) bit_copy_inv(gbs.cpu_dbus_new, reg_obp0);
      if (cpu_addr_new == 0xFF49) bit_copy_inv(gbs.cpu_dbus_new, reg_obp1);
    }
    ...
    if (sprite_scanner.AVAP_SCAN_DONE_TRIGp.state || !(!win_reg.PYNU_WIN_MODE_Ap.state || win_reg.NOPA_WIN_MODE_Bp.state) || TEVO_WIN_FETCH_TRIGp_new) {
      bpipe_a = tpix_a;
      bpipe_b = tpix_b;
    }
    ...
    if (sf.WUTY_SFETCH_DONE_TRIGp.state) {
      ...
      mpipe = gbs.oam_temp_b.DEPO_OAM_DB7p.state ? mpipe | ~smask : mpipe & smask;
      ppipe = gbs.oam_temp_b.GOMO_OAM_DB4p.state ? ppipe | ~smask : ppipe & smask;
    }
  ...
  if (!vid_rst_new) {
    ...
    lcd.PIN_55_LCD_LATCH.state = !gbs.div.UGOT_DIV06p.state;
    lcd.PIN_56_LCD_FLIPS.state = !gbs.div.TULU_DIV07p.state;
  ...
  if (gbs.cpu_signals.SIG_IN_CPU_EXT_BUSp.state && !cpu_addr_vram_new) {
    bit_copy(&gbs.ext_addr_latch, 15, &gbs.cpu_abus_new);
  }

  //----------------------------------------

  if (dma_running_new && !dma_addr_vram_new) {
    gbs.ext_ctrl.PIN_80_CSn.state = !gbs.dma_hi.MARU_DMA_A15n.state;
    bit_copy_inv(gbs.ext_abus, gbs.dma_lo);
    bit_copy(&gbs.ext_abus.PIN_09_A08, 7, &gbs.dma_hi.NAFA_DMA_A08n);
  }
  else {
    gbs.ext_ctrl.PIN_80_CSn.state = gbs.cpu_signals.ABUZ_EXT_RAM_CS_CLK.state && cpu_addr_ram_new;
    bit_copy_inv(&gbs.ext_abus.PIN_01_A00, 15, &gbs.ext_addr_latch.ALOR_EXT_ADDR_LATCH_00p);
  }

  //----------------------------------------

  if (!(dma_running_new && !dma_addr_vram_new) && gbs.cpu_signals.SIG_IN_CPU_EXT_BUSp.state && gbs.cpu_signals.SIG_IN_CPU_WRp.state) {
    gbs.ext_ctrl.PIN_79_RDn.state = cpu_addr_vram_new;
    gbs.ext_ctrl.PIN_78_WRn.state = CLK_xxxxEFGx && !cpu_addr_vram_new;
  }
  else {
    gbs.ext_ctrl.PIN_79_RDn.state = 1;
    gbs.ext_ctrl.PIN_78_WRn.state = 0;
  }
  ...
  if (dma_running_new && !dma_addr_vram_new) {
    gbs.ext_abus.PIN_16_A15.state = gbs.dma_hi.MARU_DMA_A15n.state;
  }
  else if (!gbs.cpu_signals.TEPU_BOOT_BITn.state && cpu_addr_new <= 0x00FF) {
    gbs.ext_abus.PIN_16_A15.state = 0;
  }
  else {
    gbs.ext_abus.PIN_16_A15.state = gbs.cpu_signals.ABUZ_EXT_RAM_CS_CLK.state && !gbs.cpu_abus_new.BUS_CPU_A15p.state;
  }

  CHECK_N(gbs.cpu_signals.SIG_IN_CPU_RDp.state && gbs.cpu_signals.SIG_IN_CPU_WRp.state);

  if (gbs.cpu_signals.SIG_IN_CPU_EXT_BUSp.state && gbs.cpu_signals.SIG_IN_CPU_WRp.state && !cpu_addr_vram_new) {
    bit_copy_inv(gbs.ext_dbus, gbs.cpu_dbus_new);
  }
  else {
    bit_clear(gbs.ext_dbus);
  }

  //----------------------------------------
  // Ext read

  if (gbs.ext_ctrl.PIN_79_RDn.state) {
    uint16_t ext_addr = (uint16_t)bit_pack_inv(gbs.ext_abus);
    ...
    if (cart_has_mbc1(cart_blob)) {
      ...
      bool mbc1_ram_en = gbs.ext_mbc.MBC1_RAM_EN.state;
      bool mbc1_mode = gbs.ext_mbc.MBC1_MODE.state;

      uint32_t mbc1_rom0_bank = mbc1_mode ? bit_pack(&gbs.ext_mbc.MBC1_BANK5, 2) : 0;
      uint32_t mbc1_rom0_addr = ((ext_addr & 0x3FFF) | (mbc1_rom0_bank << 19)) & rom_addr_mask;

      uint32_t mbc1_rom1_bank = bit_pack(&gbs.ext_mbc.MBC1_BANK0, 7);
      if ((mbc1_rom1_bank & 0x1F) == 0) mbc1_rom1_bank |= 1;
      uint32_t mbc1_rom1_addr = ((ext_addr & 0x3FFF) | (mbc1_rom1_bank << 14)) & rom_addr_mask;

      uint32_t mbc1_ram_bank = mbc1_mode ? bit_pack(&gbs.ext_mbc.MBC1_BANK5, 2) : 0;
    ...
    if (ext_read_en) bit_unpack_inv(gbs.ext_dbus, data_in);
  }
  ...
  if (gbs.ext_ctrl.PIN_78_WRn.state) {
    auto ext_addr = bit_pack_inv(gbs.ext_abus);
    auto region = ext_addr >> 13;
    auto data_out = bit_pack_inv(gbs.ext_dbus);

    if (cart_has_mbc1(cart_blob)) {
      bool mbc1_ram_en = gbs.ext_mbc.MBC1_RAM_EN.state;
      bool mbc1_mode = gbs.ext_mbc.MBC1_MODE.state;

      auto mbc1_ram_bank = mbc1_mode ? bit_pack(&gbs.ext_mbc.MBC1_BANK5, 2) : 0;
      auto mbc1_ram_addr = ((ext_addr & 0x1FFF) | (mbc1_ram_bank << 13)) & cart_ram_addr_mask(cart_blob);

      switch (region) {
      case 0: gbs.ext_mbc.MBC1_RAM_EN = (data_out & 0x0F) == 0x0A; break;
      case 1: bit_unpack(&gbs.ext_mbc.MBC1_BANK0, 5, data_out); break;
      case 2: bit_unpack(&gbs.ext_mbc.MBC1_BANK5, 2, data_out); break;
      case 3: gbs.ext_mbc.MBC1_MODE = (data_out & 1); break;
      case 4: break;
  ...
  if (gbs.cpu_signals.SIG_IN_CPU_RDp.state && gbs.cpu_signals.SIG_IN_CPU_EXT_BUSp.state && !cpu_addr_vram_new && gbs.cpu_signals.SIG_IN_CPU_LATCH_EXT.state) {
    bit_copy_inv(gbs.cpu_dbus_new, gbs.ext_data_latch);
  }
  else {
    bit_copy(gbs.ext_data_latch, gbs.ext_dbus);
  }

  {
    bit_set(gbs.vram_abus);
    bit_set(gbs.vram_dbus);

    //--------------------------------------------
    // CPU vram read address

    if (!dma_addr_vram_new && gbs.XYMU_RENDERINGn.state) {
      bit_copy_inv(gbs.vram_abus, gbs.cpu_abus_new);
    }
    ...
    if (dma_addr_vram_new) {
      bit_copy_inv(gbs.vram_abus, gbs.dma_lo);
      bit_copy(&gbs.vram_abus.BUS_VRAM_A08n, 5, &gbs.dma_hi.NAFA_DMA_A08n);
    }
    ...
    if (gbs.cpu_signals.SIG_IN_CPU_WRp.state && DELTA_GH) {
      if (cpu_addr_new == 0xFF42) bit_copy_inv(reg_scy, gbs.cpu_dbus_old);
      if (cpu_addr_new == 0xFF43) bit_copy_inv(reg_scx, gbs.cpu_dbus_old);
    }

    if (gbs.cpu_signals.SIG_IN_CPU_RDp.state) {
      if (cpu_addr_new == 0xFF42) bit_copy_inv(gbs.cpu_dbus_new, reg_scy);
      if (cpu_addr_new == 0xFF43) bit_copy_inv(gbs.cpu_dbus_new, reg_scx);
    }
    ...
    if (tile_fetcher.LONY_FETCHINGp.state && !tile_fetcher.MESU_BFETCH_S1p.state && !tile_fetcher.NYVA_BFETCH_S2p.state && !win_reg.PYNU_WIN_MODE_Ap.state) {
      bit_unpack_inv(&gbs.vram_abus.BUS_VRAM_A00n, 5, sum_x >> 3);
      bit_unpack_inv(&gbs.vram_abus.BUS_VRAM_A05n, 5, sum_y >> 3);
      gbs.vram_abus.BUS_VRAM_A10n.state = reg_lcdc.XAFO_LCDC_BGMAPn.state;
      gbs.vram_abus.BUS_VRAM_A11n.state = 0;
      gbs.vram_abus.BUS_VRAM_A12n.state = 0;
    }
    ...
    if (!(TEVO_WIN_FETCH_TRIGp_old && PYNU_WIN_MODE_Ap_old) && TEVO_WIN_FETCH_TRIGp_new && win_reg.PYNU_WIN_MODE_Ap.state) {
      bit_unpack(win_x, win_map_x_old + 1);
    }

    if (!winen_new || line_rst_new || reg_lcdc.XONA_LCDC_LCDENn.state) bit_clear(win_x);
    ...
    auto win_y_old = lcd.POPU_y144p || reg_lcdc.XONA_LCDC_LCDENn ? 0 : bit_pack(win_y);

    if (PYNU_WIN_MODE_Ap_old && !win_reg.PYNU_WIN_MODE_Ap.state) {
      bit_unpack(win_y, win_y_old + 1);
    }

    if (lcd.POPU_y144p || reg_lcdc.XONA_LCDC_LCDENn) {
    ...
    if (tile_fetcher.LONY_FETCHINGp.state && !tile_fetcher.MESU_BFETCH_S1p.state && !tile_fetcher.NYVA_BFETCH_S2p.state && win_reg.PYNU_WIN_MODE_Ap.state) {
      ...
      bit_unpack(&gbs.vram_abus.BUS_VRAM_A00n, 5, wx);
      bit_unpack(&gbs.vram_abus.BUS_VRAM_A05n, 5, wy);
      bit_copy_inv(&gbs.vram_abus.BUS_VRAM_A05n, 5, &win_y.TUFU_WIN_MAP_Y0);

      addr |= reg_lcdc.WOKY_LCDC_WINMAPn.state << 10;

      gbs.vram_abus.BUS_VRAM_A10n.state = get_bit(addr, 10);
      gbs.vram_abus.BUS_VRAM_A11n.state = get_bit(addr, 11);
      gbs.vram_abus.BUS_VRAM_A12n.state = get_bit(addr, 12);
    }
    ...
    if (tile_fetcher.LONY_FETCHINGp.state && (tile_fetcher.MESU_BFETCH_S1p.state || tile_fetcher.NYVA_BFETCH_S2p.state)) {
      ...
      addr |= (win_reg.PYNU_WIN_MODE_Ap.state ? bit_pack(&win_y, 3) : bit_mask(sum_y, 3)) << 1;
      addr |= bit_pack(tile_temp_b) << 4;
      addr |= (!tile_temp_b.PYJU_TILE_DB7p.state && reg_lcdc.WEXU_LCDC_BGTILEn.state) << 12;

      bit_unpack_inv(gbs.vram_abus, addr);
    }
    ...
    if (sprite_fetcher.TEXY_SFETCHINGp.state) {
      ...
      auto line = bit_pack(gbs.sprite_lbus) ^ bit_widen(!gbs.oam_temp_b.YZOS_OAM_DB6p, 4);
      auto tile = bit_pack(gbs.oam_temp_a);
      ...
      bit_unpack_inv(&gbs.vram_abus.BUS_VRAM_A00n, 12, addr);
    }

    //--------------------------------------------
    // Vram address pin driver

    bit_copy(gbs.vram_ext_abus, gbs.vram_abus);

    //--------------------------------------------
    // CPU bus to Vram data bus

    if (gbs.cpu_signals.ABUZ_EXT_RAM_CS_CLK && gbs.XYMU_RENDERINGn && cpu_addr_vram_new && gbs.cpu_signals.SIG_IN_CPU_WRp.state) {
      bit_copy(gbs.vram_dbus, gbs.cpu_dbus_new);
    }

    //--------------------------------------------
    // Vram control pins

    if (gbs.XYMU_RENDERINGn.state) {
      wire APOV_CPU_WRp = CLK_xxxxEFGx && gbs.cpu_signals.SIG_IN_CPU_WRp.state;
      wire ABUZ_EXT_RAM_CS_CLK = CLK_xxCDEFGH && gbs.cpu_signals.SIG_IN_CPU_EXT_BUSp.state;

      if (dma_addr_vram_new) {
        gbs.vram_ext_ctrl.PIN_43_VRAM_CSn.state = 1;
        gbs.vram_ext_ctrl.PIN_45_VRAM_OEn.state = 1;
      }
      else {
        gbs.vram_ext_ctrl.PIN_43_VRAM_CSn.state = cpu_addr_vram_new && ABUZ_EXT_RAM_CS_CLK;
        gbs.vram_ext_ctrl.PIN_45_VRAM_OEn.state = !cpu_addr_vram_new || !gbs.cpu_signals.SIG_IN_CPU_WRp.state;
      }

      gbs.vram_ext_ctrl.PIN_49_VRAM_WRn.state = cpu_addr_vram_new && APOV_CPU_WRp && ABUZ_EXT_RAM_CS_CLK;
    }
    else {
      if (dma_addr_vram_new) {
        gbs.vram_ext_ctrl.PIN_43_VRAM_CSn.state = 1;
        gbs.vram_ext_ctrl.PIN_49_VRAM_WRn.state = 0;
        gbs.vram_ext_ctrl.PIN_45_VRAM_OEn.state = 1;
      }
        ...
        gbs.vram_ext_ctrl.PIN_43_VRAM_CSn.state = 1;
        gbs.vram_ext_ctrl.PIN_49_VRAM_WRn.state = 0;
        gbs.vram_ext_ctrl.PIN_45_VRAM_OEn.state = !sprite_fetcher.TYFO_SFETCH_S0p_D1.state || sprite_fetcher.TOXE_SFETCH_S0p.state;
      }
      else {
        gbs.vram_ext_ctrl.PIN_43_VRAM_CSn.state = 0;
        gbs.vram_ext_ctrl.PIN_49_VRAM_WRn.state = 0;
        gbs.vram_ext_ctrl.PIN_45_VRAM_OEn.state = 0;
      }
    }

    auto vram_addr = bit_pack_inv(gbs.vram_ext_abus);
    uint8_t data = 0xFF;

    if (gbs.vram_ext_ctrl.PIN_45_VRAM_OEn.state) {
    ...
    bit_clear(gbs.vram_ext_dbus);

    if (gbs.vram_ext_ctrl.PIN_45_VRAM_OEn.state) {
      bit_unpack_inv(gbs.vram_ext_dbus, vid_ram[vram_addr]);
    }

    if (gbs.vram_ext_ctrl.PIN_49_VRAM_WRn.state) {
      vid_ram[vram_addr] = (uint8_t)bit_pack_inv(gbs.vram_ext_dbus);
    }

    if (cpu_addr_vram_new && gbs.cpu_signals.ABUZ_EXT_RAM_CS_CLK.state && gbs.XYMU_RENDERINGn.state && gbs.cpu_signals.SIG_IN_CPU_WRp.state) {
      bit_copy_inv(gbs.vram_ext_dbus, gbs.vram_dbus);
    }
    ...
    if (!cpu_addr_vram_new || !gbs.cpu_signals.ABUZ_EXT_RAM_CS_CLK.state || !gbs.XYMU_RENDERINGn.state || !gbs.cpu_signals.SIG_IN_CPU_WRp.state) {
      bit_copy_inv(gbs.vram_dbus, gbs.vram_ext_dbus);
    }

    //--------------------------------------------
    // Vram bus to cpu bus

    if (cpu_addr_vram_new && gbs.cpu_signals.ABUZ_EXT_RAM_CS_CLK.state && gbs.XYMU_RENDERINGn.state && gbs.cpu_signals.SIG_IN_CPU_RDp.state && gbs.cpu_signals.SIG_IN_CPU_LATCH_EXT.state) {
      bit_copy(gbs.cpu_dbus_new, gbs.vram_dbus);
    }

    //--------------------------------------------
    // Vram bus to sprite x flipper

    wire XONO_FLIP_X = gbs.oam_temp_b.BAXO_OAM_DB5p.state && sprite_fetcher.TEXY_SFETCHINGp.state;

    flipped_sprite = {
      XONO_FLIP_X ? gbs.vram_dbus.BUS_VRAM_D07p.state : gbs.vram_dbus.BUS_VRAM_D00p.state,
      XONO_FLIP_X ? gbs.vram_dbus.BUS_VRAM_D06p.state : gbs.vram_dbus.BUS_VRAM_D01p.state,
      XONO_FLIP_X ? gbs.vram_dbus.BUS_VRAM_D05p.state : gbs.vram_dbus.BUS_VRAM_D02p.state,
      XONO_FLIP_X ? gbs.vram_dbus.BUS_VRAM_D04p.state : gbs.vram_dbus.BUS_VRAM_D03p.state,
      XONO_FLIP_X ? gbs.vram_dbus.BUS_VRAM_D03p.state : gbs.vram_dbus.BUS_VRAM_D04p.state,
      XONO_FLIP_X ? gbs.vram_dbus.BUS_VRAM_D02p.state : gbs.vram_dbus.BUS_VRAM_D05p.state,
      XONO_FLIP_X ? gbs.vram_dbus.BUS_VRAM_D01p.state : gbs.vram_dbus.BUS_VRAM_D06p.state,
      XONO_FLIP_X ? gbs.vram_dbus.BUS_VRAM_D00p.state : gbs.vram_dbus.BUS_VRAM_D07p.state,
    };
  }
  ...
  {
    wire cpu_rd = gbs.cpu_signals.SIG_IN_CPU_RDp.state;
    wire cpu_wr = gbs.cpu_signals.SIG_IN_CPU_WRp.state && CLK_xxxxEFGx;
  
    wire dbus_free = gbs.cpu_signals.SIG_IN_CPU_LATCH_EXT.state;
    ...
    gbs.oam_ctrl.MAKA_LATCH_EXTp.state = 0;

    bit_set(gbs.oam_abus);
    bit_set(gbs.oam_dbus_a);
    bit_set(gbs.oam_dbus_b);

    if (CLK_ABCDxxxx) {
      gbs.oam_ctrl.WUJE_CPU_OAM_WRn.state = 1;
    }

    if (addr_oam && cpu_wr) {
      gbs.oam_ctrl.WUJE_CPU_OAM_WRn.state = 0;
    }

    wire oam_clk_old = gbs.oam_ctrl.SIG_OAM_CLKn.state;

    if (dma_running_new) {
      bit_copy_inv(gbs.oam_abus, gbs.dma_lo);

      if ((dma_addr_new >= 0x8000) && (dma_addr_new <= 0x9FFF)) {
        bit_copy_inv(gbs.oam_dbus_a, gbs.vram_dbus);
        bit_copy_inv(gbs.oam_dbus_b, gbs.vram_dbus);
      }
      else {
        bit_copy(gbs.oam_dbus_a, gbs.ext_dbus);
        bit_copy(gbs.oam_dbus_b, gbs.ext_dbus);
      }

      gbs.oam_ctrl.SIG_OAM_CLKn .state = CLK_ABCDxxxx;
      gbs.oam_ctrl.SIG_OAM_WRn_A.state = CLK_ABCDxxxx || !gbs.oam_abus.BUS_OAM_A00n.state;
      gbs.oam_ctrl.SIG_OAM_WRn_B.state = CLK_ABCDxxxx ||  gbs.oam_abus.BUS_OAM_A00n.state;
      gbs.oam_ctrl.SIG_OAM_OEn  .state = !(dbus_busy && addr_oam && cpu_rd);
    }
    else if (scanning_new) {
      gbs.oam_abus.BUS_OAM_A00n.state = 1;
      gbs.oam_abus.BUS_OAM_A01n.state = 1;
      bit_copy_inv(&gbs.oam_abus.BUS_OAM_A02n, 6, &scan_counter);


      gbs.oam_ctrl.SIG_OAM_CLKn .state = (!vid_rst_new && gen_clk_new(0b10011001)) && (!vid_rst_new && gen_clk_new(0b11001100)) && (!addr_oam || !CLK_xxxxEFGH);
      gbs.oam_ctrl.SIG_OAM_WRn_A.state = 1;
      gbs.oam_ctrl.SIG_OAM_WRn_B.state = 1;
      gbs.oam_ctrl.SIG_OAM_OEn  .state = (!vid_rst_new && gen_clk_new(0b10011001)) && !(dbus_busy && addr_oam && cpu_rd);
    }
    else if (rendering_new) {
      gbs.oam_abus.BUS_OAM_A00n.state = 0;
      gbs.oam_abus.BUS_OAM_A01n.state = 0;
      bit_copy_inv(&gbs.oam_abus.BUS_OAM_A02n, 6, &gbs.sprite_ibus.BUS_SPR_I0);

      gbs.oam_ctrl.SIG_OAM_CLKn .state = 
      ...
      gbs.oam_ctrl.SIG_OAM_WRn_A.state = 1;
      gbs.oam_ctrl.SIG_OAM_WRn_B.state = 1;
      gbs.oam_ctrl.SIG_OAM_OEn  .state = 
      ...
      bit_copy_inv(gbs.oam_abus, gbs.cpu_abus_new);
      if (!gbs.oam_ctrl.WUJE_CPU_OAM_WRn.state) {
        bit_copy_inv(gbs.oam_dbus_a, gbs.cpu_dbus_new);
        bit_copy_inv(gbs.oam_dbus_b, gbs.cpu_dbus_new);
      }
      gbs.oam_ctrl.SIG_OAM_CLKn .state = CLK_ABCDxxxx;
      gbs.oam_ctrl.SIG_OAM_WRn_A.state = (!cpu_wr || !gbs.oam_abus.BUS_OAM_A00n.state);
      gbs.oam_ctrl.SIG_OAM_WRn_B.state = (!cpu_wr ||  gbs.oam_abus.BUS_OAM_A00n.state);
      gbs.oam_ctrl.SIG_OAM_OEn  .state = (!cpu_rd || !dbus_busy);
    }
    else {
      bit_copy_inv(gbs.oam_abus,   gbs.cpu_abus_new);
      bit_copy_inv(gbs.oam_dbus_a, gbs.cpu_dbus_new);
      bit_copy_inv(gbs.oam_dbus_b, gbs.cpu_dbus_new);
      gbs.oam_ctrl.SIG_OAM_CLKn .state = 1;
      gbs.oam_ctrl.SIG_OAM_WRn_A.state = 1;
      gbs.oam_ctrl.SIG_OAM_WRn_B.state = 1;
      gbs.oam_ctrl.SIG_OAM_OEn  .state = 1;
    }

    wire oam_clk_new = gbs.oam_ctrl.SIG_OAM_CLKn.state;

    // data in from oam
    uint8_t oam_data_a, oam_data_b;
    {

      uint8_t oam_addr = (uint8_t)bit_pack_inv(gbs.oam_abus) >> 1;
      oam_data_a = (uint8_t)bit_pack_inv(gbs.oam_dbus_a);
      oam_data_b = (uint8_t)bit_pack_inv(gbs.oam_dbus_b);

      if (oam_clk_old && !oam_clk_new) {
        if (!gbs.oam_ctrl.SIG_OAM_WRn_A.state) oam_ram[(oam_addr << 1) + 0] = oam_data_a;
        if (!gbs.oam_ctrl.SIG_OAM_WRn_B.state) oam_ram[(oam_addr << 1) + 1] = oam_data_b;
      }
      gbs.oam_ctrl.old_oam_clk = !gbs.oam_ctrl.SIG_OAM_CLKn.state;
    ...
    if (latch_oam) {
      bit_unpack_inv(gbs.oam_dbus_a, oam_data_a);
      bit_unpack_inv(gbs.oam_dbus_b, oam_data_b);
      bit_copy(gbs.oam_latch_a, gbs.oam_dbus_a);
      bit_copy(gbs.oam_latch_b, gbs.oam_dbus_b);
    }

    if (cpu_rd && dbus_free && addr_oam && !latch_oam && !dma_running_new && !scanning_new && !rendering_new) {
      if (gbs.oam_abus.BUS_OAM_A00n.state) {
        bit_copy_inv(gbs.cpu_dbus_new, gbs.oam_latch_a);
      }
      else {
        bit_copy_inv(gbs.cpu_dbus_new, gbs.oam_latch_b);
      }
    }
  }
...

  {
    ...
    if (gbs.zram_bus.clk_old.state && !gbs.cpu_signals.TAPU_CPU_WRp.state && CSp) {
      zero_ram[cpu_addr_new & 0x007F] = (uint8_t)bit_pack(gbs.cpu_dbus_old);
    }
    gbs.zram_bus.clk_old = gbs.cpu_signals.TAPU_CPU_WRp.state;

    uint8_t data = zero_ram[cpu_addr_new & 0x007F];

    if (CSp && gbs.cpu_signals.TEDO_CPU_RDp.state) {
      bit_unpack(gbs.cpu_dbus_new, data);
    }
  }
  ...
  {
    auto pack_cpu_dbus_old = bit_pack(gbs.cpu_dbus_old);
    auto pack_cpu_dbus_new = bit_pack(gbs.cpu_dbus_new);
    auto pack_ie = bit_pack(gbs.reg_ie);
    auto pack_if = bit_pack(gbs.reg_if);
    auto pack_stat = bit_pack(reg_stat);

    if (cpu_addr_new == 0xFFFF && gbs.cpu_signals.SIG_IN_CPU_WRp.state && DELTA_GH) {
      pack_ie = pack_cpu_dbus_old;
    }

    if (cpu_addr_new == 0xFF41 && gbs.cpu_signals.SIG_IN_CPU_WRp.state && DELTA_GH) {
    ...
    if (cpu_addr_new == 0xFF41 && cpu_rd_new) {
      ...
      data |= (!gbs.XYMU_RENDERINGn.state || lcd.POPU_y144p.state) << 0;
      data |= (!gbs.XYMU_RENDERINGn.state || sprite_scanner.ACYL_SCANNINGp.state) << 1;
    ...
    wire int_joy_new = !gbs.joy_int.APUG_JP_GLITCH3.state || !gbs.joy_int.BATU_JP_GLITCH0.state;
    wire int_tim_new = gbs.int_ctrl.MOBA_TIMER_OVERFLOWp.state;
    ...
    if (gbs.cpu_signals.SIG_IN_CPU_WRp.state & (cpu_addr_new == 0xFF0F) & gen_clk_new(0b00001110)) {
      pack_if = pack_cpu_dbus_new;
    }

    pack_if &= ~bit_pack(gbs.cpu_ack);

    if (cpu_addr_new == 0xFFFF && gbs.cpu_signals.SIG_IN_CPU_RDp.state) {
      pack_cpu_dbus_new = pack_ie | 0b11100000;
    }

    if (cpu_addr_new == 0xFF0F && gbs.cpu_signals.SIG_IN_CPU_RDp.state) {
      bit_unpack(gbs.latch_if,  pack_if);
      pack_cpu_dbus_new = pack_if | 0b11100000;
    }

    bit_unpack(gbs.cpu_dbus_new, pack_cpu_dbus_new);
    bit_unpack(gbs.cpu_int, pack_if);
    bit_unpack(gbs.reg_ie, pack_ie);
    bit_unpack(gbs.reg_if, pack_if);
