...
sample_t ch1_audio_out(const SpuChannel1& ch1) {
...
void tick_ch1(const GateBoyState& reg_old, GateBoyState& reg_new) {
...

  {
    ...
    /*#p13.EZEC*/ ch1_new.EZEC_CH1_TRIGp.dff17(DOVA_ABCDxxxx, DUKA_APU_RSTn_new, ch1_old.DUPE_NR14_TRIGp.qp_old());
    ...
    /*#p13.DUPE*/ ch1_new.DUPE_NR14_TRIGp.dff9(DOGE_FF14_WRn, DADO_NR14_RSTb, dbus_old.BUS_CPU_D07p.qp_old());
...

  {
    ...
    /*#p11.AVAF*/ ch1_new.AVAF_NR10_SWEEP_DIRp    .dff9(CENU_NR10_WRn, AGUR_APU_RSTn_new, dbus_old.BUS_CPU_D03p.qp_old());
    /*#p11.ADEK*/ ch1_new.ADEK_NR10_SWEEP_PERIOD0p.dff9(CENU_NR10_WRn, AGUR_APU_RSTn_new, dbus_old.BUS_CPU_D04p.qp_old());
    /*#p11.BANA*/ ch1_new.BANA_NR10_SWEEP_PERIOD1p.dff9(CENU_NR10_WRn, AGUR_APU_RSTn_new, dbus_old.BUS_CPU_D05p.qp_old());
    /*#p11.BOTU*/ ch1_new.BOTU_NR10_SWEEP_PERIOD2p.dff9(CENU_NR10_WRn, AGUR_APU_RSTn_new, dbus_old.BUS_CPU_D06p.qp_old());
  }

  {
    ...
    /*#p11.JUSA*/ ch1_new.JUSA_NR12_PERIOD0p.dff9(KYGY_NR12_WRn, HATO_APU_RSTn_new, dbus_old.BUS_CPU_D00p.qp_old());
    /*#p11.JUZY*/ ch1_new.JUZY_NR12_PERIOD1p.dff9(KYGY_NR12_WRn, HATO_APU_RSTn_new, dbus_old.BUS_CPU_D01p.qp_old());
    /*#p11.JOMA*/ ch1_new.JOMA_NR12_PERIOD2p.dff9(KYGY_NR12_WRn, HATO_APU_RSTn_new, dbus_old.BUS_CPU_D02p.qp_old());
    /*#p11.JAFY*/ ch1_new.JAFY_NR12_ENV_DIRp.dff9(KAGY_NR12_WRn, HATO_APU_RSTn_new, dbus_old.BUS_CPU_D03p.qp_old());
    /*#p11.JATY*/ ch1_new.JATY_NR12_VOL0p   .dff9(KAGY_NR12_WRn, HATO_APU_RSTn_new, dbus_old.BUS_CPU_D04p.qp_old());
    /*#p11.JAXO*/ ch1_new.JAXO_NR12_VOL1p   .dff9(KAGY_NR12_WRn, HATO_APU_RSTn_new, dbus_old.BUS_CPU_D05p.qp_old());
    /*#p11.JENA*/ ch1_new.JENA_NR12_VOL2p   .dff9(KAGY_NR12_WRn, HATO_APU_RSTn_new, dbus_old.BUS_CPU_D06p.qp_old());
    /*#p11.JOPU*/ ch1_new.JOPU_NR12_VOL3p   .dff9(KAGY_NR12_WRn, HATO_APU_RSTn_new, dbus_old.BUS_CPU_D07p.qp_old());
  }

  {
    /*#p13.BAVE*/ wire BAVE_SWEEP_ENn_new = and3(ch1_new.BOTU_NR10_SWEEP_PERIOD2p.qn_new(), ch1_new.BANA_NR10_SWEEP_PERIOD1p.qn_new(), ch1_new.ADEK_NR10_SWEEP_PERIOD0p.qn_new());
...

  {
    ...
    /*#p13.CUPO*/ ch1_new.CUPO_SWEEP_DELAY0p.dff20(CATE_SWEEP_DELAY_CLKn,                   CYMU_SWEEP_DELAY_LOADp, ch1_new.ADEK_NR10_SWEEP_PERIOD0p.qn_new());
    /*#p13.CYPU*/ ch1_new.CYPU_SWEEP_DELAY1p.dff20(ch1_new.CUPO_SWEEP_DELAY0p.qp_new(), CYMU_SWEEP_DELAY_LOADp, ch1_new.BANA_NR10_SWEEP_PERIOD1p.qn_new());
    /*#p13.CAXY*/ ch1_new.CAXY_SWEEP_DELAY2p.dff20(ch1_new.CYPU_SWEEP_DELAY1p.qp_new(), CYMU_SWEEP_DELAY_LOADp, ch1_new.BOTU_NR10_SWEEP_PERIOD2p.qn_new());
  }
  ...
  {
    /*#p13.BUGE*/ wire BUGE_SWEEP_ENp_new = nand3(ch1_new.ANAZ_NR10_SWEEP_SHIFT2p.qn_new(),
                                                  ch1_new.ARAX_NR10_SWEEP_SHIFT1p.qn_new(),
                                                  ch1_new.BANY_NR10_SWEEP_SHIFT0p.qn_new());
    ...
    /*#p13.COPA*/ ch1_new.COPA_SHIFTCNT0.dff20(DAPU_SHIFT_CLK,                      CYLU_SHIFTCNT_LOADp, ch1_new.BANY_NR10_SWEEP_SHIFT0p.qn_new());
    /*#p13.CAJA*/ ch1_new.CAJA_SHIFTCNT1.dff20(ch1_new.COPA_SHIFTCNT0.qp_new(), CYLU_SHIFTCNT_LOADp, ch1_new.ARAX_NR10_SWEEP_SHIFT1p.qn_new());
    /*#p13.BYRA*/ ch1_new.BYRA_SHIFTCNT2.dff20(ch1_new.CAJA_SHIFTCNT1.qp_new(), CYLU_SHIFTCNT_LOADp, ch1_new.ANAZ_NR10_SWEEP_SHIFT2p.qn_new());
  }
  ...
  /*#p12.ARYL*/ wire ARYL_NR10_SWEEP_DIRn_old = not1(ch1_old.AVAF_NR10_SWEEP_DIRp.qn_old());
  /*#p12.ARYL*/ wire ARYL_NR10_SWEEP_DIRn_new = not1(ch1_new.AVAF_NR10_SWEEP_DIRp.qn_new());
  ...
  /*#p11.BOKO*/ ch1_new.BOKO_NR14_LENENp.dff9(BAGE_NR14_WRn, CAMY_APU_RSTn_new, dbus_old.BUS_CPU_D06p.qp_old());
  ...
  {
    /*#p13.CAPY*/ wire CAPY_CH1_LEN_CLKn = nor3(ch1_old.CERO_CH1_LEN_DONE.qp_old(), BUFY_CLK_256, ch1_new.BOKO_NR14_LENENp.qn_new());
  ...
  {
    /*#p13.CAPY*/ wire CAPY_CH1_LEN_CLKn = nor3(ch1_new.CERO_CH1_LEN_DONE.qp_new(), BUFY_CLK_256, ch1_new.BOKO_NR14_LENENp.qn_new());
    /*#p13.CANU*/ wire CANU_CH1_LEN_CLKp = not1(CAPY_CH1_LEN_CLKn);
  ...
  /*#p13.HOCA*/ wire HOCA_CH1_AMP_ENn_new = nor5(ch1_new.JAFY_NR12_ENV_DIRp.qp_new(),
                                                 ch1_new.JATY_NR12_VOL0p.qp_new(),
                                                 ch1_new.JAXO_NR12_VOL1p.qp_new(),
                                                 ch1_new.JENA_NR12_VOL2p.qp_new(),
                                                 ch1_new.JOPU_NR12_VOL3p.qp_new());

  {
    /*#p13.BONE*/ wire BONE_FREQ_OVERFLOWp_new = not1(ATYS_FREQ_OVERFLOWn_new); 
    /*#p13.CYFA*/ wire CYFA_LEN_DONEp_new = and2(ch1_new.CERO_CH1_LEN_DONE.qp_new(), ch1_new.BOKO_NR14_LENENp.qp_new());
  ...
  /*#p13.KOMA*/ wire KOMA_ENV_OFFp_new = nor3(ch1_new.JUSA_NR12_PERIOD0p.qp_new(), ch1_new.JUZY_NR12_PERIOD1p.qp_new(), ch1_new.JOMA_NR12_PERIOD2p.qp_new());
  ...
  /*#p13.JOVA*/ ch1_new.JOVA_ENV_DELAY0p.dff20(JOLA_ENV_DELAY_CLK_64n,                KUXU_ENV_DELAY_LOADp, ch1_new.JUSA_NR12_PERIOD0p.qn_new());
  /*#p13.KENU*/ ch1_new.KENU_ENV_DELAY1p.dff20(ch1_new.JOVA_ENV_DELAY0p.qp_new(), KUXU_ENV_DELAY_LOADp, ch1_new.JUZY_NR12_PERIOD1p.qn_new());
  /*#p13.KERA*/ ch1_new.KERA_ENV_DELAY2p.dff20(ch1_new.KENU_ENV_DELAY1p.qp_new(), KUXU_ENV_DELAY_LOADp, ch1_new.JOMA_NR12_PERIOD2p.qn_new());

  {
    ...
    /*#p13.HUFU*/ wire HUFU_ENV_TOPn_old = nand5(ch1_old.JAFY_NR12_ENV_DIRp.qp_old(), ch1_old.HAFO_CH1_ENV0p.qp_old(), ch1_old.HEMY_CH1_ENV1p.qp_old(), ch1_old.HOKO_CH1_ENV2p.qp_old(), ch1_old.HEVO_CH1_ENV3p.qp_old());
    /*#p13.HANO*/ wire HANO_ENV_BOTp_old = nor5 (ch1_old.JAFY_NR12_ENV_DIRp.qp_old(), ch1_old.HAFO_CH1_ENV0p.qp_old(), ch1_old.HEMY_CH1_ENV1p.qp_old(), ch1_old.HOKO_CH1_ENV2p.qp_old(), ch1_old.HEVO_CH1_ENV3p.qp_old());
  ...
  /*#p13.JUFY*/ wire JUFY_ENV_CLK = amux2(ch1_new.JAFY_NR12_ENV_DIRp.qp_new(), KAKE_ENV_CLK, KAKE_ENV_CLK, ch1_new.JAFY_NR12_ENV_DIRp.qn_new());
  /*#p13.HAFO*/ ch1_new.HAFO_CH1_ENV0p.dff20(JUFY_ENV_CLK, ch1_new.FEKU_CH1_TRIGp.qp_new(), ch1_new.JATY_NR12_VOL0p.qp_new());

  /*#p13.HYTO*/ wire HYTO_ENV_CLK = amux2(ch1_new.JAFY_NR12_ENV_DIRp.qp_new(), ch1_new.HAFO_CH1_ENV0p.qp_new(), ch1_new.HAFO_CH1_ENV0p.qn_new(), ch1_new.JAFY_NR12_ENV_DIRp.qn_new());
  /*#p13.HEMY*/ ch1_new.HEMY_CH1_ENV1p.dff20(HYTO_ENV_CLK, ch1_new.FEKU_CH1_TRIGp.qp_new(), ch1_new.JAXO_NR12_VOL1p.qp_new());

  /*#p13.HETO*/ wire HETO_ENV_CLK = amux2(ch1_new.JAFY_NR12_ENV_DIRp.qp_new(), ch1_new.HEMY_CH1_ENV1p.qp_new(), ch1_new.HEMY_CH1_ENV1p.qn_new(), ch1_new.JAFY_NR12_ENV_DIRp.qn_new());
  /*#p13.HOKO*/ ch1_new.HOKO_CH1_ENV2p.dff20(HETO_ENV_CLK, ch1_new.FEKU_CH1_TRIGp.qp_new(), ch1_new.JENA_NR12_VOL2p.qp_new());

  /*#p13.HESU*/ wire HESU_ENV_CLK = amux2(ch1_new.JAFY_NR12_ENV_DIRp.qp_new(), ch1_new.HOKO_CH1_ENV2p.qp_new(), ch1_new.HOKO_CH1_ENV2p.qn_new(), ch1_new.JAFY_NR12_ENV_DIRp.qn_new());
  /*#p13.HEVO*/ ch1_new.HEVO_CH1_ENV3p.dff20(HESU_ENV_CLK, ch1_new.FEKU_CH1_TRIGp.qp_new(), ch1_new.JOPU_NR12_VOL3p.qp_new());
...

  {
    ...
    /*#p13.COSO*/ wire COSO_old = nor2(ch1_old.CENA_NR11_DUTY0p.qp_old(), ch1_old.DYCA_NR11_DUTY1p.qp_old());
    /*#p13.CAVA*/ wire CAVA_old = nor2(ch1_old.CENA_NR11_DUTY0p.qn_old(), ch1_old.DYCA_NR11_DUTY1p.qp_old());
    /*#p13.CEVU*/ wire CEVU_old = nor2(ch1_old.CENA_NR11_DUTY0p.qp_old(), ch1_old.DYCA_NR11_DUTY1p.qn_old());
    /*#p13.CAXO*/ wire CAXO_old = nor2(ch1_old.CENA_NR11_DUTY0p.qn_old(), ch1_old.DYCA_NR11_DUTY1p.qn_old());
...

  {
    ...
    /*#p11.CENA*/ ch1_new.CENA_NR11_DUTY0p.dff9(DAFO_NR11_CLK, CEPO_APU_RSTn_new, dbus_old.BUS_CPU_D06p.qp_old());
    /*#p11.DYCA*/ ch1_new.DYCA_NR11_DUTY1p.dff9(DAFO_NR11_CLK, CEPO_APU_RSTn_new, dbus_old.BUS_CPU_D07p.qp_old());
  }

  {
    ...
    /*#p11.AMYD*/ triwire AMYD_NR10_SWEEP_SHIFT0  = tri6_nn(ASOP_NR10_RDn, ch1_new.BANY_NR10_SWEEP_SHIFT0p .qn_new());
    /*#p11.ATAX*/ triwire ATAX_NR10_SWEEP_SHIFT1  = tri6_nn(ASOP_NR10_RDn, ch1_new.ARAX_NR10_SWEEP_SHIFT1p .qn_new());
    /*#p11.AZYP*/ triwire AZYP_NR10_SWEEP_SHIFT2  = tri6_nn(ASOP_NR10_RDn, ch1_new.ANAZ_NR10_SWEEP_SHIFT2p .qn_new());
    /*#p11.AFOX*/ triwire AFOX_NR10_SWEEP_NEGATE  = tri6_nn(ASOP_NR10_RDn, ch1_new.AVAF_NR10_SWEEP_DIRp    .qn_new());
    /*#p11.AVEK*/ triwire AVEK_NR10_SWEEP_PERIOD0 = tri6_nn(ASOP_NR10_RDn, ch1_new.ADEK_NR10_SWEEP_PERIOD0p.qn_new());
    /*#p11.AKUX*/ triwire AKUX_NR10_SWEEP_PERIOD1 = tri6_nn(ASOP_NR10_RDn, ch1_new.BANA_NR10_SWEEP_PERIOD1p.qn_new());
    /*#p11.AWOS*/ triwire AWOS_NR10_SWEEP_PERIOD2 = tri6_nn(ASOP_NR10_RDn, ch1_new.BOTU_NR10_SWEEP_PERIOD2p.qn_new());
...

  {
    ...
    /*#p11.BOWO*/ triwire BOWO = tri6_nn(BEXU_NR11_RDn, ch1_new.CENA_NR11_DUTY0p.qn_new());
    /*#p11.CUDA*/ triwire CUDA = tri6_nn(BEXU_NR11_RDn, ch1_new.DYCA_NR11_DUTY1p.qn_new());
...

  {
    ...
    /*#p11.JYNE*/ triwire JYNE = tri6_nn(HAMY_NR12_RDn, ch1_new.JUSA_NR12_PERIOD0p .qn_new());
    /*#p11.JACA*/ triwire JACA = tri6_nn(HAMY_NR12_RDn, ch1_new.JUZY_NR12_PERIOD1p .qn_new());
    /*#p11.JOKU*/ triwire JOKU = tri6_nn(HAMY_NR12_RDn, ch1_new.JOMA_NR12_PERIOD2p .qn_new());
    /*#p11.HONO*/ triwire HONO = tri6_nn(HOCU_NR12_RDn, ch1_new.JAFY_NR12_ENV_DIRp.qn_new());
    /*#p11.HOWU*/ triwire HOWU = tri6_nn(HOCU_NR12_RDn, ch1_new.JATY_NR12_VOL0p   .qn_new());
    /*#p11.HEWA*/ triwire HEWA = tri6_nn(HOCU_NR12_RDn, ch1_new.JAXO_NR12_VOL1p   .qn_new());
    /*#p11.HEVE*/ triwire HEVE = tri6_nn(HOCU_NR12_RDn, ch1_new.JENA_NR12_VOL2p   .qn_new());
    /*#p11.JYSE*/ triwire JYSE = tri6_nn(HOCU_NR12_RDn, ch1_new.JOPU_NR12_VOL3p   .qn_new());
...

  {
    ...
    /*#p11.BYTU*/ triwire BYTU = tri6_nn(BALE_NR14_RDn, ch1_new.BOKO_NR14_LENENp.qn_new());
...
)
{
  ...
  auto AJER_AxxDExxH = spu_new.AJER_AxxDExxH.qp_any();
  ...
  {
    /*#p13.DUKA*/ wire DUKA_APU_RSTn_new = not1(KEBA_APU_RSTp);
    /*#p13.EZEC*/ ch1_new.EZEC_CH1_TRIGp.dff17(DOVA_ABCDxxxx, DUKA_APU_RSTn_new, ch1_old.DUPE_NR14_TRIGp.qp_any());

    /*#p13.DOGE*/ wire DOGE_FF14_WRn = nand2(BOGY_CPU_WRp, DUJA_ADDR_FF14p);
    /*#p13.DADO*/ wire DADO_NR14_RSTb = nor2(KEBA_APU_RSTp, ch1_new.EZEC_CH1_TRIGp.qp_any());
    /*#p13.DUPE*/ ch1_new.DUPE_NR14_TRIGp.dff9(DOGE_FF14_WRn, DADO_NR14_RSTb, cpu_dbus_old.BUS_CPU_D07p.qp_any());

    /*#p13.ERUM*/ wire ERUM_APU_RSTn_new = not1(KEBA_APU_RSTp);
    /*#p13.FYTE*/ ch1_new.FYTE_CH1_TRIGp.dff17(DYFA_xBCDExxx_new, ERUM_APU_RSTn_new, ch1_old.FARE_CH1_TRIGp.qp_any());
    /*#p13.FARE*/ ch1_new.FARE_CH1_TRIGp.dff17(DYFA_xBCDExxx_new, ERUM_APU_RSTn_new, ch1_old.FEKU_CH1_TRIGp.qp_any());

    /*#p13.EGET*/ wire EGET_TRIG_RSTn = nor2(KEBA_APU_RSTp, ch1_new.FARE_CH1_TRIGp.qp_any());
    /*#p13.FEKU*/ ch1_new.FEKU_CH1_TRIGp.dff17(DYFA_xBCDExxx_new, EGET_TRIG_RSTn, ch1_old.FYFO_CH1_TRIGn.qn_any()); // schematic wrong?

    /*#p13.GEFE*/ wire GEFE_TRIG_RSTp = not1(EGET_TRIG_RSTn);
    /*#p13.FYFO*/ ch1_new.FYFO_CH1_TRIGn.nor_latch(GEFE_TRIG_RSTp, ch1_new.EZEC_CH1_TRIGp.qp_any());
  }
...

  {
    ...
    /*#p11.AVAF*/ ch1_new.AVAF_NR10_SWEEP_DIRp    .dff9(CENU_NR10_WRn, AGUR_APU_RSTn_new, cpu_dbus_old.BUS_CPU_D03p.qp_any());
    /*#p11.ADEK*/ ch1_new.ADEK_NR10_SWEEP_PERIOD0p.dff9(CENU_NR10_WRn, AGUR_APU_RSTn_new, cpu_dbus_old.BUS_CPU_D04p.qp_any());
    /*#p11.BANA*/ ch1_new.BANA_NR10_SWEEP_PERIOD1p.dff9(CENU_NR10_WRn, AGUR_APU_RSTn_new, cpu_dbus_old.BUS_CPU_D05p.qp_any());
    /*#p11.BOTU*/ ch1_new.BOTU_NR10_SWEEP_PERIOD2p.dff9(CENU_NR10_WRn, AGUR_APU_RSTn_new, cpu_dbus_old.BUS_CPU_D06p.qp_any());
  }

  {
    ...
    /*#p11.JUSA*/ ch1_new.JUSA_NR12_PERIOD0p.dff9(KYGY_NR12_WRn, HATO_APU_RSTn_new, cpu_dbus_old.BUS_CPU_D00p.qp_any());
    /*#p11.JUZY*/ ch1_new.JUZY_NR12_PERIOD1p.dff9(KYGY_NR12_WRn, HATO_APU_RSTn_new, cpu_dbus_old.BUS_CPU_D01p.qp_any());
    /*#p11.JOMA*/ ch1_new.JOMA_NR12_PERIOD2p.dff9(KYGY_NR12_WRn, HATO_APU_RSTn_new, cpu_dbus_old.BUS_CPU_D02p.qp_any());
    /*#p11.JAFY*/ ch1_new.JAFY_NR12_ENV_DIRp.dff9(KAGY_NR12_WRn, HATO_APU_RSTn_new, cpu_dbus_old.BUS_CPU_D03p.qp_any());
    /*#p11.JATY*/ ch1_new.JATY_NR12_VOL0p   .dff9(KAGY_NR12_WRn, HATO_APU_RSTn_new, cpu_dbus_old.BUS_CPU_D04p.qp_any());
    /*#p11.JAXO*/ ch1_new.JAXO_NR12_VOL1p   .dff9(KAGY_NR12_WRn, HATO_APU_RSTn_new, cpu_dbus_old.BUS_CPU_D05p.qp_any());
    /*#p11.JENA*/ ch1_new.JENA_NR12_VOL2p   .dff9(KAGY_NR12_WRn, HATO_APU_RSTn_new, cpu_dbus_old.BUS_CPU_D06p.qp_any());
    /*#p11.JOPU*/ ch1_new.JOPU_NR12_VOL3p   .dff9(KAGY_NR12_WRn, HATO_APU_RSTn_new, cpu_dbus_old.BUS_CPU_D07p.qp_any());
  }

  {
    /*#p13.BAVE*/ wire BAVE_SWEEP_ENn_new = and3(ch1_new.BOTU_NR10_SWEEP_PERIOD2p.qn_any(), ch1_new.BANA_NR10_SWEEP_PERIOD1p.qn_any(), ch1_new.ADEK_NR10_SWEEP_PERIOD0p.qn_any());
    /*#p13.BURY*/ wire BURY_SWEEP_TRIG_RSTn = nor2(BAVE_SWEEP_ENn_new, KEBA_APU_RSTp);
    /*#p13.COZE*/ wire COZE_SWEEP_DELAY_MAX_old = and3(ch1_old.CAXY_SWEEP_DELAY2p.qp_any(), ch1_old.CYPU_SWEEP_DELAY1p.qp_any(), ch1_old.CUPO_SWEEP_DELAY0p.qp_any());
    /*#p13.BEXA*/ ch1_new.BEXA_SWEEP_TRIGp.dff17(AJER_AxxDExxH, BURY_SWEEP_TRIG_RSTn, COZE_SWEEP_DELAY_MAX_old);
  }

  {
    /*_p09.ATYV*/ wire ATYV_APU_RSTn_new = not1(KEBA_APU_RSTp);
    /*#p09.BAZA*/ ch1_new.BAZA_DBG_SWEEP_CLK.dff17(AJER_AxxDExxH, ATYV_APU_RSTn_new, spu_old.BOWY_NR52_DBG_SWEEP.qp_any());
    /*_p09.EDEK*/ wire EDEK_NR52_DBG_APUp = not1(FERO_NR52_DBG_APUp);
    /*#p09.CELY*/ wire CELY_SWEEP_DELAY_CLKn = mux2p(EDEK_NR52_DBG_APUp, ch1_new.BAZA_DBG_SWEEP_CLK.qp_any(), BYFE_CLK_128);
    /*#p09.CONE*/ wire CONE_SWEEP_DELAY_CLKp = not1(CELY_SWEEP_DELAY_CLKn);
    /*#p09.CATE*/ wire CATE_SWEEP_DELAY_CLKn = not1(CONE_SWEEP_DELAY_CLKp);

    /*#p13.DAFA*/ wire DAFA_SWEEP_DELAY_LOADn = nor2(ch1_new.BEXA_SWEEP_TRIGp.qp_any(), ch1_new.FEKU_CH1_TRIGp.qp_any());
    /*#p13.CYMU*/ wire CYMU_SWEEP_DELAY_LOADp = not1(DAFA_SWEEP_DELAY_LOADn);

    /*#p13.CUPO*/ ch1_new.CUPO_SWEEP_DELAY0p.dff20(CATE_SWEEP_DELAY_CLKn, CYMU_SWEEP_DELAY_LOADp, ch1_new.ADEK_NR10_SWEEP_PERIOD0p.qn_any());
    /*#p13.CYPU*/ ch1_new.CYPU_SWEEP_DELAY1p.dff20(ch1_new.CUPO_SWEEP_DELAY0p.qp_any(), CYMU_SWEEP_DELAY_LOADp, ch1_new.BANA_NR10_SWEEP_PERIOD1p.qn_any());
    /*#p13.CAXY*/ ch1_new.CAXY_SWEEP_DELAY2p.dff20(ch1_new.CYPU_SWEEP_DELAY1p.qp_any(), CYMU_SWEEP_DELAY_LOADp, ch1_new.BOTU_NR10_SWEEP_PERIOD2p.qn_any());
  }

  {
    /*#p13.ATAT*/ wire ATAT_SWEEP_TRIGn = nor2(KEBA_APU_RSTp, ch1_new.BEXA_SWEEP_TRIGp.qp_any());
    /*#p13.COPY*/ wire COPY_SHIFT_DONEp_old = and3(ch1_old.BYRA_SHIFTCNT2.qp_any(), ch1_old.CAJA_SHIFTCNT1.qp_any(), ch1_old.COPA_SHIFTCNT0.qp_any());
    /*#p13.BYTE*/ ch1_new.BYTE_SHIFT_DONEp.dff17(AJER_AxxDExxH, ATAT_SWEEP_TRIGn, COPY_SHIFT_DONEp_old);
  }

  {
    /*#p13.ADAD*/ wire ADAD_SHIFT_DONEp = not1(ch1_new.BYTE_SHIFT_DONEp.qn_any());
    /*#p13.EPUK*/ wire EPUK_STOP_SHIFTINGn = nor2(KEBA_APU_RSTp, ADAD_SHIFT_DONEp);
    /*#p13.EVOL*/ wire EVOL_START_SHIFTINGn = nor2(ch1_new.BEXA_SWEEP_TRIGp.qp_any(), ch1_new.FYTE_CH1_TRIGp.qp_any());
    /*#p13.FEMU*/ ch1_new.FEMU_SHIFTINGn.nand_latch(EPUK_STOP_SHIFTINGn, EVOL_START_SHIFTINGn);
  }

  {
    /*#p13.BUGE*/ wire BUGE_SWEEP_ENp_new = nand3(ch1_new.ANAZ_NR10_SWEEP_SHIFT2p.qn_any(),
      ch1_new.ARAX_NR10_SWEEP_SHIFT1p.qn_any(),
      ch1_new.BANY_NR10_SWEEP_SHIFT0p.qn_any());
    /*#p13.EGYP*/ wire EGYP_SHIFT_CLK_new = nor2(ch1_new.FEMU_SHIFTINGn.qp_any(), DYFA_xBCDExxx_new);
    /*#p13.CELE*/   wire CELE_SWEEP_ENn_new = not1(BUGE_SWEEP_ENp_new);
    /*#p13.DODY*/ wire DODY_SHIFT_CLK_new = nor2(EGYP_SHIFT_CLK_new, CELE_SWEEP_ENn_new); // border color wrong on die
    /*?p13.EGOR*/ wire EGOR_SHIFT_CLK_new = not1(DODY_SHIFT_CLK_new); // This looks like a nor3, but it almost definiteily is a not1.

    /*#p13.DAPU*/ wire DAPU_SHIFT_CLK = not1(EGOR_SHIFT_CLK_new);
    /*#p13.DACU*/ wire DACU_SHIFTCNT_LOADn = nor2(ch1_new.FEKU_CH1_TRIGp.qp_any(), ch1_new.BEXA_SWEEP_TRIGp.qp_any());
    /*#p13.CYLU*/ wire CYLU_SHIFTCNT_LOADp = not1(DACU_SHIFTCNT_LOADn);
    /*#p13.COPA*/ ch1_new.COPA_SHIFTCNT0.dff20(DAPU_SHIFT_CLK, CYLU_SHIFTCNT_LOADp, ch1_new.BANY_NR10_SWEEP_SHIFT0p.qn_any());
    /*#p13.CAJA*/ ch1_new.CAJA_SHIFTCNT1.dff20(ch1_new.COPA_SHIFTCNT0.qp_any(), CYLU_SHIFTCNT_LOADp, ch1_new.ARAX_NR10_SWEEP_SHIFT1p.qn_any());
    /*#p13.BYRA*/ ch1_new.BYRA_SHIFTCNT2.dff20(ch1_new.CAJA_SHIFTCNT1.qp_any(), CYLU_SHIFTCNT_LOADp, ch1_new.ANAZ_NR10_SWEEP_SHIFT2p.qn_any());
  }

  // Frequency summer

  /*#p13.ADAD*/ wire ADAD_SHIFT_DONEp_new = not1(ch1_new.BYTE_SHIFT_DONEp.qn_any());
  /*#p13.KABA*/   wire KABA_SUM_RSTp_new = or2(KEBA_APU_RSTp, ch1_new.FEKU_CH1_TRIGp.qp_any());
  /*#p13.KYNY*/ wire KYNY_SUM_RSTn_new = not1(KABA_SUM_RSTp_new);

  /*_p12.GALO*/ ch1_new.GALO_SUM_A00.dff11(ADAD_SHIFT_DONEp_new, KYNY_SUM_RSTn_new, ch1_old.HYKA_NR13_FREQ00.qp_any());
  /*_p12.JODE*/ ch1_new.JODE_SUM_A01.dff11(ADAD_SHIFT_DONEp_new, KYNY_SUM_RSTn_new, ch1_old.JYKA_NR13_FREQ01.qp_any());
  /*_p12.KARE*/ ch1_new.KARE_SUM_A02.dff11(ADAD_SHIFT_DONEp_new, KYNY_SUM_RSTn_new, ch1_old.HAVO_NR13_FREQ02.qp_any());
  /*_p12.JYME*/ ch1_new.JYME_SUM_A03.dff11(ADAD_SHIFT_DONEp_new, KYNY_SUM_RSTn_new, ch1_old.EDUL_NR13_FREQ03.qp_any());
  /*_p12.GYME*/ ch1_new.GYME_SUM_A04.dff11(ADAD_SHIFT_DONEp_new, KYNY_SUM_RSTn_new, ch1_old.FELY_NR13_FREQ04.qp_any());
  /*_p12.FAXO*/ ch1_new.FAXO_SUM_A05.dff11(ADAD_SHIFT_DONEp_new, KYNY_SUM_RSTn_new, ch1_old.HOLU_NR13_FREQ05.qp_any());
  /*_p12.EXAP*/ ch1_new.EXAP_SUM_A06.dff11(ADAD_SHIFT_DONEp_new, KYNY_SUM_RSTn_new, ch1_old.HYXU_NR13_FREQ06.qp_any());
  /*_p12.DELE*/ ch1_new.DELE_SUM_A07.dff11(ADAD_SHIFT_DONEp_new, KYNY_SUM_RSTn_new, ch1_old.HOPO_NR13_FREQ07.qp_any());
  /*_p12.DEXE*/ ch1_new.DEXE_SUM_A08.dff11(ADAD_SHIFT_DONEp_new, KYNY_SUM_RSTn_new, ch1_old.DYGY_NR14_FREQ08.qp_any());
  /*_p12.DOFY*/ ch1_new.DOFY_SUM_A09.dff11(ADAD_SHIFT_DONEp_new, KYNY_SUM_RSTn_new, ch1_old.EVAB_NR14_FREQ09.qp_any());
  /*_p12.DOLY*/ ch1_new.DOLY_SUM_A10.dff11(ADAD_SHIFT_DONEp_new, KYNY_SUM_RSTn_new, ch1_old.AXAN_NR14_FREQ10.qp_any());

  /*#p12.ARYL*/ wire ARYL_NR10_SWEEP_DIRn_old = not1(ch1_old.AVAF_NR10_SWEEP_DIRp.qn_any());
  /*#p12.ARYL*/ wire ARYL_NR10_SWEEP_DIRn_new = not1(ch1_new.AVAF_NR10_SWEEP_DIRp.qn_any());

  /*_p12.GYLO*/ wire GYLO_SHIFTER_FLIP_00_old = xor2(ARYL_NR10_SWEEP_DIRn_old, ch1_old.FABU_CH1_SHIFT00.qp_any());
  /*_p12.GELA*/ wire GELA_SHIFTER_FLIP_01_old = xor2(ARYL_NR10_SWEEP_DIRn_old, ch1_old.JEFA_CH1_SHIFT01.qp_any());
  /*_p12.GOPO*/ wire GOPO_SHIFTER_FLIP_02_old = xor2(ARYL_NR10_SWEEP_DIRn_old, ch1_old.GOGA_CH1_SHIFT02.qp_any());
  /*_p12.HEFY*/ wire HEFY_SHIFTER_FLIP_03_old = xor2(ARYL_NR10_SWEEP_DIRn_old, ch1_old.JOLU_CH1_SHIFT03.qp_any());
  /*_p12.KEFE*/ wire KEFE_SHIFTER_FLIP_04_old = xor2(ARYL_NR10_SWEEP_DIRn_old, ch1_old.JOTA_CH1_SHIFT04.qp_any());
  /*_p12.GOLY*/ wire GOLY_SHIFTER_FLIP_05_old = xor2(ARYL_NR10_SWEEP_DIRn_old, ch1_old.FUDE_CH1_SHIFT05.qp_any());
  /*_p12.FURE*/ wire FURE_SHIFTER_FLIP_06_old = xor2(ARYL_NR10_SWEEP_DIRn_old, ch1_old.FEDO_CH1_SHIFT06.qp_any());
  /*_p12.DYME*/ wire DYME_SHIFTER_FLIP_07_old = xor2(ARYL_NR10_SWEEP_DIRn_old, ch1_old.EXAC_CH1_SHIFT07.qp_any());
  /*_p12.CALE*/ wire CALE_SHIFTER_FLIP_08_old = xor2(ARYL_NR10_SWEEP_DIRn_old, ch1_old.ELUX_CH1_SHIFT08.qp_any());
  /*_p12.DOZY*/ wire DOZY_SHIFTER_FLIP_09_old = xor2(ARYL_NR10_SWEEP_DIRn_old, ch1_old.AGEZ_CH1_SHIFT09.qp_any());
  /*_p12.CULU*/ wire CULU_SHIFTER_FLIP_10_old = xor2(ARYL_NR10_SWEEP_DIRn_old, ch1_old.BEKU_CH1_SHIFT10.qp_any());
  ...
  /*#p12.GUXA*/ Adder GUXA_SUM00 = add3(ch1_new.GALO_SUM_A00.qp_any(), ch1_new.HORA_SUM_B00.qp_any(), ARYL_NR10_SWEEP_DIRn_new);
  /*_p12.HALU*/ Adder HALU_SUM01 = add3(ch1_new.JODE_SUM_A01.qp_any(), ch1_new.HOPA_SUM_B01.qp_any(), GUXA_SUM00.carry);
  /*_p12.JULE*/ Adder JULE_SUM02 = add3(ch1_new.KARE_SUM_A02.qp_any(), ch1_new.HELE_SUM_B02.qp_any(), HALU_SUM01.carry);
  /*_p12.JORY*/ Adder JORY_SUM03 = add3(ch1_new.JYME_SUM_A03.qp_any(), ch1_new.JAPE_SUM_B03.qp_any(), JULE_SUM02.carry);
  /*_p12.HEXO*/ Adder HEXO_SUM04 = add3(ch1_new.GYME_SUM_A04.qp_any(), ch1_new.JETE_SUM_B04.qp_any(), JORY_SUM03.carry);
  /*_p12.GEVA*/ Adder GEVA_SUM05 = add3(ch1_new.FAXO_SUM_A05.qp_any(), ch1_new.GELE_SUM_B05.qp_any(), HEXO_SUM04.carry);
  /*#p12.FEGO*/ Adder FEGO_SUM06 = add3(ch1_new.EXAP_SUM_A06.qp_any(), ch1_new.EPYR_SUM_B06.qp_any(), GEVA_SUM05.carry);
  /*_p12.ETEK*/ Adder ETEK_SUM07 = add3(ch1_new.DELE_SUM_A07.qp_any(), ch1_new.EDOK_SUM_B07.qp_any(), FEGO_SUM06.carry);
  /*_p12.DYXE*/ Adder DYXE_SUM08 = add3(ch1_new.DEXE_SUM_A08.qp_any(), ch1_new.DEFA_SUM_B08.qp_any(), ETEK_SUM07.carry);
  /*_p12.DULE*/ Adder DULE_SUM09 = add3(ch1_new.DOFY_SUM_A09.qp_any(), ch1_new.ETER_SUM_B09.qp_any(), DYXE_SUM08.carry);
  /*_p12.CORU*/ Adder CORU_SUM10 = add3(ch1_new.DOLY_SUM_A10.qp_any(), ch1_new.DEVA_SUM_B10.qp_any(), DULE_SUM09.carry);
...

  {
    ...
    /*#p13.ATUV*/ wire ATUV_FREQ_CLK = and2(ch1_new.BEXA_SWEEP_TRIGp.qp_any(), ATYS_FREQ_OVERFLOWn_new);
    /*#p13.BOJE*/ wire BOJE_FREQ_CLK = and2(ATUV_FREQ_CLK, BUGE_SWEEP_ENp_new);
    /*#p13.BUSO*/ wire BUSO_FREQ_CLK = and3(ch1_new.BEXA_SWEEP_TRIGp.qp_any(), ATYS_FREQ_OVERFLOWn_new, BUGE_SWEEP_ENp_new);

    /*#p12.GYLU*/ wire GYLU_FREQ00_SET = nand2(DYLA_FF13_WRp, cpu_dbus_new.BUS_CPU_D00p.qp_any());
    /*#p12.GETA*/ wire GETA_FREQ01_SET = nand2(DYLA_FF13_WRp, cpu_dbus_new.BUS_CPU_D01p.qp_any());
    /*#p12.GOLO*/ wire GOLO_FREQ02_SET = nand2(DYLA_FF13_WRp, cpu_dbus_new.BUS_CPU_D02p.qp_any());
    /*#p12.GOPE*/ wire GOPE_FREQ03_SET = nand2(DYLA_FF13_WRp, cpu_dbus_new.BUS_CPU_D03p.qp_any());
    /*#p12.KOVU*/ wire KOVU_FREQ04_SET = nand2(DYLA_FF13_WRp, cpu_dbus_new.BUS_CPU_D04p.qp_any());
    /*#p12.KYPA*/ wire KYPA_FREQ05_SET = nand2(DYLA_FF13_WRp, cpu_dbus_new.BUS_CPU_D05p.qp_any());
    /*#p12.ELER*/ wire ELER_FREQ06_SET = nand2(DYLA_FF13_WRp, cpu_dbus_new.BUS_CPU_D06p.qp_any());
    /*#p12.ETOL*/ wire ETOL_FREQ07_SET = nand2(DYLA_FF13_WRp, cpu_dbus_new.BUS_CPU_D07p.qp_any());
    /*#p12.BUGU*/ wire BUGU_FREQ08_SET = nand2(DEBY_FF14_WRp, cpu_dbus_new.BUS_CPU_D00p.qp_any());
    /*#p12.BUDO*/ wire BUDO_FREQ09_SET = nand2(DEBY_FF14_WRp, cpu_dbus_new.BUS_CPU_D01p.qp_any());
    /*#p12.AFEG*/ wire AFEG_FREQ10_SET = nand2(DEBY_FF14_WRp, cpu_dbus_new.BUS_CPU_D02p.qp_any());

    /*#p12.DEKE*/ wire DEKE = not1(cpu_dbus_new.BUS_CPU_D00p.qp_any());
    /*#p12.GULU*/ wire GULU = not1(cpu_dbus_new.BUS_CPU_D01p.qp_any());
    /*#p12.FULE*/ wire FULE = not1(cpu_dbus_new.BUS_CPU_D02p.qp_any());
    /*#p12.ETUV*/ wire ETUV = not1(cpu_dbus_new.BUS_CPU_D03p.qp_any());
    /*#p12.KOPU*/ wire KOPU = not1(cpu_dbus_new.BUS_CPU_D04p.qp_any());
    /*#p12.JULO*/ wire JULO = not1(cpu_dbus_new.BUS_CPU_D05p.qp_any());
    /*#p12.DYLU*/ wire DYLU = not1(cpu_dbus_new.BUS_CPU_D06p.qp_any());
    /*#p12.DULO*/ wire DULO = not1(cpu_dbus_new.BUS_CPU_D07p.qp_any());
    /*#p12.BYSU*/ wire BYSU = not1(cpu_dbus_new.BUS_CPU_D00p.qp_any());
    /*#p12.BOFU*/ wire BOFU = not1(cpu_dbus_new.BUS_CPU_D01p.qp_any());
    /*#p12.BYFU*/ wire BYFU = not1(cpu_dbus_new.BUS_CPU_D02p.qp_any());
  ...
  {
    /*#p13.KALA*/ wire KALA_SHIFTER_LOADn = nor2(ch1_new.BEXA_SWEEP_TRIGp.qp_any(), ch1_new.FEKU_CH1_TRIGp.qp_any());
    /*#p12.KAPE*/ wire KAPE_SHIFTER_LOADp = not1(KALA_SHIFTER_LOADn);
    /*#p12.JUJU*/ wire JUJU_SHIFTER_LOADp = not1(KALA_SHIFTER_LOADn);
    /*#p12.KEDO*/ wire KEDO_SHIFTER_LOADp = not1(KALA_SHIFTER_LOADn);

    /*_p12.JUTA*/ wire JUTA_CH1_FREQ00n = not1(ch1_new.HYKA_NR13_FREQ00.qp_any());
    /*_p12.HOXE*/ wire HOXE_CH1_FREQ01n = not1(ch1_new.JYKA_NR13_FREQ01.qp_any());
    /*_p12.HUNY*/ wire HUNY_CH1_FREQ02n = not1(ch1_new.HAVO_NR13_FREQ02.qp_any());
    /*_p12.KEKE*/ wire KEKE_CH1_FREQ03n = not1(ch1_new.EDUL_NR13_FREQ03.qp_any());
    /*_p12.KOVO*/ wire KOVO_CH1_FREQ04n = not1(ch1_new.FELY_NR13_FREQ04.qp_any());
    /*_p12.FOHY*/ wire FOHY_CH1_FREQ05n = not1(ch1_new.HOLU_NR13_FREQ05.qp_any());
    /*_p12.DEBO*/ wire DEBO_CH1_FREQ06n = not1(ch1_new.HYXU_NR13_FREQ06.qp_any());
    /*_p12.CYKY*/ wire CYKY_CH1_FREQ07n = not1(ch1_new.HOPO_NR13_FREQ07.qp_any());
    /*_p12.BYRU*/ wire BYRU_CH1_FREQ08n = not1(ch1_new.DYGY_NR14_FREQ08.qp_any());
    /*_p12.APAT*/ wire APAT_CH1_FREQ09n = not1(ch1_new.EVAB_NR14_FREQ09.qp_any());
    /*_p12.BOJO*/ wire BOJO_CH1_FREQ10n = not1(ch1_new.AXAN_NR14_FREQ10.qp_any());
    ...
    /*_p12.HOZU*/ wire HOZU_SHIFTER_SETn_00 = nand2(ch1_new.HYKA_NR13_FREQ00.qp_any(), KAPE_SHIFTER_LOADp);
    /*_p12.HOLA*/ wire HOLA_SHIFTER_SETn_01 = nand2(ch1_new.JYKA_NR13_FREQ01.qp_any(), KAPE_SHIFTER_LOADp);
    /*_p12.HAWY*/ wire HAWY_SHIFTER_SETn_02 = nand2(ch1_new.HAVO_NR13_FREQ02.qp_any(), KAPE_SHIFTER_LOADp);
    /*_p12.KYRY*/ wire KYRY_SHIFTER_SETn_03 = nand2(ch1_new.EDUL_NR13_FREQ03.qp_any(), JUJU_SHIFTER_LOADp);
    /*_p12.KOLA*/ wire KOLA_SHIFTER_SETn_04 = nand2(ch1_new.FELY_NR13_FREQ04.qp_any(), JUJU_SHIFTER_LOADp);
    /*_p12.GOVO*/ wire GOVO_SHIFTER_SETn_05 = nand2(ch1_new.HOLU_NR13_FREQ05.qp_any(), JUJU_SHIFTER_LOADp);
    /*_p12.EKEM*/ wire EKEM_SHIFTER_SETn_06 = nand2(ch1_new.HYXU_NR13_FREQ06.qp_any(), JUJU_SHIFTER_LOADp);
    /*_p12.DACE*/ wire DACE_SHIFTER_SETn_07 = nand2(ch1_new.HOPO_NR13_FREQ07.qp_any(), KEDO_SHIFTER_LOADp);
    /*_p12.BEGE*/ wire BEGE_SHIFTER_SETn_08 = nand2(ch1_new.DYGY_NR14_FREQ08.qp_any(), KEDO_SHIFTER_LOADp);
    /*_p12.BESO*/ wire BESO_SHIFTER_SETn_09 = nand2(ch1_new.EVAB_NR14_FREQ09.qp_any(), KEDO_SHIFTER_LOADp);
    /*_p12.BEJU*/ wire BEJU_SHIFTER_SETn_10 = nand2(ch1_new.AXAN_NR14_FREQ10.qp_any(), KEDO_SHIFTER_LOADp);
    ...
    /*#p12.FABU*/ ch1_new.FABU_CH1_SHIFT00.dff22(EGOR_SHIFT_CLK_new, HOZU_SHIFTER_SETn_00, JADO_SHIFTER_RSTn_00, ch1_old.JEFA_CH1_SHIFT01.qp_any());
    /*_p12.JEFA*/ ch1_new.JEFA_CH1_SHIFT01.dff22(EGOR_SHIFT_CLK_new, HOLA_SHIFTER_SETn_01, HOBU_SHIFTER_RSTn_01, ch1_old.GOGA_CH1_SHIFT02.qp_any());
    /*_p12.GOGA*/ ch1_new.GOGA_CH1_SHIFT02.dff22(EGOR_SHIFT_CLK_new, HAWY_SHIFTER_SETn_02, HYVU_SHIFTER_RSTn_02, ch1_old.JOLU_CH1_SHIFT03.qp_any());
    /*_p12.JOLU*/ ch1_new.JOLU_CH1_SHIFT03.dff22(EJYB_SHIFT_CLK_new, KYRY_SHIFTER_SETn_03, KETO_SHIFTER_RSTn_03, ch1_old.JOTA_CH1_SHIFT04.qp_any());
    /*_p12.JOTA*/ ch1_new.JOTA_CH1_SHIFT04.dff22(EJYB_SHIFT_CLK_new, KOLA_SHIFTER_SETn_04, KYBO_SHIFTER_RSTn_04, ch1_old.FUDE_CH1_SHIFT05.qp_any());
    /*_p12.FUDE*/ ch1_new.FUDE_CH1_SHIFT05.dff22(EJYB_SHIFT_CLK_new, GOVO_SHIFTER_SETn_05, EZUK_SHIFTER_RSTn_05, ch1_old.FEDO_CH1_SHIFT06.qp_any());
    /*_p12.FEDO*/ ch1_new.FEDO_CH1_SHIFT06.dff22(EJYB_SHIFT_CLK_new, EKEM_SHIFTER_SETn_06, ENOK_SHIFTER_RSTn_06, ch1_old.EXAC_CH1_SHIFT07.qp_any());
    /*_p12.EXAC*/ ch1_new.EXAC_CH1_SHIFT07.dff22(BECY_SHIFT_CLK_new, DACE_SHIFTER_SETn_07, BEWO_SHIFTER_RSTn_07, ch1_old.ELUX_CH1_SHIFT08.qp_any());
    /*_p12.ELUX*/ ch1_new.ELUX_CH1_SHIFT08.dff22(BECY_SHIFT_CLK_new, BEGE_SHIFTER_SETn_08, AGOR_SHIFTER_RSTn_08, ch1_old.AGEZ_CH1_SHIFT09.qp_any());
    /*_p12.AGEZ*/ ch1_new.AGEZ_CH1_SHIFT09.dff22(BECY_SHIFT_CLK_new, BESO_SHIFTER_SETn_09, AFUX_SHIFTER_RSTn_09, ch1_old.BEKU_CH1_SHIFT10.qp_any());
    /*_p12.BEKU*/ ch1_new.BEKU_CH1_SHIFT10.dff22(BECY_SHIFT_CLK_new, BEJU_SHIFTER_SETn_10, AVUF_SHIFTER_RSTn_10, 0);
  }
  ...
  /*#p11.BAGE*/ wire BAGE_NR14_WRn = nand2(ANUJ_CPU_WR_WEIRD, DUJA_ADDR_FF14p);
  /*#p11.CAMY*/ wire CAMY_APU_RSTn_new = not1(KEBA_APU_RSTp);
  /*#p11.BOKO*/ ch1_new.BOKO_NR14_LENENp.dff9(BAGE_NR14_WRn, CAMY_APU_RSTn_new, cpu_dbus_old.BUS_CPU_D06p.qp_any());
  ...
  {
    /*#p13.CAPY*/ wire CAPY_CH1_LEN_CLKn = nor3(ch1_old.CERO_CH1_LEN_DONE.qp_any(), BUFY_CLK_256, ch1_new.BOKO_NR14_LENENp.qn_any());
    /*#p13.CANU*/ wire CANU_CH1_LEN_CLKp = not1(CAPY_CH1_LEN_CLKn);
    /*#p13.BACY*/ ch1_new.BACY_NR11_LEN0.dff20(              CANU_CH1_LEN_CLKp, BUGY_FF11_WRp, cpu_dbus_new.BUS_CPU_D00p.qp_any());
    /*#p13.CAVY*/ ch1_new.CAVY_NR11_LEN1.dff20(ch1_new.BACY_NR11_LEN0.qp_any(), BUGY_FF11_WRp, cpu_dbus_new.BUS_CPU_D01p.qp_any());
    /*#p13.BOVY*/ ch1_new.BOVY_NR11_LEN2.dff20(ch1_new.CAVY_NR11_LEN1.qp_any(), BUGY_FF11_WRp, cpu_dbus_new.BUS_CPU_D02p.qp_any());
    /*#p13.CUNO*/ ch1_new.CUNO_NR11_LEN3.dff20(ch1_new.BOVY_NR11_LEN2.qp_any(), BUGY_FF11_WRp, cpu_dbus_new.BUS_CPU_D03p.qp_any());
    /*#p13.CUSO*/ wire CUSO_NR11_LEN3p = not1(ch1_new.CUNO_NR11_LEN3.qn_any());
    /*#p13.CURA*/ ch1_new.CURA_NR11_LEN4.dff20(CUSO_NR11_LEN3p, BEPE_FF11_WRp, cpu_dbus_new.BUS_CPU_D04p.qp_any());
    /*#p13.ERAM*/ ch1_new.ERAM_NR11_LEN5.dff20(ch1_new.CURA_NR11_LEN4.qp_any(), BEPE_FF11_WRp, cpu_dbus_new.BUS_CPU_D05p.qp_any());

    /*#p13.CORY*/ wire CORY_CH1_LEN_DONE_RST_new = nor3(BOKA_FF11_WRp, KEBA_APU_RSTp, ch1_new.FEKU_CH1_TRIGp.qp_any());
    /*_p13.CERO*/ ch1_new.CERO_CH1_LEN_DONE.dff17(ch1_new.ERAM_NR11_LEN5.qn_any(), CORY_CH1_LEN_DONE_RST_new, ch1_old.CERO_CH1_LEN_DONE.qn_any());
  }

  {
    /*#p13.CAPY*/ wire CAPY_CH1_LEN_CLKn = nor3(ch1_new.CERO_CH1_LEN_DONE.qp_any(), BUFY_CLK_256, ch1_new.BOKO_NR14_LENENp.qn_any());
    /*#p13.CANU*/ wire CANU_CH1_LEN_CLKp = not1(CAPY_CH1_LEN_CLKn);
    /*#p13.BACY*/ ch1_new.BACY_NR11_LEN0.dff20_any(              CANU_CH1_LEN_CLKp, BUGY_FF11_WRp, cpu_dbus_new.BUS_CPU_D00p.qp_any());
    /*#p13.CAVY*/ ch1_new.CAVY_NR11_LEN1.dff20_any(ch1_new.BACY_NR11_LEN0.qp_any(), BUGY_FF11_WRp, cpu_dbus_new.BUS_CPU_D01p.qp_any());
    /*#p13.BOVY*/ ch1_new.BOVY_NR11_LEN2.dff20_any(ch1_new.CAVY_NR11_LEN1.qp_any(), BUGY_FF11_WRp, cpu_dbus_new.BUS_CPU_D02p.qp_any());
    /*#p13.CUNO*/ ch1_new.CUNO_NR11_LEN3.dff20_any(ch1_new.BOVY_NR11_LEN2.qp_any(), BUGY_FF11_WRp, cpu_dbus_new.BUS_CPU_D03p.qp_any());
    /*#p13.CUSO*/ wire CUSO_NR11_LEN3p = not1(ch1_new.CUNO_NR11_LEN3.qn_any());
    /*#p13.CURA*/ ch1_new.CURA_NR11_LEN4.dff20_any(CUSO_NR11_LEN3p, BEPE_FF11_WRp, cpu_dbus_new.BUS_CPU_D04p.qp_any());
    /*#p13.ERAM*/ ch1_new.ERAM_NR11_LEN5.dff20_any(ch1_new.CURA_NR11_LEN4.qp_any(), BEPE_FF11_WRp, cpu_dbus_new.BUS_CPU_D05p.qp_any());

    /*#p13.CORY*/ wire CORY_CH1_LEN_DONE_RST_new = nor3(BOKA_FF11_WRp, KEBA_APU_RSTp, ch1_new.FEKU_CH1_TRIGp.qp_any());
    /*_p13.CERO*/ ch1_new.CERO_CH1_LEN_DONE.dff17_any(ch1_new.ERAM_NR11_LEN5.qn_any(), CORY_CH1_LEN_DONE_RST_new, ch1_new.CERO_CH1_LEN_DONE.qn_any());
  }
  ...
  /*#p13.HOCA*/ wire HOCA_CH1_AMP_ENn_new = nor5(ch1_new.JAFY_NR12_ENV_DIRp.qp_any(),
    ch1_new.JATY_NR12_VOL0p.qp_any(),
    ch1_new.JAXO_NR12_VOL1p.qp_any(),
    ch1_new.JENA_NR12_VOL2p.qp_any(),
    ch1_new.JOPU_NR12_VOL3p.qp_any());

  {
    /*#p13.BONE*/ wire BONE_FREQ_OVERFLOWp_new = not1(ATYS_FREQ_OVERFLOWn_new);
    /*#p13.CYFA*/ wire CYFA_LEN_DONEp_new = and2(ch1_new.CERO_CH1_LEN_DONE.qp_any(), ch1_new.BOKO_NR14_LENENp.qp_any());
    /*#p13.BERY*/ wire BERY_CH1_STOPp_new = or4(BONE_FREQ_OVERFLOWp_new, KEBA_APU_RSTp, CYFA_LEN_DONEp_new, HOCA_CH1_AMP_ENn_new);

    /*#p13.CYTO*/ ch1_new.CYTO_CH1_ACTIVEp.nor_latch(ch1_new.FEKU_CH1_TRIGp.qp_any(), BERY_CH1_STOPp_new);
  }

  // so this implies that NR12_DELAY* is DFFn?
  /*#p13.KOMA*/ wire KOMA_ENV_OFFp_new = nor3(ch1_new.JUSA_NR12_PERIOD0p.qp_any(), ch1_new.JUZY_NR12_PERIOD1p.qp_any(), ch1_new.JOMA_NR12_PERIOD2p.qp_any());

  {
    // When the delay expires, we generate one env tick.

    /*#p13.KOTE*/ wire KOTE_ENV_DELAY_DONEp_old = and3(ch1_old.KERA_ENV_DELAY2p.qp_any(), ch1_old.KENU_ENV_DELAY1p.qp_any(), ch1_old.JOVA_ENV_DELAY0p.qp_any());
    /*#p13.KOZY*/ ch1_new.KOZY_ENV_TICKp.dff17_clk(HORU_CLK_512, KOTE_ENV_DELAY_DONEp_old);

    /*#p13.KURY*/ wire KURY_ENV_CLKn_new = not1(ch1_new.KOZY_ENV_TICKp.qp_any());
    /*#p13.KUKU*/ wire KUKU_ENV_CLKp_new = nor2(HORU_CLK_512, KURY_ENV_CLKn_new);
    /*#p13.KORO*/ wire KORO_ENV_CLK_RSTn_new = nor4(KUKU_ENV_CLKp_new, KOMA_ENV_OFFp_new, ch1_new.FEKU_CH1_TRIGp.qp_any(), KEBA_APU_RSTp);
  ...
  /*#p13.KAZA*/ wire KAZA_ENV_DELAY_LOADn = nor2(ch1_new.FEKU_CH1_TRIGp.qp_any(), ch1_new.KOZY_ENV_TICKp.qp_any());
  /*#p13.KUXU*/ wire KUXU_ENV_DELAY_LOADp = not1(KAZA_ENV_DELAY_LOADn);

  /*#p13.JOVA*/ ch1_new.JOVA_ENV_DELAY0p.dff20(JOLA_ENV_DELAY_CLK_64n, KUXU_ENV_DELAY_LOADp, ch1_new.JUSA_NR12_PERIOD0p.qn_any());
  /*#p13.KENU*/ ch1_new.KENU_ENV_DELAY1p.dff20(ch1_new.JOVA_ENV_DELAY0p.qp_any(), KUXU_ENV_DELAY_LOADp, ch1_new.JUZY_NR12_PERIOD1p.qn_any());
  /*#p13.KERA*/ ch1_new.KERA_ENV_DELAY2p.dff20(ch1_new.KENU_ENV_DELAY1p.qp_any(), KUXU_ENV_DELAY_LOADp, ch1_new.JOMA_NR12_PERIOD2p.qn_any());

  {
    // Check to see if our env is 0b0000 or 0b1111
    /*#p13.KORU*/ wire KORU_ENV_MAX_RSTn_new = nor2(ch1_new.FEKU_CH1_TRIGp.qp_any(), KEBA_APU_RSTp);
    /*#p13.HUFU*/ wire HUFU_ENV_TOPn_old = nand5(ch1_old.JAFY_NR12_ENV_DIRp.qp_any(), ch1_old.HAFO_CH1_ENV0p.qp_any(), ch1_old.HEMY_CH1_ENV1p.qp_any(), ch1_old.HOKO_CH1_ENV2p.qp_any(), ch1_old.HEVO_CH1_ENV3p.qp_any());
    /*#p13.HANO*/ wire HANO_ENV_BOTp_old = nor5(ch1_old.JAFY_NR12_ENV_DIRp.qp_any(), ch1_old.HAFO_CH1_ENV0p.qp_any(), ch1_old.HEMY_CH1_ENV1p.qp_any(), ch1_old.HOKO_CH1_ENV2p.qp_any(), ch1_old.HEVO_CH1_ENV3p.qp_any());

    /*#p13.HAKE*/ wire HAKE_ENV_TOPp_old = not1(HUFU_ENV_TOPn_old);
    /*#p13.JADE*/ wire JADE_ENV_MAXp_old = or2(HANO_ENV_BOTp_old, HAKE_ENV_TOPp_old);
    /*#p13.KYNO*/ ch1_new.KYNO_ENV_MAXp.dff17(ch1_new.KOZY_ENV_TICKp.qp_any(), KORU_ENV_MAX_RSTn_new, JADE_ENV_MAXp_old);
  }

  {
    // If our env maxes out, don't tick the envelope anymore.
    /*#p13.KEKO*/ wire KEKO_ENV_STARTp = or2(KEBA_APU_RSTp, ch1_new.FEKU_CH1_TRIGp.qp_any());
    /*#p13.KEZU*/ ch1_new.KEZU_ENV_ACTIVEn.nor_latch(ch1_new.KYNO_ENV_MAXp.qp_any(), KEKO_ENV_STARTp);
  }

  /*#p13.KAKE*/ wire KAKE_ENV_CLK = or3(ch1_new.KOZY_ENV_TICKp.qp_any(), KOMA_ENV_OFFp_new, ch1_new.KEZU_ENV_ACTIVEn.qp_any()); // Die has this as and, but it's definitely or

  // The muxes select posedge or negedge for the env counter so it can count up _or_ down?
  // these were connected wrong in schematic

  /*#p13.JUFY*/ wire JUFY_ENV_CLK = amux2(ch1_new.JAFY_NR12_ENV_DIRp.qp_any(), KAKE_ENV_CLK, KAKE_ENV_CLK, ch1_new.JAFY_NR12_ENV_DIRp.qn_any());
  /*#p13.HAFO*/ ch1_new.HAFO_CH1_ENV0p.dff20(JUFY_ENV_CLK, ch1_new.FEKU_CH1_TRIGp.qp_any(), ch1_new.JATY_NR12_VOL0p.qp_any());

  /*#p13.HYTO*/ wire HYTO_ENV_CLK = amux2(ch1_new.JAFY_NR12_ENV_DIRp.qp_any(), ch1_new.HAFO_CH1_ENV0p.qp_any(), ch1_new.HAFO_CH1_ENV0p.qn_any(), ch1_new.JAFY_NR12_ENV_DIRp.qn_any());
  /*#p13.HEMY*/ ch1_new.HEMY_CH1_ENV1p.dff20(HYTO_ENV_CLK, ch1_new.FEKU_CH1_TRIGp.qp_any(), ch1_new.JAXO_NR12_VOL1p.qp_any());

  /*#p13.HETO*/ wire HETO_ENV_CLK = amux2(ch1_new.JAFY_NR12_ENV_DIRp.qp_any(), ch1_new.HEMY_CH1_ENV1p.qp_any(), ch1_new.HEMY_CH1_ENV1p.qn_any(), ch1_new.JAFY_NR12_ENV_DIRp.qn_any());
  /*#p13.HOKO*/ ch1_new.HOKO_CH1_ENV2p.dff20(HETO_ENV_CLK, ch1_new.FEKU_CH1_TRIGp.qp_any(), ch1_new.JENA_NR12_VOL2p.qp_any());

  /*#p13.HESU*/ wire HESU_ENV_CLK = amux2(ch1_new.JAFY_NR12_ENV_DIRp.qp_any(), ch1_new.HOKO_CH1_ENV2p.qp_any(), ch1_new.HOKO_CH1_ENV2p.qn_any(), ch1_new.JAFY_NR12_ENV_DIRp.qn_any());
  /*#p13.HEVO*/ ch1_new.HEVO_CH1_ENV3p.dff20(HESU_ENV_CLK, ch1_new.FEKU_CH1_TRIGp.qp_any(), ch1_new.JOPU_NR12_VOL3p.qp_any());
  ...
  {
    /*#p13.FEMY*/ wire FEMY_CH2_OFFn_new = nor2(HOCA_CH1_AMP_ENn_new, KEBA_APU_RSTp);
    /*#p13.GEPU*/ wire GEPU_CH1_TRIGn_new = not1(ch1_new.FYTE_CH1_TRIGp.qp_any());
    /*#p13.GEXU*/ ch1_new.GEXU_FREQ_GATEn.nand_latch(FEMY_CH2_OFFn_new, GEPU_CH1_TRIGn_new);
  }

  /*#p11.FULO*/ wire FULO_FREQ_CLK_new = nor2(DYFA_xBCDExxx_new, ch1_new.GEXU_FREQ_GATEn.qp_any());
  /*#p11.GEKU*/ wire GEKU_FREQ_CLK_new = not1(FULO_FREQ_CLK_new);
  ...
  //{
  /*#p11.GAXE*/ ch1_new.GAXE_CH1_FREQ_CNT_00.dff20_clk(GEKU_FREQ_CLK_new);
  /*#p11.HYFE*/ ch1_new.HYFE_CH1_FREQ_CNT_01.dff20_clk(ch1_new.GAXE_CH1_FREQ_CNT_00.qp_any());
  /*_p11.JYTY*/ ch1_new.JYTY_CH1_FREQ_CNT_02.dff20_clk(ch1_new.HYFE_CH1_FREQ_CNT_01.qp_any());
  /*_p11.KYNA*/ ch1_new.KYNA_CH1_FREQ_CNT_03.dff20_clk(ch1_new.JYTY_CH1_FREQ_CNT_02.qp_any());

  /*#p11.KYPE*/ wire KYPE_FREQ_CLK_new = not1(ch1_new.KYNA_CH1_FREQ_CNT_03.qn_any());
  /*_p11.JEMA*/ ch1_new.JEMA_CH1_FREQ_CNT_04.dff20_clk(KYPE_FREQ_CLK_new);
  /*_p11.HYKE*/ ch1_new.HYKE_CH1_FREQ_CNT_05.dff20_clk(ch1_new.JEMA_CH1_FREQ_CNT_04.qp_any());
  /*_p11.FEVA*/ ch1_new.FEVA_CH1_FREQ_CNT_06.dff20_clk(ch1_new.HYKE_CH1_FREQ_CNT_05.qp_any());
  /*_p11.EKOV*/ ch1_new.EKOV_CH1_FREQ_CNT_07.dff20_clk(ch1_new.FEVA_CH1_FREQ_CNT_06.qp_any());

  /*#p11.DERU*/ wire DERU_FREQ_CLK_new = not1(ch1_new.EKOV_CH1_FREQ_CNT_07.qn_any());
  /*#p11.EMUS*/ ch1_new.EMUS_CH1_FREQ_CNT_08.dff20_clk(DERU_FREQ_CLK_new);
  /*#p11.EVAK*/ ch1_new.EVAK_CH1_FREQ_CNT_09.dff20_clk(ch1_new.EMUS_CH1_FREQ_CNT_08.qp_any());
  /*#p11.COPU*/ ch1_new.COPU_CH1_FREQ_CNT_10.dff20_clk(ch1_new.EVAK_CH1_FREQ_CNT_09.qp_any());
  //}

  {
    /*#p13.CALA*/ wire CALA_FREQ_OVERFLOWp_new = not1(ch1_new.COPU_CH1_FREQ_CNT_10.qp_any());
    /*_p13.COMY*/ ch1_new.COMY_SAMPLE_CLKp.dff17_clk(CALA_FREQ_OVERFLOWp_new, ch1_old.COMY_SAMPLE_CLKp.qn_any());
  }

  {
    /*#p13.CYTE*/ wire CYTE_SAMPLE_CLKn_new = not1(ch1_new.COMY_SAMPLE_CLKp.qp_any());
    /*#p13.COPE*/ wire COPE_SAMPLE_CLKp_new = not1(CYTE_SAMPLE_CLKn_new);

    /*#p11.EPYK*/ wire EPYK_FREQ_LOADn_new = nor2(COPE_SAMPLE_CLKp_new, ch1_new.FEKU_CH1_TRIGp.qp_any());
    /*#p11.FUME*/ wire FUME_FREQ_LOADp_new = not1(EPYK_FREQ_LOADn_new);
    /*#p11.DEGA*/ wire DEGA_FREQ_LOADp_new = not1(EPYK_FREQ_LOADn_new);
    /*#p11.DAKO*/ wire DAKO_FREQ_LOADp_new = not1(EPYK_FREQ_LOADn_new);

    /*#p11.GAXE*/ ch1_new.GAXE_CH1_FREQ_CNT_00.dff20_any(GEKU_FREQ_CLK_new, FUME_FREQ_LOADp_new, ch1_new.HYKA_NR13_FREQ00.qp_any());
    /*#p11.HYFE*/ ch1_new.HYFE_CH1_FREQ_CNT_01.dff20_any(ch1_new.GAXE_CH1_FREQ_CNT_00.qp_any(), FUME_FREQ_LOADp_new, ch1_new.JYKA_NR13_FREQ01.qp_any());
    /*_p11.JYTY*/ ch1_new.JYTY_CH1_FREQ_CNT_02.dff20_any(ch1_new.HYFE_CH1_FREQ_CNT_01.qp_any(), FUME_FREQ_LOADp_new, ch1_new.HAVO_NR13_FREQ02.qp_any());
    /*_p11.KYNA*/ ch1_new.KYNA_CH1_FREQ_CNT_03.dff20_any(ch1_new.JYTY_CH1_FREQ_CNT_02.qp_any(), FUME_FREQ_LOADp_new, ch1_new.EDUL_NR13_FREQ03.qp_any());

    ///*#p11.KYPE*/ wire KYPE_FREQ_CLK_new = not1(ch1_new.KYNA_CH1_FREQ_CNT_03.qn_any());
    /*_p11.JEMA*/ ch1_new.JEMA_CH1_FREQ_CNT_04.dff20_any(KYPE_FREQ_CLK_new, DEGA_FREQ_LOADp_new, ch1_new.FELY_NR13_FREQ04.qp_any());
    /*_p11.HYKE*/ ch1_new.HYKE_CH1_FREQ_CNT_05.dff20_any(ch1_new.JEMA_CH1_FREQ_CNT_04.qp_any(), DEGA_FREQ_LOADp_new, ch1_new.HOLU_NR13_FREQ05.qp_any());
    /*_p11.FEVA*/ ch1_new.FEVA_CH1_FREQ_CNT_06.dff20_any(ch1_new.HYKE_CH1_FREQ_CNT_05.qp_any(), DEGA_FREQ_LOADp_new, ch1_new.HYXU_NR13_FREQ06.qp_any());
    /*_p11.EKOV*/ ch1_new.EKOV_CH1_FREQ_CNT_07.dff20_any(ch1_new.FEVA_CH1_FREQ_CNT_06.qp_any(), DEGA_FREQ_LOADp_new, ch1_new.HOPO_NR13_FREQ07.qp_any());

    ///*#p11.DERU*/ wire DERU_FREQ_CLK_new = not1(ch1_new.EKOV_CH1_FREQ_CNT_07.qn_any());
    /*#p11.EMUS*/ ch1_new.EMUS_CH1_FREQ_CNT_08.dff20_any(DERU_FREQ_CLK_new, DAKO_FREQ_LOADp_new, ch1_new.DYGY_NR14_FREQ08.qp_any());
    /*#p11.EVAK*/ ch1_new.EVAK_CH1_FREQ_CNT_09.dff20_any(ch1_new.EMUS_CH1_FREQ_CNT_08.qp_any(), DAKO_FREQ_LOADp_new, ch1_new.EVAB_NR14_FREQ09.qp_any());
    /*#p11.COPU*/ ch1_new.COPU_CH1_FREQ_CNT_10.dff20_any(ch1_new.EVAK_CH1_FREQ_CNT_09.qp_any(), DAKO_FREQ_LOADp_new, ch1_new.AXAN_NR14_FREQ10.qp_any());
  }

  {
    /*#p13.CALA*/ wire CALA_FREQ_OVERFLOWp_new = not1(ch1_new.COPU_CH1_FREQ_CNT_10.qp_any());
    /*#p13.DOKA*/ wire DOKA_COMY_RSTp_new = and2(ch1_new.COMY_SAMPLE_CLKp.qp_any(), DYFA_xBCDExxx_new);
    /*#p13.DYRU*/ wire DYRU_COMY_RSTn_new = nor3(KEBA_APU_RSTp, ch1_new.FEKU_CH1_TRIGp.qp_any(), DOKA_COMY_RSTp_new);
    /*_p13.COMY*/ ch1_new.COMY_SAMPLE_CLKp.dff17_any(CALA_FREQ_OVERFLOWp_new, DYRU_COMY_RSTn_new, ch1_new.COMY_SAMPLE_CLKp.qn_any());
  }
...

  {
    ...
    /*#p13.COPE*/ wire COPE_SAMPLE_CLKp_new = not1(CYTE_SAMPLE_CLKn_new);
    /*#p13.DAJO*/ wire DAJO_SAMPLE_CLKn_new = not1(COPE_SAMPLE_CLKp_new);
    /*#p13.ESUT*/ ch1_new.ESUT_PHASE_xBxDxFxH.dff17(DAJO_SAMPLE_CLKn_new, CEPO_APU_RSTn_new, ch1_old.ESUT_PHASE_xBxDxFxH.qn_any());
    /*#p13.EROS*/ ch1_new.EROS_PHASE_xxCDxxGH.dff13(ch1_new.ESUT_PHASE_xBxDxFxH.qn_any(), CEPO_APU_RSTn_new, ch1_old.EROS_PHASE_xxCDxxGH.qn_any());
    /*#p13.DAPE*/ ch1_new.DAPE_PHASE_xxxxEFGH.dff13(ch1_new.EROS_PHASE_xxCDxxGH.qn_any(), CEPO_APU_RSTn_new, ch1_old.DAPE_PHASE_xxxxEFGH.qn_any());

    /*#p13.DUVO*/ wire DUVO_PHASE_AxCxExGx_old = not1(ch1_old.ESUT_PHASE_xBxDxFxH.qp_any());
    /*#p13.EZOZ*/ wire EZOZ_PHASE_xxxxxxGH_old = and2(ch1_old.DAPE_PHASE_xxxxEFGH.qp_any(), ch1_old.EROS_PHASE_xxCDxxGH.qp_any());
    /*#p13.ENEK*/ wire ENEK_PHASE_xxxxxxGx_old = and2(EZOZ_PHASE_xxxxxxGH_old, DUVO_PHASE_AxCxExGx_old);
    /*#p13.CODO*/ wire CODO_PHASE_ABCDEFxx_old = not1(EZOZ_PHASE_xxxxxxGH_old);


    /*#p13.COSO*/ wire COSO_old = nor2(ch1_old.CENA_NR11_DUTY0p.qp_any(), ch1_old.DYCA_NR11_DUTY1p.qp_any());
    /*#p13.CAVA*/ wire CAVA_old = nor2(ch1_old.CENA_NR11_DUTY0p.qn_any(), ch1_old.DYCA_NR11_DUTY1p.qp_any());
    /*#p13.CEVU*/ wire CEVU_old = nor2(ch1_old.CENA_NR11_DUTY0p.qp_any(), ch1_old.DYCA_NR11_DUTY1p.qn_any());
    /*#p13.CAXO*/ wire CAXO_old = nor2(ch1_old.CENA_NR11_DUTY0p.qn_any(), ch1_old.DYCA_NR11_DUTY1p.qn_any());
    /*#p13.DUNA*/ wire DUNA_RAW_BIT_old = amux4(ENEK_PHASE_xxxxxxGx_old, COSO_old,
      EZOZ_PHASE_xxxxxxGH_old, CAVA_old,
      ch1_old.DAPE_PHASE_xxxxEFGH.qp_any(), CEVU_old,
      CODO_PHASE_ABCDEFxx_old, CAXO_old);
    /*_p13.DUWO*/ ch1_new.DUWO_RAW_BIT_SYNCp.dff17(COPE_SAMPLE_CLKp_new, CEPO_APU_RSTn_new, DUNA_RAW_BIT_old);
  }

  {
    /*#p11.COVU*/ wire COVU_NR11_WR = and2(BOGY_CPU_WRp, CAXE_ADDR_FF11p);
    /*#p11.DAFO*/ wire DAFO_NR11_CLK = not1(COVU_NR11_WR);
    /*#p11.CENA*/ ch1_new.CENA_NR11_DUTY0p.dff9(DAFO_NR11_CLK, CEPO_APU_RSTn_new, cpu_dbus_old.BUS_CPU_D06p.qp_any());
    /*#p11.DYCA*/ ch1_new.DYCA_NR11_DUTY1p.dff9(DAFO_NR11_CLK, CEPO_APU_RSTn_new, cpu_dbus_old.BUS_CPU_D07p.qp_any());
  }

  {
    ...
    // Isn't the data polarity here backwards?
    /*#p11.AMYD*/ triwire AMYD_NR10_SWEEP_SHIFT0 = tri6_nn(ASOP_NR10_RDn, ch1_new.BANY_NR10_SWEEP_SHIFT0p.qn_any());
    /*#p11.ATAX*/ triwire ATAX_NR10_SWEEP_SHIFT1 = tri6_nn(ASOP_NR10_RDn, ch1_new.ARAX_NR10_SWEEP_SHIFT1p.qn_any());
    /*#p11.AZYP*/ triwire AZYP_NR10_SWEEP_SHIFT2 = tri6_nn(ASOP_NR10_RDn, ch1_new.ANAZ_NR10_SWEEP_SHIFT2p.qn_any());
    /*#p11.AFOX*/ triwire AFOX_NR10_SWEEP_NEGATE = tri6_nn(ASOP_NR10_RDn, ch1_new.AVAF_NR10_SWEEP_DIRp.qn_any());
    /*#p11.AVEK*/ triwire AVEK_NR10_SWEEP_PERIOD0 = tri6_nn(ASOP_NR10_RDn, ch1_new.ADEK_NR10_SWEEP_PERIOD0p.qn_any());
    /*#p11.AKUX*/ triwire AKUX_NR10_SWEEP_PERIOD1 = tri6_nn(ASOP_NR10_RDn, ch1_new.BANA_NR10_SWEEP_PERIOD1p.qn_any());
    /*#p11.AWOS*/ triwire AWOS_NR10_SWEEP_PERIOD2 = tri6_nn(ASOP_NR10_RDn, ch1_new.BOTU_NR10_SWEEP_PERIOD2p.qn_any());

    /*_BUS_CPU_D00p*/ cpu_dbus_new.BUS_CPU_D00p.tri_bus(AMYD_NR10_SWEEP_SHIFT0);
    /*_BUS_CPU_D01p*/ cpu_dbus_new.BUS_CPU_D01p.tri_bus(ATAX_NR10_SWEEP_SHIFT1);
    /*_BUS_CPU_D02p*/ cpu_dbus_new.BUS_CPU_D02p.tri_bus(AZYP_NR10_SWEEP_SHIFT2);
    /*_BUS_CPU_D03p*/ cpu_dbus_new.BUS_CPU_D03p.tri_bus(AFOX_NR10_SWEEP_NEGATE);
    /*_BUS_CPU_D04p*/ cpu_dbus_new.BUS_CPU_D04p.tri_bus(AVEK_NR10_SWEEP_PERIOD0);
    /*_BUS_CPU_D05p*/ cpu_dbus_new.BUS_CPU_D05p.tri_bus(AKUX_NR10_SWEEP_PERIOD1);
    /*_BUS_CPU_D06p*/ cpu_dbus_new.BUS_CPU_D06p.tri_bus(AWOS_NR10_SWEEP_PERIOD2);
  }

  {
    /*#p11.BUWA*/ wire BUWA_CPU_RDp = not1(AGUZ_CPU_RDn);
    /*#p11.BEXU*/ wire BEXU_NR11_RDn = nand2(BUWA_CPU_RDp, CAXE_ADDR_FF11p);
    /*#p11.BOWO*/ triwire BOWO = tri6_nn(BEXU_NR11_RDn, ch1_new.CENA_NR11_DUTY0p.qn_any());
    /*#p11.CUDA*/ triwire CUDA = tri6_nn(BEXU_NR11_RDn, ch1_new.DYCA_NR11_DUTY1p.qn_any());

    /*_BUS_CPU_D06p*/ cpu_dbus_new.BUS_CPU_D06p.tri_bus(BOWO);
    /*_BUS_CPU_D07p*/ cpu_dbus_new.BUS_CPU_D07p.tri_bus(CUDA);
  }

  {
    ...
    /*#p11.JYNE*/ triwire JYNE = tri6_nn(HAMY_NR12_RDn, ch1_new.JUSA_NR12_PERIOD0p.qn_any());
    /*#p11.JACA*/ triwire JACA = tri6_nn(HAMY_NR12_RDn, ch1_new.JUZY_NR12_PERIOD1p.qn_any());
    /*#p11.JOKU*/ triwire JOKU = tri6_nn(HAMY_NR12_RDn, ch1_new.JOMA_NR12_PERIOD2p.qn_any());
    /*#p11.HONO*/ triwire HONO = tri6_nn(HOCU_NR12_RDn, ch1_new.JAFY_NR12_ENV_DIRp.qn_any());
    /*#p11.HOWU*/ triwire HOWU = tri6_nn(HOCU_NR12_RDn, ch1_new.JATY_NR12_VOL0p.qn_any());
    /*#p11.HEWA*/ triwire HEWA = tri6_nn(HOCU_NR12_RDn, ch1_new.JAXO_NR12_VOL1p.qn_any());
    /*#p11.HEVE*/ triwire HEVE = tri6_nn(HOCU_NR12_RDn, ch1_new.JENA_NR12_VOL2p.qn_any());
    /*#p11.JYSE*/ triwire JYSE = tri6_nn(HOCU_NR12_RDn, ch1_new.JOPU_NR12_VOL3p.qn_any());

    /*_BUS_CPU_D00p*/ cpu_dbus_new.BUS_CPU_D00p.tri_bus(JYNE);
    /*_BUS_CPU_D01p*/ cpu_dbus_new.BUS_CPU_D01p.tri_bus(JACA);
    /*_BUS_CPU_D02p*/ cpu_dbus_new.BUS_CPU_D02p.tri_bus(JOKU);
    /*_BUS_CPU_D03p*/ cpu_dbus_new.BUS_CPU_D03p.tri_bus(HONO);
    /*_BUS_CPU_D04p*/ cpu_dbus_new.BUS_CPU_D04p.tri_bus(HOWU);
    /*_BUS_CPU_D05p*/ cpu_dbus_new.BUS_CPU_D05p.tri_bus(HEWA);
    /*_BUS_CPU_D06p*/ cpu_dbus_new.BUS_CPU_D06p.tri_bus(HEVE);
    /*_BUS_CPU_D07p*/ cpu_dbus_new.BUS_CPU_D07p.tri_bus(JYSE);
  }
...

  {
    ...
    /*_p11.FORU*/ triwire FORU = tri6_nn(EVAJ_FF13_RDa, ch1_new.GAXE_CH1_FREQ_CNT_00.qn_any());
    /*_p11.GEFU*/ triwire GEFU = tri6_nn(EVAJ_FF13_RDa, ch1_new.HYFE_CH1_FREQ_CNT_01.qn_any());
    /*_p11.KYVU*/ triwire KYVU = tri6_nn(EVAJ_FF13_RDa, ch1_new.JYTY_CH1_FREQ_CNT_02.qn_any());
    /*_p11.KUMO*/ triwire KUMO = tri6_nn(EVAJ_FF13_RDa, ch1_new.KYNA_CH1_FREQ_CNT_03.qn_any());
    /*_p11.KARY*/ triwire KARY = tri6_nn(EVAJ_FF13_RDa, ch1_new.JEMA_CH1_FREQ_CNT_04.qn_any());
    /*_p11.GODE*/ triwire GODE = tri6_nn(EVAJ_FF13_RDa, ch1_new.HYKE_CH1_FREQ_CNT_05.qn_any());
    /*_p11.GOJE*/ triwire GOJE = tri6_nn(EVAJ_FF13_RDa, ch1_new.FEVA_CH1_FREQ_CNT_06.qn_any());
    /*_p11.FOZE*/ triwire FOZE = tri6_nn(EVAJ_FF13_RDa, ch1_new.EKOV_CH1_FREQ_CNT_07.qn_any());

    /*_BUS_CPU_D00p*/ cpu_dbus_new.BUS_CPU_D00p.tri_bus(FORU);
    /*_BUS_CPU_D01p*/ cpu_dbus_new.BUS_CPU_D01p.tri_bus(GEFU);
    /*_BUS_CPU_D02p*/ cpu_dbus_new.BUS_CPU_D02p.tri_bus(KYVU);
    /*_BUS_CPU_D03p*/ cpu_dbus_new.BUS_CPU_D03p.tri_bus(KUMO);
    /*_BUS_CPU_D04p*/ cpu_dbus_new.BUS_CPU_D04p.tri_bus(KARY);
    /*_BUS_CPU_D05p*/ cpu_dbus_new.BUS_CPU_D05p.tri_bus(GODE);
    /*_BUS_CPU_D06p*/ cpu_dbus_new.BUS_CPU_D06p.tri_bus(GOJE);
    /*_BUS_CPU_D07p*/ cpu_dbus_new.BUS_CPU_D07p.tri_bus(FOZE);
  }

  {
    /*#p11.CURE*/ wire CURE_ADDR_FF14n = not1(DUJA_ADDR_FF14p);
    /*#p11.DUPY*/ wire DUPY_FF14_RDn = or2(CURE_ADDR_FF14n, DAXA_CPU_RDn_DBGn);
    /*_p11.DOPA*/ triwire DOPA = tri6_nn(DUPY_FF14_RDn, ch1_new.EMUS_CH1_FREQ_CNT_08.qn_any());
    /*_p11.DEMU*/ triwire DEMU = tri6_nn(DUPY_FF14_RDn, ch1_new.EVAK_CH1_FREQ_CNT_09.qn_any());
    /*_p11.DEXO*/ triwire DEXO = tri6_nn(DUPY_FF14_RDn, ch1_new.COPU_CH1_FREQ_CNT_10.qn_any());

    /*_BUS_CPU_D00p*/ cpu_dbus_new.BUS_CPU_D00p.tri_bus(DOPA);
    /*_BUS_CPU_D01p*/ cpu_dbus_new.BUS_CPU_D01p.tri_bus(DEMU);
    /*_BUS_CPU_D02p*/ cpu_dbus_new.BUS_CPU_D02p.tri_bus(DEXO);

    /*#p11.BUDA*/ wire BUDA_CPU_RDp = not1(AGUZ_CPU_RDn);
    /*#p11.BALE*/ wire BALE_NR14_RDn = nand2(DUJA_ADDR_FF14p, BUDA_CPU_RDp);
    /*#p11.BYTU*/ triwire BYTU = tri6_nn(BALE_NR14_RDn, ch1_new.BOKO_NR14_LENENp.qn_any());
    /*_BUS_CPU_D06p*/ cpu_dbus_new.BUS_CPU_D06p.tri_bus(BYTU);
  }
