...
void tick_ch1(const GateBoyState& reg_old, GateBoyState& reg_new) {
  ...
  {
    /*#p13.EZEC*/ reg_new.ch1.EZEC_CH1_TRIGn.dff17(reg_new.sys_clk.DOVA_ABCDxxxx(), reg_new.DUKA_APU_RSTn_new(), reg_old.ch1.DUPE_NR14_TRIGp.qp_oldB());
