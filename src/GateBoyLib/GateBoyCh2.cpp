...
void GBSound::tick_ch2() {
  ...
  // Channel 2 frequency counter
  {
    ...
    /*#p15.CAMA*/ wire CAMA_FREQ_TICKp = nor2(spu.CEMO_CLK_1M.qp_new(), ch2.BUTA_FREQ_GATEp.qp_new()); // no idea of buta polarity
...
void GBSound::tick_nr24() {
  ...
  // NR24 length enable
  {
    ...
    /*#pXX.EMER*/ ch2.EMER_NR24_LENENp.dff9(EVYF, FAZO_APU_RSTn(), BUS_CPU_D06p.out_old());
  ...
  // NR24 CH2 trigger / sequencer
  {
    ...
    /*#p??.ETAP*/ ch2.ETAP_NR24_TRIGp.dff9(DETA_NR24_WRn, DERA_TRIG_RSTn, BUS_CPU_D07p.out_old());
    ...
    /*#p15.ELOX*/ ch2.ELOX_CH2_TRIGp.dff17(spu.CEMO_CLK_1M.qp_new(), DOXA_TRIG_RSTn,  ch2.DALA_CH2_TRIGp.qn_new());
    /*#p15.DORY*/ ch2.DORY_CH2_TRIGp.dff17(spu.CEMO_CLK_1M.qp_new(), CEXE_APU_RSTn(), ch2.ELOX_CH2_TRIGp.qp_old());
    /*#p15.CAZA*/ ch2.CAZA_CH2_TRIGp.dff17(spu.CEMO_CLK_1M.qp_new(), CEXE_APU_RSTn(), ch2.DORY_CH2_TRIGp.qp_old());
  }
}
