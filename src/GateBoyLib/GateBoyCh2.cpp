...
void SpuChannel2::reset() {
  ...
  /*#p15.JUPU*/ wire JUPU_ENV_OFFp_old() const { return nor3(HYFU_NR22_P0p.qp_old(), HORE_NR22_P1p.qp_old(), HAVA_NR22_P2p.qp_old()); }
  /*#p15.JUPU*/ wire JUPU_ENV_OFFp_new() const { return nor3(HYFU_NR22_P0p.qp_new(), HORE_NR22_P1p.qp_new(), HAVA_NR22_P2p.qp_new()); }
#endif
...
void tick_ch2(const GateBoyState& reg_old, GateBoyState& reg_new) {
  ...
  /*#p15.DOPE*/ ch2_new.DOPE_TRIGp_d00.dff17(DOVA_ABCDxxxx, CYWU_APU_RSTn_new, ch2_old.ETAP_NR24_TRIGp.qp_old());

  {
    ...
    /*_p14.HYFU*/ ch2_new.HYFU_NR22_P0p .dff9(JEDE_FF17_WRn, JYBU_APU_RSTn_new, reg_old.cpu_dbus.BUS_CPU_D00p.out_old());
    /*_p14.HORE*/ ch2_new.HORE_NR22_P1p .dff9(JEDE_FF17_WRn, JYBU_APU_RSTn_new, reg_old.cpu_dbus.BUS_CPU_D01p.out_old());
    /*_p14.HAVA*/ ch2_new.HAVA_NR22_P2p .dff9(JEDE_FF17_WRn, JYBU_APU_RSTn_new, reg_old.cpu_dbus.BUS_CPU_D02p.out_old());
    /*_p14.FORE*/ ch2_new.FORE_NR22_ADDp.dff9(ENUF_FF17_WRn, JYBU_APU_RSTn_new, reg_old.cpu_dbus.BUS_CPU_D03p.out_old());
    /*_p14.GATA*/ ch2_new.GATA_NR22_V0p .dff9(ENUF_FF17_WRn, JYBU_APU_RSTn_new, reg_old.cpu_dbus.BUS_CPU_D04p.out_old());
    /*_p14.GUFE*/ ch2_new.GUFE_NR22_V1p .dff9(ENUF_FF17_WRn, JYBU_APU_RSTn_new, reg_old.cpu_dbus.BUS_CPU_D05p.out_old());
    /*_p14.GURA*/ ch2_new.GURA_NR22_V2p .dff9(ENUF_FF17_WRn, JYBU_APU_RSTn_new, reg_old.cpu_dbus.BUS_CPU_D06p.out_old());
    /*_p14.GAGE*/ ch2_new.GAGE_NR22_V3p .dff9(ENUF_FF17_WRn, JYBU_APU_RSTn_new, reg_old.cpu_dbus.BUS_CPU_D07p.out_old());
  }

  {
    ...
    /*_p14.FOFE*/ ch2_new.FOFE_NR23_FREQ00p.dff9(ESUR_NR23_WRn1, HUDE_APU_RSTn_new, reg_old.cpu_dbus.BUS_CPU_D00p.out_old());
    /*_p14.FOVA*/ ch2_new.FOVA_NR23_FREQ01p.dff9(ESUR_NR23_WRn1, HUDE_APU_RSTn_new, reg_old.cpu_dbus.BUS_CPU_D01p.out_old());
    /*_p14.FEDY*/ ch2_new.FEDY_NR23_FREQ02p.dff9(ESUR_NR23_WRn1, HUDE_APU_RSTn_new, reg_old.cpu_dbus.BUS_CPU_D02p.out_old());
    /*_p14.FOME*/ ch2_new.FOME_NR23_FREQ03p.dff9(ESUR_NR23_WRn1, HUDE_APU_RSTn_new, reg_old.cpu_dbus.BUS_CPU_D03p.out_old());
    /*_p14.FORA*/ ch2_new.FORA_NR23_FREQ04p.dff9(ESUR_NR23_WRn1, HUDE_APU_RSTn_new, reg_old.cpu_dbus.BUS_CPU_D04p.out_old());
    /*_p14.GODA*/ ch2_new.GODA_NR23_FREQ05p.dff9(FYXO_NR23_WRn2, HUDE_APU_RSTn_new, reg_old.cpu_dbus.BUS_CPU_D05p.out_old());
    /*_p14.GUMY*/ ch2_new.GUMY_NR23_FREQ06p.dff9(FYXO_NR23_WRn2, HUDE_APU_RSTn_new, reg_old.cpu_dbus.BUS_CPU_D06p.out_old());
    /*_p14.GUPU*/ ch2_new.GUPU_NR23_FREQ07p.dff9(FYXO_NR23_WRn2, HUDE_APU_RSTn_new, reg_old.cpu_dbus.BUS_CPU_D07p.out_old());
  }

  {
    ...
    /*_pXX.JEFU*/ ch2_new.JEFU_NR24_FREQ08p.dff9(KYSA_NR24_WRn, KYPU_APU_RSTn_new, reg_old.cpu_dbus.BUS_CPU_D00p.out_old());
    /*_pXX.JANY*/ ch2_new.JANY_NR24_FREQ09p.dff9(KYSA_NR24_WRn, KYPU_APU_RSTn_new, reg_old.cpu_dbus.BUS_CPU_D01p.out_old());
    /*_pXX.JUPY*/ ch2_new.JUPY_NR24_FREQ10p.dff9(KYSA_NR24_WRn, KYPU_APU_RSTn_new, reg_old.cpu_dbus.BUS_CPU_D02p.out_old());
    ...
    /*#p??.ETAP*/ ch2_new.ETAP_NR24_TRIGp.dff9(DETA_NR24_WRn, DERA_TRIG_RSTn, reg_old.cpu_dbus.BUS_CPU_D07p.out_old());
    ...
    /*#pXX.EMER*/ ch2_new.EMER_NR24_LENENp.dff9(EVYF, FAZO_APU_RSTn_new, reg_old.cpu_dbus.BUS_CPU_D06p.out_old());
  }
  ...
  /*#p15.FUTE*/ wire FUTE_CH2_AMP_ENn_new = nor5(ch2_new.FORE_NR22_ADDp.qp_new(),
                                                 ch2_new.GATA_NR22_V0p.qp_new(),
                                                 ch2_new.GUFE_NR22_V1p.qp_new(),
                                                 ch2_new.GURA_NR22_V2p.qp_new(),
                                                 ch2_new.GAGE_NR22_V3p.qp_new());
...

  {
    ...
    /*_p14.DONE*/ ch2_new.DONE_COUNT00.dff20_any(DOCA_FREQ_TICKn                  , COGU_LOADp_new, ch2_new.FOFE_NR23_FREQ00p.qp_new());
    /*_p14.DYNU*/ ch2_new.DYNU_COUNT01.dff20_any(ch2_new.DONE_COUNT00.qp_new(), COGU_LOADp_new, ch2_new.FOVA_NR23_FREQ01p.qp_new());
    /*_p14.EZOF*/ ch2_new.EZOF_COUNT02.dff20_any(ch2_new.DYNU_COUNT01.qp_new(), COGU_LOADp_new, ch2_new.FEDY_NR23_FREQ02p.qp_new());
    /*_p14.CYVO*/ ch2_new.CYVO_COUNT03.dff20_any(ch2_new.EZOF_COUNT02.qp_new(), COGU_LOADp_new, ch2_new.FOME_NR23_FREQ03p.qp_new());

    /*#p14.EDEP*/ wire EDEP_CH2_FREQ_03 = not1(ch2_new.CYVO_COUNT03.qn_new());
    /*_p14.FUXO*/ ch2_new.FUXO_COUNT04.dff20_any(EDEP_CH2_FREQ_03                 , EROG_LOADp_new, ch2_new.FORA_NR23_FREQ04p.qp_new());
    /*_p14.GANO*/ ch2_new.GANO_COUNT05.dff20_any(ch2_new.FUXO_COUNT04.qp_new(), EROG_LOADp_new, ch2_new.GODA_NR23_FREQ05p.qp_new());
    /*_p14.GOCA*/ ch2_new.GOCA_COUNT06.dff20_any(ch2_new.GANO_COUNT05.qp_new(), EROG_LOADp_new, ch2_new.GUMY_NR23_FREQ06p.qp_new());
    /*_p14.GANE*/ ch2_new.GANE_COUNT07.dff20_any(ch2_new.GOCA_COUNT06.qp_new(), EROG_LOADp_new, ch2_new.GUPU_NR23_FREQ07p.qp_new());

    /*#p14.GALA*/ wire GALA_CH2_FREQ_07 = not1(ch2_new.GANE_COUNT07.qn_new());
    /*_p14.HEVY*/ ch2_new.HEVY_COUNT08.dff20_any(GALA_CH2_FREQ_07                 , GYPA_LOADp_new, ch2_new.JEFU_NR24_FREQ08p.qp_new());
    /*_p14.HEPU*/ ch2_new.HEPU_COUNT09.dff20_any(ch2_new.HEVY_COUNT08.qp_new(), GYPA_LOADp_new, ch2_new.JANY_NR24_FREQ09p.qp_new());
    /*_p14.HERO*/ ch2_new.HERO_COUNT10.dff20_any(ch2_new.HEPU_COUNT09.qp_new(), GYPA_LOADp_new, ch2_new.JUPY_NR24_FREQ10p.qp_new());
  }
...

  {
    ...
    /*#p15.JUPU*/ wire JUPU_ENV_OFFp_new = nor3(ch2_new.HYFU_NR22_P0p.qp_new(), ch2_new.HORE_NR22_P1p.qp_new(), ch2_new.HAVA_NR22_P2p.qp_new());
...

  {
    ...
    /*#p15.JORE*/ ch2_new.JORE_ENV_DELAY0p.dff20(KENE_ENV_CLK64_new,                    JAKE_ENV_LOADp_new, ch2_new.HYFU_NR22_P0p.qn_new());
    /*#p15.JONA*/ ch2_new.JONA_ENV_DELAY1p.dff20(ch2_new.JORE_ENV_DELAY0p.qp_new(), JAKE_ENV_LOADp_new, ch2_new.HORE_NR22_P1p.qn_new());
    /*#p15.JEVY*/ ch2_new.JEVY_ENV_DELAY2p.dff20(ch2_new.JONA_ENV_DELAY1p.qp_new(), JAKE_ENV_LOADp_new, ch2_new.HAVA_NR22_P2p.qn_new());
  }
...

  {
    ...
    /*#p15.EMYR*/ wire EMYR_ENV_BOTp_old = nor5 (ch2_old.FORE_NR22_ADDp.qp_old(), ch2_old.FENO_ENV_VOL0.qp_old(), ch2_old.FETE_ENV_VOL1.qp_old(), ch2_old.FOMY_ENV_VOL2.qp_old(), ch2_old.FENA_ENV_VOL3.qp_old());
    /*#p15.ERAT*/ wire ERAT_ENV_TOPn_old = nand5(ch2_old.FORE_NR22_ADDp.qp_old(), ch2_old.FENO_ENV_VOL0.qp_old(), ch2_old.FETE_ENV_VOL1.qp_old(), ch2_old.FOMY_ENV_VOL2.qp_old(), ch2_old.FENA_ENV_VOL3.qp_old());
...

  {
    ...
    /*#p15.GAFA*/ wire GAFA_ENV_CLK = amux2(ch2_new.FORE_NR22_ADDp.qp_new(), HOFO_ENV_CLK,                       HOFO_ENV_CLK,                       ch2_new.FORE_NR22_ADDp.qn_new());
    /*#p15.FENO*/ ch2_new.FENO_ENV_VOL0.dff20(GAFA_ENV_CLK, ch2_new.ELOX_TRIGp_d01.qp_new(), ch2_new.GATA_NR22_V0p.qp_new());

    /*#p15.FARU*/ wire FARU_ENV_CLK = amux2(ch2_new.FORE_NR22_ADDp.qp_new(), ch2_new.FENO_ENV_VOL0.qp_new(), ch2_new.FENO_ENV_VOL0.qn_new(), ch2_new.FORE_NR22_ADDp.qn_new());
    /*#p15.FETE*/ ch2_new.FETE_ENV_VOL1.dff20(FARU_ENV_CLK, ch2_new.ELOX_TRIGp_d01.qp_new(), ch2_new.GUFE_NR22_V1p.qp_new());

    /*#p15.ETUP*/ wire ETUP_ENV_CLK = amux2(ch2_new.FORE_NR22_ADDp.qp_new(), ch2_new.FETE_ENV_VOL1.qp_new(), ch2_new.FETE_ENV_VOL1.qn_new(), ch2_new.FORE_NR22_ADDp.qn_new());
    /*#p15.FOMY*/ ch2_new.FOMY_ENV_VOL2.dff20(ETUP_ENV_CLK, ch2_new.ELOX_TRIGp_d01.qp_new(), ch2_new.GURA_NR22_V2p.qp_new());

    /*#p15.FOPY*/ wire FOPY_ENV_CLK = amux2(ch2_new.FORE_NR22_ADDp.qp_new(), ch2_new.FOMY_ENV_VOL2.qp_new(), ch2_new.FOMY_ENV_VOL2.qn_new(), ch2_new.FORE_NR22_ADDp.qn_new());
    /*#p15.FENA*/ ch2_new.FENA_ENV_VOL3.dff20(FOPY_ENV_CLK, ch2_new.ELOX_TRIGp_d01.qp_new(), ch2_new.GAGE_NR22_V3p.qp_new());
  }
...

  {
    ...
    /*_p15.DEME*/ wire DEME_LEN_CLKn_new = nor3(ch2_old.CYRE_LEN_DONEp.qp_old(), BUFY_CLK_256, ch2_new.EMER_NR24_LENENp.qn_new()); // why was this or2?
...

  {
    ...
    /*_p14.BERA*/ ch2_new.BERA_NR21_DUTY0.dff9(BUDU_FF16_WRn, AFAT_APU_RSTn_new, reg_old.cpu_dbus.BUS_CPU_D06p.out_old());
    /*_p14.BAMY*/ ch2_new.BAMY_NR21_DUTY1.dff9(BUDU_FF16_WRn, AFAT_APU_RSTn_new, reg_old.cpu_dbus.BUS_CPU_D07p.out_old());
    ...
    /*#p15.DOJU*/ wire DOJU = nor2(ch2_new.BERA_NR21_DUTY0.qp_new(), ch2_new.BAMY_NR21_DUTY1.qn_new());
    /*#p15.DYTA*/ wire DYTA = nor2(ch2_new.BERA_NR21_DUTY0.qn_new(), ch2_new.BAMY_NR21_DUTY1.qp_new());
    /*#p15.DOMO*/ wire DOMO = nor2(ch2_new.BERA_NR21_DUTY0.qp_new(), ch2_new.BAMY_NR21_DUTY1.qp_new());
    /*#p15.DOVE*/ wire DOVE = nor2(ch2_new.BERA_NR21_DUTY0.qn_new(), ch2_new.BAMY_NR21_DUTY1.qn_new());
    ...
    /*_p15.DORA*/ wire DORA_CH2_STOPp_new = and2(ch2_new.CYRE_LEN_DONEp.qp_new(), ch2_new.EMER_NR24_LENENp.qp_new());
...

  {
    ...
    /*_p14.CECY*/ triwire CECY_D6 = tri6_nn(CORO_NR21_RDn, ch2_new.BERA_NR21_DUTY0.qn_new()); // polarity?
    /*_p14.CEKA*/ triwire CEKA_D7 = tri6_nn(CORO_NR21_RDn, ch2_new.BAMY_NR21_DUTY1.qn_new());
...

  {
    ...
    /*_p14.HUVU*/ triwire HUVU_D0 = tri6_nn(GEXA, ch2_new.HYFU_NR22_P0p .qn_new());
    /*_p14.HYRE*/ triwire HYRE_D1 = tri6_nn(GEXA, ch2_new.HORE_NR22_P1p .qn_new());
    /*_p14.HAVU*/ triwire HAVU_D2 = tri6_nn(GEXA, ch2_new.HAVA_NR22_P2p .qn_new());
    /*_p14.GENE*/ triwire GENE_D3 = tri6_nn(GURU, ch2_new.FORE_NR22_ADDp.qn_new());
    /*_p14.HUPE*/ triwire HUPE_D4 = tri6_nn(GURU, ch2_new.GATA_NR22_V0p .qn_new());
    /*_p14.HERE*/ triwire HERE_D5 = tri6_nn(GURU, ch2_new.GUFE_NR22_V1p .qn_new());
    /*_p14.HORO*/ triwire HORO_D6 = tri6_nn(GURU, ch2_new.GURA_NR22_V2p .qn_new());
    /*_p14.HYRY*/ triwire HYRY_D7 = tri6_nn(GURU, ch2_new.GAGE_NR22_V3p .qn_new());
...

  {
    ...
    /*#pXX.GOJY*/ triwire GOJY_D6 = tri6_nn(HUMA_NR24_RDn, ch2_new.EMER_NR24_LENENp.qn_new());
...
)
{
  ...
  /*#p10.ATUP*/ wire ATUP_A04n = not1(cpu_abus_new.BUS_CPU_A04p.out_new());
  /*_p10.DOSO*/ wire DOSO_A00p = not1(DYTE_A00n);
  /*_p10.DUPA*/ wire DUPA_A01p = not1(AFOB_A01n);
  /*_p10.DENO*/ wire DENO_A02p = not1(ABUB_A02n);
  /*#p10.DUCE*/ wire DUCE_A03p = not1(ACOL_A03n);
  ...
  /*_p10.ATEG*/ wire ATEG_ADDR_XX1Xn = or4(cpu_abus_new.BUS_CPU_A07p.out_new(), cpu_abus_new.BUS_CPU_A06p.out_new(), cpu_abus_new.BUS_CPU_A05p.out_new(), ATUP_A04n);
  /*_p10.BUNO*/ wire BUNO_ADDR_FF1Xp = nor2(BAKO_ADDR_FFXXn, ATEG_ADDR_XX1Xn);
  /*_p10.BANU*/ wire BANU_ADDR_FF1Xn = not1(BUNO_ADDR_FF1Xp);
  /*_p10.COVY*/ wire COVY_ADDR_FF16p = nor2(BANU_ADDR_FF1Xn, DAZA_ADDR_0110n);
  /*_p10.DUTU*/ wire DUTU_ADDR_FF17p = nor2(BANU_ADDR_FF1Xn, DUVU_ADDR_0111n);
...

  {
    ...
    /*_p14.JYBU*/ wire JYBU_APU_RSTn_new = not1(KEBA_APU_RSTp);
    /*_p14.HYFU*/ ch2_new.HYFU_NR22_P0p.dff9(JEDE_FF17_WRn, JYBU_APU_RSTn_new,  cpu_dbus_old.BUS_CPU_D00p.out_old());
    /*_p14.HORE*/ ch2_new.HORE_NR22_P1p.dff9(JEDE_FF17_WRn, JYBU_APU_RSTn_new,  cpu_dbus_old.BUS_CPU_D01p.out_old());
    /*_p14.HAVA*/ ch2_new.HAVA_NR22_P2p.dff9(JEDE_FF17_WRn, JYBU_APU_RSTn_new,  cpu_dbus_old.BUS_CPU_D02p.out_old());
    /*_p14.FORE*/ ch2_new.FORE_NR22_ADDp.dff9(ENUF_FF17_WRn, JYBU_APU_RSTn_new, cpu_dbus_old.BUS_CPU_D03p.out_old());
    /*_p14.GATA*/ ch2_new.GATA_NR22_V0p.dff9(ENUF_FF17_WRn, JYBU_APU_RSTn_new,  cpu_dbus_old.BUS_CPU_D04p.out_old());
    /*_p14.GUFE*/ ch2_new.GUFE_NR22_V1p.dff9(ENUF_FF17_WRn, JYBU_APU_RSTn_new,  cpu_dbus_old.BUS_CPU_D05p.out_old());
    /*_p14.GURA*/ ch2_new.GURA_NR22_V2p.dff9(ENUF_FF17_WRn, JYBU_APU_RSTn_new,  cpu_dbus_old.BUS_CPU_D06p.out_old());
    /*_p14.GAGE*/ ch2_new.GAGE_NR22_V3p.dff9(ENUF_FF17_WRn, JYBU_APU_RSTn_new,  cpu_dbus_old.BUS_CPU_D07p.out_old());
  }

  {
    ...
    /*_p14.FYXO*/ wire FYXO_NR23_WRn2 = not1(EXUC_NR23_WR2);
    /*_p14.HUDE*/ wire HUDE_APU_RSTn_new = not1(KEBA_APU_RSTp);
    /*_p14.FOFE*/ ch2_new.FOFE_NR23_FREQ00p.dff9(ESUR_NR23_WRn1, HUDE_APU_RSTn_new, cpu_dbus_old.BUS_CPU_D00p.out_old());
    /*_p14.FOVA*/ ch2_new.FOVA_NR23_FREQ01p.dff9(ESUR_NR23_WRn1, HUDE_APU_RSTn_new, cpu_dbus_old.BUS_CPU_D01p.out_old());
    /*_p14.FEDY*/ ch2_new.FEDY_NR23_FREQ02p.dff9(ESUR_NR23_WRn1, HUDE_APU_RSTn_new, cpu_dbus_old.BUS_CPU_D02p.out_old());
    /*_p14.FOME*/ ch2_new.FOME_NR23_FREQ03p.dff9(ESUR_NR23_WRn1, HUDE_APU_RSTn_new, cpu_dbus_old.BUS_CPU_D03p.out_old());
    /*_p14.FORA*/ ch2_new.FORA_NR23_FREQ04p.dff9(ESUR_NR23_WRn1, HUDE_APU_RSTn_new, cpu_dbus_old.BUS_CPU_D04p.out_old());
    /*_p14.GODA*/ ch2_new.GODA_NR23_FREQ05p.dff9(FYXO_NR23_WRn2, HUDE_APU_RSTn_new, cpu_dbus_old.BUS_CPU_D05p.out_old());
    /*_p14.GUMY*/ ch2_new.GUMY_NR23_FREQ06p.dff9(FYXO_NR23_WRn2, HUDE_APU_RSTn_new, cpu_dbus_old.BUS_CPU_D06p.out_old());
    /*_p14.GUPU*/ ch2_new.GUPU_NR23_FREQ07p.dff9(FYXO_NR23_WRn2, HUDE_APU_RSTn_new, cpu_dbus_old.BUS_CPU_D07p.out_old());
  }

  {
    ...
    /*_pXX.KYSA*/ wire KYSA_NR24_WRn = not1(JENU_NR24_WRp);
    /*_p14.KYPU*/ wire KYPU_APU_RSTn_new = not1(KEBA_APU_RSTp);
    /*_pXX.JEFU*/ ch2_new.JEFU_NR24_FREQ08p.dff9(KYSA_NR24_WRn, KYPU_APU_RSTn_new, cpu_dbus_old.BUS_CPU_D00p.out_old());
    /*_pXX.JANY*/ ch2_new.JANY_NR24_FREQ09p.dff9(KYSA_NR24_WRn, KYPU_APU_RSTn_new, cpu_dbus_old.BUS_CPU_D01p.out_old());
    /*_pXX.JUPY*/ ch2_new.JUPY_NR24_FREQ10p.dff9(KYSA_NR24_WRn, KYPU_APU_RSTn_new, cpu_dbus_old.BUS_CPU_D02p.out_old());

    /*#p??.DETA*/ wire DETA_NR24_WRn = nand2(BOGY_CPU_WRp, DOZA_ADDR_FF19p);
    /*#p15.DERA*/ wire DERA_TRIG_RSTn = nor2(KEBA_APU_RSTp, ch2_new.DOPE_TRIGp_d00.qp_new());
    /*#p??.ETAP*/ ch2_new.ETAP_NR24_TRIGp.dff9(DETA_NR24_WRn, DERA_TRIG_RSTn, cpu_dbus_old.BUS_CPU_D07p.out_old());

    // This goes to all the CHN_LENENp registers...why?
    /*_p16.ANUJ*/ wire ANUJ_CPU_WR_WEIRD = and2(SIG_IN_CPU_DBUS_FREE, BOGY_CPU_WRp);
    /*#pXX.EVYF*/ wire EVYF = nand2(ANUJ_CPU_WR_WEIRD, DOZA_ADDR_FF19p);
    /*_p14.FAZO*/ wire FAZO_APU_RSTn_new = not1(KEBA_APU_RSTp);
    /*#pXX.EMER*/ ch2_new.EMER_NR24_LENENp.dff9(EVYF, FAZO_APU_RSTn_new, cpu_dbus_old.BUS_CPU_D06p.out_old());
  }
  ...
  {
    /*_p15.CEXE*/ wire CEXE_APU_RSTn_new = not1(KEBA_APU_RSTp);
    /*#p15.DORY*/ ch2_new.DORY_TRIGp_d09.dff17(spu_new.CEMO_xBCDExxx.qp_new(), CEXE_APU_RSTn_new, ch2_old.ELOX_TRIGp_d01.qp_old());
    /*#p15.CAZA*/ ch2_new.CAZA_TRIGp_d17.dff17(spu_new.CEMO_xBCDExxx.qp_new(), CEXE_APU_RSTn_new, ch2_old.DORY_TRIGp_d09.qp_old());

    /*#p15.DOXA*/ wire DOXA_TRIG_RSTn_new = nor2(KEBA_APU_RSTp, ch2_new.DORY_TRIGp_d09.qp_new());
    /*#p15.ELOX*/ ch2_new.ELOX_TRIGp_d01.dff17(spu_new.CEMO_xBCDExxx.qp_new(), DOXA_TRIG_RSTn_new, ch2_old.DALA_TRIGp_d00.qn_old());
  ...
  /*#p15.BODO*/ wire BODO = not1(ch2_new.CAZA_TRIGp_d17.qp_new());
  /*_p15.BUTA*/ ch2_new.BUTA_FREQ_GATEp.nand_latch(ARES, BODO);
  /*#p15.CAMA*/ wire CAMA_FREQ_TICKp = nor2(spu_new.CEMO_xBCDExxx.qp_new(), ch2_new.BUTA_FREQ_GATEp.qp_new());
  /*_p15.DOCA*/ wire DOCA_FREQ_TICKn = not1(CAMA_FREQ_TICKp);
...

  {
    ...
    /*#p15.FUJY*/ wire FUJY_new = and2(ch2_new.GYKO_SAMPLE_CLKp.qp_new(), spu_new.CEMO_xBCDExxx.qp_new());
    /*#p15.GYRE*/ wire GYRE_RSTn_new = nor3(KEBA_APU_RSTp, ch2_new.ELOX_TRIGp_d01.qp_new(), FUJY_new);
    /*#p15.GYKO*/ ch2_new.GYKO_SAMPLE_CLKp.dff17_rst(GYRE_RSTn_new);
...

  {
    ...
    /*_p15.ERYC*/ ch2_new.ERYC_NR21_LEN0.dff20(DYRO_LEN_CLKp_new, BYMO_FF16_WRp_new,               cpu_dbus_old.BUS_CPU_D00p.out_new());
    /*_p15.CERA*/ ch2_new.CERA_NR21_LEN1.dff20(ch2_new.ERYC_NR21_LEN0.qp_new(), BYMO_FF16_WRp_new, cpu_dbus_old.BUS_CPU_D01p.out_new());
    /*_p15.CONU*/ ch2_new.CONU_NR21_LEN2.dff20(ch2_new.CERA_NR21_LEN1.qp_new(), BYMO_FF16_WRp_new, cpu_dbus_old.BUS_CPU_D02p.out_new());
    /*_p15.CAME*/ ch2_new.CAME_NR21_LEN3.dff20(ch2_new.CONU_NR21_LEN2.qp_new(), BYMO_FF16_WRp_new, cpu_dbus_old.BUS_CPU_D03p.out_new());
    /*#p15.BUKO*/ wire BUKO_CH2_LEN_CLK = not1(ch2_new.CAME_NR21_LEN3.qn_new());
    /*_p15.BUVA*/ ch2_new.BUVA_NR21_LEN4.dff20(               BUKO_CH2_LEN_CLK, AGET_FF16_WRp_new, cpu_dbus_old.BUS_CPU_D04p.out_new());
    /*_p15.AKYD*/ ch2_new.AKYD_NR21_LEN5.dff20(ch2_new.BUVA_NR21_LEN4.qp_new(), AGET_FF16_WRp_new, cpu_dbus_old.BUS_CPU_D05p.out_new());
...

  {
    ...
    /*_p14.BACU*/ wire BACU_FF16_WRp = and2(COVY_ADDR_FF16p, BOGY_CPU_WRp);
    /*_p14.BUDU*/ wire BUDU_FF16_WRn = not1(BACU_FF16_WRp);
    /*_p14.BERA*/ ch2_new.BERA_NR21_DUTY0.dff9(BUDU_FF16_WRn, AFAT_APU_RSTn_new, cpu_dbus_old.BUS_CPU_D06p.out_old());
    /*_p14.BAMY*/ ch2_new.BAMY_NR21_DUTY1.dff9(BUDU_FF16_WRn, AFAT_APU_RSTn_new, cpu_dbus_old.BUS_CPU_D07p.out_old());
