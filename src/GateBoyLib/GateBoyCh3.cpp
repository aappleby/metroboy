...
void tick_ch3(const GateBoyState& reg_old, GateBoyState& reg_new, uint8_t* wave_ram) {
...

  {
    ...
    /*_p16.GUXE*/ ch3_new.GUXE_NR30_AMP_ENp.dff9(GUCY_FF1A_WRn, GOVE_APU_RSTn_new, reg_old.cpu_dbus.BUS_CPU_D07p.out_any());
  }

  {
    ...
    /*_p16.HUKY*/ ch3_new.HUKY_NR32_VOL0p.dff9(GUZU_FF1C_WRn, GURO_APU_RSTn_new, reg_old.cpu_dbus.BUS_CPU_D05p.out_any());
    /*_p16.HODY*/ ch3_new.HODY_NR32_VOL1p.dff9(GUZU_FF1C_WRn, GURO_APU_RSTn_new, reg_old.cpu_dbus.BUS_CPU_D06p.out_any());
  }

  {
    ...
    /*_p16.KOGA*/ ch3_new.KOGA_NR33_FREQ00p.dff9(KULY_FF1D_WRn, KUHA_APU_RSTn_new, reg_old.cpu_dbus.BUS_CPU_D00p.out_any());
    /*_p16.JOVY*/ ch3_new.JOVY_NR33_FREQ01p.dff9(KULY_FF1D_WRn, KUHA_APU_RSTn_new, reg_old.cpu_dbus.BUS_CPU_D01p.out_any());
    /*_p16.JAXA*/ ch3_new.JAXA_NR33_FREQ02p.dff9(KULY_FF1D_WRn, KUHA_APU_RSTn_new, reg_old.cpu_dbus.BUS_CPU_D02p.out_any());
    /*_p16.JEFE*/ ch3_new.JEFE_NR33_FREQ03p.dff9(KULY_FF1D_WRn, KUHA_APU_RSTn_new, reg_old.cpu_dbus.BUS_CPU_D03p.out_any());
    /*_p16.JYPO*/ ch3_new.JYPO_NR33_FREQ04p.dff9(KULY_FF1D_WRn, KUHA_APU_RSTn_new, reg_old.cpu_dbus.BUS_CPU_D04p.out_any());
    /*_p16.JOVE*/ ch3_new.JOVE_NR33_FREQ05p.dff9(KYHO_FF1D_WRn, KUHA_APU_RSTn_new, reg_old.cpu_dbus.BUS_CPU_D05p.out_any());
    /*_p16.KANA*/ ch3_new.KANA_NR33_FREQ06p.dff9(KYHO_FF1D_WRn, KUHA_APU_RSTn_new, reg_old.cpu_dbus.BUS_CPU_D06p.out_any());
    /*_p16.KOGU*/ ch3_new.KOGU_NR33_FREQ07p.dff9(KYHO_FF1D_WRn, KUHA_APU_RSTn_new, reg_old.cpu_dbus.BUS_CPU_D07p.out_any());
  }

  {
    ...
    /*_p16.JEMO*/ ch3_new.JEMO_NR34_FREQ08p.dff9(JUZO_FF1E_WRn, KOPY_APU_RSTn_new, reg_old.cpu_dbus.BUS_CPU_D00p.out_any());
    /*_p16.JETY*/ ch3_new.JETY_NR34_FREQ09p.dff9(JUZO_FF1E_WRn, KOPY_APU_RSTn_new, reg_old.cpu_dbus.BUS_CPU_D01p.out_any());
    /*_p16.JACY*/ ch3_new.JACY_NR34_FREQ10p.dff9(JUZO_FF1E_WRn, KOPY_APU_RSTn_new, reg_old.cpu_dbus.BUS_CPU_D02p.out_any());
  }
...

  {
    ...
    /*_p16.GAVU*/ ch3_new.GAVU_NR34_TRIGp.dff9(EPYX_FF1E_WRp, FAKO_RESTART_RST, reg_old.cpu_dbus.BUS_CPU_D07p.out_any());
  }

  {
    ...
    /*#p16.GYRA*/ ch3_new.GYRA_TRIG_D3.dff17(reg_new.spu.CERY_AxxDExxH.qp_new(), GAZE_APU_RSTn_new, ch3_old.GYTA_TRIG_D2.qp_any());
...

  {
    ...
    /*#p18.ERUS*/ ch3_new.ERUS_WAVE_IDX1.dff17_clk(ch3_new.EFAR_WAVE_IDX0.qn_new(), ch3_old.ERUS_WAVE_IDX1.qn_any());
    /*#p18.EFUZ*/ ch3_new.EFUZ_WAVE_IDX2.dff17_clk(ch3_new.ERUS_WAVE_IDX1.qn_new(), ch3_old.EFUZ_WAVE_IDX2.qn_any());
    /*#p18.EXEL*/ ch3_new.EXEL_WAVE_IDX3.dff17_clk(ch3_new.EFUZ_WAVE_IDX2.qn_new(), ch3_old.EXEL_WAVE_IDX3.qn_any());
    /*#p18.EFAL*/ ch3_new.EFAL_WAVE_IDX4.dff17_clk(ch3_new.EXEL_WAVE_IDX3.qn_new(), ch3_old.EFAL_WAVE_IDX4.qn_any());
    /*#p18.FETY*/ ch3_new.FETY_WAVE_LOOP.dff17_clk(ch3_new.EFAL_WAVE_IDX4.qn_new(), ch3_old.FETY_WAVE_LOOP.qn_any());
  }
...

  {
    ...
    /*_p17.CYFO*/ ch3_new.CYFO_SAMPLE0p.dff9(BEKA_SAMPLE_CLKn, ACOR_APU_RSTn_new, reg_old.wave_dbus.BUS_WAVE_D00.qp_any());
    /*_p17.CESY*/ ch3_new.CESY_SAMPLE1p.dff9(BUFE_SAMPLE_CLKn, ACOR_APU_RSTn_new, reg_old.wave_dbus.BUS_WAVE_D01.qp_any());
    /*_p17.BUDY*/ ch3_new.BUDY_SAMPLE2p.dff9(BAJA_SAMPLE_CLKn, ACOR_APU_RSTn_new, reg_old.wave_dbus.BUS_WAVE_D02.qp_any());
    /*_p17.BEGU*/ ch3_new.BEGU_SAMPLE3p.dff9(COJU_SAMPLE_CLKn, ACOR_APU_RSTn_new, reg_old.wave_dbus.BUS_WAVE_D03.qp_any());
    /*_p17.CUVO*/ ch3_new.CUVO_SAMPLE4p.dff9(BEKA_SAMPLE_CLKn, ACOR_APU_RSTn_new, reg_old.wave_dbus.BUS_WAVE_D04.qp_any());
    /*_p17.CEVO*/ ch3_new.CEVO_SAMPLE5p.dff9(BUFE_SAMPLE_CLKn, ACOR_APU_RSTn_new, reg_old.wave_dbus.BUS_WAVE_D05.qp_any());
    /*_p17.BORA*/ ch3_new.BORA_SAMPLE6p.dff9(BAJA_SAMPLE_CLKn, ACOR_APU_RSTn_new, reg_old.wave_dbus.BUS_WAVE_D06.qp_any());
    /*_p17.BEPA*/ ch3_new.BEPA_SAMPLE7p.dff9(COJU_SAMPLE_CLKn, ACOR_APU_RSTn_new, reg_old.wave_dbus.BUS_WAVE_D07.qp_any());
  }
  ...
  /*_p16.HOTO*/ ch3_new.HOTO_NR34_LENENp.dff9(FOVO_FF1E_WRn_new, HEKY_APU_RSTn_new, reg_old.cpu_dbus.BUS_CPU_D06p.out_any());
  ...
  {
    /*#p18.GEPY*/ wire GEPY_LEN_CLKp_new = nor3(ch3_old.FEXU_LEN_DONEp.qp_any(), BUFY_CLK_256, ch3_new.HOTO_NR34_LENENp.qn_new()); // fexu/hoto polarity seems wrong
  ...
  /*_p18.FEXU*/ ch3_new.FEXU_LEN_DONEp.dff17(ch3_new.FYRU_NR31_LEN7p.qn_new(), GUDA_LEN_DONE_RSTn, ch3_old.FEXU_LEN_DONEp.qn_any());
...
)
{
  ...
  // using FEXU_old to break the loop
  {
    ...
    /*#p18.GEVO*/ ch3_new.GEVO_NR31_LEN0p.dff20(               GENU_LEN_CLKn_new, GAJY_FF1B_WRp_new, cpu_dbus_old.BUS_CPU_D00p.out_any());
    /*_p18.FORY*/ ch3_new.FORY_NR31_LEN1p.dff20(ch3_new.GEVO_NR31_LEN0p.qp_any(), GAJY_FF1B_WRp_new, cpu_dbus_old.BUS_CPU_D01p.out_any());
    /*_p18.GATU*/ ch3_new.GATU_NR31_LEN2p.dff20(ch3_new.FORY_NR31_LEN1p.qp_any(), GAJY_FF1B_WRp_new, cpu_dbus_old.BUS_CPU_D02p.out_any());
    /*_p18.GAPO*/ ch3_new.GAPO_NR31_LEN3p.dff20(ch3_new.GATU_NR31_LEN2p.qp_any(), GAJY_FF1B_WRp_new, cpu_dbus_old.BUS_CPU_D03p.out_any());

    /*#p18.FALU*/ wire FALU_LEN_CLKp = not1(ch3_new.GAPO_NR31_LEN3p.qn_any());
    /*_p18.GEMO*/ ch3_new.GEMO_NR31_LEN4p.dff20(                   FALU_LEN_CLKp, EMUT_FF1B_WRp_new, cpu_dbus_old.BUS_CPU_D04p.out_any());
    /*_p18.FORO*/ ch3_new.FORO_NR31_LEN5p.dff20(ch3_new.GEMO_NR31_LEN4p.qp_any(), EMUT_FF1B_WRp_new, cpu_dbus_old.BUS_CPU_D05p.out_any());
    /*_p18.FAVE*/ ch3_new.FAVE_NR31_LEN6p.dff20(ch3_new.FORO_NR31_LEN5p.qp_any(), EMUT_FF1B_WRp_new, cpu_dbus_old.BUS_CPU_D06p.out_any());
    /*_p18.FYRU*/ ch3_new.FYRU_NR31_LEN7p.dff20(ch3_new.FAVE_NR31_LEN6p.qp_any(), EMUT_FF1B_WRp_new, cpu_dbus_old.BUS_CPU_D07p.out_any());
  }
