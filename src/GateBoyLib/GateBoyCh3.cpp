...
)
{
  ...
  /*#p10.ASAD*/ wire ASAD_A06n = not1(cpu_abus_new.BUS_CPU_A06p.out_new());
  /*#p10.AVUN*/ wire AVUN_A07n = not1(cpu_abus_new.BUS_CPU_A07p.out_new());
  /*_p07.TONA*/ wire TONA_A08n = not1(cpu_abus_new.BUS_CPU_A08p.out_new());
  /*_p10.DOSO*/ wire DOSO_A00p = not1(DYTE_A00n);
  /*_p10.DUPA*/ wire DUPA_A01p = not1(AFOB_A01n);
  /*_p10.DENO*/ wire DENO_A02p = not1(ABUB_A02n);
  /*#p10.DUCE*/ wire DUCE_A03p = not1(ACOL_A03n);

  /*#p10.ACOM*/ wire ACOM_ADDR_XX3Xn = nand4(AVUN_A07n, ASAD_A06n, cpu_abus_new.BUS_CPU_A05p.out_new(), cpu_abus_new.BUS_CPU_A04p.out_new());
  /*#p07.SYKE*/ wire SYKE_ADDR_HIp_new = nor2(cpu_abus_new.TUNA_0000_FDFF_new(), TONA_A08n);
  /*_p07.BAKO*/ wire BAKO_ADDR_FFXXn = not1(SYKE_ADDR_HIp_new);
  /*#p10.BARO*/ wire BARO_ADDR_FF3Xp = nor2(ACOM_ADDR_XX3Xn, BAKO_ADDR_FFXXn);
...

  {
    ...
    /*_p16.GUCY*/ wire GUCY_FF1A_WRn = not1(GEJO_FF1A_WRp);
    /*_p16.GOVE*/ wire GOVE_APU_RSTn_new = not1(KEBA_APU_RSTp);
    /*_p16.GUXE*/ ch3_new.GUXE_NR30_AMP_ENp.dff9(GUCY_FF1A_WRn, GOVE_APU_RSTn_new, cpu_dbus_old.BUS_CPU_D07p.out_old());
  }

  {
    ...
    /*_p16.GUZU*/ wire GUZU_FF1C_WRn = not1(HAGA_FF1C_WRp);
    /*_p16.GURO*/ wire GURO_APU_RSTn_new = not1(KEBA_APU_RSTp);
    /*_p16.HUKY*/ ch3_new.HUKY_NR32_VOL0p.dff9(GUZU_FF1C_WRn, GURO_APU_RSTn_new, cpu_dbus_old.BUS_CPU_D05p.out_old());
    /*_p16.HODY*/ ch3_new.HODY_NR32_VOL1p.dff9(GUZU_FF1C_WRn, GURO_APU_RSTn_new, cpu_dbus_old.BUS_CPU_D06p.out_old());
  }

  {
    ...
    /*_p16.KOGA*/ ch3_new.KOGA_NR33_FREQ00p.dff9(KULY_FF1D_WRn, KUHA_APU_RSTn_new, cpu_dbus_old.BUS_CPU_D00p.out_old());
    /*_p16.JOVY*/ ch3_new.JOVY_NR33_FREQ01p.dff9(KULY_FF1D_WRn, KUHA_APU_RSTn_new, cpu_dbus_old.BUS_CPU_D01p.out_old());
    /*_p16.JAXA*/ ch3_new.JAXA_NR33_FREQ02p.dff9(KULY_FF1D_WRn, KUHA_APU_RSTn_new, cpu_dbus_old.BUS_CPU_D02p.out_old());
    /*_p16.JEFE*/ ch3_new.JEFE_NR33_FREQ03p.dff9(KULY_FF1D_WRn, KUHA_APU_RSTn_new, cpu_dbus_old.BUS_CPU_D03p.out_old());
    /*_p16.JYPO*/ ch3_new.JYPO_NR33_FREQ04p.dff9(KULY_FF1D_WRn, KUHA_APU_RSTn_new, cpu_dbus_old.BUS_CPU_D04p.out_old());
    /*_p16.JOVE*/ ch3_new.JOVE_NR33_FREQ05p.dff9(KYHO_FF1D_WRn, KUHA_APU_RSTn_new, cpu_dbus_old.BUS_CPU_D05p.out_old());
    /*_p16.KANA*/ ch3_new.KANA_NR33_FREQ06p.dff9(KYHO_FF1D_WRn, KUHA_APU_RSTn_new, cpu_dbus_old.BUS_CPU_D06p.out_old());
    /*_p16.KOGU*/ ch3_new.KOGU_NR33_FREQ07p.dff9(KYHO_FF1D_WRn, KUHA_APU_RSTn_new, cpu_dbus_old.BUS_CPU_D07p.out_old());
  }

  {
    ...
    /*_p16.KOPY*/ wire KOPY_APU_RSTn_new = not1(KEBA_APU_RSTp);
    /*_p16.JEMO*/ ch3_new.JEMO_NR34_FREQ08p.dff9(JUZO_FF1E_WRn, KOPY_APU_RSTn_new, cpu_dbus_old.BUS_CPU_D00p.out_old());
    /*_p16.JETY*/ ch3_new.JETY_NR34_FREQ09p.dff9(JUZO_FF1E_WRn, KOPY_APU_RSTn_new, cpu_dbus_old.BUS_CPU_D01p.out_old());
    /*_p16.JACY*/ ch3_new.JACY_NR34_FREQ10p.dff9(JUZO_FF1E_WRn, KOPY_APU_RSTn_new, cpu_dbus_old.BUS_CPU_D02p.out_old());
  }
...

  {
    ...
    /*#p18.EZAS*/ wire EZAS_CH3_ACTIVEn_old = not1(ch3_old.FOZU_CH3_ACTIVEp.qp_old());
    /*#p18.DORU*/ wire DORU_CH3_ACTIVEp_old = not1(EZAS_CH3_ACTIVEn_old);
    /*#p18.DAVO*/ ch3_new.DAVO_CH3_ACTIVEp.dff17(spu_new.AJER_AxxDExxH.qp_new(), CALU_APU_RSTn_new, DORU_CH3_ACTIVEp_old);
  }

  {
    ...
    /*_p16.EPYX*/ wire EPYX_FF1E_WRp = nor2(BOGY_CPU_WRp, DUGO_ADDR_FF1Ep); // polarity?
    /*_p16.FAKO*/ wire FAKO_RESTART_RST = nor2(KEBA_APU_RSTp, ch3_new.FOBA_CH3_TRIGp.qp_new());
    /*_p16.GAVU*/ ch3_new.GAVU_NR34_TRIGp.dff9(EPYX_FF1E_WRp, FAKO_RESTART_RST, cpu_dbus_old.BUS_CPU_D07p.out_old());
  }

  {
    /*_p16.GAZE*/ wire GAZE_APU_RSTn_new = not1(KEBA_APU_RSTp);
    /*#p16.FABO*/ wire FABO_CLK_xxCDxxGH = not1(spu_new.CERY_AxxDExxH.qp_new());

    /*#p16.GYRA*/ ch3_new.GYRA_TRIG_D3.dff17(spu_new.CERY_AxxDExxH.qp_new(), GAZE_APU_RSTn_new, ch3_old.GYTA_TRIG_D2.qp_old());
    /*#p16.GYTA*/ ch3_new.GYTA_TRIG_D2.dff17(FABO_CLK_xxCDxxGH, GAZE_APU_RSTn_new, ch3_old.GARA_TRIG_D1.qp_old());
  ...
  {
    /*#p18.HEFO*/ wire HEFO_FREQ_CLKn = nor2(spu_new.CERY_AxxDExxH.qp_new(), ch3_new.GUGU_FREQ_GATE.qp_new());
    /*_p18.JUTY*/ wire JUTY_FREQ_CLKp = not1(HEFO_FREQ_CLKn);
...

  {
    ...
    /*#p18.HUPA*/ wire HUPA_SAMPLE_CLK_RSTp_new = and2(ch3_new.HUNO_SAMPLE_CLKp.qp_new(), spu_new.CERY_AxxDExxH.qp_new());
    /*#p18.GAFU*/ wire GAFU_new = nor3(KEBA_APU_RSTp, ch3_new.GARA_TRIG_D1.qp_new(), HUPA_SAMPLE_CLK_RSTp_new);
    /*#p18.HUNO*/ ch3_new.HUNO_SAMPLE_CLKp.dff17_rst(GAFU_new);
  }
...

  {
    ...
    /*_p18.BOLE*/ wire BOLE_WAVE_A0 = mux2p(COKA_CH3_ACTIVEp, ch3_new.ERUS_WAVE_IDX1.qp_new(), cpu_abus_new.BUS_CPU_A00p.out_new());
    /*_p18.AGYL*/ wire AGYL_WAVE_A1 = mux2p(COKA_CH3_ACTIVEp, ch3_new.EFUZ_WAVE_IDX2.qp_new(), cpu_abus_new.BUS_CPU_A01p.out_new());
    /*_p18.AFUM*/ wire AFUM_WAVE_A2 = mux2p(COKA_CH3_ACTIVEp, ch3_new.EXEL_WAVE_IDX3.qp_new(), cpu_abus_new.BUS_CPU_A02p.out_new());
    /*_p18.AXOL*/ wire AXOL_WAVE_A3 = mux2p(COKA_CH3_ACTIVEp, ch3_new.EFAL_WAVE_IDX4.qp_new(), cpu_abus_new.BUS_CPU_A03p.out_new());
    ...
    /*_p17.CYFO*/ ch3_new.CYFO_SAMPLE0p.dff9(BEKA_SAMPLE_CLKn, ACOR_APU_RSTn_new, wave_dbus_old.BUS_WAVE_D00.qp_old());
    /*_p17.CESY*/ ch3_new.CESY_SAMPLE1p.dff9(BUFE_SAMPLE_CLKn, ACOR_APU_RSTn_new, wave_dbus_old.BUS_WAVE_D01.qp_old());
    /*_p17.BUDY*/ ch3_new.BUDY_SAMPLE2p.dff9(BAJA_SAMPLE_CLKn, ACOR_APU_RSTn_new, wave_dbus_old.BUS_WAVE_D02.qp_old());
    /*_p17.BEGU*/ ch3_new.BEGU_SAMPLE3p.dff9(COJU_SAMPLE_CLKn, ACOR_APU_RSTn_new, wave_dbus_old.BUS_WAVE_D03.qp_old());
    /*_p17.CUVO*/ ch3_new.CUVO_SAMPLE4p.dff9(BEKA_SAMPLE_CLKn, ACOR_APU_RSTn_new, wave_dbus_old.BUS_WAVE_D04.qp_old());
    /*_p17.CEVO*/ ch3_new.CEVO_SAMPLE5p.dff9(BUFE_SAMPLE_CLKn, ACOR_APU_RSTn_new, wave_dbus_old.BUS_WAVE_D05.qp_old());
    /*_p17.BORA*/ ch3_new.BORA_SAMPLE6p.dff9(BAJA_SAMPLE_CLKn, ACOR_APU_RSTn_new, wave_dbus_old.BUS_WAVE_D06.qp_old());
    /*_p17.BEPA*/ ch3_new.BEPA_SAMPLE7p.dff9(COJU_SAMPLE_CLKn, ACOR_APU_RSTn_new, wave_dbus_old.BUS_WAVE_D07.qp_old());
  }

  {
    ...
    /*#p17.CUGO*/ wire CUGO_WAVE_D0n = not1(wave_dbus_new.BUS_WAVE_D00.qp_new());
    /*#p17.CEGU*/ wire CEGU_WAVE_D1n = not1(wave_dbus_new.BUS_WAVE_D01.qp_new());
    /*#p17.ATEC*/ wire ATEC_WAVE_D2n = not1(wave_dbus_new.BUS_WAVE_D02.qp_new());
    /*#p17.ADOK*/ wire ADOK_WAVE_D3n = not1(wave_dbus_new.BUS_WAVE_D03.qp_new());
    /*#p17.BACA*/ wire BACA_WAVE_D4n = not1(wave_dbus_new.BUS_WAVE_D04.qp_new());
    /*#p17.BERO*/ wire BERO_WAVE_D5n = not1(wave_dbus_new.BUS_WAVE_D05.qp_new());
    /*#p17.CUTO*/ wire CUTO_WAVE_D6n = not1(wave_dbus_new.BUS_WAVE_D06.qp_new());
    /*#p17.AKAF*/ wire AKAF_WAVE_D7n = not1(wave_dbus_new.BUS_WAVE_D07.qp_new());
  ...
  /*#p16.FOVO*/ wire FOVO_FF1E_WRn_new = nand2(ANUJ_CPU_WR_WEIRD, DUGO_ADDR_FF1Ep);
  /*_p16.HEKY*/ wire HEKY_APU_RSTn_new = not1(KEBA_APU_RSTp);
  /*_p16.HOTO*/ ch3_new.HOTO_NR34_LENENp.dff9(FOVO_FF1E_WRn_new, HEKY_APU_RSTn_new, cpu_dbus_old.BUS_CPU_D06p.out_old());
  ...
  // using FEXU_old to break the loop
  {
    ...
    /*#p18.GEVO*/ ch3_new.GEVO_NR31_LEN0p.dff20(               GENU_LEN_CLKn_new, GAJY_FF1B_WRp_new, cpu_dbus_old.BUS_CPU_D00p.out_new());
    /*_p18.FORY*/ ch3_new.FORY_NR31_LEN1p.dff20(ch3_new.GEVO_NR31_LEN0p.qp_new(), GAJY_FF1B_WRp_new, cpu_dbus_old.BUS_CPU_D01p.out_new());
    /*_p18.GATU*/ ch3_new.GATU_NR31_LEN2p.dff20(ch3_new.FORY_NR31_LEN1p.qp_new(), GAJY_FF1B_WRp_new, cpu_dbus_old.BUS_CPU_D02p.out_new());
    /*_p18.GAPO*/ ch3_new.GAPO_NR31_LEN3p.dff20(ch3_new.GATU_NR31_LEN2p.qp_new(), GAJY_FF1B_WRp_new, cpu_dbus_old.BUS_CPU_D03p.out_new());

    /*#p18.FALU*/ wire FALU_LEN_CLKp = not1(ch3_new.GAPO_NR31_LEN3p.qn_new());
    /*_p18.GEMO*/ ch3_new.GEMO_NR31_LEN4p.dff20(                   FALU_LEN_CLKp, EMUT_FF1B_WRp_new, cpu_dbus_old.BUS_CPU_D04p.out_new());
    /*_p18.FORO*/ ch3_new.FORO_NR31_LEN5p.dff20(ch3_new.GEMO_NR31_LEN4p.qp_new(), EMUT_FF1B_WRp_new, cpu_dbus_old.BUS_CPU_D05p.out_new());
    /*_p18.FAVE*/ ch3_new.FAVE_NR31_LEN6p.dff20(ch3_new.FORO_NR31_LEN5p.qp_new(), EMUT_FF1B_WRp_new, cpu_dbus_old.BUS_CPU_D06p.out_new());
    /*_p18.FYRU*/ ch3_new.FYRU_NR31_LEN7p.dff20(ch3_new.FAVE_NR31_LEN6p.qp_new(), EMUT_FF1B_WRp_new, cpu_dbus_old.BUS_CPU_D07p.out_new());
  }
