...
)
{
...

  {
    ...
    /*_p19.EMOK*/ ch4_new.EMOK_NR42_ENV_TIMER0p.dff9(DYKE_FF21_WRn, FEXO_APU_RSTn_new, cpu_dbus_old.BUS_CPU_D00p.qp_any());
    /*_p19.ETYJ*/ ch4_new.ETYJ_NR42_ENV_TIMER1p.dff9(DYKE_FF21_WRn, FEXO_APU_RSTn_new, cpu_dbus_old.BUS_CPU_D01p.qp_any());
    /*_p19.EZYK*/ ch4_new.EZYK_NR42_ENV_TIMER2p.dff9(DYKE_FF21_WRn, FEXO_APU_RSTn_new, cpu_dbus_old.BUS_CPU_D02p.qp_any());
    /*_p19.GEKY*/ ch4_new.GEKY_NR42_ENV_DIRp   .dff9(FUPA_FF21_WRn, FEXO_APU_RSTn_new, cpu_dbus_old.BUS_CPU_D03p.qp_any());
    /*_p19.GARU*/ ch4_new.GARU_NR42_ENV0p      .dff9(FUPA_FF21_WRn, FEXO_APU_RSTn_new, cpu_dbus_old.BUS_CPU_D04p.qp_any());
    /*_p19.GOKY*/ ch4_new.GOKY_NR42_ENV1p      .dff9(FUPA_FF21_WRn, FEXO_APU_RSTn_new, cpu_dbus_old.BUS_CPU_D05p.qp_any());
    /*_p19.GOZO*/ ch4_new.GOZO_NR42_ENV2p      .dff9(FUPA_FF21_WRn, FEXO_APU_RSTn_new, cpu_dbus_old.BUS_CPU_D06p.qp_any());
    /*_p19.GEDU*/ ch4_new.GEDU_NR42_ENV3p      .dff9(FUPA_FF21_WRn, FEXO_APU_RSTn_new, cpu_dbus_old.BUS_CPU_D07p.qp_any());
  }

  {
    ...
    /*#p19.JARE*/ ch4_new.JARE_NR43_DIV0p .dff9(HOVA_FF22_WRn, KAME_APU_RSTn_new, cpu_dbus_old.BUS_CPU_D00p.qp_any());
    /*#p19.JERO*/ ch4_new.JERO_NR43_DIV1p .dff9(HOVA_FF22_WRn, KAME_APU_RSTn_new, cpu_dbus_old.BUS_CPU_D01p.qp_any());
    /*#p19.JAKY*/ ch4_new.JAKY_NR43_DIV2p .dff9(HOVA_FF22_WRn, KAME_APU_RSTn_new, cpu_dbus_old.BUS_CPU_D02p.qp_any());
    /*#p19.JAMY*/ ch4_new.JAMY_NR43_MODEp .dff9(HOSO_FF22_WRn, HYNE_APU_RSTn_new, cpu_dbus_old.BUS_CPU_D03p.qp_any());
    /*#p19.FETA*/ ch4_new.FETA_NR43_FREQ0p.dff9(EFUG_FF22_WRn, DAPA_APU_RSTn_new, cpu_dbus_old.BUS_CPU_D04p.qp_any());
    /*#p19.FYTO*/ ch4_new.FYTO_NR43_FREQ1p.dff9(EFUG_FF22_WRn, DAPA_APU_RSTn_new, cpu_dbus_old.BUS_CPU_D05p.qp_any());
    /*_p19.GOGO*/ ch4_new.GOGO_NR43_FREQ2p.dff9(EFUG_FF22_WRn, DAPA_APU_RSTn_new, cpu_dbus_old.BUS_CPU_D06p.qp_any());
    /*_p19.GAFO*/ ch4_new.GAFO_NR43_FREQ3p.dff9(EFUG_FF22_WRn, DAPA_APU_RSTn_new, cpu_dbus_old.BUS_CPU_D07p.qp_any());
  }


  /*#p20.GASO*/ wire GASO_APU_RSTn_new = not1(KEBA_APU_RSTp);
  /*#p20.GYSU*/ ch4_new.GYSU_CH4_TRIG.dff17(DOVA_ABCDxxxx, GASO_APU_RSTn_new, ch4_old.HOGA_NR44_TRIGp.qp_any());

  /*#p20.FEBY*/ wire FEBY_APU_RSTn_new = not1(KEBA_APU_RSTp);

  /*#p20.GONE*/ ch4_new.GONE_CH4_TRIGp.dff17_clk(HAMA_CLK_512K,                    ch4_old.HAZO_CH4_TRIGn.qn_any());
  /*#p20.GORA*/ ch4_new.GORA_CH4_TRIGp.dff17    (HAMA_CLK_512K, FEBY_APU_RSTn_new, ch4_old.GONE_CH4_TRIGp.qp_any());
  /*#p20.GATY*/ ch4_new.GATY_CH4_TRIGp.dff17    (HAMA_CLK_512K, FEBY_APU_RSTn_new, ch4_old.GORA_CH4_TRIGp.qp_any());
  ...
  /*#p19.CABE*/ wire CABE_APU_RSTn_new = not1(KEBA_APU_RSTp);
  /*#p19.CUNY*/ ch4_new.CUNY_NR44_LEN_ENp.dff9(DULU_FF23_WRn, CABE_APU_RSTn_new,  cpu_dbus_old.BUS_CPU_D06p.qp_any());
  /*#p19.HOGA*/ ch4_new.HOGA_NR44_TRIGp  .dff9(FOXE_FF23_WRn, GUZY_NR44_TRIG_RST, cpu_dbus_old.BUS_CPU_D07p.qp_any());
...

  {
    ...
    /*#p20.CEXO*/ ch4_new.CEXO_FREQ_00.dff17(                CARY_FREQ_CLK, DAPA_APU_RSTn_new, ch4_old.CEXO_FREQ_00.qn_any());
    /*_p20.DEKO*/ ch4_new.DEKO_FREQ_01.dff17(ch4_new.CEXO_FREQ_00.qn_any(), DAPA_APU_RSTn_new, ch4_old.DEKO_FREQ_01.qn_any());
    /*_p20.EZEF*/ ch4_new.EZEF_FREQ_02.dff17(ch4_new.DEKO_FREQ_01.qn_any(), DAPA_APU_RSTn_new, ch4_old.EZEF_FREQ_02.qn_any());
    /*_p20.EPOR*/ ch4_new.EPOR_FREQ_03.dff17(ch4_new.EZEF_FREQ_02.qn_any(), DAPA_APU_RSTn_new, ch4_old.EPOR_FREQ_03.qn_any());
    /*_p20.DURE*/ ch4_new.DURE_FREQ_04.dff17(ch4_new.EPOR_FREQ_03.qn_any(), DAPA_APU_RSTn_new, ch4_old.DURE_FREQ_04.qn_any());
    /*_p20.DALE*/ ch4_new.DALE_FREQ_05.dff17(ch4_new.DURE_FREQ_04.qn_any(), DAPA_APU_RSTn_new, ch4_old.DALE_FREQ_05.qn_any());
    /*_p20.DOKE*/ ch4_new.DOKE_FREQ_06.dff17(ch4_new.DALE_FREQ_05.qn_any(), DAPA_APU_RSTn_new, ch4_old.DOKE_FREQ_06.qn_any());
    /*_p20.DEMO*/ ch4_new.DEMO_FREQ_07.dff17(ch4_new.DOKE_FREQ_06.qn_any(), DAPA_APU_RSTn_new, ch4_old.DEMO_FREQ_07.qn_any());
    /*_p20.DOSE*/ ch4_new.DOSE_FREQ_08.dff17(ch4_new.DEMO_FREQ_07.qn_any(), DAPA_APU_RSTn_new, ch4_old.DOSE_FREQ_08.qn_any());
    /*_p20.DETE*/ ch4_new.DETE_FREQ_09.dff17(ch4_new.DOSE_FREQ_08.qn_any(), DAPA_APU_RSTn_new, ch4_old.DETE_FREQ_09.qn_any());
    /*_p20.ERUT*/ ch4_new.ERUT_FREQ_10.dff17(ch4_new.DETE_FREQ_09.qn_any(), DAPA_APU_RSTn_new, ch4_old.ERUT_FREQ_10.qn_any());
    /*_p20.DOTA*/ ch4_new.DOTA_FREQ_11.dff17(ch4_new.ERUT_FREQ_10.qn_any(), DAPA_APU_RSTn_new, ch4_old.DOTA_FREQ_11.qn_any());
    /*_p20.DERE*/ ch4_new.DERE_FREQ_12.dff17(ch4_new.DOTA_FREQ_11.qn_any(), DAPA_APU_RSTn_new, ch4_old.DERE_FREQ_12.qn_any());
    /*_p20.ESEP*/ ch4_new.ESEP_FREQ_13.dff17(ch4_new.DERE_FREQ_12.qn_any(), DAPA_APU_RSTn_new, ch4_old.ESEP_FREQ_13.qn_any());
  }
...

  {
    ...
    /*#p19.DANO*/ ch4_new.DANO_NR41_LEN0p.dff20(                   CUWA_LEN_CLKa, DOTU_FF20_WRb, cpu_dbus_old.BUS_CPU_D00p.qp_any());
    /*#p19.FAVY*/ ch4_new.FAVY_NR41_LEN1p.dff20(ch4_new.DANO_NR41_LEN0p.qp_any(), DOTU_FF20_WRb, cpu_dbus_old.BUS_CPU_D01p.qp_any());
    /*#p19.DENA*/ ch4_new.DENA_NR41_LEN2p.dff20(ch4_new.FAVY_NR41_LEN1p.qp_any(), DOTU_FF20_WRb, cpu_dbus_old.BUS_CPU_D02p.qp_any());
    /*#p19.CEDO*/ ch4_new.CEDO_NR41_LEN3p.dff20(ch4_new.DENA_NR41_LEN2p.qp_any(), DOTU_FF20_WRb, cpu_dbus_old.BUS_CPU_D03p.qp_any());

    /*#p19.DOPU*/ wire DOPU_NR41_LEN3p = not1(ch4_new.CEDO_NR41_LEN3p.qn_any());
    /*#p19.FYLO*/ ch4_new.FYLO_NR41_LEN4p.dff20(DOPU_NR41_LEN3p,                  EPEK_FF20_WRc, cpu_dbus_old.BUS_CPU_D04p.qp_any());
    /*#p19.EDOP*/ ch4_new.EDOP_NR41_LEN5p.dff20(ch4_new.FYLO_NR41_LEN4p.qp_any(), EPEK_FF20_WRc, cpu_dbus_old.BUS_CPU_D05p.qp_any());
    ...
    /*#p19.DANO*/ ch4_new.DANO_NR41_LEN0p.dff20_any(CUWA_LEN_CLKa2, DOTU_FF20_WRb, cpu_dbus_old.BUS_CPU_D00p.qp_any());
  }
  ...
  {
    /*#p20.HERY*/ wire HERY_DIV_GATE1n = nor2(GEVY_CH4_AMP_ENn, KEBA_APU_RSTp);
    /*#p20.HAPU*/ wire HAPU_CH4_TRIGn = not1(ch4_new.GATY_CH4_TRIGp.qp_any());
    /*#p20.JERY*/ ch4_new.JERY_DIV_GATE.nand_latch(HERY_DIV_GATE1n, HAPU_CH4_TRIGn);
  }

  {
    /*#p20.KYKU*/ wire KYKU_DIV_CLKb = or2(ch4_new.JERY_DIV_GATE.qp_any(), spu_new.JESO_CLK_512K.qp_any());
    /*#p20.KONY*/ wire KONY_DIV_CLKn = not1(KYKU_DIV_CLKb);
    /*#p20.KANU*/ wire KANU_DIV_CLKa = not1(KONY_DIV_CLKn);

    /*#p20.GOFU*/ wire GOFU_DIV_LOADn = nor2(ch4_new.GONE_CH4_TRIGp.qp_any(), ch4_new.GARY_FREQ_GATEp.qp_any());
    /*#p20.HUCE*/ wire HUCE_DIV_LOADp = not1(GOFU_DIV_LOADn);

    /*#p20.JYCO*/ ch4_new.JYCO_DIV0.dff20(             KANU_DIV_CLKa, HUCE_DIV_LOADp, ch4_old.JARE_NR43_DIV0p.qn_any());
    /*#p20.JYRE*/ ch4_new.JYRE_DIV1.dff20(ch4_new.JYCO_DIV0.qp_any(), HUCE_DIV_LOADp, ch4_old.JERO_NR43_DIV1p.qn_any());
    /*_p20.JYFU*/ ch4_new.JYFU_DIV2.dff20(ch4_new.JYRE_DIV1.qp_any(), HUCE_DIV_LOADp, ch4_old.JAKY_NR43_DIV2p.qn_any());
  }
...

  {
    ...
    /*#p20.GEPO*/ wire GEPO_LFSR_RSTa = or2(ch4_new.GONE_CH4_TRIGp.qp_any(), KEBA_APU_RSTp);
    /*#p20.GOGE*/ wire GOGE_LFSR_RSTn = not1(GEPO_LFSR_RSTa);
    ...
    /*#p20.KOMU*/ ch4_new.KOMU_LFSR_01.dff17(KOPA_LFSR_CLKp_new, GOGE_LFSR_RSTn, ch4_old.JOTO_LFSR_00.qp_any());
    /*#p20.KETU*/ ch4_new.KETU_LFSR_02.dff17(KOPA_LFSR_CLKp_new, GOGE_LFSR_RSTn, ch4_old.KOMU_LFSR_01.qp_any());
    /*#p20.KUTA*/ ch4_new.KUTA_LFSR_03.dff17(KOPA_LFSR_CLKp_new, GOGE_LFSR_RSTn, ch4_old.KETU_LFSR_02.qp_any());
    /*#p20.KUZY*/ ch4_new.KUZY_LFSR_04.dff17(KOPA_LFSR_CLKp_new, GOGE_LFSR_RSTn, ch4_old.KUTA_LFSR_03.qp_any());
    /*#p20.KYWY*/ ch4_new.KYWY_LFSR_05.dff17(KOPA_LFSR_CLKp_new, GOGE_LFSR_RSTn, ch4_old.KUZY_LFSR_04.qp_any());
    /*#p20.JAJU*/ ch4_new.JAJU_LFSR_06.dff17(GYVE_LFSR_CLKp_new, GOGE_LFSR_RSTn, ch4_old.KYWY_LFSR_05.qp_any());
    /*#p20.HAPE*/ ch4_new.HAPE_LFSR_07.dff17(GYVE_LFSR_CLKp_new, GOGE_LFSR_RSTn, ch4_old.JAJU_LFSR_06.qp_any());
    /*#p20.JUXE*/ ch4_new.JUXE_LFSR_08.dff17(GYVE_LFSR_CLKp_new, GOGE_LFSR_RSTn, ch4_old.HAPE_LFSR_07.qp_any());
    ...
    /*#p20.JAVO*/ ch4_new.JAVO_LFSR_10.dff17(GYVE_LFSR_CLKp_new, GOGE_LFSR_RSTn, ch4_old.JEPE_LFSR_09.qp_any());
    /*#p20.HEPA*/ ch4_new.HEPA_LFSR_11.dff17(FEME_LFSR_CLKp_new, GOGE_LFSR_RSTn, ch4_old.JAVO_LFSR_10.qp_any());
    /*#p20.HORY*/ ch4_new.HORY_LFSR_12.dff17(FEME_LFSR_CLKp_new, GOGE_LFSR_RSTn, ch4_old.HEPA_LFSR_11.qp_any());
    /*#p20.HENO*/ ch4_new.HENO_LFSR_13.dff17(FEME_LFSR_CLKp_new, GOGE_LFSR_RSTn, ch4_old.HORY_LFSR_12.qp_any());
    /*#p20.HYRO*/ ch4_new.HYRO_LFSR_14.dff17(FEME_LFSR_CLKp_new, GOGE_LFSR_RSTn, ch4_old.HENO_LFSR_13.qp_any());
    /*#p20.HEZU*/ ch4_new.HEZU_LFSR_15.dff17(FEME_LFSR_CLKp_new, GOGE_LFSR_RSTn, ch4_old.HYRO_LFSR_14.qp_any());
  }
...

  {
    ...
    /*#p20.CUNA*/ ch4_new.CUNA_ENV_DELAY0n.dff20(                  BUXO_CLK_64_new, DAPY_ENV_TIMER_LOADp_new, ch4_old.EMOK_NR42_ENV_TIMER0p.qn_any());
    /*#p20.COFE*/ ch4_new.COFE_ENV_DELAY1n.dff20(ch4_new.CUNA_ENV_DELAY0n.qp_any(), DAPY_ENV_TIMER_LOADp_new, ch4_old.ETYJ_NR42_ENV_TIMER1p.qn_any());
    /*#p20.DOGO*/ ch4_new.DOGO_ENV_DELAY2n.dff20(ch4_new.COFE_ENV_DELAY1n.qp_any(), DAPY_ENV_TIMER_LOADp_new, ch4_old.EZYK_NR42_ENV_TIMER2p.qn_any());
  }
