...
void GateBoy::tock_dma_gates() {
  ...
  /*#p04.NAFA*/ dma.NAFA_DMA_A08n.dff8p(LORU_FF46_WRn, cpu_dbus_old.BUS_CPU_D00p.out_old());
  /*_p04.PYNE*/ dma.PYNE_DMA_A09n.dff8p(LORU_FF46_WRn, cpu_dbus_old.BUS_CPU_D01p.out_old());
  /*_p04.PARA*/ dma.PARA_DMA_A10n.dff8p(LORU_FF46_WRn, cpu_dbus_old.BUS_CPU_D02p.out_old());
  /*_p04.NYDO*/ dma.NYDO_DMA_A11n.dff8p(LORU_FF46_WRn, cpu_dbus_old.BUS_CPU_D03p.out_old());
  /*_p04.NYGY*/ dma.NYGY_DMA_A12n.dff8p(LORU_FF46_WRn, cpu_dbus_old.BUS_CPU_D04p.out_old());
  /*_p04.PULA*/ dma.PULA_DMA_A13n.dff8p(LORU_FF46_WRn, cpu_dbus_old.BUS_CPU_D05p.out_old());
  /*_p04.POKU*/ dma.POKU_DMA_A14n.dff8p(LORU_FF46_WRn, cpu_dbus_old.BUS_CPU_D06p.out_old());
  /*_p04.MARU*/ dma.MARU_DMA_A15n.dff8p(LORU_FF46_WRn, cpu_dbus_old.BUS_CPU_D07p.out_old());
...
void GateBoy::tock_dma_logic() {
  ...
  if (FF46_RDp) {
    tri_8(&cpu_dbus_new.BUS_CPU_D00p, uint8_t(~pack(8, &dma.NAFA_DMA_A08n)));
  }
