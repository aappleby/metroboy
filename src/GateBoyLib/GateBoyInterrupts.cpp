...
{
  auto cpu_addr = bit_pack(reg.cpu_abus_new);
  ...
  reg.reg_ie.IE_D0.dff_r(FFFF_WRn_ext, ~reg.rst.PIN_71_RST.qp_int_new(), reg.cpu_dbus_old.BUS_CPU_D00p.out_old());
  reg.reg_ie.IE_D1.dff_r(FFFF_WRn_ext, ~reg.rst.PIN_71_RST.qp_int_new(), reg.cpu_dbus_old.BUS_CPU_D01p.out_old());
  reg.reg_ie.IE_D2.dff_r(FFFF_WRn_ext, ~reg.rst.PIN_71_RST.qp_int_new(), reg.cpu_dbus_old.BUS_CPU_D02p.out_old());
  reg.reg_ie.IE_D3.dff_r(FFFF_WRn_ext, ~reg.rst.PIN_71_RST.qp_int_new(), reg.cpu_dbus_old.BUS_CPU_D03p.out_old());
  reg.reg_ie.IE_D4.dff_r(FFFF_WRn_ext, ~reg.rst.PIN_71_RST.qp_int_new(), reg.cpu_dbus_old.BUS_CPU_D04p.out_old());
  ...
  /*_p21.ROXE*/ reg.reg_stat.ROXE_STAT_HBI_ENn.dff9(RYVE_FF41_WRn, WESY_SYS_RSTn(), reg.cpu_dbus_old.BUS_CPU_D03p.out_old());
  /*_p21.RUFO*/ reg.reg_stat.RUFO_STAT_VBI_ENn.dff9(RYVE_FF41_WRn, WESY_SYS_RSTn(), reg.cpu_dbus_old.BUS_CPU_D04p.out_old());
  /*_p21.REFE*/ reg.reg_stat.REFE_STAT_OAI_ENn.dff9(RYVE_FF41_WRn, WESY_SYS_RSTn(), reg.cpu_dbus_old.BUS_CPU_D05p.out_old());
  /*_p21.RUGU*/ reg.reg_stat.RUGU_STAT_LYI_ENn.dff9(RYVE_FF41_WRn, WESY_SYS_RSTn(), reg.cpu_dbus_old.BUS_CPU_D06p.out_old());

  /*_p21.TOBE*/ wire TOBE_FF41_RDp = and2(ASOT_CPU_RDp(), reg.cpu_abus_new.VARY_FF41p());
  ...
  /*_BUS_CPU_D00p*/ reg.cpu_dbus_new.BUS_CPU_D00p.tri_bus(TEBY_STAT0_TO_CD0);
  /*_BUS_CPU_D01p*/ reg.cpu_dbus_new.BUS_CPU_D01p.tri_bus(WUGA_STAT1_TO_CD1);
  /*_BUS_CPU_D02p*/ reg.cpu_dbus_new.BUS_CPU_D02p.tri_bus(SEGO_STAT2_TO_CD2);
  /*_BUS_CPU_D03p*/ reg.cpu_dbus_new.BUS_CPU_D03p.tri_bus(PUZO_STAT3_TO_CD3);
  /*_BUS_CPU_D04p*/ reg.cpu_dbus_new.BUS_CPU_D04p.tri_bus(POFO_STAT4_TO_CD4);
  /*_BUS_CPU_D05p*/ reg.cpu_dbus_new.BUS_CPU_D05p.tri_bus(SASY_STAT5_TO_CD5);
  /*_BUS_CPU_D06p*/ reg.cpu_dbus_new.BUS_CPU_D06p.tri_bus(POTE_STAT6_TO_CD6);
  ...
  /*_p07.REFA*/ wire REFA_FF0F_WRn = nand4(reg.cpu_signals.TAPU_CPU_WRp.out_new(), reg.cpu_abus_new.SYKE_ADDR_HIp(), reg.cpu_abus_new.SEMY_XX_0000xxxxp(), reg.cpu_abus_new.SAPA_XX_xxxx1111p()); // schematic wrong, is NAND
  ...
  /*_p02.MYZU*/ wire MYZU_FF0F_SET0n = nand3(ROTU_FF0F_WRp, LETY_INT_VBL_ACKn,  reg.cpu_dbus_new.BUS_CPU_D00p.out_new());
  /*_p02.MODY*/ wire MODY_FF0F_SET1n = nand3(ROTU_FF0F_WRp, LEJA_INT_STAT_ACKn, reg.cpu_dbus_new.BUS_CPU_D01p.out_new());
  /*_p02.PYHU*/ wire PYHU_FF0F_SET2n = nand3(ROTU_FF0F_WRp, LESA_INT_TIM_ACKn,  reg.cpu_dbus_new.BUS_CPU_D02p.out_new());
  /*_p02.TOME*/ wire TOME_FF0F_SET3n = nand3(ROTU_FF0F_WRp, LUFE_INT_SER_ACKn,  reg.cpu_dbus_new.BUS_CPU_D03p.out_new());
  /*_p02.TOGA*/ wire TOGA_FF0F_SET4n = nand3(ROTU_FF0F_WRp, LAMO_INT_JOY_ACKn,  reg.cpu_dbus_new.BUS_CPU_D04p.out_new());

  /*#p02.MUXE*/ wire MUXE_INT0_WRn = or2(reg.cpu_dbus_new.BUS_CPU_D00p.out_new(), REFA_FF0F_WRn);
  /*_p02.NABE*/ wire NABE_INT1_WRn = or2(reg.cpu_dbus_new.BUS_CPU_D01p.out_new(), REFA_FF0F_WRn);
  /*_p02.RAKE*/ wire RAKE_INT2_WRn = or2(reg.cpu_dbus_new.BUS_CPU_D02p.out_new(), REFA_FF0F_WRn);
  /*_p02.SULO*/ wire SULO_INT3_WRn = or2(reg.cpu_dbus_new.BUS_CPU_D03p.out_new(), REFA_FF0F_WRn);
  /*_p02.SEME*/ wire SEME_INT4_WRn = or2(reg.cpu_dbus_new.BUS_CPU_D04p.out_new(), REFA_FF0F_WRn);
  ...
  reg.cpu_dbus_new.BUS_CPU_D00p.tri_bus(tristate_i0);
  reg.cpu_dbus_new.BUS_CPU_D01p.tri_bus(tristate_i1);
  reg.cpu_dbus_new.BUS_CPU_D02p.tri_bus(tristate_i2);
  reg.cpu_dbus_new.BUS_CPU_D03p.tri_bus(tristate_i3);
  reg.cpu_dbus_new.BUS_CPU_D04p.tri_bus(tristate_i4);

  /*_p07.ROLO*/ wire ROLO_FF0F_RDn = nand4(reg.cpu_signals.TEDO_CPU_RDp.out_new(), reg.cpu_abus_new.SYKE_ADDR_HIp(), reg.cpu_abus_new.SEMY_XX_0000xxxxp(), reg.cpu_abus_new.SAPA_XX_xxxx1111p()); // schematic wrong, is NAND
  ...
  /*_BUS_CPU_D00p*/ reg.cpu_dbus_new.BUS_CPU_D00p.tri_bus(NELA_IF0_TO_CD0);
  /*_BUS_CPU_D01p*/ reg.cpu_dbus_new.BUS_CPU_D01p.tri_bus(NABO_IF1_TO_CD1);
  /*_BUS_CPU_D02p*/ reg.cpu_dbus_new.BUS_CPU_D02p.tri_bus(ROVA_IF2_TO_CD2);
  /*_BUS_CPU_D03p*/ reg.cpu_dbus_new.BUS_CPU_D03p.tri_bus(PADO_IF3_TO_CD3);
  /*_BUS_CPU_D04p*/ reg.cpu_dbus_new.BUS_CPU_D04p.tri_bus(PEGY_IF4_TO_CD4);
}
