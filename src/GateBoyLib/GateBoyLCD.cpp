...
void GateBoy::tock_lyc_gates(const GateBoyState& reg_old) {
  {
    ...
    /*#p21.ROPO*/ gb_state.int_ctrl.ROPO_LY_MATCH_SYNCp.dff17(gb_state.sys_clk.TALU_xxCDEFxx_new(), gb_state.sys_rst.WESY_SYS_RSTn(), PALY_LY_MATCHa_old);
  }
...
void GateBoy::tock_lcd_gates(const GateBoyState& reg_old) {
...

  {
    ...
    /*#p28.ANEL*/ gb_state.lcd.ANEL_LINE_ENDp_odd.dff17(gb_state.sys_clk.AWOH_xxCDxxGH_new(), reg_new.ABEZ_VID_RSTn(), gb_state.lcd.CATU_LINE_ENDp_odd.qp_old());
    ...
    /*#p29.CATU*/ gb_state.lcd.CATU_LINE_ENDp_odd.dff17(gb_state.sys_clk.XUPY_ABxxEFxx_new(), reg_new.ABEZ_VID_RSTn(), ABOV_LINE_ENDp_old);
    ...
    /*#p21.RUTU*/ gb_state.lcd.RUTU_LINE_ENDp_odd.dff17(gb_state.sys_clk.SONO_ABxxxxGH_new(),         reg_new.LYFE_VID_RSTn(), SANU_x113p_odd_old);

    /*_p28.ABAF*/ wire ABAF_LINE_ENDn_odd = not1(gb_state.lcd.CATU_LINE_ENDp_odd.qp_new());
    /*_p28.BYHA*/ wire BYHA_LINE_RST_TRIGn_odd = or_and3(gb_state.lcd.ANEL_LINE_ENDp_odd.qp_new(), ABAF_LINE_ENDn_odd, reg_new.ABEZ_VID_RSTn()); // so if this is or_and, BYHA should go low on 910 and 911
    /*_p28.ATEJ*/ gb_state.ATEJ_LINE_RST_TRIGp_odd <<= not1(BYHA_LINE_RST_TRIGn_odd);

    /*#p21.NYPE*/ gb_state.lcd.NYPE_LINE_ENDp_odd .dff17(gb_state.sys_clk.TALU_xxCDEFxx_new(),     reg_new.LYFE_VID_RSTn(), reg_old.lcd.RUTU_LINE_ENDp_odd.qp_old());
    /*#p21.POPU*/ gb_state.lcd.POPU_VBLANKp_odd   .dff17(gb_state.lcd.NYPE_LINE_ENDp_odd.qp_new(), reg_new.LYFE_VID_RSTn(), XYVO_y144p_old);
    /*#p21.MYTA*/ gb_state.lcd.MYTA_FRAME_ENDp_odd.dff17(gb_state.lcd.NYPE_LINE_ENDp_odd.qp_new(), reg_new.LYFE_VID_RSTn(), NOKO_y153p_old);
  }

  {
    ...
    /*#p21.SYGU*/ gb_state.lcd.SYGU_LINE_STROBE.dff17(gb_state.sys_clk.SONO_ABxxxxGH_new(), reg_new.LYFE_VID_RSTn(), TEGY_STROBE_old);
  }

  {
    /*#p21.MUDE*/ wire MUDE_X_RSTn = nor2(gb_state.lcd.RUTU_LINE_ENDp_odd.qp_new(), reg_new.LYHA_VID_RSTp());
    /*#p21.SAXO*/ gb_state.reg_lx.SAXO_LX0p_odd.dff17(gb_state.sys_clk.TALU_xxCDEFxx_new(),   MUDE_X_RSTn, gb_state.reg_lx.SAXO_LX0p_odd.qn_old());
  ...
  {
    /*#p21.LAMA*/ wire LAMA_Y_RSTn = nor2(gb_state.lcd.MYTA_FRAME_ENDp_odd.qp_new(), reg_new.LYHA_VID_RSTp());
...
void GateBoy::set_lcd_pins_gates(wire SACU_CLKPIPE_evn) {
  ...
  /*#p24.LUCA*/ gb_state.lcd.LUCA_LINE_EVENp .dff17(LOFU_x113n, reg_new.LYFE_VID_RSTn(), gb_state.lcd.LUCA_LINE_EVENp.qn_old());
  /*#p21.NAPO*/ gb_state.lcd.NAPO_FRAME_EVENp.dff17(gb_state.lcd.POPU_VBLANKp_odd.qp_new(), reg_new.LYFE_VID_RSTn(), gb_state.lcd.NAPO_FRAME_EVENp.qn_old());
  ...
  /*#p24.MEDA*/ gb_state.lcd.MEDA_VSYNC_OUTn.dff17(gb_state.lcd.NYPE_LINE_ENDp_odd.qn_new(), reg_new.LYFE_VID_RSTn(), NERU_VSYNCp);
  ...
  /*#p24.RUJU*/ gb_state.lcd.RUJU <<= or3(gb_state.lcd.PAHO_X8_SYNC.qp_new(), reg_new.TOFU_VID_RSTp(), gb_state.lcd.POME_X8_LATCH.out_mid());
  ...
  /*#p21.WEGO*/ wire WEGO_HBLANKp = or2(reg_new.TOFU_VID_RSTp(), gb_state.VOGA_HBLANKp_evn.qp_new());
