...
void GateBoy::tock_lyc_gates(const GateBoyState& reg_old) {
  {
    ...
    /*_p21.RYME*/ wire RYME_LY_MATCH0n_old = xor2(gb_state.reg_ly.MUWY_LY0p.qp_old(), gb_state.reg_lyc.SYRY_LYC0n.qn_old());
    /*_p21.TYDE*/ wire TYDE_LY_MATCH1n_old = xor2(gb_state.reg_ly.MYRO_LY1p.qp_old(), gb_state.reg_lyc.VUCE_LYC1n.qn_old());
    /*_p21.REDA*/ wire REDA_LY_MATCH2n_old = xor2(gb_state.reg_ly.LEXA_LY2p.qp_old(), gb_state.reg_lyc.SEDY_LYC2n.qn_old());
    /*_p21.RASY*/ wire RASY_LY_MATCH3n_old = xor2(gb_state.reg_ly.LYDO_LY3p.qp_old(), gb_state.reg_lyc.SALO_LYC3n.qn_old());
    /*_p21.TYKU*/ wire TYKU_LY_MATCH4n_old = xor2(gb_state.reg_ly.LOVU_LY4p.qp_old(), gb_state.reg_lyc.SOTA_LYC4n.qn_old());
    /*_p21.TUCY*/ wire TUCY_LY_MATCH5n_old = xor2(gb_state.reg_ly.LEMA_LY5p.qp_old(), gb_state.reg_lyc.VAFA_LYC5n.qn_old());
    /*_p21.TERY*/ wire TERY_LY_MATCH6n_old = xor2(gb_state.reg_ly.MATO_LY6p.qp_old(), gb_state.reg_lyc.VEVO_LYC6n.qn_old());
    /*_p21.SYFU*/ wire SYFU_LY_MATCH7n_old = xor2(gb_state.reg_ly.LAFO_LY7p.qp_old(), gb_state.reg_lyc.RAHA_LYC7n.qn_old());
...
void GateBoy::tock_lcd_gates() {
  {
    /*#p21.XYVO*/ wire XYVO_y144p = and2(gb_state.reg_ly.LOVU_LY4p.qp_old(), gb_state.reg_ly.LAFO_LY7p.qp_old()); // 128 + 16 = 144
    /*#p21.NOKO*/ wire NOKO_y153p = and4(gb_state.reg_ly.LAFO_LY7p.qp_old(), gb_state.reg_ly.LOVU_LY4p.qp_old(), gb_state.reg_ly.LYDO_LY3p.qp_old(), gb_state.reg_ly.MUWY_LY0p.qp_old()); // Schematic wrong: NOKO = and2(V7, V4, V3, V0) = 128 + 16 + 8 + 1 = 153

    /*#p28.ANEL*/ gb_state.lcd.ANEL_x113p.dff17(gb_state.sys_clk.AWOH_xxCDxxGH(), ABEZ_VID_RSTn(), gb_state.lcd.CATU_x113p.qp_old());

    /*#p21.PURE*/ wire PURE_x113n = not1(gb_state.lcd.RUTU_x113p.qp_old());
    ...
    /*#p29.CATU*/ gb_state.lcd.CATU_x113p.dff17(gb_state.sys_clk.XUPY_ABxxEFxx(), ABEZ_VID_RSTn(), ABOV_x113p);

    /*#p21.NYPE*/ gb_state.lcd.NYPE_x113p.dff17(gb_state.sys_clk.TALU_xxCDEFxx(),         LYFE_VID_RSTn(), gb_state.lcd.RUTU_x113p.qp_old());
    /*#p21.SANU*/ wire SANU_x113p = and4(gb_state.reg_lx.TYRY_LX6p.qp_old(), gb_state.reg_lx.TAHA_LX5p.qp_old(), gb_state.reg_lx.SUDE_LX4p.qp_old(), gb_state.reg_lx.SAXO_LX0p.qp_old()); // 113 = 64 + 32 + 16 + 1, schematic is wrong
    /*#p21.RUTU*/ gb_state.lcd.RUTU_x113p.dff17(gb_state.sys_clk.SONO_ABxxxxGH(),         LYFE_VID_RSTn(), SANU_x113p);

    /*_p28.ABAF*/ wire ABAF_x113n = not1(gb_state.lcd.CATU_x113p.qp_new());
  ...
  {
    /*#p21.TOCU*/ wire TOCU_LX0n_old = not1(gb_state.reg_lx.SAXO_LX0p.qp_old());
    /*#p21.VEPE*/ wire VEPE_LX1n_old = not1(gb_state.reg_lx.TYPO_LX1p.qp_old());
    /*_p21.VUTY*/ wire VUTY_LX2n_old = not1(gb_state.reg_lx.VYZO_LX2p.qp_old());
    /*_p21.VATE*/ wire VATE_LX3n_old = not1(gb_state.reg_lx.TELU_LX3p.qp_old());
    /*_p21.TUDA*/ wire TUDA_LX4n_old = not1(gb_state.reg_lx.SUDE_LX4p.qp_old());
    /*_p21.TAFY*/ wire TAFY_LX5n_old = not1(gb_state.reg_lx.TAHA_LX5p.qp_old());
    /*_p21.TUJU*/ wire TUJU_LX6n_old = not1(gb_state.reg_lx.TYRY_LX6p.qp_old());
    ...
    /*_p21.TOZU*/ wire TOZU_LX007n_old = nand7(TUJU_LX6n_old,            TAFY_LX5n_old,            TUDA_LX4n_old,            VATE_LX3n_old,            gb_state.reg_lx.VYZO_LX2p.qp_old(), gb_state.reg_lx.TYPO_LX1p.qp_old(), gb_state.reg_lx.SAXO_LX0p.qp_old()); // 0000111 == 7
    /*_p21.TECE*/ wire TECE_LX045n_old = nand7(TUJU_LX6n_old,            gb_state.reg_lx.TAHA_LX5p.qp_old(), TUDA_LX4n_old,            gb_state.reg_lx.TELU_LX3p.qp_old(), gb_state.reg_lx.VYZO_LX2p.qp_old(), VEPE_LX1n_old,            gb_state.reg_lx.SAXO_LX0p.qp_old()); // 0101101 == 45
    /*#p21.TEBO*/ wire TEBO_LX083n_old = nand7(gb_state.reg_lx.TYRY_LX6p.qp_old(), TAFY_LX5n_old,            gb_state.reg_lx.SUDE_LX4p.qp_old(), VATE_LX3n_old,            VUTY_LX2n_old,            gb_state.reg_lx.TYPO_LX1p.qp_old(), gb_state.reg_lx.SAXO_LX0p.qp_old()); // 1010011 == 83
  ...
  {
    /*#p21.MUDE*/ wire MUDE_X_RSTn = nor2(gb_state.lcd.RUTU_x113p.qp_new(), LYHA_VID_RSTp());
    /*#p21.SAXO*/ gb_state.reg_lx.SAXO_LX0p.dff17(gb_state.sys_clk.TALU_xxCDEFxx(),           MUDE_X_RSTn, gb_state.reg_lx.SAXO_LX0p.qn_old());
    /*#p21.TYPO*/ gb_state.reg_lx.TYPO_LX1p.dff17(gb_state.reg_lx.SAXO_LX0p.qn_new(), MUDE_X_RSTn, gb_state.reg_lx.TYPO_LX1p.qn_old());
    /*#p21.VYZO*/ gb_state.reg_lx.VYZO_LX2p.dff17(gb_state.reg_lx.TYPO_LX1p.qn_new(), MUDE_X_RSTn, gb_state.reg_lx.VYZO_LX2p.qn_old());
    /*#p21.TELU*/ gb_state.reg_lx.TELU_LX3p.dff17(gb_state.reg_lx.VYZO_LX2p.qn_new(), MUDE_X_RSTn, gb_state.reg_lx.TELU_LX3p.qn_old());
    /*#p21.SUDE*/ gb_state.reg_lx.SUDE_LX4p.dff17(gb_state.reg_lx.TELU_LX3p.qn_new(), MUDE_X_RSTn, gb_state.reg_lx.SUDE_LX4p.qn_old());
    /*#p21.TAHA*/ gb_state.reg_lx.TAHA_LX5p.dff17(gb_state.reg_lx.SUDE_LX4p.qn_new(), MUDE_X_RSTn, gb_state.reg_lx.TAHA_LX5p.qn_old());
    /*#p21.TYRY*/ gb_state.reg_lx.TYRY_LX6p.dff17(gb_state.reg_lx.TAHA_LX5p.qn_new(), MUDE_X_RSTn, gb_state.reg_lx.TYRY_LX6p.qn_old());
  }

  {
    /*#p21.LAMA*/ wire LAMA_Y_RSTn = nor2(gb_state.lcd.MYTA_y153p.qp_new(), LYHA_VID_RSTp());
    /*#p21.MUWY*/ gb_state.reg_ly.MUWY_LY0p.dff17(gb_state.lcd.RUTU_x113p.qp_new(), LAMA_Y_RSTn, gb_state.reg_ly.MUWY_LY0p.qn_old());
    /*#p21.MYRO*/ gb_state.reg_ly.MYRO_LY1p.dff17(gb_state.reg_ly.MUWY_LY0p.qn_new(),  LAMA_Y_RSTn, gb_state.reg_ly.MYRO_LY1p.qn_old());
    /*#p21.LEXA*/ gb_state.reg_ly.LEXA_LY2p.dff17(gb_state.reg_ly.MYRO_LY1p.qn_new(),  LAMA_Y_RSTn, gb_state.reg_ly.LEXA_LY2p.qn_old());
    /*#p21.LYDO*/ gb_state.reg_ly.LYDO_LY3p.dff17(gb_state.reg_ly.LEXA_LY2p.qn_new(),  LAMA_Y_RSTn, gb_state.reg_ly.LYDO_LY3p.qn_old());
    /*#p21.LOVU*/ gb_state.reg_ly.LOVU_LY4p.dff17(gb_state.reg_ly.LYDO_LY3p.qn_new(),  LAMA_Y_RSTn, gb_state.reg_ly.LOVU_LY4p.qn_old());
    /*#p21.LEMA*/ gb_state.reg_ly.LEMA_LY5p.dff17(gb_state.reg_ly.LOVU_LY4p.qn_new(),  LAMA_Y_RSTn, gb_state.reg_ly.LEMA_LY5p.qn_old());
    /*#p21.MATO*/ gb_state.reg_ly.MATO_LY6p.dff17(gb_state.reg_ly.LEMA_LY5p.qn_new(),  LAMA_Y_RSTn, gb_state.reg_ly.MATO_LY6p.qn_old());
    /*#p21.LAFO*/ gb_state.reg_ly.LAFO_LY7p.dff17(gb_state.reg_ly.MATO_LY6p.qn_new(),  LAMA_Y_RSTn, gb_state.reg_ly.LAFO_LY7p.qn_old());
  }

  {
    ...
    /*#p23.WURY*/ wire WURY_LY0n = not1(gb_state.reg_ly.MUWY_LY0p.qp_new());
    /*_p23.XEPO*/ wire XEPO_LY1n = not1(gb_state.reg_ly.MYRO_LY1p.qp_new());
    /*_p23.MYFA*/ wire MYFA_LY2n = not1(gb_state.reg_ly.LEXA_LY2p.qp_new());
    /*_p23.XUHY*/ wire XUHY_LY3n = not1(gb_state.reg_ly.LYDO_LY3p.qp_new());
    /*_p23.WATA*/ wire WATA_LY4n = not1(gb_state.reg_ly.LOVU_LY4p.qp_new());
    /*_p23.XAGA*/ wire XAGA_LY5n = not1(gb_state.reg_ly.LEMA_LY5p.qp_new());
    /*_p23.XUCE*/ wire XUCE_LY6n = not1(gb_state.reg_ly.MATO_LY6p.qp_new());
    /*_p23.XOWO*/ wire XOWO_LY7n = not1(gb_state.reg_ly.LAFO_LY7p.qp_new());
...
void GateBoy::set_lcd_pins_gates(wire SACU_CLKPIPE_evn) {
  ...
  /*_PIN_52*/ gb_state.lcd.PIN_52_LCD_CNTRL.pin_out(POGU, POGU);
  ...
  /*_PIN_56*/ gb_state.lcd.PIN_56_LCD_FLIPS.pin_out(KOFO, KOFO);
  ...
  /*_PIN_57*/ gb_state.lcd.PIN_57_LCD_VSYNC.pin_out(MURE_VSYNC, MURE_VSYNC);
  ...
  /*_PIN_54*/ gb_state.lcd.PIN_54_LCD_HSYNC.pin_out(RUZE_HSYNCn, RUZE_HSYNCn);

  /*_PIN_51*/ gb_state.lcd.PIN_51_LCD_DATA0.pin_out(gb_state.lcd.REMY_LD0n.out_new(), gb_state.lcd.REMY_LD0n.out_new());
  /*_PIN_50*/ gb_state.lcd.PIN_50_LCD_DATA1.pin_out(gb_state.lcd.RAVO_LD1n.out_new(), gb_state.lcd.RAVO_LD1n.out_new());
  ...
  /*_PIN_55*/ gb_state.lcd.PIN_55_LCD_LATCH.pin_out(KYMO_LINE_ENDn, KYMO_LINE_ENDn);
  ...
  /*#p21.WUSA*/ gb_state.lcd.WUSA_LCD_CLOCK_GATE.nor_latch(XAJO_X_009p, WEGO_HBLANKp);
  ...
  /*_PIN_53*/ gb_state.lcd.PIN_53_LCD_CLOCK.pin_out(RYPO_LCD_CLOCK, RYPO_LCD_CLOCK);
