...
void GateBoy::tock_oam_bus_gates(const GateBoyState& reg_old)
{
  ...
  /*_p28.XUTO*/ wire XUTO_CPU_OAM_WRp = and2(reg_new.cpu_abus.SARO_ADDR_OAMp(), reg_new.cpu_signals.CUPA_CPU_WRp());
  /*_p28.WUJE*/ reg_new.oam_ctrl.WUJE_CPU_OAM_WRn.nor_latch(reg_new.sys_clk.XYNY_ABCDxxxx_new(), XUTO_CPU_OAM_WRp);

  /*_p28.XUPA*/ wire XUPA_CPU_OAM_WRp  = not1(reg_new.oam_ctrl.WUJE_CPU_OAM_WRn.qp_new());
  /*#p28.AJUJ*/ wire AJUJ_OAM_BUSYn    = nor3(reg_new.MATU_DMA_RUNNINGp_odd.qp_new(), reg_new.ACYL_SCANNINGp_odd.out_new(), AJON_RENDERINGp);
  /*#p28.AMAB*/ wire AMAB_CPU_OAM_ENp  = and2(reg_new.cpu_abus.SARO_ADDR_OAMp(), AJUJ_OAM_BUSYn); // def and
  /*#p28.APAG*/ wire APAG_CBD_TO_OBDp  = amux2(XUPA_CPU_OAM_WRp, AMAB_CPU_OAM_ENp, AJUJ_OAM_BUSYn, reg_new.cpu_abus.ADAH_FE00_FEFFn());
  /*#p28.AZUL*/ wire AZUL_CBD_TO_OBDn  = not1(APAG_CBD_TO_OBDp);

  /*_p28.ZAMY*/ triwire ZAMY_CD0_TO_ODA0 = tri6_nn(AZUL_CBD_TO_OBDn, reg_new.cpu_dbus.BUS_CPU_D00p.out_new());
  /*_p28.ZOPU*/ triwire ZOPU_CD1_TO_ODA1 = tri6_nn(AZUL_CBD_TO_OBDn, reg_new.cpu_dbus.BUS_CPU_D01p.out_new());
  /*_p28.WYKY*/ triwire WYKY_CD2_TO_ODA2 = tri6_nn(AZUL_CBD_TO_OBDn, reg_new.cpu_dbus.BUS_CPU_D02p.out_new());
  /*_p28.ZAJA*/ triwire ZAJA_CD3_TO_ODA3 = tri6_nn(AZUL_CBD_TO_OBDn, reg_new.cpu_dbus.BUS_CPU_D03p.out_new());
  /*_p28.ZUGA*/ triwire ZUGA_CD4_TO_ODA4 = tri6_nn(AZUL_CBD_TO_OBDn, reg_new.cpu_dbus.BUS_CPU_D04p.out_new());
  /*_p28.ZUMO*/ triwire ZUMO_CD5_TO_ODA5 = tri6_nn(AZUL_CBD_TO_OBDn, reg_new.cpu_dbus.BUS_CPU_D05p.out_new());
  /*_p28.XYTO*/ triwire XYTO_CD6_TO_ODA6 = tri6_nn(AZUL_CBD_TO_OBDn, reg_new.cpu_dbus.BUS_CPU_D06p.out_new());
  /*_p28.ZYFA*/ triwire ZYFA_CD7_TO_ODA7 = tri6_nn(AZUL_CBD_TO_OBDn, reg_new.cpu_dbus.BUS_CPU_D07p.out_new());

  /*_p28.ZAXA*/ triwire ZAXA_CD0_TO_ODB0 = tri6_nn(AZUL_CBD_TO_OBDn, reg_new.cpu_dbus.BUS_CPU_D00p.out_new());
  /*_p28.ZAKY*/ triwire ZAKY_CD1_TO_ODB1 = tri6_nn(AZUL_CBD_TO_OBDn, reg_new.cpu_dbus.BUS_CPU_D01p.out_new());
  /*_p28.WULE*/ triwire WULE_CD2_TO_ODB2 = tri6_nn(AZUL_CBD_TO_OBDn, reg_new.cpu_dbus.BUS_CPU_D02p.out_new());
  /*_p28.ZOZO*/ triwire ZOZO_CD3_TO_ODB3 = tri6_nn(AZUL_CBD_TO_OBDn, reg_new.cpu_dbus.BUS_CPU_D03p.out_new());
  /*_p28.ZUFO*/ triwire ZUFO_CD4_TO_ODB4 = tri6_nn(AZUL_CBD_TO_OBDn, reg_new.cpu_dbus.BUS_CPU_D04p.out_new());
  /*_p28.ZATO*/ triwire ZATO_CD5_TO_ODB5 = tri6_nn(AZUL_CBD_TO_OBDn, reg_new.cpu_dbus.BUS_CPU_D05p.out_new());
  /*_p28.YVUC*/ triwire YVUC_CD6_TO_ODB6 = tri6_nn(AZUL_CBD_TO_OBDn, reg_new.cpu_dbus.BUS_CPU_D06p.out_new());
  /*_p28.ZUFE*/ triwire ZUFE_CD7_TO_ODB7 = tri6_nn(AZUL_CBD_TO_OBDn, reg_new.cpu_dbus.BUS_CPU_D07p.out_new());

  /*_BUS_OAM_DA00n*/ reg_new.oam_dbus_a.BUS_OAM_DA00n.tri_bus(ZAMY_CD0_TO_ODA0);
  /*_BUS_OAM_DA01n*/ reg_new.oam_dbus_a.BUS_OAM_DA01n.tri_bus(ZOPU_CD1_TO_ODA1);
  /*_BUS_OAM_DA02n*/ reg_new.oam_dbus_a.BUS_OAM_DA02n.tri_bus(WYKY_CD2_TO_ODA2);
  /*_BUS_OAM_DA03n*/ reg_new.oam_dbus_a.BUS_OAM_DA03n.tri_bus(ZAJA_CD3_TO_ODA3);
  /*_BUS_OAM_DA04n*/ reg_new.oam_dbus_a.BUS_OAM_DA04n.tri_bus(ZUGA_CD4_TO_ODA4);
  /*_BUS_OAM_DA05n*/ reg_new.oam_dbus_a.BUS_OAM_DA05n.tri_bus(ZUMO_CD5_TO_ODA5);
  /*_BUS_OAM_DA06n*/ reg_new.oam_dbus_a.BUS_OAM_DA06n.tri_bus(XYTO_CD6_TO_ODA6);
  /*_BUS_OAM_DA07n*/ reg_new.oam_dbus_a.BUS_OAM_DA07n.tri_bus(ZYFA_CD7_TO_ODA7);

  /*_BUS_OAM_DB00n*/ reg_new.oam_dbus_b.BUS_OAM_DB00n.tri_bus(ZAXA_CD0_TO_ODB0);
  /*_BUS_OAM_DB01n*/ reg_new.oam_dbus_b.BUS_OAM_DB01n.tri_bus(ZAKY_CD1_TO_ODB1);
  /*_BUS_OAM_DB02n*/ reg_new.oam_dbus_b.BUS_OAM_DB02n.tri_bus(WULE_CD2_TO_ODB2);
  /*_BUS_OAM_DB03n*/ reg_new.oam_dbus_b.BUS_OAM_DB03n.tri_bus(ZOZO_CD3_TO_ODB3);
  /*_BUS_OAM_DB04n*/ reg_new.oam_dbus_b.BUS_OAM_DB04n.tri_bus(ZUFO_CD4_TO_ODB4);
  /*_BUS_OAM_DB05n*/ reg_new.oam_dbus_b.BUS_OAM_DB05n.tri_bus(ZATO_CD5_TO_ODB5);
  /*_BUS_OAM_DB06n*/ reg_new.oam_dbus_b.BUS_OAM_DB06n.tri_bus(YVUC_CD6_TO_ODB6);
  /*_BUS_OAM_DB07n*/ reg_new.oam_dbus_b.BUS_OAM_DB07n.tri_bus(ZUFE_CD7_TO_ODB7);
  ...
  /*_p04.MORY*/ wire MORY_DMA_CARTn = nand2(reg_new.MATU_DMA_RUNNINGp_odd.qp_new(), LOGO_DMA_VRAMn);
  ...
  /*_BUS_OAM_DA00n*/ reg_new.oam_dbus_a.BUS_OAM_DA00n.tri_bus(WASA_ED0_TO_ODA0);
  /*_BUS_OAM_DA01n*/ reg_new.oam_dbus_a.BUS_OAM_DA01n.tri_bus(BOMO_ED1_TO_ODA1);
  /*_BUS_OAM_DA02n*/ reg_new.oam_dbus_a.BUS_OAM_DA02n.tri_bus(BASA_ED2_TO_ODA2);
  /*_BUS_OAM_DA03n*/ reg_new.oam_dbus_a.BUS_OAM_DA03n.tri_bus(CAKO_ED3_TO_ODA3);
  /*_BUS_OAM_DA04n*/ reg_new.oam_dbus_a.BUS_OAM_DA04n.tri_bus(BUMA_ED4_TO_ODA4);
  /*_BUS_OAM_DA05n*/ reg_new.oam_dbus_a.BUS_OAM_DA05n.tri_bus(BUPY_ED5_TO_ODA5);
  /*_BUS_OAM_DA06n*/ reg_new.oam_dbus_a.BUS_OAM_DA06n.tri_bus(BASY_ED6_TO_ODA6);
  /*_BUS_OAM_DA07n*/ reg_new.oam_dbus_a.BUS_OAM_DA07n.tri_bus(BAPE_ED7_TO_ODA7);

  /*_BUS_OAM_DB00n*/ reg_new.oam_dbus_b.BUS_OAM_DB00n.tri_bus(WEJO_ED0_TO_ODB0);
  /*_BUS_OAM_DB01n*/ reg_new.oam_dbus_b.BUS_OAM_DB01n.tri_bus(BUBO_ED1_TO_ODB1);
  /*_BUS_OAM_DB02n*/ reg_new.oam_dbus_b.BUS_OAM_DB02n.tri_bus(BETU_ED2_TO_ODB2);
  /*_BUS_OAM_DB03n*/ reg_new.oam_dbus_b.BUS_OAM_DB03n.tri_bus(CYME_ED3_TO_ODB3);
  /*_BUS_OAM_DB04n*/ reg_new.oam_dbus_b.BUS_OAM_DB04n.tri_bus(BAXU_ED4_TO_ODB4);
  /*_BUS_OAM_DB05n*/ reg_new.oam_dbus_b.BUS_OAM_DB05n.tri_bus(BUHU_ED5_TO_ODB5);
  /*_BUS_OAM_DB06n*/ reg_new.oam_dbus_b.BUS_OAM_DB06n.tri_bus(BYNY_ED6_TO_ODB6);
  /*_BUS_OAM_DB07n*/ reg_new.oam_dbus_b.BUS_OAM_DB07n.tri_bus(BYPY_ED7_TO_ODB7);

  // vram dma to oam data bus

  /*_p04.MUHO*/ wire MUHO_DMA_VRAMp = nand2(reg_new.MATU_DMA_RUNNINGp_odd.qp_new(), MUDA_DMA_VRAMp);
  /*_p04.LUFA*/ wire LUFA_DMA_VRAMp = not1(MUHO_DMA_VRAMp);
  /*_p28.AZAR*/ wire AZAR_VBD_TO_OBDn = not1(LUFA_DMA_VRAMp);

  /*_p28.WUZU*/ triwire WUZU_VD0_TO_ODA0 = tri6_nn(AZAR_VBD_TO_OBDn, reg_new.vram_dbus.BUS_VRAM_D00p.out_new());
  /*_p28.AXER*/ triwire AXER_VD1_TO_ODA1 = tri6_nn(AZAR_VBD_TO_OBDn, reg_new.vram_dbus.BUS_VRAM_D01p.out_new());
  /*_p28.ASOX*/ triwire ASOX_VD2_TO_ODA2 = tri6_nn(AZAR_VBD_TO_OBDn, reg_new.vram_dbus.BUS_VRAM_D02p.out_new());
  /*_p28.CETU*/ triwire CETU_VD3_TO_ODA3 = tri6_nn(AZAR_VBD_TO_OBDn, reg_new.vram_dbus.BUS_VRAM_D03p.out_new());
  /*_p28.ARYN*/ triwire ARYN_VD4_TO_ODA4 = tri6_nn(AZAR_VBD_TO_OBDn, reg_new.vram_dbus.BUS_VRAM_D04p.out_new());
  /*_p28.ACOT*/ triwire ACOT_VD5_TO_ODA5 = tri6_nn(AZAR_VBD_TO_OBDn, reg_new.vram_dbus.BUS_VRAM_D05p.out_new());
  /*_p28.CUJE*/ triwire CUJE_VD6_TO_ODA6 = tri6_nn(AZAR_VBD_TO_OBDn, reg_new.vram_dbus.BUS_VRAM_D06p.out_new());
  /*_p28.ATER*/ triwire ATER_VD7_TO_ODA7 = tri6_nn(AZAR_VBD_TO_OBDn, reg_new.vram_dbus.BUS_VRAM_D07p.out_new());

  /*_p28.WOWA*/ triwire WOWA_VD0_TO_ODB0 = tri6_nn(AZAR_VBD_TO_OBDn, reg_new.vram_dbus.BUS_VRAM_D00p.out_new());
  /*_p28.AVEB*/ triwire AVEB_VD1_TO_ODB1 = tri6_nn(AZAR_VBD_TO_OBDn, reg_new.vram_dbus.BUS_VRAM_D01p.out_new());
  /*_p28.AMUH*/ triwire AMUH_VD2_TO_ODB2 = tri6_nn(AZAR_VBD_TO_OBDn, reg_new.vram_dbus.BUS_VRAM_D02p.out_new());
  /*_p28.COFO*/ triwire COFO_VD3_TO_ODB3 = tri6_nn(AZAR_VBD_TO_OBDn, reg_new.vram_dbus.BUS_VRAM_D03p.out_new());
  /*_p28.AZOZ*/ triwire AZOZ_VD4_TO_ODB4 = tri6_nn(AZAR_VBD_TO_OBDn, reg_new.vram_dbus.BUS_VRAM_D04p.out_new());
  /*_p28.AGYK*/ triwire AGYK_VD5_TO_ODB5 = tri6_nn(AZAR_VBD_TO_OBDn, reg_new.vram_dbus.BUS_VRAM_D05p.out_new());
  /*_p28.BUSE*/ triwire BUSE_VD6_TO_ODB6 = tri6_nn(AZAR_VBD_TO_OBDn, reg_new.vram_dbus.BUS_VRAM_D06p.out_new());
  /*_p28.ANUM*/ triwire ANUM_VD7_TO_ODB7 = tri6_nn(AZAR_VBD_TO_OBDn, reg_new.vram_dbus.BUS_VRAM_D07p.out_new());

  /*_BUS_OAM_DA00n*/ reg_new.oam_dbus_a.BUS_OAM_DA00n.tri_bus(WUZU_VD0_TO_ODA0);
  /*_BUS_OAM_DA01n*/ reg_new.oam_dbus_a.BUS_OAM_DA01n.tri_bus(AXER_VD1_TO_ODA1);
  /*_BUS_OAM_DA02n*/ reg_new.oam_dbus_a.BUS_OAM_DA02n.tri_bus(ASOX_VD2_TO_ODA2);
  /*_BUS_OAM_DA03n*/ reg_new.oam_dbus_a.BUS_OAM_DA03n.tri_bus(CETU_VD3_TO_ODA3);
  /*_BUS_OAM_DA04n*/ reg_new.oam_dbus_a.BUS_OAM_DA04n.tri_bus(ARYN_VD4_TO_ODA4);
  /*_BUS_OAM_DA05n*/ reg_new.oam_dbus_a.BUS_OAM_DA05n.tri_bus(ACOT_VD5_TO_ODA5);
  /*_BUS_OAM_DA06n*/ reg_new.oam_dbus_a.BUS_OAM_DA06n.tri_bus(CUJE_VD6_TO_ODA6);
  /*_BUS_OAM_DA07n*/ reg_new.oam_dbus_a.BUS_OAM_DA07n.tri_bus(ATER_VD7_TO_ODA7);

  /*_BUS_OAM_DB00n*/ reg_new.oam_dbus_b.BUS_OAM_DB00n.tri_bus(WOWA_VD0_TO_ODB0);
  /*_BUS_OAM_DB01n*/ reg_new.oam_dbus_b.BUS_OAM_DB01n.tri_bus(AVEB_VD1_TO_ODB1);
  /*_BUS_OAM_DB02n*/ reg_new.oam_dbus_b.BUS_OAM_DB02n.tri_bus(AMUH_VD2_TO_ODB2);
  /*_BUS_OAM_DB03n*/ reg_new.oam_dbus_b.BUS_OAM_DB03n.tri_bus(COFO_VD3_TO_ODB3);
  /*_BUS_OAM_DB04n*/ reg_new.oam_dbus_b.BUS_OAM_DB04n.tri_bus(AZOZ_VD4_TO_ODB4);
  /*_BUS_OAM_DB05n*/ reg_new.oam_dbus_b.BUS_OAM_DB05n.tri_bus(AGYK_VD5_TO_ODB5);
  /*_BUS_OAM_DB06n*/ reg_new.oam_dbus_b.BUS_OAM_DB06n.tri_bus(BUSE_VD6_TO_ODB6);
  /*_BUS_OAM_DB07n*/ reg_new.oam_dbus_b.BUS_OAM_DB07n.tri_bus(ANUM_VD7_TO_ODB7);

  /*_p25.AVER*/ wire AVER_AxxxExxx = nand2(reg_new.ACYL_SCANNINGp_odd.out_new(), reg_new.sys_clk.XYSO_xBCDxFGH_new());
  /*_p25.CUFE*/ wire CUFE_OAM_CLKp = not_or_and3(reg_new.cpu_abus.SARO_ADDR_OAMp(), reg_new.MATU_DMA_RUNNINGp_odd.qp_new(), reg_new.sys_clk.MOPA_xxxxEFGH_new()); // CUFE looks like BYHA minus an inverter
  ...
  /*_p29.TEPA*/ wire TEPA_RENDERINGp = not1(reg_new.XYMU_RENDERING_LATCHn.qn_new());
  /*_p29.TUVO*/ wire TUVO_PPU_OAM_RDp = nor3(TEPA_RENDERINGp, reg_new.sfetch_counter_evn.TULY_SFETCH_S1p_evn.qp_new(), reg_new.sfetch_counter_evn.TESE_SFETCH_S2p_evn.qp_new());
  ...
  /*_SIG_OAM_CLKn*/ reg_new.oam_ctrl.SIG_OAM_CLKn.sig_out(COTA_OAM_CLKn);

  /*#p28.GEKA*/ wire GEKA_OAM_A0p = not1(reg_new.oam_abus.BUS_OAM_A00n.out_new());
  /*_p28.WAFO*/ wire WAFO_OAM_A0n = not1(GEKA_OAM_A0p);

  /*_p04.MAKA*/ reg_new.oam_ctrl.MAKA_LATCH_EXTp.dff17(reg_new.sys_clk.ZEME_odd_new(), reg_new.sys_rst.AVOR_SYS_RSTp(), reg_old.cpu_signals.CATY_LATCH_EXTp());

  /*_p04.NAXY*/ wire NAXY_DMA_OAM_WRp = nor2(reg_new.sys_clk.UVYT_ABCDxxxx_new(), reg_new.oam_ctrl.MAKA_LATCH_EXTp.qp_new()); // def nor2
  /*_p04.POWU*/ wire POWU_DMA_OAM_WRp = and2(reg_new.MATU_DMA_RUNNINGp_odd.qp_new(), NAXY_DMA_OAM_WRp); // def and
  /*_p04.WYJA*/ wire WYJA_OAM_WRp     = and_or3(AMAB_CPU_OAM_ENp, reg_new.cpu_signals.CUPA_CPU_WRp(), POWU_DMA_OAM_WRp);
  ...
  /*_SIG_OAM_WRn_A*/ reg_new.oam_ctrl.SIG_OAM_WRn_A.sig_out(ZOFE_OAM_A_WRn);
  /*_SIG_OAM_WRn_B*/ reg_new.oam_ctrl.SIG_OAM_WRn_B.sig_out(ZONE_OAM_B_WRn);

  /*#p28.AJEP*/ wire AJEP_SCAN_OAM_LATCHn = nand2(reg_new.ACYL_SCANNINGp_odd.out_new(), reg_new.sys_clk.XOCE_xBCxxFGx_new()); // schematic wrong, is def nand2
  /*_p28.WEFY*/ wire WEFY_SPR_READp = and2(TUVO_PPU_OAM_RDp, reg_new.sfetch_control.TYFO_SFETCH_S0p_D1_odd.qp_new());
  /*#p28.XUJA*/ wire XUJA_SPR_OAM_LATCHn  = not1(WEFY_SPR_READp);

  /*#p28.BOTA*/ wire BOTA_OAM_OEn  = nand3(reg_new.cpu_signals.BOFE_LATCH_EXTn(), reg_new.cpu_abus.SARO_ADDR_OAMp(), reg_new.cpu_signals.ASOT_CPU_RDp()); // Schematic wrong, this is NAND
  ...
  /*_SIG_OAM_OEn*/ reg_new.oam_ctrl.SIG_OAM_OEn.sig_out(ZODO_OAM_OEn);
  ...
  /*#p29.YDYV*/ reg_new.oam_latch_a.YDYV_OAM_LATCH_DA0n.tp_latchn(BODE_OAM_OEp, reg_new.oam_dbus_a.BUS_OAM_DA00n.out_new());
  /*_p29.YCEB*/ reg_new.oam_latch_a.YCEB_OAM_LATCH_DA1n.tp_latchn(BODE_OAM_OEp, reg_new.oam_dbus_a.BUS_OAM_DA01n.out_new());
  /*_p29.ZUCA*/ reg_new.oam_latch_a.ZUCA_OAM_LATCH_DA2n.tp_latchn(BODE_OAM_OEp, reg_new.oam_dbus_a.BUS_OAM_DA02n.out_new());
  /*_p29.WONE*/ reg_new.oam_latch_a.WONE_OAM_LATCH_DA3n.tp_latchn(BODE_OAM_OEp, reg_new.oam_dbus_a.BUS_OAM_DA03n.out_new());
  /*_p29.ZAXE*/ reg_new.oam_latch_a.ZAXE_OAM_LATCH_DA4n.tp_latchn(BODE_OAM_OEp, reg_new.oam_dbus_a.BUS_OAM_DA04n.out_new());
  /*_p29.XAFU*/ reg_new.oam_latch_a.XAFU_OAM_LATCH_DA5n.tp_latchn(BODE_OAM_OEp, reg_new.oam_dbus_a.BUS_OAM_DA05n.out_new());
  /*_p29.YSES*/ reg_new.oam_latch_a.YSES_OAM_LATCH_DA6n.tp_latchn(BODE_OAM_OEp, reg_new.oam_dbus_a.BUS_OAM_DA06n.out_new());
  /*_p29.ZECA*/ reg_new.oam_latch_a.ZECA_OAM_LATCH_DA7n.tp_latchn(BODE_OAM_OEp, reg_new.oam_dbus_a.BUS_OAM_DA07n.out_new());

  /*#p31.XYKY*/ reg_new.oam_latch_b.XYKY_OAM_LATCH_DB0n.tp_latchn(BODE_OAM_OEp, reg_new.oam_dbus_b.BUS_OAM_DB00n.out_new());
  /*_p31.YRUM*/ reg_new.oam_latch_b.YRUM_OAM_LATCH_DB1n.tp_latchn(BODE_OAM_OEp, reg_new.oam_dbus_b.BUS_OAM_DB01n.out_new());
  /*_p31.YSEX*/ reg_new.oam_latch_b.YSEX_OAM_LATCH_DB2n.tp_latchn(BODE_OAM_OEp, reg_new.oam_dbus_b.BUS_OAM_DB02n.out_new());
  /*_p31.YVEL*/ reg_new.oam_latch_b.YVEL_OAM_LATCH_DB3n.tp_latchn(BODE_OAM_OEp, reg_new.oam_dbus_b.BUS_OAM_DB03n.out_new());
  /*_p31.WYNO*/ reg_new.oam_latch_b.WYNO_OAM_LATCH_DB4n.tp_latchn(BODE_OAM_OEp, reg_new.oam_dbus_b.BUS_OAM_DB04n.out_new());
  /*_p31.CYRA*/ reg_new.oam_latch_b.CYRA_OAM_LATCH_DB5n.tp_latchn(BODE_OAM_OEp, reg_new.oam_dbus_b.BUS_OAM_DB05n.out_new());
  /*_p31.ZUVE*/ reg_new.oam_latch_b.ZUVE_OAM_LATCH_DB6n.tp_latchn(BODE_OAM_OEp, reg_new.oam_dbus_b.BUS_OAM_DB06n.out_new());
  /*_p31.ECED*/ reg_new.oam_latch_b.ECED_OAM_LATCH_DB7n.tp_latchn(BODE_OAM_OEp, reg_new.oam_dbus_b.BUS_OAM_DB07n.out_new());

  /*_p28.GUKO*/ wire GUKO_OBL_TO_CBDp = and3(reg_new.cpu_signals.LEKO_CPU_RDp(), AMAB_CPU_OAM_ENp, WAFO_OAM_A0n);
  /*_p28.WUME*/ wire WUME_OBL_TO_CBDn = not1(GUKO_OBL_TO_CBDp);
  /*_p29.YFAP*/ triwire YFAP_OLA_TO_CBD0 = tri10_np(WUME_OBL_TO_CBDn, reg_new.oam_latch_a.YDYV_OAM_LATCH_DA0n.qn_new());
  /*_p29.XELE*/ triwire XELE_OLA_TO_CBD1 = tri10_np(WUME_OBL_TO_CBDn, reg_new.oam_latch_a.YCEB_OAM_LATCH_DA1n.qn_new());
  /*_p29.YPON*/ triwire YPON_OLA_TO_CBD2 = tri10_np(WUME_OBL_TO_CBDn, reg_new.oam_latch_a.ZUCA_OAM_LATCH_DA2n.qn_new());
  /*_p29.XUVO*/ triwire XUVO_OLA_TO_CBD3 = tri10_np(WUME_OBL_TO_CBDn, reg_new.oam_latch_a.WONE_OAM_LATCH_DA3n.qn_new());
  /*_p29.ZYSA*/ triwire ZYSA_OLA_TO_CBD4 = tri10_np(WUME_OBL_TO_CBDn, reg_new.oam_latch_a.ZAXE_OAM_LATCH_DA4n.qn_new());
  /*_p29.YWEG*/ triwire YWEG_OLA_TO_CBD5 = tri10_np(WUME_OBL_TO_CBDn, reg_new.oam_latch_a.XAFU_OAM_LATCH_DA5n.qn_new());
  /*_p29.XABU*/ triwire XABU_OLA_TO_CBD6 = tri10_np(WUME_OBL_TO_CBDn, reg_new.oam_latch_a.YSES_OAM_LATCH_DA6n.qn_new());
  /*_p29.YTUX*/ triwire YTUX_OLA_TO_CBD7 = tri10_np(WUME_OBL_TO_CBDn, reg_new.oam_latch_a.ZECA_OAM_LATCH_DA7n.qn_new());

  /*_BUS_CPU_D00p*/ reg_new.cpu_dbus.BUS_CPU_D00p.tri_bus(YFAP_OLA_TO_CBD0);
  /*_BUS_CPU_D01p*/ reg_new.cpu_dbus.BUS_CPU_D01p.tri_bus(XELE_OLA_TO_CBD1);
  /*_BUS_CPU_D02p*/ reg_new.cpu_dbus.BUS_CPU_D02p.tri_bus(YPON_OLA_TO_CBD2);
  /*_BUS_CPU_D03p*/ reg_new.cpu_dbus.BUS_CPU_D03p.tri_bus(XUVO_OLA_TO_CBD3);
  /*_BUS_CPU_D04p*/ reg_new.cpu_dbus.BUS_CPU_D04p.tri_bus(ZYSA_OLA_TO_CBD4);
  /*_BUS_CPU_D05p*/ reg_new.cpu_dbus.BUS_CPU_D05p.tri_bus(YWEG_OLA_TO_CBD5);
  /*_BUS_CPU_D06p*/ reg_new.cpu_dbus.BUS_CPU_D06p.tri_bus(XABU_OLA_TO_CBD6);
  /*_BUS_CPU_D07p*/ reg_new.cpu_dbus.BUS_CPU_D07p.tri_bus(YTUX_OLA_TO_CBD7);

  /*_p28.WUKU*/ wire WUKU_OBL_TO_CBDp = and3(reg_new.cpu_signals.LEKO_CPU_RDp(), AMAB_CPU_OAM_ENp, GEKA_OAM_A0p);
  /*_p28.WEWU*/ wire WEWU_OBL_TO_CBDn = not1(WUKU_OBL_TO_CBDp);
  /*_p31.XACA*/ triwire XACA_OLB_TO_CBD0 = tri10_np(WEWU_OBL_TO_CBDn, reg_new.oam_latch_b.XYKY_OAM_LATCH_DB0n.qn_new());
  /*_p31.XAGU*/ triwire XAGU_OLB_TO_CBD1 = tri10_np(WEWU_OBL_TO_CBDn, reg_new.oam_latch_b.YRUM_OAM_LATCH_DB1n.qn_new());
  /*_p31.XEPU*/ triwire XEPU_OLB_TO_CBD2 = tri10_np(WEWU_OBL_TO_CBDn, reg_new.oam_latch_b.YSEX_OAM_LATCH_DB2n.qn_new());
  /*_p31.XYGU*/ triwire XYGU_OLB_TO_CBD3 = tri10_np(WEWU_OBL_TO_CBDn, reg_new.oam_latch_b.YVEL_OAM_LATCH_DB3n.qn_new());
  /*_p31.XUNA*/ triwire XUNA_OLB_TO_CBD4 = tri10_np(WEWU_OBL_TO_CBDn, reg_new.oam_latch_b.WYNO_OAM_LATCH_DB4n.qn_new());
  /*_p31.DEVE*/ triwire DEVE_OLB_TO_CBD5 = tri10_np(WEWU_OBL_TO_CBDn, reg_new.oam_latch_b.CYRA_OAM_LATCH_DB5n.qn_new());
  /*_p31.ZEHA*/ triwire ZEHA_OLB_TO_CBD6 = tri10_np(WEWU_OBL_TO_CBDn, reg_new.oam_latch_b.ZUVE_OAM_LATCH_DB6n.qn_new());
  /*_p31.FYRA*/ triwire FYRA_OLB_TO_CBD7 = tri10_np(WEWU_OBL_TO_CBDn, reg_new.oam_latch_b.ECED_OAM_LATCH_DB7n.qn_new());

  /*_BUS_CPU_D00p*/ reg_new.cpu_dbus.BUS_CPU_D00p.tri_bus(XACA_OLB_TO_CBD0);
  /*_BUS_CPU_D01p*/ reg_new.cpu_dbus.BUS_CPU_D01p.tri_bus(XAGU_OLB_TO_CBD1);
  /*_BUS_CPU_D02p*/ reg_new.cpu_dbus.BUS_CPU_D02p.tri_bus(XEPU_OLB_TO_CBD2);
  /*_BUS_CPU_D03p*/ reg_new.cpu_dbus.BUS_CPU_D03p.tri_bus(XYGU_OLB_TO_CBD3);
  /*_BUS_CPU_D04p*/ reg_new.cpu_dbus.BUS_CPU_D04p.tri_bus(XUNA_OLB_TO_CBD4);
  /*_BUS_CPU_D05p*/ reg_new.cpu_dbus.BUS_CPU_D05p.tri_bus(DEVE_OLB_TO_CBD5);
  /*_BUS_CPU_D06p*/ reg_new.cpu_dbus.BUS_CPU_D06p.tri_bus(ZEHA_OLB_TO_CBD6);
  /*_BUS_CPU_D07p*/ reg_new.cpu_dbus.BUS_CPU_D07p.tri_bus(FYRA_OLB_TO_CBD7);
}
