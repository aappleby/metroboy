...
void GateBoy::oam_latch_to_temp_a_gates(const GateBoyState& reg_old, wire COTA_OAM_CLKn)
{
  ...
  /*#p29.XUSO*/ reg_new.oam_temp_a.XUSO_OAM_DA0p.dff8nB(YWOK_OAM_CLKp, reg_old.oam_latch_a.YDYV_OAM_LATCH_DA0n.qp_old());
  /*_p29.XEGU*/ reg_new.oam_temp_a.XEGU_OAM_DA1p.dff8nB(YWOK_OAM_CLKp, reg_old.oam_latch_a.YCEB_OAM_LATCH_DA1n.qp_old());
  /*_p29.YJEX*/ reg_new.oam_temp_a.YJEX_OAM_DA2p.dff8nB(YWOK_OAM_CLKp, reg_old.oam_latch_a.ZUCA_OAM_LATCH_DA2n.qp_old());
  /*_p29.XYJU*/ reg_new.oam_temp_a.XYJU_OAM_DA3p.dff8nB(YWOK_OAM_CLKp, reg_old.oam_latch_a.WONE_OAM_LATCH_DA3n.qp_old());
  /*_p29.YBOG*/ reg_new.oam_temp_a.YBOG_OAM_DA4p.dff8nB(YWOK_OAM_CLKp, reg_old.oam_latch_a.ZAXE_OAM_LATCH_DA4n.qp_old());
  /*_p29.WYSO*/ reg_new.oam_temp_a.WYSO_OAM_DA5p.dff8nB(YWOK_OAM_CLKp, reg_old.oam_latch_a.XAFU_OAM_LATCH_DA5n.qp_old());
  /*_p29.XOTE*/ reg_new.oam_temp_a.XOTE_OAM_DA6p.dff8nB(YWOK_OAM_CLKp, reg_old.oam_latch_a.YSES_OAM_LATCH_DA6n.qp_old());
  /*_p29.YZAB*/ reg_new.oam_temp_a.YZAB_OAM_DA7p.dff8nB(YWOK_OAM_CLKp, reg_old.oam_latch_a.ZECA_OAM_LATCH_DA7n.qp_old());
}
...
void GateBoy::oam_latch_to_temp_b_gates(const GateBoyState& reg_old, wire COTA_OAM_CLKn)
{
  ...
  /*_p31.YLOR*/ reg_new.oam_temp_b.YLOR_OAM_DB0p.dff8nB(XEGA_OAM_CLKp, reg_old.oam_latch_b.XYKY_OAM_LATCH_DB0n.qp_old());
  /*_p31.ZYTY*/ reg_new.oam_temp_b.ZYTY_OAM_DB1p.dff8nB(XEGA_OAM_CLKp, reg_old.oam_latch_b.YRUM_OAM_LATCH_DB1n.qp_old());
  /*_p31.ZYVE*/ reg_new.oam_temp_b.ZYVE_OAM_DB2p.dff8nB(XEGA_OAM_CLKp, reg_old.oam_latch_b.YSEX_OAM_LATCH_DB2n.qp_old());
  /*_p31.ZEZY*/ reg_new.oam_temp_b.ZEZY_OAM_DB3p.dff8nB(XEGA_OAM_CLKp, reg_old.oam_latch_b.YVEL_OAM_LATCH_DB3n.qp_old());
  /*_p31.GOMO*/ reg_new.oam_temp_b.GOMO_OAM_DB4p.dff8nB(XEGA_OAM_CLKp, reg_old.oam_latch_b.WYNO_OAM_LATCH_DB4n.qp_old());
  /*_p31.BAXO*/ reg_new.oam_temp_b.BAXO_OAM_DB5p.dff8nB(XEGA_OAM_CLKp, reg_old.oam_latch_b.CYRA_OAM_LATCH_DB5n.qp_old());
  /*_p31.YZOS*/ reg_new.oam_temp_b.YZOS_OAM_DB6p.dff8nB(XEGA_OAM_CLKp, reg_old.oam_latch_b.ZUVE_OAM_LATCH_DB6n.qp_old());
  /*_p31.DEPO*/ reg_new.oam_temp_b.DEPO_OAM_DB7p.dff8nB(XEGA_OAM_CLKp, reg_old.oam_latch_b.ECED_OAM_LATCH_DB7n.qp_old());
}
