...
void GateBoy::tock_window_gates(const GateBoyState& reg_old, wire SEGU_CLKPIPE_evn, wire REPU_VBLANKp) {
  /*_p27.ROCO*/ wire ROCO_CLKPIPE_odd = not1(SEGU_CLKPIPE_evn);

  /*_p27.PYCO*/ gb_state.win_ctrl.PYCO_WIN_MATCHp.dff17(ROCO_CLKPIPE_odd, XAPO_VID_RSTn(), gb_state.win_ctrl.NUKO_WX_MATCHp.out_old());

  /*#p27.ROZE*/ wire ROZE_FINE_COUNT_7n_old = nand3(gb_state.fine_count.RUBU_FINE_CNT2.qp_old(), gb_state.fine_count.ROGA_FINE_CNT1.qp_old(), gb_state.fine_count.RYKU_FINE_CNT0.qp_old());
  /*_p27.PANY*/ wire PANY_WIN_FETCHn_old = nor2(gb_state.win_ctrl.NUKO_WX_MATCHp.out_old(), ROZE_FINE_COUNT_7n_old);

  /*_p27.RENE*/ gb_state.win_ctrl.RENE_WIN_FETCHn_B.dff17(gb_state.sys_clk.ALET_xBxDxFxH(),  gb_state.XYMU_RENDERINGn.qn_new(), gb_state.win_ctrl.RYFA_WIN_FETCHn_A.qp_old());
  /*_p27.RYFA*/ gb_state.win_ctrl.RYFA_WIN_FETCHn_A.dff17(SEGU_CLKPIPE_evn, gb_state.XYMU_RENDERINGn.qn_new(), PANY_WIN_FETCHn_old);
  ...
  /*#p27.NAZE*/ wire NAZE_WY_MATCH0p = xnor2(gb_state.reg_wy.NESO_WY0n.qn_new(), gb_state.reg_ly.MUWY_LY0p.qp_new());
  /*_p27.PEBO*/ wire PEBO_WY_MATCH1p = xnor2(gb_state.reg_wy.NYRO_WY1n.qn_new(), gb_state.reg_ly.MYRO_LY1p.qp_new());
  /*_p27.POMO*/ wire POMO_WY_MATCH2p = xnor2(gb_state.reg_wy.NAGA_WY2n.qn_new(), gb_state.reg_ly.LEXA_LY2p.qp_new());
  /*_p27.NEVU*/ wire NEVU_WY_MATCH3p = xnor2(gb_state.reg_wy.MELA_WY3n.qn_new(), gb_state.reg_ly.LYDO_LY3p.qp_new());
  /*_p27.NOJO*/ wire NOJO_WY_MATCH4p = xnor2(gb_state.reg_wy.NULO_WY4n.qn_new(), gb_state.reg_ly.LOVU_LY4p.qp_new());
  /*_p27.PAGA*/ wire PAGA_WY_MATCH5p = xnor2(gb_state.reg_wy.NENE_WY5n.qn_new(), gb_state.reg_ly.LEMA_LY5p.qp_new());
  /*_p27.PEZO*/ wire PEZO_WY_MATCH6p = xnor2(gb_state.reg_wy.NUKA_WY6n.qn_new(), gb_state.reg_ly.MATO_LY6p.qp_new());
  /*_p27.NUPA*/ wire NUPA_WY_MATCH7p = xnor2(gb_state.reg_wy.NAFU_WY7n.qn_new(), gb_state.reg_ly.LAFO_LY7p.qp_new());

  /*#p27.MYLO*/ wire MYLO_WX_MATCH0p = xnor2(gb_state.pix_count.XEHO_PX0p.qp_new(), gb_state.reg_wx.MYPA_WX0n.qn_new());
  /*_p27.PUWU*/ wire PUWU_WX_MATCH1p = xnor2(gb_state.pix_count.SAVY_PX1p.qp_new(), gb_state.reg_wx.NOFE_WX1n.qn_new());
  /*_p27.PUHO*/ wire PUHO_WX_MATCH2p = xnor2(gb_state.pix_count.XODU_PX2p.qp_new(), gb_state.reg_wx.NOKE_WX2n.qn_new());
  /*_p27.NYTU*/ wire NYTU_WX_MATCH3p = xnor2(gb_state.pix_count.XYDO_PX3p.qp_new(), gb_state.reg_wx.MEBY_WX3n.qn_new());
  /*_p27.NEZO*/ wire NEZO_WX_MATCH4p = xnor2(gb_state.pix_count.TUHU_PX4p.qp_new(), gb_state.reg_wx.MYPU_WX4n.qn_new());
  /*_p27.NORY*/ wire NORY_WX_MATCH5p = xnor2(gb_state.pix_count.TUKY_PX5p.qp_new(), gb_state.reg_wx.MYCE_WX5n.qn_new());
  /*_p27.NONO*/ wire NONO_WX_MATCH6p = xnor2(gb_state.pix_count.TAKO_PX6p.qp_new(), gb_state.reg_wx.MUVO_WX6n.qn_new());
  /*_p27.PASE*/ wire PASE_WX_MATCH7p = xnor2(gb_state.pix_count.SYBE_PX7p.qp_new(), gb_state.reg_wx.NUKU_WX7n.qn_new());

  /*#p27.PALO*/ wire PALO_WY_MATCHn  = nand5(gb_state.reg_lcdc.WYMO_LCDC_WINENn.qn_new(), NOJO_WY_MATCH4p, PAGA_WY_MATCH5p, PEZO_WY_MATCH6p, NUPA_WY_MATCH7p);
  ...
  /*_p27.SARY*/ gb_state.win_ctrl.SARY_WY_MATCHp.dff17(gb_state.sys_clk.TALU_xxCDEFxx(), XAPO_VID_RSTn(), gb_state.win_ctrl.ROGE_WY_MATCHp.out_old());
  /*_p27.ROGE*/ gb_state.win_ctrl.ROGE_WY_MATCHp = not1(PAFU_WY_MATCHn);
  /*_p27.REJO*/ gb_state.win_ctrl.REJO_WY_MATCH_LATCHp.nor_latch(gb_state.win_ctrl.SARY_WY_MATCHp.qp_new(), REPU_VBLANKp);

  /*_p27.PUKY*/ wire PUKY_WX_MATCHn  = nand5(gb_state.win_ctrl.REJO_WY_MATCH_LATCHp.qp_new(), NEZO_WX_MATCH4p, NORY_WX_MATCH5p, NONO_WX_MATCH6p, PASE_WX_MATCH7p);
  ...
  /*_p27.NUKO*/ gb_state.win_ctrl.NUKO_WX_MATCHp  = not1(NOGY_WX_MATCHn);
...
void GateBoy::tock_pix_pipes_gates(const GateBoyState& reg_old, wire SACU_CLKPIPE_new, wire NYXU_BFETCH_RSTn)
{
  ...
  /*#p27.LAXE*/ wire LAXE_BFETCH_S0n = not1(gb_state.tfetch_counter.LAXU_BFETCH_S0p.qp_new());
  ...
  /*_p29.SYCU*/ wire SYCU_SFETCH_S0pe = nor3(TYTU_SFETCH_S0n, LOBY_RENDERINGn, gb_state.sfetch_control.TYFO_SFETCH_S0p_D1.qp_new());
  ...
  /*#p27.NYDY*/ wire NYDY_LATCH_TILE_DAn = nand3(MYSO_STORE_VRAM_DATA_TRIGp, gb_state.tfetch_counter.MESU_BFETCH_S1p.qp_new(), NOFU_BFETCH_S2n); // NYDY on fetch phase 6
  /*_p27.MOFU*/ wire MOFU_LATCH_TILE_DBp = and2(MYSO_STORE_VRAM_DATA_TRIGp, NAKO_BFETCH_S1n); // MOFU fires on fetch phase 2 and 10
  /*#p29.TOPU*/ wire TOPU_STORE_SPRITE_Ap = and2(gb_state.sfetch_counter.TULY_SFETCH_S1p.qp_new(), SYCU_SFETCH_S0pe);
  /*#p29.RACA*/ wire RACA_STORE_SPRITE_Bp = and2(gb_state.sfetch_control.VONU_SFETCH_S1p_D4.qp_new(), SYCU_SFETCH_S0pe);
