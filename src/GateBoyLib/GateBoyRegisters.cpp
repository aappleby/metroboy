...
{
  /*_p23.WARU*/ wire WARU_FF40_WRp = and2(CUPA_CPU_WRp(), reg.cpu_abus_new.VOCA_FF40p());
  /*_p23.XUBO*/ wire XUBO_FF40_WRn = not1(WARU_FF40_WRp);
  /*#p23.VYXE*/ reg.reg_lcdc.VYXE_LCDC_BGENn  .dff9(XUBO_FF40_WRn, XARE_SYS_RSTn(), reg.cpu_dbus_old.BUS_CPU_D00p.out_old());
  /*_p23.XYLO*/ reg.reg_lcdc.XYLO_LCDC_SPENn  .dff9(XUBO_FF40_WRn, XARE_SYS_RSTn(), reg.cpu_dbus_old.BUS_CPU_D01p.out_old());
  /*_p23.XYMO*/ reg.reg_lcdc.XYMO_LCDC_SPSIZEn.dff9(XUBO_FF40_WRn, XARE_SYS_RSTn(), reg.cpu_dbus_old.BUS_CPU_D02p.out_old());
  /*_p23.XAFO*/ reg.reg_lcdc.XAFO_LCDC_BGMAPn .dff9(XUBO_FF40_WRn, XARE_SYS_RSTn(), reg.cpu_dbus_old.BUS_CPU_D03p.out_old());
  /*_p23.WEXU*/ reg.reg_lcdc.WEXU_LCDC_BGTILEn.dff9(XUBO_FF40_WRn, XARE_SYS_RSTn(), reg.cpu_dbus_old.BUS_CPU_D04p.out_old());
  /*_p23.WYMO*/ reg.reg_lcdc.WYMO_LCDC_WINENn .dff9(XUBO_FF40_WRn, XARE_SYS_RSTn(), reg.cpu_dbus_old.BUS_CPU_D05p.out_old());
  /*_p23.WOKY*/ reg.reg_lcdc.WOKY_LCDC_WINMAPn.dff9(XUBO_FF40_WRn, XARE_SYS_RSTn(), reg.cpu_dbus_old.BUS_CPU_D06p.out_old());
  /*_p23.XONA*/ reg.reg_lcdc.XONA_LCDC_LCDENn. dff9(XUBO_FF40_WRn, XARE_SYS_RSTn(), reg.cpu_dbus_old.BUS_CPU_D07p.out_old());

  /*_p23.VYRE*/ wire VYRE_FF40_RDp = and2(ASOT_CPU_RDp(), reg.cpu_abus_new.VOCA_FF40p());
  ...
  /*_BUS_CPU_D00p*/ reg.cpu_dbus_new.BUS_CPU_D00p.tri_bus(WYPO_LCDC0_TO_CD0);
  /*_BUS_CPU_D01p*/ reg.cpu_dbus_new.BUS_CPU_D01p.tri_bus(XERO_LCDC1_TO_CD1);
  /*_BUS_CPU_D02p*/ reg.cpu_dbus_new.BUS_CPU_D02p.tri_bus(WYJU_LCDC2_TO_CD2);
  /*_BUS_CPU_D03p*/ reg.cpu_dbus_new.BUS_CPU_D03p.tri_bus(WUKA_LCDC3_TO_CD3);
  /*_BUS_CPU_D04p*/ reg.cpu_dbus_new.BUS_CPU_D04p.tri_bus(VOKE_LCDC4_TO_CD4);
  /*_BUS_CPU_D05p*/ reg.cpu_dbus_new.BUS_CPU_D05p.tri_bus(VATO_LCDC5_TO_CD5);
  /*_BUS_CPU_D06p*/ reg.cpu_dbus_new.BUS_CPU_D06p.tri_bus(VAHA_LCDC6_TO_CD6);
  /*_BUS_CPU_D07p*/ reg.cpu_dbus_new.BUS_CPU_D07p.tri_bus(XEBU_LCDC7_TO_CD7);
}
