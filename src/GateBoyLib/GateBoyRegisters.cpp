...
{
  /*_p23.WARU*/ wire WARU_FF40_WRp = and2(reg.cpu_signals.CUPA_CPU_WRp(), reg.cpu_abus.VOCA_FF40p());
  /*_p23.XUBO*/ wire XUBO_FF40_WRn = not1(WARU_FF40_WRp);
  /*#p23.VYXE*/ reg.reg_lcdc.VYXE_LCDC_BGENn  .dff9(XUBO_FF40_WRn, reg.sys_rst.XARE_SYS_RSTn(), reg_old.cpu_dbus.BUS_CPU_D00p.out_old());
  /*_p23.XYLO*/ reg.reg_lcdc.XYLO_LCDC_SPENn  .dff9(XUBO_FF40_WRn, reg.sys_rst.XARE_SYS_RSTn(), reg_old.cpu_dbus.BUS_CPU_D01p.out_old());
  /*_p23.XYMO*/ reg.reg_lcdc.XYMO_LCDC_SPSIZEn.dff9(XUBO_FF40_WRn, reg.sys_rst.XARE_SYS_RSTn(), reg_old.cpu_dbus.BUS_CPU_D02p.out_old());
  /*_p23.XAFO*/ reg.reg_lcdc.XAFO_LCDC_BGMAPn .dff9(XUBO_FF40_WRn, reg.sys_rst.XARE_SYS_RSTn(), reg_old.cpu_dbus.BUS_CPU_D03p.out_old());
  /*_p23.WEXU*/ reg.reg_lcdc.WEXU_LCDC_BGTILEn.dff9(XUBO_FF40_WRn, reg.sys_rst.XARE_SYS_RSTn(), reg_old.cpu_dbus.BUS_CPU_D04p.out_old());
  /*_p23.WYMO*/ reg.reg_lcdc.WYMO_LCDC_WINENn .dff9(XUBO_FF40_WRn, reg.sys_rst.XARE_SYS_RSTn(), reg_old.cpu_dbus.BUS_CPU_D05p.out_old());
  /*_p23.WOKY*/ reg.reg_lcdc.WOKY_LCDC_WINMAPn.dff9(XUBO_FF40_WRn, reg.sys_rst.XARE_SYS_RSTn(), reg_old.cpu_dbus.BUS_CPU_D06p.out_old());
  /*_p23.XONA*/ reg.reg_lcdc.XONA_LCDC_LCDENn. dff9(XUBO_FF40_WRn, reg.sys_rst.XARE_SYS_RSTn(), reg_old.cpu_dbus.BUS_CPU_D07p.out_old());

  /*_p23.VYRE*/ wire VYRE_FF40_RDp = and2(reg.cpu_signals.ASOT_CPU_RDp(), reg.cpu_abus.VOCA_FF40p());
