...
void GateBoy::tock_reset_gates(DFF17 UPOF_DIV15p) {
  ...
  /*_p01.UPYF*/ wire UPYF = or2(gb_state.pins.sys.PIN_71_RST.qp_int_new(), gb_state.pins.sys.UCOB_CLKBADp());
  ...
  /*_SIG_CPU_EXT_CLKGOOD*/ gb_state.sys_rst.SIG_CPU_EXT_CLKGOOD.sig_out(gb_state.pins.sys.PIN_74_CLK.clkgood());
