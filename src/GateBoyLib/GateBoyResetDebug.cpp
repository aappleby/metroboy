...
void GateBoy::tock_reset_gates(DFF17 UPOF_DIV15p) {
  ...
  /*_p01.AFER*/ reg.sys_rst.AFER_SYS_RSTp.dff13(BOGA_Axxxxxxx(), UPOJ_MODE_PRODn(), reg.sys_rst.ASOL_POR_DONEn.qp_old());

  /*_p01.UPYF*/ wire UPYF = or2(reg.sys_rst.PIN_71_RST.qp_int_new(), UCOB_CLKBADp());
  ...
  /*#p25.SOTO*/ reg.sys_rst.SOTO_DBG_VRAMp.dff17(SYCY_MODE_DBG2n, CUNU_SYS_RSTn(), reg.sys_rst.SOTO_DBG_VRAMp.qn_old());
