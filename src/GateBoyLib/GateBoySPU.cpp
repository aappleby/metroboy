...
void GBSound::tick(const GateBoyState& reg_old, GateBoyState& reg_new) {

  {
    //----------
    // SPU clock dividers

    /*_p01.CERY*/ CERY_CLK_2M.dff17(CYBO_AxCxExGx(),          BELA_APU_RSTn(), CERY_CLK_2M.qn_old());
    /*_p01.ATYK*/ ATYK_CLK_2M.dff17(ARYF_AxCxExGx(),          BOPO_APU_RSTn(), ATYK_CLK_2M.qn_old());
    /*_p09.AJER*/ AJER_CLK_2M.dff17(APUV_AxCxExGx(),          ATYV_APU_RSTn(), AJER_CLK_2M.qn_old());
    /*_p01.AVOK*/ AVOK_CLK_1M.dff17(ATYK_CLK_2M.qn_new(), BOPO_APU_RSTn(), AVOK_CLK_1M.qn_old());

    /*#p09.CALO*/ ch1.CALO_CLK_1M.dff17(BATA_CLK_2M(), AGUR_APU_RSTn(), ch1.CALO_CLK_1M.qn_new());

    /*_p01.JESO*/ JESO_CLK_512K.dff17(BAVU_CLK_1M(), KAME_APU_RSTn(), JESO_CLK_512K.qn_old());

    /*_p15.ATEP*/ ATEP_CLK_2M.dff17(AZEG_AxCxExGx(), BUWE_APU_RSTn(), ATEP_CLK_2M.qn_old());
    /*#p15.BUFO*/   wire BUFO = not1(ATEP_CLK_2M.qp_new());
    /*_p15.BYHO*/   wire BYHO_APU_RSTp = not1(BUWE_APU_RSTn());
    /*#p15.CEMO*/ CEMO_CLK_1M.dff17(BUFO, BYHO_APU_RSTp, CEMO_CLK_1M.qn_old());

    //----------
    // Low-speed clocks are picked up from DIV

    /*_p01.COKE*/ wire COKE_CLK_2M = not1(AJER_CLK_2M.qn_new());
    /*_p01.BARA*/ BARA_CLK_512.dff17(COKE_CLK_2M, ATUS_APU_RSTn(), UMER_DIV10n_old);
  ...
  tick_nr50(reg_old, reg_new);
  tick_nr51(reg_old, reg_new);
  tick_nr52(reg_old, reg_new);

  tick_ch1(reg_old, reg_new);
  tick_ch2(reg_old, reg_new);
  tick_ch3(reg_old, reg_new);
  tick_ch4(reg_old, reg_new);
}

//-----------------------------------------------------------------------------

void GBSound::tick_nr50(const GateBoyState& reg_old, GateBoyState& reg_new) {
  /*_p09.BOSU*/ wire BOSU_NR50_WRn = nand2(reg_new.cpu_abus.CAFY_ADDR_FF24p(), BOGY_CPU_WRp());
  ...
  /*_p09.APEG*/ APEG_NR50_VOL_L0   .dff9(ATAF_NR50_WRn, KEPY_APU_RSTn(), reg_old.cpu_dbus.BUS_CPU_D00p.out_old());
  /*_p09.BYGA*/ BYGA_NR50_VOL_L1   .dff9(ATAF_NR50_WRn, KEPY_APU_RSTn(), reg_old.cpu_dbus.BUS_CPU_D01p.out_old());
  /*_p09.AGER*/ AGER_NR50_VOL_L2   .dff9(ATAF_NR50_WRn, KEPY_APU_RSTn(), reg_old.cpu_dbus.BUS_CPU_D02p.out_old());
  /*_p09.APOS*/ APOS_NR50_VIN_TO_L .dff9(ATAF_NR50_WRn, KEPY_APU_RSTn(), reg_old.cpu_dbus.BUS_CPU_D03p.out_old());
  /*_p09.BYRE*/ BYRE_NR50_VOL_R0   .dff9(BUBU_NR50_WRn, KEPY_APU_RSTn(), reg_old.cpu_dbus.BUS_CPU_D04p.out_old());
  /*_p09.BUMO*/ BUMO_NR50_VOL_R1   .dff9(BUBU_NR50_WRn, KEPY_APU_RSTn(), reg_old.cpu_dbus.BUS_CPU_D05p.out_old());
  /*_p09.COZU*/ COZU_NR50_VOL_R2   .dff9(BUBU_NR50_WRn, KEPY_APU_RSTn(), reg_old.cpu_dbus.BUS_CPU_D06p.out_old());
  /*_p09.BEDU*/ BEDU_NR50_VIN_TO_R .dff9(BUBU_NR50_WRn, KEPY_APU_RSTn(), reg_old.cpu_dbus.BUS_CPU_D07p.out_old());

  /*_p09.BEFU*/ wire BEFU_NR50_RDp = nor2(AGUZ_CPU_RDn(), reg_new.cpu_abus.BYMA_ADDR_FF24n());
...
void GBSound::tick_nr51(const GateBoyState& reg_old, GateBoyState& reg_new) {
  /*_p09.BUPO*/ wire BUPO_NR51_WRn = nand2(reg_new.cpu_abus.CORA_ADDR_FF25p(), BOGY_CPU_WRp());
  /*_p09.BONO*/ wire BONO_NR51_WRp = not1(BUPO_NR51_WRn);
  /*_p09.BYFA*/ wire BYFA_NR51_WRp = not1(BUPO_NR51_WRn);

  /*_p09.ANEV*/ ANEV_NR51_D0.dff9(BONO_NR51_WRp, KEPY_APU_RSTn(), reg_old.cpu_dbus.BUS_CPU_D00p.out_old());
  /*_p09.BOGU*/ BOGU_NR51_D1.dff9(BONO_NR51_WRp, KEPY_APU_RSTn(), reg_old.cpu_dbus.BUS_CPU_D01p.out_old());
  /*_p09.BAFO*/ BAFO_NR51_D2.dff9(BONO_NR51_WRp, KEPY_APU_RSTn(), reg_old.cpu_dbus.BUS_CPU_D02p.out_old());
  /*_p09.ATUF*/ ATUF_NR51_D3.dff9(BONO_NR51_WRp, KEPY_APU_RSTn(), reg_old.cpu_dbus.BUS_CPU_D03p.out_old());
  /*_p09.BUME*/ BUME_NR51_D4.dff9(BYFA_NR51_WRp, KEPY_APU_RSTn(), reg_old.cpu_dbus.BUS_CPU_D04p.out_old());
  /*_p09.BOFA*/ BOFA_NR51_D5.dff9(BYFA_NR51_WRp, KEPY_APU_RSTn(), reg_old.cpu_dbus.BUS_CPU_D05p.out_old());
  /*_p09.BEFO*/ BEFO_NR51_D6.dff9(BYFA_NR51_WRp, KEPY_APU_RSTn(), reg_old.cpu_dbus.BUS_CPU_D06p.out_old());
  /*_p09.BEPU*/ BEPU_NR51_D7.dff9(BYFA_NR51_WRp, KEPY_APU_RSTn(), reg_old.cpu_dbus.BUS_CPU_D07p.out_old());

  /*_p09.HEFA*/ wire HEFA_NR51_RDp = nor2(reg_new.cpu_abus.GEPA_ADDR_FF25n(), AGUZ_CPU_RDn()); // outline wrong color in die
...
void GBSound::tick_nr52(const GateBoyState& reg_old, GateBoyState& reg_new) {
  ...
  /*#p09.EFOP*/ wire EFOP_NR52_DBG_APU_IN = and2(reg_old.cpu_dbus.BUS_CPU_D04p.out_old(), UNOR_MODE_DBG2);
  /*#p09.FERO*/ FERO_NR52_DBG_APUn    .dff9 (FOKU_NR52_WRn, KEPY_APU_RSTn(), EFOP_NR52_DBG_APU_IN);
  /*#p09.BOWY*/ BOWY_NR52_DBG_SWEEP   .dff17(BOPY_NR52_WRn, KEPY_APU_RSTn(), reg_old.cpu_dbus.BUS_CPU_D05p.out_old());
  /*#p09.HADA*/ HADA_NR52_ALL_SOUND_ON.dff17(HAWU_NR52_WRn, GUFO_SYS_RSTn(), reg_old.cpu_dbus.BUS_CPU_D07p.out_old()); // Since this bit controls APU_RESET*, it is reset by SYS_RESET.
