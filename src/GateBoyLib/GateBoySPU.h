...
struct GateBoySPU {
  ...
  /*_p01.HORU*/ wire HORU_CLK_512_old() const {
    ...
    /*_p01.GALE*/ wire GALE_CLK_512_old = mux2p(FERO_NR52_DBG_APUp.qp_old(), HAMA_CLK_512K_old(), FYNE_CLK_512_old);
  ...
  /*_p01.HORU*/ wire HORU_CLK_512_new() const {
    ...
    /*_p01.GALE*/ wire GALE_CLK_512 = mux2p(FERO_NR52_DBG_APUp.qp_new(), HAMA_CLK_512K_new(), FYNE_CLK_512);
  ...
  /*_p01.BUFY*/ wire BUFY_CLK_256n() const {
    ...
    /*_p01.BEZE*/ wire BEZE_CLK_256 = mux2p(FERO_NR52_DBG_APUp.qp_new(), HAMA_CLK_512K_new(), CULO_CLK_256);
  ...
  /*_p01.BYFE*/ wire BYFE_CLK_128n() const {
    ...
    /*_p01.BULE*/ wire BULE_CLK_128 = mux2p(FERO_NR52_DBG_APUp.qp_new(), HAMA_CLK_512K_new(), APEF_CLK_128);
