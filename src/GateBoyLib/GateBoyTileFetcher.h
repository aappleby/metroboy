...
struct TileFetchCounter {
  void reset_to_poweron() {
    LAXU_BFETCH_S0p.state = 0b00011000;
    MESU_BFETCH_S1p.state = 0b00011000;
    NYVA_BFETCH_S2p.state = 0b00011000;
  }

  void reset_to_bootrom() {
    LAXU_BFETCH_S0p.state = 0b00011011;
    MESU_BFETCH_S1p.state = 0b00011000;
    NYVA_BFETCH_S2p.state = 0b00011011;
  }
...
struct TileFetchControl {
  void reset_to_poweron() {
    ...
    POKY_PRELOAD_LATCHp.state = 0b00011000;
    LONY_FETCHINGp.state      = 0b00011000;
    LOVY_FETCH_DONEp.state    = 0b00011000;
    NYKA_FETCH_DONEp.state    = 0b00011000;
    PORY_FETCH_DONEp.state    = 0b00011000;
    PYGO_FETCH_DONEp.state    = 0b00011000;
  ...
  void reset_to_bootrom() {
    ...
    NYKA_FETCH_DONEp.state    = 0b00011000;
    PORY_FETCH_DONEp.state    = 0b00011010;
    PYGO_FETCH_DONEp.state    = 0b00011000;
    LYZU_BFETCH_S0p_D1.state  = 0b00011000;
  }
