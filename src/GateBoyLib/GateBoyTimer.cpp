...
void GateBoy::tock_timer_gates() {
  ...
  /*_p03.SABU*/ tma.SABU_TMA0p.dff17(TYJU_FF06_WRn, ALUR_SYS_RSTn(), cpu_dbus_old.BUS_CPU_D00p.out_old());
  /*_p03.NYKE*/ tma.NYKE_TMA1p.dff17(TYJU_FF06_WRn, ALUR_SYS_RSTn(), cpu_dbus_old.BUS_CPU_D01p.out_old());
  /*_p03.MURU*/ tma.MURU_TMA2p.dff17(TYJU_FF06_WRn, ALUR_SYS_RSTn(), cpu_dbus_old.BUS_CPU_D02p.out_old());
  /*_p03.TYVA*/ tma.TYVA_TMA3p.dff17(TYJU_FF06_WRn, ALUR_SYS_RSTn(), cpu_dbus_old.BUS_CPU_D03p.out_old());
  /*_p03.TYRU*/ tma.TYRU_TMA4p.dff17(TYJU_FF06_WRn, ALUR_SYS_RSTn(), cpu_dbus_old.BUS_CPU_D04p.out_old());
  /*_p03.SUFY*/ tma.SUFY_TMA5p.dff17(TYJU_FF06_WRn, ALUR_SYS_RSTn(), cpu_dbus_old.BUS_CPU_D05p.out_old());
  /*_p03.PETO*/ tma.PETO_TMA6p.dff17(TYJU_FF06_WRn, ALUR_SYS_RSTn(), cpu_dbus_old.BUS_CPU_D06p.out_old());
  /*_p03.SETA*/ tma.SETA_TMA7p.dff17(TYJU_FF06_WRn, ALUR_SYS_RSTn(), cpu_dbus_old.BUS_CPU_D07p.out_old());
  ...
  /*_p03.SOPU*/ tac.SOPU_TAC0p.dff17(SARA_FF07_WRn, ALUR_SYS_RSTn(), cpu_dbus_old.BUS_CPU_D00p.out_old());
  /*_p03.SAMY*/ tac.SAMY_TAC1p.dff17(SARA_FF07_WRn, ALUR_SYS_RSTn(), cpu_dbus_old.BUS_CPU_D01p.out_old());
  /*_p03.SABO*/ tac.SABO_TAC2p.dff17(SARA_FF07_WRn, ALUR_SYS_RSTn(), cpu_dbus_old.BUS_CPU_D02p.out_old());

  /*#p03.MERY*/ wire MERY_TIMER_OVERFLOWp_old = nor2(tima.NUGA_TIMA7p.qp_old(), int_ctrl.NYDU_TIMA7p_DELAY.qn_old());
  ...
  /*#p03.NYDU*/ int_ctrl.NYDU_TIMA7p_DELAY.dff17(BOGA_Axxxxxxx(), MUGY_TIMA_MAX_RSTn, tima.NUGA_TIMA7p.qp_old());
  ...
  /*#p03.UKAP*/ wire UKAP_CLK_MUXa  = mux2n(tac.SOPU_TAC0p.qp_new(), UVYN_DIV05n, UVYR_DIV03n);
  /*#p03.TEKO*/ wire TEKO_CLK_MUXb  = mux2n(tac.SOPU_TAC0p.qp_new(), UBOT_DIV01n, UREK_DIV07n);
  /*#p03.TECY*/ wire TECY_CLK_MUXc  = mux2n(tac.SAMY_TAC1p.qp_new(), UKAP_CLK_MUXa, TEKO_CLK_MUXb);
  /*#p03.SOGU*/ wire SOGU_TIMA_CLKn = nor2(TECY_CLK_MUXc, tac.SABO_TAC2p.qn_new());
  ...
  /*#p03.ROKE*/ wire ROKE_TIMA_D0 = mux2n(TOPE_FF05_WRn, tma.SABU_TMA0p.qp_new(), cpu_dbus_new.BUS_CPU_D00p.out_new());
  /*#p03.PETU*/ wire PETU_TIMA_D1 = mux2n(TOPE_FF05_WRn, tma.NYKE_TMA1p.qp_new(), cpu_dbus_new.BUS_CPU_D01p.out_new());
  /*#p03.NYKU*/ wire NYKU_TIMA_D2 = mux2n(TOPE_FF05_WRn, tma.MURU_TMA2p.qp_new(), cpu_dbus_new.BUS_CPU_D02p.out_new());
  /*#p03.SOCE*/ wire SOCE_TIMA_D3 = mux2n(TOPE_FF05_WRn, tma.TYVA_TMA3p.qp_new(), cpu_dbus_new.BUS_CPU_D03p.out_new());
  /*#p03.SALA*/ wire SALA_TIMA_D4 = mux2n(TOPE_FF05_WRn, tma.TYRU_TMA4p.qp_new(), cpu_dbus_new.BUS_CPU_D04p.out_new());
  /*#p03.SYRU*/ wire SYRU_TIMA_D5 = mux2n(TOPE_FF05_WRn, tma.SUFY_TMA5p.qp_new(), cpu_dbus_new.BUS_CPU_D05p.out_new());
  /*#p03.REFU*/ wire REFU_TIMA_D6 = mux2n(TOPE_FF05_WRn, tma.PETO_TMA6p.qp_new(), cpu_dbus_new.BUS_CPU_D06p.out_new());
  /*#p03.RATO*/ wire RATO_TIMA_D7 = mux2n(TOPE_FF05_WRn, tma.SETA_TMA7p.qp_new(), cpu_dbus_new.BUS_CPU_D07p.out_new());
  ...
  /*#p03.REGA*/ tima.REGA_TIMA0p.dff20(SOGU_TIMA_CLKn,                MEXU_TIMA_LOADp, PUXY_TIMA_D0);
  /*#p03.POVY*/ tima.POVY_TIMA1p.dff20(tima.REGA_TIMA0p.qp_any(), MEXU_TIMA_LOADp, NERO_TIMA_D1);
  /*#p03.PERU*/ tima.PERU_TIMA2p.dff20(tima.POVY_TIMA1p.qp_any(), MEXU_TIMA_LOADp, NADA_TIMA_D2);
  /*#p03.RATE*/ tima.RATE_TIMA3p.dff20(tima.PERU_TIMA2p.qp_any(), MEXU_TIMA_LOADp, REPA_TIMA_D3);
  /*#p03.RUBY*/ tima.RUBY_TIMA4p.dff20(tima.RATE_TIMA3p.qp_any(), MEXU_TIMA_LOADp, ROLU_TIMA_D4);
  /*#p03.RAGE*/ tima.RAGE_TIMA5p.dff20(tima.RUBY_TIMA4p.qp_any(), MEXU_TIMA_LOADp, RUGY_TIMA_D5);
  /*#p03.PEDA*/ tima.PEDA_TIMA6p.dff20(tima.RAGE_TIMA5p.qp_any(), MEXU_TIMA_LOADp, PYMA_TIMA_D6);
  /*#p03.NUGA*/ tima.NUGA_TIMA7p.dff20(tima.PEDA_TIMA6p.qp_any(), MEXU_TIMA_LOADp, PAGU_TIMA_D7);
  ...
  /*#p03.SOKU*/ triwire SOKU_TIMA0_TO_CD0 = tri6_pn(TEDA_FF05_RDp, tima.REGA_TIMA0p.qn_new());
  /*#p03.RACY*/ triwire RACY_TIMA1_TO_CD1 = tri6_pn(TEDA_FF05_RDp, tima.POVY_TIMA1p.qn_new());
  /*#p03.RAVY*/ triwire RAVY_TIMA2_TO_CD2 = tri6_pn(TEDA_FF05_RDp, tima.PERU_TIMA2p.qn_new());
  /*#p03.SOSY*/ triwire SOSY_TIMA3_TO_CD3 = tri6_pn(TEDA_FF05_RDp, tima.RATE_TIMA3p.qn_new());
  /*#p03.SOMU*/ triwire SOMU_TIMA4_TO_CD4 = tri6_pn(TEDA_FF05_RDp, tima.RUBY_TIMA4p.qn_new());
  /*#p03.SURO*/ triwire SURO_TIMA5_TO_CD5 = tri6_pn(TEDA_FF05_RDp, tima.RAGE_TIMA5p.qn_new());
  /*#p03.ROWU*/ triwire ROWU_TIMA6_TO_CD6 = tri6_pn(TEDA_FF05_RDp, tima.PEDA_TIMA6p.qn_new());
  /*#p03.PUSO*/ triwire PUSO_TIMA7_TO_CD7 = tri6_pn(TEDA_FF05_RDp, tima.NUGA_TIMA7p.qn_new());
  ...
  /*#p03.SETE*/ triwire SETE_TMA0_TO_CD0 = tri6_pn(TUBY_FF06_RDp, tma.SABU_TMA0p.qn_new());
  /*#p03.PYRE*/ triwire PYRE_TMA1_TO_CD1 = tri6_pn(TUBY_FF06_RDp, tma.NYKE_TMA1p.qn_new());
  /*#p03.NOLA*/ triwire NOLA_TMA2_TO_CD2 = tri6_pn(TUBY_FF06_RDp, tma.MURU_TMA2p.qn_new());
  /*#p03.SALU*/ triwire SALU_TMA3_TO_CD3 = tri6_pn(TUBY_FF06_RDp, tma.TYVA_TMA3p.qn_new());
  /*#p03.SUPO*/ triwire SUPO_TMA4_TO_CD4 = tri6_pn(TUBY_FF06_RDp, tma.TYRU_TMA4p.qn_new());
  /*#p03.SOTU*/ triwire SOTU_TMA5_TO_CD5 = tri6_pn(TUBY_FF06_RDp, tma.SUFY_TMA5p.qn_new());
  /*#p03.REVA*/ triwire REVA_TMA6_TO_CD6 = tri6_pn(TUBY_FF06_RDp, tma.PETO_TMA6p.qn_new());
  /*#p03.SAPU*/ triwire SAPU_TMA7_TO_CD7 = tri6_pn(TUBY_FF06_RDp, tma.SETA_TMA7p.qn_new());
  ...
  /*#p03.RYLA*/ triwire RYLA_TAC0_TO_CD0 = tri6_pn(SORA_FF07_RDp, tac.SOPU_TAC0p.qn_new());
  /*#p03.ROTE*/ triwire ROTE_TAC1_TO_CD1 = tri6_pn(SORA_FF07_RDp, tac.SAMY_TAC1p.qn_new());
  /*#p03.SUPE*/ triwire SUPE_TAC2_TO_CD2 = tri6_pn(SORA_FF07_RDp, tac.SABO_TAC2p.qn_new());
...
void GateBoy::tock_timer_logic() {
  ...
  wire UKAP_CLK_MUXa = bit(tac.SOPU_TAC0p.state) ? div.TAMA_DIV05p.state : div.TERO_DIV03p.state;
  wire TEKO_CLK_MUXb = bit(tac.SOPU_TAC0p.state) ? div.UFOR_DIV01p.state : div.TULU_DIV07p.state;
  wire TECY_CLK_MUXc = bit(tac.SAMY_TAC1p.state) ? UKAP_CLK_MUXa : TEKO_CLK_MUXb;
  wire SOGU_TIMA_CLKn = and2(TECY_CLK_MUXc, tac.SABO_TAC2p.state);
  ...
  tima.REGA_TIMA0p.dff20_any(SOGU_TIMA_CLKn,             MEXU_TIMA_LOADp, ROKE_TIMA_D0);
  tima.POVY_TIMA1p.dff20_any(tima.REGA_TIMA0p.state, MEXU_TIMA_LOADp, PETU_TIMA_D1);
  tima.PERU_TIMA2p.dff20_any(tima.POVY_TIMA1p.state, MEXU_TIMA_LOADp, NYKU_TIMA_D2);
  tima.RATE_TIMA3p.dff20_any(tima.PERU_TIMA2p.state, MEXU_TIMA_LOADp, SOCE_TIMA_D3);
  tima.RUBY_TIMA4p.dff20_any(tima.RATE_TIMA3p.state, MEXU_TIMA_LOADp, SALA_TIMA_D4);
  tima.RAGE_TIMA5p.dff20_any(tima.RUBY_TIMA4p.state, MEXU_TIMA_LOADp, SYRU_TIMA_D5);
  tima.PEDA_TIMA6p.dff20_any(tima.RAGE_TIMA5p.state, MEXU_TIMA_LOADp, REFU_TIMA_D6);
  tima.NUGA_TIMA7p.dff20_any(tima.PEDA_TIMA6p.state, MEXU_TIMA_LOADp, RATO_TIMA_D7);
