...
void GateBoy::tock_vram_bus_logic(wire TEVO_WIN_FETCH_TRIGp) {
  ...
  wire NOCU_WIN_MODEn = not1(win_reg.PYNU_WIN_MODE_Ap.qp_new());
  wire PORE_WIN_MODEp = not1(NOCU_WIN_MODEn);
  wire AXAD_WIN_MODEn = not1(PORE_WIN_MODEp);

  //--------------------------------------------
  // CPU vram read address

  wire LEBU_DMA_A15n = not1(dma.MARU_DMA_A15n.qn_new());
  wire MUDA_DMA_VRAMp = nor3(dma.PULA_DMA_A13n.qn_new(), dma.POKU_DMA_A14n.qn_new(), LEBU_DMA_A15n);
  wire MUHO_DMA_VRAMp = nand2(dma.MATU_DMA_RUNNINGp.qp_new(), MUDA_DMA_VRAMp);
  wire LUFA_DMA_VRAMp = not1(MUHO_DMA_VRAMp);
  wire XANE_VRAM_LOCKn = nor2(LUFA_DMA_VRAMp, XYMU_RENDERINGn.qn_new());
  wire XEDU_VRAM_LOCKp = not1(XANE_VRAM_LOCKn);
  triwire XAKY_CA00_TO_VA00 = tri6_nn(XEDU_VRAM_LOCKp, new_bus.BUS_CPU_A00p.out_new());
  triwire XUXU_CA01_TO_VA01 = tri6_nn(XEDU_VRAM_LOCKp, new_bus.BUS_CPU_A01p.out_new());
  triwire XYNE_CA02_TO_VA02 = tri6_nn(XEDU_VRAM_LOCKp, new_bus.BUS_CPU_A02p.out_new());
  triwire XODY_CA03_TO_VA03 = tri6_nn(XEDU_VRAM_LOCKp, new_bus.BUS_CPU_A03p.out_new());
  triwire XECA_CA04_TO_VA04 = tri6_nn(XEDU_VRAM_LOCKp, new_bus.BUS_CPU_A04p.out_new());
  triwire XOBA_CA05_TO_VA05 = tri6_nn(XEDU_VRAM_LOCKp, new_bus.BUS_CPU_A05p.out_new());
  triwire XOPO_CA06_TO_VA06 = tri6_nn(XEDU_VRAM_LOCKp, new_bus.BUS_CPU_A06p.out_new());
  triwire XYBO_CA07_TO_VA07 = tri6_nn(XEDU_VRAM_LOCKp, new_bus.BUS_CPU_A07p.out_new());
  triwire RYSU_CA08_TO_VA08 = tri6_nn(XEDU_VRAM_LOCKp, new_bus.BUS_CPU_A08p.out_new());
  triwire RESE_CA09_TO_VA09 = tri6_nn(XEDU_VRAM_LOCKp, new_bus.BUS_CPU_A09p.out_new());
  triwire RUSE_CA10_TO_VA10 = tri6_nn(XEDU_VRAM_LOCKp, new_bus.BUS_CPU_A10p.out_new());
  triwire RYNA_CA11_TO_VA11 = tri6_nn(XEDU_VRAM_LOCKp, new_bus.BUS_CPU_A11p.out_new());
  triwire RUMO_CA12_TO_VA12 = tri6_nn(XEDU_VRAM_LOCKp, new_bus.BUS_CPU_A12p.out_new());

  vram_bus.BUS_VRAM_A00n.tri_bus(XAKY_CA00_TO_VA00);
  vram_bus.BUS_VRAM_A01n.tri_bus(XUXU_CA01_TO_VA01);
  vram_bus.BUS_VRAM_A02n.tri_bus(XYNE_CA02_TO_VA02);
  vram_bus.BUS_VRAM_A03n.tri_bus(XODY_CA03_TO_VA03);
  vram_bus.BUS_VRAM_A04n.tri_bus(XECA_CA04_TO_VA04);
  vram_bus.BUS_VRAM_A05n.tri_bus(XOBA_CA05_TO_VA05);
  vram_bus.BUS_VRAM_A06n.tri_bus(XOPO_CA06_TO_VA06);
  vram_bus.BUS_VRAM_A07n.tri_bus(XYBO_CA07_TO_VA07);
  vram_bus.BUS_VRAM_A08n.tri_bus(RYSU_CA08_TO_VA08);
  vram_bus.BUS_VRAM_A09n.tri_bus(RESE_CA09_TO_VA09);
  vram_bus.BUS_VRAM_A10n.tri_bus(RUSE_CA10_TO_VA10);
  vram_bus.BUS_VRAM_A11n.tri_bus(RYNA_CA11_TO_VA11);
  vram_bus.BUS_VRAM_A12n.tri_bus(RUMO_CA12_TO_VA12);

  //--------------------------------------------
  // DMA vram read address

  wire AHOC_DMA_VRAMn_new = not1(LUFA_DMA_VRAMp);
  triwire ECAL_DA00_TO_VA00 = tri6_nn(AHOC_DMA_VRAMn_new, dma.NAKY_DMA_A00p.qp_new());
  triwire EGEZ_DA01_TO_VA01 = tri6_nn(AHOC_DMA_VRAMn_new, dma.PYRO_DMA_A01p.qp_new());
  triwire FUHE_DA02_TO_VA02 = tri6_nn(AHOC_DMA_VRAMn_new, dma.NEFY_DMA_A02p.qp_new());
  triwire FYZY_DA03_TO_VA03 = tri6_nn(AHOC_DMA_VRAMn_new, dma.MUTY_DMA_A03p.qp_new());
  triwire DAMU_DA04_TO_VA04 = tri6_nn(AHOC_DMA_VRAMn_new, dma.NYKO_DMA_A04p.qp_new());
  triwire DAVA_DA05_TO_VA05 = tri6_nn(AHOC_DMA_VRAMn_new, dma.PYLO_DMA_A05p.qp_new());
  triwire ETEG_DA06_TO_VA06 = tri6_nn(AHOC_DMA_VRAMn_new, dma.NUTO_DMA_A06p.qp_new());
  triwire EREW_DA07_TO_VA07 = tri6_nn(AHOC_DMA_VRAMn_new, dma.MUGU_DMA_A07p.qp_new());
  triwire EVAX_DA08_TO_VA08 = tri6_nn(AHOC_DMA_VRAMn_new, dma.NAFA_DMA_A08n.qn_new());
  triwire DUVE_DA09_TO_VA09 = tri6_nn(AHOC_DMA_VRAMn_new, dma.PYNE_DMA_A09n.qn_new());
  triwire ERAF_DA10_TO_VA10 = tri6_nn(AHOC_DMA_VRAMn_new, dma.PARA_DMA_A10n.qn_new());
  triwire FUSY_DA11_TO_VA11 = tri6_nn(AHOC_DMA_VRAMn_new, dma.NYDO_DMA_A11n.qn_new());
  triwire EXYF_DA12_TO_VA12 = tri6_nn(AHOC_DMA_VRAMn_new, dma.NYGY_DMA_A12n.qn_new());

  vram_bus.BUS_VRAM_A00n.tri_bus(ECAL_DA00_TO_VA00);
  vram_bus.BUS_VRAM_A01n.tri_bus(EGEZ_DA01_TO_VA01);
  vram_bus.BUS_VRAM_A02n.tri_bus(FUHE_DA02_TO_VA02);
  vram_bus.BUS_VRAM_A03n.tri_bus(FYZY_DA03_TO_VA03);
  vram_bus.BUS_VRAM_A04n.tri_bus(DAMU_DA04_TO_VA04);
  vram_bus.BUS_VRAM_A05n.tri_bus(DAVA_DA05_TO_VA05);
  vram_bus.BUS_VRAM_A06n.tri_bus(ETEG_DA06_TO_VA06);
  vram_bus.BUS_VRAM_A07n.tri_bus(EREW_DA07_TO_VA07);
  vram_bus.BUS_VRAM_A08n.tri_bus(EVAX_DA08_TO_VA08);
  vram_bus.BUS_VRAM_A09n.tri_bus(DUVE_DA09_TO_VA09);
  vram_bus.BUS_VRAM_A10n.tri_bus(ERAF_DA10_TO_VA10);
  vram_bus.BUS_VRAM_A11n.tri_bus(FUSY_DA11_TO_VA11);
  vram_bus.BUS_VRAM_A12n.tri_bus(EXYF_DA12_TO_VA12);
  ...
  wire NOFU_BFETCH_S2n = not1(tile_fetcher.NYVA_BFETCH_S2p.qp_new());
  wire NAKO_BFETCH_S1n = not1(tile_fetcher.MESU_BFETCH_S1p.qp_new());
  wire NOGU_BFETCH_01p = nand2(NAKO_BFETCH_S1n, NOFU_BFETCH_S2n);
  wire NENY_BFETCH_01n = not1(NOGU_BFETCH_01p);
  wire LUSU_FETCHINGn = not1(tile_fetcher.LONY_FETCHINGp.qp_new());
  wire LENA_BFETCHINGp = not1(LUSU_FETCHINGn);
  wire POTU_BGW_MAP_READp = and2(LENA_BFETCHINGp, NENY_BFETCH_01n);

  wire ACEN_BG_MAP_READp = and2(POTU_BGW_MAP_READp, AXAD_WIN_MODEn);
  wire BAFY_BG_MAP_READn = not1(ACEN_BG_MAP_READp);
  ...
  triwire AXEP_MX00_TO_VA00 = tri6_nn(BAFY_BG_MAP_READn, BABE_MAP_X0.sum);
  triwire AFEB_MX01_TO_VA01 = tri6_nn(BAFY_BG_MAP_READn, ABOD_MAP_X1.sum);
  triwire ALEL_MX02_TO_VA02 = tri6_nn(BAFY_BG_MAP_READn, BEWY_MAP_X2.sum);
  triwire COLY_MX03_TO_VA03 = tri6_nn(BAFY_BG_MAP_READn, BYCA_MAP_X3.sum);
  triwire AJAN_MX04_TO_VA04 = tri6_nn(BAFY_BG_MAP_READn, ACUL_MAP_X4.sum);
  triwire DUHO_MY00_TO_VA05 = tri6_nn(BAFY_BG_MAP_READn, ETAM_MAP_Y0.sum);
  triwire CASE_MY01_TO_VA06 = tri6_nn(BAFY_BG_MAP_READn, DOTO_MAP_Y1.sum);
  triwire CYPO_MY02_TO_VA07 = tri6_nn(BAFY_BG_MAP_READn, DABA_MAP_Y2.sum);
  triwire CETA_MY03_TO_VA08 = tri6_nn(BAFY_BG_MAP_READn, EFYK_MAP_Y3.sum);
  triwire DAFE_MY04_TO_VA09 = tri6_nn(BAFY_BG_MAP_READn, EJOK_MAP_Y4.sum);
  triwire AMUV_BMAP_TO_VA10 = tri6_nn(BAFY_BG_MAP_READn, reg_lcdc.XAFO_LCDC_BGMAPn.qn_new());
  triwire COVE_BMAP_TO_VA11 = tri6_nn(BAFY_BG_MAP_READn, SIG_VCC.out_new());
  triwire COXO_BMAP_TO_VA12 = tri6_nn(BAFY_BG_MAP_READn, SIG_VCC.out_new());

  vram_bus.BUS_VRAM_A00n.tri_bus(AXEP_MX00_TO_VA00);
  vram_bus.BUS_VRAM_A01n.tri_bus(AFEB_MX01_TO_VA01);
  vram_bus.BUS_VRAM_A02n.tri_bus(ALEL_MX02_TO_VA02);
  vram_bus.BUS_VRAM_A03n.tri_bus(COLY_MX03_TO_VA03);
  vram_bus.BUS_VRAM_A04n.tri_bus(AJAN_MX04_TO_VA04);
  vram_bus.BUS_VRAM_A05n.tri_bus(DUHO_MY00_TO_VA05);
  vram_bus.BUS_VRAM_A06n.tri_bus(CASE_MY01_TO_VA06);
  vram_bus.BUS_VRAM_A07n.tri_bus(CYPO_MY02_TO_VA07);
  vram_bus.BUS_VRAM_A08n.tri_bus(CETA_MY03_TO_VA08);
  vram_bus.BUS_VRAM_A09n.tri_bus(DAFE_MY04_TO_VA09);
  vram_bus.BUS_VRAM_A10n.tri_bus(AMUV_BMAP_TO_VA10);
  vram_bus.BUS_VRAM_A11n.tri_bus(COVE_BMAP_TO_VA11);
  vram_bus.BUS_VRAM_A12n.tri_bus(COXO_BMAP_TO_VA12);

  //--------------------------------------------
  // Win map counters & win map read address

  wire XEZE_WIN_MAP_READp = and2(POTU_BGW_MAP_READp, PORE_WIN_MODEp);
  wire WUKO_WIN_MAP_READn = not1(XEZE_WIN_MAP_READp);

  wire VETU_WIN_MAPp = and2(TEVO_WIN_FETCH_TRIGp, PORE_WIN_MODEp);
  wire XAHY_LINE_RSTn = not1(ATEJ_LINE_RSTp.out_new());
  wire XOFO_WIN_RSTp = nand3(reg_lcdc.WYMO_LCDC_WINENn.qn_new(), XAHY_LINE_RSTn, XAPO_VID_RSTn());
  wire XACO_WIN_RSTn = not1(XOFO_WIN_RSTp);
  win_coords.WYKA_WIN_MAP_X0.dff17(VETU_WIN_MAPp, XACO_WIN_RSTn, win_coords.WYKA_WIN_MAP_X0.qn_old());
  win_coords.WODY_WIN_MAP_X1.dff17(win_coords.WYKA_WIN_MAP_X0.qn_new(), XACO_WIN_RSTn, win_coords.WODY_WIN_MAP_X1.qn_old());
  win_coords.WOBO_WIN_MAP_X2.dff17(win_coords.WODY_WIN_MAP_X1.qn_new(), XACO_WIN_RSTn, win_coords.WOBO_WIN_MAP_X2.qn_old());
  win_coords.WYKO_WIN_MAP_X3.dff17(win_coords.WOBO_WIN_MAP_X2.qn_new(), XACO_WIN_RSTn, win_coords.WYKO_WIN_MAP_X3.qn_old());
  win_coords.XOLO_WIN_MAP_X4.dff17(win_coords.WYKO_WIN_MAP_X3.qn_new(), XACO_WIN_RSTn, win_coords.XOLO_WIN_MAP_X4.qn_old());

  // Every time we leave win mode we increment win_y
  wire WAZY_WIN_MODEn = not1(PORE_WIN_MODEp);
  wire PARU_VBLANKp = not1(lcd.POPU_y144p.qn_new());
  wire REPU_VBLANKp = or2(PARU_VBLANKp, PYRY_VID_RSTp());
  wire SYNY_VBLANKn = not1(REPU_VBLANKp);
  win_coords.VYNO_WIN_TILE_Y0.dff17(WAZY_WIN_MODEn, SYNY_VBLANKn, win_coords.VYNO_WIN_TILE_Y0.qn_old());
  win_coords.VUJO_WIN_TILE_Y1.dff17(win_coords.VYNO_WIN_TILE_Y0.qn_new(), SYNY_VBLANKn, win_coords.VUJO_WIN_TILE_Y1.qn_old());
  win_coords.VYMU_WIN_TILE_Y2.dff17(win_coords.VUJO_WIN_TILE_Y1.qn_new(), SYNY_VBLANKn, win_coords.VYMU_WIN_TILE_Y2.qn_old());
  win_coords.TUFU_WIN_MAP_Y0.dff17(win_coords.VYMU_WIN_TILE_Y2.qn_new(), SYNY_VBLANKn, win_coords.TUFU_WIN_MAP_Y0.qn_old());

  win_coords.TAXA_WIN_MAP_Y1.dff17(win_coords.TUFU_WIN_MAP_Y0.qn_new(), SYNY_VBLANKn, win_coords.TAXA_WIN_MAP_Y1.qn_old());
  win_coords.TOZO_WIN_MAP_Y2.dff17(win_coords.TAXA_WIN_MAP_Y1.qn_new(), SYNY_VBLANKn, win_coords.TOZO_WIN_MAP_Y2.qn_old());
  win_coords.TATE_WIN_MAP_Y3.dff17(win_coords.TOZO_WIN_MAP_Y2.qn_new(), SYNY_VBLANKn, win_coords.TATE_WIN_MAP_Y3.qn_old());
  win_coords.TEKE_WIN_MAP_Y4.dff17(win_coords.TATE_WIN_MAP_Y3.qn_new(), SYNY_VBLANKn, win_coords.TEKE_WIN_MAP_Y4.qn_old());

  if (!bit(WUKO_WIN_MAP_READn)) {
  ...
  wire NETA_BGW_TILE_READp = and2(LENA_BFETCHINGp, NOGU_BFETCH_01p);
  wire ASUL_BG_TILE_READp = and2(NETA_BGW_TILE_READp, AXAD_WIN_MODEn);
  wire BEJE_BG_TILE_READn = not1(ASUL_BG_TILE_READp);
  wire XUCY_WIN_TILE_READn = nand2(NETA_BGW_TILE_READp, PORE_WIN_MODEp);
  wire XUHA_FETCH_HILOp = not1(NOFU_BFETCH_S2n);

  triwire ASUM_HILO_TO_VA00 = tri6_nn(BEJE_BG_TILE_READn, XUHA_FETCH_HILOp);
  triwire EVAD_TLY0_TO_VA01 = tri6_nn(BEJE_BG_TILE_READn, FAFO_TILE_Y0.sum);
  triwire DAHU_TLY1_TO_VA02 = tri6_nn(BEJE_BG_TILE_READn, EMUX_TILE_Y1.sum);
  triwire DODE_TLY2_TO_VA03 = tri6_nn(BEJE_BG_TILE_READn, ECAB_TILE_Y2.sum);

  vram_bus.BUS_VRAM_A00n.tri_bus(ASUM_HILO_TO_VA00);
  vram_bus.BUS_VRAM_A01n.tri_bus(EVAD_TLY0_TO_VA01);
  vram_bus.BUS_VRAM_A02n.tri_bus(DAHU_TLY1_TO_VA02);
  vram_bus.BUS_VRAM_A03n.tri_bus(DODE_TLY2_TO_VA03);

  triwire XONU_HILO_TO_VA00 = tri6_nn(XUCY_WIN_TILE_READn, XUHA_FETCH_HILOp);
  triwire WUDO_WNY0_TO_VA01 = tri6_nn(XUCY_WIN_TILE_READn, win_coords.VYNO_WIN_TILE_Y0.qp_new());
  triwire WAWE_WNY1_TO_VA02 = tri6_nn(XUCY_WIN_TILE_READn, win_coords.VUJO_WIN_TILE_Y1.qp_new());
  triwire WOLU_WNY2_TO_VA03 = tri6_nn(XUCY_WIN_TILE_READn, win_coords.VYMU_WIN_TILE_Y2.qp_new());

  vram_bus.BUS_VRAM_A00n.tri_bus(XONU_HILO_TO_VA00);
  vram_bus.BUS_VRAM_A01n.tri_bus(WUDO_WNY0_TO_VA01);
  vram_bus.BUS_VRAM_A02n.tri_bus(WAWE_WNY1_TO_VA02);
  vram_bus.BUS_VRAM_A03n.tri_bus(WOLU_WNY2_TO_VA03);

  triwire VAPY_TEMP_TO_VA04 = tri6_pn(NETA_BGW_TILE_READp, tile_temp_b.RAWU_TILE_DB0p.qp_new());
  triwire SEZU_TEMP_TO_VA05 = tri6_pn(NETA_BGW_TILE_READp, tile_temp_b.POZO_TILE_DB1p.qp_new());
  triwire VEJY_TEMP_TO_VA06 = tri6_pn(NETA_BGW_TILE_READp, tile_temp_b.PYZO_TILE_DB2p.qp_new());
  triwire RUSA_TEMP_TO_VA07 = tri6_pn(NETA_BGW_TILE_READp, tile_temp_b.POXA_TILE_DB3p.qp_new());
  triwire ROHA_TEMP_TO_VA08 = tri6_pn(NETA_BGW_TILE_READp, tile_temp_b.PULO_TILE_DB4p.qp_new());
  triwire RESO_TEMP_TO_VA09 = tri6_pn(NETA_BGW_TILE_READp, tile_temp_b.POJU_TILE_DB5p.qp_new());
  triwire SUVO_TEMP_TO_VA10 = tri6_pn(NETA_BGW_TILE_READp, tile_temp_b.POWY_TILE_DB6p.qp_new());
  triwire TOBO_TEMP_TO_VA11 = tri6_pn(NETA_BGW_TILE_READp, tile_temp_b.PYJU_TILE_DB7p.qp_new());

  vram_bus.BUS_VRAM_A04n.tri_bus(VAPY_TEMP_TO_VA04);
  vram_bus.BUS_VRAM_A05n.tri_bus(SEZU_TEMP_TO_VA05);
  vram_bus.BUS_VRAM_A06n.tri_bus(VEJY_TEMP_TO_VA06);
  vram_bus.BUS_VRAM_A07n.tri_bus(RUSA_TEMP_TO_VA07);
  vram_bus.BUS_VRAM_A08n.tri_bus(ROHA_TEMP_TO_VA08);
  vram_bus.BUS_VRAM_A09n.tri_bus(RESO_TEMP_TO_VA09);
  vram_bus.BUS_VRAM_A10n.tri_bus(SUVO_TEMP_TO_VA10);
  vram_bus.BUS_VRAM_A11n.tri_bus(TOBO_TEMP_TO_VA11);

  wire VUZA_TILE_BANKp = nor2(tile_temp_b.PYJU_TILE_DB7p.qp_new(), reg_lcdc.WEXU_LCDC_BGTILEn.qn_new());
  triwire VURY_BANK_TO_VA12 = tri6_pn(NETA_BGW_TILE_READp, VUZA_TILE_BANKp);

  vram_bus.BUS_VRAM_A12n.tri_bus(VURY_BANK_TO_VA12);

  //--------------------------------------------
  // Sprite read address

  wire WUKY_FLIP_Yp = not1(oam_temp_b.YZOS_OAM_DB6p.qp_new());
  wire FUFO_LCDC_SPSIZEn = not1(reg_lcdc.XYMO_LCDC_SPSIZEn.qn_new());

  wire XUQU_SPRITE_AB = not1(sprite_fetcher.VONU_SFETCH_S1p_D4.qn_new());
  ...
  wire GEJY_L3 = amux2(oam_temp_a.XUSO_OAM_DA0p.qp_new(), FUFO_LCDC_SPSIZEn, reg_lcdc.XYMO_LCDC_SPSIZEn.qn_new(), WAGO_L3);

  wire ABON_SFETCHINGn = not1(sprite_fetcher.TEXY_SFETCHINGp.out_new());
  triwire ABEM_HILO_TO_VA00 = tri6_nn(ABON_SFETCHINGn, XUQU_SPRITE_AB);
  triwire BAXE_SPL0_TO_VA01 = tri6_nn(ABON_SFETCHINGn, CYVU_L0);
  triwire ARAS_SPL1_TO_VA02 = tri6_nn(ABON_SFETCHINGn, BORE_L1);
  triwire AGAG_SPL2_TO_VA03 = tri6_nn(ABON_SFETCHINGn, BUVY_L2);
  triwire FAMU_SPL3_TO_VA04 = tri6_nn(ABON_SFETCHINGn, GEJY_L3);
  triwire FUGY_ODA1_TO_VA05 = tri6_nn(ABON_SFETCHINGn, oam_temp_a.XEGU_OAM_DA1p.qp_new());
  triwire GAVO_ODA2_TO_VA06 = tri6_nn(ABON_SFETCHINGn, oam_temp_a.YJEX_OAM_DA2p.qp_new());
  triwire WYGA_ODA3_TO_VA07 = tri6_nn(ABON_SFETCHINGn, oam_temp_a.XYJU_OAM_DA3p.qp_new());
  triwire WUNE_ODA4_TO_VA08 = tri6_nn(ABON_SFETCHINGn, oam_temp_a.YBOG_OAM_DA4p.qp_new());
  triwire GOTU_ODA5_TO_VA09 = tri6_nn(ABON_SFETCHINGn, oam_temp_a.WYSO_OAM_DA5p.qp_new());
  triwire GEGU_ODA6_TO_VA10 = tri6_nn(ABON_SFETCHINGn, oam_temp_a.XOTE_OAM_DA6p.qp_new());
  triwire XEHE_ODA7_TO_VA11 = tri6_nn(ABON_SFETCHINGn, oam_temp_a.YZAB_OAM_DA7p.qp_new());
  triwire DYSO_BANK_TO_VA12 = tri6_nn(ABON_SFETCHINGn, SIG_GND.out_new());   // sprites always in low half of tile store

  vram_bus.BUS_VRAM_A00n.tri_bus(ABEM_HILO_TO_VA00);
  vram_bus.BUS_VRAM_A01n.tri_bus(BAXE_SPL0_TO_VA01);
  vram_bus.BUS_VRAM_A02n.tri_bus(ARAS_SPL1_TO_VA02);
  vram_bus.BUS_VRAM_A03n.tri_bus(AGAG_SPL2_TO_VA03);
  vram_bus.BUS_VRAM_A04n.tri_bus(FAMU_SPL3_TO_VA04);
  vram_bus.BUS_VRAM_A05n.tri_bus(FUGY_ODA1_TO_VA05);
  vram_bus.BUS_VRAM_A06n.tri_bus(GAVO_ODA2_TO_VA06);
  vram_bus.BUS_VRAM_A07n.tri_bus(WYGA_ODA3_TO_VA07);
  vram_bus.BUS_VRAM_A08n.tri_bus(WUNE_ODA4_TO_VA08);
  vram_bus.BUS_VRAM_A09n.tri_bus(GOTU_ODA5_TO_VA09);
  vram_bus.BUS_VRAM_A10n.tri_bus(GEGU_ODA6_TO_VA10);
  vram_bus.BUS_VRAM_A11n.tri_bus(XEHE_ODA7_TO_VA11);
  vram_bus.BUS_VRAM_A12n.tri_bus(DYSO_BANK_TO_VA12);

  //--------------------------------------------
  // Vram address pin driver

  wire MYFUp = not1(vram_bus.BUS_VRAM_A00n.out_new());
  wire MASAp = not1(vram_bus.BUS_VRAM_A01n.out_new());
  wire MYREp = not1(vram_bus.BUS_VRAM_A02n.out_new());
  wire MAVUp = not1(vram_bus.BUS_VRAM_A03n.out_new());
  wire MEPAp = not1(vram_bus.BUS_VRAM_A04n.out_new());
  wire MYSAp = not1(vram_bus.BUS_VRAM_A05n.out_new());
  wire MEWYp = not1(vram_bus.BUS_VRAM_A06n.out_new());
  wire MUMEp = not1(vram_bus.BUS_VRAM_A07n.out_new());
  wire VOVAp = not1(vram_bus.BUS_VRAM_A08n.out_new());
  wire VODEp = not1(vram_bus.BUS_VRAM_A09n.out_new());
  wire RUKYp = not1(vram_bus.BUS_VRAM_A10n.out_new());
  wire RUMAp = not1(vram_bus.BUS_VRAM_A11n.out_new());
  wire REHOp = not1(vram_bus.BUS_VRAM_A12n.out_new());

  wire LEXEn = not1(MYFUp);
  wire LOZUn = not1(MASAp);
  wire LACAn = not1(MYREp);
  wire LUVOn = not1(MAVUp);
  wire LOLYn = not1(MEPAp);
  wire LALOn = not1(MYSAp);
  wire LEFAn = not1(MEWYp);
  wire LUBYn = not1(MUMEp);
  wire TUJYn = not1(VOVAp);
  wire TAGOn = not1(VODEp);
  wire NUVAn = not1(RUKYp);
  wire PEDUn = not1(RUMAp);
  wire PONYn = not1(REHOp);

  vram_pins.PIN_34_VRAM_A00.pin_out(LEXEn, LEXEn);
  vram_pins.PIN_35_VRAM_A01.pin_out(LOZUn, LOZUn);
  vram_pins.PIN_36_VRAM_A02.pin_out(LACAn, LACAn);
  vram_pins.PIN_37_VRAM_A03.pin_out(LUVOn, LUVOn);
  vram_pins.PIN_38_VRAM_A04.pin_out(LOLYn, LOLYn);
  vram_pins.PIN_39_VRAM_A05.pin_out(LALOn, LALOn);
  vram_pins.PIN_40_VRAM_A06.pin_out(LEFAn, LEFAn);
  vram_pins.PIN_41_VRAM_A07.pin_out(LUBYn, LUBYn);
  vram_pins.PIN_48_VRAM_A08.pin_out(TUJYn, TUJYn);
  vram_pins.PIN_47_VRAM_A09.pin_out(TAGOn, TAGOn);
  vram_pins.PIN_44_VRAM_A10.pin_out(NUVAn, NUVAn);
  vram_pins.PIN_46_VRAM_A11.pin_out(PEDUn, PEDUn);
  vram_pins.PIN_42_VRAM_A12.pin_out(PONYn, PONYn);
  ...
  {
    wire RUVY_CPU_VRAM_WRp = not1(SALE_CPU_VRAM_WRn());
    wire ROPY_RENDERINGn = not1(XYMU_RENDERINGn.qn_new());
    wire SERE_CPU_VRAM_RDp = and2(TOLE_CPU_VRAM_RDp(), ROPY_RENDERINGn);

    wire SAZO_CBD_TO_VPDp = and2(SERE_CPU_VRAM_RDp, RUVY_CPU_VRAM_WRp);
    wire RYJE_CBD_TO_VPDn = not1(SAZO_CBD_TO_VPDp);
    wire REVO_CBD_TO_VPDp = not1(RYJE_CBD_TO_VPDn);

    wire ROCY_CBD_TO_VPDp = and2(SAZO_CBD_TO_VPDp, REVO_CBD_TO_VPDp);
    wire RAHU_CBD_TO_VPDn = not1(ROCY_CBD_TO_VPDp);

    triwire TEME_CD0_TO_VD0 = tri10_np(RAHU_CBD_TO_VPDn, new_bus.BUS_CPU_D00p.out_new());
    triwire TEWU_CD1_TO_VD1 = tri10_np(RAHU_CBD_TO_VPDn, new_bus.BUS_CPU_D01p.out_new());
    triwire TYGO_CD2_TO_VD2 = tri10_np(RAHU_CBD_TO_VPDn, new_bus.BUS_CPU_D02p.out_new());
    triwire SOTE_CD3_TO_VD3 = tri10_np(RAHU_CBD_TO_VPDn, new_bus.BUS_CPU_D03p.out_new());
    triwire SEKE_CD4_TO_VD4 = tri10_np(RAHU_CBD_TO_VPDn, new_bus.BUS_CPU_D04p.out_new());
    triwire RUJO_CD5_TO_VD5 = tri10_np(RAHU_CBD_TO_VPDn, new_bus.BUS_CPU_D05p.out_new());
    triwire TOFA_CD6_TO_VD6 = tri10_np(RAHU_CBD_TO_VPDn, new_bus.BUS_CPU_D06p.out_new());
    triwire SUZA_CD7_TO_VD7 = tri10_np(RAHU_CBD_TO_VPDn, new_bus.BUS_CPU_D07p.out_new());

    vram_bus.BUS_VRAM_D00p.tri_bus(TEME_CD0_TO_VD0);
    vram_bus.BUS_VRAM_D01p.tri_bus(TEWU_CD1_TO_VD1);
    vram_bus.BUS_VRAM_D02p.tri_bus(TYGO_CD2_TO_VD2);
    vram_bus.BUS_VRAM_D03p.tri_bus(SOTE_CD3_TO_VD3);
    vram_bus.BUS_VRAM_D04p.tri_bus(SEKE_CD4_TO_VD4);
    vram_bus.BUS_VRAM_D05p.tri_bus(RUJO_CD5_TO_VD5);
    vram_bus.BUS_VRAM_D06p.tri_bus(TOFA_CD6_TO_VD6);
    vram_bus.BUS_VRAM_D07p.tri_bus(SUZA_CD7_TO_VD7);
  }
...

  {
    wire ROPY_RENDERINGn = not1(XYMU_RENDERINGn.qn_new());
    wire SERE_CPU_VRAM_RDp = and2(TOLE_CPU_VRAM_RDp(), ROPY_RENDERINGn);
    wire RACO_DBG_VRAMn = not1(TUTO_VRAM_DBGp());
    wire SUTU_MCSn = nor4(LENA_BFETCHINGp, LUFA_DMA_VRAMp, sprite_fetcher.TEXY_SFETCHINGp.out_new(), SERE_CPU_VRAM_RDp);
    wire TODE_MCSn_A = and2(SUTU_MCSn, RACO_DBG_VRAMn);
    wire SEWO_MCSn_D = or2(SUTU_MCSn, TUTO_VRAM_DBGp());
    wire SOKY_MCSp_A = not1(TODE_MCSn_A);
    wire SETY_MCSp_D = not1(SEWO_MCSn_D);

    vram_pins.PIN_43_VRAM_CSn.pin_out(SOKY_MCSp_A, SETY_MCSp_D); // FIXME not actually using this pin, but we should
  }

  {
    ...
    wire SUDO_MWRp = not1(SIG_VCC.out_new()); // Ignoring debug stuff for now

    wire TYJY_VRAM_WRp = mux2p(TUTO_VRAM_DBGp(), SUDO_MWRp, TUJA_CPU_VRAM_WRp());
    wire SOHY_MWRn = nand2(TYJY_VRAM_WRp, SERE_CPU_VRAM_RDp);

    wire RACO_DBG_VRAMn = not1(TUTO_VRAM_DBGp());
    wire TAXY_MWRn_A = and2(SOHY_MWRn, RACO_DBG_VRAMn);
    wire SOFY_MWRn_D = or2(SOHY_MWRn, TUTO_VRAM_DBGp());
    wire SYSY_MWRp_A = not1(TAXY_MWRn_A);
    wire RAGU_MWRp_D = not1(SOFY_MWRn_D);

    vram_pins.PIN_49_VRAM_WRn.pin_out(SYSY_MWRp_A, RAGU_MWRp_D);

    wire RYLU_CPU_VRAM_RDn = nand2(SALE_CPU_VRAM_WRn(), XANE_VRAM_LOCKn);
    ...
    wire SOHO_SPR_VRAM_RDp = and2(TACU_SPR_SEQ_5_TRIG, sprite_fetcher.TEXY_SFETCHINGp.out_new());
    wire RAWA_SPR_VRAM_RDn = not1(SOHO_SPR_VRAM_RDp);
    wire MYMA_BGW_VRAM_RDn = not1(tile_fetcher.LONY_FETCHINGp.qp_new());
    wire APAM_DMA_VRAMn = not1(LUFA_DMA_VRAMp);
    wire RACU_MOEn = and4(RYLU_CPU_VRAM_RDn, RAWA_SPR_VRAM_RDn, MYMA_BGW_VRAM_RDn, APAM_DMA_VRAMn); // def and
    wire SEMA_MOEn_A = and2(RACU_MOEn, RACO_DBG_VRAMn);
    wire RUTE_MOEn_D = or2(RACU_MOEn, TUTO_VRAM_DBGp()); // schematic wrong, second input is RACU
    wire REFO_MOEn_A = not1(SEMA_MOEn_A);
    wire SAHA_MOEn_D = not1(RUTE_MOEn_D);
    vram_pins.PIN_45_VRAM_OEn.pin_out(REFO_MOEn_A, SAHA_MOEn_D);
  }
...

  {
    ...
    wire ROCY_CBD_TO_VPDp = and2(SAZO_CBD_TO_VPDp, REVO_CBD_TO_VPDp);
    wire RAHU_CBD_TO_VPDn = not1(ROCY_CBD_TO_VPDp);
    wire ROVE_CBD_TO_VPDp = not1(RAHU_CBD_TO_VPDn);

    wire SEFA_D0p = and2(vram_bus.BUS_VRAM_D00p.out_new(), ROVE_CBD_TO_VPDp);
    wire SOGO_D1p = and2(vram_bus.BUS_VRAM_D01p.out_new(), ROVE_CBD_TO_VPDp);
    wire SEFU_D2p = and2(vram_bus.BUS_VRAM_D02p.out_new(), ROVE_CBD_TO_VPDp);
    wire SUNA_D3p = and2(vram_bus.BUS_VRAM_D03p.out_new(), ROVE_CBD_TO_VPDp);
    wire SUMO_D4p = and2(vram_bus.BUS_VRAM_D04p.out_new(), ROVE_CBD_TO_VPDp);
    wire SAZU_D5p = and2(vram_bus.BUS_VRAM_D05p.out_new(), ROVE_CBD_TO_VPDp);
    wire SAMO_D6p = and2(vram_bus.BUS_VRAM_D06p.out_new(), ROVE_CBD_TO_VPDp);
    wire SUKE_D7p = and2(vram_bus.BUS_VRAM_D07p.out_new(), ROVE_CBD_TO_VPDp);

    wire SYNU_D0p = or2(RAHU_CBD_TO_VPDn, vram_bus.BUS_VRAM_D00p.out_new());
    wire SYMA_D1p = or2(RAHU_CBD_TO_VPDn, vram_bus.BUS_VRAM_D01p.out_new());
    wire ROKO_D2p = or2(RAHU_CBD_TO_VPDn, vram_bus.BUS_VRAM_D02p.out_new());
    wire SYBU_D3p = or2(RAHU_CBD_TO_VPDn, vram_bus.BUS_VRAM_D03p.out_new());
    wire SAKO_D4p = or2(RAHU_CBD_TO_VPDn, vram_bus.BUS_VRAM_D04p.out_new());
    wire SEJY_D5p = or2(RAHU_CBD_TO_VPDn, vram_bus.BUS_VRAM_D05p.out_new());
    wire SEDO_D6p = or2(RAHU_CBD_TO_VPDn, vram_bus.BUS_VRAM_D06p.out_new());
    wire SAWU_D7p = or2(RAHU_CBD_TO_VPDn, vram_bus.BUS_VRAM_D07p.out_new());

    wire REGE_D0n = not1(SEFA_D0p);
    wire RYKY_D1n = not1(SOGO_D1p);
    wire RAZO_D2n = not1(SEFU_D2p);
    wire RADA_D3n = not1(SUNA_D3p);
    wire RYRO_D4n = not1(SUMO_D4p);
    wire REVU_D5n = not1(SAZU_D5p);
    wire REKU_D6n = not1(SAMO_D6p);
    wire RYZE_D7n = not1(SUKE_D7p);

    wire RURA_D0n = not1(SYNU_D0p);
    wire RULY_D1n = not1(SYMA_D1p);
    wire RARE_D2n = not1(ROKO_D2p);
    wire RODU_D3n = not1(SYBU_D3p);
    wire RUBE_D4n = not1(SAKO_D4p);
    wire RUMU_D5n = not1(SEJY_D5p);
    wire RYTY_D6n = not1(SEDO_D6p);
    wire RADY_D7n = not1(SAWU_D7p);

    wire RELA_CBD_TO_VPDp = or2(REVO_CBD_TO_VPDp, SAZO_CBD_TO_VPDp);
    wire RENA_CBD_TO_VPDn = not1(RELA_CBD_TO_VPDp);
    wire ROFA_CBD_TO_VPDp = not1(RENA_CBD_TO_VPDn);
    ...
    vram_pins.PIN_33_VRAM_D00.pin_io(ROFA_CBD_TO_VPDp, REGE_D0n, RURA_D0n, vram_pins.PIN_45_VRAM_OEn.qn_ext_new(), EXT_vram_d0);
    vram_pins.PIN_31_VRAM_D01.pin_io(ROFA_CBD_TO_VPDp, RYKY_D1n, RULY_D1n, vram_pins.PIN_45_VRAM_OEn.qn_ext_new(), EXT_vram_d1);
    vram_pins.PIN_30_VRAM_D02.pin_io(ROFA_CBD_TO_VPDp, RAZO_D2n, RARE_D2n, vram_pins.PIN_45_VRAM_OEn.qn_ext_new(), EXT_vram_d2);
    vram_pins.PIN_29_VRAM_D03.pin_io(ROFA_CBD_TO_VPDp, RADA_D3n, RODU_D3n, vram_pins.PIN_45_VRAM_OEn.qn_ext_new(), EXT_vram_d3);
    vram_pins.PIN_28_VRAM_D04.pin_io(ROFA_CBD_TO_VPDp, RYRO_D4n, RUBE_D4n, vram_pins.PIN_45_VRAM_OEn.qn_ext_new(), EXT_vram_d4);
    vram_pins.PIN_27_VRAM_D05.pin_io(ROFA_CBD_TO_VPDp, REVU_D5n, RUMU_D5n, vram_pins.PIN_45_VRAM_OEn.qn_ext_new(), EXT_vram_d5);
    vram_pins.PIN_26_VRAM_D06.pin_io(ROFA_CBD_TO_VPDp, REKU_D6n, RYTY_D6n, vram_pins.PIN_45_VRAM_OEn.qn_ext_new(), EXT_vram_d6);
    vram_pins.PIN_25_VRAM_D07.pin_io(ROFA_CBD_TO_VPDp, RYZE_D7n, RADY_D7n, vram_pins.PIN_45_VRAM_OEn.qn_ext_new(), EXT_vram_d7);
  }
...

  {
    ...
    triwire RODY_VP0_TO_VD0 = tri6_pn(RENA_CBD_TO_VPDn, vram_pins.PIN_33_VRAM_D00.qp_int_new());
    triwire REBA_VP1_TO_VD1 = tri6_pn(RENA_CBD_TO_VPDn, vram_pins.PIN_31_VRAM_D01.qp_int_new());
    triwire RYDO_VP2_TO_VD2 = tri6_pn(RENA_CBD_TO_VPDn, vram_pins.PIN_30_VRAM_D02.qp_int_new());
    triwire REMO_VP3_TO_VD3 = tri6_pn(RENA_CBD_TO_VPDn, vram_pins.PIN_29_VRAM_D03.qp_int_new());
    triwire ROCE_VP4_TO_VD4 = tri6_pn(RENA_CBD_TO_VPDn, vram_pins.PIN_28_VRAM_D04.qp_int_new());
    triwire ROPU_VP5_TO_VD5 = tri6_pn(RENA_CBD_TO_VPDn, vram_pins.PIN_27_VRAM_D05.qp_int_new());
    triwire RETA_VP6_TO_VD6 = tri6_pn(RENA_CBD_TO_VPDn, vram_pins.PIN_26_VRAM_D06.qp_int_new());
    triwire RAKU_VP7_TO_VD7 = tri6_pn(RENA_CBD_TO_VPDn, vram_pins.PIN_25_VRAM_D07.qp_int_new());

    vram_bus.BUS_VRAM_D00p.tri_bus(RODY_VP0_TO_VD0);
    vram_bus.BUS_VRAM_D01p.tri_bus(REBA_VP1_TO_VD1);
    vram_bus.BUS_VRAM_D02p.tri_bus(RYDO_VP2_TO_VD2);
    vram_bus.BUS_VRAM_D03p.tri_bus(REMO_VP3_TO_VD3);
    vram_bus.BUS_VRAM_D04p.tri_bus(ROCE_VP4_TO_VD4);
    vram_bus.BUS_VRAM_D05p.tri_bus(ROPU_VP5_TO_VD5);
    vram_bus.BUS_VRAM_D06p.tri_bus(RETA_VP6_TO_VD6);
    vram_bus.BUS_VRAM_D07p.tri_bus(RAKU_VP7_TO_VD7);
  }
  ...
  {
    wire RERY_VBUS_D0n = not1(vram_bus.BUS_VRAM_D00p.out_new());
    wire RUNA_VBUS_D1n = not1(vram_bus.BUS_VRAM_D01p.out_new());
    wire RONA_VBUS_D2n = not1(vram_bus.BUS_VRAM_D02p.out_new());
    wire RUNO_VBUS_D3n = not1(vram_bus.BUS_VRAM_D03p.out_new());
    wire SANA_VBUS_D4n = not1(vram_bus.BUS_VRAM_D04p.out_new());
    wire RORO_VBUS_D5n = not1(vram_bus.BUS_VRAM_D05p.out_new());
    wire RABO_VBUS_D6n = not1(vram_bus.BUS_VRAM_D06p.out_new());
    wire SAME_VBUS_D7n = not1(vram_bus.BUS_VRAM_D07p.out_new());

    wire ROPY_RENDERINGn = not1(XYMU_RENDERINGn.qn_new());
    wire SERE_CPU_VRAM_RDp = and2(TOLE_CPU_VRAM_RDp(), ROPY_RENDERINGn);
    wire TYVY_VBD_TO_CBDn = nand2(SERE_CPU_VRAM_RDp, LEKO_CPU_RDp());
    wire SEBY_VBD_TO_CBDp = not1(TYVY_VBD_TO_CBDn);

    triwire RUGA_VD0_TO_CD0 = tri6_pn(SEBY_VBD_TO_CBDp, RERY_VBUS_D0n);
    triwire ROTA_VD1_TO_CD1 = tri6_pn(SEBY_VBD_TO_CBDp, RUNA_VBUS_D1n);
    triwire RYBU_VD2_TO_CD2 = tri6_pn(SEBY_VBD_TO_CBDp, RONA_VBUS_D2n);
    triwire RAJU_VD3_TO_CD3 = tri6_pn(SEBY_VBD_TO_CBDp, RUNO_VBUS_D3n);
    triwire TYJA_VD4_TO_CD4 = tri6_pn(SEBY_VBD_TO_CBDp, SANA_VBUS_D4n);
    triwire REXU_VD5_TO_CD5 = tri6_pn(SEBY_VBD_TO_CBDp, RORO_VBUS_D5n);
    triwire RUPY_VD6_TO_CD6 = tri6_pn(SEBY_VBD_TO_CBDp, RABO_VBUS_D6n);
    triwire TOKU_VD7_TO_CD7 = tri6_pn(SEBY_VBD_TO_CBDp, SAME_VBUS_D7n);

    new_bus.BUS_CPU_D00p.tri_bus(RUGA_VD0_TO_CD0);
    new_bus.BUS_CPU_D01p.tri_bus(ROTA_VD1_TO_CD1);
    new_bus.BUS_CPU_D02p.tri_bus(RYBU_VD2_TO_CD2);
    new_bus.BUS_CPU_D03p.tri_bus(RAJU_VD3_TO_CD3);
    new_bus.BUS_CPU_D04p.tri_bus(TYJA_VD4_TO_CD4);
    new_bus.BUS_CPU_D05p.tri_bus(REXU_VD5_TO_CD5);
    new_bus.BUS_CPU_D06p.tri_bus(RUPY_VD6_TO_CD6);
    new_bus.BUS_CPU_D07p.tri_bus(TOKU_VD7_TO_CD7);
  }
  ...
  {
    wire XONO_FLIP_X = and2(oam_temp_b.BAXO_OAM_DB5p.qp_new(), sprite_fetcher.TEXY_SFETCHINGp.out_new());
    wire PUTE_FLIP0p = mux2p(XONO_FLIP_X, vram_bus.BUS_VRAM_D07p.out_new(), vram_bus.BUS_VRAM_D00p.out_new());
    wire PELO_FLIP1p = mux2p(XONO_FLIP_X, vram_bus.BUS_VRAM_D06p.out_new(), vram_bus.BUS_VRAM_D01p.out_new());
    wire PONO_FLIP2p = mux2p(XONO_FLIP_X, vram_bus.BUS_VRAM_D05p.out_new(), vram_bus.BUS_VRAM_D02p.out_new());
    wire POBE_FLIP3p = mux2p(XONO_FLIP_X, vram_bus.BUS_VRAM_D04p.out_new(), vram_bus.BUS_VRAM_D03p.out_new());
    wire PACY_FLIP4p = mux2p(XONO_FLIP_X, vram_bus.BUS_VRAM_D03p.out_new(), vram_bus.BUS_VRAM_D04p.out_new());
    wire PUGU_FLIP5p = mux2p(XONO_FLIP_X, vram_bus.BUS_VRAM_D02p.out_new(), vram_bus.BUS_VRAM_D05p.out_new());
    wire PAWE_FLIP6p = mux2p(XONO_FLIP_X, vram_bus.BUS_VRAM_D01p.out_new(), vram_bus.BUS_VRAM_D06p.out_new());
    wire PULY_FLIP7p = mux2p(XONO_FLIP_X, vram_bus.BUS_VRAM_D00p.out_new(), vram_bus.BUS_VRAM_D07p.out_new());
