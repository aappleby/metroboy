...
void GateBoy::tock_zram_gates(const GateBoyState& reg_old) {
  ...
  if (bit(reg_old.zram_bus.clk_old.out_old() & ~reg_new.cpu_signals.TAPU_CPU_WRp.out_new() & CSp)) {
  ...
  triwire tri0 = tri_pp(CSp && bit(reg_new.cpu_signals.TEDO_CPU_RDp.out_new()), get_bit(data, 0));
  triwire tri1 = tri_pp(CSp && bit(reg_new.cpu_signals.TEDO_CPU_RDp.out_new()), get_bit(data, 1));
  triwire tri2 = tri_pp(CSp && bit(reg_new.cpu_signals.TEDO_CPU_RDp.out_new()), get_bit(data, 2));
  triwire tri3 = tri_pp(CSp && bit(reg_new.cpu_signals.TEDO_CPU_RDp.out_new()), get_bit(data, 3));
  triwire tri4 = tri_pp(CSp && bit(reg_new.cpu_signals.TEDO_CPU_RDp.out_new()), get_bit(data, 4));
  triwire tri5 = tri_pp(CSp && bit(reg_new.cpu_signals.TEDO_CPU_RDp.out_new()), get_bit(data, 5));
  triwire tri6 = tri_pp(CSp && bit(reg_new.cpu_signals.TEDO_CPU_RDp.out_new()), get_bit(data, 6));
  triwire tri7 = tri_pp(CSp && bit(reg_new.cpu_signals.TEDO_CPU_RDp.out_new()), get_bit(data, 7));
