...
TestResults test_logic_truncate() {
  ...
  b = a + 0;
  EXPECT_EQ(b, 0b11111, "Assignment after addition should compile and truncate.");
...
TestResults test_logic_slice() {
  ...
  a = 0; slice< 7, 0>(a) = 0xFF; EXPECT_EQ(0x00FF, a);
  a = 0; slice< 8, 1>(a) = 0xFF; EXPECT_EQ(0x01FE, a);
  a = 0; slice< 9, 2>(a) = 0xFF; EXPECT_EQ(0x03FC, a);
  a = 0; slice<10, 3>(a) = 0xFF; EXPECT_EQ(0x07F8, a);
  a = 0; slice<11, 4>(a) = 0xFF; EXPECT_EQ(0x0FF0, a);
  a = 0; slice<12, 5>(a) = 0xFF; EXPECT_EQ(0x0FE0, a);
  a = 0; slice<13, 6>(a) = 0xFF; EXPECT_EQ(0x0FC0, a);
  a = 0; slice<14, 7>(a) = 0xFF; EXPECT_EQ(0x0F80, a);
  a = 0; slice<15, 8>(a) = 0xFF; EXPECT_EQ(0x0F00, a);
