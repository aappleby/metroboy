...
AddressSignals AddressRegisters::sig(const CpuBus& cpu_bus) const {
  ...
  /*p08.TOLA*/ wire _TOLA_A01n = not(cpu_bus.PIN_A01);
  /*p06.SEFY*/ wire _SEFY_A02n = not(cpu_bus.PIN_A02);
  /*p07.TONA*/ wire _TONA_A08n = not(cpu_bus.PIN_A08);

  /*p22.XOLA*/ wire _XOLA_A00n = not(cpu_bus.PIN_A00);
  /*p22.XENO*/ wire _XENO_A01n = not(cpu_bus.PIN_A01);
  /*p22.XUSY*/ wire _XUSY_A02n = not(cpu_bus.PIN_A02);
  /*p22.XERA*/ wire _XERA_A03n = not(cpu_bus.PIN_A03);
  /*p10.BYKO*/ wire _BYKO_A05n = not(cpu_bus.PIN_A05);
  /*p10.AKUG*/ wire _AKUG_A06n = not(cpu_bus.PIN_A06);
  ...
  /*p07.TUNA*/ wire _TUNA_0000_FDFFp = nand(cpu_bus.PIN_A15, cpu_bus.PIN_A14, cpu_bus.PIN_A13, cpu_bus.PIN_A12, cpu_bus.PIN_A11, cpu_bus.PIN_A10, cpu_bus.PIN_A09);
  /*p06.SARE*/ wire _SARE_XX00_XX07p = nor(cpu_bus.PIN_A07, cpu_bus.PIN_A06, cpu_bus.PIN_A05, cpu_bus.PIN_A04, cpu_bus.PIN_A03);
  /*p07.SYKE*/ wire _SYKE_FF00_FFFFp = nor(_TUNA_0000_FDFFp, _TONA_A08n);
  /*p25.SYRO*/ wire _SYRO_FE00_FFFFp = not(_TUNA_0000_FDFFp);

  /*p22.XALY*/ wire _XALY_0x00xxxxp = nor(cpu_bus.PIN_A07, cpu_bus.PIN_A05, cpu_bus.PIN_A04);
  /*p22.WUTU*/ wire _WUTU_FF40_FF4Fn = nand(_SYKE_FF00_FFFFp, cpu_bus.PIN_A06, _XALY_0x00xxxxp);
  ...
  /*p03.RYFO*/ wire _RYFO_FF04_FF07p = and (cpu_bus.PIN_A02, _SARE_XX00_XX07p, _SYKE_FF00_FFFFp);
  ...
  /*p08.SORE*/ wire _SORE_0000_7FFFp = not(cpu_bus.PIN_A15);
  /*p08.TEVY*/ wire _TEVY_8000_9FFFn = or(cpu_bus.PIN_A13, cpu_bus.PIN_A14, _SORE_0000_7FFFp);
  ...
  /*p25.SOSE*/ wire _SOSE_8000_9FFFp = and (cpu_bus.PIN_A15, _TEFA_8000_9FFFp);
