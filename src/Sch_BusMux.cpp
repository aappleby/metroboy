...
void BusMux::tick(SchematicTop& gb) {

  {
    ...
    /*p28.WUKU*/ wire WUKU_OAM_A_CPU_RD = and (cpu_sig.LEKO_CPU_RDp, AMAB_OAM_LOCKn, OAM_PIN_A0);
    /*p28.GUKO*/ wire GUKO_OAM_B_CPU_RD = and (cpu_sig.LEKO_CPU_RDp, AMAB_OAM_LOCKn, WAFO_OAM_A0n);
