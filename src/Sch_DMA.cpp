...
void DmaRegisters::tock(const SchematicTop& top, CpuBus& cpu_bus) {
...

  {
    ...
    /*p04.NAVO*/ wire _NAVO_DMA_DONEn = nand6(NAKY_DMA_A00.qp(), PYRO_DMA_A01.qp(), NEFY_DMA_A02.qp(), MUTY_DMA_A03.qp(), NYKO_DMA_A04.qp(), MUGU_DMA_A07.qp()); // 128+16+8+4+2+1 = 159, this must be "dma done"
    ...
    /*p04.NAKY*/ NAKY_DMA_A00 = dff17_AB(_META_DMA_CLKp,     _LAPA_DMA_RSTn, NAKY_DMA_A00.qn());
    /*p04.PYRO*/ PYRO_DMA_A01 = dff17_AB(NAKY_DMA_A00.qn(),  _LAPA_DMA_RSTn, PYRO_DMA_A01.qn());
    /*p04.NEFY*/ NEFY_DMA_A02 = dff17_AB(PYRO_DMA_A01.qn(),  _LAPA_DMA_RSTn, NEFY_DMA_A02.qn());
    /*p04.MUTY*/ MUTY_DMA_A03 = dff17_AB(NEFY_DMA_A02.qn(),  _LAPA_DMA_RSTn, MUTY_DMA_A03.qn());
    /*p04.NYKO*/ NYKO_DMA_A04 = dff17_AB(MUTY_DMA_A03.qn(),  _LAPA_DMA_RSTn, NYKO_DMA_A04.qn());
    /*p04.PYLO*/ PYLO_DMA_A05 = dff17_AB(NYKO_DMA_A04.qn(),  _LAPA_DMA_RSTn, PYLO_DMA_A05.qn());
    /*p04.NUTO*/ NUTO_DMA_A06 = dff17_AB(PYLO_DMA_A05.qn(),  _LAPA_DMA_RSTn, NUTO_DMA_A06.qn());
    /*p04.MUGU*/ MUGU_DMA_A07 = dff17_AB(NUTO_DMA_A06.qn(),  _LAPA_DMA_RSTn, MUGU_DMA_A07.qn());
  }

  // FF46 DMA
  {
#if 0
    CPU_BUS_D0 = tribuf_6p(and(CPU_PIN_RDp FF46p), NAFA_DMA_A08.qp());
#endif
