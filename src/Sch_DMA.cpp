...
void DmaRegisters::tock(const SchematicTop& top, CpuBus& cpu_bus) {
...

  {
    ...
    /*#p04.MATU*/ _MATU_DMA_RUNNINGp = dff17_B(top.clk_reg.UVYT_ABCDxxxx(), top.clk_reg.CUNU_SYS_RSTn(), _LOKY_DMA_LATCHp.qp());
  }

  {
    ...
    /*#p04.META*/ wire _META_DMA_CLKp = and2(top.clk_reg.UVYT_ABCDxxxx(), _LOKY_DMA_LATCHp.qp());
