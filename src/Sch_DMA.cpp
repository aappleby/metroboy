...
void DmaRegisters::tock(const SchematicTop& top, CpuBus& cpu_bus) {
  ...
  /*p04.LAVY*/ wire _LAVY_FF46_WRp = and2(_XEDA_FF46p, top.CUPA_CPU_WRp_xxxxEFGx());
...

  {
    ...
    /*p04.LUPA*/ wire _LUPA_DMA_TRIG = nor2(_LAVY_FF46_WRp, _LYXE_DMA_LATCHn);
...

  {
    ...
    /*p04.META*/ wire _META_DMA_CLKp = and2(top.clk_reg.UVYT_ABCDxxxx(), _LOKY_DMA_LATCHp);
