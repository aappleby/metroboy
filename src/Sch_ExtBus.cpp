...
void ExtBus::tock(SchematicTop& top) {
  ...
  /*p07.UBET*/ wire UBET_T1p = not1(top.clk_reg._SYS_PIN_T1n.qp());
  /*p07.UVAR*/ wire UVAR_T2p = not1(top.clk_reg._SYS_PIN_T2n.qp());
  /*p07.UNOR*/ wire UNOR_MODE_DBG2p = and2(top.clk_reg._SYS_PIN_T2n.qp(), UBET_T1p);
  /*p07.UMUT*/ wire UMUT_MODE_DBG1p = and2(top.clk_reg._SYS_PIN_T1n.qp(), UVAR_T2p);
  ...
  // DMA address / CPU address latch -> ext addr pins
  {
    ...
    /*p08.AMET*/ wire _EXT_ADDR_00 = mux2_p(top.dma_reg.NAKY_DMA_A00.qp(), _ALOR_EXT_ADDR_LATCH_00.qp(), LUMA_DMA_READ_CARTp);
    /*p08.ATOL*/ wire _EXT_ADDR_01 = mux2_p(top.dma_reg.PYRO_DMA_A01.qp(), _APUR_EXT_ADDR_LATCH_01.qp(), LUMA_DMA_READ_CARTp);
    /*p08.APOK*/ wire _EXT_ADDR_02 = mux2_p(top.dma_reg.NEFY_DMA_A02.qp(), _ALYR_EXT_ADDR_LATCH_02.qp(), LUMA_DMA_READ_CARTp);
    /*p08.AMER*/ wire _EXT_ADDR_03 = mux2_p(top.dma_reg.MUTY_DMA_A03.qp(), _ARET_EXT_ADDR_LATCH_03.qp(), LUMA_DMA_READ_CARTp);
    /*p08.ATEM*/ wire _EXT_ADDR_04 = mux2_p(top.dma_reg.NYKO_DMA_A04.qp(), _AVYS_EXT_ADDR_LATCH_04.qp(), LUMA_DMA_READ_CARTp);
    /*p08.ATOV*/ wire _EXT_ADDR_05 = mux2_p(top.dma_reg.PYLO_DMA_A05.qp(), _ATEV_EXT_ADDR_LATCH_05.qp(), LUMA_DMA_READ_CARTp);
    /*p08.ATYR*/ wire _EXT_ADDR_06 = mux2_p(top.dma_reg.NUTO_DMA_A06.qp(), _AROS_EXT_ADDR_LATCH_06.qp(), LUMA_DMA_READ_CARTp);
    /*p08.ASUR*/ wire _EXT_ADDR_07 = mux2_p(top.dma_reg.MUGU_DMA_A07.qp(), _ARYM_EXT_ADDR_LATCH_07.qp(), LUMA_DMA_READ_CARTp);

    /*p08.MANO*/ wire _EXT_ADDR_08 = mux2_p(top.dma_reg.NAFA_DMA_A08.qn(), _LUNO_EXT_ADDR_LATCH_08.qp(), LUMA_DMA_READ_CARTp);
    /*p08.MASU*/ wire _EXT_ADDR_09 = mux2_p(top.dma_reg.PYNE_DMA_A09.qn(), _LYSA_EXT_ADDR_LATCH_09.qp(), LUMA_DMA_READ_CARTp);
    /*p08.PAMY*/ wire _EXT_ADDR_10 = mux2_p(top.dma_reg.PARA_DMA_A10.qn(), _PATE_EXT_ADDR_LATCH_10.qp(), LUMA_DMA_READ_CARTp);
    /*p08.MALE*/ wire _EXT_ADDR_11 = mux2_p(top.dma_reg.NYDO_DMA_A11.qn(), _LUMY_EXT_ADDR_LATCH_11.qp(), LUMA_DMA_READ_CARTp);
    /*p08.MOJY*/ wire _EXT_ADDR_12 = mux2_p(top.dma_reg.NYGY_DMA_A12.qn(), _LOBU_EXT_ADDR_LATCH_12.qp(), LUMA_DMA_READ_CARTp);
    /*p08.MUCE*/ wire _EXT_ADDR_13 = mux2_p(top.dma_reg.PULA_DMA_A13.qn(), _LONU_EXT_ADDR_LATCH_13.qp(), LUMA_DMA_READ_CARTp);
    /*p08.PEGE*/ wire _EXT_ADDR_14 = mux2_p(top.dma_reg.POKU_DMA_A14.qn(), _NYRE_EXT_ADDR_LATCH_14.qp(), LUMA_DMA_READ_CARTp);
  ...
  // Ext data in
  {
    ...
    // Ext pin -> Ext latch
    /*p08.SOMA*/ _SOMA_EXT_DATA_LATCH_00 = tp_latch_A(LAVO_EPD_TO_CBDn, EXT_PIN_D0_C.qp());
    /*p08.RONY*/ _RONY_EXT_DATA_LATCH_01 = tp_latch_A(LAVO_EPD_TO_CBDn, EXT_PIN_D1_C.qp());
    /*p08.RAXY*/ _RAXY_EXT_DATA_LATCH_02 = tp_latch_A(LAVO_EPD_TO_CBDn, EXT_PIN_D2_C.qp());
    /*p08.SELO*/ _SELO_EXT_DATA_LATCH_03 = tp_latch_A(LAVO_EPD_TO_CBDn, EXT_PIN_D3_C.qp());
    /*p08.SODY*/ _SODY_EXT_DATA_LATCH_04 = tp_latch_A(LAVO_EPD_TO_CBDn, EXT_PIN_D4_C.qp());
    /*p08.SAGO*/ _SAGO_EXT_DATA_LATCH_05 = tp_latch_A(LAVO_EPD_TO_CBDn, EXT_PIN_D5_C.qp());
    /*p08.RUPA*/ _RUPA_EXT_DATA_LATCH_06 = tp_latch_A(LAVO_EPD_TO_CBDn, EXT_PIN_D6_C.qp());
    /*p08.SAZY*/ _SAZY_EXT_DATA_LATCH_07 = tp_latch_A(LAVO_EPD_TO_CBDn, EXT_PIN_D7_C.qp());

    // Ext latch -> int bus
    /*p08.RYMA*/ top.cpu_bus.CPU_BUS_D0 = tribuf_6n(LAVO_EPD_TO_CBDn, _SOMA_EXT_DATA_LATCH_00.qp());
    /*p08.RUVO*/ top.cpu_bus.CPU_BUS_D1 = tribuf_6n(LAVO_EPD_TO_CBDn, _RONY_EXT_DATA_LATCH_01.qp());
    /*p08.RYKO*/ top.cpu_bus.CPU_BUS_D2 = tribuf_6n(LAVO_EPD_TO_CBDn, _RAXY_EXT_DATA_LATCH_02.qp());
    /*p08.TAVO*/ top.cpu_bus.CPU_BUS_D3 = tribuf_6n(LAVO_EPD_TO_CBDn, _SELO_EXT_DATA_LATCH_03.qp());
    /*p08.TEPE*/ top.cpu_bus.CPU_BUS_D4 = tribuf_6n(LAVO_EPD_TO_CBDn, _SODY_EXT_DATA_LATCH_04.qp());
    /*p08.SAFO*/ top.cpu_bus.CPU_BUS_D5 = tribuf_6n(LAVO_EPD_TO_CBDn, _SAGO_EXT_DATA_LATCH_05.qp());
    /*p08.SEVU*/ top.cpu_bus.CPU_BUS_D6 = tribuf_6n(LAVO_EPD_TO_CBDn, _RUPA_EXT_DATA_LATCH_06.qp());
    /*p08.TAJU*/ top.cpu_bus.CPU_BUS_D7 = tribuf_6n(LAVO_EPD_TO_CBDn, _SAZY_EXT_DATA_LATCH_07.qp());
  }
}
