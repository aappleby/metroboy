...
void JoypadRegisters::tick(SchematicTop& top) {
...

  {
    ...
    /*p02.AWOB*/ AWOB_WAKE_CPU.tp_latch(BOGA_AxCDEFGH, ANY_BUTTON);
...

  {
    ...
    /*p05.KEMA*/ top.CPU_TRI_D0.set_tribuf(!BYZO_FF00_RDn, KEVU_JOYP_L0.q());
    /*p05.KURO*/ top.CPU_TRI_D1.set_tribuf(!BYZO_FF00_RDn, KAPA_JOYP_L1.q());
    /*p05.KUVE*/ top.CPU_TRI_D2.set_tribuf(!BYZO_FF00_RDn, KEJA_JOYP_L2.q());
    /*p05.JEKU*/ top.CPU_TRI_D3.set_tribuf(!BYZO_FF00_RDn, KOLO_JOYP_L3.q());
    /*p05.KOCE*/ top.CPU_TRI_D4.set_tribuf(!BYZO_FF00_RDn, KELY_JOYP_UDLR.q());
    /*p05.CUDY*/ top.CPU_TRI_D5.set_tribuf(!BYZO_FF00_RDn, COFY_JOYP_ABCS.q());
    /*p??.????*/ top.CPU_TRI_D6.set_tribuf(!BYZO_FF00_RDn, KUKO_DBG_FF00_D6.q());
    /*p??.????*/ top.CPU_TRI_D7.set_tribuf(!BYZO_FF00_RDn, KERU_DBG_FF00_D7.q());
  }
