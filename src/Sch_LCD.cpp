...
void LcdRegisters::tock(const SchematicTop& top, CpuBus& cpu_bus) {
...

  {
    ...
    LCD_PIN_FR = SignalState::from_wire(_KOFO);
  }
  ...
  // LCD line strobe
  {
    ...
    LCD_PIN_CPG = SignalState::from_wire(_POGU);
  }
  ...
  // LCD LCD_PIN_CPL pin
  {
    ...
    LCD_PIN_CPL = SignalState::from_wire(_KYMO_LINE_ENDn);
  }
  ...
  // LCD vertical sync pin
  {
    ...
    LCD_PIN_S = SignalState::from_wire(_MURE_PIN_S);
  }
  ...
  // FF44 LY
  {
    ...
    /*p23.VEGA*/ cpu_bus.CPU_TRI_D0 = tribuf_6n(_VARO_FF44_RDn, not(_WURY_LY0n));
    /*p23.WUVA*/ cpu_bus.CPU_TRI_D1 = tribuf_6n(_VARO_FF44_RDn, not(_XEPO_LY1n));
    /*p23.LYCO*/ cpu_bus.CPU_TRI_D2 = tribuf_6n(_VARO_FF44_RDn, not(_MYFA_LY2n));
    /*p23.WOJY*/ cpu_bus.CPU_TRI_D3 = tribuf_6n(_VARO_FF44_RDn, not(_XUHY_LY3n));
    /*p23.VYNE*/ cpu_bus.CPU_TRI_D4 = tribuf_6n(_VARO_FF44_RDn, not(_WATA_LY4n));
    /*p23.WAMA*/ cpu_bus.CPU_TRI_D5 = tribuf_6n(_VARO_FF44_RDn, not(_XAGA_LY5n));
    /*p23.WAVO*/ cpu_bus.CPU_TRI_D6 = tribuf_6n(_VARO_FF44_RDn, not(_XUCE_LY6n));
    /*p23.WEZE*/ cpu_bus.CPU_TRI_D7 = tribuf_6n(_VARO_FF44_RDn, not(_XOWO_LY7n));
  }
  ...
  // FF45 LYC
  {
    ...
    /*p23.RETU*/ cpu_bus.CPU_TRI_D0 = tribuf_6n(_WEKU_FF45_RDn, SYRY_LYC0.q());
    /*p23.VOJO*/ cpu_bus.CPU_TRI_D1 = tribuf_6n(_WEKU_FF45_RDn, VUCE_LYC1.q());
    /*p23.RAZU*/ cpu_bus.CPU_TRI_D2 = tribuf_6n(_WEKU_FF45_RDn, SEDY_LYC2.q());
    /*p23.REDY*/ cpu_bus.CPU_TRI_D3 = tribuf_6n(_WEKU_FF45_RDn, SALO_LYC3.q());
    /*p23.RACE*/ cpu_bus.CPU_TRI_D4 = tribuf_6n(_WEKU_FF45_RDn, SOTA_LYC4.q());
    /*p23.VAZU*/ cpu_bus.CPU_TRI_D5 = tribuf_6n(_WEKU_FF45_RDn, VAFA_LYC5.q());
    /*p23.VAFE*/ cpu_bus.CPU_TRI_D6 = tribuf_6n(_WEKU_FF45_RDn, VEVO_LYC6.q());
    /*p23.PUFY*/ cpu_bus.CPU_TRI_D7 = tribuf_6n(_WEKU_FF45_RDn, RAHA_LYC7.q());
