...
void TestGB::tick_everything() {
  ...
  /*p01.AREV*/ wire AREV_CPU_WRn_ABCDxxxH = nand(cpu_pins.CPU_RAW_WR, AFAS_xxxxxFGH);
  ...
  //----------------------------------------
  // sch_joypad
  [this, BOGA_AxCDEFGH, ALUR_RSTn, TEDO_BUS_RD, TAPU_BUS_WR_ABCDxxxH, ADDR_111111110xx00000] {
