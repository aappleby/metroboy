...
private:
  ...
  /*p31.XYKY*/ TpLatch XYKY_LATCH_OAM_DA0;
  /*p31.YRUM*/ TpLatch YRUM_LATCH_OAM_DA1;
  /*p31.YSEX*/ TpLatch YSEX_LATCH_OAM_DA2;
  /*p31.YVEL*/ TpLatch YVEL_LATCH_OAM_DA3;
  /*p31.WYNO*/ TpLatch WYNO_LATCH_OAM_DA4;
  /*p31.CYRA*/ TpLatch CYRA_LATCH_OAM_DA5;
  /*p31.ZUVE*/ TpLatch ZUVE_LATCH_OAM_DA6;
  /*p31.ECED*/ TpLatch ECED_LATCH_OAM_DA7;

  /*p29.YDYV*/ TpLatch YDYV_LATCH_OAM_DB0;
  /*p29.YCEB*/ TpLatch YCEB_LATCH_OAM_DB1;
  /*p29.ZUCA*/ TpLatch ZUCA_LATCH_OAM_DB2;
  /*p29.WONE*/ TpLatch WONE_LATCH_OAM_DB3;
  /*p29.ZAXE*/ TpLatch ZAXE_LATCH_OAM_DB4;
  /*p29.XAFU*/ TpLatch XAFU_LATCH_OAM_DB5;
  /*p29.YSES*/ TpLatch YSES_LATCH_OAM_DB6;
  /*p29.ZECA*/ TpLatch ZECA_LATCH_OAM_DB7;
