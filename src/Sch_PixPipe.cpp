...
void PixelPipe::tock(const SchematicTop& top, CpuBus& cpu_bus) {
...

  {
    ...
    /*p21.XEHO*/ XEHO_X0.set(_SACU_CLKPIPEp, _TADY_LINE_START_RST, XEHO_X0.qn());
    /*p21.SAVY*/ SAVY_X1.set(_SACU_CLKPIPEp, _TADY_LINE_START_RST, _RYBO);
    /*p21.XODU*/ XODU_X2.set(_SACU_CLKPIPEp, _TADY_LINE_START_RST, _XEGY);
    /*p21.XYDO*/ XYDO_X3.set(_SACU_CLKPIPEp, _TADY_LINE_START_RST, _XORA);
...

  {
    ...
    /*p27.PYCO*/ _PYCO_WX_MATCH_A.set(_ROCO_CLKPIPEp, top.clk_reg.XAPO_VID_RSTn(), _NUKO_WX_MATCHp);
    /*p27.NUNU*/ _NUNU_WX_MATCH_B.set(top.clk_reg.MEHE_AxCxExGx(), top.clk_reg.XAPO_VID_RSTn(), _PYCO_WX_MATCH_A.q());
    ...
    /*p27.NOPA*/ _NOPA_WIN_MODE_B.set(top.clk_reg.ALET_xBxDxFxH(), top.clk_reg.XAPO_VID_RSTn(), _PYNU_WIN_MODE_A.q());
  }

  {
    ...
    /*p27.RYFA*/ _RYFA_WX_MATCHn_A.set(_SEGU_CLKPIPEn, XYMU_RENDERINGp(), _PANY_WX_MATCHn);
    /*p27.RENE*/ _RENE_WX_MATCHn_B.set(top.clk_reg.ALET_xBxDxFxH(), XYMU_RENDERINGp(), _RYFA_WX_MATCHn_A.q());
  }

  {
    /*p27.REPU*/ wire _REPU_VBLANK_RSTp = or(top.lcd_reg.PARU_VBLANKp_d4(), top.clk_reg.PYRY_VID_RSTp());
    /*p27.SARY*/ _SARY_WY_MATCH.set(top.clk_reg.TALU_ABCDxxxx(), top.clk_reg.XAPO_VID_RSTn(), _ROGE_WY_MATCHp);
...

  {
    ...
    /*p27.SOVY*/ _SOVY_WIN_FIRST_TILE_B.set(top.clk_reg.ALET_xBxDxFxH(), top.clk_reg.XAPO_VID_RSTn(), _RYDY_WIN_FIRST_TILE_A.q());
  }
...

  {
    ...
    /*p32.MYDE*/ BG_PIPE_A0.set(_SACU_CLKPIPEp, BG_PIPE_A_SET0, BG_PIPE_A_RST0, GND);
    /*p32.NOZO*/ BG_PIPE_A1.set(_SACU_CLKPIPEp, BG_PIPE_A_SET1, BG_PIPE_A_RST1, BG_PIPE_A0.q());
    /*p32.MOJU*/ BG_PIPE_A2.set(_SACU_CLKPIPEp, BG_PIPE_A_SET2, BG_PIPE_A_RST2, BG_PIPE_A1.q());
    /*p32.MACU*/ BG_PIPE_A3.set(_SACU_CLKPIPEp, BG_PIPE_A_SET3, BG_PIPE_A_RST3, BG_PIPE_A2.q());
    /*p32.NEPO*/ BG_PIPE_A4.set(_SACU_CLKPIPEp, BG_PIPE_A_SET4, BG_PIPE_A_RST4, BG_PIPE_A3.q());
    /*p32.MODU*/ BG_PIPE_A5.set(_SACU_CLKPIPEp, BG_PIPE_A_SET5, BG_PIPE_A_RST5, BG_PIPE_A4.q());
    /*p32.NEDA*/ BG_PIPE_A6.set(_SACU_CLKPIPEp, BG_PIPE_A_SET6, BG_PIPE_A_RST6, BG_PIPE_A5.q());
    /*p32.PYBO*/ BG_PIPE_A7.set(_SACU_CLKPIPEp, BG_PIPE_A_SET7, BG_PIPE_A_RST7, BG_PIPE_A6.q());
  }

  {
    ...
    /*p32.TOMY*/ BG_PIPE_B0.set(_SACU_CLKPIPEp, BG_PIPE_B_SET0, BG_PIPE_B_RST0, GND);
    /*p32.TACA*/ BG_PIPE_B1.set(_SACU_CLKPIPEp, BG_PIPE_B_SET1, BG_PIPE_B_RST1, BG_PIPE_B0.q());
    /*p32.SADY*/ BG_PIPE_B2.set(_SACU_CLKPIPEp, BG_PIPE_B_SET2, BG_PIPE_B_RST2, BG_PIPE_B1.q());
    /*p32.RYSA*/ BG_PIPE_B3.set(_SACU_CLKPIPEp, BG_PIPE_B_SET3, BG_PIPE_B_RST3, BG_PIPE_B2.q());
    /*p32.SOBO*/ BG_PIPE_B4.set(_SACU_CLKPIPEp, BG_PIPE_B_SET4, BG_PIPE_B_RST4, BG_PIPE_B3.q());
    /*p32.SETU*/ BG_PIPE_B5.set(_SACU_CLKPIPEp, BG_PIPE_B_SET5, BG_PIPE_B_RST5, BG_PIPE_B4.q());
    /*p32.RALU*/ BG_PIPE_B6.set(_SACU_CLKPIPEp, BG_PIPE_B_SET6, BG_PIPE_B_RST6, BG_PIPE_B5.q());
    /*p32.SOHU*/ BG_PIPE_B7.set(_SACU_CLKPIPEp, BG_PIPE_B_SET7, BG_PIPE_B_RST7, BG_PIPE_B6.q());
  }
...

  {
    ...
    // Sprite pipe A
    {
      ...
      /*p33.NYLU*/ SPR_PIPE_A0.set(_SACU_CLKPIPEp, SPR_PIX_A_SET0, SPR_PIX_A_RST0, GND);
      /*p33.PEFU*/ SPR_PIPE_A1.set(_SACU_CLKPIPEp, SPR_PIX_A_SET1, SPR_PIX_A_RST1, SPR_PIPE_A0.q());
      /*p33.NATY*/ SPR_PIPE_A2.set(_SACU_CLKPIPEp, SPR_PIX_A_SET2, SPR_PIX_A_RST2, SPR_PIPE_A1.q());
      /*p33.PYJO*/ SPR_PIPE_A3.set(_SACU_CLKPIPEp, SPR_PIX_A_SET3, SPR_PIX_A_RST3, SPR_PIPE_A2.q());
      /*p33.VARE*/ SPR_PIPE_A4.set(_SACU_CLKPIPEp, SPR_PIX_A_SET4, SPR_PIX_A_RST4, SPR_PIPE_A3.q());
      /*p33.WEBA*/ SPR_PIPE_A5.set(_SACU_CLKPIPEp, SPR_PIX_A_SET5, SPR_PIX_A_RST5, SPR_PIPE_A4.q());
      /*p33.VANU*/ SPR_PIPE_A6.set(_SACU_CLKPIPEp, SPR_PIX_A_SET6, SPR_PIX_A_RST6, SPR_PIPE_A5.q());
      /*p33.VUPY*/ SPR_PIPE_A7.set(_SACU_CLKPIPEp, SPR_PIX_A_SET7, SPR_PIX_A_RST7, SPR_PIPE_A6.q());
    }
    ...
    // Sprite pipe B
    {
      ...
      /*p33.NURO*/ SPR_PIPE_B0.set(_SACU_CLKPIPEp, SPR_PIX_B_SET0, SPR_PIX_B_RST0, GND);
      /*p33.MASO*/ SPR_PIPE_B1.set(_SACU_CLKPIPEp, SPR_PIX_B_SET1, SPR_PIX_B_RST1, SPR_PIPE_B0.q());
      /*p33.LEFE*/ SPR_PIPE_B2.set(_SACU_CLKPIPEp, SPR_PIX_B_SET2, SPR_PIX_B_RST2, SPR_PIPE_B1.q());
      /*p33.LESU*/ SPR_PIPE_B3.set(_SACU_CLKPIPEp, SPR_PIX_B_SET3, SPR_PIX_B_RST3, SPR_PIPE_B2.q());
      /*p33.WYHO*/ SPR_PIPE_B4.set(_SACU_CLKPIPEp, SPR_PIX_B_SET4, SPR_PIX_B_RST4, SPR_PIPE_B3.q());
      /*p33.WORA*/ SPR_PIPE_B5.set(_SACU_CLKPIPEp, SPR_PIX_B_SET5, SPR_PIX_B_RST5, SPR_PIPE_B4.q());
      /*p33.VAFO*/ SPR_PIPE_B6.set(_SACU_CLKPIPEp, SPR_PIX_B_SET6, SPR_PIX_B_RST6, SPR_PIPE_B5.q());
      /*p33.WUFY*/ SPR_PIPE_B7.set(_SACU_CLKPIPEp, SPR_PIX_B_SET7, SPR_PIX_B_RST7, SPR_PIPE_B6.q());
    }
    ...
    // Palette pipe
    {
      ...
      /*p34.RUGO*/ PAL_PIPE_0.set(_SACU_CLKPIPEp, _PUME_PAL_PIPE_SET0n, _SUCO_PAL_PIPE_RST0n, GND);
      /*p34.SATA*/ PAL_PIPE_1.set(_SACU_CLKPIPEp, _SORO_PAL_PIPE_SET1n, _TAFA_PAL_PIPE_RST1n, PAL_PIPE_0.q());
      /*p34.ROSA*/ PAL_PIPE_2.set(_SACU_CLKPIPEp, _PAMO_PAL_PIPE_SET2n, _PYZY_PAL_PIPE_RST2n, PAL_PIPE_1.q());
      /*p34.SOMY*/ PAL_PIPE_3.set(_SACU_CLKPIPEp, _SUKY_PAL_PIPE_SET3n, _TOWA_PAL_PIPE_RST3n, PAL_PIPE_2.q());
      /*p34.PALU*/ PAL_PIPE_4.set(_SACU_CLKPIPEp, _RORA_PAL_PIPE_SET4n, _RUDU_PAL_PIPE_RST4n, PAL_PIPE_3.q());
      /*p34.NUKE*/ PAL_PIPE_5.set(_SACU_CLKPIPEp, _MENE_PAL_PIPE_SET5n, _PAZO_PAL_PIPE_RST5n, PAL_PIPE_4.q());
      /*p34.MODA*/ PAL_PIPE_6.set(_SACU_CLKPIPEp, _LUKE_PAL_PIPE_SET6n, _LOWA_PAL_PIPE_RST6n, PAL_PIPE_5.q());
      /*p34.LYME*/ PAL_PIPE_7.set(_SACU_CLKPIPEp, _LAMY_PAL_PIPE_SET7n, _LUNU_PAL_PIPE_RST7n, PAL_PIPE_6.q());
    }
    ...
    // Background mask pipe
    {
      ...
      /*p26.VEZO*/ MASK_PIPE_0.set(_SACU_CLKPIPEp, _TEDE_MASK_PIPE_SET0, _WOKA_MASK_PIPE_RST0, GND);
      /*p26.WURU*/ MASK_PIPE_1.set(_SACU_CLKPIPEp, _XALA_MASK_PIPE_SET1, _WEDE_MASK_PIPE_RST1, MASK_PIPE_0.q());
      /*p26.VOSA*/ MASK_PIPE_2.set(_SACU_CLKPIPEp, _TYRA_MASK_PIPE_SET2, _TUFO_MASK_PIPE_RST2, MASK_PIPE_1.q());
      /*p26.WYFU*/ MASK_PIPE_3.set(_SACU_CLKPIPEp, _XYRU_MASK_PIPE_SET3, _WEVO_MASK_PIPE_RST3, MASK_PIPE_2.q());
      /*p26.XETE*/ MASK_PIPE_4.set(_SACU_CLKPIPEp, _XUKU_MASK_PIPE_SET4, _WEDY_MASK_PIPE_RST4, MASK_PIPE_3.q());
      /*p26.WODA*/ MASK_PIPE_5.set(_SACU_CLKPIPEp, _XELY_MASK_PIPE_SET5, _WUJA_MASK_PIPE_RST5, MASK_PIPE_4.q());
      /*p26.VUMO*/ MASK_PIPE_6.set(_SACU_CLKPIPEp, _TYKO_MASK_PIPE_SET6, _TENA_MASK_PIPE_RST6, MASK_PIPE_5.q());
      /*p26.VAVA*/ MASK_PIPE_7.set(_SACU_CLKPIPEp, _TUWU_MASK_PIPE_SET7, _WUBU_MASK_PIPE_RST7, MASK_PIPE_6.q());
    }
  }
...

  {
    ...
    LCD_PIN_LD0.set(not(_REMY_LD0n));
    LCD_PIN_LD1.set(not(_RAVO_LD1n));
  }
...

  {
    ...
    /*p21.ROXE*/ _ROXE_INT_HBL_EN.set(_RYVE_FF41_WRn, !_RYVE_FF41_WRn, top.clk_reg.WESY_SYS_RSTn(), cpu_bus.CPU_TRI_D0.q());
    /*p21.RUFO*/ _RUFO_INT_VBL_EN.set(_RYVE_FF41_WRn, !_RYVE_FF41_WRn, top.clk_reg.WESY_SYS_RSTn(), cpu_bus.CPU_TRI_D1.q());
    /*p21.REFE*/ _REFE_INT_OAM_EN.set(_RYVE_FF41_WRn, !_RYVE_FF41_WRn, top.clk_reg.WESY_SYS_RSTn(), cpu_bus.CPU_TRI_D2.q());
    /*p21.RUGU*/ _RUGU_INT_LYC_EN.set(_RYVE_FF41_WRn, !_RYVE_FF41_WRn, top.clk_reg.WESY_SYS_RSTn(), cpu_bus.CPU_TRI_D3.q());
...

  {
    ...
    /*p36.PAVO*/ PAVO_BGP0.set(_TEPO_FF47_WRn, !_TEPO_FF47_WRn, top.cpu_bus.CPU_TRI_D0.q());
    /*p36.NUSY*/ NUSY_BGP1.set(_TEPO_FF47_WRn, !_TEPO_FF47_WRn, top.cpu_bus.CPU_TRI_D1.q());
    /*p36.PYLU*/ PYLU_BGP2.set(_TEPO_FF47_WRn, !_TEPO_FF47_WRn, top.cpu_bus.CPU_TRI_D2.q());
    /*p36.MAXY*/ MAXY_BGP3.set(_TEPO_FF47_WRn, !_TEPO_FF47_WRn, top.cpu_bus.CPU_TRI_D3.q());
    /*p36.MUKE*/ MUKE_BGP4.set(_TEPO_FF47_WRn, !_TEPO_FF47_WRn, top.cpu_bus.CPU_TRI_D4.q());
    /*p36.MORU*/ MORU_BGP5.set(_TEPO_FF47_WRn, !_TEPO_FF47_WRn, top.cpu_bus.CPU_TRI_D5.q());
    /*p36.MOGY*/ MOGY_BGP6.set(_TEPO_FF47_WRn, !_TEPO_FF47_WRn, top.cpu_bus.CPU_TRI_D6.q());
    /*p36.MENA*/ MENA_BGP7.set(_TEPO_FF47_WRn, !_TEPO_FF47_WRn, top.cpu_bus.CPU_TRI_D7.q());

    /*p36.VUSO*/ wire _VUSO_FF47_RD = and (top.ASOT_CPU_RDp(), _WERA_FF47);
    /*p36.TEPY*/ wire _TEPY_FF47_RDn = not(_VUSO_FF47_RD);

    /*p36.RARO*/ cpu_bus.CPU_TRI_D0.set_tribuf_6n(_TEPY_FF47_RDn, PAVO_BGP0.q());
    /*p36.PABA*/ cpu_bus.CPU_TRI_D1.set_tribuf_6n(_TEPY_FF47_RDn, NUSY_BGP1.q());
    /*p36.REDO*/ cpu_bus.CPU_TRI_D2.set_tribuf_6n(_TEPY_FF47_RDn, PYLU_BGP2.q());
    /*p36.LOBE*/ cpu_bus.CPU_TRI_D3.set_tribuf_6n(_TEPY_FF47_RDn, MAXY_BGP3.q());
    /*p36.LACE*/ cpu_bus.CPU_TRI_D4.set_tribuf_6n(_TEPY_FF47_RDn, MUKE_BGP4.q());
    /*p36.LYKA*/ cpu_bus.CPU_TRI_D5.set_tribuf_6n(_TEPY_FF47_RDn, MORU_BGP5.q());
    /*p36.LODY*/ cpu_bus.CPU_TRI_D6.set_tribuf_6n(_TEPY_FF47_RDn, MOGY_BGP6.q());
    /*p36.LARY*/ cpu_bus.CPU_TRI_D7.set_tribuf_6n(_TEPY_FF47_RDn, MENA_BGP7.q());
  }
...

  {
    ...
    /*p36.XUFU*/ OBP00.set(_XELO_FF48_WRn, !_XELO_FF48_WRn, top.cpu_bus.CPU_TRI_D0.q());
    /*p36.XUKY*/ OBP01.set(_XELO_FF48_WRn, !_XELO_FF48_WRn, top.cpu_bus.CPU_TRI_D1.q());
    /*p36.XOVA*/ OBP02.set(_XELO_FF48_WRn, !_XELO_FF48_WRn, top.cpu_bus.CPU_TRI_D2.q());
    /*p36.XALO*/ OBP03.set(_XELO_FF48_WRn, !_XELO_FF48_WRn, top.cpu_bus.CPU_TRI_D3.q());
    /*p36.XERU*/ OBP04.set(_XELO_FF48_WRn, !_XELO_FF48_WRn, top.cpu_bus.CPU_TRI_D4.q());
    /*p36.XYZE*/ OBP05.set(_XELO_FF48_WRn, !_XELO_FF48_WRn, top.cpu_bus.CPU_TRI_D5.q());
    /*p36.XUPO*/ OBP06.set(_XELO_FF48_WRn, !_XELO_FF48_WRn, top.cpu_bus.CPU_TRI_D6.q());
    /*p36.XANA*/ OBP07.set(_XELO_FF48_WRn, !_XELO_FF48_WRn, top.cpu_bus.CPU_TRI_D7.q());

    /*p36.XUFY*/ wire _XUFY_FF48_RD = and (top.ASOT_CPU_RDp(), _XAYO_FF48);
    /*p36.XOZY*/ wire _XOZY_FF48_RDn = not(_XUFY_FF48_RD);

    /*p36.XARY*/ cpu_bus.CPU_TRI_D0.set_tribuf_6n(_XOZY_FF48_RDn, OBP00.q());
    /*p36.XOKE*/ cpu_bus.CPU_TRI_D1.set_tribuf_6n(_XOZY_FF48_RDn, OBP01.q());
    /*p36.XUNO*/ cpu_bus.CPU_TRI_D2.set_tribuf_6n(_XOZY_FF48_RDn, OBP02.q());
    /*p36.XUBY*/ cpu_bus.CPU_TRI_D3.set_tribuf_6n(_XOZY_FF48_RDn, OBP03.q());
    /*p36.XAJU*/ cpu_bus.CPU_TRI_D4.set_tribuf_6n(_XOZY_FF48_RDn, OBP04.q());
    /*p36.XOBO*/ cpu_bus.CPU_TRI_D5.set_tribuf_6n(_XOZY_FF48_RDn, OBP05.q());
    /*p36.XAXA*/ cpu_bus.CPU_TRI_D6.set_tribuf_6n(_XOZY_FF48_RDn, OBP06.q());
    /*p36.XAWO*/ cpu_bus.CPU_TRI_D7.set_tribuf_6n(_XOZY_FF48_RDn, OBP07.q());
  }
...

  {
    ...
    /*p36.MOXY*/ OBP10.set(_LEHO_FF49_WRn, !_LEHO_FF49_WRn, top.cpu_bus.CPU_TRI_D0.q());
    /*p36.LAWO*/ OBP11.set(_LEHO_FF49_WRn, !_LEHO_FF49_WRn, top.cpu_bus.CPU_TRI_D1.q());
    /*p36.MOSA*/ OBP12.set(_LEHO_FF49_WRn, !_LEHO_FF49_WRn, top.cpu_bus.CPU_TRI_D2.q());
    /*p36.LOSE*/ OBP13.set(_LEHO_FF49_WRn, !_LEHO_FF49_WRn, top.cpu_bus.CPU_TRI_D3.q());
    /*p36.LUNE*/ OBP14.set(_LEHO_FF49_WRn, !_LEHO_FF49_WRn, top.cpu_bus.CPU_TRI_D4.q());
    /*p36.LUGU*/ OBP15.set(_LEHO_FF49_WRn, !_LEHO_FF49_WRn, top.cpu_bus.CPU_TRI_D5.q());
    /*p36.LEPU*/ OBP16.set(_LEHO_FF49_WRn, !_LEHO_FF49_WRn, top.cpu_bus.CPU_TRI_D6.q());
    /*p36.LUXO*/ OBP17.set(_LEHO_FF49_WRn, !_LEHO_FF49_WRn, top.cpu_bus.CPU_TRI_D7.q());

    /*p36.MUMY*/ wire _MUMY_FF49_RD = and (top.ASOT_CPU_RDp(), _TEGO_FF49);
    /*p36.LOTE*/ wire _LOTE_FF49_RDn = not(_MUMY_FF49_RD);

    /*p36.LAJU*/ cpu_bus.CPU_TRI_D0.set_tribuf_6n(_LOTE_FF49_RDn, OBP10.q());
    /*p36.LEPA*/ cpu_bus.CPU_TRI_D1.set_tribuf_6n(_LOTE_FF49_RDn, OBP11.q());
    /*p36.LODE*/ cpu_bus.CPU_TRI_D2.set_tribuf_6n(_LOTE_FF49_RDn, OBP12.q());
    /*p36.LYZA*/ cpu_bus.CPU_TRI_D3.set_tribuf_6n(_LOTE_FF49_RDn, OBP13.q());
    /*p36.LUKY*/ cpu_bus.CPU_TRI_D4.set_tribuf_6n(_LOTE_FF49_RDn, OBP14.q());
    /*p36.LUGA*/ cpu_bus.CPU_TRI_D5.set_tribuf_6n(_LOTE_FF49_RDn, OBP15.q());
    /*p36.LEBA*/ cpu_bus.CPU_TRI_D6.set_tribuf_6n(_LOTE_FF49_RDn, OBP16.q());
    /*p36.LELU*/ cpu_bus.CPU_TRI_D7.set_tribuf_6n(_LOTE_FF49_RDn, OBP17.q());
  }
...

  {
    ...
    /*p23.NESO*/ _NESO_WY0.set(_VEFU_FF4A_WRn, !_VEFU_FF4A_WRn, top.clk_reg.WALU_SYS_RSTn(), top.cpu_bus.CPU_TRI_D0.q());
    /*p23.NYRO*/ _NYRO_WY1.set(_VEFU_FF4A_WRn, !_VEFU_FF4A_WRn, top.clk_reg.WALU_SYS_RSTn(), top.cpu_bus.CPU_TRI_D1.q());
    /*p23.NAGA*/ _NAGA_WY2.set(_VEFU_FF4A_WRn, !_VEFU_FF4A_WRn, top.clk_reg.WALU_SYS_RSTn(), top.cpu_bus.CPU_TRI_D2.q());
    /*p23.MELA*/ _MELA_WY3.set(_VEFU_FF4A_WRn, !_VEFU_FF4A_WRn, top.clk_reg.WALU_SYS_RSTn(), top.cpu_bus.CPU_TRI_D3.q());
    /*p23.NULO*/ _NULO_WY4.set(_VEFU_FF4A_WRn, !_VEFU_FF4A_WRn, top.clk_reg.WALU_SYS_RSTn(), top.cpu_bus.CPU_TRI_D4.q());
    /*p23.NENE*/ _NENE_WY5.set(_VEFU_FF4A_WRn, !_VEFU_FF4A_WRn, top.clk_reg.WALU_SYS_RSTn(), top.cpu_bus.CPU_TRI_D5.q());
    /*p23.NUKA*/ _NUKA_WY6.set(_VEFU_FF4A_WRn, !_VEFU_FF4A_WRn, top.clk_reg.WALU_SYS_RSTn(), top.cpu_bus.CPU_TRI_D6.q());
    /*p23.NAFU*/ _NAFU_WY7.set(_VEFU_FF4A_WRn, !_VEFU_FF4A_WRn, top.clk_reg.WALU_SYS_RSTn(), top.cpu_bus.CPU_TRI_D7.q());
...

  {
    ...
    /*p23.MYPA*/ _MYPA_WX0.set(_VOXU_FF4B_WRn, !_VOXU_FF4B_WRn, top.clk_reg.WALU_SYS_RSTn(), top.cpu_bus.CPU_TRI_D0.q());
    /*p23.NOFE*/ _NOFE_WX1.set(_VOXU_FF4B_WRn, !_VOXU_FF4B_WRn, top.clk_reg.WALU_SYS_RSTn(), top.cpu_bus.CPU_TRI_D1.q());
    /*p23.NOKE*/ _NOKE_WX2.set(_VOXU_FF4B_WRn, !_VOXU_FF4B_WRn, top.clk_reg.WALU_SYS_RSTn(), top.cpu_bus.CPU_TRI_D2.q());
    /*p23.MEBY*/ _MEBY_WX3.set(_VOXU_FF4B_WRn, !_VOXU_FF4B_WRn, top.clk_reg.WALU_SYS_RSTn(), top.cpu_bus.CPU_TRI_D3.q());
    /*p23.MYPU*/ _MYPU_WX4.set(_VOXU_FF4B_WRn, !_VOXU_FF4B_WRn, top.clk_reg.WALU_SYS_RSTn(), top.cpu_bus.CPU_TRI_D4.q());
    /*p23.MYCE*/ _MYCE_WX5.set(_VOXU_FF4B_WRn, !_VOXU_FF4B_WRn, top.clk_reg.WALU_SYS_RSTn(), top.cpu_bus.CPU_TRI_D5.q());
    /*p23.MUVO*/ _MUVO_WX6.set(_VOXU_FF4B_WRn, !_VOXU_FF4B_WRn, top.clk_reg.WALU_SYS_RSTn(), top.cpu_bus.CPU_TRI_D6.q());
    /*p23.NUKU*/ _NUKU_WX7.set(_VOXU_FF4B_WRn, !_VOXU_FF4B_WRn, top.clk_reg.WALU_SYS_RSTn(), top.cpu_bus.CPU_TRI_D7.q());
