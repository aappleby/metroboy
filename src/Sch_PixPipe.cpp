...
void PixelPipe::tock(const SchematicTop& top, CpuBus& cpu_bus) {
  ...
  {
    /*p35.RAJY*/ wire _PIX_BG0  = and(top.ppu_reg.VYXE_LCDC_BGEN.q(), BG_PIPE_A7.q());
    /*p35.TADE*/ wire _PIX_BG1  = and(top.ppu_reg.VYXE_LCDC_BGEN.q(), BG_PIPE_B7.q());

    /*p35.WOXA*/ wire _PIX_SP0  = and(top.ppu_reg.XYLO_LCDC_SPEN.q(), SPR_PIPE_A7.q());
    /*p35.XULA*/ wire _PIX_SP1  = and(top.ppu_reg.XYLO_LCDC_SPEN.q(), SPR_PIPE_B7.q());
...

  {
    ...
    /*p32.MYDE*/ BG_PIPE_A0.set(top.SACU_CLKPIPEp(), BG_PIPE_A_SET0, BG_PIPE_A_RST0, GND);
...

  {
    ...
    /*p32.TOMY*/ BG_PIPE_B0.set(top.SACU_CLKPIPEp(), BG_PIPE_B_SET0, BG_PIPE_B_RST0, GND);
...

  {
    ...
    // Sprite pipe A
    {
      ...
      /*p33.NYLU*/ SPR_PIPE_A0.set(top.SACU_CLKPIPEp(), SPR_PIX_A_SET0, SPR_PIX_A_RST0, GND);
    ...
    // Sprite pipe B
    {
      ...
      /*p33.NURO*/ SPR_PIPE_B0.set(top.SACU_CLKPIPEp(), SPR_PIX_B_SET0, SPR_PIX_B_RST0, GND);
    ...
    // Palette pipe
    {
      ...
      /*p34.RUGO*/ PAL_PIPE_0.set(top.SACU_CLKPIPEp(), _PUME_PAL_PIPE_SET0n, _SUCO_PAL_PIPE_RST0n, GND);
    ...
    // Background mask pipe
    {
      ...
      /*p26.VEZO*/ MASK_PIPE_0.set(top.SACU_CLKPIPEp(), _TEDE_MASK_PIPE_SET0, _WOKA_MASK_PIPE_RST0, GND);
...
uint8_t bg_pix_a() { return (uint8_t)pack(LEGU_TILE_DA0.q(), NUDU_TILE_DA1.q(), MUKU_TILE_DA2.q(), LUZO_TILE_DA3.q(), MEGU_TILE_DA4.q(), MYJY_TILE_DA5.q(), NASA_TILE_DA6.q(), NEFO_TILE_DA7.q()); }
uint8_t bg_pix_b() { return (uint8_t)pack(RAWU_TILE_DB0.q(), POZO_TILE_DB1.q(), PYZO_TILE_DB2.q(), POXA_TILE_DB3.q(), PULO_TILE_DB4.q(), POJU_TILE_DB5.q(), POWY_TILE_DB6.q(), PYJU_TILE_DB7.q()); }
