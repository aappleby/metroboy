...
//private:
  ...
  /*p33.NURO*/ Reg NURO_SPR_PIPE_B0 = REG_D0C0;
  /*p33.MASO*/ Reg MASO_SPR_PIPE_B1 = REG_D0C0;
  /*p33.LEFE*/ Reg LEFE_SPR_PIPE_B2 = REG_D0C0;
  /*p33.LESU*/ Reg LESU_SPR_PIPE_B3 = REG_D0C0;
  /*p33.WYHO*/ Reg WYHO_SPR_PIPE_B4 = REG_D0C0;
  /*p33.WORA*/ Reg WORA_SPR_PIPE_B5 = REG_D0C0;
  /*p33.VAFO*/ Reg VAFO_SPR_PIPE_B6 = REG_D0C0;
  /*p33.WUFY*/ Reg WUFY_SPR_PIPE_B7 = REG_D0C0;

  /*p33.NYLU*/ Reg NYLU_SPR_PIPE_A0 = REG_D0C0;
  /*p33.PEFU*/ Reg PEFU_SPR_PIPE_A1 = REG_D0C0;
  /*p33.NATY*/ Reg NATY_SPR_PIPE_A2 = REG_D0C0;
  /*p33.PYJO*/ Reg PYJO_SPR_PIPE_A3 = REG_D0C0;
  /*p33.VARE*/ Reg VARE_SPR_PIPE_A4 = REG_D0C0;
  /*p33.WEBA*/ Reg WEBA_SPR_PIPE_A5 = REG_D0C0;
  /*p33.VANU*/ Reg VANU_SPR_PIPE_A6 = REG_D0C0;
  /*p33.VUPY*/ Reg VUPY_SPR_PIPE_A7 = REG_D0C0;
