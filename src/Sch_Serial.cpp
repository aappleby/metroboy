...
void SerialRegisters::tock(const SchematicTop& top, CpuBus& cpu_bus) {
  ...
  /*p06.URYS*/ wire _FF01_WRn_xxxxxFGH = nand4(top.TAPU_CPU_WRp_xxxxEFGx(), _ADDR_FF00_FF03, cpu_bus.CPU_BUS_A00, cpu_bus.TOLA_A01n());
  /*p06.UWAM*/ wire _FF02_WRn_xxxxxFGH = nand4(top.TAPU_CPU_WRp_xxxxEFGx(), _ADDR_FF00_FF03, cpu_bus.TOVY_A00n(), cpu_bus.CPU_BUS_A01);
  /*p06.UFEG*/ wire _FF01_RD = and4(top.TEDO_CPU_RDp(), _ADDR_FF00_FF03, cpu_bus.CPU_BUS_A00, cpu_bus.TOLA_A01n());
  /*p06.UCOM*/ wire _FF02_RD = and4(top.TEDO_CPU_RDp(), _ADDR_FF00_FF03, cpu_bus.TOVY_A00n(), cpu_bus.CPU_BUS_A01);
  ...
  /*p06.CUFU*/ wire _SER_DATA0_SETn = nand2(cpu_bus.CPU_BUS_D0, _FF01_WRp_xxxxxFGH);
  /*p06.DOCU*/ wire _SER_DATA1_SETn = nand2(cpu_bus.CPU_BUS_D1, _FF01_WRp_xxxxxFGH);
  /*p06.DELA*/ wire _SER_DATA2_SETn = nand2(cpu_bus.CPU_BUS_D2, _FF01_WRp_xxxxxFGH);
  /*p06.DYGE*/ wire _SER_DATA3_SETn = nand2(cpu_bus.CPU_BUS_D3, _FF01_WRp_xxxxxFGH);
  /*p06.DOLA*/ wire _SER_DATA4_SETn = nand2(cpu_bus.CPU_BUS_D4, _FF01_WRp_xxxxxFGH);
  /*p06.ELOK*/ wire _SER_DATA5_SETn = nand2(cpu_bus.CPU_BUS_D5, _FF01_WRp_xxxxxFGH);
  /*p06.EDEL*/ wire _SER_DATA6_SETn = nand2(cpu_bus.CPU_BUS_D6, _FF01_WRp_xxxxxFGH);
  /*p06.EFEF*/ wire _SER_DATA7_SETn = nand2(cpu_bus.CPU_BUS_D7, _FF01_WRp_xxxxxFGH);
  ...
  /*p06.COHY*/ wire _SER_DATA0_RSTn = or2(and2(_FF01_WRn_xxxxxFGH, cpu_bus.CPU_BUS_D0), top.clk_reg.ALUR_SYS_RSTn());
  /*p06.DUMO*/ wire _SER_DATA1_RSTn = or2(and2(_FF01_WRn_xxxxxFGH, cpu_bus.CPU_BUS_D1), top.clk_reg.ALUR_SYS_RSTn());
  /*p06.DYBO*/ wire _SER_DATA2_RSTn = or2(and2(_FF01_WRn_xxxxxFGH, cpu_bus.CPU_BUS_D2), top.clk_reg.ALUR_SYS_RSTn());
  /*p06.DAJU*/ wire _SER_DATA3_RSTn = or2(and2(_FF01_WRn_xxxxxFGH, cpu_bus.CPU_BUS_D3), top.clk_reg.ALUR_SYS_RSTn());
  /*p06.DYLY*/ wire _SER_DATA4_RSTn = or2(and2(_FF01_WRn_xxxxxFGH, cpu_bus.CPU_BUS_D4), top.clk_reg.ALUR_SYS_RSTn());
  /*p06.EHUJ*/ wire _SER_DATA5_RSTn = or2(and2(_FF01_WRn_xxxxxFGH, cpu_bus.CPU_BUS_D5), top.clk_reg.ALUR_SYS_RSTn());
  /*p06.EFAK*/ wire _SER_DATA6_RSTn = or2(and2(_FF01_WRn_xxxxxFGH, cpu_bus.CPU_BUS_D6), top.clk_reg.ALUR_SYS_RSTn());
  /*p06.EGUV*/ wire _SER_DATA7_RSTn = or2(and2(_FF01_WRn_xxxxxFGH, cpu_bus.CPU_BUS_D7), top.clk_reg.ALUR_SYS_RSTn());

  /*p06.CAGE*/ wire _SIN_Cn = not1(SIN_C);
