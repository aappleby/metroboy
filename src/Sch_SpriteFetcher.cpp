...
void SpriteFetcher::tick(SchematicTop& top) {
  ...
  /*p29.VUSA*/ wire VUSA_SPRITE_DONEn = or(!TYFO_SFETCH_S0_D1, !TOXE_SFETCH_S0, !SEBA_SFETCH_S1_D5, !VONU_SFETCH_S1_D4);
    ...
    /*p27.SOWO*/ wire SOWO_SFETCH_RUNNINGn = not(TAKA_SFETCH_RUNNINGp.q());
    ...
    /*p27.RYCE*/ wire RYCE_SPRITE_FETCHpe = and (SOBU_SPRITE_FETCH_A.q(),  SUDA_SPRITE_FETCH_B.qn());
    ...
    /*p29.TAME*/ wire TAME_SFETCH_CLK_GATE = nand(TESE_SFETCH_S2.q(), TOXE_SFETCH_S0.q());
    /*p29.TOMA*/ wire TOMA_SFETCH_CLK_xBxDxFxH = nand(_LAPE_AxCxExGx, TAME_SFETCH_CLK_GATE);

    /*p29.TOXE*/ TOXE_SFETCH_S0.set(TOMA_SFETCH_CLK_xBxDxFxH, SECA_SPRITE_FETCHne, TOXE_SFETCH_S0.qn());
    /*p29.TULY*/ TULY_SFETCH_S1.set(TOXE_SFETCH_S0.qn(),       SECA_SPRITE_FETCHne, TULY_SFETCH_S1.qn());
    /*p29.TESE*/ TESE_SFETCH_S2.set(TULY_SFETCH_S1.qn(),       SECA_SPRITE_FETCHne, TESE_SFETCH_S2.qn());
...

  {
    ...
    /*p29.TOPU*/ wire TOPU_LATCH_SPPIXA = and(TULY_SFETCH_S1.q(), SYCU_SFETCH_S0pe);
