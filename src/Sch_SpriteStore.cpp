...
void SpriteStoreRegisters::tick(SchematicTop& top) {
...

  {
    ...
    /*p29.CAKE*/ pwire CAKE_CLKp = or (BAKY_SPRITES_FULL, DEZY_STORE_ENn_SYNC);
    
    /*p28.AZYB*/ nwire AZYB_RST = not(top.BYHA_VID_LINE_TRIG_d4());
    /*p29.BESE*/ SPRITE_COUNT0.set(CAKE_CLKp,            AZYB_RST, !SPRITE_COUNT0);
    /*p29.CUXY*/ SPRITE_COUNT1.set(pwire(SPRITE_COUNT0), AZYB_RST, !SPRITE_COUNT1);
    /*p29.BEGO*/ SPRITE_COUNT2.set(pwire(SPRITE_COUNT1), AZYB_RST, !SPRITE_COUNT2);
    /*p29.DYBE*/ SPRITE_COUNT3.set(pwire(SPRITE_COUNT2), AZYB_RST, !SPRITE_COUNT3);
  }
...

  {
    ...
    /*p29.WUTY*/ pwire WUTY_SPRITE_DONEp = not(top.VUSA_SPRITE_DONEn());
    /*p28.ATEJ*/ pwire ATEJ_VID_LINE_TRIG_d4p = not(top.BYHA_VID_LINE_TRIG_d4());
    /*p01.AMYG*/ pwire AMYG_VID_RSTp = not(top.XAPO_VID_RSTn());
    /*p28.ABAK*/ pwire ABAK_VID_LINE_TRIG_d4p = or (ATEJ_VID_LINE_TRIG_d4p, AMYG_VID_RSTp);
    /*p28.BYVA*/ nwire BYVA_VID_LINE_TRIG_d4n = not(ABAK_VID_LINE_TRIG_d4p);
