...
void SpriteStore::tock(const SchematicTop& top) {
...

  {
    ...
    /*p30.YWAK*/ YWAK_STORE0_INDX0 = dff8(GENY_STORE0_CLKp, !GENY_STORE0_CLKp, SPR_TRI_INDX_0.q());
    /*p30.ZONY*/ ZONY_STORE0_INDX1 = dff8(GENY_STORE0_CLKp, !GENY_STORE0_CLKp, SPR_TRI_INDX_1.q());
    /*p30.WYTE*/ WYTE_STORE0_INDX2 = dff8(GENY_STORE0_CLKp, !GENY_STORE0_CLKp, SPR_TRI_INDX_2.q());
    /*p30.YZEP*/ YZEP_STORE0_INDX3 = dff8(GENY_STORE0_CLKp, !GENY_STORE0_CLKp, SPR_TRI_INDX_3.q());
    /*p30.YSOK*/ YSOK_STORE0_INDX4 = dff8(GENY_STORE0_CLKp, !GENY_STORE0_CLKp, SPR_TRI_INDX_4.q());
    /*p30.YGUS*/ YGUS_STORE0_INDX5 = dff8(GENY_STORE0_CLKp, !GENY_STORE0_CLKp, SPR_TRI_INDX_5.q());
    /*p30.FYHY*/ FYHY_STORE0_LINE0 = dff8(ENOB_STORE0_CLKp, !ENOB_STORE0_CLKp, SPR_TRI_LINE_0.q());
    /*p30.GYHO*/ GYHO_STORE0_LINE1 = dff8(ENOB_STORE0_CLKp, !ENOB_STORE0_CLKp, SPR_TRI_LINE_1.q());
    /*p30.BOZU*/ BOZU_STORE0_LINE2 = dff8(ENOB_STORE0_CLKp, !ENOB_STORE0_CLKp, SPR_TRI_LINE_2.q());
    /*p30.CUFO*/ CUFO_STORE0_LINE3 = dff8(ENOB_STORE0_CLKp, !ENOB_STORE0_CLKp, SPR_TRI_LINE_3.q());
    ...
    /*p30.CAJY*/ STORE1_INDX0 = dff8(BYVU_STORE1_CLKp, !BYVU_STORE1_CLKp, SPR_TRI_INDX_5.q());
    /*p30.CUZA*/ STORE1_INDX1 = dff8(BYVU_STORE1_CLKp, !BYVU_STORE1_CLKp, SPR_TRI_INDX_4.q());
    /*p30.COMA*/ STORE1_INDX2 = dff8(BYVU_STORE1_CLKp, !BYVU_STORE1_CLKp, SPR_TRI_INDX_3.q());
    /*p30.CUFA*/ STORE1_INDX3 = dff8(BYVU_STORE1_CLKp, !BYVU_STORE1_CLKp, SPR_TRI_INDX_2.q());
    /*p30.CEBO*/ STORE1_INDX4 = dff8(BYVU_STORE1_CLKp, !BYVU_STORE1_CLKp, SPR_TRI_INDX_1.q());
    /*p30.CADU*/ STORE1_INDX5 = dff8(BYVU_STORE1_CLKp, !BYVU_STORE1_CLKp, SPR_TRI_INDX_0.q());
    /*p30.ABUG*/ STORE1_LINE0 = dff8(AHOF_STORE1_CLKp, !AHOF_STORE1_CLKp, SPR_TRI_LINE_0.q());
    /*p30.AMES*/ STORE1_LINE1 = dff8(AHOF_STORE1_CLKp, !AHOF_STORE1_CLKp, SPR_TRI_LINE_1.q());
    /*p30.ABOP*/ STORE1_LINE2 = dff8(AHOF_STORE1_CLKp, !AHOF_STORE1_CLKp, SPR_TRI_LINE_2.q());
    /*p30.AROF*/ STORE1_LINE3 = dff8(AHOF_STORE1_CLKp, !AHOF_STORE1_CLKp, SPR_TRI_LINE_3.q());
    ...
    /*p30.BOXA*/ STORE2_INDX0 = dff8(BUZY_STORE2_CLKp, !BUZY_STORE2_CLKp, SPR_TRI_INDX_5.q());
    /*p30.BUNA*/ STORE2_INDX1 = dff8(BUZY_STORE2_CLKp, !BUZY_STORE2_CLKp, SPR_TRI_INDX_4.q());
    /*p30.BULU*/ STORE2_INDX2 = dff8(BUZY_STORE2_CLKp, !BUZY_STORE2_CLKp, SPR_TRI_INDX_3.q());
    /*p30.BECA*/ STORE2_INDX3 = dff8(BUZY_STORE2_CLKp, !BUZY_STORE2_CLKp, SPR_TRI_INDX_2.q());
    /*p30.BYHU*/ STORE2_INDX4 = dff8(BUZY_STORE2_CLKp, !BUZY_STORE2_CLKp, SPR_TRI_INDX_1.q());
    /*p30.BUHE*/ STORE2_INDX5 = dff8(BUZY_STORE2_CLKp, !BUZY_STORE2_CLKp, SPR_TRI_INDX_0.q());
    /*p30.YKUK*/ STORE2_LINE0 = dff8(FUKE_STORE2_CLKp, !FUKE_STORE2_CLKp, SPR_TRI_LINE_0.q());
    /*p30.YLOV*/ STORE2_LINE1 = dff8(FUKE_STORE2_CLKp, !FUKE_STORE2_CLKp, SPR_TRI_LINE_1.q());
    /*p30.XAZY*/ STORE2_LINE2 = dff8(FUKE_STORE2_CLKp, !FUKE_STORE2_CLKp, SPR_TRI_LINE_2.q());
    /*p30.XOSY*/ STORE2_LINE3 = dff8(FUKE_STORE2_CLKp, !FUKE_STORE2_CLKp, SPR_TRI_LINE_3.q());
    ...
    /*p30.DAFU*/ STORE3_INDX0 = dff8(FEKA, !FEKA, SPR_TRI_INDX_5.q());
    /*p30.DEBA*/ STORE3_INDX1 = dff8(FEKA, !FEKA, SPR_TRI_INDX_4.q());
    /*p30.DUHA*/ STORE3_INDX2 = dff8(FEKA, !FEKA, SPR_TRI_INDX_3.q());
    /*p30.DUNY*/ STORE3_INDX3 = dff8(FEKA, !FEKA, SPR_TRI_INDX_2.q());
    /*p30.DESE*/ STORE3_INDX4 = dff8(FEKA, !FEKA, SPR_TRI_INDX_1.q());
    /*p30.DEVY*/ STORE3_INDX5 = dff8(FEKA, !FEKA, SPR_TRI_INDX_0.q());
    /*p30.ZURY*/ STORE3_LINE0 = dff8(XYHA, !XYHA, SPR_TRI_LINE_0.q());
    /*p30.ZURO*/ STORE3_LINE1 = dff8(XYHA, !XYHA, SPR_TRI_LINE_1.q());
    /*p30.ZENE*/ STORE3_LINE2 = dff8(XYHA, !XYHA, SPR_TRI_LINE_2.q());
    /*p30.ZYLU*/ STORE3_LINE4 = dff8(XYHA, !XYHA, SPR_TRI_LINE_3.q());
    ...
    /*p30.XYNU*/ XYNU      = dff8(WYLU, !WYLU, SPR_TRI_INDX_5.q());
    /*p30.XEGE*/ XEGE      = dff8(WYLU, !WYLU, SPR_TRI_INDX_4.q());
    /*p30.XABO*/ XABO      = dff8(WYLU, !WYLU, SPR_TRI_INDX_3.q());
    /*p30.WANU*/ WANU      = dff8(WYLU, !WYLU, SPR_TRI_INDX_2.q());
    /*p30.XEFE*/ XEFE      = dff8(WYLU, !WYLU, SPR_TRI_INDX_1.q());
    /*p30.XAVE*/ XAVE      = dff8(WYLU, !WYLU, SPR_TRI_INDX_0.q());
    /*p30.CUMU*/ CUMU      = dff8(EWOT, !EWOT, SPR_TRI_LINE_0.q());
    /*p30.CAPO*/ CAPO      = dff8(EWOT, !EWOT, SPR_TRI_LINE_1.q());
    /*p30.CONO*/ CONO      = dff8(EWOT, !EWOT, SPR_TRI_LINE_2.q());
    /*p30.CAJU*/ CAJU      = dff8(EWOT, !EWOT, SPR_TRI_LINE_3.q());
    ...
    /*p30.EKAP*/ EKAP      = dff8(DYMO, !DYMO, SPR_TRI_INDX_5.q());
    /*p30.ETAV*/ ETAV      = dff8(DYMO, !DYMO, SPR_TRI_INDX_4.q());
    /*p30.EBEX*/ EBEX      = dff8(DYMO, !DYMO, SPR_TRI_INDX_3.q());
    /*p30.GORU*/ GORU      = dff8(DYMO, !DYMO, SPR_TRI_INDX_2.q());
    /*p30.ETYM*/ ETYM      = dff8(DYMO, !DYMO, SPR_TRI_INDX_1.q());
    /*p30.EKOP*/ EKOP      = dff8(DYMO, !DYMO, SPR_TRI_INDX_0.q());
    /*p30.ANED*/ ANED      = dff8(BUCY, !BUCY, SPR_TRI_LINE_0.q());
    /*p30.ACEP*/ ACEP      = dff8(BUCY, !BUCY, SPR_TRI_LINE_1.q());
    /*p30.ABUX*/ ABUX      = dff8(BUCY, !BUCY, SPR_TRI_LINE_2.q());
    /*p30.ABEG*/ ABEG      = dff8(BUCY, !BUCY, SPR_TRI_LINE_3.q());
    ...
    /*p30.GECU*/ GECU      = dff8(WUSE, !WUSE, SPR_TRI_INDX_5.q());
    /*p30.FOXY*/ FOXY      = dff8(WUSE, !WUSE, SPR_TRI_INDX_4.q());
    /*p30.GOHU*/ GOHU      = dff8(WUSE, !WUSE, SPR_TRI_INDX_3.q());
    /*p30.FOGO*/ FOGO      = dff8(WUSE, !WUSE, SPR_TRI_INDX_2.q());
    /*p30.GACY*/ GACY      = dff8(WUSE, !WUSE, SPR_TRI_INDX_1.q());
    /*p30.GABO*/ GABO      = dff8(WUSE, !WUSE, SPR_TRI_INDX_0.q());
    /*p30.ZUBE*/ ZUBE      = dff8(ZURU, !ZURU, SPR_TRI_LINE_0.q());
    /*p30.ZUMY*/ ZUMY      = dff8(ZURU, !ZURU, SPR_TRI_LINE_1.q());
    /*p30.ZEXO*/ ZEXO      = dff8(ZURU, !ZURU, SPR_TRI_LINE_2.q());
    /*p30.ZAFU*/ ZAFU      = dff8(ZURU, !ZURU, SPR_TRI_LINE_3.q());
    ...
    /*p30.FUZO*/ FUZO      = dff8(FEFO, !FEFO, SPR_TRI_INDX_5.q());
    /*p30.GESY*/ GESY      = dff8(FEFO, !FEFO, SPR_TRI_INDX_4.q());
    /*p30.FYSU*/ FYSU      = dff8(FEFO, !FEFO, SPR_TRI_INDX_3.q());
    /*p30.FEFA*/ FEFA      = dff8(FEFO, !FEFO, SPR_TRI_INDX_2.q());
    /*p30.GYNO*/ GYNO      = dff8(FEFO, !FEFO, SPR_TRI_INDX_1.q());
    /*p30.GULE*/ GULE      = dff8(FEFO, !FEFO, SPR_TRI_INDX_0.q());
    /*p30.XYGO*/ XYGO      = dff8(WABE, !WABE, SPR_TRI_LINE_0.q());
    /*p30.XYNA*/ XYNA      = dff8(WABE, !WABE, SPR_TRI_LINE_1.q());
    /*p30.XAKU*/ XAKU      = dff8(WABE, !WABE, SPR_TRI_LINE_2.q());
    /*p30.YGUM*/ YGUM      = dff8(WABE, !WABE, SPR_TRI_LINE_3.q());
    ...
    /*p30.AXUV*/ STORE8_INDX5 = dff8(AKOL, !AKOL, SPR_TRI_INDX_5.q());
    /*p30.BADA*/ STORE8_INDX4 = dff8(AKOL, !AKOL, SPR_TRI_INDX_4.q());
    /*p30.APEV*/ STORE8_INDX3 = dff8(AKOL, !AKOL, SPR_TRI_INDX_3.q());
    /*p30.BADO*/ STORE8_INDX2 = dff8(AKOL, !AKOL, SPR_TRI_INDX_2.q());
    /*p30.BEXY*/ STORE8_INDX1 = dff8(AKOL, !AKOL, SPR_TRI_INDX_1.q());
    /*p30.BYHE*/ STORE8_INDX0 = dff8(AKOL, !AKOL, SPR_TRI_INDX_0.q());
    /*p30.AFYM*/ STORE8_LINE0 = dff8(BYMY, !BYMY, SPR_TRI_LINE_0.q());
    /*p30.AZAP*/ STORE8_LINE1 = dff8(BYMY, !BYMY, SPR_TRI_LINE_1.q());
    /*p30.AFUT*/ STORE8_LINE2 = dff8(BYMY, !BYMY, SPR_TRI_LINE_2.q());
    /*p30.AFYX*/ STORE8_LINE3 = dff8(BYMY, !BYMY, SPR_TRI_LINE_3.q());
    ...
    /*p30.XUFO*/ STORE9_INDX0 = dff8(STORE9_CLKb, !STORE9_CLKb, SPR_TRI_INDX_5.q());
    /*p30.XUTE*/ STORE9_INDX1 = dff8(STORE9_CLKb, !STORE9_CLKb, SPR_TRI_INDX_4.q());
    /*p30.XOTU*/ STORE9_INDX2 = dff8(STORE9_CLKb, !STORE9_CLKb, SPR_TRI_INDX_3.q());
    /*p30.XYFE*/ STORE9_INDX3 = dff8(STORE9_CLKb, !STORE9_CLKb, SPR_TRI_INDX_2.q());
    /*p30.YZOR*/ STORE9_INDX4 = dff8(STORE9_CLKb, !STORE9_CLKb, SPR_TRI_INDX_1.q());
    /*p30.YBER*/ STORE9_INDX5 = dff8(STORE9_CLKb, !STORE9_CLKb, SPR_TRI_INDX_0.q());
    /*p30.DEWU*/ STORE9_LINE0 = dff8(STORE9_CLKc, !STORE9_CLKc, SPR_TRI_LINE_0.q());
    /*p30.CANA*/ STORE9_LINE1 = dff8(STORE9_CLKc, !STORE9_CLKc, SPR_TRI_LINE_1.q());
    /*p30.DYSY*/ STORE9_LINE2 = dff8(STORE9_CLKc, !STORE9_CLKc, SPR_TRI_LINE_2.q());
    /*p30.FOFO*/ STORE9_LINE3 = dff8(STORE9_CLKc, !STORE9_CLKc, SPR_TRI_LINE_3.q());
