...
void SpriteStore::tick(const SchematicTop& top) {
  {
    ...
    /* p31.EDYM*/ wire EDYM_STORE1_MATCH0n = xor2(DANY_STORE1_X0.qn(), ACAM_X0n);
    /* p31.EMYB*/ wire EMYB_STORE1_MATCH1n = xor2(DUKO_STORE1_X1.qn(), AZUB_X1n);
    /* p31.EBEF*/ wire EBEF_STORE1_MATCH2n = xor2(DESU_STORE1_X2.qn(), AMEL_X2n);
    /* p31.EWOK*/ wire EWOK_STORE1_MATCH3n = xor2(DAZO_STORE1_X3.qn(), AHAL_X3n);
    /* p31.COLA*/ wire COLA_STORE1_MATCH4n = xor2(DAKE_STORE1_X4.qn(), APUX_X4n);
    /* p31.BOBA*/ wire BOBA_STORE1_MATCH5n = xor2(CESO_STORE1_X5.qn(), ABEF_X5n);
    /* p31.COLU*/ wire COLU_STORE1_MATCH6n = xor2(DYFU_STORE1_X6.qn(), ADAZ_X6n);
    /* p31.BAHU*/ wire BAHU_STORE1_MATCH7n = xor2(CUSY_STORE1_X7.qn(), ASAH_X7n);
       
    /* p31.FUZU*/ wire FUZU_STORE2_MATCH0n = xor2(FOKA_STORE2_X0.qn(), ACAM_X0n);
    /* p31.FESO*/ wire FESO_STORE2_MATCH1n = xor2(FYTY_STORE2_X1.qn(), AZUB_X1n);
    /* p31.FOKY*/ wire FOKY_STORE2_MATCH2n = xor2(FUBY_STORE2_X2.qn(), AMEL_X2n);
    /* p31.FYVA*/ wire FYVA_STORE2_MATCH3n = xor2(GOXU_STORE2_X3.qn(), AHAL_X3n);
    /* p31.CEKO*/ wire CEKO_STORE2_MATCH4n = xor2(DUHY_STORE2_X4.qn(), APUX_X4n);
    /* p31.DETY*/ wire DETY_STORE2_MATCH5n = xor2(EJUF_STORE2_X5.qn(), ABEF_X5n);
    /* p31.DOZO*/ wire DOZO_STORE2_MATCH6n = xor2(ENOR_STORE2_X6.qn(), ADAZ_X6n);
    /* p31.CONY*/ wire CONY_STORE2_MATCH7n = xor2(DEPY_STORE2_X7.qn(), ASAH_X7n);
       
    /* p31.YHOK*/ wire YHOK_STORE3_MATCH0n = xor2(XOLY_STORE3_X0.qn(), ACAM_X0n);
    /* p31.YCAH*/ wire YCAH_STORE3_MATCH1n = xor2(XYBA_STORE3_X1.qn(), AZUB_X1n);
    /* p31.YDAJ*/ wire YDAJ_STORE3_MATCH2n = xor2(XABE_STORE3_X2.qn(), AMEL_X2n);
    /* p31.YVUZ*/ wire YVUZ_STORE3_MATCH3n = xor2(XEKA_STORE3_X3.qn(), AHAL_X3n);
    /* p31.YVAP*/ wire YVAP_STORE3_MATCH4n = xor2(XOMY_STORE3_X4.qn(), APUX_X4n);
    /* p31.XENY*/ wire XENY_STORE3_MATCH5n = xor2(WUHA_STORE3_X5.qn(), ABEF_X5n);
    /* p31.XAVU*/ wire XAVU_STORE3_MATCH6n = xor2(WYNA_STORE3_X6.qn(), ADAZ_X6n);
    /* p31.XEVA*/ wire XEVA_STORE3_MATCH7n = xor2(WECO_STORE3_X7.qn(), ASAH_X7n);
       
    /* p31.XEJU*/ wire XEJU_STORE4_MATCH0n = xor2(WEDU_STORE4_X0.qn(), ACAM_X0n);
    /* p31.ZATE*/ wire ZATE_STORE4_MATCH1n = xor2(YGAJ_STORE4_X1.qn(), AZUB_X1n);
    /* p31.ZAKU*/ wire ZAKU_STORE4_MATCH2n = xor2(ZYJO_STORE4_X2.qn(), AMEL_X2n);
    /* p31.YBOX*/ wire YBOX_STORE4_MATCH3n = xor2(XURY_STORE4_X3.qn(), AHAL_X3n);
    /* p31.ZYKU*/ wire ZYKU_STORE4_MATCH4n = xor2(YBED_STORE4_X4.qn(), APUX_X4n);
    /* p31.ZYPU*/ wire ZYPU_STORE4_MATCH5n = xor2(ZALA_STORE4_X5.qn(), ABEF_X5n);
    /* p31.XAHA*/ wire XAHA_STORE4_MATCH6n = xor2(WYDE_STORE4_X6.qn(), ADAZ_X6n);
    /* p31.ZEFE*/ wire ZEFE_STORE4_MATCH7n = xor2(XEPA_STORE4_X7.qn(), ASAH_X7n);
       
    /* p31.GUZO*/ wire GUZO_STORE5_MATCH0n = xor2(FUSA_STORE5_X0.qn(), ACAM_X0n);
    /* p31.GOLA*/ wire GOLA_STORE5_MATCH1n = xor2(FAXA_STORE5_X1.qn(), AZUB_X1n);
    /* p31.GEVE*/ wire GEVE_STORE5_MATCH2n = xor2(FOZY_STORE5_X2.qn(), AMEL_X2n);
    /* p31.GUDE*/ wire GUDE_STORE5_MATCH3n = xor2(FESY_STORE5_X3.qn(), AHAL_X3n);
    /* p31.BAZY*/ wire BAZY_STORE5_MATCH4n = xor2(CYWE_STORE5_X4.qn(), APUX_X4n);
    /* p31.CYLE*/ wire CYLE_STORE5_MATCH5n = xor2(DYBY_STORE5_X5.qn(), ABEF_X5n);
    /* p31.CEVA*/ wire CEVA_STORE5_MATCH6n = xor2(DURY_STORE5_X6.qn(), ADAZ_X6n);
    /* p31.BUMY*/ wire BUMY_STORE5_MATCH7n = xor2(CUVY_STORE5_X7.qn(), ASAH_X7n);
       
    /* p31.XOSU*/ wire XOSU_STORE6_MATCH0n = xor2(YCOL_STORE6_X0.qn(), ACAM_X0n);
    /* p31.ZUVU*/ wire ZUVU_STORE6_MATCH1n = xor2(YRAC_STORE6_X1.qn(), AZUB_X1n);
    /* p31.XUCO*/ wire XUCO_STORE6_MATCH2n = xor2(YMEM_STORE6_X2.qn(), AMEL_X2n);
    /* p31.ZULO*/ wire ZULO_STORE6_MATCH3n = xor2(YVAG_STORE6_X3.qn(), AHAL_X3n);
    /* p31.ZARE*/ wire ZARE_STORE6_MATCH4n = xor2(ZOLY_STORE6_X4.qn(), APUX_X4n);
    /* p31.ZEMU*/ wire ZEMU_STORE6_MATCH5n = xor2(ZOGO_STORE6_X5.qn(), ABEF_X5n);
    /* p31.ZYGO*/ wire ZYGO_STORE6_MATCH6n = xor2(ZECU_STORE6_X6.qn(), ADAZ_X6n);
    /* p31.ZUZY*/ wire ZUZY_STORE6_MATCH7n = xor2(ZESA_STORE6_X7.qn(), ASAH_X7n);
       
    /* p31.DUSE*/ wire DUSE_STORE7_MATCH0n = xor2(ERAZ_STORE7_X0.qn(), ACAM_X0n);
    /* p31.DAGU*/ wire DAGU_STORE7_MATCH1n = xor2(EPUM_STORE7_X1.qn(), AZUB_X1n);
    /* p31.DYZE*/ wire DYZE_STORE7_MATCH2n = xor2(EROL_STORE7_X2.qn(), AMEL_X2n);
    /* p31.DESO*/ wire DESO_STORE7_MATCH3n = xor2(EHYN_STORE7_X3.qn(), AHAL_X3n);
    /* p31.EJOT*/ wire EJOT_STORE7_MATCH4n = xor2(FAZU_STORE7_X4.qn(), APUX_X4n);
    /* p31.ESAJ*/ wire ESAJ_STORE7_MATCH5n = xor2(FAXE_STORE7_X5.qn(), ABEF_X5n);
    /* p31.DUCU*/ wire DUCU_STORE7_MATCH6n = xor2(EXUK_STORE7_X6.qn(), ADAZ_X6n);
    /* p31.EWUD*/ wire EWUD_STORE7_MATCH7n = xor2(FEDE_STORE7_X7.qn(), ASAH_X7n);
       
    /* p31.DUZE*/ wire DUZE_STORE8_MATCH0n = xor2(EZUF_STORE8_X0.qn(), APUX_X4n);
    /* p31.DAGA*/ wire DAGA_STORE8_MATCH1n = xor2(ENAD_STORE8_X1.qn(), ABEF_X5n);
    /* p31.DAWU*/ wire DAWU_STORE8_MATCH2n = xor2(EBOW_STORE8_X2.qn(), ADAZ_X6n);
    /* p31.EJAW*/ wire EJAW_STORE8_MATCH3n = xor2(FYCA_STORE8_X3.qn(), ASAH_X7n);
    /* p31.GOHO*/ wire GOHO_STORE8_MATCH4n = xor2(GAVY_STORE8_X4.qn(), ACAM_X0n);
    /* p31.GASU*/ wire GASU_STORE8_MATCH5n = xor2(GYPU_STORE8_X5.qn(), AZUB_X1n);
    /* p31.GABU*/ wire GABU_STORE8_MATCH6n = xor2(GADY_STORE8_X6.qn(), AMEL_X2n);
    /* p31.GAFE*/ wire GAFE_STORE8_MATCH7n = xor2(GAZA_STORE8_X7.qn(), AHAL_X3n);
       
    /* p31.YMAM*/ wire YMAM_STORE9_MATCH0n = xor2(XUVY_STORE9_X0.qn(), ACAM_X0n);
    /* p31.YTYP*/ wire YTYP_STORE9_MATCH1n = xor2(XERE_STORE9_X1.qn(), AZUB_X1n);
    /* p31.YFOP*/ wire YFOP_STORE9_MATCH2n = xor2(XUZO_STORE9_X2.qn(), AMEL_X2n);
    /* p31.YVAC*/ wire YVAC_STORE9_MATCH3n = xor2(XEXA_STORE9_X3.qn(), AHAL_X3n);
    /* p31.ZYWU*/ wire ZYWU_STORE9_MATCH4n = xor2(YPOD_STORE9_X4.qn(), APUX_X4n);
    /* p31.ZUZA*/ wire ZUZA_STORE9_MATCH5n = xor2(YROP_STORE9_X5.qn(), ABEF_X5n);
    /* p31.ZEJO*/ wire ZEJO_STORE9_MATCH6n = xor2(YNEP_STORE9_X6.qn(), ADAZ_X6n);
    /* p31.ZEDA*/ wire ZEDA_STORE9_MATCH7n = xor2(YZOF_STORE9_X7.qn(), ASAH_X7n);

    /*p31.ZAKO*/ wire STORE0_MATCHA = nor4(ZOGY_STORE0_MATCH0n, ZEBA_STORE0_MATCH1n, ZAHA_STORE0_MATCH2n, ZOKY_STORE0_MATCH3n);
    /*p31.XEBA*/ wire STORE0_MATCHB = nor4(WOJU_STORE0_MATCH4n, YFUN_STORE0_MATCH5n, WYZA_STORE0_MATCH6n, YPUK_STORE0_MATCH7n);
    /*p31.CYVY*/ wire STORE1_MATCHB = nor4(COLA_STORE1_MATCH4n, BOBA_STORE1_MATCH5n, COLU_STORE1_MATCH6n, BAHU_STORE1_MATCH7n);
    /*p31.EWAM*/ wire STORE1_MATCHA = nor4(EDYM_STORE1_MATCH0n, EMYB_STORE1_MATCH1n, EBEF_STORE1_MATCH2n, EWOK_STORE1_MATCH3n);
    /*p31.CEHU*/ wire STORE2_MATCHA = nor4(CEKO_STORE2_MATCH4n, DETY_STORE2_MATCH5n, DOZO_STORE2_MATCH6n, CONY_STORE2_MATCH7n);
    /*p31.EKES*/ wire STORE2_MATCHB = nor4(FUZU_STORE2_MATCH0n, FESO_STORE2_MATCH1n, FOKY_STORE2_MATCH2n, FYVA_STORE2_MATCH3n);
    /*p31.ZURE*/ wire STORE3_MATCHA = nor4(YHOK_STORE3_MATCH0n, YCAH_STORE3_MATCH1n, YDAJ_STORE3_MATCH2n, YVUZ_STORE3_MATCH3n);
    /*p31.YWOS*/ wire STORE3_MATCHB = nor4(YVAP_STORE3_MATCH4n, XENY_STORE3_MATCH5n, XAVU_STORE3_MATCH6n, XEVA_STORE3_MATCH7n);
    /*p31.YKOK*/ wire STORE4_MATCHA = nor4(XEJU_STORE4_MATCH0n, ZATE_STORE4_MATCH1n, ZAKU_STORE4_MATCH2n, YBOX_STORE4_MATCH3n);
    /*p31.YNAZ*/ wire STORE4_MATCHB = nor4(ZYKU_STORE4_MATCH4n, ZYPU_STORE4_MATCH5n, XAHA_STORE4_MATCH6n, ZEFE_STORE4_MATCH7n);
    /*p31.COGY*/ wire STORE5_MATCHA = nor4(BAZY_STORE5_MATCH4n, CYLE_STORE5_MATCH5n, CEVA_STORE5_MATCH6n, BUMY_STORE5_MATCH7n);
    /*p31.FYMA*/ wire STORE5_MATCHB = nor4(GUZO_STORE5_MATCH0n, GOLA_STORE5_MATCH1n, GEVE_STORE5_MATCH2n, GUDE_STORE5_MATCH3n);
    /*p31.YWAP*/ wire STORE6_MATCHA = nor4(ZARE_STORE6_MATCH4n, ZEMU_STORE6_MATCH5n, ZYGO_STORE6_MATCH6n, ZUZY_STORE6_MATCH7n);
    /*p31.YDOT*/ wire STORE6_MATCHB = nor4(XOSU_STORE6_MATCH0n, ZUVU_STORE6_MATCH1n, XUCO_STORE6_MATCH2n, ZULO_STORE6_MATCH3n);
    /*p31.CYCO*/ wire STORE7_MATCHA = nor4(DUSE_STORE7_MATCH0n, DAGU_STORE7_MATCH1n, DYZE_STORE7_MATCH2n, DESO_STORE7_MATCH3n);
    /*p31.DAJE*/ wire STORE7_MATCHB = nor4(EJOT_STORE7_MATCH4n, ESAJ_STORE7_MATCH5n, DUCU_STORE7_MATCH6n, EWUD_STORE7_MATCH7n);
    /*p31.DAMA*/ wire STORE8_MATCHA = nor4(DUZE_STORE8_MATCH0n, DAGA_STORE8_MATCH1n, DAWU_STORE8_MATCH2n, EJAW_STORE8_MATCH3n);
    /*p31.FEHA*/ wire STORE8_MATCHB = nor4(GOHO_STORE8_MATCH4n, GASU_STORE8_MATCH5n, GABU_STORE8_MATCH6n, GAFE_STORE8_MATCH7n);
    /*p31.YLEV*/ wire STORE9_MATCHA = nor4(YMAM_STORE9_MATCH0n, YTYP_STORE9_MATCH1n, YFOP_STORE9_MATCH2n, YVAC_STORE9_MATCH3n);
    /*p31.YTUB*/ wire STORE9_MATCHB = nor4(ZYWU_STORE9_MATCH4n, ZUZA_STORE9_MATCH5n, ZEJO_STORE9_MATCH6n, ZEDA_STORE9_MATCH7n);
