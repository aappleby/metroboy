...
SpriteStoreSignals SpriteStoreRegisters::sig(const TestGB& gb, wire XYMO_LCDC_SPSIZE) const {
...

  {
    ...
    /*p29.AVAP*/ sig.AVAP_SCAN_DONE_d0_TRIGp = not(SCAN_DONE_d0_TRIGn);
  }

  {
    /*p29.CEHA*/ sig.CEHA_SCANNINGp = not(!CENO_SCANNINGp);
  }
...

  {
    ...
    /*p29.DABU*/ sig.SPRITE_DELTA2 = not(YDIFF_S2);
    /*p29.GYSA*/ sig.SPRITE_DELTA3 = not(YDIFF_S3);
    ...
    /*p29.DYTY*/ sig.DYTY_STORE_ENn_xxCDxxGH = not(CARE_STORE_ENp_ABxxEFxx);
  }

  {
    sig.BESU_SCANNINGp = BESU_SCANNINGp.q();
  }
  ...
  {
    /*p28.GUSE*/ sig.GUSE_SCAN0n = not(SCAN0.q());
    /*p28.GEMA*/ sig.GEMA_SCAN1n = not(SCAN1.q());
    /*p28.FUTO*/ sig.FUTO_SCAN2n = not(SCAN2.q());
    /*p28.FAKU*/ sig.FAKU_SCAN3n = not(SCAN3.q());
    /*p28.GAMA*/ sig.GAMA_SCAN4n = not(SCAN4.q());
    /*p28.GOBY*/ sig.GOBY_SCAN5n = not(SCAN5.q());
  }
...
void SpriteStoreRegisters::tick(const TestGB& gb) {
...

  {
    ...
    /*p29.EBOJ*/ EBOJ_STORE0_RSTp.set(ppu_sig.WUTY_SPRITE_DONEp, lcd_sig.BYVA_VID_LINE_TRIG_d4n, GUVA_SPRITE0_GETp);
    /*p29.CEDY*/ CEDY_STORE1_RSTp.set(ppu_sig.WUTY_SPRITE_DONEp, lcd_sig.BYVA_VID_LINE_TRIG_d4n, ENUT_SPRITE1_GETp);
    /*p29.EGAV*/ EGAV_STORE2_RSTp.set(ppu_sig.WUTY_SPRITE_DONEp, lcd_sig.BYVA_VID_LINE_TRIG_d4n, EMOL_SPRITE2_GETp);
    /*p29.GOTA*/ GOTA_STORE3_RSTp.set(ppu_sig.WUTY_SPRITE_DONEp, lcd_sig.BYVA_VID_LINE_TRIG_d4n, GYFY_SPRITE3_GETp);
    /*p29.XUDY*/ XUDY_STORE4_RSTp.set(ppu_sig.WUTY_SPRITE_DONEp, lcd_sig.BYVA_VID_LINE_TRIG_d4n, GONO_SPRITE4_GETp);
    /*p29.WAFY*/ WAFY_STORE5_RSTp.set(ppu_sig.WUTY_SPRITE_DONEp, lcd_sig.BYVA_VID_LINE_TRIG_d4n, GEGA_SPRITE5_GETp);
    /*p29.WOMY*/ WOMY_STORE6_RSTp.set(ppu_sig.WUTY_SPRITE_DONEp, lcd_sig.BYVA_VID_LINE_TRIG_d4n, XOJA_SPRITE6_GETp);
    /*p29.WAPO*/ WAPO_STORE7_RSTp.set(ppu_sig.WUTY_SPRITE_DONEp, lcd_sig.BYVA_VID_LINE_TRIG_d4n, GUTU_SPRITE7_GETp);
    /*p29.EXUQ*/ EXUQ_STORE8_RSTp.set(ppu_sig.WUTY_SPRITE_DONEp, lcd_sig.BYVA_VID_LINE_TRIG_d4n, FOXA_SPRITE8_GETp);
    /*p29.FONO*/ FONO_STORE9_RSTp.set(ppu_sig.WUTY_SPRITE_DONEp, lcd_sig.BYVA_VID_LINE_TRIG_d4n, GUZE_SPRITE9_GETp);
