...
void SpriteStore::tick(const SchematicTop& top) {
  {
    ...
    /*#p31.ZOGY*/ wire ZOGY_STORE0_MATCH0n = xor2_gnd(XEPE_STORE0_X0p.qn(), ACAM_X0n);
    /* p31.ZEBA*/ wire ZEBA_STORE0_MATCH1n = xor2_gnd(YLAH_STORE0_X1p.qn(), AZUB_X1n);
    /* p31.ZAHA*/ wire ZAHA_STORE0_MATCH2n = xor2_gnd(ZOLA_STORE0_X2p.qn(), AMEL_X2n);
    /* p31.ZOKY*/ wire ZOKY_STORE0_MATCH3n = xor2_gnd(ZULU_STORE0_X3p.qn(), AHAL_X3n);
    /* p31.WOJU*/ wire WOJU_STORE0_MATCH4n = xor2_gnd(WELO_STORE0_X4p.qn(), APUX_X4n);
    /* p31.YFUN*/ wire YFUN_STORE0_MATCH5n = xor2_gnd(XUNY_STORE0_X5p.qn(), ABEF_X5n);
    /* p31.WYZA*/ wire WYZA_STORE0_MATCH6n = xor2_gnd(WOTE_STORE0_X6p.qn(), ADAZ_X6n);
    /* p31.YPUK*/ wire YPUK_STORE0_MATCH7n = xor2_gnd(XAKO_STORE0_X7p.qn(), ASAH_X7n);
       
    /* p31.EDYM*/ wire EDYM_STORE1_MATCH0n = xor2_gnd(DANY_STORE1_X0.qn(), ACAM_X0n);
    /* p31.EMYB*/ wire EMYB_STORE1_MATCH1n = xor2_gnd(DUKO_STORE1_X1.qn(), AZUB_X1n);
    /* p31.EBEF*/ wire EBEF_STORE1_MATCH2n = xor2_gnd(DESU_STORE1_X2.qn(), AMEL_X2n);
    /* p31.EWOK*/ wire EWOK_STORE1_MATCH3n = xor2_gnd(DAZO_STORE1_X3.qn(), AHAL_X3n);
    /* p31.COLA*/ wire COLA_STORE1_MATCH4n = xor2_gnd(DAKE_STORE1_X4.qn(), APUX_X4n);
    /* p31.BOBA*/ wire BOBA_STORE1_MATCH5n = xor2_gnd(CESO_STORE1_X5.qn(), ABEF_X5n);
    /* p31.COLU*/ wire COLU_STORE1_MATCH6n = xor2_gnd(DYFU_STORE1_X6.qn(), ADAZ_X6n);
    /* p31.BAHU*/ wire BAHU_STORE1_MATCH7n = xor2_gnd(CUSY_STORE1_X7.qn(), ASAH_X7n);
       
    /* p31.FUZU*/ wire FUZU_STORE2_MATCH0n = xor2_gnd(FOKA_STORE2_X0.qn(), ACAM_X0n);
    /* p31.FESO*/ wire FESO_STORE2_MATCH1n = xor2_gnd(FYTY_STORE2_X1.qn(), AZUB_X1n);
    /* p31.FOKY*/ wire FOKY_STORE2_MATCH2n = xor2_gnd(FUBY_STORE2_X2.qn(), AMEL_X2n);
    /* p31.FYVA*/ wire FYVA_STORE2_MATCH3n = xor2_gnd(GOXU_STORE2_X3.qn(), AHAL_X3n);
    /* p31.CEKO*/ wire CEKO_STORE2_MATCH4n = xor2_gnd(DUHY_STORE2_X4.qn(), APUX_X4n);
    /* p31.DETY*/ wire DETY_STORE2_MATCH5n = xor2_gnd(EJUF_STORE2_X5.qn(), ABEF_X5n);
    /* p31.DOZO*/ wire DOZO_STORE2_MATCH6n = xor2_gnd(ENOR_STORE2_X6.qn(), ADAZ_X6n);
    /* p31.CONY*/ wire CONY_STORE2_MATCH7n = xor2_gnd(DEPY_STORE2_X7.qn(), ASAH_X7n);
       
    /* p31.YHOK*/ wire YHOK_STORE3_MATCH0n = xor2_gnd(XOLY_STORE3_X0.qn(), ACAM_X0n);
    /* p31.YCAH*/ wire YCAH_STORE3_MATCH1n = xor2_gnd(XYBA_STORE3_X1.qn(), AZUB_X1n);
    /* p31.YDAJ*/ wire YDAJ_STORE3_MATCH2n = xor2_gnd(XABE_STORE3_X2.qn(), AMEL_X2n);
    /* p31.YVUZ*/ wire YVUZ_STORE3_MATCH3n = xor2_gnd(XEKA_STORE3_X3.qn(), AHAL_X3n);
    /* p31.YVAP*/ wire YVAP_STORE3_MATCH4n = xor2_gnd(XOMY_STORE3_X4.qn(), APUX_X4n);
    /* p31.XENY*/ wire XENY_STORE3_MATCH5n = xor2_gnd(WUHA_STORE3_X5.qn(), ABEF_X5n);
    /* p31.XAVU*/ wire XAVU_STORE3_MATCH6n = xor2_gnd(WYNA_STORE3_X6.qn(), ADAZ_X6n);
    /* p31.XEVA*/ wire XEVA_STORE3_MATCH7n = xor2_gnd(WECO_STORE3_X7.qn(), ASAH_X7n);
       
    /* p31.XEJU*/ wire XEJU_STORE4_MATCH0n = xor2_gnd(WEDU_STORE4_X0.qn(), ACAM_X0n);
    /* p31.ZATE*/ wire ZATE_STORE4_MATCH1n = xor2_gnd(YGAJ_STORE4_X1.qn(), AZUB_X1n);
    /* p31.ZAKU*/ wire ZAKU_STORE4_MATCH2n = xor2_gnd(ZYJO_STORE4_X2.qn(), AMEL_X2n);
    /* p31.YBOX*/ wire YBOX_STORE4_MATCH3n = xor2_gnd(XURY_STORE4_X3.qn(), AHAL_X3n);
    /* p31.ZYKU*/ wire ZYKU_STORE4_MATCH4n = xor2_gnd(YBED_STORE4_X4.qn(), APUX_X4n);
    /* p31.ZYPU*/ wire ZYPU_STORE4_MATCH5n = xor2_gnd(ZALA_STORE4_X5.qn(), ABEF_X5n);
    /* p31.XAHA*/ wire XAHA_STORE4_MATCH6n = xor2_gnd(WYDE_STORE4_X6.qn(), ADAZ_X6n);
    /* p31.ZEFE*/ wire ZEFE_STORE4_MATCH7n = xor2_gnd(XEPA_STORE4_X7.qn(), ASAH_X7n);
       
    /* p31.GUZO*/ wire GUZO_STORE5_MATCH0n = xor2_gnd(FUSA_STORE5_X0.qn(), ACAM_X0n);
    /* p31.GOLA*/ wire GOLA_STORE5_MATCH1n = xor2_gnd(FAXA_STORE5_X1.qn(), AZUB_X1n);
    /* p31.GEVE*/ wire GEVE_STORE5_MATCH2n = xor2_gnd(FOZY_STORE5_X2.qn(), AMEL_X2n);
    /* p31.GUDE*/ wire GUDE_STORE5_MATCH3n = xor2_gnd(FESY_STORE5_X3.qn(), AHAL_X3n);
    /* p31.BAZY*/ wire BAZY_STORE5_MATCH4n = xor2_gnd(CYWE_STORE5_X4.qn(), APUX_X4n);
    /* p31.CYLE*/ wire CYLE_STORE5_MATCH5n = xor2_gnd(DYBY_STORE5_X5.qn(), ABEF_X5n);
    /* p31.CEVA*/ wire CEVA_STORE5_MATCH6n = xor2_gnd(DURY_STORE5_X6.qn(), ADAZ_X6n);
    /* p31.BUMY*/ wire BUMY_STORE5_MATCH7n = xor2_gnd(CUVY_STORE5_X7.qn(), ASAH_X7n);
       
    /* p31.XOSU*/ wire XOSU_STORE6_MATCH0n = xor2_gnd(YCOL_STORE6_X0.qn(), ACAM_X0n);
    /* p31.ZUVU*/ wire ZUVU_STORE6_MATCH1n = xor2_gnd(YRAC_STORE6_X1.qn(), AZUB_X1n);
    /* p31.XUCO*/ wire XUCO_STORE6_MATCH2n = xor2_gnd(YMEM_STORE6_X2.qn(), AMEL_X2n);
    /* p31.ZULO*/ wire ZULO_STORE6_MATCH3n = xor2_gnd(YVAG_STORE6_X3.qn(), AHAL_X3n);
    /* p31.ZARE*/ wire ZARE_STORE6_MATCH4n = xor2_gnd(ZOLY_STORE6_X4.qn(), APUX_X4n);
    /* p31.ZEMU*/ wire ZEMU_STORE6_MATCH5n = xor2_gnd(ZOGO_STORE6_X5.qn(), ABEF_X5n);
    /* p31.ZYGO*/ wire ZYGO_STORE6_MATCH6n = xor2_gnd(ZECU_STORE6_X6.qn(), ADAZ_X6n);
    /* p31.ZUZY*/ wire ZUZY_STORE6_MATCH7n = xor2_gnd(ZESA_STORE6_X7.qn(), ASAH_X7n);
       
    /* p31.DUSE*/ wire DUSE_STORE7_MATCH0n = xor2_gnd(ERAZ_STORE7_X0.qn(), ACAM_X0n);
    /* p31.DAGU*/ wire DAGU_STORE7_MATCH1n = xor2_gnd(EPUM_STORE7_X1.qn(), AZUB_X1n);
    /* p31.DYZE*/ wire DYZE_STORE7_MATCH2n = xor2_gnd(EROL_STORE7_X2.qn(), AMEL_X2n);
    /* p31.DESO*/ wire DESO_STORE7_MATCH3n = xor2_gnd(EHYN_STORE7_X3.qn(), AHAL_X3n);
    /* p31.EJOT*/ wire EJOT_STORE7_MATCH4n = xor2_gnd(FAZU_STORE7_X4.qn(), APUX_X4n);
    /* p31.ESAJ*/ wire ESAJ_STORE7_MATCH5n = xor2_gnd(FAXE_STORE7_X5.qn(), ABEF_X5n);
    /* p31.DUCU*/ wire DUCU_STORE7_MATCH6n = xor2_gnd(EXUK_STORE7_X6.qn(), ADAZ_X6n);
    /* p31.EWUD*/ wire EWUD_STORE7_MATCH7n = xor2_gnd(FEDE_STORE7_X7.qn(), ASAH_X7n);
       
    /* p31.DUZE*/ wire DUZE_STORE8_MATCH0n = xor2_gnd(EZUF_STORE8_X0.qn(), APUX_X4n);
    /* p31.DAGA*/ wire DAGA_STORE8_MATCH1n = xor2_gnd(ENAD_STORE8_X1.qn(), ABEF_X5n);
    /* p31.DAWU*/ wire DAWU_STORE8_MATCH2n = xor2_gnd(EBOW_STORE8_X2.qn(), ADAZ_X6n);
    /* p31.EJAW*/ wire EJAW_STORE8_MATCH3n = xor2_gnd(FYCA_STORE8_X3.qn(), ASAH_X7n);
    /* p31.GOHO*/ wire GOHO_STORE8_MATCH4n = xor2_gnd(GAVY_STORE8_X4.qn(), ACAM_X0n);
    /* p31.GASU*/ wire GASU_STORE8_MATCH5n = xor2_gnd(GYPU_STORE8_X5.qn(), AZUB_X1n);
    /* p31.GABU*/ wire GABU_STORE8_MATCH6n = xor2_gnd(GADY_STORE8_X6.qn(), AMEL_X2n);
    /* p31.GAFE*/ wire GAFE_STORE8_MATCH7n = xor2_gnd(GAZA_STORE8_X7.qn(), AHAL_X3n);
       
    /* p31.YMAM*/ wire YMAM_STORE9_MATCH0n = xor2_gnd(XUVY_STORE9_X0.qn(), ACAM_X0n);
    /* p31.YTYP*/ wire YTYP_STORE9_MATCH1n = xor2_gnd(XERE_STORE9_X1.qn(), AZUB_X1n);
    /* p31.YFOP*/ wire YFOP_STORE9_MATCH2n = xor2_gnd(XUZO_STORE9_X2.qn(), AMEL_X2n);
    /* p31.YVAC*/ wire YVAC_STORE9_MATCH3n = xor2_gnd(XEXA_STORE9_X3.qn(), AHAL_X3n);
    /* p31.ZYWU*/ wire ZYWU_STORE9_MATCH4n = xor2_gnd(YPOD_STORE9_X4.qn(), APUX_X4n);
    /* p31.ZUZA*/ wire ZUZA_STORE9_MATCH5n = xor2_gnd(YROP_STORE9_X5.qn(), ABEF_X5n);
    /* p31.ZEJO*/ wire ZEJO_STORE9_MATCH6n = xor2_gnd(YNEP_STORE9_X6.qn(), ADAZ_X6n);
    /* p31.ZEDA*/ wire ZEDA_STORE9_MATCH7n = xor2_gnd(YZOF_STORE9_X7.qn(), ASAH_X7n);

    /* p31.ZAKO*/ wire ZAKO_STORE0_MATCHA = nor4(ZOGY_STORE0_MATCH0n, ZEBA_STORE0_MATCH1n, ZAHA_STORE0_MATCH2n, ZOKY_STORE0_MATCH3n);
    /* p31.XEBA*/ wire XEBA_STORE0_MATCHB = nor4(WOJU_STORE0_MATCH4n, YFUN_STORE0_MATCH5n, WYZA_STORE0_MATCH6n, YPUK_STORE0_MATCH7n);
    /* p31.CYVY*/ wire CYVY_STORE1_MATCHB = nor4(COLA_STORE1_MATCH4n, BOBA_STORE1_MATCH5n, COLU_STORE1_MATCH6n, BAHU_STORE1_MATCH7n);
    /* p31.EWAM*/ wire EWAM_STORE1_MATCHA = nor4(EDYM_STORE1_MATCH0n, EMYB_STORE1_MATCH1n, EBEF_STORE1_MATCH2n, EWOK_STORE1_MATCH3n);
    /* p31.CEHU*/ wire CEHU_STORE2_MATCHA = nor4(CEKO_STORE2_MATCH4n, DETY_STORE2_MATCH5n, DOZO_STORE2_MATCH6n, CONY_STORE2_MATCH7n);
    /* p31.EKES*/ wire EKES_STORE2_MATCHB = nor4(FUZU_STORE2_MATCH0n, FESO_STORE2_MATCH1n, FOKY_STORE2_MATCH2n, FYVA_STORE2_MATCH3n);
    /* p31.ZURE*/ wire ZURE_STORE3_MATCHA = nor4(YHOK_STORE3_MATCH0n, YCAH_STORE3_MATCH1n, YDAJ_STORE3_MATCH2n, YVUZ_STORE3_MATCH3n);
    /* p31.YWOS*/ wire YWOS_STORE3_MATCHB = nor4(YVAP_STORE3_MATCH4n, XENY_STORE3_MATCH5n, XAVU_STORE3_MATCH6n, XEVA_STORE3_MATCH7n);
    /* p31.YKOK*/ wire YKOK_STORE4_MATCHA = nor4(XEJU_STORE4_MATCH0n, ZATE_STORE4_MATCH1n, ZAKU_STORE4_MATCH2n, YBOX_STORE4_MATCH3n);
    /* p31.YNAZ*/ wire YNAZ_STORE4_MATCHB = nor4(ZYKU_STORE4_MATCH4n, ZYPU_STORE4_MATCH5n, XAHA_STORE4_MATCH6n, ZEFE_STORE4_MATCH7n);
    /* p31.COGY*/ wire COGY_STORE5_MATCHA = nor4(BAZY_STORE5_MATCH4n, CYLE_STORE5_MATCH5n, CEVA_STORE5_MATCH6n, BUMY_STORE5_MATCH7n);
    /* p31.FYMA*/ wire FYMA_STORE5_MATCHB = nor4(GUZO_STORE5_MATCH0n, GOLA_STORE5_MATCH1n, GEVE_STORE5_MATCH2n, GUDE_STORE5_MATCH3n);
    /* p31.YWAP*/ wire YWAP_STORE6_MATCHA = nor4(ZARE_STORE6_MATCH4n, ZEMU_STORE6_MATCH5n, ZYGO_STORE6_MATCH6n, ZUZY_STORE6_MATCH7n);
    /* p31.YDOT*/ wire YDOT_STORE6_MATCHB = nor4(XOSU_STORE6_MATCH0n, ZUVU_STORE6_MATCH1n, XUCO_STORE6_MATCH2n, ZULO_STORE6_MATCH3n);
    /* p31.CYCO*/ wire CYCO_STORE7_MATCHA = nor4(DUSE_STORE7_MATCH0n, DAGU_STORE7_MATCH1n, DYZE_STORE7_MATCH2n, DESO_STORE7_MATCH3n);
    /* p31.DAJE*/ wire DAJE_STORE7_MATCHB = nor4(EJOT_STORE7_MATCH4n, ESAJ_STORE7_MATCH5n, DUCU_STORE7_MATCH6n, EWUD_STORE7_MATCH7n);
    /* p31.DAMA*/ wire DAMA_STORE8_MATCHA = nor4(DUZE_STORE8_MATCH0n, DAGA_STORE8_MATCH1n, DAWU_STORE8_MATCH2n, EJAW_STORE8_MATCH3n);
    /* p31.FEHA*/ wire FEHA_STORE8_MATCHB = nor4(GOHO_STORE8_MATCH4n, GASU_STORE8_MATCH5n, GABU_STORE8_MATCH6n, GAFE_STORE8_MATCH7n);
    /* p31.YLEV*/ wire YLEV_STORE9_MATCHA = nor4(YMAM_STORE9_MATCH0n, YTYP_STORE9_MATCH1n, YFOP_STORE9_MATCH2n, YVAC_STORE9_MATCH3n);
    /* p31.YTUB*/ wire YTUB_STORE9_MATCHB = nor4(ZYWU_STORE9_MATCH4n, ZUZA_STORE9_MATCH5n, ZEJO_STORE9_MATCH6n, ZEDA_STORE9_MATCH7n);
    ...
    /* p29.YDUG*/ YDUG_STORE0_MATCHn = nand3(AROR_MATCH_ENp, ZAKO_STORE0_MATCHA, XEBA_STORE0_MATCHB);
    /* p29.DYDU*/ DYDU_STORE1_MATCHn = nand3(AROR_MATCH_ENp, EWAM_STORE1_MATCHA, CYVY_STORE1_MATCHB);
    /* p29.DEGO*/ DEGO_STORE2_MATCHn = nand3(AROR_MATCH_ENp, CEHU_STORE2_MATCHA, EKES_STORE2_MATCHB);
    /* p29.YLOZ*/ YLOZ_STORE3_MATCHn = nand3(AROR_MATCH_ENp, ZURE_STORE3_MATCHA, YWOS_STORE3_MATCHB);
    /* p29.XAGE*/ XAGE_STORE4_MATCHn = nand3(AROR_MATCH_ENp, YKOK_STORE4_MATCHA, YNAZ_STORE4_MATCHB);
    /* p29.EGOM*/ EGOM_STORE5_MATCHn = nand3(AROR_MATCH_ENp, COGY_STORE5_MATCHA, FYMA_STORE5_MATCHB);
    /* p29.YBEZ*/ YBEZ_STORE6_MATCHn = nand3(AROR_MATCH_ENp, YWAP_STORE6_MATCHA, YDOT_STORE6_MATCHB);
    /* p29.DYKA*/ DYKA_STORE7_MATCHn = nand3(AROR_MATCH_ENp, CYCO_STORE7_MATCHA, DAJE_STORE7_MATCHB);
    /* p29.EFYL*/ EFYL_STORE8_MATCHn = nand3(AROR_MATCH_ENp, DAMA_STORE8_MATCHA, FEHA_STORE8_MATCHB);
    /* p29.YGEM*/ YGEM_STORE9_MATCHn = nand3(AROR_MATCH_ENp, YLEV_STORE9_MATCHA, YTUB_STORE9_MATCHB);
...
void SpriteStore::tock(const SchematicTop& top) {
...

  {
    ...
    /*p29.BUZA*/ wire BUZA_STORE_SPRITE_INDX = and2(top.sprite_scanner.CENO_SCANNINGp.qn(), top.pix_pipe._XYMU_RENDERINGp.qp());

    /*p30.WUZY*/ SPR_TRI_I0 = tribuf_6n(BUZA_STORE_SPRITE_INDX, XADU_SPRITE_IDX0n.qn());
    /*p30.WYSE*/ SPR_TRI_I1 = tribuf_6n(BUZA_STORE_SPRITE_INDX, XEDY_SPRITE_IDX1n.qn());
    /*p30.ZYSU*/ SPR_TRI_I2 = tribuf_6n(BUZA_STORE_SPRITE_INDX, ZUZE_SPRITE_IDX2n.qn());
    /*p30.WYDA*/ SPR_TRI_I3 = tribuf_6n(BUZA_STORE_SPRITE_INDX, XOBE_SPRITE_IDX3n.qn());
    /*p30.WUCO*/ SPR_TRI_I4 = tribuf_6n(BUZA_STORE_SPRITE_INDX, YDUF_SPRITE_IDX4n.qn());
    /*p30.WEZA*/ SPR_TRI_I5 = tribuf_6n(BUZA_STORE_SPRITE_INDX, XECU_SPRITE_IDX5n.qn());
  }
...

  {
    ...
    /*#p31.ZAGO*/ wire ZAGO_OAM_DB0p = not1(top.oam_bus.YLOR_OAM_DB0n.qp());
    /* p31.ZOCY*/ wire ZOCY_OAM_DB1p = not1(top.oam_bus.ZYTY_OAM_DB1n.qp());
    /* p31.YPUR*/ wire YPUR_OAM_DB2p = not1(top.oam_bus.ZYVE_OAM_DB2n.qp());
    /* p31.YVOK*/ wire YVOK_OAM_DB3p = not1(top.oam_bus.ZEZY_OAM_DB3n.qp());
    /* p31.COSE*/ wire COSE_OAM_DB4p = not1(top.oam_bus.GOMO_OAM_DB4n.qp());
    /* p31.AROP*/ wire AROP_OAM_DB5p = not1(top.oam_bus.BAXO_OAM_DB5n.qp());
    /* p31.XATU*/ wire XATU_OAM_DB6p = not1(top.oam_bus.YZOS_OAM_DB6n.qp());
    /* p31.BADY*/ wire BADY_OAM_DB7p = not1(top.oam_bus.DEPO_OAM_DB7n.qp());
    ...
    // so this dff9 variant seems to work
    /*#p31.XEPE*/ XEPE_STORE0_X0p = dff9_A2(FUXU_STORE0_CLKp, !FUXU_STORE0_CLKp, DYNA_STORE0_RSTn, ZAGO_OAM_DB0p);
    /* p31.YLAH*/ YLAH_STORE0_X1p = dff9_A2(FUXU_STORE0_CLKp, !FUXU_STORE0_CLKp, DYNA_STORE0_RSTn, ZOCY_OAM_DB1p);
    /* p31.ZOLA*/ ZOLA_STORE0_X2p = dff9_A2(FUXU_STORE0_CLKp, !FUXU_STORE0_CLKp, DYNA_STORE0_RSTn, YPUR_OAM_DB2p);
    /* p31.ZULU*/ ZULU_STORE0_X3p = dff9_A2(FUXU_STORE0_CLKp, !FUXU_STORE0_CLKp, DYNA_STORE0_RSTn, YVOK_OAM_DB3p);
    /* p31.WELO*/ WELO_STORE0_X4p = dff9_A2(FUXU_STORE0_CLKp, !FUXU_STORE0_CLKp, DYNA_STORE0_RSTn, COSE_OAM_DB4p);
    /* p31.XUNY*/ XUNY_STORE0_X5p = dff9_A2(FUXU_STORE0_CLKp, !FUXU_STORE0_CLKp, DYNA_STORE0_RSTn, AROP_OAM_DB5p);
    /* p31.WOTE*/ WOTE_STORE0_X6p = dff9_A2(FUXU_STORE0_CLKp, !FUXU_STORE0_CLKp, DYNA_STORE0_RSTn, XATU_OAM_DB6p);
    /* p31.XAKO*/ XAKO_STORE0_X7p = dff9_A2(FUXU_STORE0_CLKp, !FUXU_STORE0_CLKp, DYNA_STORE0_RSTn, BADY_OAM_DB7p);
    ...
    /*p31.DANY*/ DANY_STORE1_X0 = dff9_A2(ASYS_STORE1_CLKp, !ASYS_STORE1_CLKp, DOKU_STORE1_RSTn, ZAGO_OAM_DB0p);
    /*p31.DUKO*/ DUKO_STORE1_X1 = dff9_A2(ASYS_STORE1_CLKp, !ASYS_STORE1_CLKp, DOKU_STORE1_RSTn, ZOCY_OAM_DB1p);
    /*p31.DESU*/ DESU_STORE1_X2 = dff9_A2(ASYS_STORE1_CLKp, !ASYS_STORE1_CLKp, DOKU_STORE1_RSTn, YPUR_OAM_DB2p);
    /*p31.DAZO*/ DAZO_STORE1_X3 = dff9_A2(ASYS_STORE1_CLKp, !ASYS_STORE1_CLKp, DOKU_STORE1_RSTn, YVOK_OAM_DB3p);
    /*p31.DAKE*/ DAKE_STORE1_X4 = dff9_A2(ASYS_STORE1_CLKp, !ASYS_STORE1_CLKp, DOKU_STORE1_RSTn, COSE_OAM_DB4p);
    /*p31.CESO*/ CESO_STORE1_X5 = dff9_A2(ASYS_STORE1_CLKp, !ASYS_STORE1_CLKp, DOKU_STORE1_RSTn, AROP_OAM_DB5p);
    /*p31.DYFU*/ DYFU_STORE1_X6 = dff9_A2(ASYS_STORE1_CLKp, !ASYS_STORE1_CLKp, DOKU_STORE1_RSTn, XATU_OAM_DB6p);
    /*p31.CUSY*/ CUSY_STORE1_X7 = dff9_A2(ASYS_STORE1_CLKp, !ASYS_STORE1_CLKp, DOKU_STORE1_RSTn, BADY_OAM_DB7p);
    ...
    /*p31.FOKA*/ FOKA_STORE2_X0 = dff9_A2(CACU_STORE2_CLKp, !CACU_STORE2_CLKp, GAMY_STORE2_RSTn, ZAGO_OAM_DB0p);
    /*p31.FYTY*/ FYTY_STORE2_X1 = dff9_A2(CACU_STORE2_CLKp, !CACU_STORE2_CLKp, GAMY_STORE2_RSTn, ZOCY_OAM_DB1p);
    /*p31.FUBY*/ FUBY_STORE2_X2 = dff9_A2(CACU_STORE2_CLKp, !CACU_STORE2_CLKp, GAMY_STORE2_RSTn, YPUR_OAM_DB2p);
    /*p31.GOXU*/ GOXU_STORE2_X3 = dff9_A2(CACU_STORE2_CLKp, !CACU_STORE2_CLKp, GAMY_STORE2_RSTn, YVOK_OAM_DB3p);
    /*p31.DUHY*/ DUHY_STORE2_X4 = dff9_A2(CACU_STORE2_CLKp, !CACU_STORE2_CLKp, GAMY_STORE2_RSTn, COSE_OAM_DB4p);
    /*p31.EJUF*/ EJUF_STORE2_X5 = dff9_A2(CACU_STORE2_CLKp, !CACU_STORE2_CLKp, GAMY_STORE2_RSTn, AROP_OAM_DB5p);
    /*p31.ENOR*/ ENOR_STORE2_X6 = dff9_A2(CACU_STORE2_CLKp, !CACU_STORE2_CLKp, GAMY_STORE2_RSTn, XATU_OAM_DB6p);
    /*p31.DEPY*/ DEPY_STORE2_X7 = dff9_A2(CACU_STORE2_CLKp, !CACU_STORE2_CLKp, GAMY_STORE2_RSTn, BADY_OAM_DB7p);
    ...
    /*p31.XOLY*/ XOLY_STORE3_X0 = dff9_A2(YFAG_STORE3_CLKp, !YFAG_STORE3_CLKp, WUPA_STORE3_RSTn, ZAGO_OAM_DB0p);
    /*p31.XYBA*/ XYBA_STORE3_X1 = dff9_A2(YFAG_STORE3_CLKp, !YFAG_STORE3_CLKp, WUPA_STORE3_RSTn, ZOCY_OAM_DB1p);
    /*p31.XABE*/ XABE_STORE3_X2 = dff9_A2(YFAG_STORE3_CLKp, !YFAG_STORE3_CLKp, WUPA_STORE3_RSTn, YPUR_OAM_DB2p);
    /*p31.XEKA*/ XEKA_STORE3_X3 = dff9_A2(YFAG_STORE3_CLKp, !YFAG_STORE3_CLKp, WUPA_STORE3_RSTn, YVOK_OAM_DB3p);
    /*p31.XOMY*/ XOMY_STORE3_X4 = dff9_A2(YFAG_STORE3_CLKp, !YFAG_STORE3_CLKp, WUPA_STORE3_RSTn, COSE_OAM_DB4p);
    /*p31.WUHA*/ WUHA_STORE3_X5 = dff9_A2(YFAG_STORE3_CLKp, !YFAG_STORE3_CLKp, WUPA_STORE3_RSTn, AROP_OAM_DB5p);
    /*p31.WYNA*/ WYNA_STORE3_X6 = dff9_A2(YFAG_STORE3_CLKp, !YFAG_STORE3_CLKp, WUPA_STORE3_RSTn, XATU_OAM_DB6p);
    /*p31.WECO*/ WECO_STORE3_X7 = dff9_A2(YFAG_STORE3_CLKp, !YFAG_STORE3_CLKp, WUPA_STORE3_RSTn, BADY_OAM_DB7p);
    ...
    /*p31.WEDU*/ WEDU_STORE4_X0 = dff9_A2(WOFO_STORE4_CLKp, !WOFO_STORE4_CLKp, WUNU_STORE4_RSTn, ZAGO_OAM_DB0p);
    /*p31.YGAJ*/ YGAJ_STORE4_X1 = dff9_A2(WOFO_STORE4_CLKp, !WOFO_STORE4_CLKp, WUNU_STORE4_RSTn, ZOCY_OAM_DB1p);
    /*p31.ZYJO*/ ZYJO_STORE4_X2 = dff9_A2(WOFO_STORE4_CLKp, !WOFO_STORE4_CLKp, WUNU_STORE4_RSTn, YPUR_OAM_DB2p);
    /*p31.XURY*/ XURY_STORE4_X3 = dff9_A2(WOFO_STORE4_CLKp, !WOFO_STORE4_CLKp, WUNU_STORE4_RSTn, YVOK_OAM_DB3p);
    /*p31.YBED*/ YBED_STORE4_X4 = dff9_A2(WOFO_STORE4_CLKp, !WOFO_STORE4_CLKp, WUNU_STORE4_RSTn, COSE_OAM_DB4p);
    /*p31.ZALA*/ ZALA_STORE4_X5 = dff9_A2(WOFO_STORE4_CLKp, !WOFO_STORE4_CLKp, WUNU_STORE4_RSTn, AROP_OAM_DB5p);
    /*p31.WYDE*/ WYDE_STORE4_X6 = dff9_A2(WOFO_STORE4_CLKp, !WOFO_STORE4_CLKp, WUNU_STORE4_RSTn, XATU_OAM_DB6p);
    /*p31.XEPA*/ XEPA_STORE4_X7 = dff9_A2(WOFO_STORE4_CLKp, !WOFO_STORE4_CLKp, WUNU_STORE4_RSTn, BADY_OAM_DB7p);
    ...
    /*p31.FUSA*/ FUSA_STORE5_X0 = dff9_A2(CYLA_STORE5_CLKp, !CYLA_STORE5_CLKp, EJAD_STORE5_RSTn, ZAGO_OAM_DB0p);
    /*p31.FAXA*/ FAXA_STORE5_X1 = dff9_A2(CYLA_STORE5_CLKp, !CYLA_STORE5_CLKp, EJAD_STORE5_RSTn, ZOCY_OAM_DB1p);
    /*p31.FOZY*/ FOZY_STORE5_X2 = dff9_A2(CYLA_STORE5_CLKp, !CYLA_STORE5_CLKp, EJAD_STORE5_RSTn, YPUR_OAM_DB2p);
    /*p31.FESY*/ FESY_STORE5_X3 = dff9_A2(CYLA_STORE5_CLKp, !CYLA_STORE5_CLKp, EJAD_STORE5_RSTn, YVOK_OAM_DB3p);
    /*p31.CYWE*/ CYWE_STORE5_X4 = dff9_A2(CYLA_STORE5_CLKp, !CYLA_STORE5_CLKp, EJAD_STORE5_RSTn, COSE_OAM_DB4p);
    /*p31.DYBY*/ DYBY_STORE5_X5 = dff9_A2(CYLA_STORE5_CLKp, !CYLA_STORE5_CLKp, EJAD_STORE5_RSTn, AROP_OAM_DB5p);
    /*p31.DURY*/ DURY_STORE5_X6 = dff9_A2(CYLA_STORE5_CLKp, !CYLA_STORE5_CLKp, EJAD_STORE5_RSTn, XATU_OAM_DB6p);
    /*p31.CUVY*/ CUVY_STORE5_X7 = dff9_A2(CYLA_STORE5_CLKp, !CYLA_STORE5_CLKp, EJAD_STORE5_RSTn, BADY_OAM_DB7p);
    ...
    /*p31.YCOL*/ YCOL_STORE6_X0 = dff9_A2(ZAPE_STORE6_CLKp, !ZAPE_STORE6_CLKp, XAHO_STORE6_RSTn, ZAGO_OAM_DB0p);
    /*p31.YRAC*/ YRAC_STORE6_X1 = dff9_A2(ZAPE_STORE6_CLKp, !ZAPE_STORE6_CLKp, XAHO_STORE6_RSTn, ZOCY_OAM_DB1p);
    /*p31.YMEM*/ YMEM_STORE6_X2 = dff9_A2(ZAPE_STORE6_CLKp, !ZAPE_STORE6_CLKp, XAHO_STORE6_RSTn, YPUR_OAM_DB2p);
    /*p31.YVAG*/ YVAG_STORE6_X3 = dff9_A2(ZAPE_STORE6_CLKp, !ZAPE_STORE6_CLKp, XAHO_STORE6_RSTn, YVOK_OAM_DB3p);
    /*p31.ZOLY*/ ZOLY_STORE6_X4 = dff9_A2(ZAPE_STORE6_CLKp, !ZAPE_STORE6_CLKp, XAHO_STORE6_RSTn, COSE_OAM_DB4p);
    /*p31.ZOGO*/ ZOGO_STORE6_X5 = dff9_A2(ZAPE_STORE6_CLKp, !ZAPE_STORE6_CLKp, XAHO_STORE6_RSTn, AROP_OAM_DB5p);
    /*p31.ZECU*/ ZECU_STORE6_X6 = dff9_A2(ZAPE_STORE6_CLKp, !ZAPE_STORE6_CLKp, XAHO_STORE6_RSTn, XATU_OAM_DB6p);
    /*p31.ZESA*/ ZESA_STORE6_X7 = dff9_A2(ZAPE_STORE6_CLKp, !ZAPE_STORE6_CLKp, XAHO_STORE6_RSTn, BADY_OAM_DB7p);
    ...
    /*p31.ERAZ*/ ERAZ_STORE7_X0 = dff9_A2(GECY_STORE7_CLKp, !GECY_STORE7_CLKp, GAFY_STORE7_RSTn, ZAGO_OAM_DB0p);
    /*p31.EPUM*/ EPUM_STORE7_X1 = dff9_A2(GECY_STORE7_CLKp, !GECY_STORE7_CLKp, GAFY_STORE7_RSTn, ZOCY_OAM_DB1p);
    /*p31.EROL*/ EROL_STORE7_X2 = dff9_A2(GECY_STORE7_CLKp, !GECY_STORE7_CLKp, GAFY_STORE7_RSTn, YPUR_OAM_DB2p);
    /*p31.EHYN*/ EHYN_STORE7_X3 = dff9_A2(GECY_STORE7_CLKp, !GECY_STORE7_CLKp, GAFY_STORE7_RSTn, YVOK_OAM_DB3p);
    /*p31.FAZU*/ FAZU_STORE7_X4 = dff9_A2(GECY_STORE7_CLKp, !GECY_STORE7_CLKp, GAFY_STORE7_RSTn, COSE_OAM_DB4p);
    /*p31.FAXE*/ FAXE_STORE7_X5 = dff9_A2(GECY_STORE7_CLKp, !GECY_STORE7_CLKp, GAFY_STORE7_RSTn, AROP_OAM_DB5p);
    /*p31.EXUK*/ EXUK_STORE7_X6 = dff9_A2(GECY_STORE7_CLKp, !GECY_STORE7_CLKp, GAFY_STORE7_RSTn, XATU_OAM_DB6p);
    /*p31.FEDE*/ FEDE_STORE7_X7 = dff9_A2(GECY_STORE7_CLKp, !GECY_STORE7_CLKp, GAFY_STORE7_RSTn, BADY_OAM_DB7p);
    ...
    /*p31.GAVY*/ GAVY_STORE8_X4 = dff9_A2(CEXU_STORE8_CLKp, !CEXU_STORE8_CLKp, WUZO_STORE8_RSTn, ZAGO_OAM_DB0p);
    /*p31.GYPU*/ GYPU_STORE8_X5 = dff9_A2(CEXU_STORE8_CLKp, !CEXU_STORE8_CLKp, WUZO_STORE8_RSTn, ZOCY_OAM_DB1p);
    /*p31.GADY*/ GADY_STORE8_X6 = dff9_A2(CEXU_STORE8_CLKp, !CEXU_STORE8_CLKp, WUZO_STORE8_RSTn, YPUR_OAM_DB2p);
    /*p31.GAZA*/ GAZA_STORE8_X7 = dff9_A2(CEXU_STORE8_CLKp, !CEXU_STORE8_CLKp, WUZO_STORE8_RSTn, YVOK_OAM_DB3p);
    /*p31.EZUF*/ EZUF_STORE8_X0 = dff9_A2(CEXU_STORE8_CLKp, !CEXU_STORE8_CLKp, WUZO_STORE8_RSTn, COSE_OAM_DB4p);
    /*p31.ENAD*/ ENAD_STORE8_X1 = dff9_A2(CEXU_STORE8_CLKp, !CEXU_STORE8_CLKp, WUZO_STORE8_RSTn, AROP_OAM_DB5p);
    /*p31.EBOW*/ EBOW_STORE8_X2 = dff9_A2(CEXU_STORE8_CLKp, !CEXU_STORE8_CLKp, WUZO_STORE8_RSTn, XATU_OAM_DB6p);
    /*p31.FYCA*/ FYCA_STORE8_X3 = dff9_A2(CEXU_STORE8_CLKp, !CEXU_STORE8_CLKp, WUZO_STORE8_RSTn, BADY_OAM_DB7p);
    ...
    /*p31.XUVY*/ XUVY_STORE9_X0 = dff9_A2(WEME_STORE9_CLKp, !WEME_STORE9_CLKp, DOSY_STORE9_RSTn, ZAGO_OAM_DB0p);
    /*p31.XERE*/ XERE_STORE9_X1 = dff9_A2(WEME_STORE9_CLKp, !WEME_STORE9_CLKp, DOSY_STORE9_RSTn, ZOCY_OAM_DB1p);
    /*p31.XUZO*/ XUZO_STORE9_X2 = dff9_A2(WEME_STORE9_CLKp, !WEME_STORE9_CLKp, DOSY_STORE9_RSTn, YPUR_OAM_DB2p);
    /*p31.XEXA*/ XEXA_STORE9_X3 = dff9_A2(WEME_STORE9_CLKp, !WEME_STORE9_CLKp, DOSY_STORE9_RSTn, YVOK_OAM_DB3p);
    /*p31.YPOD*/ YPOD_STORE9_X4 = dff9_A2(WEME_STORE9_CLKp, !WEME_STORE9_CLKp, DOSY_STORE9_RSTn, COSE_OAM_DB4p);
    /*p31.YROP*/ YROP_STORE9_X5 = dff9_A2(WEME_STORE9_CLKp, !WEME_STORE9_CLKp, DOSY_STORE9_RSTn, AROP_OAM_DB5p);
    /*p31.YNEP*/ YNEP_STORE9_X6 = dff9_A2(WEME_STORE9_CLKp, !WEME_STORE9_CLKp, DOSY_STORE9_RSTn, XATU_OAM_DB6p);
    /*p31.YZOF*/ YZOF_STORE9_X7 = dff9_A2(WEME_STORE9_CLKp, !WEME_STORE9_CLKp, DOSY_STORE9_RSTn, BADY_OAM_DB7p);
  }
}
