...
void TileFetcher::tock(SchematicTop& top, CpuBus& cpu_bus) {
  ...
  {
    /*p24.NAFY*/ wire _NAFY_RENDERING_AND_NOT_WIN_TRIG = nor(top.win_reg.MOSU_TILE_FETCHER_RSTp(), top.ppu_reg.LOBY_RENDERINGn());
  ...
  {
    /*p27.MYSO*/ wire _MYSO_BG_TRIGp        = nor(top.ppu_reg.LOBY_RENDERINGn(), LAXE_BFETCH_S0n(), _LYZU_BFETCH_S0_DELAY.q());
  ...
  // FF42 SCY
  {
    ...
    /*p23.GAVE*/ GAVE_SCY0.set(_CAVO_FF42_WRn, !_CAVO_FF42_WRn, top.rst_reg.CUNU_SYS_RSTn(), top.cpu_bus.CPU_TRI_D0.q());
    /*p23.FYMO*/ FYMO_SCY1.set(_CAVO_FF42_WRn, !_CAVO_FF42_WRn, top.rst_reg.CUNU_SYS_RSTn(), top.cpu_bus.CPU_TRI_D1.q());
    /*p23.FEZU*/ FEZU_SCY2.set(_CAVO_FF42_WRn, !_CAVO_FF42_WRn, top.rst_reg.CUNU_SYS_RSTn(), top.cpu_bus.CPU_TRI_D2.q());
    /*p23.FUJO*/ FUJO_SCY3.set(_CAVO_FF42_WRn, !_CAVO_FF42_WRn, top.rst_reg.CUNU_SYS_RSTn(), top.cpu_bus.CPU_TRI_D3.q());
    /*p23.DEDE*/ DEDE_SCY4.set(_CAVO_FF42_WRn, !_CAVO_FF42_WRn, top.rst_reg.CUNU_SYS_RSTn(), top.cpu_bus.CPU_TRI_D4.q());
    /*p23.FOTY*/ FOTY_SCY5.set(_CAVO_FF42_WRn, !_CAVO_FF42_WRn, top.rst_reg.CUNU_SYS_RSTn(), top.cpu_bus.CPU_TRI_D5.q());
    /*p23.FOHA*/ FOHA_SCY6.set(_CAVO_FF42_WRn, !_CAVO_FF42_WRn, top.rst_reg.CUNU_SYS_RSTn(), top.cpu_bus.CPU_TRI_D6.q());
    /*p23.FUNY*/ FUNY_SCY7.set(_CAVO_FF42_WRn, !_CAVO_FF42_WRn, top.rst_reg.CUNU_SYS_RSTn(), top.cpu_bus.CPU_TRI_D7.q());
  ...
  // FF43 SCX
  {
    ...
    /*p23.DATY*/ DATY_SCX0.set(_AMUN_FF43_WRn, !_AMUN_FF43_WRn, top.rst_reg.CUNU_SYS_RSTn(), top.cpu_bus.CPU_TRI_D0.q());
    /*p23.DUZU*/ DUZU_SCX1.set(_AMUN_FF43_WRn, !_AMUN_FF43_WRn, top.rst_reg.CUNU_SYS_RSTn(), top.cpu_bus.CPU_TRI_D1.q());
    /*p23.CYXU*/ CYXU_SCX2.set(_AMUN_FF43_WRn, !_AMUN_FF43_WRn, top.rst_reg.CUNU_SYS_RSTn(), top.cpu_bus.CPU_TRI_D2.q());
    /*p23.GUBO*/ GUBO_SCX3.set(_AMUN_FF43_WRn, !_AMUN_FF43_WRn, top.rst_reg.CUNU_SYS_RSTn(), top.cpu_bus.CPU_TRI_D3.q());
    /*p23.BEMY*/ BEMY_SCX4.set(_AMUN_FF43_WRn, !_AMUN_FF43_WRn, top.rst_reg.CUNU_SYS_RSTn(), top.cpu_bus.CPU_TRI_D4.q());
    /*p23.CUZY*/ CUZY_SCX5.set(_AMUN_FF43_WRn, !_AMUN_FF43_WRn, top.rst_reg.CUNU_SYS_RSTn(), top.cpu_bus.CPU_TRI_D5.q());
    /*p23.CABU*/ CABU_SCX6.set(_AMUN_FF43_WRn, !_AMUN_FF43_WRn, top.rst_reg.CUNU_SYS_RSTn(), top.cpu_bus.CPU_TRI_D6.q());
    /*p23.BAKE*/ BAKE_SCX7.set(_AMUN_FF43_WRn, !_AMUN_FF43_WRn, top.rst_reg.CUNU_SYS_RSTn(), top.cpu_bus.CPU_TRI_D7.q());
