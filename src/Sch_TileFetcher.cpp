...
TileFetcherSignals TileFetcher::sig(const TestGB& gb) const {
  ...
  /*p27.MOCE*/ wire _MOCE_BFETCH_DONEn = nand(LAXU_BFETCH_S0, NYVA_FETCH_TILE_AB, ppu_sig.NYXU_BFETCH_RSTn);
...
void TileFetcher::tick(TestGB& gb) {
  ...
  /*p27.NOFU*/ wire NOFU_FETCH_TILE_AB = not(NYVA_FETCH_TILE_AB.q());
...

  {
    ...
    /*p27.LURY*/ wire LURY_BG_READ_VRAM_LATCH_RSTn = and(!LOVY_BG_SEQ5_SYNC, ppu_sig.XYMU_RENDERINGp);
    /*p27.LONY*/ LONY_BG_READ_VRAM_LATCHp.nand_latch(ppu_sig.NYXU_BFETCH_RSTn, LURY_BG_READ_VRAM_LATCH_RSTn);

    /*p27.MOCE*/ wire MOCE_BFETCH_DONEn = nand(LAXU_BFETCH_S0, NYVA_FETCH_TILE_AB, ppu_sig.NYXU_BFETCH_RSTn);
...

  {
    ...
    /*p27.NYDY*/ wire NYDY_LATCH_BG_PIX_Ap = nand(MYSO_BG_TRIGn, MESU_BFETCH_S1.q(), NOFU_FETCH_TILE_AB);
    /*p27.MOFU*/ wire MOFU_LATCH_BG_PIX_Bn = and (MYSO_BG_TRIGn, NAKO_FETCH_S1n);
...

  {
    ...
    /*p27.NYVA*/ NYVA_FETCH_TILE_AB.set(!MESU_BFETCH_S1, ppu_sig.NYXU_BFETCH_RSTn, !NYVA_FETCH_TILE_AB);
  }
...
#if 0
    /*p26.BAFY*/ wire BAFY_BG_MAP_READn = nand(LONY_BG_READ_VRAM_LATCHp, tile_fetcher_sig.NAKO_FETCH_S1n, tile_fetcher_sig.NOFU_FETCH_TILE_AB, !win_sig.PORE_WIN_MODE);
...

  {
    // Window map read
#if 0
    /*p25.WUKO*/ wire WUKO_WIN_MAP_READn = nand(LONY_BG_READ_VRAM_LATCHp, tile_fetcher_sig.NAKO_FETCH_S1n, tile_fetcher_sig.NOFU_FETCH_TILE_AB, win_sig.PORE_WIN_MODE));
#else
    /*p27.LUSU*/ wire LUSU_BGW_VRAM_RDn = not(LONY_BG_READ_VRAM_LATCHp);
    /*p27.LENA*/ wire LENA_BGW_VRAM_RD = not(LUSU_BGW_VRAM_RDn);
    /*p27.NOGU*/ wire NOGU_FETCH_01p = nand(NAKO_FETCH_S1n, NOFU_FETCH_TILE_AB);
    /*p27.NENY*/ wire NENY_FETCH_01n = not(NOGU_FETCH_01p);
    /*p27.POTU*/ wire POTU_BGW_FETCH_01 = and (LENA_BGW_VRAM_RD, NENY_FETCH_01n);
    /*p25.XEZE*/ wire XEZE_WIN_MAP_READp = and (POTU_BGW_FETCH_01, win_sig.PORE_WIN_MODE);
...

  {
    ...
    /*p27.NOGU*/ wire NOGU_FETCH_01p  = nand(tile_fetcher_sig.NAKO_FETCH_S1n, tile_fetcher_sig.NOFU_FETCH_TILE_AB);
    /*p26.BEJE*/ wire BEJE_TILE_READn = nand(LONY_BG_READ_VRAM_LATCHp, NOGU_FETCH_01p, !win_sig.PORE_WIN_MODE);
    /*p25.XUCY*/ wire XUCY_TILE_READn = nand(LONY_BG_READ_VRAM_LATCHp, NOGU_FETCH_01p,  win_sig.PORE_WIN_MODE);
    /*p27.NETA*/ wire NETA_TILE_READn = and (LONY_BG_READ_VRAM_LATCHp, NOGU_FETCH_01p);
...
bool TileFetcher::commit() {
  ...
  changed |= NYVA_FETCH_TILE_AB.commit_reg();
