...
struct TileFetcher {
  ...
  // -> vram bus
  /*p27.NAKO*/ wire NAKO_BFETCH_S1n() const { return not1(_MESU_BFETCH_S1.q()); }

  // -> vram bus
  /*p27.NOFU*/ wire NOFU_BFETCH_S2n() const { return not1(_NYVA_BFETCH_S2.q()); }
...
//private:
  /*p27.LAXE*/ wire LAXE_BFETCH_S0n() const { return not1(_LAXU_BFETCH_S0.q()); }
  /*p27.MOCE*/ wire MOCE_BFETCH_DONEn() const { return nand3(_LAXU_BFETCH_S0.q(), _NYVA_BFETCH_S2.q(), _NYXU_TILE_FETCHER_RSTn); }
