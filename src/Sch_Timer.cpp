...
void TimerRegisters::tick(TestGB& gb) {
  ...
  // FF05 TIMA
  {
    ...
    /*p03.ROKE*/ wire _TIMA_MUX_0 = mux2_n(TMA_0.q(), cpu_bus.TS_D0, _TOPE_FF05_WRn);
    /*p03.PETU*/ wire _TIMA_MUX_1 = mux2_n(TMA_1.q(), cpu_bus.TS_D1, _TOPE_FF05_WRn);
    /*p03.NYKU*/ wire _TIMA_MUX_2 = mux2_n(TMA_2.q(), cpu_bus.TS_D2, _TOPE_FF05_WRn); // die annotation box wrong, this is a 5-rung
    /*p03.SOCE*/ wire _TIMA_MUX_3 = mux2_n(TMA_3.q(), cpu_bus.TS_D3, _TOPE_FF05_WRn);
    /*p03.SALA*/ wire _TIMA_MUX_4 = mux2_n(TMA_4.q(), cpu_bus.TS_D4, _TOPE_FF05_WRn);
    /*p03.SYRU*/ wire _TIMA_MUX_5 = mux2_n(TMA_5.q(), cpu_bus.TS_D5, _TOPE_FF05_WRn);
    /*p03.REFU*/ wire _TIMA_MUX_6 = mux2_n(TMA_6.q(), cpu_bus.TS_D6, _TOPE_FF05_WRn);
    /*p03.RATO*/ wire _TIMA_MUX_7 = mux2_n(TMA_7.q(), cpu_bus.TS_D7, _TOPE_FF05_WRn);
    ...
    /*p03.SOKU*/ cpu_bus.TS_D0.set_tribuf(_TEDA_FF05_RD, TIMA_0.q());
    /*p03.RACY*/ cpu_bus.TS_D1.set_tribuf(_TEDA_FF05_RD, TIMA_1.q());
    /*p03.RAVY*/ cpu_bus.TS_D2.set_tribuf(_TEDA_FF05_RD, TIMA_2.q());
    /*p03.SOSY*/ cpu_bus.TS_D3.set_tribuf(_TEDA_FF05_RD, TIMA_3.q());
    /*p03.SOMU*/ cpu_bus.TS_D4.set_tribuf(_TEDA_FF05_RD, TIMA_4.q());
    /*p03.SURO*/ cpu_bus.TS_D5.set_tribuf(_TEDA_FF05_RD, TIMA_5.q());
    /*p03.ROWU*/ cpu_bus.TS_D6.set_tribuf(_TEDA_FF05_RD, TIMA_6.q());
    /*p03.PUSO*/ cpu_bus.TS_D7.set_tribuf(_TEDA_FF05_RD, TIMA_7.q());
  }
...

  {
    ...
    /*p03.MOBA*/ MOBA_INT_TIMERp.set(clk_sig.PIN_BOGA_AxCDEFGH, rst_sig.ALUR_RSTn, _MERY_INT_TIMER_IN);
  }
