...
void Timer::tock(const SchematicTop& top, CpuBus& cpu_bus) {
  ...
  // FF04 DIV
  {
    ...
    /*p01.TAWU*/ cpu_bus.CPU_TRI_D0.set_tribuf_6p(_TAGY_FF04_RDp, not(UMEK_DIV_06n()));
    /*p01.TAKU*/ cpu_bus.CPU_TRI_D1.set_tribuf_6p(_TAGY_FF04_RDp, not(UREK_DIV_07n()));
    /*p01.TEMU*/ cpu_bus.CPU_TRI_D2.set_tribuf_6p(_TAGY_FF04_RDp, not(_UTOK_DIV_08n));
    /*p01.TUSE*/ cpu_bus.CPU_TRI_D3.set_tribuf_6p(_TAGY_FF04_RDp, not(_SAPY_DIV_09n));
    /*p01.UPUG*/ cpu_bus.CPU_TRI_D4.set_tribuf_6p(_TAGY_FF04_RDp, not(_UMER_DIV_10n));
    /*p01.SEPU*/ cpu_bus.CPU_TRI_D5.set_tribuf_6p(_TAGY_FF04_RDp, not(_RAVE_DIV_11n));
    /*p01.SAWA*/ cpu_bus.CPU_TRI_D6.set_tribuf_6p(_TAGY_FF04_RDp, not(_RYSO_DIV_12n));
    /*p01.TATU*/ cpu_bus.CPU_TRI_D7.set_tribuf_6p(_TAGY_FF04_RDp, not(_UDOR_DIV_13n));
  }
  ...
  // FF05 TIMA
  {
    ...
    /*p03.RAVY*/ cpu_bus.CPU_TRI_D2.set_tribuf_6p(_TEDA_FF05_RDp, PERU_TIMA_2.q());
    /*p03.SOSY*/ cpu_bus.CPU_TRI_D3.set_tribuf_6p(_TEDA_FF05_RDp, RATE_TIMA_3.q());
    /*p03.SOMU*/ cpu_bus.CPU_TRI_D4.set_tribuf_6p(_TEDA_FF05_RDp, RUBY_TIMA_4.q());
    /*p03.SURO*/ cpu_bus.CPU_TRI_D5.set_tribuf_6p(_TEDA_FF05_RDp, RAGE_TIMA_5.q());
    /*p03.ROWU*/ cpu_bus.CPU_TRI_D6.set_tribuf_6p(_TEDA_FF05_RDp, PEDA_TIMA_6.q());
    /*p03.PUSO*/ cpu_bus.CPU_TRI_D7.set_tribuf_6p(_TEDA_FF05_RDp, NUGA_TIMA_7.q());
  ...
  // FF06 TMA
  {
    ...
    /*p03.SETE*/ cpu_bus.CPU_TRI_D0.set_tribuf_6p(_TUBY_FF06_RDp, SABU_TMA_0.q());
    /*p03.PYRE*/ cpu_bus.CPU_TRI_D1.set_tribuf_6p(_TUBY_FF06_RDp, NYKE_TMA_1.q());
    /*p03.NOLA*/ cpu_bus.CPU_TRI_D2.set_tribuf_6p(_TUBY_FF06_RDp, MURU_TMA_2.q());
    /*p03.SALU*/ cpu_bus.CPU_TRI_D3.set_tribuf_6p(_TUBY_FF06_RDp, TYVA_TMA_3.q());
    /*p03.SUPO*/ cpu_bus.CPU_TRI_D4.set_tribuf_6p(_TUBY_FF06_RDp, TYRU_TMA_4.q());
    /*p03.SOTU*/ cpu_bus.CPU_TRI_D5.set_tribuf_6p(_TUBY_FF06_RDp, SUFY_TMA_5.q());
    /*p03.REVA*/ cpu_bus.CPU_TRI_D6.set_tribuf_6p(_TUBY_FF06_RDp, PETO_TMA_6.q());
    /*p03.SAPU*/ cpu_bus.CPU_TRI_D7.set_tribuf_6p(_TUBY_FF06_RDp, SETA_TMA_7.q());
  }
  ...
  // FF07 TAC
  {
    ...
    /*p03.RYLA*/ cpu_bus.CPU_TRI_D0.set_tribuf_6p(_SORA_FF07_RDp, SOPU_TAC_0.q());
    /*p03.ROTE*/ cpu_bus.CPU_TRI_D1.set_tribuf_6p(_SORA_FF07_RDp, SAMY_TAC_1.q());
    /*p03.SUPE*/ cpu_bus.CPU_TRI_D2.set_tribuf_6p(_SORA_FF07_RDp, SABO_TAC_2.q());
  }
}
