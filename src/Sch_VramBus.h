...
struct VramBus {
  ...
  /*p33.PEFO*/ RegQN PEFO_SPRITE_DA0 = REG_D0C0;
  /*p33.ROKA*/ RegQN ROKA_SPRITE_DA1 = REG_D0C0;
  /*p33.MYTU*/ RegQN MYTU_SPRITE_DA2 = REG_D0C0;
  /*p33.RAMU*/ RegQN RAMU_SPRITE_DA3 = REG_D0C0;
  /*p33.SELE*/ RegQN SELE_SPRITE_DA4 = REG_D0C0;
  /*p33.SUTO*/ RegQN SUTO_SPRITE_DA5 = REG_D0C0;
  /*p33.RAMA*/ RegQN RAMA_SPRITE_DA6 = REG_D0C0;
  /*p33.RYDU*/ RegQN RYDU_SPRITE_DA7 = REG_D0C0;

  /*p33.REWO*/ RegQN REWO_SPRITE_DB0 = REG_D0C0;
  /*p33.PEBA*/ RegQN PEBA_SPRITE_DB1 = REG_D0C0;
  /*p33.MOFO*/ RegQN MOFO_SPRITE_DB2 = REG_D0C0;
  /*p33.PUDU*/ RegQN PUDU_SPRITE_DB3 = REG_D0C0;
  /*p33.SAJA*/ RegQN SAJA_SPRITE_DB4 = REG_D0C0;
  /*p33.SUNY*/ RegQN SUNY_SPRITE_DB5 = REG_D0C0;
  /*p33.SEMO*/ RegQN SEMO_SPRITE_DB6 = REG_D0C0;
  /*p33.SEGA*/ RegQN SEGA_SPRITE_DB7 = REG_D0C0;
