...
const Pin2 Pin2::HIZ_NP = {PIN_HZNP};
const Pin2 Pin2::HIZ_PU = {PIN_HZPU};
const Pin2 Pin2::HIZ_PD = {PIN_HZPD};
...
// all reg states + x = x
CHECK_LOGIC(REG_D0C0, SIG_NONE, REG_XXXX);
CHECK_LOGIC(REG_D1C0, SIG_NONE, REG_XXXX);
CHECK_LOGIC(REG_D0C1, SIG_NONE, REG_XXXX);
CHECK_LOGIC(REG_D1C1, SIG_NONE, REG_XXXX);
...
// lo-z pin states + x = x
CHECK_LOGIC(PIN_D0PD, SIG_NONE, PIN_XXXX);
CHECK_LOGIC(PIN_D1PD, SIG_NONE, PIN_XXXX);
CHECK_LOGIC(PIN_D0PU, SIG_NONE, PIN_XXXX);
CHECK_LOGIC(PIN_D1PU, SIG_NONE, PIN_XXXX);
CHECK_LOGIC(PIN_D0NP, SIG_NONE, PIN_XXXX);
CHECK_LOGIC(PIN_D1NP, SIG_NONE, PIN_XXXX);
...
// hi-z pin states + x = x
CHECK_LOGIC(PIN_HZPD, SIG_NONE, PIN_XXXX);
CHECK_LOGIC(PIN_HZPU, SIG_NONE, PIN_XXXX);
CHECK_LOGIC(PIN_HZNP, SIG_NONE, PIN_XXXX);
...
//-----------------------------------------------------------------------------
// temp signals reset state to 0 on commit

CHECK_LOGIC(REG_D0C0, SIG_TEMP, SIG_XXXX);
CHECK_LOGIC(REG_D1C0, SIG_TEMP, SIG_XXXX);
CHECK_LOGIC(REG_D0C1, SIG_TEMP, SIG_XXXX);
CHECK_LOGIC(REG_D1C1, SIG_TEMP, SIG_XXXX);
CHECK_LOGIC(PIN_D0PD, SIG_TEMP, SIG_XXXX);
CHECK_LOGIC(PIN_D1PD, SIG_TEMP, SIG_XXXX);
CHECK_LOGIC(PIN_D0PU, SIG_TEMP, SIG_XXXX);
CHECK_LOGIC(PIN_D1PU, SIG_TEMP, SIG_XXXX);
CHECK_LOGIC(PIN_D0NP, SIG_TEMP, SIG_XXXX);
CHECK_LOGIC(PIN_D1NP, SIG_TEMP, SIG_XXXX);
CHECK_LOGIC(PIN_HZPD, SIG_TEMP, SIG_XXXX);
CHECK_LOGIC(PIN_HZPU, SIG_TEMP, SIG_XXXX);
CHECK_LOGIC(PIN_HZNP, SIG_TEMP, SIG_XXXX);
CHECK_LOGIC(REG_XXXX, SIG_TEMP, SIG_XXXX);
CHECK_LOGIC(PIN_XXXX, SIG_TEMP, SIG_XXXX);
CHECK_LOGIC(SIG_XXXX, SIG_TEMP, SIG_XXXX);

//-----------------------------------------------------------------------------
// meaningless, free slot

CHECK_LOGIC(REG_D0C0, SIG_QQQQ, SIG_XXXX);
CHECK_LOGIC(REG_D1C0, SIG_QQQQ, SIG_XXXX);
CHECK_LOGIC(REG_D0C1, SIG_QQQQ, SIG_XXXX);
CHECK_LOGIC(REG_D1C1, SIG_QQQQ, SIG_XXXX);
CHECK_LOGIC(PIN_D0PD, SIG_QQQQ, SIG_XXXX);
CHECK_LOGIC(PIN_D1PD, SIG_QQQQ, SIG_XXXX);
CHECK_LOGIC(PIN_D0PU, SIG_QQQQ, SIG_XXXX);
CHECK_LOGIC(PIN_D1PU, SIG_QQQQ, SIG_XXXX);
CHECK_LOGIC(PIN_D0NP, SIG_QQQQ, SIG_XXXX);
CHECK_LOGIC(PIN_D1NP, SIG_QQQQ, SIG_XXXX);
CHECK_LOGIC(PIN_HZPD, SIG_QQQQ, SIG_XXXX);
CHECK_LOGIC(PIN_HZPU, SIG_QQQQ, SIG_XXXX);
CHECK_LOGIC(PIN_HZNP, SIG_QQQQ, SIG_XXXX);
CHECK_LOGIC(REG_XXXX, SIG_QQQQ, SIG_XXXX);
CHECK_LOGIC(PIN_XXXX, SIG_QQQQ, SIG_XXXX);
CHECK_LOGIC(SIG_XXXX, SIG_QQQQ, SIG_XXXX);

//-----------------------------------------------------------------------------
// meaningless, free slot

CHECK_LOGIC(REG_D0C0, SIG_RRRR, SIG_XXXX);
CHECK_LOGIC(REG_D1C0, SIG_RRRR, SIG_XXXX);
CHECK_LOGIC(REG_D0C1, SIG_RRRR, SIG_XXXX);
CHECK_LOGIC(REG_D1C1, SIG_RRRR, SIG_XXXX);
CHECK_LOGIC(PIN_D0PD, SIG_RRRR, SIG_XXXX);
CHECK_LOGIC(PIN_D1PD, SIG_RRRR, SIG_XXXX);
CHECK_LOGIC(PIN_D0PU, SIG_RRRR, SIG_XXXX);
CHECK_LOGIC(PIN_D1PU, SIG_RRRR, SIG_XXXX);
CHECK_LOGIC(PIN_D0NP, SIG_RRRR, SIG_XXXX);
CHECK_LOGIC(PIN_D1NP, SIG_RRRR, SIG_XXXX);
CHECK_LOGIC(PIN_HZPD, SIG_RRRR, SIG_XXXX);
CHECK_LOGIC(PIN_HZPU, SIG_RRRR, SIG_XXXX);
CHECK_LOGIC(PIN_HZNP, SIG_RRRR, SIG_XXXX);
CHECK_LOGIC(REG_XXXX, SIG_RRRR, SIG_XXXX);
CHECK_LOGIC(PIN_XXXX, SIG_RRRR, SIG_XXXX);
CHECK_LOGIC(SIG_XXXX, SIG_RRRR, SIG_XXXX);
...
CHECK_LOGIC(SIG_XXXX, SIG_PASS, SIG_XXXX);
...
CHECK_LOGIC(SIG_XXXX, SIG_HOLD, SIG_XXXX | SIG_HOLD);

//-----------------------------------------------------------------------------
// error states are sticky

CHECK_LOGIC(REG_XXXX, SIG_NONE, REG_XXXX);
...
CHECK_LOGIC(PIN_XXXX, SIG_NONE, PIN_XXXX);
...
CHECK_LOGIC(SIG_XXXX, SIG_NONE, SIG_XXXX);
CHECK_LOGIC(SIG_XXXX, SIG_ZZZZ, SIG_XXXX);
CHECK_LOGIC(SIG_XXXX, SIG_D0C0, SIG_XXXX);
CHECK_LOGIC(SIG_XXXX, SIG_D1C0, SIG_XXXX);
CHECK_LOGIC(SIG_XXXX, SIG_D0C1, SIG_XXXX);
CHECK_LOGIC(SIG_XXXX, SIG_D1C1, SIG_XXXX);
CHECK_LOGIC(SIG_XXXX, SIG_A0C0, SIG_XXXX);
CHECK_LOGIC(SIG_XXXX, SIG_A1C0, SIG_XXXX);
CHECK_LOGIC(SIG_XXXX, SIG_A0C1, SIG_XXXX);
CHECK_LOGIC(SIG_XXXX, SIG_A1C1, SIG_XXXX);
