...
bool TestGB::commit_everything() {
  ...
  /*p04.MATU*/ changed |= dma_reg.MATU_DMA_WRITE.commit_reg(); // -> p25,p28
  ...
  /*p21.XYMU*/ changed |= vid_reg.RENDERING_LATCHp.commit_latch();
  ...
  /*p27.WYKA*/ changed |= vid_reg.WIN_MAP_X0.commit_reg();
  /*p27.WODY*/ changed |= vid_reg.WIN_MAP_X1.commit_reg();
  /*p27.WOBO*/ changed |= vid_reg.WIN_MAP_X2.commit_reg();
  /*p27.WYKO*/ changed |= vid_reg.WIN_MAP_X3.commit_reg();
  /*p27.XOLO*/ changed |= vid_reg.WIN_MAP_X4.commit_reg();
  /*p27.VYNO*/ changed |= vid_reg.WIN_TILE_Y0.commit_reg();
  /*p27.VUJO*/ changed |= vid_reg.WIN_TILE_Y1.commit_reg();
  /*p27.VYMU*/ changed |= vid_reg.WIN_TILE_Y2.commit_reg();
  /*p27.TUFU*/ changed |= vid_reg.WIN_MAP_Y0.commit_reg();
  /*p27.TAXA*/ changed |= vid_reg.WIN_MAP_Y1.commit_reg();
  /*p27.TOZO*/ changed |= vid_reg.WIN_MAP_Y2.commit_reg();
  /*p27.TATE*/ changed |= vid_reg.WIN_MAP_Y3.commit_reg();
  /*p27.TEKE*/ changed |= vid_reg.WIN_MAP_Y4.commit_reg();
