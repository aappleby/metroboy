...
bool TestGB::commit_everything() {
  ...
  /*p04.MATU*/ changed |= dma_reg.MATU_DMA_WRITEp.commit_reg(); // -> p25,p28
  ...
  /*p29.TOXE*/ changed |= spr_reg.SFETCH_S0.commit_reg();
  /*p29.TULY*/ changed |= spr_reg.SFETCH_S1.commit_reg();
  /*p29.TESE*/ changed |= spr_reg.SFETCH_S2.commit_reg();
  ...
  /*p29.TYFO*/ changed |= spr_reg.SFETCH_S0_DELAY.commit_reg();
  ...
  /*p27.LAXU*/ changed |= vid_reg.FETCH_S0.commit_reg();
  /*p27.MESU*/ changed |= vid_reg.FETCH_S1.commit_reg();
  /*p27.NYVA*/ changed |= vid_reg.FETCH_S2.commit_reg();
  /*p27.LOVY*/ changed |= vid_reg.LOVY_BG_SEQ5_SYNC.commit_reg();
  /*p24.NYKA*/ changed |= vid_reg.FETCH_STOP_SYNC.commit_reg();
  /*p24.PORY*/ changed |= vid_reg.FETCH_STOP_SYNC_DELAY.commit_reg();
  /*p27.LYZU*/ changed |= vid_reg.FETCH_S0_DELAY.commit_reg();
  ...
  /*p27.TAKA*/ changed |= vid_reg.TAKA_SPRITE_FETCH_LATCH.commit_latch();
