...
Z80State next_state(Z80State state, uint8_t op, uint8_t cb, bool no_branch, bool no_halt, bool unhalt) {
  ...
  case Z80_STATE_PUSH1:      return Z80_STATE_PUSH2;
  case Z80_STATE_PUSH2:      return Z80_STATE_DECODE;

  //----------

  case Z80_STATE_POPN:       return Z80_STATE_POP0;

  case Z80_STATE_POP0:
    if      (RET)            return Z80_STATE_POP1;
    else if (RETI)           return Z80_STATE_POP1;
    else if (POP_RR)         return Z80_STATE_POP1;
    else if (RET_CC)         return no_branch ? Z80_STATE_DECODE : Z80_STATE_POP1;
    break;

  case Z80_STATE_POP1:       return Z80_STATE_POP2;

  case Z80_STATE_POP2:
    if      (POP_RR)         return Z80_STATE_DECODE;
    else if (RET)            return Z80_STATE_PTR1;
    else if (RETI)           return Z80_STATE_PTR1;
    else if (RET_CC)         return Z80_STATE_PTR1;
    break;

  //----------

  case Z80_STATE_ARG0:       return Z80_STATE_ARG1;
  ...
  case Z80_STATE_ARG1:
    ...
    else if (JR_R8)          return Z80_STATE_PTR1;
    else if (JR_CC_R8)       return no_branch ? Z80_STATE_DECODE : Z80_STATE_PTR1;
  ...
  case Z80_STATE_ARG2:
    if      (LDM_A_A16)      return Z80_STATE_MEM_READ1;
    ...
    else if (JP_A16)         return Z80_STATE_PTR1;
    else if (LD_RR_D16)      return Z80_STATE_DECODE;
    else if (JP_CC_A16)      return no_branch ? Z80_STATE_DECODE : Z80_STATE_PTR1;
