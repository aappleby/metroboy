  ...
  // REGULAR OPS
    ...
    // QUAD 3
      ...
      if (POP_BC) {
        ...
        else if (state == 2)       { x = data; addr = sp; data = data; read = 1; write = 0; state_ = 3; }
        else if (state == 3)       {           addr = sp; data = pch;  read = 0; write = 1; state_ = 4; }
        else if (state == 4)       {           addr = sp; data = pcl;  read = 0; write = 1; state_ = 5; }
