...
#define PASS(A)     { addr = A;           write = 0; read = 0; }
    ...
    if (CALL_CC_A16 && nb && state == 1) { pc = addr + 1;                                                          y = data;                                                                                 READ(pc);       state_ = 2; break; }
    if (CALL_CC_A16 && nb && state == 2) { pc = addr + 1;                                                          x = data;                                                                                 READ(pc);       state_ = 0; break; }
    ...
    if (JP_A16            && state == 1) { pc = addr + 1;                                                          y = data;                                                                                 READ(pc);       state_ = 2; break; }
    if (JP_A16            && state == 2) { pc = addr + 1;                                                          x = data;                                                                                 PASS(pc);       state_ = 3; break; }
    if (JP_A16            && state == 3) {                                                                                                                                                                   READ(xy);       state_ = 0; break; }
                                                                                                                                                                                                                                  
    if (JP_CC_A16 && tb   && state == 0) { pc = addr + 1;                                                                                                                                                    READ(pc);       state_ = 1; break; }
    if (JP_CC_A16 && tb   && state == 1) { pc = addr + 1;                                                          y = data;                                                                                 READ(pc);       state_ = 2; break; }
    if (JP_CC_A16 && tb   && state == 2) { pc = addr + 1;                                                          x = data;                                                                                 READ(pc);       state_ = 3; break; }
    if (JP_CC_A16 && tb   && state == 3) {                                                                                                                                                                   READ(xy);       state_ = 0; break; }
                                                                                                                                                                                                                                  
    if (JP_CC_A16 && nb   && state == 0) { pc = addr + 1;                                                                                                                                                    READ(pc);       state_ = 1; break; }
    if (JP_CC_A16 && nb   && state == 1) { pc = addr + 1;                                                          y = data;                                                                                 READ(pc);       state_ = 2; break; }
    if (JP_CC_A16 && nb   && state == 2) { pc = addr + 1;                                                          x = data;                                                                                 READ(pc);       state_ = 0; break; }
