...
#define PASS(A)     { addr = A;           write = 0; read = 0; }
    ...
    if (CALL_CC_A16 && tb && state == 1) { pc = addr + 1;                                                          y = data;                                                                                 READ(pc);       state_ = 2; break; }
    if (CALL_CC_A16 && tb && state == 2) { pc = addr + 1;                                                          x = data;                                                                                 PASS(sp);       state_ = 3; break; }
    ...
    if (RST_NN            && state == 2) { sp = addr - 1;                                                          x = 0x00;                                                                                 WRITE(sp, pcl); state_ = 3; break; }
