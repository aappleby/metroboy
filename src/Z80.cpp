...
void Z80::tock_t12(const uint8_t imask, const uint8_t intf) {
  ...
  if (INT) {
    ...
    if (state == 1 && OP_CB_HL)                                   /**/ { pc = addr + 1;   alu_x = z;                  /**/ alu_y = z;                alu_f = z;     alu_op = z;      alu(); /**/                          addr = rr;             /**/ state_ = 2; }
    if (state == 2 && PREFIX_CB)                                  /**/ {                  alu_x = data_in;            /**/ alu_y = z;                alu_f = f;     alu_op = cb;     alu(); /**/ data_out    = alu_o;     addr = rr; write = 1;  /**/ state_ = 3; update_flags(); }
    if (state == 3 && PREFIX_CB)                                  /**/ {                  alu_x = z;                  /**/ alu_y = z;                alu_f = z;     alu_op = z;      alu(); /**/                          addr = pc;             /**/ state_ = 0; }
  }
  else if (state == 0) {
    if (state == 0 && JP_HL)                                      /**/ { pc = addr + 1;   alu_x = z;                  /**/ alu_y = z;                alu_f = z;     alu_op = z;      alu(); /**/                          addr = rr;             /**/ state_ = 0; }
    ...
    if (state == 0 && STM_BC_A )                                  /**/ { pc = addr + 1;   alu_x = 0;                  /**/ alu_y = a;                alu_f = z;     alu_op = 0;      alu(); /**/ data_out    = alu_o;     addr = rr; write = 1;  /**/ state_ = 6; }
    if (state == 0 && STM_DE_A )                                  /**/ { pc = addr + 1;   alu_x = 0;                  /**/ alu_y = a;                alu_f = z;     alu_op = 0;      alu(); /**/ data_out    = alu_o;     addr = rr; write = 1;  /**/ state_ = 6; }
    if (state == 0 && STM_HLP_A)                                  /**/ { pc = addr + 1;   alu_x = 0;                  /**/ alu_y = a;                alu_f = z;     alu_op = 0;      alu(); /**/ data_out    = alu_o;     addr = rr; write = 1;  /**/ state_ = 1; }
    if (state == 0 && STM_HLM_A)                                  /**/ { pc = addr + 1;   alu_x = 0;                  /**/ alu_y = a;                alu_f = z;     alu_op = 0;      alu(); /**/ data_out    = alu_o;     addr = rr; write = 1;  /**/ state_ = 1; }
