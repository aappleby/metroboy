...
void Z80::tock_t12(const uint8_t imask, const uint8_t intf) {
  ...
  if (interrupt) {
    ...
    else if (state == 4)       /**/ {                  alu_y = 0;                  /**/ alu_x = int_addr;           /**/                                   y = alu_x;    /**/                  addr = xy; write = 0; int_ack = which_ack; state_ = 0; }
  }                            /**/                                                /**/                             /**/                                                 /**/                  
  ...
  // CB OPS                    /**/                                                /**/                             /**/                                                 /**/                  
    ...
    if      (state == 0)       /**/ {                                              /**/                             /**/                                                 /**/                  addr = pc; write = 0; state_ = 1; }
    else if (state == 1) {     /**/                                                /**/                             /**/                                                 /**/                  
      if (OP_CB_R  )           /**/ { pc = addr + 1;   alu_y = 0;                  /**/ alu_x = reg_get8(CB_COL);   /**/ alu_op = cb; alu_cb(); reg_put8(CB_COL, alu_o); /**/ update_flags();  addr = pc; write = 0; state_ = 0; }
      if (OP_CB_HL )           /**/ { pc = addr + 1;                               /**/                             /**/                                                 /**/                  addr = hl; write = 0; state_ = 2; }
    }                          /**/                                                /**/                             /**/                                                 /**/                  
    else if (state == 2)       /**/ {                  alu_y = 0;                  /**/ alu_x = data;               /**/ alu_op = cb; alu_cb();                          /**/ data = alu_o;    addr = hl; write = 1; state_ = 3; }
  ...
  // REGULAR OPS               /**/                                                /**/                             /**/                                                 /**/                  
    ...
    if (OP_QUAD == 0) {        /**/                                                /**/                             /**/                                                 /**/                  
      if (state == 0) pc = addr + 1;
      if (OP_COL == 0) {       /**/                                                /**/                             /**/                                                 /**/                  
        if      (NOP)          /**/ {                                              /**/                             /**/                                                 /**/                  addr = pc; write = 0; state_ = 0; }
        else if (STM_A16_SP) { /**/                                                /**/                             /**/                                                 /**/                  
          if      (state == 0) /**/ {                                              /**/                             /**/                                                 /**/                  addr = pc; write = 0; state_ = 1; }
          else if (state == 1) /**/ { pc = addr + 1;   alu_y = 0;                  /**/ alu_x = data;               /**/ alu_op = 0; alu(); y = alu_o;                   /**/                  addr = pc; write = 0; state_ = 2; }
          else if (state == 2) /**/ { pc = addr + 1;   alu_y = 0;                  /**/ alu_x = data;               /**/ alu_op = 0; alu(); x = alu_o;                   /**/ data = p;        addr = xy; write = 1; state_ = 3; }
          else if (state == 3) /**/ { xy = addr + 1;                               /**/                             /**/                                                 /**/ data = s;        addr = xy; write = 1; state_ = 4; }
          else if (state == 4) /**/ {                                              /**/                             /**/                                                 /**/                  addr = pc; write = 0; state_ = 0; }
        }                      /**/                                                /**/                             /**/                                                 /**/                  
        else if (STOP)         /**/ {                                              /**/                             /**/                                                 /**/                  addr = pc; write = 0; state_ = 0; }
        else if (JR_R8) {      /**/                                                /**/                             /**/                                                 /**/                  
          if      (state == 0) /**/ {                                              /**/                             /**/                                                 /**/                  addr = pc; write = 0; state_ = 1; }
          else if (state == 1) /**/ { pc = addr + 1;   alu_y = pcl;                /**/ alu_x = data;               /**/ alu_op = 0; alu(); pcl = alu_o;                 /**/                  addr = pc; write = 0; state_ = 2; }
          else if (state == 2) /**/ {                  alu_y = pch;                /**/ alu_x = sxt(alu_x);         /**/ alu_op = 1; alu(); pch = alu_o;                 /**/                  addr = pc; write = 0; state_ = 0; }
        }                      /**/                                                /**/                             /**/                                                 /**/                  
        else if (JR_CC_R8) {   /**/                                                /**/                             /**/                                                 /**/                  
          if      (state == 0) /**/ {                                              /**/                             /**/                                                 /**/                  addr = pc; write = 0; state_ = 1; }
          else if (state == 1) /**/ { pc = addr + 1;   alu_y = pcl;                /**/ alu_x = data;               /**/ alu_op = 0; alu(); y = alu_o;                   /**/                  addr = pc; write = 0; state_ = cond_fail ? 0 : 2; }
          else if (state == 2) /**/ {                  alu_y = pch;                /**/ alu_x = sxt(alu_x);         /**/ alu_op = 1; alu(); x = alu_o;                   /**/                  addr = xy; write = 0; state_ = 0; }
        }                      /**/                                                /**/                             /**/                                                 /**/                      
      }                        /**/                                                /**/                             /**/                                                 /**/                      
      else if (OP_COL == 1) {  /**/                                                /**/                             /**/                                                 /**/                      
        if      (LD_BC_D16) {  /**/                                                /**/                             /**/                                                 /**/                      
          if      (state == 0) /**/ {                                              /**/                             /**/                                                 /**/                  addr = pc; write = 0; state_ = 1; }
          else if (state == 1) /**/ { pc = addr + 1;   alu_y = 0;                  /**/ alu_x = data;               /**/                    c = alu_x;                   /**/                  addr = pc; write = 0; state_ = 2; }
          else if (state == 2) /**/ { pc = addr + 1;   alu_y = 0;                  /**/ alu_x = data;               /**/                    b = alu_x;                   /**/                  addr = pc; write = 0; state_ = 0; }
        }                      /**/                                                /**/                             /**/                                                 /**/                            
        else if (LD_DE_D16) {  /**/                                                /**/                             /**/                                                 /**/                            
          if      (state == 0) /**/ {                                              /**/                             /**/                                                 /**/                  addr = pc; write = 0; state_ = 1; }
          else if (state == 1) /**/ { pc = addr + 1;   alu_y = 0;                  /**/ alu_x = data;               /**/                    e = alu_x;                   /**/                  addr = pc; write = 0; state_ = 2; }
          else if (state == 2) /**/ { pc = addr + 1;   alu_y = 0;                  /**/ alu_x = data;               /**/                    d = alu_x;                   /**/                  addr = pc; write = 0; state_ = 0; }
        }                      /**/                                                /**/                             /**/                                                 /**/                            
        else if (LD_HL_D16) {  /**/                                                /**/                             /**/                                                 /**/                            
          if      (state == 0) /**/ {                                              /**/                             /**/                                                 /**/                  addr = pc; write = 0; state_ = 1; }
          else if (state == 1) /**/ { pc = addr + 1;   alu_y = 0;                  /**/ alu_x = data;               /**/                    l = alu_x;                   /**/                  addr = pc; write = 0; state_ = 2; }
          else if (state == 2) /**/ { pc = addr + 1;   alu_y = 0;                  /**/ alu_x = data;               /**/                    h = alu_x;                   /**/                  addr = pc; write = 0; state_ = 0; }
        }                      /**/                                                /**/                             /**/                                                 /**/                            
        else if (LD_SP_D16) {  /**/                                                /**/                             /**/                                                 /**/                            
          if      (state == 0) /**/ {                                              /**/                             /**/                                                 /**/                  addr = pc; write = 0; state_ = 1; }
          else if (state == 1) /**/ { pc = addr + 1;   alu_y = 0;                  /**/ alu_x = data;               /**/                    p = alu_x;                   /**/                  addr = pc; write = 0; state_ = 2; }
          else if (state == 2) /**/ { pc = addr + 1;   alu_y = 0;                  /**/ alu_x = data;               /**/                    s = alu_x;                   /**/                  addr = pc; write = 0; state_ = 0; }
        }                      /**/                                                /**/                             /**/                                                 /**/                                              
        else if (ADD_HL_BC) {  /**/                                                /**/                             /**/                                                 /**/                  
          if      (state == 0) /**/ {                  alu_y = l;                  /**/ alu_x = c;                  /**/ alu_op = 0; alu(); l = alu_o;                   /**/                  addr = pc; write = 0; state_ = 1; }
          else if (state == 1) /**/ {                  alu_y = h;                  /**/ alu_x = b;                  /**/ alu_op = 1; alu(); h = alu_o;                   /**/ update_flags();  addr = pc; write = 0; state_ = 0; }
        }                      /**/                                                /**/                             /**/                                                 /**/                  
        else if (ADD_HL_DE) {  /**/                                                /**/                             /**/                                                 /**/                  
          if      (state == 0) /**/ {                  alu_y = l;                  /**/ alu_x = e;                  /**/ alu_op = 0; alu(); l = alu_o;                   /**/                  addr = pc; write = 0; state_ = 1; }
          else if (state == 1) /**/ {                  alu_y = h;                  /**/ alu_x = d;                  /**/ alu_op = 1; alu(); h = alu_o;                   /**/ update_flags();  addr = pc; write = 0; state_ = 0; }
        }                      /**/                                                /**/                             /**/                                                 /**/                  
        else if (ADD_HL_HL) {  /**/                                                /**/                             /**/                                                 /**/                  
          if      (state == 0) /**/ {                  alu_y = l;                  /**/ alu_x = l;                  /**/ alu_op = 0; alu(); l = alu_o;                   /**/                  addr = pc; write = 0; state_ = 1; }
          else if (state == 1) /**/ {                  alu_y = h;                  /**/ alu_x = h;                  /**/ alu_op = 1; alu(); h = alu_o;                   /**/ update_flags();  addr = pc; write = 0; state_ = 0; }
        }                      /**/                                                /**/                             /**/                                                 /**/                  
        else if (ADD_HL_SP) {  /**/                                                /**/                             /**/                                                 /**/                  
          if      (state == 0) /**/ {                  alu_y = l;                  /**/ alu_x = p;                  /**/ alu_op = 0; alu(); l = alu_o;                   /**/                  addr = pc; write = 0; state_ = 1; }
          else if (state == 1) /**/ {                  alu_y = h;                  /**/ alu_x = s;                  /**/ alu_op = 1; alu(); h = alu_o;                   /**/ update_flags();  addr = pc; write = 0; state_ = 0; }
        }                      /**/                                                /**/                             /**/                                                 /**/                  
      }                        /**/                                                /**/                             /**/                                                 /**/                  
      else if (OP_COL == 2) {  /**/                                                /**/                             /**/                                                 /**/                  
        if (state == 0) {      /**/                                                /**/                             /**/                                                 /**/                  
          if      (STM_BC_A )  /**/ {                                              /**/                             /**/                                                 /**/ data = a;        addr = bc; write = 1; state_ = 1; }
          else if (STM_DE_A )  /**/ {                                              /**/                             /**/                                                 /**/ data = a;        addr = de; write = 1; state_ = 1; }
          else if (STM_HLP_A)  /**/ {                                              /**/                             /**/                                                 /**/ data = a;        addr = hl; write = 1; state_ = 1; }
          else if (STM_HLM_A)  /**/ {                                              /**/                             /**/                                                 /**/ data = a;        addr = hl; write = 1; state_ = 1; }
          else if (LDM_A_BC )  /**/ {                                              /**/                             /**/                                                 /**/                  addr = bc; write = 0; state_ = 1; }
          else if (LDM_A_DE )  /**/ {                                              /**/                             /**/                                                 /**/                  addr = de; write = 0; state_ = 1; }
          else if (LDM_A_HLP)  /**/ {                                              /**/                             /**/                                                 /**/                  addr = hl; write = 0; state_ = 1; }
          else if (LDM_A_HLM)  /**/ {                                              /**/                             /**/                                                 /**/                  addr = hl; write = 0; state_ = 1; }
        }                      /**/                                                /**/                             /**/                                                 /**/                  
        else if (state == 1) { /**/                                                /**/                             /**/                                                 /**/                  
          ...
          else if (LDM_A_BC )  /**/ {                  alu_y = 0;                  /**/ alu_x = data;               /**/ a = alu_x;                                      /**/                  addr = pc; write = 0; state_ = 0; }
          else if (LDM_A_DE )  /**/ {                  alu_y = 0;                  /**/ alu_x = data;               /**/ a = alu_x;                                      /**/                  addr = pc; write = 0; state_ = 0; }
          else if (LDM_A_HLP)  /**/ { hl = addr + 1;   alu_y = 0;                  /**/ alu_x = data;               /**/ a = alu_x;                                      /**/                  addr = pc; write = 0; state_ = 0; }
          else if (LDM_A_HLM)  /**/ { hl = addr - 1;   alu_y = 0;                  /**/ alu_x = data;               /**/ a = alu_x;                                      /**/                  addr = pc; write = 0; state_ = 0; }
        }                      /**/                                                /**/                             /**/                                                 /**/                  
      }                        /**/                                                /**/                             /**/                                                 /**/                  
      else if (OP_COL == 3) {  /**/                                                /**/                             /**/                                                 /**/                  
        if (state == 0) {      /**/                                                /**/                             /**/                                                 /**/                  
        ...
        if (INC_AT_HL) {       /**/                                                /**/                             /**/                                                 /**/                  
          if      (state == 0) /**/ {                                              /**/                             /**/                                                 /**/                  addr = hl; write = 0; state_ = 1; }
          else if (state == 1) /**/ {                  alu_y = 1;                  /**/ alu_x = data;               /**/ alu_op = 0; alu();                              /**/ data = alu_o;    addr = hl; write = 1; state_ = 2; }
          else if (state == 2) /**/ {                                              /**/                             /**/                                                 /**/ update_flags();  addr = pc; write = 0; state_ = 0; }
        }                      /**/                                                /**/                             /**/                                                 /**/                                        
        else if (INC_R)        /**/ {                  alu_y = 1;                  /**/ alu_x = reg_get8();         /**/ alu_op = 0; alu(); reg_put8(alu_o);             /**/ update_flags();  addr = pc; write = 0; state_ = 0; }
      }                        /**/                                                /**/                             /**/                                                 /**/                  
      else if (OP_COL == 5) {  /**/                                                /**/                             /**/                                                 /**/                  
        if (DEC_AT_HL) {       /**/                                                /**/                             /**/                                                 /**/                  
          if      (state == 0) /**/ {                                              /**/                             /**/                                                 /**/                  addr = hl; write = 0; state_ = 1; }
          else if (state == 1) /**/ {                  alu_y = 1;                  /**/ alu_x = data;               /**/ alu_op = 2; alu();                              /**/ data = alu_o;    addr = hl; write = 1; state_ = 2; }
          else if (state == 2) /**/ {                                              /**/                             /**/                                                 /**/ update_flags();  addr = pc; write = 0; state_ = 0; }
        }                      /**/                                                /**/                             /**/                                                 /**/                  
        else if (DEC_R)        /**/ {                  alu_y = 1;                  /**/ alu_x = reg_get8();         /**/ alu_op = 2; alu(); reg_put8(alu_o);             /**/ update_flags();  addr = pc; write = 0; state_ = 0; }
      }                        /**/                                                /**/                             /**/                                                 /**/                  
      else if (OP_COL == 6) {  /**/                                                /**/                             /**/                                                 /**/                  
        if (STM_HL_D8) {       /**/                                                /**/                             /**/                                                 /**/                  
          if      (state == 0) /**/ {                                              /**/                             /**/                                                 /**/                  addr = pc; write = 0; state_ = 1; }
        ...
        if (RLU_R) {           /**/                                                /**/                             /**/                                                 /**/                  
          if      (state == 0) /**/ {                  alu_y = 0;                  /**/ alu_x = reg_get8();         /**/ alu_op = OP_ROW; rlu(); a = alu_o;              /**/ update_flags();  addr = pc; write = 0; state_ = 0; }
        }                      /**/                                                /**/                             /**/                                                 /**/                  
      }                        /**/                                                /**/                             /**/                                                 /**/                  
    }                          /**/                                                /**/                             /**/                                                 /**/                  
                               /**/                                                /**/                             /**/                                                 /**/                  
    ...
    // QUAD 1                  /**/                                                /**/                             /**/                                                 /**/                  
      ...
      if (state == 0) pc = addr + 1;
      if (HALT) {              /**/                                                /**/                             /**/                                                 /**/                  
        if      (state == 0)   /**/ {                                              /**/                             /**/                                                 /**/                  addr = pc; write = 0; state_ = !no_halt; }
        ...
        if      (state == 0)   /**/ {                  alu_y = 0;                  /**/ alu_x = reg_get8();         /**/                                                 /**/ data = alu_x;    addr = hl; write = 1; state_ = 1; }
        else if (state == 1)   /**/ {                                              /**/                             /**/                                                 /**/                  addr = pc; write = 0; state_ = 0; }
      }                        /**/                                                /**/                             /**/                                                 /**/                  
      else {                   /**/                                                /**/                             /**/                                                 /**/                  
        if      (state == 0)   /**/ {                  alu_y = 0;                  /**/ alu_x = reg_get8();         /**/ reg_put8(alu_x);                                /**/                  addr = pc; write = 0; state_ = 0; }
      }                        /**/                                                /**/                             /**/                                                 /**/                  
    }                          /**/                                                /**/                             /**/                                                 /**/                  
                               /**/                                                /**/                             /**/                                                 /**/                  
    //----------               /**/                                                /**/                             /**/                                                 /**/                  
    // QUAD 2                  /**/                                                /**/                             /**/                                                 /**/                  
      ...
      if (OP_COL == 6) {       /**/                                                /**/                             /**/                                                 /**/                  
        ...
        if (state == 0)        /**/ {                  alu_y = reg_get8();         /**/ alu_x = a;                  /**/ alu_op = OP_ROW; alu(); a = alu_o;              /**/ update_flags();  addr = pc; write = 0; state_ = 0; }
      }                        /**/                                                /**/                             /**/                                                 /**/                  
    }                          /**/                                                /**/                             /**/                                                 /**/                  
                               /**/                                                /**/                             /**/                                                 /**/                  
    //----------               /**/                                                /**/                             /**/                                                 /**/                  
    // QUAD 3                  /**/                                                /**/                             /**/                                                 /**/                  
      ...
      if (POP_BC) {            /**/                                                /**/                             /**/                                                 /**/                  
        ...
        if (state == 0)        /**/ {                  alu_y = 0;                  /**/                             /**/                                                 /**/                  addr = sp; write = 0; state_ = 1; }
      ...
      else if (JP_HL)          /**/ {                                              /**/                             /**/                                                 /**/                  addr = hl; write = 0; state_ = 0; }
      else if (LD_SP_HL) {     /**/                                                /**/                             /**/                                                 /**/                  
        if      (state == 0)   /**/ {                                              /**/                             /**/                                                 /**/                  addr = hl; write = 0; state_ = 1; }
        ...
        if      (state == 0)   /**/ {                  alu_y = 0;                  /**/ alu_x = c;                  /**/ y = alu_x;                                      /**/ data = a;        addr = xy; write = 1; state_ = 1; }
        else if (state == 1)   /**/ {                                              /**/                             /**/                                                 /**/                  addr = pc; write = 0; state_ = 0; }
      }                        /**/                                                /**/                             /**/                                                 /**/                  
      else if (STM_A16_A) {    /**/                                                /**/                             /**/                                                 /**/                  
        if      (state == 0)   /**/ {                                              /**/                             /**/                                                 /**/                  addr = pc; write = 0; state_ = 1; }
        ...
        if      (state == 0)   /**/ {                  alu_y = 0;                  /**/ alu_x = c;                  /**/ y = alu_x;                                      /**/                  addr = xy; write = 0; state_ = 1; }
      ...
      else if (DI)             /**/ {                                              /**/                             /**/                                                 /**/                  addr = pc; write = 0; state_ = 0; }
      else if (EI)             /**/ {                                              /**/                             /**/                                                 /**/                  addr = pc; write = 0; state_ = 0; }
      else if (CALL_CC_A16) {  /**/                                                /**/                             /**/                                                 /**/                  
        if      (state == 0)   /**/ {                                              /**/                             /**/                                                 /**/                  addr = pc; write = 0; state_ = 1; }
        else if (state == 1)   /**/ { pc = addr + 1;   alu_y = 0;                  /**/ alu_x = data;               /**/ y = alu_x;                                      /**/                  addr = pc; write = 0; state_ = 2; }
                               /**/                                                /**/                             /**/                                                 /**/                  
