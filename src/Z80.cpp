...
void Z80::tock_t12(const uint8_t imask, const uint8_t intf) {
  ...
  if (INT) {
    ...
    if (state == 1 && PUSH_BC)                /**/ { bus = b;           data_out = bus; sp = addr - 1; /**/                                                                   addr = sp; write = 1; /**/                                  /**/                                        state_ = 2; }
    if (state == 1 && PUSH_DE)                /**/ { bus = d;           data_out = bus; sp = addr - 1; /**/                                                                   addr = sp; write = 1; /**/                                  /**/                                        state_ = 2; }
    if (state == 1 && PUSH_HL)                /**/ { bus = h;           data_out = bus; sp = addr - 1; /**/                                                                   addr = sp; write = 1; /**/                                  /**/                                        state_ = 2; }
    if (state == 1 && PUSH_AF)                /**/ { bus = a;           data_out = bus; sp = addr - 1; /**/                                                                   addr = sp; write = 1; /**/                                  /**/                                        state_ = 2; }
    if (state == 2 && PUSH_BC)                /**/ { bus = c;           data_out = bus; sp = addr - 1; /**/                                                                   addr = sp; write = 1; /**/                                  /**/                                        state_ = 6; }
    if (state == 2 && PUSH_DE)                /**/ { bus = e;           data_out = bus; sp = addr - 1; /**/                                                                   addr = sp; write = 1; /**/                                  /**/                                        state_ = 6; }
    if (state == 2 && PUSH_HL)                /**/ { bus = l;           data_out = bus; sp = addr - 1; /**/                                                                   addr = sp; write = 1; /**/                                  /**/                                        state_ = 6; }
    if (state == 2 && PUSH_AF)                /**/ { bus = f;           data_out = bus; sp = addr - 1; /**/                                                                   addr = sp; write = 1; /**/                                  /**/                                        state_ = 6; }
    ...
    if (state == 0 && STM_HLP_A)              /**/ { bus = a;           data_out = bus; pc = addr + 1; /**/                                                                   addr = hl; write = 1; /**/                                  /**/                                        state_ = 1; }
    if (state == 1 && STM_HLP_A)              /**/ {                                    hl = addr + 1; /**/                                                                   addr = pc; write = 0; /**/                                  /**/                                        state_ = 0; }

    if (state == 0 && STM_HLM_A)              /**/ { bus = a;           data_out = bus; pc = addr + 1; /**/                                                                   addr = hl; write = 1; /**/                                  /**/                                        state_ = 1; }
