  ...
  // REGULAR OPS               /**/                   /**/                             /**/                             /**/                                                 /**/                 /**/ 
    ...
    if (OP_QUAD == 0) {        /**/                   /**/                             /**/                             /**/                                                 /**/                 /**/ 
      if (OP_COL == 0) {       /**/                   /**/                             /**/                             /**/                                                 /**/                 /**/ 
        ...
        if      (LD_BC_D16) {  /**/                   /**/                             /**/                             /**/                                                 /**/                 /**/     
          ...
          if      (state == 0) /**/ { pc = addr + 1;  /**/ alu_y = l;                  /**/ alu_x = c;                  /**/ alu_op = 0; alu(); l = alu_o;                   /**/                 /**/ addr = pc; write = 0; state_ = 1; }
          else if (state == 1) /**/ {                 /**/ alu_y = h;                  /**/ alu_x = b;                  /**/ alu_op = 1; alu(); h = alu_o;                   /**/ update_flags(); /**/ addr = pc; write = 0; state_ = 0; }
        }                      /**/                   /**/                             /**/                             /**/                                                 /**/                 /**/ 
        else if (ADD_HL_DE) {  /**/                   /**/                             /**/                             /**/                                                 /**/                 /**/ 
          if      (state == 0) /**/ { pc = addr + 1;  /**/ alu_y = l;                  /**/ alu_x = e;                  /**/ alu_op = 0; alu(); l = alu_o;                   /**/                 /**/ addr = pc; write = 0; state_ = 1; }
          else if (state == 1) /**/ {                 /**/ alu_y = h;                  /**/ alu_x = d;                  /**/ alu_op = 1; alu(); h = alu_o;                   /**/ update_flags(); /**/ addr = pc; write = 0; state_ = 0; }
        }                      /**/                   /**/                             /**/                             /**/                                                 /**/                 /**/ 
        else if (ADD_HL_HL) {  /**/                   /**/                             /**/                             /**/                                                 /**/                 /**/ 
          if      (state == 0) /**/ { pc = addr + 1;  /**/ alu_y = l;                  /**/ alu_x = l;                  /**/ alu_op = 0; alu(); l = alu_o;                   /**/                 /**/ addr = pc; write = 0; state_ = 1; }
          else if (state == 1) /**/ {                 /**/ alu_y = h;                  /**/ alu_x = h;                  /**/ alu_op = 1; alu(); h = alu_o;                   /**/ update_flags(); /**/ addr = pc; write = 0; state_ = 0; }
        }                      /**/                   /**/                             /**/                             /**/                                                 /**/                 /**/ 
        else if (ADD_HL_SP) {  /**/                   /**/                             /**/                             /**/                                                 /**/                 /**/ 
          if      (state == 0) /**/ { pc = addr + 1;  /**/ alu_y = l;                  /**/ alu_x = p;                  /**/ alu_op = 0; alu(); l = alu_o;                   /**/                 /**/ addr = pc; write = 0; state_ = 1; }
        ...
        else if (INC_R)        /**/ { pc = addr + 1;  /**/ alu_y = 1;                  /**/ alu_x = reg_get8();         /**/ alu_op = 0; alu(); reg_put8(alu_o);             /**/ update_flags(); /**/ addr = pc; write = 0; state_ = 0; }
      }                        /**/                   /**/                             /**/                             /**/                                                 /**/                 /**/ 
      else if (OP_COL == 5) {  /**/                   /**/                             /**/                             /**/                                                 /**/                 /**/ 
        if (DEC_AT_HL) {       /**/                   /**/                             /**/                             /**/                                                 /**/                 /**/ 
          if      (state == 0) /**/ { pc = addr + 1;  /**/                             /**/                             /**/                                                 /**/                 /**/ addr = hl; write = 0; state_ = 1; }
        ...
        else if (DEC_R)        /**/ { pc = addr + 1;  /**/ alu_y = 1;                  /**/ alu_x = reg_get8();         /**/ alu_op = 2; alu(); reg_put8(alu_o);             /**/ update_flags(); /**/ addr = pc; write = 0; state_ = 0; }
      }                        /**/                   /**/                             /**/                             /**/                                                 /**/                 /**/ 
      else if (OP_COL == 6) {  /**/                   /**/                             /**/                             /**/                                                 /**/                 /**/ 
        if (STM_HL_D8) {       /**/                   /**/                             /**/                             /**/                                                 /**/                 /**/ 
          if      (state == 0) /**/ { pc = addr + 1;  /**/                             /**/                             /**/                                                 /**/                 /**/ addr = pc; write = 0; state_ = 1; }
    ...
    // QUAD 3                  /**/                   /**/                             /**/                             /**/                                                 /**/                 /**/ 
      ...
      if (POP_BC) {            /**/                   /**/                             /**/                             /**/                                                 /**/                 /**/ 
        ...
        if      (state == 0)   /**/ { pc = addr + 1;  /**/ alu_y = c;                  /**/ alu_x = 0;                  /**/ y = alu_y;                                      /**/                 /**/ addr = xy; write = 0; state_ = 1; }
        else if (state == 1)   /**/ {                 /**/ alu_x = 0;                  /**/ alu_y = data;               /**/ a = alu_y;                                      /**/                 /**/ addr = pc; write = 0; state_ = 0; }
      }                        /**/                   /**/                             /**/                             /**/                                                 /**/                 /**/ 
      else if (LDM_A_A16) {    /**/                   /**/                             /**/                             /**/                                                 /**/                 /**/ 
        if      (state == 0)   /**/ { pc = addr + 1;  /**/                             /**/                             /**/                                                 /**/                 /**/ addr = pc; write = 0; state_ = 1; }
        else if (state == 1)   /**/ { pc = addr + 1;  /**/ alu_x = 0;                  /**/ alu_y = data;               /**/ y = alu_y;                                      /**/                 /**/ addr = pc; write = 0; state_ = 2; }
        else if (state == 2)   /**/ { pc = addr + 1;  /**/ alu_x = 0;                  /**/ alu_y = data;               /**/ x = alu_y;                                      /**/                 /**/ addr = xy; write = 0; state_ = 3; }
        else if (state == 3)   /**/ {                 /**/ alu_x = 0;                  /**/ alu_y = data;               /**/ a = alu_y;                                      /**/                 /**/ addr = pc; write = 0; state_ = 0; }
      }                        /**/                   /**/                             /**/                             /**/                                                 /**/                 /**/ 
      else if (JP_A16) {       /**/                   /**/                             /**/                             /**/                                                 /**/                 /**/ 
        if      (state == 0)   /**/ { pc = addr + 1;  /**/                             /**/                             /**/                                                 /**/                 /**/ addr = pc; write = 0; state_ = 1; }
        else if (state == 1)   /**/ { pc = addr + 1;  /**/ alu_x = 0;                  /**/ alu_y = data;               /**/ y = alu_y;                                      /**/                 /**/ addr = pc; write = 0; state_ = 2; }
        else if (state == 2)   /**/ { pc = addr + 1;  /**/ alu_x = 0;                  /**/ alu_y = data;               /**/ x = alu_y;                                      /**/                 /**/ addr = pc; write = 0; state_ = 3; }
        ...
        if      (state == 0)   /**/ { pc = addr + 1;  /**/                             /**/                             /**/                                                 /**/                 /**/ addr = pc; write = 0; state_ = 1; }
                               ...
                               /**/                   /**/                             /**/                             /**/                                                 /**/                 /**/ 
        if (nb) {              /**/                   /**/                             /**/                             /**/                                                 /**/                 /**/ 
          if      (state == 2) /**/ { pc = addr + 1;  /**/ alu_x = 0;                  /**/ alu_y = data;               /**/ x = alu_y;                                      /**/                 /**/ addr = pc; write = 0; state_ = 0; }
        }                      /**/                   /**/                             /**/                             /**/                                                 /**/                 /**/ 
        else {                 /**/                   /**/                             /**/                             /**/                                                 /**/                 /**/ 
          if      (state == 2) /**/ { pc = addr + 1;  /**/ alu_x = 0;                  /**/ alu_y = data;               /**/ x = alu_y;                                      /**/                 /**/ addr = sp; write = 0; state_ = 3; }
        ...
        else if (state == 2)   /**/ { pc = addr + 1;  /**/ alu_x = 0;                  /**/ alu_y = data;               /**/ x = alu_y;                                      /**/                 /**/ addr = sp; write = 0; state_ = 3; }
        else if (state == 3)   /**/ { sp = addr - 1;  /**/                             /**/                             /**/                                                 /**/ data = pch;     /**/ addr = sp; write = 1; state_ = 4; }
        else if (state == 4)   /**/ { sp = addr - 1;  /**/                             /**/                             /**/                                                 /**/ data = pcl;     /**/ addr = sp; write = 1; state_ = 5; }
        ...
        else if (state == 2)   /**/ { sp = addr - 1;  /**/ alu_x = 0;                  /**/ alu_y = 0;                  /**/ x = alu_y;                                      /**/ data = pcl;     /**/ addr = sp; write = 1; state_ = 3; }
        else if (state == 3)   /**/ {                 /**/ alu_x = 0x38;               /**/ alu_y = op;                 /**/ y = alu_x & alu_y;                              /**/                 /**/ addr = xy; write = 0; state_ = 0; }
      }
    }
  }
