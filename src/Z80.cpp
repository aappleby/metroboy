...
void Z80::tock_t12(const uint8_t imask, const uint8_t intf) {
  ...
  if (INT) {
    ...
    if (state == 2 && RET)                    /**/ { bus = data_in;          pch = bus; sp = addr + 1; /**/                                                                              write = 0; /**/                                  /**/                                        state_ = 6; }
    if (state == 2 && RETI)                   /**/ { bus = data_in;          pch = bus; sp = addr + 1; /**/                                                                              write = 0; /**/                                  /**/                                        state_ = 6; }
    ...
    if (state == 2 && JP_CC_A16 && branch)    /**/ { bus = data_in;            x = bus; pc = addr + 1; /**/                                                                   addr = pc; write = 0; /**/                                  /**/                                        state_ = 5; }
                                                                     
    if (state == 3 && CALL_CC_A16)            /**/ { bus = pch;         data_out = bus; sp = addr - 1; /**/                                                                   addr = sp; write = 1; /**/                                  /**/                                        state_ = 4; }
    if (state == 3 && CALL_A16)               /**/ { bus = pch;         data_out = bus; sp = addr - 1; /**/                                                                   addr = sp; write = 1; /**/                                  /**/                                        state_ = 4; }
    if (state == 4 && CALL_CC_A16)            /**/ { bus = pcl;         data_out = bus; sp = addr - 1; /**/                                                                   addr = sp; write = 1; /**/                                  /**/                                        state_ = 5; }
    if (state == 4 && CALL_A16)               /**/ { bus = pcl;         data_out = bus; sp = addr - 1; /**/                                                                   addr = sp; write = 1; /**/                                  /**/                                        state_ = 5; }
